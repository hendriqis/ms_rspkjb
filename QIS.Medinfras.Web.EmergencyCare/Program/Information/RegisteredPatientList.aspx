<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="RegisteredPatientList.aspx.cs" Inherits="QIS.Medinfras.Web.EmergencyCare.Program.RegisteredPatientList" %>

<%@ Register Src="~/Libs/Controls/PatientGrid/GridInformationPatientVisitCtl.ascx" TagName="ctlGrdInpatientReg"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=txtRegistrationDateFrom.ClientID %>').datepicker('option', 'maxDate', new Date());
            $('#<%=txtRegistrationDateTo.ClientID %>').datepicker('option', 'maxDate', new Date());

            $('#<%=txtRegistrationDateTo.ClientID %>').change(function (evt) {
                onRefreshGridView();
            });
                    ...
                    <fieldset id="fsPatientList">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtRegistrationDateFrom" Width="120px" runat="server" CssClass="datepicker" /> Sampai dengan
                                    <asp:TextBox ID="txtRegistrationDateTo" Width="120px" runat="server" CssClass="datepicker" />
                                </td>
