<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master" AutoEventWireup="true" 
    CodeBehind="EpisodeSummary.aspx.cs" Inherits="QIS.Medinfras.Web.EmergencyCare.Program.EpisodeSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <style type="text/css">
        ...
        #leftPanel > ul > li    { list-style-type: none; font-size: 12px; display: inline-block; border: 1px solid #848484; padding: 5px 8px; cursor: pointer; }
        #leftPanel > ul > li.selected { background-color: #DB2C12; color: White; }
    </style>
            ...
            <td style="height:460px">
                <div id="leftPanel">
                    <ul>
                        ...
                        <li url="~/Program/PatientPage/Summary/EpisodeSummary/EpisodeSummaryVaccinationShotCtl.ascx" title="Vaccination Shot">VS</li>
                    </ul>
