<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.Master"
    AutoEventWireup="true" CodeBehind="ERPatientStatus.aspx.cs" Inherits="QIS.Medinfras.Web.EmergencyCare.Program.ERPatientStatus" %>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                        ...
                        <td colspan="3">
                            <table>
                                ...
                                <tr>
                                    <td colspan="2">&nbsp;</td>
                                    <td colspan="2">
                                        <div class="lblComponent" style="width:100%;text-align:center"><%=GetLabel("Jam Datang")%></div>
                                    </td>
                                    <td colspan="2">
                                        <div class="lblComponent" style="width:100%;text-align:center"><%=GetLabel("Jam Layan")%></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2"><div class="lblComponent" style="width:100%;text-align:center"><%=GetLabel("Jam Kejadian") %></div></td>
                                    <td><asp:TextBox ID="txtRegistrationDate" Width="120px" runat="server" CssClass="datepicker" /></td>
                                    <td><asp:TextBox ID="txtRegistrationTime" Width="80px" runat="server" CssClass="time" /></td>
                                    <td><asp:TextBox ID="txtServiceDate" Width="120px" CssClass="datepicker" runat="server" /></td>
                                    <td><asp:TextBox ID="txtServiceTime" Width="80px" CssClass="time" runat="server" Style="text-align: center" /></td>
                                </tr>
                                <tr>
                                    <td><asp:TextBox ID="txtEmergencyCaseDate" Width="120px" CssClass="datepicker" runat="server" /></td>
                                    <td><asp:TextBox ID="txtEmergencyCaseTime" Width="80px" CssClass="time" runat="server" Style="text-align: center" /></td>
                                    <td colspan="2"><asp:TextBox ID="txtRegistrationDateDiff" ReadOnly="true" Style="text-align:center" Width="100%" runat="server"/></td>
                                    <td colspan="2"><asp:TextBox ID="txtServiceDateDiff" ReadOnly="true" Style="text-align:center" Width="100%" runat="server"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtChiefComplaint" Width="500px" runat="server" TextMode="MultiLine"
                                Rows="5" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td><%=GetLabel("Triage") %></td>
                        <td>
                            <dxe:ASPxComboBox runat="server" ID="cboTriage" ClientInstanceName="cboTriage" Width="500px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel" valign="top" style="padding-top: 5px;"><%=GetLabel("Lokasi Kejadian (Kasus di luar penyakit)") %></td>
                        <td>
                            <asp:TextBox ID="txtEmergencyCase" runat="server" Width="500px" TextMode="Multiline" Rows="10" />
                        </td>
                    </tr>
                </table>
            </td>
