...
namespace QIS.Medinfras.Web.EmergencyCare.Program
{
    public partial class ERPatientStatus : BasePageTrx
    {
        ...
        {
            string filterExpression = string.Format("ParentID IN ('{0}','{1}','{2}','{3}','{4}','{5}','{6}') AND IsDeleted = 0", Constant.StandardCode.ONSET, Constant.StandardCode.EXACERBATED, Constant.StandardCode.QUALITY,
        ...
        private void ControlToEntity(ChiefComplaint entity, PatientVisitNote entitypvn)
        {
            ...
            if (type == "save")
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        PatientVisitNote entitypvn = new PatientVisitNote();
                        ControlToEntity(entity, entitypvn);
