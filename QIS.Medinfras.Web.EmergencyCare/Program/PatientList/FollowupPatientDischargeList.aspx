<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="FollowupPatientDischargeList.aspx.cs" Inherits="QIS.Medinfras.Web.EmergencyCare.Program.FollowupPatientDischargeList" %>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    title="Has Nurse Anamnesis" alt="" style='<%# Eval("IsHasNurseAnamnesis").ToString() == "True" ? "cursor: pointer;width:24px;heght:24px": "width:24px;heght:24px;display:none" %>'>
                                                </td>
                                                <td align="center">
