<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="RegistrationList.aspx.cs" Inherits="QIS.Medinfras.Web.EmergencyCare.Program.RegistrationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
            ...
            if (!isHoverTdExpand) {
                ...
                if ($('#<%=hdnTransactionNo.ClientID %>').val($(this).find('.hdnRegistrationID').val()) != null) {
                    ...
                    Methods.getObject('GetvRegistrationList', filterExpression, function (result) {
                        if (result != null) {
                            if (result.BedID == 0) {
                                showToast('Informasi', 'Pasien tidak dapat dipindah karena Tempat Tidur Belum Dipilih');
                            }
                            else {
        ...
        $('#<%=chkIsPreviousEpisodePatient.ClientID %>').live('change', function () {
            if ($(this).is(':checked')) {
                $('#<%=txtVisitDate.ClientID %>').attr('readonly', 'readonly');
            }
            else $('#<%=txtVisitDate.ClientID %>').removeAttr('readonly');
            onRefreshGridView();
        });

    </script>
    <input type="hidden" value="" id="hdnFilterHealthcareServiceUnit" runat="server" />
                    ...
                    <fieldset id="fsPatientList">
                        <table class="tblEntryContent" style="width: 60%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtVisitDate" Width="120px" runat="server" CssClass="datepicker" />
