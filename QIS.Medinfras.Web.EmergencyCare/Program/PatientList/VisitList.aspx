<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="VisitList.aspx.cs" Inherits="QIS.Medinfras.Web.EmergencyCare.Program.VisitList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        ...
        function onGetPhysicianFilterExpression() {
            var filterExpression = "ParamedicID IN (SELECT ParamedicID FROM vServiceUnitParamedic WHERE DepartmentID = 'EMERGENCY') AND IsDeleted = 0";
                                ...
                                <td colspan="2">
                                    ...
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPhysicianName" ReadOnly="true" Width="50%" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
