...
namespace QIS.Medinfras.Web.Outpatient.Program
{
    public partial class FollowupPatientDischargeList : BasePageContent
    {
        ...
        {
            return Constant.MenuCode.Outpatient.FOLLOWUP_PATIENT_DISCHARGE;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                List<GetServiceUnitUserList> lstServiceUnit = BusinessLayer.GetServiceUnitUserList(AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID, Constant.Facility.OUTPATIENT, filterExpression);
        ...
        {
            string filterExpression = string.Format("DepartmentID = '{0}' AND HealthcareServiceUnitID = {1} AND GCVisitStatus IN ('{2}','{3}')", Constant.Facility.OUTPATIENT, cboServiceUnit.Value, Constant.VisitStatus.DISCHARGED, Constant.VisitStatus.CLOSED);
            string orderBy = "";
