           ...
           function openDefault(){}
            ...
            document.getElementById("txtParam24").onkeyup = function (e) {
                //BMI();
                BMICal();
            };
            document.getElementById("txtParam25").onkeyup = function (e) {
                BMICal();
            ...
            function BMICal() {
                ...
                if (tinggiBadan != "" && beratBadan != "" && tinggiBadan != "0" && beratBadan != "0") {
                    if (tinggiBadan > 160) {
                        anjuranBeratBadan = (parseInt(tinggiBadan) - 100) - (0.1 * (parseInt(tinggiBadan) - 100));
                    } else {
                        anjuranBeratBadan = (parseInt(tinggiBadan) - 100);
                    }
                    ...
                    var tinggi = Math.pow(parseInt(tinggiBadan) / 100, 2);
                    bmi = Math.round(parseInt(beratBadan) / tinggi);
                    ...
                    if (parseFloat(bmi) < 18.5) {
                        ...
                        document.getElementById("ddlParameter23").value = "Obesitas";
