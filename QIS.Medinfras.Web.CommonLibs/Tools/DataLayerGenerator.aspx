<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataLayerGenerator.aspx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.DataLayerGenerator" %>
...
<body>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=cboProc.ClientID %>').change(function () {
                setTxtProcNameText();
            });
            ...
            function setTxtProcNameText() {
                $('#<%=txtProcName.ClientID %>').val($('#<%=cboProc.ClientID %> option:selected').text());
            }
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="vertical-align: top">
                    <asp:TextBox ID="txtResult" runat="server" ReadOnly="true" TextMode="MultiLine" Rows="30"
                        Width="100%" />
                </td>
                <td style="vertical-align: top">
                    <asp:TextBox ID="txtBusinessLayer" runat="server" ReadOnly="true" TextMode="MultiLine"
                        Rows="30" Width="100%" />
                </td>
            </tr>
        </table>
