<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPEntry.master" AutoEventWireup="true" 
    CodeBehind="DataMigrationConfigurationEntry.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Tools.DataMigrationConfigurationEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <div class="pageTitle"><%=GetLabel("Data Migration")%></div>
