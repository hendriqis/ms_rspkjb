<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedicalSummaryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.MedicalSummaryCtl" %>
                    ...
                    <div id="divPage12" class="w3-border divContent w3-animate-left">
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButtonList ID="rblItemTypeImagingTab" runat="server" RepeatDirection="Horizontal"
                                        RepeatLayout="Table">
                                        <asp:ListItem Text=" Semua" Value="0" Selected="True" />
                                        <asp:ListItem Text=" Kunjungan/Perawatan saat ini " Value="1" />
                                    </asp:RadioButtonList>
    ...
    $(function () {
        ...
        $('.btnViewer').live('click', function () {
            ...
            if (postData != '' && postData != '&nbsp;') {
                ...
                else if ($('#<%=hdnRISVendorImaging.ClientID %>').val() == "X081^02") {
                    var viewerUrl = $(this).closest('tr').find('.imageViewerLinkUrl').html();
                    if (viewerUrl == '&nbsp;') {
        ...
        $('#<%=rblItemTypeImagingTab.ClientID %> input').change(function () {
        ...
        $('.btnViewLaboratoryReport').live('click', function () {
            ...
            var reportCode = $('#<%=hdnReportCodeLabResult.ClientID %>').val();
