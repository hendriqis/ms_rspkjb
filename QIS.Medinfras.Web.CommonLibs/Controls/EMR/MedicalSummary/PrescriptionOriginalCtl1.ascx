<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionOriginalCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.PrescriptionOriginalCtl1" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%;margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                ...
                                OnRowDataBound="grdView_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PrescriptionOrderID" HeaderStyle-CssClass="hiddenColumn prescriptionOrderID" ItemStyle-CssClass="hiddenColumn" />
                                    ...
                                    <EmptyDataTemplate>
                                        <%=GetLabel("Tidak ada informasi pelayanan resep untuk pasien")%>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </asp:Panel>
                        </dx:PanelContent>
                            ...
                            <dx:PanelContent ID="PanelContent2" runat="server">
                                <asp:Panel runat="server" ID="Panel1" CssClass="pnlContainerGridPatientPage">
                                    <asp:GridView ID="grdPopupViewDt" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                        ...
                                        <EmptyDataTemplate>
                                            <%=GetLabel("Tidak ada informasi log pengiriman resep untuk pasien ini")%>
                                        </EmptyDataTemplate>
                                    </asp:GridView>
                                </asp:Panel>
                            </dx:PanelContent>
