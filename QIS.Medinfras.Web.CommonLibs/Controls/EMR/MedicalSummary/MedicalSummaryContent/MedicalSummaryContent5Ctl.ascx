<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedicalSummaryContent5Ctl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.MedicalSummaryContent5Ctl" %>
...
<div class="w3-border divContent w3-animate-left">
    <table style="margin-top:10px; width:100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="3">
                <center>
	                <h2 class="w3-blue" style="text-shadow:1px 1px 0 #444"><%=GetLabel("PAGE CONTENT #5")%></h2>     
                </center>            
            </td>
        </tr>
        <tr>
