<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedicalSummaryContent1Ctl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.MedicalSummaryContent1Ctl" %>
