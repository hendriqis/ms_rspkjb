<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewPreProcedureAssesmentCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.ViewPreProcedureAssesmentCtl1" %>
...
<script type="text/javascript" id="dxss_viewPreOpAssessmentCtl1">
    $(function () {
        ...
        $('#<%=divFormContent1.ClientID %>').html($('#<%=hdnDiagnosticTestLayout.ClientID %>').val());
        if ($('#<%=hdnDiagnosticTestValue.ClientID %>').val() != '') {
            var oldData = $('#<%=hdnDiagnosticTestValue.ClientID %>').val().split(';');
        ...
        //#region Kelengkapan Berkas/Dokumen
        $('#<%=divFormContent2.ClientID %>').html($('#<%=hdnDocumentChecklistLayout.ClientID %>').val());
    ...
    $(function () {
        ...
        $(function () {
            setPaging($("#rosPaging"), parseInt('<%=gridROSPageCount %>'), function (page) {
...
<div style="width:100%;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
        ...
        <tr>
            ...
            <td>
               <div id="lblTitle" runat="server" class="w3-blue-grey w3-xxlarge" style="text-align:center; text-shadow:1px 1px 0 #444"><%=GetLabel("ASESMEN PRA TINDAKAN")%></div>
            </td>
        </tr>
        <tr>
            <td style="vertical-align:top">
                <div id="leftPanel" class="w3-border">
                    <ul>
                        ...
                        <li contentID="divPage2" title="Anamnesis dan Riwayat Kesehatan" class="w3-hover-red">Anamnesis dan Riwayat Kesehatan</li>
                        ...
                        <li contentID="divPage6" title="Hasil Pemeriksaan Penunjang" class="w3-hover-red">Hasil Pemeriksaan Penunjang</li>
                        <li contentID="divPage7" title="Kelengkapan Berkas/Dokumen Terkait" class="w3-hover-red">Kelengkapan Berkas/Dokumen Terkait</li>
            ...
            <td style="vertical-align:top; padding-left: 5px;">
                            ...
                            <td>
                                <table border = "0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdLabel" style="vertical-align:top">:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="tdLabel"><label id="lblOrderNo"><%:GetLabel("Nomor Transaksi")%></label></td>
                                        <td class="tdLabel">:</td>
                                        <td>
                                             <span ID="lblTransactionNo" runat="server" style="color:Black" />
                                        </td>
                                    </tr> 
                                    <tr>
                                        <td class="tdLabel" style="vertical-align:top"><%:GetLabel("Tindakan")%></td>
                                        <td class="tdLabel" style="vertical-align:top">:</td>
                                        <td>
                                            <span ID="lblItemName" runat="server" style="width:100%;color:Black" />
                                        </td>
                                    </tr>                                                                                                                                                                                                                                                                                           
                                </table>
                            </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td style="vertical-align:top">
                                    ...
                                    <div style="max-height: 300px; overflow-y: auto; padding: 5px 0px 5px 0px">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 99%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtAssessmentText" Width="100%" runat="server" TextMode="MultiLine"
                                ...
                                <h4 class="w3-blue h4collapsed">
                                    <%=GetLabel("Riwayat Tindakan Sebelumnya")%></h4>
                                <div class="containerTblEntryContent">
                                    <div style="max-height:220px;overflow-y:auto; padding : 5px 0px 5px 0px">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width:99%">
                                            <colgroup>
                ...
                <div id="divPage6" class="divContent w3-animate-left" style="display:none">
                   <table border="0" cellpadding="1" cellspacing="0" style="width:100%">
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="hidden" runat="server" id="hdnDiagnosticTestLayout" value="" />
                                <input type="hidden" runat="server" id="hdnDiagnosticTestValue" value="" />
                                <div id="divFormContent1" runat="server" style="min-height: 300px; height: 300px;
                ...
                <div id="divPage7" class="divContent w3-animate-left" style="display:none">
                    ...
                    <div id="divFormContent2" runat="server" style="min-height:490px; height: 490px;overflow-y: auto;overflow-x: auto;"></div>
                </div>   
