<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewProcedureAnesthesyStatusCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.ViewProcedureAnesthesyStatusCtl1" %>
...
<style type="text/css">
    ...
    .regionalAnesthesyformContainer 
    {
        flex: 1;
        overflow-x: scroll;
        max-width:1200px;
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
        ...
        <tr>
            ...
            <td style="vertical-align: top; padding-left: 5px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table border="0" cellpadding="1" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="txtTransactionNo" Width="150px" runat="server" Enabled="false" ReadOnly="true" />
                                                            </td>
                                                            <td class="tdLabel">
                                                            </td>
                                                            <td>
                ...
                <div id="divPage10" class="w3-border divContent w3-animate-left regionalAnesthesyformContainer" style="display:none">
                    <table class="tblContentArea">
                        <colgroup>
                            <col width="200px" />
                            <col />
