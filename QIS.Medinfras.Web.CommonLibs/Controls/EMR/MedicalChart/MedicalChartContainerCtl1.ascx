<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedicalChartContainerCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.MedicalChartContainerCtl1" %>
...
<div style="clear:both;width:100%; height:100%; padding:5px;" class="borderBox" id="containerEpisodeSummaryMedicalChartCtn">
    <div id="episodeSummaryChart" style="height:300px;width:450px;border:1px solid;float:left;" class="boxShadow"></div> 
