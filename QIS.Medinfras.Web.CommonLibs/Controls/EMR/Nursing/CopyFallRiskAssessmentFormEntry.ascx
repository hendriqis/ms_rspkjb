<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyFallRiskAssessmentFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CopyFallRiskAssessmentFormEntry" %>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTotalScore" Width="120px" CssClass="numeric" runat="server" />
                        </td>
                        <td>
