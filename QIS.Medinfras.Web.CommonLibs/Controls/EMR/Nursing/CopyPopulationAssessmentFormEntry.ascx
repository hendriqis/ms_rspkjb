<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyPopulationAssessmentFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CopyPopulationAssessmentFormEntry" %>
...
<script type="text/javascript" id="dxss_copypopulationassessmentformentryctl">
