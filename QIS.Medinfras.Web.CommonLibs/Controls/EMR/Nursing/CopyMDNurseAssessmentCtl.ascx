<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyMDNurseAssessmentCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.CopyMDNurseAssessmentCtl" %>
