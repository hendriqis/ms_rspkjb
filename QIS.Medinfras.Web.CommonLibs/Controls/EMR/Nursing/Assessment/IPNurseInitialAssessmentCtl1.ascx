<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IPNurseInitialAssessmentCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.IPNurseInitialAssessmentCtl1" %>
...
<script type="text/javascript" id="dxss_nurseInitialAssessmentctl1">
    $(function () {
        ...
        //#region Kebutuhan Informasi dan Edukasi
    ...
    $('.lnkView a').live('click', function () {
        var formTypeName = $(this).closest('tr').find('.formTypeName').html();
        var date = $(this).closest('tr').find('.assessmentDate').html();
        var ppa = $(this).closest('tr').find('.paramedicName').html();
        var layout = $(this).closest('tr').find('.formLayout').html();
        var values = $(this).closest('tr').find('.formValue').html();

        $('#<%=hdnPopupAssessmentLayout.ClientID %>').val(layout);
        $('#<%=hdnPopupAssessmentValue.ClientID %>').val(values);
        pcPopulationAssessment.SetHeaderText("Pengkajian Populasi Khusus : " + formTypeName);
        pcPopulationAssessment.Show();
    });
    ...
    function onPcPopulationAssessmentShown() {
    }

    function onPcPopulationAssessmentPopup() {
        var formContent = $('#<%=hdnPopupAssessmentLayout.ClientID %>').val();
        ...
        OnLoadPopulationAssessmentContent();
    }

    function OnLoadPopulationAssessmentContent() {
        if ($('#<%=hdnPopupAssessmentValue.ClientID %>').val() != '') {
            var oldData = $('#<%=hdnPopupAssessmentValue.ClientID %>').val().split(';');
            for (var i = 0; i < oldData.length; ++i) {
                var temp = oldData[i].split('=');
...
<div style="width: 100%;">
    ...
    <input type="hidden" id="hdnVisitIDPopUpCtl" runat="server" value='0' />
        ...
        <tr>
            ...
            <td>
                <div id="lblTitle" runat="server" class="w3-blue-grey w3-xxlarge" style="text-align: center;
                    ...
                    <%=GetLabel("PENGKAJIAN AWAL PASIEN (PERAWAT)")%></div>
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top">
                <div id="leftPanel" class="w3-border">
                    <ul>
                        ...
                        <li contentid="divPage6" title="Psikososial Spiritual dan Kultural" class="w3-hover-red">
                            Psikososial Spiritual dan Kultural</li>
                        <li contentid="divPage7" title="Kebutuhan Informasi dan Edukasi" class="w3-hover-red">
                            Kebutuhan Informasi dan Edukasi</li>
                        <li contentid="divPage8" title="Perencanaan Pemulangan Pasien" class="w3-hover-red">
                            Perencanaan Pemulangan Pasien</li>
                        ...
                        <li contentid="divPage11" title="Kebutuhan Informasi dan Edukasi" class="w3-hover-red"
                            style="display: none"></li>
                        <li contentid="divPage12" title="Asesmen Tambahan (Populasi Khusus)" class="w3-hover-red"
                            style="display: none"></li>
                    </ul>
                </div>
                <div>
            ...
            <td style="vertical-align: top; padding-left: 5px;">
                                    ...
                                    <div style="max-height: 220px; overflow-y: auto; padding: 5px 0px 5px 0px">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 99%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtFamilyHistory" Width="100%" runat="server" TextMode="MultiLine"
                                                        Rows="5" ReadOnly="true" />
                                                </td>
                                            </tr>
                                        </table>
                ...
                <div id="divPage6" class="divContent w3-animate-left" style="display: none">
                    ...
                    <fieldset disabled style="min-height: 490px; height: 490px; overflow-y: scroll; overflow-x: auto;">
                        <div id="divFormContent2" runat="server">
                        </div>
                    </fieldset>
                </div>
                ...
                <div id="divPage12" class="divContent w3-animate-left" style="display: none">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <colgroup>
                            <col />
                        </colgroup>
...
<dxpc:ASPxPopupControl ID="pcPopulationAssessment" runat="server" ClientInstanceName="pcPopulationAssessment"
    CloseAction="CloseButton" Height="300px" HeaderText="Pengkajian Populasi Khusus :"
    Width="600px" Modal="True" PopupAction="None" PopupHorizontalAlign="WindowCenter"
    PopupVerticalAlign="WindowCenter">
    <ClientSideEvents PopUp="function (s,e) { onPcPopulationAssessmentPopup();}" />
    <ContentCollection>
        <dxpc:PopupControlContentControl runat="server" ID="pccc2">
            <dxcp:ASPxCallbackPanel ID="cbpPopulationAssessmentContent" runat="server" Width="100%"
                ClientInstanceName="cbpPopulationAssessmentContent" ShowLoadingPanel="false">
                <PanelCollection>
