<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewFallRiskAssessmentCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewFallRiskAssessmentCtl" %>
...
<div style="height: auto">
    ...
    <table class="tblContentArea" border="0">
        <tr>
            <td>
                <div id="divFormContent" runat="server" style="max-height: 400px;overflow-y: auto;"></div>
            </td>
        </tr>
    </table>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTotalScore" Width="120px" CssClass="numeric" runat="server" ReadOnly="true" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtTotalScoreType" Width="100%" runat="server" ReadOnly=true />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                        ...
                        <td colspan="2">
                            <dxe:ASPxComboBox ID="cboFallRiskScoreType" ClientInstanceName="cboFallRiskScoreType" Width="350px" runat="server" Enabled="false" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                        ...
                        <td colspan="2">
                            <asp:CheckBox ID="chkIsFallRisk" runat="server" Text=" Penanda Resiko Jatuh" Enabled="false" />
                        </td>
                    </tr>
