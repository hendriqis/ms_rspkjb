<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MDNurseInitialAssessmentCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.MDNurseInitialAssessmentCtl1" %>
...
<div style="width:100%;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
        ...
        <tr>
            ...
            <td>
               <div id="lblTitle" runat="server" class="w3-blue-grey w3-xxlarge" style="text-align:center; text-shadow:1px 1px 0 #444"><%=GetLabel("ASESMEN AWAL PENUNJANG MEDIS")%></div>
            </td>
        </tr>
        <tr>
...
<%--                        <li contentID="divPage5" title="Body Diagram" class="w3-hover-red">Body Diagram</li>--%>
                        <li contentID="divPage6" title="Psikososial Spiritual dan Kultural" class="w3-hover-red">Psikososial Spiritual dan Kultural</li>
                        ...
                        <tr>
                            ...
                            <td>
                                <table border = "0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="tdLabel" style="vertical-align:top"><%=GetLabel("Unit Penunjang Medis")%></td>
                                        <td class="tdLabel" style="vertical-align:top"><%=GetLabel(":")%></td>
                                        <td>
                                            <td><span id="lblHealthcareServiceUnitName" runat="server" style="color:Black"></span></td>
                                        </td>
                                    </tr>                                            
                                    <tr>
