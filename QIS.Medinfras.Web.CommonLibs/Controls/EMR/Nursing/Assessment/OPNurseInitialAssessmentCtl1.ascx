<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OPNurseInitialAssessmentCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.OPNurseInitialAssessmentCtl1" %>
