<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ERNurseInitialAssessmentCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.ERNurseInitialAssessmentCtl1" %>
        ...
        <tr>
            ...
            <td>
                <div id="lblTitle" runat="server" class="w3-blue-grey w3-xxlarge" style="text-align: center;
                    ...
                    <%=GetLabel("ASESMEN AWAL PASIEN (PERAWAT)")%></div>
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top">
                <div id="leftPanel" class="w3-border">
                    <ul>
                        ...
                        <li contentid="divPage2" title="Keluhan Utama Pasien" class="w3-hover-red">Keluhan Utama
                            Pasien</li>
                        <li contentid="divPage3" title="Triase & Survey Primer" class="w3-hover-red">Triase
                            & Survey Primer</li>
                        ...
                        <li contentid="divPage5" title="Riwayat Penggunaan Obat" class="w3-hover-red">Riwayat
                            Penggunaan Obat</li>
                        <li contentid="divPage6" title="Ketergantungan Fungsional" class="w3-hover-red">Ketergantungan
                            Fungsional</li>
                        <li contentid="divPage7" title="Psikososial Spiritual dan Kultural" class="w3-hover-red">
                            Psikososial Spiritual dan Kultural</li>
                        <li contentid="divPage8" title="Kebutuhan Informasi dan Edukasi" class="w3-hover-red">
                            Kebutuhan Informasi dan Edukasi</li>
                        <li contentid="divPage9" title="Asesmen Tambahan (Populasi Khusus)" class="w3-hover-red">
                            Asesmen Tambahan (Populasi Khusus)</li>
                        <li contentid="divPage10" title="Masalah Keperawatan" class="w3-hover-red">Masalah Keperawatan</li>
                        <li contentid="divPage11" title="Catatan Planning" class="w3-hover-red">Catatan Planning</li>
                        <li contentid="divPage12" title="Catatan Instruksi" class="w3-hover-red">Catatan Instruksi</li>
                        <%--comment--%>
                        <li contentid="divPage13" title="Pemeriksaan Fisik" class="w3-hover-red" style="display: none">
                            Pemeriksaan Fisik</li>
                        <li contentid="divPage14" title="Tanda Vital dan Indikator Lainnya" class="w3-hover-red"
                            style="display: none">Tanda Vital dan Indikator Lainnya</li>
                        <li contentid="divPage15" title="Body Diagram" class="w3-hover-red" style="display: none">
                            Body Diagram</li>
                        <li contentid="divPage16" title="Alergi & Diagnosa" class="w3-hover-red" style="display: none">
                            Alergi & Diagnosa</li>
                        <li contentid="divPage17" title="Tanda Vital dan Indikator Lainnya" class="w3-hover-red"
                            style="display: none"></li>
                        <li contentid="divPage18" title="Body Diagram" class="w3-hover-red" style="display: none">
                        </li>
                        <li contentid="divPage19" title="Pemeriksaan Fisik" class="w3-hover-red" style="display: none">
                        </li>
                        <li contentid="divPage20" title="Tanda Vital dan Indikator Lainnya" class="w3-hover-red"
                            style="display: none"></li>
                    </ul>
                </div>
                <div>
                    <table class="w3-table-all" style="width: 100%">
                        ...
                        <tr>
                            <td style="text-align: left" class="w3-blue-grey">
                                <div class="w3-small">
                                    <%=GetLabel("Diverifikasi Oleh : PPJA")%></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left">
                                <div id="lblPrimaryNurseName" runat="server" class="w3-medium">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left" class="w3-blue-grey">
                                <div class="w3-small">
                                    <%=GetLabel("Diverifikasi Oleh : DPJP")%></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left">
            ...
            <td style="vertical-align: top; padding-left: 5px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkAlloAnamnesis" runat="server" Text="Alloanamnesis" Checked="false"
                                            Enabled="false" />
                                    </td>
                        ...
                        <tr style="display: none">
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtDiagnose" runat="server" Width="100%" ReadOnly="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboVisitReason" ClientInstanceName="cboVisitReason"
                                    Width="100%" ReadOnly="true" />
                                <asp:TextBox ID="txtVisitNotes" Width="100%" runat="server" ReadOnly="true" />
                            </td>
                        </tr>
                    </table>
                </div>
                                ...
                                <div style="max-height: 300px; overflow-y: auto; padding: 5px 0px 5px 0px">
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 99%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtEmergencyCaseDate" Width="120px" CssClass="datepicker" runat="server"
                                                    ReadOnly="true" />
                                                <asp:TextBox ID="txtEmergencyCaseTime" Width="80px" runat="server" CssClass="time"
                                                    ReadOnly="true" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtRegistrationDate" Width="120px" CssClass="datepicker" runat="server"
                                                    ReadOnly="true" />
                                                <asp:TextBox ID="txtRegistrationTime" Width="80px" CssClass="time" runat="server"
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <%=GetLabel("Waktu Triage")%></label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtTriageDate" Width="120px" CssClass="datepicker" runat="server"
                                                    ReadOnly="true" />
                                                <asp:TextBox ID="txtTriageTime" Width="80px" CssClass="time" runat="server"
                                                    Style="text-align: center" ReadOnly="true" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTriageByParamedicName" Width="100%" runat="server" ReadOnly="true" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tdLabel">
                ...
                <div id="divPage4" class="w3-border divContent w3-animate-left" style="display: none">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMedicalHistory" Width="100%" runat="server" TextMode="MultiLine"
                ...
                <div id="divPage5" class="w3-border divContent w3-animate-left" style="display: none">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMedicationHistory" Width="100%" runat="server" TextMode="MultiLine"
                                    Rows="2" ReadOnly="true" />
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="rblFamilyRelationship" CssClass="rblFamilyRelationship"
                                    runat="server" RepeatDirection="Horizontal" CellPadding="10" ReadOnly="true">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="rblIsNeedAdditionalPrivacy" CssClass="rblIsNeedAdditionalPrivacy"
                                    runat="server" RepeatDirection="Horizontal" CellPadding="14" ReadOnly="true">
                ...
                <div id="divPage8" class="w3-border divContent w3-animate-left" style="display: none">
                    <div>
                        <dxcp:ASPxCallbackPanel ID="cbpPatientEducationView" runat="server" Width="100%"
                            ClientInstanceName="cbpPatientEducationView" ShowLoadingPanel="false" OnCallback="cbpPatientEducationView_Callback">
                        ...
                        <tr>
                            ...
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtRAPUHScore" runat="server" Width="50%" CssClass="number" ReadOnly="true" />
                                        </td>
                                        <td class="tdLabel">
                                            <label class="lblNormal">
                ...
                <div id="divPage11" class="w3-border divContent w3-animate-left" style="display: none">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <colgroup>
                            <col width="20%" />
                            <col width="80%" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPlanningNotes" Width="100%" runat="server" TextMode="MultiLine"
                                    Rows="3" ReadOnly="true" />
                            </td>
                        </tr>
                    </table>
                </div>
                <div id="divPage12" class="w3-border divContent w3-animate-left" style="display: none">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <colgroup>
                            <col width="20%" />
                            <col width="80%" />
                ...
                <%--comment--%>
                <div id="divPage13" class="w3-border divContent w3-animate-left" style="display: none">
                    <div>
                ...
                <div id="divPage14" class="w3-border divContent w3-animate-left" style="display: none">
                    <div>
                ...
                <div id="divPage15" class="w3-border divContent w3-animate-left" style="display: none">
                ...
                <div id="divPage16" class="divContent w3-animate-left" style="display: none">
                    ...
                    <div class="containerTblEntryContent">
                        <div style="max-height: 450px; overflow-y: auto; padding: 5px 0px 5px 0px">
                            <table border="0" cellpadding="1" cellspacing="0" width="100%" style="margin-top: 2px">
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chkIsPatientAllergyExists2" runat="server" Text="Tidak ada Alergi"
                                            Checked="false" Enabled="false" />
                                    </td>
                                </tr>
                                <tr>
                ...
                <div id="divPage17" class="divContent w3-animate-left" style="display: none">
                ...
                <div id="divPage18" class="divContent w3-animate-left" style="display: none">
                ...
                <div id="divPage19" class="w3-border divContent w3-animate-left" style="display: none">
                ...
                <div id="divPage20" class="divContent w3-animate-left" style="display: none">
