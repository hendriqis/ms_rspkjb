...
{
    public partial class OPNurseInitialAssessmentCtl1 : BaseViewPopupCtl
    {
        ...
        protected void cbpBodyDiagramView_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter == "refresh")
            {
                ...
                filterExpression = string.Format("VisitID = {0} AND IsDeleted = 0", hdnVisitIDCtl.Value);
        ...
        {
            string filterExpression = string.Format("VisitID = {0} AND IsDeleted = 0", hdnVisitIDCtl.Value);
