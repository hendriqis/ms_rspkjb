<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyPainAssessmentFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CopyPainAssessmentFormEntry" %>
...
<script type="text/javascript" id="dxss_copyPainAssessmentCtl">
