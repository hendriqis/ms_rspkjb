...
{
    public partial class CopyPainAssessmentFormEntry : BasePagePatientPageEntryCtl
    {
        ...
        private void SetControlProperties(string[] paramInfo)
        {
            ...
            cboProvocation.Value = paramInfo[10];
            txtProvocation.Text = paramInfo[11].Replace("&nbsp;", "");
            cboQuality.Value = paramInfo[12];
            txtQuality.Text = paramInfo[13].Replace("&nbsp;", "");
            cboRegio.Value = paramInfo[14];
            txtRegio.Text = paramInfo[15].Replace("&nbsp;", "");
            cboTime.Value = paramInfo[16];
            ...
            if (paramInfo.Length >= 22)
            {
                string[] patientInfo = paramInfo[22].Split('|');
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(cboRegio, new ControlEntrySetting(true, true, false));
