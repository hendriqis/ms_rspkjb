<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyEWSAssessmentFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CopyEWSAssessmentFormEntry" %>
...
<script type="text/javascript" id="dxss_copyFallRiskAssessmentEntryctl">
