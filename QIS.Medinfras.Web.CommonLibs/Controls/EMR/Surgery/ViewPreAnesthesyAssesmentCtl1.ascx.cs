...
{
    public partial class ViewPreAnesthesyAssesmentCtl1 : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            string filterExp = string.Format("VisitID = {0} AND TestOrderID = {1} AND PreAnesthesyAssessmentID = {2} AND IsDeleted = 0 ORDER BY PreAnesthesyAssessmentID DESC", visitID, testOrderID, assessmentID);
