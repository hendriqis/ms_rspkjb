<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewAssesmentPreOpCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.ViewAssesmentPreOpCtl1" %>
...
<div style="width:100%;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
        ...
        <tr>
            ...
            <td>
               <div id="lblTitle" runat="server" class="w3-blue-grey w3-xxlarge" style="text-align:center; text-shadow:1px 1px 0 #444"><%=GetLabel("ASESMEN PRA BEDAH")%></div>
            </td>
        </tr>
        <tr>
            <td style="vertical-align:top">
                <div id="leftPanel" class="w3-border">
                    <ul>
                        ...
                        <li contentID="divPage8" title="Penandaan Lokasi Operasi" class="w3-hover-red">Penandaan Lokasi Operasi</li>
                        <li contentID="divPage9" title="Analisis" class="w3-hover-red">Analisis</li>
                        <li contentID="divPage10" title="Jenis Tindakan Operasi" class="w3-hover-red">Jenis Tindakan Operasi</li>
                    </ul>     
                </div> 
                <div>
