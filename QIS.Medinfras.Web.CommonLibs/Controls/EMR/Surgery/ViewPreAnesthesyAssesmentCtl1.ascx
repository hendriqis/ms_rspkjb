<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewPreAnesthesyAssesmentCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.ViewPreAnesthesyAssesmentCtl1" %>
