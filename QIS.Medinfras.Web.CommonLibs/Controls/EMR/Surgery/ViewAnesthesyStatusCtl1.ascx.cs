...
{
    public partial class ViewAnesthesyStatusCtl1 : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            string filterExp = string.Format("VisitID = {0} AND TestOrderID = {1} AND AnesthesyStatusID = {2} AND IsDeleted = 0 ORDER BY AnesthesyStatusID DESC", hdnVisitID.Value, hdnTestOrderID.Value, hdnAnesthesyStatusID.Value);
            ...
            if (obj != null)
            {
                ...
                vPreAnesthesyAssessment objPreAnesthesy = BusinessLayer.GetvPreAnesthesyAssessmentList(string.Format("VisitID = {0} AND TestOrderID  = {1} AND IsDeleted = 0", AppSession.RegisteredPatient.VisitID, hdnTestOrderID.Value)).FirstOrDefault();
