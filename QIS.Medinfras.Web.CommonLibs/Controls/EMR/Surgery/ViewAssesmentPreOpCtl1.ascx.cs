...
{
    public partial class ViewAssesmentPreOpCtl1 : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            string filterExp = string.Format("VisitID = {0} AND TestOrderID = {1} AND PreSurgicalAssessmentID = {2} AND IsDeleted = 0 ORDER BY PreSurgicalAssessmentID DESC", visitID, testOrderID, assessmentID);
        ...
        protected void cbpBodyDiagramView_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter == "refresh")
            {
                ...
                filterExpression = string.Format("VisitID = {0} AND TestOrderID = {1} AND IsDeleted = 0", visitID, testOrderID);
        ...
        {
            string filterExpression = "";
            filterExpression = string.Format("VisitID = {0} AND TestOrderID = {1} AND IsDeleted = 0", hdnVisitID.Value, hdnTestOrderID.Value);
