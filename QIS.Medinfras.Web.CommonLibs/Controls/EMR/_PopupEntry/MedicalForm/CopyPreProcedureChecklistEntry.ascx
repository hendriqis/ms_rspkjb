<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyPreProcedureChecklistEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CopyPreProcedureChecklistEntry" %>
