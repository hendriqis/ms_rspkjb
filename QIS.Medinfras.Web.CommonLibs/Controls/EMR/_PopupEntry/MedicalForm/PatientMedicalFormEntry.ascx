<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientMedicalFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientMedicalFormEntry" %>
