<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HSUFluidBalanceOutputEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.HSUFluidBalanceOutputEntry" %>
...
<script type="text/javascript" id="dxss_HSUFluidBalanceOutputEntry">
