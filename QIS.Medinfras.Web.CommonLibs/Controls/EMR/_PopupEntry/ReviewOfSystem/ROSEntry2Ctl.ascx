<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ROSEntry2Ctl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ROSEntry2Ctl" %>
<script type="text/javascript" id="dxss_rosentry2ctl">
...
<div>
    ...
    <input type="hidden" runat="server" id="hdnLinkAssessmentID" value="0" />
