...
{
    public partial class ROSEntry2Ctl : BasePagePatientPageEntryCtl
    {
        public override void InitializeDataControl(string param)
        {
            ...
            if (paramInfo.Length >= 4)
            {
                ...
                {
                    hdnLinkMedicalResumeID.Value = paramInfo[5];
                }
                if (paramInfo.Length >= 6)
                {
                    hdnLinkAssessmentID.Value = paramInfo[6];
                }
            }
            else
            {
        ...
        private void ControlToEntity(ReviewOfSystemHd entity, List<ReviewOfSystemDt> lstEntityDt)
        {
            ...
            if (hdnLinkAssessmentID.Value != "0" && hdnLinkAssessmentID.Value != "" && hdnLinkAssessmentID.Value != null)
            {
                entity.NurseAssessmentID = Convert.ToInt32(hdnLinkAssessmentID.Value);
            }
            else
            {
                entity.NurseAssessmentID = null;
            }
