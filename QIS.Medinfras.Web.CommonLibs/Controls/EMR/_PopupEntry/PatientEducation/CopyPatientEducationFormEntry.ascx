<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyPatientEducationFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CopyPatientEducationFormEntry" %>
...
<script type="text/javascript" id="dxss_copyPatientEducationEntryctl">
