...
{
    public partial class VerifySurgicalSafetyChecklistCtl1 : BaseProcessPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            if (hdnLookupTestOrderID.Value != "0")
            {
                //hdnLookupVisitID.Value = paramInfo[3];
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            string filterExpression = string.Format("VisitID = {0} AND TestOrderID = {1} AND IsDeleted = 0", hdnLookupVisitID.Value, hdnLookupTestOrderID.Value);
