...
{
    public partial class AddAnesthesyMedicationCtl1 : BaseEntryPopupCtl
    {
        public override void InitializeDataControl(string param)
        {
            ...
            {
                IsAdd = false;
                vAnesthesyMedicationLog entity = BusinessLayer.GetvAnesthesyMedicationLogList(string.Format("ID = {0}", hdnPopupID.Value)).FirstOrDefault();
                if (entity != null)
                {
        ...
        private void SetEntityToControl(vAnesthesyMedicationLog entity)
        {
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retVal)
        {
            ...
            AnesthesyMedicationLogDao entityDao = new AnesthesyMedicationLogDao(ctx);
            try
            {
                if (IsValid(ref errMessage))
                {
                    AnesthesyMedicationLog entity = new AnesthesyMedicationLog();
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retVal)
        {
            ...
            try
            {
                if (IsValid(ref errMessage))
                {
                    AnesthesyMedicationLog entity = entityDao.Get(Convert.ToInt32(hdnPopupID.Value));
                    ControlToEntity(entity);
        ...
        private void ControlToEntity(AnesthesyMedicationLog oMedication)
        {
