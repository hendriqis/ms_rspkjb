<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PartografMedicationEntryCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PartografMedicationEntryCtl1" %>
...
<input type="hidden" runat="server" id="hdnPopupAntenatalRecordID" value="" />
