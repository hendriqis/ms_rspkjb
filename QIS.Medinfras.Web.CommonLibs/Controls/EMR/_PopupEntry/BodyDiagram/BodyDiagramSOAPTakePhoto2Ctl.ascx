<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BodyDiagramSOAPTakePhoto2Ctl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.BodyDiagramSOAPTakePhoto2Ctl" %>
