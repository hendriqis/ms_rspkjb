<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BodyDiagramSOAPTakePhoto1Ctl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.BodyDiagramSOAPTakePhoto1Ctl" %>
...
<script id="dxss_webcamctl" type="text/javascript">
    ...
    window.handleUpload = function () {
        if ($("#fc").is(":visible")) {
            ...
            webcam.upload('<%= ResolveUrl("~/libs/Controls/EMR/_PopupEntry/BodyDiagram/BodyDiagramUploadWebcam.aspx")%>', function () {
