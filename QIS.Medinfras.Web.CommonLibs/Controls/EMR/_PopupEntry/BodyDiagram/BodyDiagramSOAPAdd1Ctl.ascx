<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BodyDiagramSOAPAdd1Ctl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPage.BodyDiagramSOAPAdd1Ctl" %>
...
<%@ Register Src="~/libs/Controls/EMR/_PopupEntry/BodyDiagram/BodyDiagramSOAPTakePhoto1Ctl.ascx"
        ...
        if ($("#<%=txtObservationTime.ClientID %>").valid()) {
            ...
            $("#containerApplied .content").each(function () {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: url,
                    data: '{ "observationDate" : "' + observationDate + '", "observationTime" : "' + observationTime + '", "imageData" : "' + image + '", "idx" : "' + idxImage++ + '", "listSymbol" : "' + $(this).find('.listImageSymbol').val() + '", "customSrc" : "' + customSrc + '", "paramedicID" : "' + paramedicID + '", "testOrderID" : "' + testOrderID + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    error: function (msg) {
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="5">
                                <tr>
                                    ...
                                    <td><dxe:ASPxComboBox ID="cboParamedicID" ClientInstanceName="cboParamedicID" Width="250px" runat="server" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
...
<div class="container" style="height:530px">
    ...
    <div class="contentFooter">
        <table cellpadding="0" cellspacing="10" style="margin-left:auto;margin-right:auto;text-align:left">
            <tr>
                <td>
                    <input type="button" value='<%= GetLabel("FREE ANNOTATION")%>'
                        id="btnFreeAnnotation" style="width: 125px;height:25px"" />
                </td>
                <td>
                    <input type="button" value='<%= GetLabel("FREE DRAWING")%>'
                        id="btnFreeDrawing" style="width: 120px;height:25px"" />
                </td>
                <td><input type="button" value='<%= GetLabel("PHOTO")%>' onclick="pcTakePhoto.Show();" style="width:80px; height:25px" /></td>
                <td><input type="button" value='<%= GetLabel("RESET")%>' id="btnReset" style="width:80px; height:25px" /></td>
                <td><input type="button" value='<%= GetLabel("APPLY")%>' id="btnApply" style="width:80px; height:25px" /></td>
                <td><input type="button" value='<%= GetLabel("SAVE")%>' id="btnSave"  style="width:80px; height:25px"/></td>
                <td><input type="button" value='<%= GetLabel("CANCEL")%>' id="btnCancel" style="width:80px; height:25px" /></td>
            </tr>
        </table>
    </div>    
</div> 
...
<dx:ASPxPopupControl ID="pcTakePhoto" runat="server" ClientInstanceName="pcTakePhoto"
    EnableHierarchyRecreation="True" FooterText="" HeaderText="MEDINFRAS : PHOTO CAPTURE" HeaderStyle-HorizontalAlign="Left" Height="400px"
