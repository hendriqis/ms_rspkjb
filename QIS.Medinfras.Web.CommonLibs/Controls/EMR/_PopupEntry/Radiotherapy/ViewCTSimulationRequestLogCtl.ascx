<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCTSimulationRequestLogCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewCTSimulationRequestLogCtl" %>
...
<div style="height: auto">
    ...
    <input type="hidden" runat="server" id="hdnPopupRequestID" value="" />
        ...
        <tr>
            <td style="vertical-align: top">
                <div id="leftPageNavPanel" class="w3-border">
                    <ul>
                        <li contentid="divPage1" title="Informasi Simulasi" class="w3-hover-red">Informasi Simulasi</li>
                ...
                <div id="divPage1" class="w3-border divPageNavPanelContent w3-animate-left" style="display: none">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel" valign="top">
                                <label class="lblMandatory">
                                    <%=GetLabel("Tanggal Simulasi")%></label>
                            </td>
                            <td>
                                <table border="0" cellpadding="1" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtProgramDate" Width="120px" runat="server" Enabled="False" />
                                        </td>
                                        <td>
                        ...
                        <tr style="display:none">
                            ...
                            <td>
                                <asp:TextBox ID="txtStagingInfo" Width="100%" runat="server" ReadOnly="True"
                                    Style="text-align: left" />
                            </td>                         
                        </tr>
                        <tr>
                            <td class="tdLabel" style="vertical-align:top">
                                <label class="lblMandatory">
                                    <%=GetLabel("Orientasi Posisi")%></label>
                            </td>
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCOrientation" ClientInstanceName="cboGCOrientation"
                                    Width="50%" ToolTip="Orientasi Posisi" Enabled="False">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <label class="lblMandatory">
                                    <%=GetLabel("Posisi Pasien")%></label>
                            </td>
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCPatientPosition" ClientInstanceName="cboGCPatientPosition"
                                    Width="50%" ToolTip="Scan Area" Enabled="False">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel" style="vertical-align:top">
                                <label class="lblMandatory">
                                    <%=GetLabel("Posisi Tangan")%></label>
                            </td>
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCHandPosition" ClientInstanceName="cboGCHandPosition"
                                    Width="50%" ToolTip="Posisi Tangan" Enabled="False">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel" style="vertical-align:top">
                                <label class="lblMandatory">
                                    <%=GetLabel("Alat Bantu Imobilisasi")%></label>
                            </td>
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCImmobilizationTool" ClientInstanceName="cboGCImmobilizationTool"
                                    Width="50%" ToolTip="Alat Bantu Imobilisasi" Enabled="False">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <label class="lblMandatory">
                                    <%=GetLabel("Foto Posisi Pasien")%></label>                            
                            </td>
                            <td>
                                <asp:RadioButtonList ID="rblIsHasPatientPositionImage" runat="server" RepeatDirection="Horizontal" Enabled="False">
                                    <asp:ListItem Text=" Sudah" Value="1" />
                                    <asp:ListItem Text=" Belum" Value="0"  />
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                    </table>
