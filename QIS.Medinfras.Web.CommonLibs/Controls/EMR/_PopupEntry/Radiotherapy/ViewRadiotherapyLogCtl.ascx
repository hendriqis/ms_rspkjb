<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewRadiotherapyLogCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewRadiotherapyLogCtl" %>
            ...
            <td>
                <table style="width: 100%" id="tblEntryContent">
                    ...
                    <tr>
                        ...
                        <td colspan="2"> 
                            <dxe:ASPxComboBox runat="server" ID="cboGCBeamUnit" ClientInstanceName="cboGCBeamUnit"
                                Width="50%" ToolTip="Unit Rad" Enabled="False">
                            </dxe:ASPxComboBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2"> 
                            <dxe:ASPxComboBox runat="server" ID="cboGCAccess" ClientInstanceName="cboGCAccess"
                                Width="50%" ToolTip="Access" Enabled="False">
                            </dxe:ASPxComboBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2"> 
                            <dxe:ASPxComboBox runat="server" ID="cboGCSetup" ClientInstanceName="cboGCSetup"
                                Width="50%" ToolTip="Setup" Enabled="False">
                            </dxe:ASPxComboBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <table border="0" cellpadding="1" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtVRT" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> cm
                                    </td>
                                    <td>
                                        <label class="lblNormal">
                                            <%=GetLabel("LNG")%></label>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtLNG" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> cm
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtLAT" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> cm
                                    </td>
                                    <td>
                                        <label class="lblNormal">
                                            <%=GetLabel("ROT")%></label>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtROT" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> n°
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtDuration" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> menit
                        </td>
                    </tr> 
                    <tr>
                        <td class="tdLabel" style="vertical-align:top">
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtNumberOfFields" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> 
                        </td>
                    </tr>  
                    <tr>
                        <td class="tdLabel" style="vertical-align:top">
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtMachineUnit" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> 
                        </td>
                    </tr>         
                    <tr>
                        <td class="tdLabel" style="vertical-align:top">
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtIsoCenter" Width="60px" CssClass="number" runat="server" ReadOnly="True"/> 
                        </td>
                    </tr>                                                                                                                                                                          
                    <tr>
                        <td class="tdLabel" style="vertical-align:top">
