<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewRTProgramCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewRTProgramCtl" %>
...
//        var values = getFormValues();
    ...
    function onAfterSaveAddRecordEntryPopup(result) {
        ...
        if (typeof onRefreshRTProgramViewGrid == 'function')
            onRefreshRTProgramViewGrid();
    }
                        ...
                        <tr>
                            ...
                            <td>
                                <table border="0" cellpadding="1" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtProgramDate" Width="120px" runat="server" ReadOnly="True" />
                                        </td>
                                        <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCTherapyType" ClientInstanceName="cboGCTherapyType"
                                    Width="50%" ToolTip="Jenis Radioterapi" Enabled="False">
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCTherapyPurpose" ClientInstanceName="cboGCTherapyPurpose"
                                    Width="50%" ToolTip="Tujuan Radiasi" Enabled="False">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr id="trExternal1" runat="server">
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCTherapyPlan" ClientInstanceName="cboGCTherapyPlan"
                                    Width="50%" ToolTip="Rencana Pengobatan" Enabled="False">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <dxe:ASPxComboBox runat="server" ID="cboGCBeamTechnique" ClientInstanceName="cboGCBeamTechnique"
                                                Width="50%" ToolTip="Teknik Penyinaran" Enabled="False">
                        ...
                        <tr id="trCombination" runat="server" style="display:none">
                            ...
                            <td>
                                <asp:DataList ID="dlBeamTechnique" runat="server" RepeatColumns="3"  
                                    CellSpacing="3" RepeatLayout="Table" Enabled="False">  
                                    <ItemTemplate>  
                                        <table class="table">  
                                            <tr>  
                                                <td>
                                ...
                                <table border="0" cellpadding="1" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <asp:TextBox ID="txtNumberOfDosage1" Width="80px" CssClass="number" runat="server" Style="text-align: right" ReadOnly="true" /> Gy                                             
                                        </td>
                                        <td style="text-align:center">
                                            <asp:TextBox ID="txtNumberOfFields1" Width="100px" CssClass="number" runat="server" Style="text-align: right" ReadOnly="true" />                                            
                                        </td>
                                        <td style="text-align:center">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <asp:TextBox ID="txtNumberOfDosage2" Width="80px" CssClass="number" runat="server" Style="text-align: right" Enabled="False" /> Gy                                             
                                        </td>
                                        <td style="text-align:center">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <asp:TextBox ID="txtNumberOfDosage3" Width="80px" CssClass="number" runat="server" Style="text-align: right" Enabled="False" /> Gy                                            
                                        </td>
                                        <td style="text-align:center">
