<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCTSimulationRequestCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewCTSimulationRequestCtl" %>
...
<script type="text/javascript" id="dxss_viewCTSimulationRequestCtl">
    $(function () {
                ...
                <div id="divPage1" class="w3-border divPageNavPanelContent w3-animate-left" style="display: none">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCSimulationRequestType" ClientInstanceName="cboGCSimulationRequestType"
                                    Width="50%" ToolTip="Jenis Permintaan" Enabled="False">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtScanBorder" Width="180px" runat="server" ReadOnly="True"  /> 
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel"></td>
                            <td>
                                <asp:RadioButtonList ID="rblIsUsingContrast" runat="server" RepeatDirection="Horizontal" Enabled="False">
