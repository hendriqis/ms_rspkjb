<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TimeOutFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TimeOutFormEntry" %>
...
<script type="text/javascript" id="dxss_SurgeryTimeOutFormEntry">
    setDatePicker('<%=txtTimeOutDate.ClientID %>');
    $('#<%=txtTimeOutDate.ClientID %>').datepicker('option', 'maxDate', new Date(getDateNow()));
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTimeOutDate" Width="120px" CssClass="datepicker" runat="server" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtTimeOutTime" Width="80px" CssClass="time" runat="server"
