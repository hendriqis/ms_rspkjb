<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RTProgramEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.RTProgramEntryCtl" %>
                                ...
                                <table border="0" cellpadding="1" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <asp:TextBox ID="txtNumberOfDosage1" Width="80px" CssClass="number" runat="server" Style="text-align: right" /> Gy                                             
                                        </td>
                                        <td style="text-align:center">
