<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CTSimulationRequestLogEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CTSimulationRequestLogEntryCtl" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCOrientation" ClientInstanceName="cboGCOrientation"
                                    Width="50%" ToolTip="Orientasi Posisi">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCHandPosition" ClientInstanceName="cboGCHandPosition"
                                    Width="50%" ToolTip="Posisi Tangan">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboGCImmobilizationTool" ClientInstanceName="cboGCImmobilizationTool"
                                    Width="50%" ToolTip="Alat Bantu Imobilisasi">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="rblIsHasPatientPositionImage" runat="server" RepeatDirection="Horizontal">
