<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SignInFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SignInFormEntry" %>
...
<script type="text/javascript" id="dxss_SurgerySignInFormEntry">
    setDatePicker('<%=txtSignInDate.ClientID %>');
    $('#<%=txtSignInDate.ClientID %>').datepicker('option', 'maxDate', new Date(getDateNow()));
    ...
    function onAfterSaveAddRecordEntryPopup(result) {
        if (typeof onRefreshSafetyCheckViewGrid == 'function')
            onRefreshSafetyCheckViewGrid();
    }
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSignInDate" Width="120px" CssClass="datepicker" runat="server" />
                        </td>
                        <td>
                    ...
                    <tr style="display:none">
                        <td class="tdLabel">
                            <label class="lblMandatory">
                                <%=GetLabel("Fisikawan")%></label>
                        </td>
                        <td colspan="2">
                            <dxe:ASPxComboBox ID="cboParamedic2" Width="350px" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
