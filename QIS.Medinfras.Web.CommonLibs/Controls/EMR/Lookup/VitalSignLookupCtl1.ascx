<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VitalSignLookupCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.VitalSignLookupCtl1" %>
...
<input type="hidden" id="hdnLinkChiefComplaintID" runat="server" value="0" />
<input type="hidden" id="hdnLinkPreSurgeryAssessmentID" runat="server" value="0" />
<input type="hidden" id="hdnLinkSurgeryAnesthesyStatusID" runat="server" value="0" />
<input type="hidden" id="hdnLinkPreAnesthesyAssesmentID" runat="server" value="0" />
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div>
                                            <asp:Repeater ID="rptVitalSignDt" runat="server">
                                                <ItemTemplate>
                                                    <div style="padding-left: 20px; float: left; width: 450px;">
                                                        <strong>
