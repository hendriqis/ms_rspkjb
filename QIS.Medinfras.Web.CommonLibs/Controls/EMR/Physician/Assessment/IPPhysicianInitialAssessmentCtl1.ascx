<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IPPhysicianInitialAssessmentCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.IPPhysicianInitialAssessmentCtl1" %>
