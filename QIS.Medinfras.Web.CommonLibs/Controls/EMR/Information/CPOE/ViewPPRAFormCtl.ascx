<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewPPRAFormCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewPPRAFormCtl" %>
...
<script type="text/javascript" id="dxss_PPRAFormCtl">
    $(function () {
                        ...
                        <tr>
                            <td class="tdLabel" colspan="5">
                                <label class="lblMandatory">
                                    <%=GetLabel("Pengisian Formulir PPRA")%></label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                <asp:RadioButtonList ID="rblIsHasPPRAForm" runat="server" RepeatDirection="Horizontal" Enabled="false">
                ...
                <div id="divPage2" class="w3-border divPageNavPanelContent w3-animate-left" style="display: none">
                   <table class="tblEntryContent" style="width:99%">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:TextBox ID="txtPPRASubjectiveSummary" Width="100%" runat="server" TextMode="MultiLine" Rows="3" ReadOnly="True" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel" style="vertical-align:top">
                            ...
                            <td colspan="4">
                                <asp:TextBox ID="txtPPRAObjectiveSummary" Width="100%" runat="server" TextMode="MultiLine" Rows="3" ReadOnly="True" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel" style="vertical-align:top">
                            ...
                            <td colspan="4">
                                <asp:TextBox ID="txtPPRAAssessmentSummary" Width="100%" runat="server" TextMode="MultiLine" Rows="3" ReadOnly="True" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                            ...
                            <td colspan="4">
                                <asp:RadioButtonList ID="rblPPRAIndication" runat="server" RepeatDirection="Horizontal" Enabled="False">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:TextBox ID="txtPPRAReason" Width="100%" runat="server" TextMode="MultiLine" ReadOnly="True" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                            ...
                            <td colspan="4">
                                <asp:RadioButtonList ID="rblPPRAMicrobiologyTestStatus" runat="server" RepeatDirection="Horizontal" Enabled="False">
                        ...
                        <tr id="trMicrobiologyTestOrder2" runat="server">
                            ...
                            <td colspan="4">
                                <asp:RadioButtonList ID="rblPPRAMicrobiologyTestResultStatus" runat="server" RepeatDirection="Horizontal" Enabled="False">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:TextBox ID="txtPPRAPlanningSummary" Width="100%" runat="server" TextMode="MultiLine" Rows="3" ReadOnly="True" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel" colspan="5">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:TextBox ID="txtPPRARemarks" Width="100%" runat="server" TextMode="MultiLine" Rows="3" ReadOnly="True" />
                            </td>
                        </tr>
                        <tr style="display:none">
                            <td colspan="2">
