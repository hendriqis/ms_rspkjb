...
{
    public partial class GridPatientVisitOutpatientCtl : System.Web.UI.UserControl
    {
        ...
        public void InitializeControl()
        {
            List<SettingParameterDt> lstSettingParameterDt = BusinessLayer.GetSettingParameterDtList(string.Format(
                    ...
                    Constant.SettingParameter.OP0042 //2
                ));
            ...
            hdnOP0042.Value = lstSettingParameterDt.Where(t => t.ParameterCode == Constant.SettingParameter.OP0042).FirstOrDefault().ParameterValue;
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vConsultVisit9> lstEntity = new List<vConsultVisit9>();
            if (hdnOP0042.Value != "1")
            {
                lstEntity = BusinessLayer.GetvConsultVisit9List(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST_2, pageIndex, "ParamedicID, Session, QueueNo");
            }
            else
            {
                lstEntity = BusinessLayer.GetvConsultVisit9List(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST_2, pageIndex, "VisitID");
            }
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                HtmlGenericControl divQueueNo = e.Item.FindControl("divQueueNo") as HtmlGenericControl;
                ...
                {
                    divQueueNo.InnerText = entity.cfReferenceQueueNo;
                }
                else
                {
                    divQueueNo.InnerText = entity.QueueNo.ToString();
                }
