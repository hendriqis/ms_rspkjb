<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridInpatientRegistrationBPJSCtlNew.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridInpatientRegistrationBPJSCtlNew" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_gridreigsteredpatientbpjsctlnew">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="text-align: right">
                                    <%#: Eval("cfTransactionProcessInString")%></div>
                            </td>
                            <td>
                                <div style="text-align: right">
                                    <%#: Eval("cfTransactionOpenInString")%></div>
                            </td>
                            <td>
                                <div style="text-align: right">
                            ...
                            <td>
                                <div style="text-align: right">
                                    <%#: Eval("cfCoverageAmountInString")%></div>
                            </td>
                            <td>
                                <div style="text-align: right; <%#: Eval("cfIsNormal").ToString() == "False" ? "color:red" : "color:blue"%>">
                                    <%#: Eval("cfBalanceAmountInString")%>
                                </div>
                            </td>
                            <td>
                                <div style="text-align: center" class="lnkDetail lblLink">
                                    <%#: Eval("OpenOrderCount")%></div>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
