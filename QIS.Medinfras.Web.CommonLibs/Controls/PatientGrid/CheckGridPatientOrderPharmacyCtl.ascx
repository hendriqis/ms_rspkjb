<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckGridPatientOrderPharmacyCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.CheckGridPatientOrderPharmacyCtl" %>
...
<script type="text/javascript" id="dxss_gridreigsteredpatientctl">
    ...
    function getCheckedRow() {
        ...
        $('.chkIsSelected input:checked').each(function () {
            var orderID = $(this).closest('tr').find('.hdnPrescriptionOrderID').val();
            if (param != '')
                param += ',';
            param += orderID;
        });
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="font-weight:bold">
                                    <label class="lblPrescriptionOrderNo lblLink"><%#: Eval("PrescriptionOrderNo") %></label>                                   
                                </div>   
                                <div>
                                    <%#: Eval("PrescriptionType") %>
                                </div>
