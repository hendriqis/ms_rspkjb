<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientServiceResultCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientServiceResultCtl" %>
...
<script type="text/javascript" id="dxss_gridserviceresultctl">
                    ...
                    <EmptyDataTemplate>
                        <table id="tblView" runat="server" class="grdCollapsible lvwView" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:200px" align="left" ><%=GetLabel("INFORMASI TRANSAKSI")%></th>
                                <th style="width:200px" align="left"><%=GetLabel("INFORMASI REGISTRASI")%></th>
                                <th style="width:330px" align="left"><%=GetLabel("INFORMASI PASIEN")%></th>
                                <th style="width:300px" align="left"><%=GetLabel("INFORMASI KONTAK")%></th>
                                <th align="left"><%=GetLabel("PEMBAYAR")%></th>
                            </tr>
                            <tr class="trEmpty">
                                <td colspan="6">
                        ...
                        <tr style="display:none" class="trDetail">
                            ...
                            <td>
                                <div style="padding:3px">
                                    ...
                                    <div><%#: Eval("PatientName") %> , <%#: Eval("MedicalNo") %></div>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="text-align:right;font-size:0.9em;font-style:italic" width="200px"><%=GetLabel("Nama Panggilan")%></td>
                                            <td>&nbsp;</td>
