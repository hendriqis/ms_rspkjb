<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridMedicalRecordStatusCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridMedicalRecordStatusCtl" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_gridMedicalRecordStatusctl">
                ...
                <asp:ListView runat="server" ID="lvwView">
                    ...
                    <LayoutTemplate>
                        <table id="tblView" runat="server" class="grdCollapsible lvwView" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:380px; text-align: left"><%=GetLabel("DATA PASIEN")%></th>
                                <th style="width:200px; text-align: left"><%=GetLabel("STATUS BERKAS RM")%></th>
                                <th style="text-align: left"><%=GetLabel("PETUGAS")%></th>
                            </tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <div><span style="font-weight:bold"><%#: Eval("PatientName") %></span> (<%#: Eval("DateOfBirthInString") %>)</div>                                           
                            </td>
                            <td>
                                    <div>
                        ...
                        <tr style="display: none" class="trDetail">
                            ...
                            <td>
                                <div>
                                    ...
                                    <div style="float: left">
                                        <%#: Eval("ActualVisitDateInString")%></div>
                                    <div style="margin-left: 100px">
                                        <%#: Eval("ActualVisitTime")%></div>
                                    <div>
                            ...
                            <td>
                                <div style="padding: 3px">
                                    <div>
                                        <%=GetLabel("Tanggal")%> : <%#: Eval("LogDateInString")%>
                                    </div>
                                    <div>
                                        <%=GetLabel("Jam")%> : <%#: Eval("LogTime")%>
                                    </div>
                                </div>
                            </td>
                            <td>
