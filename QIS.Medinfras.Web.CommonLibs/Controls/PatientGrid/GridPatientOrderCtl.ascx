<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientOrderCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientOrderCtl" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="float: left">
                                    <%#: Eval("TestOrderDateInString")%>
                                    -
                                    <%#: Eval("TestOrderTime") %></div>
                            </td>
                            <td>
                                <div>
                                    <%#: Eval("RegistrationNo") %>
                            ...
                            <img class="imgSampel" title='<%=GetLabel("Terdapat Sampel Pemeriksaan")%>' src=' <%# ResolveUrl("~/Libs/Images/sampellab.png") %>'
                                    style='<%# Eval("cfIsSpecimen") == "1" ? "width:25px": "width:25px; display:none" %>'
                                    alt="" />
                        ...
                        <tr style="display: none" class="trDetail">
                            ...
                            <td>
                                <div>
                                    ...
                                    <input type="hidden" class="hdnTestOrderIDOrder" value='<%#: Eval("TestOrderID") %>' />
                                    <div style="float: left">
                                        <%#: Eval("TestOrderDateInString")%></div>
