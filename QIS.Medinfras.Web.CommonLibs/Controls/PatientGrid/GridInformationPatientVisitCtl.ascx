<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridInformationPatientVisitCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridInformationPatientVisitCtl" %>
            ...
            <asp:Panel runat="server" ID="pnlGridView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;height:365px;overflow-y:scroll;">
                <table style="width:80%">
                    <tr>
                        ...
                        <td style="min-width:20%">
                            <span class="openedPatientColor">&nbsp&nbsp&nbsp&nbsp&nbsp</span>
                            <span id="openedVisitCounter" runat="server">Opened</span>
                        </td>
                        <td style="min-width:20%">
                        ...
                        <td style="min-width:20%">
                            <span class="unknownPatientColor">&nbsp&nbsp&nbsp&nbsp&nbsp</span>
                            <span id="unknownVisitCounter" runat="server">Unknown</span>
                        </td>
                    </tr>
                </table>
