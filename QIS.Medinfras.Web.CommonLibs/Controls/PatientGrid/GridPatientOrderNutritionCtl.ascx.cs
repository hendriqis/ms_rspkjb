...
{
    public partial class GridPatientOrderNutritionCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vTestOrderHdVisit> lstEntity = BusinessLayer.GetvTestOrderHdVisitList(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex);
        ...
        protected void btnOpenTransactionDtOrder_Click(object sender, EventArgs e)
        {
            ...
            {
                string orderInfo = string.Format("{0}|{1}",hdnOrderNo.Value,hdnPrescriptionType.Value);
