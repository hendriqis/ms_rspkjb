<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientRegOrderPrescriptionReturnCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientRegOrderPrescriptionReturnCtl" %>
                    ...
                    <EmptyDataTemplate>
                        <table id="tblView" runat="server" class="grdCollapsible lvwView" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:250px"><%=GetLabel("Informasi Registrasi")%></th>
