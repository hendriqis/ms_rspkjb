<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientVisitCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientVisitCtl" %>
                ...
                <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <div id="tdIsHasBillingNotes1" runat="server" style="display: none">
                                    <img id="imgHasBillingNotes" src='<%= ResolveUrl("~/Libs/Images/Toolbar/registration_notes.png")%>'
                                        title="<%=GetLabel("Has Billing Notes")%>" alt="" style='<%# Eval("IsHasBillingNotes").ToString() == "True" ? "cursor: pointer;width:23px": "width:25px;display:none" %>' />
                                </div>
                            </td>
                            <td align="center">
