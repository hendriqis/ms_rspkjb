<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridImagingPatientListCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridImagingPatientListCtl" %>
    ...
    <PanelCollection>
        <dx:PanelContent ID="PanelContent1" runat="server">
            <asp:Panel runat="server" ID="pnlGridView" Style="width: 100%; margin-left: auto;
                ...
                <asp:ListView runat="server" ID="lvwViewCount" Style="display: none">
                    <EmptyDataTemplate>
                ...
                <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <br><span>
                                        <%#: Eval("BusinessPartner") %></span></br>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <%#: Eval("cfDetailItemInfo")%>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <%#: Eval("cfDetailParamedicInfo")%></div>
                            </td>
                            <td>
                                <div>
                        ...
                        <tr style="display: none" class="trDetail">
                            ...
                            <td>
                                <div>
                                    <input type="hidden" class="hdnVisitID" value='<%#: Eval("TransactionID") %>' />
