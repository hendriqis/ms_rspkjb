<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientRegistrationCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientRegistrationCtl" %>
                ...
                <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <img id="imgPatientSatisfactionLevelImageUri" runat="server" width="24" height="24" alt="" />
                            </td>
                            <td>
