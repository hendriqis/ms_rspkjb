<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientRegOrderCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientRegOrderCtl1" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_GridPatientRegOrderCtl1">
    ...
    var isHovertdExpand1 = false;
    $('.lvwView1 tr:gt(0) td.tdExpand1').live({
        mouseenter: function () { isHovertdExpand1 = true; },
        mouseleave: function () { isHovertdExpand1 = false; }
    });

    $('.lvwView1 tr:gt(0) td.tdExpand1').live('click', function () {
        $tr = $(this).parent().next();
        if (!$tr.is(":visible")) {
        ...
        <dx:PanelContent ID="PanelContent1" runat="server">
            <asp:Panel runat="server" ID="pnlGridView" Style="width: 100%; margin-left: auto;
                ...
                <asp:ListView runat="server" ID="lvwView1" OnItemDataBound="lvwView1_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td class="tdExpand1" style="text-align: center">
