<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridImagingResultVerificationCtl.ascx.cs" 
Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridImagingResultVerificationCtl" %>
                    ...
                    <EmptyDataTemplate>
                        <table id="tblView" runat="server" class="grdCollapsible lvwView" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:150px" align="left"><%=GetLabel("INFORMASI REGISTRASI")%></th>
