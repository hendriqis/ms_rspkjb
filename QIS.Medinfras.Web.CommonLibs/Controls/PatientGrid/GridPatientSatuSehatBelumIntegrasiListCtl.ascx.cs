...
{
    public partial class GridPatientSatuSehatBelumIntegrasiListCtl : System.Web.UI.UserControl
    {
        ...
        protected void cbpViewBelumIntegrasi_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
        ...
        {
            string filterExpression = ((BasePagePatientOrderSatuSehatBelumIntegrasi)Page).GetFilterExpressionSatuSehatBelumIntegrasi();
        ...
        protected void btnOpenTransactionDtDalamIntegrasi_Click(object sender, EventArgs e)
        {
            if (hdnTransactionNo.Value != "")
            {
                ((BasePagePatientOrderSatuSehatBelumIntegrasi)Page).OnGrdRowClickSatuSehatBelumIntegrasi(hdnTransactionNo.Value, "", "");
            }
        }
