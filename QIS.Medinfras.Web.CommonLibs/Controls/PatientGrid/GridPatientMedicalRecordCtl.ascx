<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientMedicalRecordCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientMedicalRecordCtl" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="divMedicalFileStatus" runat="server" style="font-style: italic; font-size:smaller">
                                </div>
                            </td>
                            <td>
                                <div>
