...
{
    public partial class GridPatientScheduledOrderCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vTestOrderHdVisit> lstEntity = BusinessLayer.GetvTestOrderHdVisitList(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex, "ScheduledTime");
