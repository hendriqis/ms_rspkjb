...
{
    public partial class GridInpatientRegistrationCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            hdnFilterExpressionReport.Value = filterExpression;
            if (!filterExpression.Equals(string.Empty)) filterExpression += " AND ";
            filterExpression += string.Format("GCRegistrationStatus NOT IN ('{0}','{1}') ", Constant.VisitStatus.DISCHARGED, Constant.VisitStatus.CANCELLED);
            if (isCountPageCount)
            {
            ...
            List<vRegistration13> lstEntity = BusinessLayer.GetvRegistration13List(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex, "BedCode ASC");
