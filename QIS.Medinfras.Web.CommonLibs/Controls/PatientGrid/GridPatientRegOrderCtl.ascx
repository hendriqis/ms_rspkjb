<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientRegOrderCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientRegOrderCtl" %>
