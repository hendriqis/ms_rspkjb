<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientOrderUDDCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientOrderUDDCtl" %>
                ...
                <asp:ListView runat="server" ID="lvwViewOrder">
                    <EmptyDataTemplate>
                        <table id="tblViewOrder" runat="server" class="grdCollapsible lvwViewOrder" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:350px" align="left"><%=GetLabel("DATA PASIEN")%></th>
                                ...
                                <th style="width:100px" align="center"><%=GetLabel("STATUS KONFIRMASI")%></th>
                    ...
                    <LayoutTemplate>
                        <table id="tblViewOrder" runat="server" class="grdCollapsible lvwViewOrder" cellspacing="0" rules="all" >
                            <tr>
                                <th style="width:15px"></th>
                                <th style="width:300px" align="left"><%=GetLabel("INFORMASI TRANSAKSI")%></th>
                                <th style="width:250px" align="left"><%=GetLabel("INFORMASI PENDAFTARAN")%></th>
                                <th style="width:400px" align="left"><%=GetLabel("DATA PASIEN")%></th>
                                <th style="width:350px" align="left"><%=GetLabel("ALAMAT DAN NO.TELEPON")%></th>
                                <th style="width:100px" align="center"><%=GetLabel("STATUS ORDER")%></th>
                                <th style="width:100px" align="center"><%=GetLabel("STATUS KONFIRMASI")%></th>
                                 <th style="width:30px"></th>
                            </tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <div style="color: Blue"><%#: Eval("PrescriptionOrderDateInString")%> <%#: Eval("PrescriptionTime")%> <span style="color:black;font-weight:bold"> <%#: Eval("PrescriptionType") %></span> </div>
                                <div><%#: Eval("PrescriptionOrderNo") %><br />
                            ...
                            <td>
                                <div>
                                    <%#: Eval("RegistrationNo") %>
                                    <span><div><%#: Eval("ServiceUnitName")%>, <%#: Eval("ClassName") %></div></span>
                            ...
                            <td>
                                <div><%#: Eval("cfPatientNameSalutation") %>(<%#: Eval("DateOfBirthInString") %>, <%#: Eval("Sex") %>, <%#: Eval("MedicalNo") %>)</div>                                           
                            </td>
                            <td>&nbsp;</td>
                            <td align="center"> <div><%#: Eval("OrderStatus") %> </div> </td>
                            <td align="center"> <div><%#: Eval("cfOrderTransactionStatusLabel") %> </div> </td>
                            <td align="center">
