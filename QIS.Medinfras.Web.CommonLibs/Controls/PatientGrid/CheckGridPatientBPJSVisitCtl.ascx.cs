...
{
    public partial class CheckGridPatientBPJSVisitCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vConsultVisitBPJS> lstEntity = BusinessLayer.GetvConsultVisitBPJSList(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_MR_LIST, pageIndex, "VisitDate");
