...
{
    public partial class GridPatientListUDDCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvConsultVisit20RowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_PATIENT_LIST);
            }

            List<vConsultVisit20> lstEntity = BusinessLayer.GetvConsultVisit20List(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex,"BedCode");
