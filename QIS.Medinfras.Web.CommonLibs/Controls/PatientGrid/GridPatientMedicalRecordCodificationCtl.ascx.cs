...
{
    public partial class GridPatientMedicalRecordCodificationCtl : System.Web.UI.UserControl
    {
        protected int PageCount = 1;
        public void InitializeControl()
        {
            if (AppSession.LastPagingMR3 != null)
            {
                hdnLastPagging3.Value = AppSession.LastPagingMR3.PageID.ToString();
            }
        ...
        {
            string filterExpression = ((BasePagePatientOrder2)Page).GetFilterExpressionCodification();
            ...
            LastPagingMR3 mr = new LastPagingMR3();
            mr.PageID = pageIndex;
            AppSession.LastPagingMR3 = mr;
            ...
            {
                lvwView1.DataSource = lstEntityAllDiagnose;
                lvwView1.DataBind();
        ...
        protected void btnOpenTransactionDt1_Click(object sender, EventArgs e)
        {
            if (hdnTransactionNo.Value != "")
            {
                ((BasePagePatientOrder2)Page).OnGrdRowClickCodification(hdnTransactionNo.Value, "", "");
            }
        }
