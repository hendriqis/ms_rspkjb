<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientOrderNutritionCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientOrderNutritionCtl" %>
...
<script type="text/javascript" id="dxss_gridreigsteredpatientctl">
    $('.lvwViewOrder tr:gt(0):not(.trEmpty)').live('click', function () {
        if (!isHoverTdExpandOrder) {
            ...
            $('#<%=hdnOrderNo.ClientID %>').val($(this).find('.hdnPrescriptionOrderID').val());
                        ...
                        <tr style="display:none" class="trDetail">
                            ...
                            <td>
                                <div style="padding:3px">
                                    ...
                                    <div><%#: Eval("cfPatientNameSalutation") %></div>
