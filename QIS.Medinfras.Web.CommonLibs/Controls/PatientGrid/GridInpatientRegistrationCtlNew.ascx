<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridInpatientRegistrationCtlNew.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridInpatientRegistrationCtlNew" %>
