<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridPatientListNutritionCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridPatientListNutritionCtl" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                ...
                                <div>
                                    <font color="red"><%#: Eval("cfTextDischargeDateOrPlanDischargeDate") %></font>
                                </div>
                            </td>
                            <td>
