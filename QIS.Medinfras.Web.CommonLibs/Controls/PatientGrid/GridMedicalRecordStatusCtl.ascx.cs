...
{
    public partial class GridMedicalRecordStatusCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvMedicalRecordLogStatusRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_PATIENT_LIST);
            }

            List<vMedicalRecordLogStatus> lstEntity = BusinessLayer.GetvMedicalRecordLogStatusList(filterExpression);
