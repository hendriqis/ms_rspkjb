<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridHospitalizedPatientRegistrationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.GridHospitalizedPatientRegistrationCtl" %>
