...
{
    public partial class GridPatientSatuSehatDalamIntegrasiListCtl : System.Web.UI.UserControl
    {
        ...
        protected void cbpViewDalamIntegrasi_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
        ...
        {
            string filterExpression = ((BasePagePatientOrderSatuSehatDalamIntegrasi)Page).GetFilterExpressionSatuSehatDalamIntegrasi();
        ...
        protected void btnOpenTransactionDt2_Click(object sender, EventArgs e)
        {
            ...
            {
                ((BasePagePatientOrderSatuSehatDalamIntegrasi)Page).OnGrdRowClickSatuSehatDalamIntegrasi(hdnTransactionNo.Value, "", "");
            }
        }
