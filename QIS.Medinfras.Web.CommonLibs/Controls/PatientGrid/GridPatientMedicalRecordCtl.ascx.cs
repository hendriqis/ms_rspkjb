...
{
    public partial class GridPatientMedicalRecordCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            {
                lvwView.DataSource = lstEntityAllDiagnose;
                lvwView.DataBind();
        ...
        protected void btnOpenTransactionDt2_Click(object sender, EventArgs e)
        {
            ...
            {
                ((BasePagePatientOrder)Page).OnGrdRowClickTestOrder(hdnTransactionNo.Value, "");
            }
        }
