...
{
    public partial class GridImagingResultVerificationCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvImagingResultHdVerificationRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_PATIENT_LIST);
            }

            List<vImagingResultHdVerification> lstEntity = BusinessLayer.GetvImagingResultHdVerificationList(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex);
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            {
                vImagingResultHdVerification entity = (vImagingResultHdVerification)e.Item.DataItem;
                HtmlGenericControl spnProcessed = e.Item.FindControl("spnProcessed") as HtmlGenericControl;
                if (entity.ImagingHdGCTransactionStatus != Constant.TransactionStatus.PROCESSED)
