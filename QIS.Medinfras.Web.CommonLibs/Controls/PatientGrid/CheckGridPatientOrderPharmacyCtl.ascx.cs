...
{
    public partial class CheckGridPatientOrderPharmacyCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vPrescriptionOrderHdVisit> lstEntity = BusinessLayer.GetvPrescriptionOrderHdVisitList(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex, "PrescriptionDate DESC");
