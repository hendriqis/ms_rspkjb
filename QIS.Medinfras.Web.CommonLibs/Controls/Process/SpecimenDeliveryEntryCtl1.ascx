<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SpecimenDeliveryEntryCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SpecimenDeliveryEntryCtl1" %>
...
<script type="text/javascript" id="dxss_NewSurgeryOrderEntryCtl1">
    $(function () {
        setDatePicker('<%=txtDeliveryDate.ClientID %>');
        $('#<%=txtDeliveryDate.ClientID %>').datepicker('option', 'maxDate', '0');
                ...
                <div id="divPage1" class="w3-border divPageNavPanelContent w3-animate-left" style="display: none">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txtSpecimenTakenName" Width="250px" runat="server" Style="text-align: left" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                ...
                <div id="divPage2" class="w3-border divPageNavPanelContent w3-animate-left" style="display: none">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDeliveryDate" Width="120px" runat="server"  CssClass="datepicker"/>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDeliveryTime" Width="80px" CssClass="time" runat="server" Style="text-align: center"  />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txtSpecimenDeliveryName" Width="250px" runat="server" Style="text-align: center" />
                            </td>
                        </tr>
                    </table>
                </div>
