<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SurgeryOrderEntryCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SurgeryOrderEntryCtl1" %>
                ...
                <div id="divPage1" class="w3-border divPageNavPanelContent w3-animate-left">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:RadioButtonList ID="rblIsHasInfectiousDisease" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:RadioButtonList ID="rblIsHasComorbidities" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table">
                                    <asp:ListItem Text=" Ya" Value="1" />
                                    <asp:ListItem Text=" Tidak" Value="0" Selected="True" />
                                </asp:RadioButtonList>
                            </td>    
                                                ...
                                                <tr>
                                                    <td>
                                                        <qis:QISSearchTextBox ID="ledProcedureGroup" ClientInstanceName="ledProcedureGroup"
                                                            runat="server" Width="99%" ValueText="ProcedureGroupID" FilterExpression="IsDeleted = 0" DisplayText="ProcedureGroupName"
...
<%--<dx:ASPxPopupControl ID="pcScheduleInfo" runat="server" ClientInstanceName="pcScheduleInfo"
    EnableHierarchyRecreation="True" FooterText="" HeaderText="Jadwal Kamar Operasi" HeaderStyle-HorizontalAlign="Left" Height="400px"
    Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
    Width="300px" CloseAction="CloseButton" AllowDragging="true">
    <ContentCollection>
        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
            <div style="text-align: center; width: 100%;">
                <dxcp:ASPxCallbackPanel ID="cbpScheduleInfo" runat="server" Width="100%" ClientInstanceName="cbpScheduleInfo"
                    ShowLoadingPanelImage="true">
                    <PanelCollection>
                        <dx:PanelContent ID="panScheduleInfo" runat="server">
                            <asp:Panel ID="panScheduleInfoPanel1" Style="width: 100%;" runat="server" Height="350px">
                                <uc1:ORScheduleInfo1Ctl ID="ctlORScheduleInfoCtl" runat="server" />
                            </asp:Panel>
                        </dx:PanelContent>
                    </PanelCollection>
                </dxcp:ASPxCallbackPanel>
