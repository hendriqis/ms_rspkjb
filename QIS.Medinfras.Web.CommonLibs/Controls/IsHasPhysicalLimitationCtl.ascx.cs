...
{
    public partial class IsHasPhysicalLimitationCtl : BaseViewPopupCtl
    {
        public override void InitializeDataControl(string param)
        {
            ...
            if (opatient != null)
            {
                ...
                {
                    if (opatient.GCPhysicalLimitationType != "")
                    {
                        StandardCode sc = BusinessLayer.GetStandardCode(opatient.GCPhysicalLimitationType);
