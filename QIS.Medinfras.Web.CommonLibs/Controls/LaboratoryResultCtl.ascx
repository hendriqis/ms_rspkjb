<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LaboratoryResultCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.LaboratoryResultCtl" %>
...
<div style="height: 370px; overflow-y: scroll;">
    ...
    <input type="hidden" runat="server" id="hdnIsShowResultAfterProposed" value="" />
                ...
                <ItemTemplate>
                    <div class='<%#: Eval("IsNormal").ToString() == "False" ?  (Eval("cfIsPanicRange").ToString() == "False" ? "isAbnormalColor" : "isPanicRangeColor") : "" %>'
                        ...
                        <div class='<%#: Eval("cfIsResultInPDF").ToString() != "False" ? "lblLink lblPrintPDF" : "" %>'>
                            <asp:Literal ID="literal" Text='<%# Eval("cfTestResultValueNew") %>' Mode="PassThrough"
                                runat="server" /></div>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
