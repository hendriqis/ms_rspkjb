...
{
    public partial class MPEntryPopupCtl2 : BaseMPPopupEntry
    {
        private BaseEntryPopupCtl2 ctl = null;
        protected void Page_Load(object sender, EventArgs e)
        {
            bool IsAllowAdd = true;
            ctl = (BaseEntryPopupCtl2)pnlEntryPopup.Controls[0];
        ...
        protected void cbpMPEntryPopupProcess_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            {
                ctl.OnBtnVoidClick(ref result);
            }
            else if (param == "propose")
            {
                ctl.OnBtnProposeClick(ref result);
            }
