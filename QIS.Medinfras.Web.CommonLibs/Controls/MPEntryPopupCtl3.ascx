<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MPEntryPopupCtl3.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.MPEntryPopupCtl3" %>
...
<div style="padding: 5px 0;">
    <script type="text/javascript" id="dxss_mpentrypopupctl3">
        ...
        $(function () {
            ...
            $('#<%=btnMPEntryPopupSave.ClientID %>').click(function (evt) {
                ...
                if (isAllowSave) {
                    ...
                    var messageBody = errMessage.text;
                    showToastConfirmation(messageBody, function (result) {
                        if (result) {
                            if (IsValid(evt, 'fsMPEntryPopup', 'mpEntryPopup'))
                                cbpMPEntryPopupProcess.PerformCallback('save');
                        }
