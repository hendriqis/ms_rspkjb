﻿<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IsHasPhysicalLimitationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.IsHasPhysicalLimitationCtl" %>
<div align="center">
                ...
                <td valign="top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal">
                                    <%:GetLabel("Keterbatasan Fisik")%></label>
                            </td>
                            <td colspan="3">
