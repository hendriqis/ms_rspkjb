...
{
    public partial class EpisodeSummaryPatientInstructionCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            filterExpression += string.Format("VisitID IN ({0},{1}) AND IsDeleted = 0", VisitID, hdnLinkedVisitID.Value);
