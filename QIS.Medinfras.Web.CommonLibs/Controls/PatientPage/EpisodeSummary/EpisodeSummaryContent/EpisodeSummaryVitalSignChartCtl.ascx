<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EpisodeSummaryVitalSignChartCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.EpisodeSummaryVitalSignChartCtl" %>
