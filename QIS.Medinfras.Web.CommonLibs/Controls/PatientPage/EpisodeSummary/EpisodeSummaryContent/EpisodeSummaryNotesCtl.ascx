<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EpisodeSummaryNotesCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.EpisodeSummaryNotesCtl" %>

<h3 class="headerContent"><%=GetLabel("Integration Notes")%></h3>
<style type="text/css">
.warnaHeader
{
    color:#016482;
...
<div style="max-height:420px;overflow-y:auto">
    <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
        ...
        <EmptyDataTemplate>
            <%=GetLabel("Tidak ada catatan untuk pasien ini") %>
        </EmptyDataTemplate>
    </asp:GridView>
</div>
