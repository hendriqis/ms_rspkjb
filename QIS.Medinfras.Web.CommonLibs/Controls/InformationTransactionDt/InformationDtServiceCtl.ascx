<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformationDtServiceCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.InformationDtServiceCtl" %>
...
<script type="text/javascript" id="dxss_infodtservice">
