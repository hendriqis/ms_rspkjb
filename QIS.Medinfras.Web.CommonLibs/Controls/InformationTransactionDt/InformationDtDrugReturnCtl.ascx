<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformationDtDrugReturnCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.InformationDtDrugReturnCtl" %>
...
<script type="text/javascript" id="dxss_infodtdrugreturn">

</script>
<input type="hidden" value="0" id="hdnHideCheckbox" runat="server" />
<asp:ListView ID="lvwDrugReturn" runat="server">
    <EmptyDataTemplate>
    ...
    <LayoutTemplate>
        <table id="tblView" runat="server" class="grdDrugReturn grdNormal" cellspacing="0" rules="all">
            <tr>
                <th rowspan="2">
                    <div style="text-align: left; padding-left: 3px">
                        <%=GetLabel("Deskripsi")%>
            ...
            <tr id="Tr1" class="trFooter" runat="server">
                ...
                <td align="right" style="padding-right: 3px" id="tdDrugReturnTotalPayer" runat="server">
                </td>
                <td align="right" style="padding-right: 3px" id="tdDrugReturnTotalPatient" runat="server">
                </td>
                <td align="right" style="padding-right: 3px" id="tdDrugReturnTotal" runat="server">
                </td>
                <td colspan="3">
                    &nbsp;
                </td>
