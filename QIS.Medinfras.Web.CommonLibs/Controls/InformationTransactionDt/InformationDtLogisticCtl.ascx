<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformationDtLogisticCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.InformationDtLogisticCtl" %>
...
<script type="text/javascript" id="dxss_infodtLogistic">
...
<asp:ListView ID="lvwLogistic" runat="server">
    ...
    <LayoutTemplate>
        <table id="tblView" runat="server" class="grdLogistic grdNormal" cellspacing="0" rules="all">
            <tr>
                <th rowspan="2">
                    <div style="text-align: left; padding-left: 3px">
                        <%=GetLabel("Deskripsi")%>
