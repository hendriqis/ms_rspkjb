...
{
    public partial class MPBasePatientPageTrx3 : BaseMP
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                bool isAllowProposed = BasePageEntry.IsAllowProposed;
                hdnIsAllowProposed.Value = isAllowProposed ? "1" : "0";
                ...
                GetUserMenuAccess menu = BusinessLayer.GetUserMenuAccess(ModuleID, AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID, string.Format("MenuCode = '{0}'", menuCode)).FirstOrDefault();
        ...
        protected void cbpMPEntryContent_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            string isAllowProposed = BasePageEntry.IsAllowProposed ? "1" : "0";
            ...
            panel.JSProperties["cpProposed"] = isAllowProposed;
        }
