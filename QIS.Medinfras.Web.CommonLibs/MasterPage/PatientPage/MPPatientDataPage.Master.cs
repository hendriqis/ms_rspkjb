    ...
    public partial class MPPatientDataPage : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string parentCode = Constant.MenuCode.Inpatient.MEDICAL_RECORD_VIEW;
                switch (ModuleID)
                {
                    case Constant.Module.INPATIENT:
                        parentCode = Constant.MenuCode.Inpatient.MEDICAL_RECORD_VIEW;
                        break;
                    case Constant.Module.OUTPATIENT:
                        parentCode = Constant.MenuCode.Outpatient.MEDICAL_RECORD_VIEW;
                        break;
                    case Constant.Module.EMERGENCY:
                        parentCode = Constant.MenuCode.EmergencyCare.MEDICAL_RECORD_VIEW;
                        break;
                    case Constant.Module.MEDICAL_DIAGNOSTIC:
                        parentCode = Constant.MenuCode.MedicalDiagnostic.MEDICAL_RECORD_VIEW;
                        break;
                    case Constant.Module.MEDICAL_CHECKUP:
                        parentCode = Constant.MenuCode.MedicalCheckup.MEDICAL_RECORD_VIEW;
                        break;
                    default:
                        parentCode = Constant.MenuCode.EMR.PATIENT_EMR_VIEW;
                        break;
                }
