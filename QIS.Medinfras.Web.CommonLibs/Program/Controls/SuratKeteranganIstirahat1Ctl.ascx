<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratKeteranganIstirahat1Ctl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratKeteranganIstirahat1Ctl" %>
...
<script type="text/javascript" id="dxss_medicalsickleave">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var errMessage = { text: "" };
        var filterExpression = "VisitID = " + visitID + "|" + from + "|" + to + "|" + fromS + "|" + toS + "|" + diagnoseText;
        var reportCode = "PM-00549";
