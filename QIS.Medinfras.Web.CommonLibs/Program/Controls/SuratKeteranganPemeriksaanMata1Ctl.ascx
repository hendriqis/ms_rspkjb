<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratKeteranganPemeriksaanMata1Ctl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratKeteranganPemeriksaanMata1Ctl" %>
...
<script type="text/javascript" id="dxss_medicalsickleave">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var filterExpression = "VisitID = " + visitID + "|" + mataKanan + "|" + mataKananKoreksi + "|" + mataKiri + "|" + mataKiriKoreksi + "|" + type + "|" + lainlain;
        var reportCode = "PM-00551";
        if (reportCode != "") {
