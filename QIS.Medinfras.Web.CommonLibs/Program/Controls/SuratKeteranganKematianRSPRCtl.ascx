<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratKeteranganKematianRSPRCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratKeteranganKematianRSPRCtl" %>
...
<script type="text/javascript" id="dxss_medicalsickleave">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var filterExpression = registrationID + "|" + date + "|" + time1 + "|" + time2;
        var reportCode = "PM-00575";
        if (reportCode != "") {
