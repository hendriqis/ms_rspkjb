<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratKeteranganKematianRSBLCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratKeteranganKematianRSBLCtl" %>
...
<script type="text/javascript" id="dxss_medicalsickleave">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var filterExpression = registrationID + "|" + newDate + "|" + time1 + "|" + time2 + "|" + diagnoseText;
        if (reportCode != "") {
