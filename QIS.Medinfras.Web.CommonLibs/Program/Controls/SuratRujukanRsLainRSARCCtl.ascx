<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratRujukanRsLainRSARCCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratRujukanRsLainRSARCCtl" %>
...
<script type="text/javascript" id="dxss_medicalconsultation">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var filterExpression = visitID + "|" + referralphysicianText + "|" + therapyText + "|" + from + "|" + di;
        var reportCode = "PM-00581";
        if (reportCode != "") {
