...
{
    public partial class PrintLabelPenunjangEditableCtl : BaseViewPopupCtl
    {
        ...
        private bool PrintDrugLabel(string DetailID, ref string errMessage)
        {
            ...
            try
            {
                ...
                //charges.ItemName1 = hdnItemNameFinal.Value;
                ZebraPrinting.printLabelRadiologiRSPM(charges, printerUrl1);
            }
            catch (Exception ex)
            {
