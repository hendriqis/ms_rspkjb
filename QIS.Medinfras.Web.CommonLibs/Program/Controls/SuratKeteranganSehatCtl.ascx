<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratKeteranganSehatCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratKeteranganSehatCtl" %>
...
<script type="text/javascript" id="dxss_medicalsickleave">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var HealthcareInitial = $('#<%=hdnHealthcareInitialCtl.ClientID %>').val();
        
        if (HealthcareInitial == "PHS") {
            var reportCode = "PM-00720";
        }  
...
<input type="hidden" value="" id="hdnHealthcareInitialCtl" runat="server"  />
