<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratKeteranganIstirahat3Ctl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratKeteranganIstirahat3Ctl" %>
...
<script type="text/javascript" id="dxss_medicalsickleave">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var errMessage = { text: "" };
        var filterExpression = "RegistrationID = " + registrationID + "|" + from + "|" + to + "|" + fromS + "|" + toS;
        var reportCode = $('#<%=hdnRptCodeReport.ClientID %>').val();
...
<div style="padding: 10px;">
    <fieldset id="fsTrxPopup" style="margin: 0">
        ...
        <input type="hidden" value="PM-00593" id="hdnRptCodeReport" runat="server" />
         <table>
            <colgroup>
