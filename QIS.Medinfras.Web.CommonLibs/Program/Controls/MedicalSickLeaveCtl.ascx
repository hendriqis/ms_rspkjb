<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedicalSickLeaveCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.MedicalSickLeaveCtl" %>
            ...
            <tr>
                ...
                <td>
                    <td class="tdCustomDate">
                        <asp:TextBox ID="txtValueDateFrom" CssClass="txtValueDateFrom datepicker required" runat="server"
                            Width="120px" />
                        -
