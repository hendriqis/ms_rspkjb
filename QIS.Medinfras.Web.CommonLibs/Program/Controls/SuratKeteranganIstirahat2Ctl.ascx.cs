...
{
    public partial class SuratKeteranganIstirahat2Ctl : BaseViewPopupCtl
    {
        public override void InitializeDataControl(string param)
        {
            ...
            vPatientDiagnosis entityPD = BusinessLayer.GetvPatientDiagnosisList(string.Format("RegistrationID = {0} AND GCDiagnoseType = '{1}'", hdnRegistrationID.Value, Constant.DiagnoseType.MAIN_DIAGNOSIS)).FirstOrDefault();
            if (entityPD != null)
            {
