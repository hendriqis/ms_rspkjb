<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoRegistrationCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Controls.InfoRegistrationCtl" %>
...
<div class="pageTitle"><%=GetLabel("Registration Information")%></div>
<fieldset id="fsPatientListPopup">  
    <table>
        ...
        <tr id="trServiceUnit" runat="server">
            <td><label><%=GetLabel("Unit Pelayanan") %></label></td>
            <td>
                <dxe:ASPxComboBox ID="cboInfoRegistrationServiceUnit" ClientInstanceName="cboInfoRegistrationServiceUnit" Width="300px" runat="server">
                        ...
                        <EmptyDataTemplate>
                            <table id="tblView" runat="server" class="grdCollapsible lvwInfoRegistration" cellspacing="0" rules="all" >
                                <tr>
                                    ...
                                    <th style="width:220px"><%=GetLabel("Registration Information")%></th>
                                    <th style="width:400px"><%=GetLabel("Patient Information")%></th>
                                    <th style="width:270px"><%=GetLabel("Contact Information")%></th>
