<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NusingNotesPerDateCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.NusingNotesPerDateCtl" %>
...
<script type="text/javascript" id="dxss_nursingnotesperdate">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var dateperiod = from + ";" + to;

        var errMessage = { text: "" };
        var filterExpression = registrationID + "|" + dateperiod;
        var reportCode = "MR000015";
        if (reportCode != "") {
