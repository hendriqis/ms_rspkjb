<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GenerateDokumenPenagihanPiutangCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.GenerateDokumenPenagihanPiutangCtl" %>
...
<input type="hidden" runat="server" id="hdnInvoiceID" value="0" />
     ...
     <div>
        <table>
            <tbody>
                <tr>
                    <th>No Invoice</th>
                    <td><asp:TextBox runat="server" ID="txtInvoiceNo" Width="150px" ReadOnly=true /></td>
                </tr>
                <tr>
                    <td></td>
