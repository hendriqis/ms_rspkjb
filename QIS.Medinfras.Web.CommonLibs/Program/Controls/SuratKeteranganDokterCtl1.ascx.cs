...
{
    public partial class SuratKeteranganDokterCtl1 : BaseViewPopupCtl
    {
        public override void InitializeDataControl(string param)
        {
            hdnVisitID.Value = param;

            Helper.SetControlEntrySetting(txtMingguHamil, new ControlEntrySetting(false, false, true), "mpTrxPopup");
            Helper.SetControlEntrySetting(txtHariHamil, new ControlEntrySetting(false, false, true), "mpTrxPopup");
