<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuratKeteranganIstirahat2Ctl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SuratKeteranganIstirahatCtl" %>
...
<script type="text/javascript" id="dxss_medicalsickleave">
    ...
    function onReprintPatientPaymentReceiptSuccess() {
        ...
        var errMessage = { text: "" };
        var filterExpression = "RegistrationID = " + registrationID + "|" + from + "|" + to + "|" + fromS + "|" + toS + "|" + diagnoseText;
        var reportCode = "PM-00587";
        if (reportCode != "") {
