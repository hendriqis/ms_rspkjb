<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="InformationRegistrationPatient.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.InformationRegistrationPatient" %>

<%@ Register Src="~/Libs/Controls/PatientGrid/GridInformationPatientVisitCtlNew.ascx"
                    ...
                    <fieldset id="fsPatientList">
                        <table class="tblEntryContent" style="width: 60%;">
                            ...
                            <tr id="trServiceUnit" runat="server">
                                <td class="tdLabel">
                                    <label class="lblNormal">
                                        <%=GetLabel("Service Unit / Unit Pelayanan")%></label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="tdLabel">
                                    <label class="lblNormal">
                                        <%=GetLabel("Tipe Penjamin Pasien")%></label>
                                </td>
                                <td>
