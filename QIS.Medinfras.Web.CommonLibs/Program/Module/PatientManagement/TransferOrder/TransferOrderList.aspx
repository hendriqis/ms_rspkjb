<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="TransferOrderList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransferOrderList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnTransferOrder.ClientID %>').click(function () {
                ...
                if (param == '') {
                    showToast('Warning', 'Order yang ingin ditransfer belum dipilih');
                }
                else if (cboToServiceUnitOrder.GetText() == '') {
                    showToast('Warning', 'Tujuan Order belum dipilih');
                }
                else {
    ...
    <div>
        <div>
            ...
            <div class="pageTitle"><%=GetLabel("Daftar Order Resep")%> : <%=GetLabel("Pilih Order yang ingin ditransfer")%></div>
                        ...
                        <fieldset id="fsPatientListOrder">  
                            <table class="tblEntryContent" style="width:60%;">
                                ...
                                <tr>
                                    ...
                                    <td><asp:TextBox ID="txtTestOrderDate" Width="120px" runat="server" CssClass="datepicker" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="tdLabel"><b><label class="lblNormal"><%=GetLabel("Transfer ke Unit")%></label></b></td>
                                    <td>
                                        <dxe:ASPxComboBox ID="cboToServiceUnitOrder" ClientInstanceName="cboToServiceUnitOrder" Width="100%" runat="server">
                                        </dxe:ASPxComboBox>
                                    </td>
                                </tr>
                            </table>
