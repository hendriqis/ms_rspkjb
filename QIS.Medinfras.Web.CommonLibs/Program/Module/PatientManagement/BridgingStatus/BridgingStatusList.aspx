<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="BridgingStatusList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.BridgingStatusList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            function getHealthcareServiceUnitFilterExpression() {
                var filterExpression = "HealthcareID = '" + AppSession.healthcareID + "' AND DepartmentID = '" + cboPatientFrom.GetValue() + "' AND IsUsingRegistration = 1";
    ...
    <div style="padding:15px">
        ...
        <div class="pageTitle"><%=GetLabel("Status Bridging : Radiologi")%></div>
                    ...
                    <fieldset id="fsPatientList"> 
                        <table class="tblEntryContent" style="width:60%;">
                            ...
                            <tr id="trServiceUnitOrder" runat="server">
                                ...
                                <td>
                                    <dxe:ASPxComboBox ID="cboMedicalDiagnostic" ClientInstanceName="cboMedicalDiagnostic" runat="server" Width="350px">
