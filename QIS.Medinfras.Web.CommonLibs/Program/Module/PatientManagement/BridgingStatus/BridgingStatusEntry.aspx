<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="BridgingStatusEntry.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.BridgingStatusEntry" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnResendBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Libs/Program/Module/PatientManagement/BridgingStatus/BridgingStatusList.aspx');
            });
                                                    ...
                                                    <tr>
                                                        <th style="width: 40px" rowspan="2">
                                                            <div style="padding: 3px">
                                                                <asp:CheckBox ID="chkSelectAll" runat="server" CssClass="chkSelectAll" Visible="false" />
                                                            </div>
                                                        </th>
                                                        ...
                                                        <th colspan="3">
                                                            <%=GetLabel("Test Order Information")%>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <th style="width: 120px">
                                                            <div style="text-align: center; padding-right: 3px">
                                                                <%=GetLabel("Test Order Date")%>
                                                            </div>
                                                        </th>
                                                        <th style="width: 150px">
                                                            <div style="text-align: center; padding-right: 3px">
                                                                <%=GetLabel("Test Order No")%>
                                                            </div>
                                                        </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="padding: 3px; text-align: left;">
                                                            <div>
                                                                <%#: Eval("TestOrderPhysician")%></div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div style="padding: 3px; text-align: center;">
                                                            <div>
                                                                <%#: Eval("ReferenceNo")%></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
