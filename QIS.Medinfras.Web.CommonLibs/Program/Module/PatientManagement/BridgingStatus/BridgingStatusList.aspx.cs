...
{
    public partial class BridgingStatusList : BasePageRegisteredPatient
    {
        ...
        public override void OnGrdRowClick(string visitID)
        {
            ...
            string url = "";
            url = string.Format("~/Libs/Program/Module/PatientManagement/BridgingStatus/BridgingStatusEntry.aspx?id={0}|{1}", healthcareServiceUnitID, visitID);
