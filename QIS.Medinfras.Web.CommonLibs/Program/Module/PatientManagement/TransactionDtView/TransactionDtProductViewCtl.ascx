<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransactionDtProductViewCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionDtProductViewCtl" %>
...
<script type="text/javascript" id="dxss_transactiondtproductviewctl">
    $(function () {
        ...
        <LayoutTemplate>
            <table id="tblView" runat="server" class="grdNormal notAllowSelect" cellspacing="0"
                ...
                <tr id="Tr2" class="trFooter" runat="server">
                    <td colspan="12" align="right" style="padding-right: 3px">
                        <%=GetLabel("Total") %>
                    </td>
                ...
                <td>
                    <div style="padding: 3px">
                        ...
                        <div style="font-size:smaller">
                            <i><b>
                                <%#: Eval("TransactionNo")%></b> (<%#: Eval("TransactionStatus")%>)</i></div>
                        <div style="font-size:smaller">
                            <i><b>
                                <%#: Eval("PatientBillingNo")%></b></i></div>
                    </div>
                </td>
                <td>
                    <div style="padding: 3px;">
