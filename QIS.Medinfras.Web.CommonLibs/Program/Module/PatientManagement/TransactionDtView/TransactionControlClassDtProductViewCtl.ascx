<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransactionControlClassDtProductViewCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionControlClassDtProductViewCtl" %>
...
<script type="text/javascript" id="dxss_transactioncontrolclassdtproductviewctl">
    $(function () {
