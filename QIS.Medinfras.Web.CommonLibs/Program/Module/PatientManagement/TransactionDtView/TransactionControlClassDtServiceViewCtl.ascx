<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransactionControlClassDtServiceViewCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionControlClassDtServiceViewCtl" %>
...
<script type="text/javascript" id="dxss_transactioncontrolclassdtserviceviewctl">
    $(function () {
