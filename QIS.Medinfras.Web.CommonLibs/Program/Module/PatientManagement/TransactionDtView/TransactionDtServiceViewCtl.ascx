<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransactionDtServiceViewCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionDtServiceViewCtl" %>
