...
{
    public partial class DraftPrescriptionOrderDtServiceViewCtl : BaseUserControlCtl
    {
        public void BindGrid(List<vDraftPrescriptionOrderDt> lstPrescriptionOrderDt)
        {
            lvwTestOrder.DataSource = lstPrescriptionOrderDt;
