<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransactionDtServiceView1Ctl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionDtServiceView1Ctl" %>
...
<script type="text/javascript" id="dxss_transactiondtserviceviewctl">
</script>
<input type="hidden" value="0" id="hdnShowCheckbox" runat="server" /> 
        ...
        <tr>
            ...
            <td>
                <div style="padding: 3px; text-align: right;">
                    ...
                    <div>
                        <%#: Eval("LastUpdatedDateInString")%></div>
                </div>
            </td>
        </tr>
    </ItemTemplate>
