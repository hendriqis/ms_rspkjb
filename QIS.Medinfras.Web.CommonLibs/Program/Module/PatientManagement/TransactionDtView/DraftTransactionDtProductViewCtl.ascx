<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DraftTransactionDtProductViewCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.DraftTransactionDtProductViewCtl" %>
...
<script type="text/javascript" id="dxss_drafttransactiondtproductviewctl">
    $(function () {
