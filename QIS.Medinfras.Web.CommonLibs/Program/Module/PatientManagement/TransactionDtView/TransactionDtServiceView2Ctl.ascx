<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransactionDtServiceView2Ctl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionDtServiceView2Ctl" %>
