<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="PatientAppointmentInformation.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientAppointmentInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <script type="text/javascript">
        ...
        function onCboRegistrationStatusChanged() {
            cbpView.PerformCallback('refresh');
        }
                            ...
                            <tr id="trRegistrationStatus" runat="server">
                                ...
                                <td>
                                    <dxe:ASPxComboBox ID="cboRegistrationStatus" ClientInstanceName="cboRegistrationStatus"
                                        ...
                                        <ClientSideEvents ValueChanged="function(s,e) { onCboRegistrationStatusChanged(); }" />
                                    </dxe:ASPxComboBox>
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <tr runat="server" id="trItem">
                                                ...
                                                <td align="left">
                                                    <div>
                                                        ...
                                                        -
                                                        <%#: Eval("ParamedicName") %>
                                                        <input type="hidden" class="hdnFromVisitID" value='<%#: Eval("FromVisitID") %>' />
                                                    </div>
                                                </td>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <div style="padding: 3px; text-align: center;">
                                                        <asp:CheckBox ID="chkIsFromMobileApps" runat="server" Checked='<%# Eval("cfIsFromMobileApps")%>'
                                                            Enabled="false" />
                                                    </div>
                                                </td>
                                                <td align="center">
