<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="TransferPatientBillDetail.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransferPatientBillDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnTransferPatientBillBack" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/back.png")%>' alt="" /><div><%=GetLabel("Back")%></div></li>
    <li id="btnTransferPatientBillProcess" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbprocess.png")%>' alt="" /><div><%=GetLabel("Transfer")%></div></li>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    <script type="text/javascript" id="dxss_generatebilldtctl">
        function onLoad() {
            ...
            $('#<%=btnTransferPatientBillBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/PatientList/RegistrationList.aspx?id=tpb');
            });

            $('#<%=btnTransferPatientBillProcess.ClientID %>').click(function () {
        ...
        function onCbpProcessEndCallback(s) {
            ...
            if (param[0] == 'fail')
                ...
                showToast('Transfer Success', '', function () {
                    $('#<%=btnTransferPatientBillBack.ClientID %>').click();
                });
            }
            hideLoadingPanel();
        }
                ...
                <td style="padding-top: 5px;">
                    <table id="tblInfoOutstandingBill" runat="server">
                        <tr>
                            ...
                            <td><label class="lblInfo" id="lblInfoOutstandingBill"><%=GetLabel("Masih Ada Tagihan Yang Belum Lunas atau Order Yang Belum Direalisasi") %></label></td>
                        </tr>
                    </table>
