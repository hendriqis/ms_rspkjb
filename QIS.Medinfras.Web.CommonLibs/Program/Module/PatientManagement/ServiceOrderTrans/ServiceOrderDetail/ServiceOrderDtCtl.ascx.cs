...
{
    public partial class ServiceOrderDtCtl : BaseViewPopupCtl
    {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(hdnListServiceOrderDtID.Value))
                {
                    ...
                    foreach (string orderID in tempListOrderDt)
                    {
                        ...
                        decimal grossLineAmount = ServiceDt.ItemQty * price;
                        ...
                        totalDiscountAmount = (totalDiscountAmount1 + totalDiscountAmount2 + totalDiscountAmount3) * (ServiceDt.ItemQty);
                        ...
                        patientChargesDt.UsedQuantity = patientChargesDt.BaseQuantity = patientChargesDt.ChargedQuantity = ServiceDt.ItemQty;
