<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceOrderDtAIOCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ServiceOrderDtAIOCtl" %>
                ...
                <fieldset id="fsMPPopupEntry">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr id="trOrderDateTime" runat="server">
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txtServiceOrderTime" CssClass="time" runat="server" Width="100px"
                        ...
                        <tr id="trTransactionDateTime" runat="server">
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txtRealizationTime" CssClass="time" runat="server" Width="100px"
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-VerticalAlign="Top"
