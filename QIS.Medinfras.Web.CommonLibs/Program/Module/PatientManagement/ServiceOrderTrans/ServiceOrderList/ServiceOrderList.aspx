<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="ServiceOrderList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ServiceOrderList" %>
                            ...
                            <table class="tblEntryContent" style="width: 60%;">
                                ...
                                <tr id="trRegistrationDate">
                                    ...
                                    <td colspan="2">
                                        ...
                                        <asp:CheckBox ID="chkIsPreviousEpisodePatientReg" runat="server" Checked="false"
                            ...
                            <table class="tblEntryContent" style="width: 60%;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <asp:CheckBox ID="chkIsPreviousEpisodePatientOrder" runat="server" Checked="false"
                                            Text="Abaikan Tanggal" />
                                    </td>
                                </tr>
                                <tr>
