...
{
    public partial class ServiceOrderAIOList : BasePagePatientOrder
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            switch (id)
            {
                case "eo": return Constant.MenuCode.EmergencyCare.SERVICE_ORDER_TRANS_AIO;
                case "op": return Constant.MenuCode.Outpatient.SERVICE_ORDER_TRANS_AIO;
                default: return Constant.MenuCode.EmergencyCare.SERVICE_ORDER_TRANS_AIO;
            }            
        }
        ...
        public override string GetFilterExpression()
        {
            ...
            string filterExpression = string.Format("GCVisitStatus NOT IN ('{0}','{1}','{2}')",
        ...
        public override void OnGrdRowClickTestOrder(string transactionNo, string serviceOrderID)
        {
            ...
            if (hdnSetVarMenuRealisasi.Value == "0")
            {
                url = string.Format("~/Libs/Program/Module/PatientManagement/TransactionPage/PatientUse/PatientManagementTransactionUseDetailAIO.aspx?id={0}|{1}|{2}", type, serviceOrderID, transactionNo);
            }
            else
            {
                url = string.Format("~/Libs/Program/Module/PatientManagement/Transaction/PatientManagementTransactionDetailAIO.aspx?id={0}|{1}|{2}", type, serviceOrderID, transactionNo);
            }
