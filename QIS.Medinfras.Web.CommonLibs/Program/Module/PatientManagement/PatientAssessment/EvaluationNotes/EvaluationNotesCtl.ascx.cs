...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class EvaluationNotesCtl : BasePagePatientPageEntryCtl
    {
        ...
        {
            SetControlEntrySetting(txtJournalDate, new ControlEntrySetting(true, true, true, AppSession.RegisteredPatient.VisitDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT)));
            SetControlEntrySetting(txtJournalTime, new ControlEntrySetting(true, true, true, AppSession.RegisteredPatient.VisitTime));
