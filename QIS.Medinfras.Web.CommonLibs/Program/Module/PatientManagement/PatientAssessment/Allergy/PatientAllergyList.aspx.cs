...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class PatientAllergyList : BasePagePatientPageList
    {
        ...
        {
            string menuCode = Constant.MenuCode.EmergencyCare.PATIENT_ALLERGY;
        ...
        {
            url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientAssessment/Allergy/PatientAllergyEntryCtl.ascx");
            queryString = "";
            popupWidth = 500;
            popupHeight = 400;
