<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    CodeBehind="NutritionSGAList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.NutritionSGAList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdNutritionPage"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ParamedicName" HeaderText="Ahli Gizi" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="cfNutritionSummary" HeaderText="Penilaian" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                            </Columns>
                            <EmptyDataTemplate>
                                <%=GetLabel("Tidak ada data Subjective Global Assessment") %>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </asp:Panel>
                </dx:PanelContent>
