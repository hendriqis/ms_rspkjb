<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    CodeBehind="ObstetricScreeningList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ObstetricScreeningList" %>
                ...
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdNutritionPage"
                            ...
                            <EmptyDataTemplate>
                                <%=GetLabel("Tidak ada data Skrining Obstetri / Partus / Post Partum") %>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </asp:Panel>
                </dx:PanelContent>
