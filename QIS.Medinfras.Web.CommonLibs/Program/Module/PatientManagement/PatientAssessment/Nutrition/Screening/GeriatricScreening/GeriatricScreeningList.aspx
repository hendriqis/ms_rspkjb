<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    CodeBehind="GeriatricScreeningList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.GeriatricScreeningList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdNutritionPage"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NutritionistName" HeaderText="Ahli Gizi" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="ScreeningScoreTotal" HeaderText="Total Penapisan" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="AssessmentScoreTotal" HeaderText="Total Pengkajian" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="OverallTotal" HeaderText="Skor Total" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="MalnutritionIndicator" HeaderText="Skor Indikator Malnutrisi" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                            </Columns>
                            <EmptyDataTemplate>
                                <%=GetLabel("Tidak ada data Mini Nutritional Assessment") %>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </asp:Panel>
                </dx:PanelContent>
