...
{
    public partial class PhysicalExam : BasePagePatientPageList
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            {
                case Constant.Facility.EMERGENCY: return Constant.MenuCode.EmergencyCare.PHYSICAL_EXAMINATION;
                default: return Constant.MenuCode.Outpatient.PHYSICAL_EXAMINATION;
            }
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vReviewOfSystemHd> lstEntity = BusinessLayer.GetvReviewOfSystemHdList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex);
        ...
        {
            url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientAssessment/PhysicalExam/PhysicalExamEntryCtl.ascx");
            queryString = "";
            popupWidth = 700;
            popupHeight = 500;
