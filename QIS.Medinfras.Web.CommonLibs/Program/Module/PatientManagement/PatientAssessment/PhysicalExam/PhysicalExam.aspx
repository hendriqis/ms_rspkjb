<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="PhysicalExam.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PhysicalExam" %>
                        ...
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <div><%=GetLabel("Pemeriksaan Fisik") %></div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <div>
                                            <b>
                                            ...
                                            <asp:Repeater ID="rptReviewOfSystemDt" runat="server">
                                                <ItemTemplate>
                                                    <div style="padding-left:20px;float:left;width:300px;">
                                                        <span style="color:Black"><strong> <%#: DataBinder.Eval(Container.DataItem, "ROSystem") %> : </strong></span>&nbsp;
                                                        <span style="color:Blue"><%#: DataBinder.Eval(Container.DataItem, "cfRemarks")%></span>
                                                    </div>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <br style="clear:both"/>
                            ...
                            <EmptyDataTemplate>
                                <%=GetLabel("Tidak ada data pemeriksaan fisik") %>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </asp:Panel>
                </dx:PanelContent>
