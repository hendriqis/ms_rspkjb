...
{
    public partial class PhysicalExamEntryCtl : BasePagePatientPageEntryCtl
    {
        ...
        {
            base.OnInit(e);
            List<StandardCode> lst = BusinessLayer.GetStandardCodeList(string.Format("ParentID = '{0}' AND IsDeleted = 0", Constant.StandardCode.REVIEW_OF_SYSTEM));
