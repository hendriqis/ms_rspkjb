<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BodyDiagramAddCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPage.BodyDiagramAddCtl" %>
...
<%@ Register Src="~/Libs/Program/Module/PatientManagement/PatientAssessment/BodyDiagram/BodyDiagramTakePhotoCtl.ascx"
...
<script type="text/javascript" id="dxss_dragctl1">
    ...
    function OnCancelClick() {
        ...
        if (totalImage > 0) {
            var message = "Are you sure to reset or clear all of your applied image ?";
    ...
    function OnSaveClick() {
        ...
        var totalImage = $("#containerApplied .content").length;
        if (totalImage == 0) {
            showToast('Warning', 'Please select and apply at least one image before save');
            return;
        }
        if ($("#<%=txtObservationTime.ClientID %>").valid()) {
            ...
            $("#containerApplied .content").each(function () {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: url,
                    data: '{ "observationDate" : "' + observationDate + '", "observationTime" : "' + observationTime + '", "imageData" : "' + image + '", "idx" : "' + idxImage++ + '", "listSymbol" : "' + $(this).find('.listImageSymbol').val() + '", "customSrc" : "' + customSrc + '", "paramedicID" : "' + paramedicID + '", "testOrderID" : "0"}',
...
<style type="text/css">
    ...
    {
        float: right;
        padding: 5px 5px 5px 5px; /*padding-top:10px;
        text-align:center;*/
        width: 60px;
        border: 1px solid #9C9898;
        height: 450px;
    ...
    <table style="width: 100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td style="width: 300px; text-align: right" valign="top">
                <table id="Table1" runat="server" cellpadding="0" width="100%">
                    <tr>
    ...
    <div class="contentFooter">
        <table cellpadding="0" cellspacing="10" style="margin-left: auto; margin-right: auto;
            ...
            <tr>
                ...
                <td>
                    <input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("Take Photo")%>' onclick="pcTakePhoto.Show();" style="width: 80px;" />
                </td>
                <td>
                    <input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("Reset")%>' id="btnReset" style="width: 80px;" />
                </td>
                <td>
                    <input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("Apply")%>' id="btnApply" style="width: 80px;" />
                </td>
                <td>
                    <input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("Save")%>' id="btnSave" style="width: 80px;" />
                </td>
                <td>
                    <input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("Cancel")%>' id="btnCancel" style="width: 80px;" />
                </td>
            </tr>
        </table>
    </div>
...
<dx:ASPxPopupControl ID="pcNotes" runat="server" ClientInstanceName="pcNotes" Height="150px"
    HeaderText="Notes" CloseAction="None" Width="350px" Modal="True" PopupAction="None"
                    ...
                    <dx:PanelContent ID="PanelContent1" runat="server">
                        <div style="text-align: center; width: 100%;">
                            ...
                            <table style="margin-left: auto; margin-right: auto; margin-top: 5px;">
                                <tr>
                                    <td>
                                        <input type="button" id="btnNotesOk" style="width: 100px" value='<%= GetLabel("Ok")%>' />
                                    </td>
                                    <td>
                                        <input type="button" id="btnNotesCancel" style="width: 100px" value='<%= GetLabel("Cancel")%>' />
                                    </td>
                                </tr>
                            </table>
                        </div>
...
<dx:ASPxPopupControl ID="pcTakePhoto" runat="server" ClientInstanceName="pcTakePhoto"
    EnableHierarchyRecreation="True" FooterText="" HeaderText="Take Photo" HeaderStyle-HorizontalAlign="Left"
    Height="400px" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
