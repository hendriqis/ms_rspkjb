...
namespace QIS.Medinfras.Web.CommonLibs.Program.PatientPage
{
    public partial class BodyDiagramAddCtl : BaseViewPopupCtl
    {
        ...
        private void GenerateThumbs()
        {
            ...
            List<StandardCode> listGroup = BusinessLayer.GetStandardCodeList(string.Format("ParentID = '{0}' AND IsDeleted = 0 ORDER BY TagProperty", Constant.StandardCode.BODY_DIAGRAM_GROUP));
