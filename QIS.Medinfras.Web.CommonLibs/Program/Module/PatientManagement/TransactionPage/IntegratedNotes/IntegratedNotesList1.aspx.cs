...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class IntegratedNotesList1 : BasePagePatientPageList
    {
        ...
        public override string OnGetMenuCode()
        {
            if (hdnSubMenuType.Value == "fo")
            {
                switch (hdnDepartmentID.Value)
                {
                    ...
                    default:
                        return Constant.MenuCode.Outpatient.FOLLOWUP_NURSING_NOTE;
                }
            }
            else
            {
                ...
                {
                    case Constant.Facility.EMERGENCY:
                        if (hdnSubMenuType.Value == "pe")
                            return Constant.MenuCode.EmergencyCare.ASSESMENT_NURSING_NOTE;
                        else
                            return Constant.MenuCode.EmergencyCare.NURSING_NOTE;
                    case Constant.Facility.INPATIENT:
                        return Constant.MenuCode.Inpatient.PATIENT_PAGE_NURSING_NOTE;
                    case Constant.Facility.DIAGNOSTIC:
                        if (hdnSubMenuType.Value == "tr") return Constant.MenuCode.MedicalDiagnostic.NURSING_NOTE_TRANSACTION;
                        else if (hdnSubMenuType.Value == "md") return Constant.MenuCode.MedicalDiagnostic.PATIENT_NURSING_NOTES;
                        else return Constant.MenuCode.MedicalDiagnostic.PATIENT_PAGE_PARAMEDIC_NOTE;
                    case Constant.Facility.LABORATORY:
                        return Constant.MenuCode.Laboratory.PATIENT_NURSING_NOTES;
                    case Constant.Facility.PHARMACY:
                        if (hdnSubMenuType.Value == Constant.MenuCode.Pharmacy.PHARMACIST_CLINICAL_PHARMACIST_NOTES)
                            return Constant.MenuCode.Pharmacy.PHARMACIST_CLINICAL_PHARMACIST_NOTES;
                        else
                            return Constant.MenuCode.Pharmacy.PHARMACIST_NOTES;
                    default:
                        return Constant.MenuCode.Outpatient.NURSING_NOTE;
                }
            }
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            else if (cboDisplay.Value.ToString() == "5")
            {
        ...
        {
            url = ResolveUrl("~/Libs/Program/Module/PatientManagement/TransactionPage/IntegratedNotes/IntegratedNotesEntryCtl1.ascx");
            queryString = "";
            popupWidth = 900;
            popupHeight = 600;
