<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="IntegratedNotes.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.IntegratedNotes" %>
    ...
    <script type="text/javascript" id="dxss_integrationnotes">
        function onBeforeRightPanelPrint(code, filter, errMessage) {
            ...
            if (id == '' || id == '0') {
                ...
                if (code == 'MR000005' || code == 'MR000007' || code == 'MR000025' || code == 'PM-00222' || code == 'MR000021' || code == 'MR000043') 
                {
        ...
        <dxcp:ASPxCallbackPanel ID="cbpView" runat="server" Width="100%" ClientInstanceName="cbpView"
            ...
            <PanelCollection>
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage" Style="height: 450px; width:97%;">
