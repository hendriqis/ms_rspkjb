...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class EvaluationNotes : BasePagePatientPageList
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            {
                case Constant.Facility.EMERGENCY: return Constant.MenuCode.EmergencyCare.NURSING_NOTE;
                case Constant.Facility.INPATIENT: return Constant.MenuCode.Inpatient.PATIENT_PAGE_NURSING_NOTE;
                case Constant.Facility.OUTPATIENT: return Constant.MenuCode.Outpatient.NURSING_NOTE;
            }
        ...
        {
            url = ResolveUrl("~/Libs/Program/Module/PatientManagement/TransactionPage/EvaluationNotes/EvaluationNotesCtl.ascx");
            queryString = "";
            popupWidth = 900;
            popupHeight = 500;
