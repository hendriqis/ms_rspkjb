<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NurseExtendOrderDurationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.NurseExtendOrderDurationCtl" %>
                            ...
                            <td style="vertical-align:top">
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                    <tr>
                                        ...
                                        <td><asp:CheckBox ID="chkIsGenerateJournal" runat="server" Text=" Jurnal Perawat" ToolTip="Generate Jurnal" Checked="true" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                    ...
                                    <asp:ListView runat="server" ID="lvwExtendView" OnItemDataBound="lvwExtendView_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="width: 40px;"><input type="text" class="txtMedicationTime1" value="<%#:Eval("Sequence1Time") %>" style="width:60px; text-align:center" /></td>
                                                <td style="width: 40px;"><input type="text" class="txtMedicationTime2" value="<%#:Eval("Sequence2Time") %>" style="width:60px; text-align:center" /></td>
                                                <td style="width: 40px;"><input type="text" class="txtMedicationTime3" value="<%#:Eval("Sequence3Time") %>" style="width:60px; text-align:center" /></td>
                                                <td style="width: 40px;"><input type="text" class="txtMedicationTime4" value="<%#:Eval("Sequence4Time") %>" style="width:60px; text-align:center" /></td>
                                                <td style="width: 40px;"><input type="text" class="txtMedicationTime5" value="<%#:Eval("Sequence5Time") %>" style="width:60px; text-align:center" /></td>
                                                <td style="width: 40px;"><input type="text" class="txtMedicationTime6" value="<%#:Eval("Sequence6Time") %>" style="width:60px; text-align:center" /></td>
