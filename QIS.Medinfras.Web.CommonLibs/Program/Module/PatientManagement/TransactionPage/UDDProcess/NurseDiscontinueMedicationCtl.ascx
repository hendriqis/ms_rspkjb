<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NurseDiscontinueMedicationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.NurseDiscontinueMedicationCtl" %>
                            ...
                            <td style="vertical-align:top">
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                    <tr>
                                        ...
                                        <td><asp:CheckBox ID="chkIsGenerateJournal" runat="server" Text=" Catatan Perawat" ToolTip="Generate Catatan" Checked="true" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <div style="position: relative;"> 
                            <table border="0" cellpadding="1" cellspacing="0" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtJournalNoteText" Width="100%" runat="server" TextMode="MultiLine" />
                                    </td>
                                </tr>
                                <tr>
                                    <td />
