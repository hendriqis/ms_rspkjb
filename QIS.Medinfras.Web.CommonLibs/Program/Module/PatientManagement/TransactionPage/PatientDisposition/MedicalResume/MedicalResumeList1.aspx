<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="MedicalResumeList1.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.MedicalResumeList1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript" id="dxss_IPInitialAssessmentList">
        $(function () {
            ...
            $('#<%=btnPreview.ClientID %>').click(function (evt) {
                var ohdnDeptType = $('#<%=hdnDeptType.ClientID %>').val();
                var ohdnMenuType = $('#<%=hdnMenuType.ClientID %>').val();
                var ohdnID = $('#<%=hdnID.ClientID %>').val();
                if (ohdnID != null && ohdnID != "") {
                    var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/TransactionPage/PatientDisposition/MedicalResume/MedicalResumeEntry1.aspx?id=" + ohdnDeptType + "|" + ohdnMenuType + "|" + ohdnID);
                    document.location = url;
                } else {
                    displayErrorMessageBox('PREVIEW', 'Maaf, Tidak ada data Resume Medis yang dapat dilihat saat ini.');
                }
            });
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if (hdnID == '' || hdnID == '0') {
                if (code == 'PM-00425' || code == 'MR000016' || code == 'PM-00160' || code == 'PM-00524') {
                ...
                else if (code == 'MR000013' || code == 'MR000017' || code == 'MR000052') {
                    ...
                    return false;
                     ...
                     code == 'PM-90019' || code == 'PM-90020' || code == 'PM-90022' || code == 'PM-90023' || code == 'PM-90035' || code == 'PM-90040' ||
                     code == 'PM-90063' || code == 'MR000009' || code == 'PM-90056' || code == 'MR000050' || code == 'MR000052' || code == 'MR000042' ||
                     code == 'MR000058' || code == 'PM-90114' || code == 'PM-90117' || code == 'PM-90118') {
                filterExpression.text = visitID;
                return true;
            }
