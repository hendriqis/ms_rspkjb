...
{
    public partial class NutritionInterventionList : BasePagePatientPageList
    {
        protected int PageCount = 1;

        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Nutrition.NUTRITION_INTERVENTION_NOTES;
        }
        ...
        {
            url = ResolveUrl("~/libs/Program/Module/PatientManagement/TransactionPage/Nutrition/NutritionIntervention/NutritionInterventionCtl.ascx");
            queryString = String.Format("add|{0}", hdnVisitID.Value);
            popupWidth = 800;
            popupHeight = 400;
            popupHeaderText = "Catatan Intervensi Gizi";
            return true;
        }
