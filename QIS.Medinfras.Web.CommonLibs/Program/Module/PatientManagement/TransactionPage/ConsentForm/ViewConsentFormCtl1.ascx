<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewConsentFormCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPage.ViewConsentFormCtl1" %>
            ...
            <td style="vertical-align: top">
                <div id="leftPageNavPanel" class="w3-border" style="width:150px">
                    <ul>
                        ...
                        <li contentID="divPage2" contentIndex="2" title="Materi Edukasi" class="w3-hover-red">Consent Form</li>
                        <li contentID="divPage3" contentIndex="3" title="Evaluas Edukasi" class="w3-hover-red">Tanda Tangan</li>
                    </ul>
                </div>
            </td>
            <td style="padding:5px;vertical-align:top;">
                <div id="divPage1" class="w3-border divPageNavPanelContent w3-animate-left" style="display: none">
                   <table class="tblEntryContent" style="width:99%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblMandatory">
                                    <%=GetLabel("Saksi-1")%></label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="txtSignature3Name" Width="350px" runat="server" Style="text-align:left" ReadOnly="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <label class="lblMandatory">
                                    <%=GetLabel("Saksi-2")%></label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="txtSignature4Name" Width="350px" runat="server" Style="text-align:left" ReadOnly="true" />
                            </td>
                        </tr>
                  </table>             
                </div>
                <div id="divPage2" class="w3-border divPageNavPanelContent w3-animate-left" style="display: none">
                    <table class="tblEntryContent" style="width:99%">
                        ...
                        <tr>
                            <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Kelompok")%></label></td>
                            <td>
                                <asp:TextBox ID="txtGroup" CssClass="txtGroup" runat="server" Width="100%" ReadOnly="true"  />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Form")%></label></td>
                            <td>
                                <asp:TextBox ID="txtType" CssClass="txtType" runat="server" Width="100%" ReadOnly="true"  />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                <table border="0" cellpadding="1" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:RadioButtonList ID="rblIsReadAndUnderstand" runat="server" RepeatDirection="Horizontal" Enabled="false">
                            ...
                            <td colspan="2">
                                <table border="0" cellpadding="1" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:RadioButtonList ID="rblIsApproveOrReject" runat="server" RepeatDirection="Horizontal" Enabled="false">
                                                <asp:ListItem Text=" Ya" Value="1" />
                                                <asp:ListItem Text=" Tidak" Value="0"  />
                                            </asp:RadioButtonList>
                                        </td>
