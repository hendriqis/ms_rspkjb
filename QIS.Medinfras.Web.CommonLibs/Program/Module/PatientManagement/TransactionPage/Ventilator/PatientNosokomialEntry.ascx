<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientNosokomialEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientNosokomialEntry" %>
...
<script type="text/javascript" id="dxss_vitalsignentryctl">
    ...
    function onAfterSaveAddRecordEntryPopup(result) {
        if (typeof onRefreshNosokomialGrid == 'function')
            onRefreshNosokomialGrid();
    }
