<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewNosokomialEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewNosokomialEntryCtl" %>
...
<div style="height: auto">
    <input type="hidden" runat="server" id="hdnHeaderID" value="" />
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtObservationDate" Width="120px" runat="server" Style="text-align: center" ReadOnly="true" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="vertical-align:top">
                            <asp:TextBox ID="txtRemarks" Width="100%" runat="server" TextMode="MultiLine" Rows="2" runat="server" ReadOnly="true" />
                        </td>
                    </tr>
                </table>
            </td>
