<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx2.master"
    AutoEventWireup="true" CodeBehind="MedicationChartList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.MedicationChartList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnProcess.ClientID %>').click(function () {
                ...
                if ($('#<%=hdnParamNR0001.ClientID %>').val() == "0" || $('#<%=hdnParamNR0001.ClientID %>').val() == "") {
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage2">
                                <asp:GridView runat="server" ID="grdView" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PastMedicationID" HeaderStyle-CssClass="hiddenColumn"
                                    ...
                                    <EmptyDataTemplate>
                                        <div style="font-weight: bold; color: red; font-size: 1.1em; padding-top: 7px">
                                            <%=GetLabel("no medication schedulled for this patient")%></div>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </asp:Panel>
                        </dx:PanelContent>
                                                                    ...
                                                                    <td align="center">
                                                                        ...
                                                                        <div class="divSTATUS divOverDue" <%# Eval("MedicationDisplayStatus").ToString() != "OVERDUE" ? "Style='display:none'":"" %>>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    <td style="width: 80%">
                                                                                        <label class="blink-medication-overdue">
                                                                                            <%#: Eval("MedicationTime") %></label>
                                                                                    </td>
                                                                                    <td style="width: 20%" valign="top">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                            <tr>
                                                                                        ...
                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="padding-top: 4px">
                                                                                                    ...
                                                                                                    <div <%# Eval("cfIsNeedToReturn").ToString() != "True" ? "Style='display:none'":"" %>>
                                                                                                        <img class="btnInfo blink-alert" src='<%# ResolveUrl("~/Libs/Images/Button/warning.png") %>'
                                                                                                            alt="<%#:Eval("ID") %>" style="width: 24px" title="Obat sudah diproses oleh Farmasi (Harus diretur)" />
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
