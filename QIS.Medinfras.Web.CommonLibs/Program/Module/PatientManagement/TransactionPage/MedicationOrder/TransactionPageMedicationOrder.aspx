<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx2.master"
    AutoEventWireup="true" CodeBehind="TransactionPageMedicationOrder.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionPageMedicationOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onGetDrugFilterExpression() {
            ...
            var menuType = $('#<%=hdnMenuType.ClientID %>').val();
            ...
            if (menuType == 'al') {
                filterExpression += " AND GCItemType = 'X001^003'";
            }
        ...
        $('#lblTestOrderQuickPick').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                ...
                var id = orderID + '|' + locationID + '|' + defaultGCMedicationRoute + '|' + paramedicID + '|' + registration + '|' + visitID + '|' + chargeClassID + '|' + orderNotes + '|' + dispensaryServiceUnitID + '|' + date + '|' + time + '|' + prescriptionType + '|' + menuType;
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if ($('#<%=txtPrescriptionOrderNo.ClientID %>').val() != '') {
                if (TransactionStatus == Constant.TransactionStatus.OPEN) {
                    ...
                    if (code == 'PM-00529' || code == 'PM-00540' || code == 'PM-00557' || code == 'PM-00573') {
                        filterExpression.text = 'prescriptionOrderID = ' + prescriptionOrderID;
                        return true;
                    }
                    else if (code == 'PM-00534') {
                ...
                errMessage.text = 'Mohon pilih No. Order / buat order baru terlebih dahulu!';
                return false;
            }
        }
        //#endregion
        ...
        function onBeforeLoadRightPanelContent(code) {
            if ($('#<%=txtPrescriptionOrderNo.ClientID %>').val() != '') {
                if (code == 'prescriptionOrderChangesLogNotes') {
