...
{
    public partial class TransactionPageMedicationOrder1 : BasePageTrx
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            //string filterExpression = string.Format("HealthcareID = '{0}' AND ParameterCode IN ('{1}','{2}')", AppSession.UserLogin.HealthcareID, Constant.SettingParameter.IM_TRANSAKSI_OBAT_HANYA_TIPE_DISTRIBUSI, Constant.SettingParameter.DEF);
            //List<SettingParameterDt> lstParam = BusinessLayer.GetSettingParameterDtList();
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(cboLocation, new ControlEntrySetting(true, true, true));
            ...
            try
            {
                ...
                if (entity.GCTransactionStatus == Constant.TransactionStatus.OPEN)
                {
                    ...
                    foreach (PrescriptionOrderDt entityDt in lstEntityDt)
                    {
                        ...
                        entityDt.LastUpdatedBy = AppSession.UserLogin.UserID;
                        BusinessLayer.UpdatePrescriptionOrderDt(entityDt);
                    }
        ...
        private bool OnSaveAddRecordEntityDt(ref string errMessage, ref int prescriptionOrderID, ref string isAllow)
        {
            ...
            if (result || isAllow.Equals("confirm"))
            {
                ...
                {
                    SavePrescriptionOrderHd(ctx, ref prescriptionOrderID);
                    if (prescriptionOrderHdDao.Get(prescriptionOrderID).GCTransactionStatus == Constant.TransactionStatus.OPEN)
                    {
