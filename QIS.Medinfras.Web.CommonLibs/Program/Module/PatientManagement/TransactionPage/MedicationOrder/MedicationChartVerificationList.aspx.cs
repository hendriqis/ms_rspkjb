...
{
    public partial class MedicationChartVerificationList : BasePageTrx
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            hdnParamNR0001.Value = AppSession.NR0001;

            List<SettingParameterDt> lstSettingParameterDt = BusinessLayer.GetSettingParameterDtList(string.Format("HealthcareID = '{0}' AND ParameterCode IN ('{1}','{2}')", AppSession.UserLogin.HealthcareID, Constant.SettingParameter.PATIENT_GRID_REFRESH_INTERVAL, Constant.SettingParameter.PH_SEQUENCE_FOR_MEDICATION_LIST));
