<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewLaborStageEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewLaborStageEntry" %>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtLaborStageDate" Width="120px" runat="server" ReadOnly="true"  />
                        </td>
                        <td>
