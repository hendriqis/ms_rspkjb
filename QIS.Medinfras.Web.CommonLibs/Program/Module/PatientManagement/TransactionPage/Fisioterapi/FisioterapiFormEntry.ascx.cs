...
{
    public partial class FisioterapiFormEntry : BasePagePatientPageEntryCtl
    {
        ...
        private void PopulateFormContent()
        {
            ...
            string fileName = string.Format(@"{0}\medicalForm\Fisioterapi\{1}.html", filePath, hdnFormType.Value.Replace('^', '_'));
