<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx2.Master"
    AutoEventWireup="true" CodeBehind="PatientAccompanyCharges.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientAccompanyCharges" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onBeforeLoadRightPanelContent(code) {
            if (code == 'sendOrderToRIS') {
                return $('#<%:hdnTransactionHdID.ClientID %>').val();
            }
            else if (code == 'transactionNotes') {
                return $('#<%:hdnRegistrationID.ClientID %>').val();
            }
            else {
                return $('#<%:hdnRegistrationID.ClientID %>').val();
