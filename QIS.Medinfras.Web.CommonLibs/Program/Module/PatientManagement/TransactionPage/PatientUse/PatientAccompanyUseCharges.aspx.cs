...
{
    public partial class PatientAccompanyUseCharges : BasePageTrxPatientManagement
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            string menuCode = Constant.MenuCode.Inpatient.PATIENT_TRANSACTION_PAGE_PATIENT_ACCOMPANY_USE;
            ...
            try
            {
                ...
                if (entity.PatientBillingID == null && entity.GCTransactionStatus == Constant.TransactionStatus.OPEN)
                {
                    ...
                    if (isProcessCharges)
                    {
                        ...
                        oChargesHD.ProposedBy = AppSession.UserLogin.UserID;
                        oChargesHD.ProposedDate = DateTime.Now;
