<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientUseDetailLogisticReturnCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientUseDetailLogisticReturnCtl" %>
...
<script type="text/javascript" id="dxss_ptlgrtctl">
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><asp:TextBox ID="txtLogisticReturnLocationName" runat="server" Width="100%" ReadOnly="true" /></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                <table style="width:100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td><asp:TextBox ID="txtLogisticReturnItemCode" ReadOnly="true" Width="100%" runat="server" /></td>
                                        <td>&nbsp;</td>
                                        <td><asp:TextBox ID="txtLogisticReturnItemName" ReadOnly="true" Width="100%" runat="server" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="txtLogisticReturnQtyUsed" Width="100%" ReadOnly="true" CssClass="number" runat="server" /></td>
                            <td><asp:TextBox ID="txtLogisticReturnQtyUoM" Width="100%" ReadOnly="true" CssClass="number" runat="server" /></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="txtLogisticReturnBaseQty" ReadOnly="true" CssClass="number" Width="100%" runat="server" /></td>
                            <td><asp:TextBox ID="txtLogisticReturnConversion" ReadOnly="true" Width="100%" runat="server" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
...
<dxcp:ASPxCallbackPanel ID="cbpLogisticReturn" runat="server" Width="100%" ClientInstanceName="cbpLogisticReturn"
    ...
    <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }"
        EndCallback="function(s,e) { onCbpLogisticReturnEndCallback(s); }" />
    <PanelCollection>
        <dx:PanelContent ID="PanelContent2" runat="server">
            <asp:Panel runat="server" ID="Panel1" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                ...
                <asp:ListView ID="lvwLogisticReturn" runat="server">
                    <LayoutTemplate>                                
                        <table id="tblView" runat="server" class="grdLogisticReturn grdNormal notAllowSelect" cellspacing="0" rules="all" >
                            <tr> 
                            ...
                            <td align="center">
                                <div>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="width:24px">
                                                <img class="imgLogisticReturnVerified" <%# IsEditable.ToString() == "True" && Eval("IsVerified").ToString() == "True" ? "" : "style='display:none'"%> title='<%=GetLabel("Verified")%>' src='<%# ResolveUrl("~/Libs/Images/Button/verify.png")%>' alt="" />
                                                <img class="imgLogisticReturnApprove imgLink" <%# IsEditable.ToString() == "False" || Eval("IsVerified").ToString() == "True" || (Eval("IsVerified").ToString() == "False" && Eval("IsApproved").ToString() == "True") ? "style='display:none'" : ""%> title='<%=GetLabel("Approve This Item")%>' src='<%# ResolveUrl("~/Libs/Images/Button/unlock.png")%>' alt="" />
                                                <img class="imgLogisticReturnVoid imgLink" <%# IsEditable.ToString() == "False" || Eval("IsVerified").ToString() == "True" || (Eval("IsVerified").ToString() == "False" && Eval("IsApproved").ToString() == "False") ? "style='display:none'" : ""%> title='<%=GetLabel("Void This Item")%>' src='<%# ResolveUrl("~/Libs/Images/Button/lock.png")%>' alt="" />
                                            </td>
                                            <td style="width:1px">&nbsp;</td>
                                            <td style="width:24px"><img class="imgLogisticReturnDelete imgLink" <%# Eval("IsApproved").ToString() == "True" || Eval("IsVerified").ToString() == "True" ? "style='display:none'" : ""%> title='<%=GetLabel("Delete")%>' src='<%# ResolveUrl("~/Libs/Images/Button/delete.png")%>' alt="" /></td>
                                        </tr>
                                    </table>
                ...
                <div style="width:100%;text-align:center">
                    <span class="lblLink" id="lblLogisticReturnQuickPick"><%= GetLabel("Quick Pick")%></span>
                </div>
            </asp:Panel>
        </dx:PanelContent>
    </PanelCollection>
