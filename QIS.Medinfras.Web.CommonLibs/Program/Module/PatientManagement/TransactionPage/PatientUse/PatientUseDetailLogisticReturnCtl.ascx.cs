...
{
    public partial class PatientUseDetailLogisticReturnCtl : BaseUserControlCtl
    {
        ...
        private void BindGridLogisticReturn()
        {
            ...
            if (transactionID != "")
                filterExpression = string.Format("TransactionID = {0} AND UsedQuantity < 0 AND GCItemType IN ('{1}') AND IsDeleted = 0", transactionID, Constant.ItemGroupMaster.LOGISTIC);
