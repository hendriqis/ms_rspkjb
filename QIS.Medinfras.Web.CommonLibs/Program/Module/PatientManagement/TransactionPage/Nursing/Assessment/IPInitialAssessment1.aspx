 <%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master" ValidateRequest="false"
    AutoEventWireup="true" CodeBehind="IPInitialAssessment1.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.IPInitialAssessment1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        ...
        $('#lblAddROS').live('click', function (evt) {
            ...
            openUserControlPopup("~/libs/Controls/EMR/_PopupEntry/ReviewOfSystem/ROSEntry1Ctl.ascx", param, "Pemeriksaan Fisik", 700, 500);
        });
                                                ...
                                                <dx:PanelContent ID="PanelContent2" runat="server">
                                                    <asp:Panel runat="server" ID="Panel1" CssClass="pnlContainerGridPatientPage">
                                                        <asp:GridView ID="grdEducationView" runat="server" CssClass="grdSelected grdPatientPage"
                                                            AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdEducationView_RowDataBound">
                                                            <Columns>
                                                                <asp:BoundField DataField="ID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                                                <asp:TemplateField HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="hiddenColumn">
                                                                    <ItemTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <div>
                                                                            <asp:Repeater ID="rptPatientEducationDt" runat="server" >
                                                                                <ItemTemplate>
                                                                                    <div style="padding-left:20px;float:left;width:300px;">
                                                                                        <span style="color:Black"><strong> <%#: DataBinder.Eval(Container.DataItem, "EducationType") %> : </strong></span>&nbsp;
                                                                                        <span style="color:Blue"><%#: DataBinder.Eval(Container.DataItem, "Remarks")%></span>
                                                                                    </div>
                                                                                </ItemTemplate>
                                                                                <FooterTemplate>
                                                                                    <br style="clear:both"/>
