<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="ERInitialAssessmentList1.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ERInitialAssessmentList1" %>
    ...
    <script type="text/javascript" id="dxss_IPInitialAssessmentList">
        $(function () {
            ...
            $('.btnView').live('click', function () {
                ...
                openUserControlPopup(url, visitID, 'Kajian Awal Pasien Rawat Darurat (IGD)', 1300, 600);
            });
