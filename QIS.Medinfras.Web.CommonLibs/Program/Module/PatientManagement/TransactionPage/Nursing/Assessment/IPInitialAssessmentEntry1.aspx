<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    ValidateRequest="false" AutoEventWireup="true" CodeBehind="IPInitialAssessmentEntry1.aspx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.IPInitialAssessmentEntry1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        $(function () {
            ...
            $('#<%=grdNursingDiagnosisView.ClientID %> tr:gt(0):not(.trEmpty)').live('click', function () {
                $('#<%=grdNursingDiagnosisView.ClientID %> tr.selected').removeClass('selected');
                $(this).addClass('selected');
                $('#<%=hdnNursingDiagnosisID.ClientID %>').val($(this).find('.keyField').html());
            });
            $('#<%=grdNursingDiagnosisView.ClientID %> tr:eq(1)').click();
            ...
            function submitDiagnosis()
            {
                if ($('#<%=hdnEntryDiagnoseID.ClientID %>').val() != '') {
                    if ($('#<%=hdnDiagnosisProcessMode.ClientID %>').val() == "1")
                        cbpNursingDiagnosis.PerformCallback('add');
                    else
                        cbpNursingDiagnosis.PerformCallback('edit');
                }
                else {
        ...
        function SetAllergyEntityToControl(param) {
            ...
            if (selectedObj.GCAllergenType == '0127^DA') {
                $('#<%:lblAllergenName.ClientID %>').attr('class', 'lblLink');
                $('#<%:txtAllergenName.ClientID %>').attr('readonly', 'readonly');    
            }
            else {
                $('#<%:lblAllergenName.ClientID %>').removeAttr('class');
                $('#<%:txtAllergenName.ClientID %>').removeAttr('readonly');
            }
...
//            var visitNoteID = <%=HttpUtility.HtmlEncode(GetVisitNoteID())%>;
        ...
        function GetCurrentSelectedDiagnosis(s) {
            ...
            $('#<%=grdNursingDiagnosisView.ClientID %> tr:eq(' + idx + ')').click();

            $row = $('#<%=grdNursingDiagnosisView.ClientID %> tr.selected');
            var selectedObj = {};
        ...
        $('.imgDeleteDiagnosis.imgLink').live('click', function () {
            ...
            displayConfirmationMessageBox('MASALAH KEPERAWATAN', message, function (result) {
                if (result) {
                    cbpNursingDiagnosis.PerformCallback('delete');
                }
            });
        });

        var pageCount = parseInt('<%=gridNursingDiagnosisPageCount%>');
        $(function () {
            setPaging($("#nursingDiagnosisPaging"), pageCount, function (page) {
                cbpNursingDiagnosisView.PerformCallback('changepage|' + page);
            });
        });

        function onCbpNursingDiagnosisViewEndCallback(s) {
            var param = s.cpResult.split('|');
            var isMainDiagnosisExists = s.cpRetval;
        ...
        function onCbpNursingDiagnosisEndCallback(s) {
            var param = s.cpResult.split('|');
            $('#<%=hdnDiagnosisProcessMode.ClientID %>').val('1');
            if (param[0] == '1') {
                ResetDiagnosisEntryControls();
                cbpNursingDiagnosisView.PerformCallback('refresh');
            }
            else if (param[0] == '0') {
    ...
    $('#<%:lblAllergenName.ClientID %>.lblLink').live('click', function () {
    ...
    function ontxtDrugGenericNameChanged(value) {
        ...
        Methods.getObject('GetvGenericNameList', filterExpression, function (result) {
            if (result != null) {
                $('#<%=txtAllergenName.ClientID %>').val(result.DrugGenericName);
            }
            else {
                $('#<%=txtAllergenName.ClientID %>').val('');
            }
    ...
    <div>
        ...
        <input type="hidden" value="" id="hdnNursingDiagnosisID" runat="server" />
                    ...
                    <td style="padding: 5px; vertical-align: top">
                        <table class="tblEntryContent">
                                ...
                                <td>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td style="width: 50px">
                                                <asp:CheckBox ID="chkAlloAnamnesis" runat="server" Text=" Allo" Checked="false" />
                                            </td>
                                            <td class="tdLabel">
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxComboBox ID="cboClinicalPathway" ClientInstanceName="cboClinicalPathway"
                    ...
                    <td style="vertical-align: top">
                                        ...
                                        <td>
                                            <table border="0" cellpadding="1" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="lblLink" id="lblAllergenName" runat="server">
                                                            <%=GetLabel("Jenis/Nama")%></label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtAllergenName" runat="server" ReadOnly="true" Width="150px" />
                                                    </td>
                                                    <td>
                                                        <label class="lblNormal">
                        ...
                        <div class="containerTblEntryContent">
                            <table class="tblContentArea">
                                <tr>
                                    <td>
                                        <div id="divFormContent1" runat="server" style="height: 400px; overflow-y: scroll;">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="containerTblEntryContent">
                            <table class="tblContentArea">
                                <tr>
                                    <td>
                                        <div id="divFormContent2" runat="server" style="height: 400px; overflow-y: scroll;">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="containerTblEntryContent">
                            <table class="tblContentArea">
                                <tr>
                                    <td>
                                        <div id="divFormContent3" runat="server" style="height: 400px; overflow-y: scroll;">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="containerTblEntryContent">
                            <table class="tblContentArea">
                                <tr>
                                    <td>
                                        <div id="divFormContent5" runat="server" style="height: 400px; overflow-y: scroll;">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="containerTblEntryContent containerEntryPanel1">
                            <table border="0" cellpadding="1" cellspacing="0" width="100%" style="margin-top: 2px;">
                                ...
                                <tr>
                                    <td>
                                        <div style="position: relative;">
                                            <dxcp:ASPxCallbackPanel ID="cbpNursingDiagnosisView" runat="server" Width="100%"
                                                ClientInstanceName="cbpNursingDiagnosisView" ShowLoadingPanel="false" OnCallback="cbpNursingDiagnosisView_Callback">
                                                <ClientSideEvents EndCallback="function(s,e){ onCbpNursingDiagnosisViewEndCallback(s); }" />
                                                <PanelCollection>
                                                    <dx:PanelContent ID="PanelContent2" runat="server">
                                                        <asp:Panel runat="server" ID="Panel1" CssClass="pnlContainerGrid" Style="height: 300px">
                                                            <asp:GridView ID="grdNursingDiagnosisView" runat="server" CssClass="grdSelected grdPatientPage"
                                                                AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                                                <Columns>
                                                                    <asp:BoundField DataField="ID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                                                    <asp:TemplateField HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="hiddenColumn">
        ...
        <div style="display: none">
            <dxcp:ASPxCallbackPanel ID="cbpNursingDiagnosis" runat="server" Width="100%" ClientInstanceName="cbpNursingDiagnosis"
                ShowLoadingPanel="false" OnCallback="cbpNursingDiagnosis_Callback">
                <ClientSideEvents EndCallback="function(s,e){ onCbpNursingDiagnosisEndCallback(s); }" />
            </dxcp:ASPxCallbackPanel>
        </div>
        <div style="display: none">
