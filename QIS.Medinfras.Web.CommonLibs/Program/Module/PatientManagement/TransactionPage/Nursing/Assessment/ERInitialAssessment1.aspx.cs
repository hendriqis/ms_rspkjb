...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class ERInitialAssessment1 : BasePagePatientPageList
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            {
                return Constant.MenuCode.EmergencyCare.PATIENT_PAGE_NURSE_INITIAL_ASSESSMENT;
            }
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            List<SettingParameterDt> lstSettingParameter = BusinessLayer.GetSettingParameterDtList(string.Format("ParameterCode IN ('{0}','{1}')", Constant.SettingParameter.IS_PENDAFTARAN_DENGAN_RUANG, Constant.SettingParameter.ER0010));
            ...
            hdnER0010.Value = lstSettingParameter.FirstOrDefault(p => p.ParameterCode == Constant.SettingParameter.ER0010).ParameterValue;
        ...
        protected override void SetControlProperties()
        {
            ...
            if (AppSession.UserLogin.ParamedicID != 0 && AppSession.UserLogin.ParamedicID != null)
            {
                if (!string.IsNullOrEmpty(hdnAssessmentParamedicID.Value) && hdnAssessmentParamedicID.Value != "0")
                {
                    if (Convert.ToInt32(hdnAssessmentParamedicID.Value) != AppSession.UserLogin.ParamedicID)
                        cboParamedicID.Value = hdnAssessmentParamedicID.Value;
                    else
            ...
            Helper.SetControlEntrySetting(txtTriageDate, new ControlEntrySetting(isEnabled, isEnabled, true), "mpPatientStatus");
            Helper.SetControlEntrySetting(txtTriageTime1, new ControlEntrySetting(isEnabled, isEnabled, true), "mpPatientStatus");
            Helper.SetControlEntrySetting(txtTriageTime2, new ControlEntrySetting(isEnabled, isEnabled, true), "mpPatientStatus");
            Helper.SetControlEntrySetting(txtTriageByParamedicName, new ControlEntrySetting(isEnabled, isEnabled, false), "mpPatientStatus");
            Helper.SetControlEntrySetting(chkIsTrueEmergency, new ControlEntrySetting(isEnabled, isEnabled, false), "mpPatientStatus");
        ...
        private void PopulateFormContent()
        {
            ...
            string fileName = string.Format(@"{0}\medicalForm\DischargePlanning\{1}", filePath, "dischargePlanning01.html");
        ...
        private void EntityToControl(vNurseChiefComplaint entity, vConsultVisit entityVisit)
        {
            ...
            hdnDischargePlanningLayout.Value = entity.DischargePlanningLayout;
            hdnDischargePlanningValue.Value = entity.DischargePlanningValues;
            ...
            if (entity.TriageDate != null && !string.IsNullOrEmpty(entity.TriageTime))
            {
                txtTriageDate.Text = entity.TriageDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
                txtTriageTime1.Text = entity.TriageTime.Substring(0, 2);
                txtTriageTime2.Text = entity.TriageTime.Substring(3, 2);
            }
            else
            {
                txtTriageDate.Text = DateTime.Now.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
                txtTriageTime1.Text = DateTime.Now.ToString(Constant.FormatString.TIME_FORMAT).Substring(0, 2);
                txtTriageTime2.Text = DateTime.Now.ToString(Constant.FormatString.TIME_FORMAT).Substring(3, 2);
            }
            txtTriageByParamedicName.Text = entity.TriageByParamedicName;
            chkIsTrueEmergency.Checked = entityVisit.IsTrueEmergency;
        ...
        private void ControlToEntity(NurseChiefComplaint entity, PatientVisitNote entitypvn, ConsultVisit entityVisit, Bed entityBed)
        {
            #region Chief Complaint
            ...
            entitypvn.NoteTime = string.Format("{0}:{1}", txtServiceTime1.Text, txtServiceTime2.Text);
            ...
            entityVisit.IsTrueEmergency = chkIsTrueEmergency.Checked;
            #endregion
        }
        ...
        private void UpdateConsultVisitRegistration(IDbContext ctx)
        {
            ...
            entityConsultVisit.IsTrueEmergency = chkIsTrueEmergency.Checked;
            ...
            entityRegistration.TriageByParamedicName = txtTriageByParamedicName.Text;
            entityRegistration.TriageDateTime = DateTime.Now;
            entityRegistration.TriageDate = Helper.GetDatePickerValue(txtTriageDate);
            entityRegistration.TriageTime = string.Format("{0}:{1}", txtTriageTime1.Text, txtTriageTime2.Text);
        ...
        private void OnSaveAddEditPatientStatus(IDbContext ctx, ref string errMessage)
        {
            ...
            ControlToEntity(entity, entityEmergencyCaseNote, entityVisit, entityBed);
