<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="OPInitialAssessmentList1.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.OPInitialAssessmentList1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript" id="dxss_OPInitialAssessmentList">
        $(function () {
            ...
            $('.btnView').live('click', function () {
                ...
                openUserControlPopup(url, visitID, 'Kajian Awal Pasien Rawat Jalan (Perawat)', 1300, 600);
            });
        ...
        function onBeforeBasePatientPageListEdit() {
            if ($('#<%=hdnID.ClientID %>').val() == 0 || $('#<%=hdnID.ClientID %>').val() == "") {
                ...
                if (($('#<%=hdnCurrentParamedicID.ClientID %>').val() == $('#<%=hdnParamedicID.ClientID %>').val()) || $('#<%=hdnCurrentParamedicID.ClientID %>').val() == $('#<%=hdnRevisedParamedicID.ClientID %>').val()) {
                    ...
                    displayErrorMessageBox('EDIT', 'Maaf, Asesmen Pasien hanya bisa dilakukan perubahan oleh user yang mengkaji atau yang melakukan koreksi.');
                    return false;
                }
            }
        }
        ...
        function onBeforeBasePatientPageListDelete() {
            if ($('#<%=hdnCurrentParamedicID.ClientID %>').val() == $('#<%=hdnParamedicID.ClientID %>').val()) {
                ...
                displayErrorMessageBox('EDIT', 'Maaf,Asesmen Pasien hanya bisa dihapus oleh user yang mengkaji.');
                return false;
            }
        }
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Dikaji Oleh" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <div>
