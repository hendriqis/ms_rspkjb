<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingTransactionDiagnosisItemTransferCtl.ascx.cs" 
Inherits="QIS.Medinfras.Web.CommonLibs.Program.NursingTransactionDiagnosisItemTransferCtl" %>
                ...
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent1" runat="server">
                        <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                            <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdDiagnosisItem" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdView_RowDataBound">
                                <Columns>
                ...
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent2" runat="server">
                        <asp:Panel runat="server" ID="pnlView1" CssClass="pnlContainerGrid">
                            ...
                            <div style="display:none"><center><asp:TextBox runat="server" ID="txtNewDiagnoseItem" Width="95%"></asp:TextBox></center></div>
                            <asp:GridView ID="grdView1" runat="server" CssClass="grdSelected grdDiagnosisItem1" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdView1_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="chkIsSelected" class="chkIsSelectedDiagnosisItem" Enabled="false"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <div <%#: Eval("IsEditableByUser").ToString() == "False" ? "style='display:none'" : ""%>>
                                                <asp:CheckBox runat="server" ID="chkIsEditedByUser" class="chkIsEditedByUser" Enabled="false"/>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
