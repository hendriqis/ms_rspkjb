...
{
    public partial class NursingProcessTransfer : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.Inpatient.NURSING_ASSESSMENT_TRANSFER;
        ...
        protected override void InitializeDataControl()
        {
            ...
            List<vParamedicMaster> lstParamedic = BusinessLayer.GetvParamedicMasterList(string.Format("GCParamedicMasterType NOT IN ('{0}')",
        ...
        {
            return String.Format("RegistrationID in  (Select LinkedRegistrationID from Registration where RegistrationID={0})", AppSession.RegisteredPatient.RegistrationID);
        }
