<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingTransactionEntryInterventionCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.NursingTransactionEntryInterventionCtl" %>
...
<script type="text/javascript">
    ...
    $('#<%=txtInterventionCode.ClientID %>').change(function () {
        onTxtInterventionCodeChanged($(this).val());
    });
    ...
    function onTxtInterventionCodeChanged(value) {
        ...
        Methods.getObject('GetNursingInterventionList', filterExpression, function (result) {
            if (result != null) {
                ...
                $('#<%=txtInterventionName.ClientID %>').val(result.NurseInterventionName);
            }
            else {
                $('#<%=hdnInterventionID.ClientID %>').val('');
                $('#<%=txtInterventionCode.ClientID %>').val('');
                $('#<%=txtInterventionName.ClientID %>').val('');
            }
        });
    }
    ...
    function onCbpFilterExpressionEndCallback(s) {
        ...
        openSearchDialog('nurseDiagnoseIntervention', $('#<%=hdnFilterExpression.ClientID %>').val(), function (value) {
            $('#<%=txtInterventionCode.ClientID %>').val(value);
    ...
    $('#<%=grdViewIntervention.ClientID %> .imgDelete.imgLink').die('click');
    $('#<%=grdViewIntervention.ClientID %> .imgDelete.imgLink').live('click', function () {
    ...
    <tr valign="top">
        <td>
            <table>
                ...
                <tr>
                    <td class="tdLabel">
                        <label id="lblIntervention" class="lblLink">
                            <%=GetLabel("Intervensi")%></label>
                    </td>
                    <td>
                        ...
                        <table style="width: 100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtInterventionCode" CssClass="required" Width="100%" runat="server" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                <td>
                                    <asp:TextBox ID="txtInterventionName" ReadOnly="true" Width="100%" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="text-align: right">
                        <input type="button" id="btnAddIntervention" class="btnAddIntervention  w3-btn w3-hover-blue"
                            value="Tambah Intervensi" />
                    </td>
                </tr>
            </table>
            <dxcp:ASPxCallbackPanel ID="cbpViewIntervention" runat="server" Width="100%" ClientInstanceName="cbpViewIntervention"
                ...
                <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }" EndCallback="function(s,e){ onCbpViewInterventionEndCallback(s); }" />
                <PanelCollection>
                    <dx:PanelContent ID="PanelViewIntervention" runat="server">
                        <asp:Panel runat="server" ID="pnlViewIntervention" CssClass="pnlContainerGrid">
                            ...
                            <asp:GridView ID="grdViewIntervention" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdViewIntervention_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10px">
                                        <ItemTemplate>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <img runat="server" id="imgDelete" class="imgDelete imgLink" src='<%# ResolveUrl("~/Libs/Images/Button/delete.png")%>'
                                                            alt="" />
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <asp:TemplateField HeaderText="Item" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblTotalSelectedIntervention"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
        ...
        <td>
            <dxcp:ASPxCallbackPanel ID="cbpViewIntervention1" runat="server" Width="100%" ClientInstanceName="cbpViewIntervention1"
                ...
                <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }" EndCallback="function(s,e){ onCbpViewIntervention1EndCallback(s); }" />
                <PanelCollection>
                    <dx:PanelContent ID="PanelViewIntervention1" runat="server">
                        <asp:Panel runat="server" ID="pnlViewIntervention1" CssClass="pnlContainerGrid">
                            ...
                            <asp:GridView ID="grdViewIntervention1" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdViewIntervention1_RowDataBound">
                                <Columns>
                                    <asp:BoundField DataField="NursingInterventionItemID" HeaderStyle-CssClass="keyField"
                                        ItemStyle-CssClass="keyField" />
                                    <asp:TemplateField HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="chkIsSelectedIntervention" class="chkIsSelectedIntervention" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Aktifitas Intervensi" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            ...
                                            <div runat="server" id="divTxtInterventionItemText" class="divTxtInterventionItemText"
                                                style="display: none">
                                    ...
                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <div <%#: Eval("IsEditableByUser").ToString() == "False" ? "style='display:none'" : ""%>>
                                                <asp:CheckBox runat="server" ID="chkIsInterventionEditedByUser" class="chkIsInterventionEditedByUser" />
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
