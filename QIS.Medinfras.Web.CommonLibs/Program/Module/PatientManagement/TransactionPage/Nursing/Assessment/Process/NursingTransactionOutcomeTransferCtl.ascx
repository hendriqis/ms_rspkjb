<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingTransactionOutcomeTransferCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.NursingTransactionOutcomeTransferCtl" %>
                            ...
                            <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Item" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblTotalSelectedOutcomeTransfer"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
                            ...
                            <fieldset id="fsTrx" style="margin: 0">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtNOCInterval" ReadOnly="True" Width="20px" CssClass="txtNumeric"
                                                Style="text-align: center; color: Red" Text="0"></asp:TextBox>
                                        </td>
                                        <td>
                                            <dxe:ASPxComboBox ID="cboIntervalType" ClientInstanceName="cboIntervalType" Enabled="False"
                                                runat="server" Width="60px" ItemStyle-ForeColor="Red">
                                            </dxe:ASPxComboBox>
                                        </td>
                                        <td>
                            ...
                            <asp:GridView ID="grdView1" runat="server" CssClass="grdSelected grdView1" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <table>
                                                ...
                                                <tr valign="top">
                                                    <td>
                                                        <asp:RadioButton ID="rbtScale1Text" runat="server" Enabled="False" CssClass="rbtScale1Text"
                                                            GroupName="ScaleText" Text='<%#: "1-" + Eval("Scale1Text") %>' />
                                                    </td>
                                                    <td>
                                                        <asp:RadioButton ID="rbtScale2Text" runat="server" Enabled="False" CssClass="rbtScale2Text"
                                                            GroupName="ScaleText" Text='<%#: "2-" + Eval("Scale2Text") %>' />
                                                    </td>
                                                    <td>
                                                        <asp:RadioButton ID="rbtScale3Text" runat="server" Enabled="False" CssClass="rbtScale3Text"
                                                            GroupName="ScaleText" Text='<%#: "3-" + Eval("Scale3Text") %>' />
                                                    </td>
                                                    <td>
                                                        <asp:RadioButton ID="rbtScale4Text" runat="server" Enabled="False" CssClass="rbtScale4Text"
                                                            GroupName="ScaleText" Text='<%#: "4-" + Eval("Scale4Text") %>' />
                                                    </td>
                                                    <td>
                                                        <asp:RadioButton ID="rbtScale5Text" runat="server" Enabled="False" CssClass="rbtScale5Text"
                                                            GroupName="ScaleText" Text='<%#: "5-" + Eval("Scale5Text") %>' />
                                                    </td>
                                                </tr>
                                            </table>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Ket" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtRemarksOutcome" ReadOnly="True" CssClass="txtRemarksOutcome"
