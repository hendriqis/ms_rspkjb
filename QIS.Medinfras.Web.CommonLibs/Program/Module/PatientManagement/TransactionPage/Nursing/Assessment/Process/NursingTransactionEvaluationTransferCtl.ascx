<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingTransactionEvaluationTransferCtl.ascx.cs" 
Inherits="QIS.Medinfras.Web.CommonLibs.Program.NursingTransactionEvaluationTransferCtl" %>
...
<table width="100%">
    ...
    <tr valign="top">
        <td>
            <dxcp:ASPxCallbackPanel ID="cbpViewOutcomeEvaluation" runat="server" Width="100%" ClientInstanceName="cbpViewOutcomeEvaluation"
                ShowLoadingPanel="false" OnCallback="cbpViewOutcomeEvaluation_Callback">
                <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }"
                    EndCallback="function(s,e){ oncbpViewOutcomeEvaluationEndCallback(s); }" />
                <PanelCollection>
                    <dx:PanelContent ID="PanelContentEvaluation1" runat="server">
                        <asp:Panel runat="server" ID="pnlViewEvaluation1" CssClass="pnlContainerGrid">
                            <asp:GridView ID="grdViewOutcomeEvaluation" runat="server" CssClass="grdSelected grdViewOutcomeEvaluation" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdView_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NursingOutcomeResult" HeaderText="Ekspektasi" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100px" />
        ...
        <td>
            <dxcp:ASPxCallbackPanel ID="cbpViewOutcomeEvaluation1" runat="server" Width="100%" ClientInstanceName="cbpViewOutcomeEvaluation1"
                ShowLoadingPanel="false" OnCallback="cbpViewOutcomeEvaluation1_Callback">
                <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }"
                    EndCallback="function(s,e){ oncbpViewOutcomeEvaluation1EndCallback(s); }" />
                <PanelCollection>
                    <dx:PanelContent ID="PanelContentEvaluation2" runat="server">
                        <asp:Panel runat="server" ID="pnlViewEvaluation2" CssClass="pnlContainerGrid">
                            ...
                            <fieldset id="fsTrx" style="margin:0"> 
                                <table>
                                    <tr>
                                        <td><asp:Label runat="server" style="font-weight:bold"><%=GetLabel("Setelah dilakukan tindakan keperawatan selama ")%></asp:Label></td>
                                        <td><asp:TextBox runat="server" ID="txtNOCInterval" Width="20px" CssClass="txtNumeric" style="text-align:center; color:red" Text="0" ReadOnly="True"></asp:TextBox></td>
                                        <td><dxe:ASPxComboBox ID="cboIntervalType" ClientInstanceName="cboIntervalType" runat="server" Width="60px" Enabled="False"></dxe:ASPxComboBox></td>
                                        <td>
                                            <asp:RadioButtonList ID="rblProblemStatus" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" style="font-weight:bold" >
                                                <asp:ListItem Text=" teratasi" Value="1" Selected="True" Enabled="False"/>
                                                <asp:ListItem Text=" tidak teratasi" Value="0" Enabled="False"/>
                                            </asp:RadioButtonList>
                                        </td>
                                        <td><asp:Label ID="Label1" runat="server" style="font-weight:bold"><%=GetLabel(" dengan kriteria ")%></asp:Label></td>
                                    </tr>
                                </table>
                            </fieldset>
                            <asp:GridView ID="grdViewOutcomeEvaluation1" runat="server" CssClass="grdSelected grdViewOutcomeEvaluation1" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdView1_RowDataBound">
                                <Columns>
                                    <asp:BoundField DataField="NursingDiagnoseItemIndicatorID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                    <asp:BoundField DataField="NursingDiagnoseItemIndicatorID" />
                                    <asp:TemplateField HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="chkIsSelectedEvaluationOutcome" class="chkIsSelectedEvaluationOutcome" Enabled = "False"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="Kriteria Hasil" DataField="NursingIndicatorText" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <table>
                                                <colgroup>
                                                ...
                                                <tr valign="top">
                                                    <td><asp:RadioButton ID="rbtScaleEvalution1Text" runat="server" CssClass="rbtScaleEvalution1Text" Enabled = "False" GroupName="ScaleEvalutionText" Text='<%#: "1-" + Eval("Scale1Text") %>' /></td>
                                                    <td><asp:RadioButton ID="rbtScaleEvalution2Text" runat="server" CssClass="rbtScaleEvalution2Text" Enabled = "False" GroupName="ScaleEvalutionText" Text='<%#: "2-" + Eval("Scale2Text") %>' /></td>
                                                    <td><asp:RadioButton ID="rbtScaleEvalution3Text" runat="server" CssClass="rbtScaleEvalution3Text" Enabled = "False" GroupName="ScaleEvalutionText" Text='<%#: "3-" + Eval("Scale3Text") %>' /></td>
                                                    <td><asp:RadioButton ID="rbtScaleEvalution4Text" runat="server" CssClass="rbtScaleEvalution4Text" Enabled = "False" GroupName="ScaleEvalutionText" Text='<%#: "4-" + Eval("Scale4Text") %>' /></td>
                                                    <td><asp:RadioButton ID="rbtScaleEvalution5Text" runat="server" CssClass="rbtScaleEvalution5Text" Enabled = "False" GroupName="ScaleEvalutionText" Text='<%#: "5-" + Eval("Scale5Text") %>' /></td>
                                                </tr>
                                            </table>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Ket" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtRemarksEvaluationOutcome" CssClass="txtRemarksEvaluationOutcome" Width="100%" TextMode="MultiLine" Wrap="true" ReadOnly = "True" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
