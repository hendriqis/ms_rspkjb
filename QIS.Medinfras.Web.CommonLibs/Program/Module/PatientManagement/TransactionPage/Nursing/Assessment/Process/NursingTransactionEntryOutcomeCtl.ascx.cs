    ...
    public partial class NursingTransactionEntryOutcomeCtl : BaseUserControlCtl
    {
        ...
        protected void grdView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label lblTotalSelectedOutcome = (Label)e.Row.FindControl("lblTotalSelectedOutcome");
                int count = BusinessLayer.GetvNursingTransactionOutcomeDt1List(String.Format("NursingDiagnoseItemID = {0} AND TransactionID = {1} AND NursingDiagnoseID = {2}", entity.NursingDiagnoseItemID, MainPage.GetNursingTransactionID(), MainPage.GetNursingDiagnoseID())).Count;
                lblTotalSelectedOutcome.Text = count.ToString();
            }
        }
