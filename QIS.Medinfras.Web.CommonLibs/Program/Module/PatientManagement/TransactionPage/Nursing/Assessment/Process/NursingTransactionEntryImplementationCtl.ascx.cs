...
{
    public partial class NursingTransactionEntryImplementationCtl : BaseUserControlCtl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            hdnCurrentVisitID.Value = AppSession.RegisteredPatient.VisitID.ToString();
        ...
        private void BindGridViewDiagnoseItem()
        {
            ...
            grdViewImplementation1.DataSource = lstEntity;
            grdViewImplementation1.DataBind();
        ...
        protected void grdViewImplementation_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label lblTotalSelectedImplementation = (Label)e.Row.FindControl("lblTotalSelectedImplementation");

                Int32 count = entity.NursingJournalCount;
                lblTotalSelectedImplementation.Text = count.ToString();
            }
        }
        ...
        protected void cbpProcessImplementation_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            string result = "";
            string errMessage = "";
            int OrderID = 0;
        ...
        {
            entityDt.VisitID = Convert.ToInt32(MainPage.GetVisitID());
            entityDt.HealthcareServiceUnitID = Convert.ToInt32(MainPage.GetHealthcareServiceUnitID());
            ...
            entityDt.IsNeedVerification = chkIsNeedConfirmation.Checked;
            entityDt.IsBillingInformation = chkIsBillingInformation.Checked;
        ...
        private bool OnSaveAddRecordEntityDt(ref string errMessage, ref int NutritionOrderID)
        {
            ...
            try
            {
                ...
                entityDt.ParamedicID = Convert.ToInt32(AppSession.UserLogin.ParamedicID);
                ...
                {
                    entityDt.ChargeTransactionID = Convert.ToInt32(hdnChargesTransactionID.Value); 
                }
                entityDt.IsNeedVerification = chkIsNeedConfirmation.Checked;
                entityDt.IsBillingInformation = chkIsBillingInformation.Checked;
                entityDt.LinkField = "";
