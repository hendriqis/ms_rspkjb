<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx2.master" AutoEventWireup="true" 
    CodeBehind="PhysicianInstructionList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PhysicianInstructionList" %>
        ...
        $(function () {
            ...
            $('#<%=btnNursingNote.ClientID %>').click(function () {
                if (!getSelectedCheckbox()) {
                    ...
                    openUserControlPopup("~/Libs/Program/Module/PatientManagement/TransactionPage/NursingNotes/NursingNotes2Ctl.ascx", param, "Integration Notes - Nurse", 700, 400);
                }
            });
        });
