<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewReferralResponseCtl.ascx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPage.ViewReferralResponseCtl" %>
