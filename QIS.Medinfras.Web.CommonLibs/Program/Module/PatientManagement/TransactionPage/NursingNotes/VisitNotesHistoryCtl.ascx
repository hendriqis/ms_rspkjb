<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VisitNotesHistoryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.VisitNotesHistoryCtl" %>
                                ...
                                <asp:TemplateField HeaderText="Note" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <div>
                                            ...
                                            <div  style=" <%# Eval("cfLastUpdate") == "" ? "display:none;" : "" %>" ><small>terakhir diubah <%#:Eval("cfLastUpdate") %> </small></div>                                      
                                        </div>
