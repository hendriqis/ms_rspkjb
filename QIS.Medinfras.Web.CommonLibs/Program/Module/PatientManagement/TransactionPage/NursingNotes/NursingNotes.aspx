<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="NursingNotes.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.NursingNotes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript" id="dxss_erevaluationnotes">
        $(function () {
            ...
            $('.btnView').live('click', function () {
                ...
                if (paramedicMasterType == Constant.ParamedicType.Physician) {
                    ...
                    param = visitID + "|" + id + "|" + chiefComplaintID + "|" + paramedicID;
                }
                else {
                    if (deptID == Constant.Facility.EMERGENCY) {
        ...
        function onBeforeBasePatientPageListEdit() {
            if ($('#<%=hdnPatientNoteType.ClientID %>').val() != Constant.SOAPNoteType.NURSE_ANAMNESIS) {
                ...
                displayErrorMessageBox('Catatan Terintegrasi', 'Maaf, Catatan Pengkajian Awal Perawat tidak bisa diubah melalui menu ini');
                return false;
            }
        }
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if (code == 'PM-90008' || code == 'PM-90009' || code == 'PM-90010' || code == 'PM-90011' || code == 'PM-90012' || code == 'PM-90013' || code == 'PM-90014' || code == 'PM-90015'
                || code == 'PM-90016' || code == 'PM-90017' || code == 'PM-00572' || code == 'PM-90019' || code == 'PM-90020' || code == 'PM-900201' || code == 'PM-90022' || code == 'PM-90023'
                || code == 'PM-90035' || code == 'MR000037' || code == 'MR000003' || code == 'PM-90040' || code == 'PM-90046' || code == 'MR000009' || code == 'PM-90056' || code == 'MR000050'
                || code == 'PM-90063' || code == 'MR000052' || code == 'MR000042' || code == 'MR000058' || code == 'PM-90085' || code == 'PM-90114' || code == 'PM-90117' || code == 'PM-90118') {
                filterExpression.text = visitID;
                return true;
            }

            if (hdnID == '' || hdnID == '0') {
                if (code == 'PM-00425' || code == 'PM-00524' || code == 'PM-00583' || code == 'PM-00645'
                    || code == 'PM-00642' || code == 'PM-00644' || code == 'PM-00565' || code == 'PM-00650' || code == 'PM-00654' || code == 'PM-00184'
                    || code == 'PM-00661' || code == 'MR000016' || code == 'PM-00689' || code == 'PM-00700' || code == 'MR000045' || code == 'PM-90062'
                    || code == 'PM-00735' || code == 'PM-00751' || code == 'MR000065' || code == 'PM-00792' || code == 'PM-00847') {
                    filterExpression.text = registrationID;
                    return true;
                }
                else if (code == 'MR000013' || code == 'MR000030' || code == 'MR000017' || code == 'PM-00618' || code == 'PM-00160') {
                    filterExpression.text = visitID;
                    return true;
                }
                else if (code == 'MR000028' || code == 'PM-00674') {
            ...
            else if (code == 'MR000013' || code == 'MR000014' || code == 'MR000017' || code == 'MR000019' || code == 'MR000024' || code == 'MR000032'
                     || code == 'MR000039' || code == 'PM-00618' || code == 'MR000027' || code == 'MR000044' || code == 'MR000064') {
                filterExpression.text = visitID;
                return true;
            }
            else if (code == 'PM-00425' || code == 'MR000016' || code == 'MR000030' || code == 'MR000045' || code == 'PM-00522' || code == 'PM-00523' || code == 'PM-00159'
                     || code == 'PM-00564' || code == 'PM-00524' || code == 'PM-00583' || code == 'PM-00546' || code == 'PM-00642' || code == 'PM-00565'
                     || code == 'PM-00644' || code == 'PM-00570' || code == 'PM-00645' || code == 'PM-00654' || code == 'PM-00184' || code == 'PM-00650' || code == 'PM-00661'
                     || code == 'PM-00641' || code == 'PM-00689' || code == 'PM-00700' || code == 'PM-00133' || code == 'PM-00735' || code == 'PM-00751' || code == 'MR000065'
                     || code == 'PM-00792' || code == 'PM-90083' || code == 'PM-00847') {
                filterExpression.text = registrationID;
                return true;
            }
            ...
            else if (code == "MD-00014" || code == "MD-00015") {
                filterExpression.text = "RegistrationID = " + registrationID;
                return true;
            }
            else if (code == 'PM-00160') {
                filterExpression.text = visitID;
                return true;
            }
            else {
        ...
        function onBeforeLoadRightPanelContent(code) {
            if (code == 'keteranganIstirahat1' || code == 'keteranganIstirahat3' || code == 'kesehatanMata1' || code == 'keteranganSehat1'
                ...
                || code == 'keteranganKematian' || code == 'keteranganSehat' || code == 'kontrolKesehatanfisio') {
            ...
            else if (code == 'keteranganIstirahatKaryawan') {
                ...
                param = "03" + "|" + $('#<%=hdnRegistrationID.ClientID %>').val() + "|" + "4";
                return param;
            }
            else {
                return $('#<%:hdnRegistrationID.ClientID %>').val();
    ...
    <input type="hidden" id="hdnRegistrationIDEmergencyContact" runat="server" />
    ...
    <input type="hidden" runat="server" id="hdnDiagnose" value="" />
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div id="divView" runat="server" style='margin-top: 5px;'>
                                            <input type="button" id="btnView" runat="server" class="btnView w3-btn w3-hover-blue" value="Detail Kajian Awal"
                                                ...
                                                paramedicID = '<%#Eval("ParamedicID") %>' chiefComplaintID = '<%#Eval("ChiefComplaintID") %>' nurseChiefComplaintID = '<%#Eval("NurseChiefComplaintID") %>'   />
                                        </div>
