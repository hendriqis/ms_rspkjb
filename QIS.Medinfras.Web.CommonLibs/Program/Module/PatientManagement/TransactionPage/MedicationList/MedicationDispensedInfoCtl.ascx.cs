...
{
    public partial class MedicationDispensedInfoDetailCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            hdnItemID.Value = paramInfo[1];
            hdnItemName.Value = paramInfo[2];
            hdnParamedicName.Value = paramInfo[3];
