<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfirmMedicationAdministrationCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ConfirmMedicationAdministrationPHCtl1" %>
                                            ...
                                            <table id="tblView" runat="server" class="grdPurchaseRequest grdSelected" cellspacing="0" rules="all">
                                                ...
                                                <tr class="trEmpty">
                                                    <td colspan="2" style="font-size:11pt;color:red; font-weight:bold">
                                                        <%=GetLabel("Tidak ada informasi pemberian obat yang perlu dikonfirmasi untuk pasien ini")%>
                                                    </td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
