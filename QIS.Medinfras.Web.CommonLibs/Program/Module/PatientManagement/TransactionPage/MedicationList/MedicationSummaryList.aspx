<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx2.master"
    AutoEventWireup="true" CodeBehind="MedicationSummaryList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.MedicationSummaryList" %>
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="2" align="left">
                                                    <div>
                                                        <%=GetLabel("Nama Obat")%>
                                                        <br />
                                                        <span style="color: Blue;"><%=GetLabel("Generik")%></span>
                                                        <br />
                                                        <span style="font-style:italic"><%=GetLabel("Dokter")%></span>
                                                    <div>
                                                </th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td align="center" style="background:#ecf0f1; vertical-align:middle">
                                                ...
                                                <div>
                                                    <img src='<%# ResolveUrl("~/Libs/Images/Misc/compound.png")%>' alt="" style='<%# Eval("IsCompound").ToString() == "False" ? "display:none;": "" %> max-width:30px; min-width: 30px; float: left;' />
                                                 </div> 
                                            </td>
                                            <td>
                                            ...
                                            <td align="center">
                                                <label id="lblEndDate" runat="server"><%#: Eval("cfEndDate")%></label>
                                            </td>
                                            ...
                                            <td valign="middle" style="background:#ecf0f1">
                                                <div style="text-align: right;color:Maroon">
                                                    <%#: Eval("cfReturnItemQty")%>
                                                </div>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
