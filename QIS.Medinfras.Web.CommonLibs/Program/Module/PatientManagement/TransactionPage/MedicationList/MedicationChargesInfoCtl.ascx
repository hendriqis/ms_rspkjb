<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedicationChargesInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.MedicationChargesInfoCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:340px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ServiceUnitName" HeaderStyle-Width="150px" HeaderText="Unit Pelayanan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
