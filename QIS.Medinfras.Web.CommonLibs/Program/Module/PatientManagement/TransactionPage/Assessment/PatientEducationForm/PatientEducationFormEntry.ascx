<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientEducationFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientEducationFormEntry" %>
