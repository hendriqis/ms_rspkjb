<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PopulationAssessmentFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PopulationAssessmentFormEntry" %>
