<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EWSAssessmentFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.EWSAssessmentFormEntry" %>
...
//            var message = 'Form pengkajian masih kosong/belum terisi atau Kesimpulan kebutuhan monitoring EWS belum terisi';
//            if (totalScore == 0) {
//                errMessage = message;
...
//                message = 'Kesimpulan kebutuhan monitoring EWS belum ditentukan';
//                errMessage = message;
//                displayErrorMessageBox('SAVE', message);
//                return false;
//            }
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <dxe:ASPxComboBox ID="cboParamedicID" Width="440px" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                ...
                <table class="tblEntryContent">
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px">
                            <asp:CheckBox ID="chkIsEWSAlert" runat="server" Text=" Indikator Pemantauan EWS" />
                        </td>
                    </tr>
                    <tr style="display:none">
                        ...
                        <td colspan="2">
                            <dxe:ASPxComboBox ID="cboEWSScoreType" ClientInstanceName="cboEWSScoreType" Width="350px" runat="server" />
                        </td>
                    </tr>
                    <tr>
