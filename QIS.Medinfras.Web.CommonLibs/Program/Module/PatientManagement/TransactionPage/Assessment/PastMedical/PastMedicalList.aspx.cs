...
{
    public partial class PastMedicalList : BasePagePatientPageList
    {
        ...
        protected override void SetControlProperties()
        {
            ...
            Helper.SetControlEntrySetting(txtGenericName, new ControlEntrySetting(true, true, false),"PastMedical");
            Helper.SetControlEntrySetting(cboForm, new ControlEntrySetting(true, true, true), "PastMedical");
            Helper.SetControlEntrySetting(txtStrengthAmount, new ControlEntrySetting(true, true, false), "PastMedical");
            Helper.SetControlEntrySetting(cboStrengthUnit, new ControlEntrySetting(true, true, false), "PastMedical");
            Helper.SetControlEntrySetting(txtFrequencyNumber, new ControlEntrySetting(true, true, true), "PastMedical");
            Helper.SetControlEntrySetting(cboFrequencyTimeline, new ControlEntrySetting(true, true, true), "PastMedical");
            Helper.SetControlEntrySetting(txtDosingDose, new ControlEntrySetting(true, true, true), "PastMedical");
            Helper.SetControlEntrySetting(cboDosingUnit, new ControlEntrySetting(true, true, true), "PastMedical");
            Helper.SetControlEntrySetting(cboMedicationRoute, new ControlEntrySetting(true, true, true), "PastMedical");
            Helper.SetControlEntrySetting(txtStartDate, new ControlEntrySetting(true, true, false), "PastMedical");
            Helper.SetControlEntrySetting(chkIsUntilNow, new ControlEntrySetting(true, true, false), "PastMedical");
            Helper.SetControlEntrySetting(txtDuration, new ControlEntrySetting(true, true, false), "PastMedical");
            Helper.SetControlEntrySetting(txtPurposeOfMedication, new ControlEntrySetting(true, true, false), "PastMedical");
        }
