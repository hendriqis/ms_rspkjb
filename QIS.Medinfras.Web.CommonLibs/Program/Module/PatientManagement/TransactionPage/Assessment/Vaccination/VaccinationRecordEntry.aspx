<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageListEntry.master" AutoEventWireup="true" 
    CodeBehind="VaccinationRecordEntry.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.VaccinationRecordEntry" %>
    ...
    <script type="text/javascript">
        ...
        $('#<%=lblPhysician.ClientID %>.lblLink').click(function () {
            ...
            openSearchDialog('paramedic', filterExpression, function (value) {
                onGetParamedicInformation(value);
            });
        });

        function onGetParamedicInformation(value) {
        ...
        <tr>
            <td valign="top">
                <table id="Table2" runat="server" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="tdLabel" style="width: 150px;"><%=GetLabel("Tanggal Imunisasi") %></td>
                        <td style="width: 150px;"><asp:TextBox ID="txtVaccinationDate" Width="120px" CssClass="datepicker" runat="server" /></td>
            ...
            <td style="width:500px;text-align:right" valign="top">
                <table id="Table1" runat="server" cellpadding="0">
                    <tr>
                        <td class="tdLabel" style="width: 200px;"><label class="lblLink" runat="server" id="lblPhysician"><%=GetLabel("Dokter / Tenaga Medis") %></label></td>
                        <td><asp:TextBox ID="txtPhysicianName" runat="server" Width="300px" /> </td>
                    </tr>
                </table>
            </td>
        </tr>
