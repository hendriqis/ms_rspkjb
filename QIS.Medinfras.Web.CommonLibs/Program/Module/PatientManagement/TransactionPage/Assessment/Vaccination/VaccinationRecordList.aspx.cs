...
{
    public partial class VaccinationRecordList : BasePagePatientPageList
    {
        ...
        {
            url = ResolveUrl(string.Format("~/Libs/Program/Module/PatientManagement/TransactionPage/Assessment/Vaccination/VaccinationRecordEntry2.aspx?id={0}|0", hdnDepartmentID.Value));
            return true;
        }
            ...
            if (hdnID.Value != "")
            {
                ...
                if (entityHd.IsInternal)
                {
                    if (entityHd.ParamedicID == AppSession.RegisteredPatient.ParamedicID)
                        url = ResolveUrl(string.Format("~/Libs/Program/Module/PatientManagement/TransactionPage/Assessment/Vaccination/VaccinationRecordEntry2.aspx?id={0}|{1}", hdnDepartmentID.Value,hdnID.Value));
                    else
                    {
