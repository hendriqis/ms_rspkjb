...
{
    public partial class PatientAllergyEntryCtl1 : BasePagePatientPageEntryCtl
    {
        ...
        private void SetControlProperties()
        {
            ...
            if (hdnIsNutrition.Value == "1")
                cboAllergenType.Value = Constant.AllergenType.FOOD;
