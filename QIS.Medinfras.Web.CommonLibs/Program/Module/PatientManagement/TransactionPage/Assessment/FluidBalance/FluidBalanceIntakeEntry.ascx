<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FluidBalanceIntakeEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.FluidBalanceIntakeEntry" %>
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr id="trIntakeBalance" runat="server">
                        <td class="tdLabel">
                            <label class="lblMandatory" id="lblFluidBalance" runat="server">
                                Cairan Ada</label>
                        </td>
                        <td><asp:TextBox ID="txtIntakeFluidBalance" Width="80px" CssClass="number" runat="server" /> ml</td>
                        <td><asp:CheckBox ID="chkIsInitialize" runat="server" Text=" Inisialisasi Cairan" Checked="false" Enabled="false" /></td>                                            
                    </tr>
                    <tr id="trIntakeFrequency" runat="server">
                        <td class="tdLabel">
                            <label class="lblMandatory">
                                <%=GetLabel("Frequency")%></label>
                        </td>
                        <td><asp:TextBox ID="txtFrequency" Width="80px" CssClass="number" runat="server" /></td>          
                        <td />                                  
                    </tr>
                    <tr>
