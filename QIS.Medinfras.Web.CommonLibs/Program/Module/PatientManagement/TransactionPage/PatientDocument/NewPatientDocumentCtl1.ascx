<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewPatientDocumentCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPage.NewPatientDocumentCtl1" %>
...
<input type="hidden" id="hdnMRNParamCtl" runat="server" value="" />
<input type="hidden" id="hdnVisitIDParamCtl" runat="server" value="" />
<input type="hidden" id="hdnRegDateCtl" runat="server" value="" />
