...
{
    public partial class NewPatientDocumentCtl1 : BasePagePatientPageEntryCtl
    {
        public override void InitializeDataControl(string param)
        {
            ...
            hdnID.Value = "";
            hdnMRNParamCtl.Value = paramSplit[0];
            hdnVisitIDParamCtl.Value = paramSplit[1];
            hdnRegDateCtl.Value = paramSplit[2];
            IsAdd = true;
            txtDocumentDate.Text = hdnRegDateCtl.Value;
        }
        ...
        private void SetControlProperties()
        {
            ...
            Methods.SetComboBoxField<StandardCode>(cboGCDocumentType, lstStandardCode.Where(sc => sc.ParentID == Constant.StandardCode.DOCUMENT_TYPE && sc.StandardCodeID == "0270^X1").ToList(), "StandardCodeName", "StandardCodeID");
        ...
        {
            SetControlEntrySetting(txtDocumentDate, new ControlEntrySetting(true, true, true, hdnRegDateCtl.Value));
            SetControlEntrySetting(cboGCDocumentType, new ControlEntrySetting(false, false, true, "0270^X1"));
        ...
        private void ControlToEntity(PatientDocument entity)
        {
            ...
            entity.MRN = Convert.ToInt32(hdnMRNParamCtl.Value);
            entity.VisitID = Convert.ToInt32(hdnVisitIDParamCtl.Value);
        ...
        protected override bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            try
            {
                int mrn = Convert.ToInt32(hdnMRNParamCtl.Value);
