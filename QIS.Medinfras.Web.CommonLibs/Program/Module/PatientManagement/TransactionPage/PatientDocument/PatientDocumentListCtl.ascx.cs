...
{
    public partial class PatientDocumentListCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("VisitID = {0} AND IsDeleted = 0 AND GCDocumentType = '0270^X1'", hdnVisitIDCtl.Value);
