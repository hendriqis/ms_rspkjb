<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientChargesPrescriptionVoidCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientChargesPrescriptionVoidCtl" %>
