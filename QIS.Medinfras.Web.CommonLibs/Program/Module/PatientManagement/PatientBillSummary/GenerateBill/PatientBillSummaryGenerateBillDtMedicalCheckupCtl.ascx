<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientBillSummaryGenerateBillDtMedicalCheckupCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientBillSummaryGenerateBillDtMedicalCheckupCtl" %>
