<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientBillSummaryGenerateBillDtCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientBillSummaryGenerateBillDtCtl" %>
