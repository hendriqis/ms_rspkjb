<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.master"
    AutoEventWireup="true" CodeBehind="InfoPatientUse.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.InfoPatientUse" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('.lnkReq').click(function () {
                ...
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientBillSummary/Information/InfoPatientRequestCtl.ascx");
            ...
            $('.lnkDisc').click(function () {
                var id = $(this).closest('tr').find('.hdnKeyField').val();
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientBillSummary/Information/InfoPatientDistribusiCtl.ascx");
                openUserControlPopup(url, id, 'Distribusi', 1000, 200);
            });

            $('.lnkCahrge').click(function () {
                var id = $(this).closest('tr').find('.hdnKeyField').val();
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientBillSummary/Information/InfoPatientChargesCtl.ascx");
                openUserControlPopup(url, id, 'Digunakan oleh Pasien', 1000, 200);
            });

            $('.lnkUse').click(function () {
                var id = $(this).closest('tr').find('.hdnKeyField').val();
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientBillSummary/Information/InfoPatientUseCtl.ascx");
                openUserControlPopup(url, id, 'Pemakaian oleh Pasien', 1000, 200);
            });
