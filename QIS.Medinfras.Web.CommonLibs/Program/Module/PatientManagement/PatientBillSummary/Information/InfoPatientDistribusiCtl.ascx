<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoPatientDistribusiCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.InfoPatientDistribusiCtl" %>
