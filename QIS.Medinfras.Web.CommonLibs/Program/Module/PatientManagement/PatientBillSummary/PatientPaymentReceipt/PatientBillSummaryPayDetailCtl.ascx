<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientBillSummaryPayDetailCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientBillSummaryPayDetailCtl" %>
...
<script type="text/javascript" id="dxss_generatebilldtctl">
    $('#ulTabClinicPayment li').click(function () {
        $('#ulTabClinicPayment li.selected').removeAttr('class');
    ...
    <tr>
        <td style="padding:5px;vertical-align:top">
            <table class="tblEntryContent" style="width:100%">
                ...
                <tr>
                    <td class="tdLabel"><label><%=GetLabel("No Pembayaran")%></label></td>
                ...
                <tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding-right: 1px;width:145px"><asp:TextBox ID="txtPaymentDate" ReadOnly="true" Width="120px" CssClass="datepicker" runat="server" /></td>
                            <td style="width:5px">&nbsp;</td>
                            <td><asp:TextBox ID="txtPaymentTime" Width="80px" CssClass="time" runat="server" ReadOnly="true" Style="text-align:center" /></td>
                        </tr>
                    </table>
                </td>
                </tr>
...
<div class="containerUlTabPage">
    <ul class="ulTabPage" id="ulTabClinicPayment">
