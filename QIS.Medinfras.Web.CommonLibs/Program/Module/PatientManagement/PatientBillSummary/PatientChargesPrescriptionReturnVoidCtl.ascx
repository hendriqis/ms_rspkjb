<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientChargesPrescriptionReturnVoidCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientChargesPrescriptionReturnVoidCtl" %>
