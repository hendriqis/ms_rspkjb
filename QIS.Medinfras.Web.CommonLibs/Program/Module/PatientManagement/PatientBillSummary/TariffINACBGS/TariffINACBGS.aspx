<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.Master" AutoEventWireup="true" 
    CodeBehind="TariffINACBGS.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.TariffINACBGS" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnSaveINACBGs" CRUDMode="R" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbsave.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Save")%></div></li>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    <script type="text/javascript">
        ...
        function onLoadGenerateBill() {
            ...
            $('#<%=btnSaveINACBGs.ClientID %>').click(function (evt) {
                if (IsValid(evt, 'fsINACBGs', 'mpINACBGs')) {
                    onCustomButtonClick('saveinacbgs');
                }
            });

            $('#<%=txtCoverageLimit.ClientID %>').change(function () {
            ...
            if ($('#<%=hdnIsControlCoverageLimit.ClientID %>').val() == '1') {
                ...
                if (isControlBPJSCoverage == '1') {
                    //if (patientBPJSAmount > 0) {
                        diffPayerAmount = (patientBPJSAmount + remainingCoverageAmount) - (patientAmount + payerAmount);
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if (code == 'PM-00203' || code == 'PM-00204' || code == 'PM-00205' || code == 'PM-00206' || code == 'PM-00207' || code == 'PM-00208' || code == 'PM-00209' || code == 'PM-00210' || code == 'PM-00211' || code == 'PM-00212' || code == 'PM-00213') {
                filterExpression.text = '((RegistrationID = ' + linkedRegisID + ' AND IsChargesTransfered = 1) OR RegistrationID = ' + registrationID + ')';
            }
    ...
    <div>
        <fieldset id="fsINACBGs" style="margin: 0">
            <table class="tblEntryContent">
                ...
                <tr>
                    <td class="tdLabel"><label class="lblMandatory">INACBG's Grouper</label></td>
                    <td>
