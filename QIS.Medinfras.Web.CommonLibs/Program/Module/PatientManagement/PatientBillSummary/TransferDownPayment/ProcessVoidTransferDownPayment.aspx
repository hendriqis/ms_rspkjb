<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.master"
    AutoEventWireup="true" CodeBehind="ProcessVoidTransferDownPayment.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ProcessVoidTransferDownPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('.btnVoidTransfer').live('click', function () {
            var paymentID = $(this).closest('tr').find('.hdnKeyField').val();
            cbpView.PerformCallback("voidtransfer|" + paymentID);
        });
        ...
        function onCbpViewEndCallback(s) {
            ...
            if (param[0] == 'voidtransfer') {
                if (param[1] == 'fail') {
                    ...
                    showToast("INFORMATION", "Process void transfer down payment success.");
                }
                                        ...
                                        <asp:ListView ID="lvwView" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr runat="server" id="trItem">
                                                    ...
                                                    <td align="center">
                                                        <input type="button" id="btnVoidTransfer" class="btnVoidTransfer" value="Batal Transfer" runat="server" />
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:ListView>
