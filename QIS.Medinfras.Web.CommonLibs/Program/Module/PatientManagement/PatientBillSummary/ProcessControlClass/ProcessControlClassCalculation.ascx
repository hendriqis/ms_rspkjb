<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProcessControlClassCalculation.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ProcessControlClassCalculation" %>
...
<script type="text/javascript" id="dxss_patientrecalculate1ctl">
    $(function () {
        ...
        var param = '<li id="btnCalculate"><img src="<%=ResolveUrl("~/Libs/Images/Icon/tbrecalculate.png")%>" alt="" /><div>Recalculate</div></li>';
    ...
    function onCboRecalculateTypeChanged() {
        ...
        cbpProcessControlClass.PerformCallback('refresh|');
    }
                    ...
                    showToastConfirmation('Proses Rekalkulasi Sekarang?', function (result) {
                        if (result) {
                            ...
                            if (param != "") {
                                ...
                                cbpProcessControlClass.PerformCallback('recal|');
                            } else {
...
<div>
                ...
                <td valign="top">
                    <table style="border: 3px double black; margin: 3px">
                        ...
                        <tr id="trRecalByClass" runat="server" style="display: none">
                            ...
                            <td>
                                <dxe:ASPxComboBox ID="cboClass" ClientInstanceName="cboClass" runat="server"
                                    Width="350px">
                        ...
                        <table width="300px" align="right">
                            <tr>
                                <td align="right" style="vertical-align: middle;">
                                    <img height="35px" src='<%= ResolveUrl("~/Libs/Images/warning.png")%>' alt='' />
                                </td>
                                <td align="right" style="vertical-align: middle;">
                                    <label class="lblWarning">
                                        <%=GetLabel("DON'T FORGET TO SAVE AFTER RECALCULATE")%></label>
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <div style="height: 240px; overflow-y: auto; overflow-x: hidden">
        <dxcp:ASPxCallbackPanel ID="cbpProcessControlClass" runat="server" ClientInstanceName="cbpProcessControlClass"
            ShowLoadingPanel="false" OnCallback="cbpProcessControlClass_Callback">
