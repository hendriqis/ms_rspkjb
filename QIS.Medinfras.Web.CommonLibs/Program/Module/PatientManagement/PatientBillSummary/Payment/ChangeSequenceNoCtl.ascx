<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChangeSequenceNoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ChangeSequenceNoCtl" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<script type="text/javascript" id="dxss_ChangeSequenceNoCtl">
    $(function () {
    });
</script>
<div style="height: 250px; overflow-y: auto;">
    <input type="hidden" runat="server" id="hdnPatientPaymentDtID" value="" />
    <table class="tblContentArea">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtSequenceNo" Width="100px" runat="server" CssClass="number" />
            </td>
        </tr>
    </table>
</div>
