<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientBillSummaryPrescriptionReturnEntryCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientBillSummaryPrescriptionReturnEntryCtl" %>
...
//    }
    ...
    function getCheckedMember(errMessage) {
        ...
        $('#<%=grdView.ClientID %> .chkIsSelectedDrugsReturn input:checked').each(function () {
            ...
            var chargeClassID = $tr.find('.hdnChargeClassID').val();
...
<input type="hidden" id="hdnIsCorrectionTransaction" runat="server" value="" />
...
<table>
    ...
    <tr>
        ...
        <td>
            <dxe:ASPxComboBox ID="cboReturnLocation" ClientInstanceName="cboReturnLocation" Width="100%" runat="server" OnCallback="cboReturnLocation_Callback">
                        ...
                        <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;">
                            <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" HeaderText="Jumlah" >
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Dikembalikan" >
                                        <ItemTemplate>
