...
{
    public partial class NewPatientEDocumentPageCtl : BasePagePatientPageEntryCtl
    {
        ...
        private void SetControlProperties()
        {
            ...
            Methods.SetComboBoxField<StandardCode>(cboGCDocumentType, lstStandardCode.Where(sc => sc.ParentID == Constant.StandardCode.DOCUMENT_TYPE && sc.StandardCodeID == Constant.DocumentType.FINANCE_BILLING_DOCUMENT).ToList(), "StandardCodeName", "StandardCodeID");
        ...
        protected override bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                if (fileType.ToLower() != "msword" && fileType.ToLower() != "plain" && fileType.ToLower() != "jpg" && fileType.ToLower() != "jpeg" && fileType.ToLower() != "png" && fileType.ToLower() != "txt" && fileType.ToLower() != "doc" && fileType.ToLower() != "docx" && fileType.ToLower() != "pdf" && fileType.ToLower() != "mp4" && fileType.ToLower() != "dcm" && fileType.ToLower() != "xls" && fileType.ToLower() != "xlsx")
                {
                    errMessage = "Ekstension yang digunakan tidak sesuai dengan yang diizinkan.";
                    return false;
                }
                else if (fileNameExt != "jpg" && fileNameExt != "jpeg" && fileNameExt != "png" && fileNameExt != "txt" && fileNameExt != "doc" && fileNameExt != "docx" && fileNameExt != "pdf" && fileNameExt != "mp4" && fileNameExt != "dcm" && fileType.ToLower() != "xls" && fileType.ToLower() != "xlsx")
                {
                    errMessage = "Ekstension yang digunakan tidak sesuai dengan yang diizinkan.";
                    return false;
                }
