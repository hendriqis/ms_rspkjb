...
{
    public partial class PatientEDocumentPageList : BasePagePatientPageList
    {
        protected int PageCount = 1;
        protected List<vPatientDocument> lstEDocument = null;
        ...
        public override string OnGetMenuCode()
        {
            ...
            switch (ModuleID)
            {
                case "OP": return Constant.MenuCode.Outpatient.E_DOCUMENT;
                case "IP": return Constant.MenuCode.Inpatient.E_DOCUMENT;
                case "ER": return Constant.MenuCode.EmergencyCare.E_DOCUMENT;
                case "LB": return Constant.MenuCode.Laboratory.E_DOCUMENT;
                case "IS": return Constant.MenuCode.Imaging.E_DOCUMENT;
                case "MD": return Constant.MenuCode.MedicalDiagnostic.E_DOCUMENT;
                case "PH": return Constant.MenuCode.Pharmacy.E_DOCUMENT;
                case "MC": return Constant.MenuCode.MedicalCheckup.E_DOCUMENT;
                case "RT": return Constant.MenuCode.Radiotheraphy.E_DOCUMENT;
                default: return Constant.MenuCode.Outpatient.E_DOCUMENT;
            }
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            filterExpression += string.Format("VisitID = {0} AND IsDeleted = 0 AND GCDocumentType = '{1}'", AppSession.RegisteredPatient.VisitID, Constant.DocumentType.FINANCE_BILLING_DOCUMENT);
            ...
            //lstEDocument = BusinessLayer.GetvPatientDocumentList(string.Format("VisitID = {0} AND IsDeleted = 0 ORDER BY ID DESC", AppSession.RegisteredPatient.VisitID));
        ...
        {
            url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientBillSummary/Utility/NewPatientEDocumentPageCtl.ascx");
            queryString = "";
            popupWidth = 700;
            popupHeight = 500;
