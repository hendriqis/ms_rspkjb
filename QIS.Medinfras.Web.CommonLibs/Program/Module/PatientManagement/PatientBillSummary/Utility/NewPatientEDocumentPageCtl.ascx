<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewPatientEDocumentPageCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPage.NewPatientEDocumentPageCtl" %>
                ...
                <tr>
                    ...
                    <td style="vertical-align:top">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>          
                                <td><%=GetLabel("Allowed extension") %> : jpg,jpeg,png,txt,doc,docx,xls,xlsx,pdf,mp4,dcm</td>
                            </tr>
                            <tr>                                
