...
{
    public partial class ClaimOrder : BasePageTrx
    {
        public override string OnGetMenuCode()
        {
            switch (hdnRequestID.Value)
            {
                case Constant.Facility.EMERGENCY: return Constant.MenuCode.EmergencyCare.BPJS_PROCESS_CLAIM_ORDER;
                case Constant.Facility.INPATIENT: return Constant.MenuCode.Inpatient.BPJS_PROCESS_CLAIM_ORDER;
                case Constant.Facility.IMAGING: return Constant.MenuCode.Imaging.BPJS_PROCESS_CLAIM_ORDER;
                case Constant.Facility.LABORATORY: return Constant.MenuCode.Laboratory.BPJS_PROCESS_CLAIM_ORDER;
                case Constant.Facility.MEDICAL_CHECKUP: return Constant.MenuCode.MedicalCheckup.BPJS_PROCESS_CLAIM_ORDER;
                case Constant.Facility.DIAGNOSTIC:
                    if (AppSession.MedicalDiagnostic.MedicalDiagnosticType == MedicalDiagnosticType.Radiotheraphy)
                        return Constant.MenuCode.Radiotheraphy.BPJS_PROCESS_CLAIM_ORDER;
                    else
                        return Constant.MenuCode.MedicalDiagnostic.BPJS_PROCESS_CLAIM_ORDER;
                case Constant.Facility.OUTPATIENT: return Constant.MenuCode.Outpatient.BPJS_PROCESS_CLAIM_ORDER;
                case Constant.Facility.PHARMACY: return Constant.MenuCode.Pharmacy.BPJS_PROCESS_CLAIM_ORDER;
                default: return Constant.MenuCode.Inpatient.BPJS_PROCESS_CLAIM_ORDER;
            }
        }
