<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientBillSummaryRecalculationBillMDProcessCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientBillSummaryRecalculationBillMDProcessCtl" %>
...
<div class="pageTitle"><%=GetLabel("Rekalkulasi Transaksi Pasien")%></div>
<div>
