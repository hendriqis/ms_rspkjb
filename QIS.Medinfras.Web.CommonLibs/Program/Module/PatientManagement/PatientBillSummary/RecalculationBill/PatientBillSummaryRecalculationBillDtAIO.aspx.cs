...
{
    public partial class PatientBillSummaryRecalculationBillDtAIO : BasePageTrx
    {
        public override string OnGetMenuCode()
        {
            switch (hdnDepartmentID.Value)
            {
                case Constant.Facility.INPATIENT: return Constant.MenuCode.Inpatient.AIO_BILL_SUMMARY_RECALCULATION;
                case Constant.Facility.DIAGNOSTIC:
                    if (AppSession.MedicalDiagnostic.MedicalDiagnosticType == MedicalDiagnosticType.Imaging)
                        return Constant.MenuCode.Imaging.AIO_BILL_SUMMARY_RECALCULATION;
                    else if (AppSession.MedicalDiagnostic.MedicalDiagnosticType == MedicalDiagnosticType.Laboratory)
                        return Constant.MenuCode.Laboratory.AIO_BILL_SUMMARY_RECALCULATION;
                    return Constant.MenuCode.MedicalDiagnostic.AIO_BILL_SUMMARY_RECALCULATION;
                default: return Constant.MenuCode.Outpatient.AIO_BILL_SUMMARY_RECALCULATION;
            }
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            String filterExpression = GetFilterExpression() + " AND IsDeleted = 0 AND (IsAIOTransaction = 1 OR IsControlAmount = 1)";
