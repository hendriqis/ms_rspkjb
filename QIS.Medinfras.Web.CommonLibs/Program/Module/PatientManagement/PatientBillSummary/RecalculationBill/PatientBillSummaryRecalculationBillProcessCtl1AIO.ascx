<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientBillSummaryRecalculationBillProcessCtl1AIO.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientBillSummaryRecalculationBillProcessCtl1AIO" %>
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="3" style="color: Red">
                                <%=GetLabel("WARNING !")%>
                                <br />
                                <%=GetLabel("Hitung ulang berdasarkan tariff AIO, akan menimpa semua nilai diskon.")%>
                            </td>
                        </tr>
                    </table>
                </td>
