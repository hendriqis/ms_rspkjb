<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.master" AutoEventWireup="true" 
    CodeBehind="PatientBillSummaryRecalculationBillMDDetail.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientBillSummaryRecalculationBillMDDetail" %>
    ...
    <script type="text/javascript" id="dxss_generatebilldtctl">
        function onLoad() {
            ...
            $('#<%=btnRecalculationPatientBillRecalculate.ClientID %>').click(function () {
                ...
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientBillSummary/RecalculationBill/PatientBillSummaryRecalculationBillMDProcessCtl.ascx");
