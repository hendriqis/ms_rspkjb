...
{
    public partial class PatientBillSummaryRecalculationBillProcessCtl1 : BasePatientManagementRecalculationBillPage
    {
        ...
        private string GetFilterExpression()
        {
            ...
            filterExpression = string.Format("(RegistrationID = {0} OR (LinkedToRegistrationID = {0} AND IsChargesTransfered = 1)) AND IsAIOTransaction = 0 AND IsControlAmount = 0", hdnRegistrationID.Value);
