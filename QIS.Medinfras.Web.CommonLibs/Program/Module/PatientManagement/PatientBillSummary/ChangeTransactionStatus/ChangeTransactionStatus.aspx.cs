...
{
    public partial class ChangeTransactionStatus : BasePageTrx
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            {
                case Constant.Facility.INPATIENT: return Constant.MenuCode.Inpatient.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
                case Constant.Facility.MEDICAL_CHECKUP: return Constant.MenuCode.MedicalCheckup.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
                case Constant.Facility.EMERGENCY: return Constant.MenuCode.EmergencyCare.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
                case Constant.Facility.PHARMACY: return Constant.MenuCode.Pharmacy.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
                case Constant.Facility.DIAGNOSTIC:
                    if (AppSession.MedicalDiagnostic.MedicalDiagnosticType == MedicalDiagnosticType.Laboratory)
                        return Constant.MenuCode.Laboratory.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
                    else if (AppSession.MedicalDiagnostic.MedicalDiagnosticType == MedicalDiagnosticType.Imaging)
                        return Constant.MenuCode.Imaging.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
                    ...
                    return Constant.MenuCode.MedicalDiagnostic.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
                default: return Constant.MenuCode.Outpatient.BILL_SUMMARY_UPDATE_TRANSACTION_STATUS;
            }
        }
