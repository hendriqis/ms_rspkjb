<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoPatientRequestCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.InfoPatientRequestCtl1" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemRequestNo" HeaderText="No. Permintaan" HeaderStyle-Width="100px"
                                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" >
                                            <HeaderStyle HorizontalAlign="Center" Width="100px"></HeaderStyle>

                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TransactionDateInString" 
                                            HeaderText="Tanggal Permintaan" HeaderStyle-Width="50px"
                                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" >
