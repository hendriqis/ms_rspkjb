<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoPatientChargesCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.InfoPatientChargesCtl1" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ChargedQuantity" HeaderText="Quantity" HeaderStyle-Width="20px"
