<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoPatientDistribusiCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.InfoPatientDistribusiCtl1" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DistributionNo" HeaderText="No. Distribusi" HeaderStyle-Width="100px"
                                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" >
                                            <HeaderStyle HorizontalAlign="Center" Width="100px"></HeaderStyle>

                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DeliveryDateInString" HeaderText="Tanggal Distribusi" HeaderStyle-Width="50px"
                                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" >
                                            <HeaderStyle HorizontalAlign="Center" Width="50px"></HeaderStyle>

                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="QtyDistribusi" HeaderText="Quantity" HeaderStyle-Width="20px"
