...
{
    public partial class InfoPatientUseCtl1 : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(String ItemID)
        {
            ...
            vItemTransactionDt ph = BusinessLayer.GetvItemTransactionDtList(string.Format("ItemID= {0} AND GCItemDetailStatus != 'X121^999' ", ItemID)).FirstOrDefault();
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vItemTransactionDt> lstEntity = BusinessLayer.GetvItemTransactionDtList(filterExpression, 8, pageIndex, "ItemID ASC");
