...
{
    public partial class InfoPatientRequestCtl1 : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(String ItemID)
        {
            ...
            vItemRequestDt ph = BusinessLayer.GetvItemRequestDtList(string.Format ("ItemID = {0}", ItemID)).FirstOrDefault();
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vItemRequestDt> lstEntity = BusinessLayer.GetvItemRequestDtList(filterExpression, 8, pageIndex, "ItemID ASC");
