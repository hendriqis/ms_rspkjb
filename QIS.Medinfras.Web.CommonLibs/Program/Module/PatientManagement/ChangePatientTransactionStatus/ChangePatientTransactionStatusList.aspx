...
CodeBehind="ChangePatientTransactionStatusList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ChangePatientTransactionStatusList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding:15px">
        ...
        <div class="pageTitle"><%=GetLabel("Ubah Status Transaksi")%></div>
