<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientTransactionServiceDtCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientTransactionServiceDtCtl" %>

<%@ Register Src="~/Libs/Program/Module/PatientManagement/TransactionDtView/TransactionDtServiceView1Ctl.ascx" TagName="ServiceCtl" TagPrefix="uc1" %>
