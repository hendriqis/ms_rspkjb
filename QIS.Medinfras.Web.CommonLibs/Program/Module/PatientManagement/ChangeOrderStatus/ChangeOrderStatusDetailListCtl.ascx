<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChangeOrderStatusDetailListCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.SystemSetup.Program.ChangeOutstandingOrderDetailListCtl" %>
