<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChangeOrderStatusReopenCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ChangeOrderStatusReopenCtl" %>
