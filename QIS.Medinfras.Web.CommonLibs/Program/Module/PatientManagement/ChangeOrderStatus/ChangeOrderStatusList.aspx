<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="ChangeOrderStatusList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ChangeOrderStatusList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            function getHealthcareServiceUnitFilterExpression() {
                var filterExpression = "IsUsingRegistration = 1 AND HealthcareID = '" + AppSession.healthcareID + "' AND DepartmentID = '" + cboPatientFrom.GetValue() + "'"; ;
