<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="PatientPerBillDetailReprintList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPerBillDetailReprintList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        ...
        $('.lvwView tr:gt(0):not(.trEmpty)').live('click', function () {
            if (!isHoverTdExpand) {
                showLoadingPanel();
                $('#<%=hdnID.ClientID %>').val($(this).find('.hdnVisitID').val());
                                                ...
                                                <td>
                                                    <div>
                                                        <span style="font-weight: bold">
                                                            <%#: Eval("PatientName") %>
                                                        </span>(<%#: Eval("MedicalNo") %>,<%#: Eval("DateOfBirthInString") %>,<%#: Eval("Sex") %>,<%#: Eval("Religion") %>)
                                                    </div>
                                                </td>
                                                <td>
                                                    &nbsp;
