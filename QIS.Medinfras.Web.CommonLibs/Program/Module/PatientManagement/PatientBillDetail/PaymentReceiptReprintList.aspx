<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="PaymentReceiptReprintList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PaymentReceiptReprintList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        ...
        $('.lvwView tr:gt(0):not(.trEmpty)').live('click', function () {
            showLoadingPanel();
            $('#<%=hdnID.ClientID %>').val($(this).find('.RegistrationID').val());
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <%#: Eval("BedCode") %><br />
                                                        <i>
                                                            <%=GetLabel("Kelas Perawatan : ")%></i><%#: Eval("ClassName") %></div>
                                                    <br />
                                                    <font color="red">
                                                ...
                                                <td style="text-align: center">
                                                    <div>
                                                        <%#: Eval("cfDischargeDate")%>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        <%#: Eval("BusinessPartner")%>
                                                    </div>
                                                </td>
                                                <td align="center">
