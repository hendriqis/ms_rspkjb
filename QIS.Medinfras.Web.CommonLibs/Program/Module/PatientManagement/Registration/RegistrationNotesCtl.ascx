<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RegistrationNotesCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.RegistrationNotesCtl" %>
...
<script type="text/javascript" id="dxss_patientvisitnotesctl">
    ...
    $('#<%=txtVisitNoteDate.ClientID %>').datepicker('option', 'maxDate', new Date(getDateNow()));
