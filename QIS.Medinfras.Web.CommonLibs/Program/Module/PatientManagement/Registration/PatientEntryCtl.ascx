<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientEntryCtl" %>
...
<script type="text/javascript" id="dxss_patiententryctl">
    ...
    //#region Office City
    $('#<%=lblPatientJobOfficeCity.ClientID%>.lblLink').live('click', function (evt) {
    ...
    //#region City
    $('#<%=lblCity.ClientID%>.lblLink').live('click', function (evt) {
        openSearchDialog('city', '', function (value) {
    ...
    $('#<%=lblCityDomicile.ClientID%>.lblLink').live('click', function (evt) {
        openSearchDialog('city', '', function (value) {
    ...
    $('#<%=lblDomicileProvince.ClientID%>.lblLink').live('click', function (evt) {
        openSearchDialog('stdcode', onGetSCProvinceFilterExpression(), function (value) {
            ...
            <td style="padding: 5px; vertical-align: top;">
                ...
                <div class="containerTblEntryContent">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblLink" id="lblPatientJobOfficeCity" runat="server">
                                    <%=GetLabel("Kota")%></label>
                            </td>
                            <td>
            ...
            <td style="padding: 5px; vertical-align: top;">
                ...
                <div class="containerTblEntryContent">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblMandatory lblLink" id="lblCity" runat="server">
                                    <%=GetLabel("Kota")%></label>
                            </td>
                            <td>
                ...
                <div class="containerTblEntryContent">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblLink" id="lblCityDomicile" runat="server">
                                    <%=GetLabel("Kota")%></label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblLink" id="lblDomicileProvince" runat="server">
                                    <%=GetLabel("Provinsi")%></label>
                            </td>
                            <td>
                                <table style="width: 100%" cellpadding="0" cellspacing="0">
