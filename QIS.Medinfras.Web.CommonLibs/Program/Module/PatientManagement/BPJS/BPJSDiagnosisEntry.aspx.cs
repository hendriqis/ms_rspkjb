...
{
    public partial class BPJSDiagnosisEntry : BasePagePatientPageListEntry
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            {
                case Constant.Facility.INPATIENT: return Constant.MenuCode.Inpatient.IP_BPJS_CLAIM_DIAGNOSA_PASIEN;
                case Constant.Facility.EMERGENCY: return Constant.MenuCode.EmergencyCare.ER_BPJS_CLAIM_DIAGNOSA_PASIEN;
                case Constant.Facility.PHARMACY: return Constant.MenuCode.Pharmacy.PH_BPJS_CLAIM_DIAGNOSA_PASIEN;
                case Constant.Facility.DIAGNOSTIC:
                    if (AppSession.MedicalDiagnostic.MedicalDiagnosticType == MedicalDiagnosticType.Laboratory)
                        return Constant.MenuCode.Laboratory.LB_BPJS_CLAIM_DIAGNOSA_PASIEN;
                    if (AppSession.MedicalDiagnostic.MedicalDiagnosticType == MedicalDiagnosticType.Imaging)
                        return Constant.MenuCode.Imaging.IS_BPJS_CLAIM_DIAGNOSA_PASIEN;
                    return Constant.MenuCode.MedicalDiagnostic.MD_BPJS_CLAIM_DIAGNOSA_PASIEN;
                default: return Constant.MenuCode.MedicalRecord.BPJS_PROSES_DIAGNOSA_PASIEN;
            }
        }
