<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointmentManagementTransactionDetailServiceCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.AppointmentManagementTransactionDetailServiceCtl" %>
...
<script type="text/javascript" id="dxss_draftservicectl">
    //#region Service
    function onLoadService() {
        $('#<%=hdnParamHealthcareServiceUnitID.ClientID %>').val(getHealthcareServiceUnitID());
    ...
    $('#lblServiceAddData').live('click', function (evt) {
        if (IsValid(null, 'fsMPEntry', 'mpEntryPopup')) {
            $('#<%=hdnTempTotalPatient.ClientID %>').val(getServiceTotalPatient());
            $('#<%=hdnTempTotalPayer.ClientID %>').val(getServiceTotalPayer());
