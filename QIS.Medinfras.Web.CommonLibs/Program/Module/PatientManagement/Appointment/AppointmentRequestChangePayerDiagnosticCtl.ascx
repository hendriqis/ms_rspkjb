<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointmentRequestChangePayerDiagnosticCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.AppointmentRequestChangePayerDiagnosticCtl" %>
