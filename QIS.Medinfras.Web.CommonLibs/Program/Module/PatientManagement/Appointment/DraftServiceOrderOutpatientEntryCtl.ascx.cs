...
{
    public partial class DraftServiceOrderOutpatientEntryCtl : BaseEntryPopupCtl2
    {
        ...
        {
            SetControlEntrySetting(hdnDraftServiceOrderOutpatientID, new ControlEntrySetting(false, false, false, "0"));
            SetControlEntrySetting(txtDraftServiceOrderOutpatientNo, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtReferenceNo, new ControlEntrySetting(true, true, false));
            SetControlEntrySetting(txtDraftServiceOrderOutpatientDate, new ControlEntrySetting(true, false, true, DateTime.Now.ToString(Constant.FormatString.DATE_PICKER_FORMAT)));
            SetControlEntrySetting(txtDraftServiceOrderOutpatientTime, new ControlEntrySetting(true, false, true, DateTime.Now.ToString(Constant.FormatString.TIME_FORMAT)));
        ...
        private void OnLoadEntity(string keyValue)
        {
            ...
            {
                filterExpression = string.Format("DraftServiceOrderNo = '{0}'", txtDraftServiceOrderOutpatientNo.Text);
            }
        ...
        protected void cbpMainPopup_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            {
                LoadPage(hdnDraftServiceOrderOutpatientID.Value);
            }
            else if (param[0] == "new")
            {
                ReInitControl();
        ...
        public void SaveDraftServiceOrderHd(IDbContext ctx, ref int draftserviceOrderID)
        {
            ...
            if (hdnDraftServiceOrderOutpatientID.Value == "0")
            {
                ...
                entityHd.DraftServiceOrderDate = Helper.GetDatePickerValue(Request.Form[txtDraftServiceOrderOutpatientDate.UniqueID]);
                entityHd.DraftServiceOrderTime = Request.Form[txtDraftServiceOrderOutpatientTime.UniqueID];
                entityHd.Remarks = txtNotes.Text;
                entityHd.ParamedicID = Convert.ToInt32(hdnPhysicianID.Value);
                entityHd.TransactionCode = Constant.TransactionCode.DRAFT_ER_OUTPATIENT_ORDER;
            ...
            {
                draftserviceOrderID = Convert.ToInt32(hdnDraftServiceOrderOutpatientID.Value);
            }
        }
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                if (entity.GCAppointmentStatus == Constant.AppointmentStatus.STARTED)
                {
                    ...
                    hdnDraftServiceOrderOutpatientID.Value = draftServiceOrderID.ToString();
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retval)
        {
            try
            {
                ...
                {
                    DraftServiceOrderHd entity = BusinessLayer.GetDraftServiceOrderHd(Convert.ToInt32(hdnDraftServiceOrderOutpatientID.Value));
        ...
        protected override bool OnVoidRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                if (appointment.GCAppointmentStatus == Constant.AppointmentStatus.STARTED)
                {
                    Int32 DraftServiceOrderID = Convert.ToInt32(hdnDraftServiceOrderOutpatientID.Value);
            ...
            try
            {
                ...
                if (appointment.GCAppointmentStatus == Constant.AppointmentStatus.STARTED)
                {
                    ...
                    if (entity.GCTransactionStatus == Constant.TransactionStatus.OPEN)
                    {
                        ...
                        entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                        //                    List<DraftServiceOrderDt> lstDt = BusinessLayer.GetDraftServiceOrderDtList(string.Format("DraftserviceOrderID = {0}", hdnDraftServiceOrderOutpatientID.Value));
                        BusinessLayer.UpdateDraftServiceOrderHd(entity);
                        return true;
                    }
                    else
        ...
        protected void cbpViewCtl_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            if (param[0] == "save")
            {
                ...
                {
                    serviceOrderID = Convert.ToInt32(hdnDraftServiceOrderOutpatientID.Value);
        ...
        private void EntityToControl(vDraftServiceOrderHd entity)
        {
            ...
            if (IsEditable)
            {
                divAddDataOutpatientDraftOrder.Style.Remove("display");
                hdnIsEditable.Value = "1";
            }
            else
            {
                divAddDataOutpatientDraftOrder.Style.Add("display", "none");
                hdnIsEditable.Value = "0";
            }

            hdnDraftServiceOrderOutpatientID.Value = entity.DraftServiceOrderID.ToString();
            txtDraftServiceOrderOutpatientNo.Text = entity.DraftServiceOrderNo;
            txtDraftServiceOrderOutpatientDate.Text = entity.DraftServiceOrderDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
            txtDraftServiceOrderOutpatientTime.Text = entity.DraftServiceOrderTime;
