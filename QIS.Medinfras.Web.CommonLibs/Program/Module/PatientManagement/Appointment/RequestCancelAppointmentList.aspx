<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="RequestCancelAppointmentList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.RequestCancelAppointmentList" %>
...
//                }
        ...
        $('.btnSave').live('click', function () {
            ...
            cbpView.PerformCallback('confirm');
        });
                                    ...
                                    <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                                        <EmptyDataTemplate>
                                            <table id="tblView" runat="server" class="grdMCUOrder grdSelected" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <th align="left">
                                                        <%=GetLabel("No. Apppointment")%>
                                                    </th>
                                                    <th align="left">
                                                        <i><%=GetLabel("No. Rekam Medis")%></i><br />
                                                        <%=GetLabel("Pasien")%>
                                                    </th>
                                                    <th align="left">
                                                        <%=GetLabel("Klinik")%>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <i><%#: Eval("GuestID").ToString() != null && Eval("GuestID").ToString() != "0" ? Eval("GuestNo") : Eval("MedicalNo")%></i><br />
                                                ...
                                                <td align="left">
                                                    <%#: Eval("cfAppointmentRequestDate")%>
                                                </td>
                                                <td align="left">
                                                    <%#: Eval("RequestDeletedReason")%>
                                                </td>
                                                ...
                                                <td align="center">
                                                    <input type="button" id="btnSave" class="btnSave" value="Konfirmasi Batal" runat="server" />
                                                </td>
                                                <td align="center" style="display:none"> 
