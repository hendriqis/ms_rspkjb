...
{
    public partial class AppointmentRescheduleCtl : BaseEntryPopupCtl
    {
                        ...
                        if (isTimeSlot)
                        {
                            if (timeSlot == "0")
                            {
                                if (objSchDateFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objSchDateFrom.StartTime1, objSchDateFrom.EndTime1);
                                ...
                                else if (objFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED,Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objFrom.StartTime1, objFrom.EndTime1);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                            ...
                            else if (timeSlot == "1")
                            {
                                if (objSchDateFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objSchDateFrom.StartTime2, objSchDateFrom.EndTime2);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                                ...
                                else if (objFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objFrom.StartTime2, objFrom.EndTime2);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                            ...
                            else if (timeSlot == "2")
                            {
                                if (objSchDateFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objSchDateFrom.StartTime3, objSchDateFrom.EndTime3);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                                ...
                                else if (objFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objFrom.StartTime3, objFrom.EndTime3);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                            ...
                            else if (timeSlot == "3")
                            {
                                if (objSchDateFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objSchDateFrom.StartTime4, objSchDateFrom.EndTime4);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                                ...
                                else if (objFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objFrom.StartTime4, objFrom.EndTime4);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                            ...
                            else if (timeSlot == "4")
                            {
                                if (objSchDateFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objSchDateFrom.StartTime5, objSchDateFrom.EndTime5);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                                ...
                                else if (objFrom != null)
                                {
                                    ...
                                    {
                                        filterFrom = String.Format("GCAppointmentStatus NOT IN ('{0}','{1}','{2}') AND isWaitingList = 0 AND ParamedicID = {3} AND HealthcareServiceUnitID = {4} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{6}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{5}') + ' ' + '{7}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, Constant.AppointmentStatus.COMPLETE, ParamedicIDFrom, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), selectedDateFrom.ToString("yyyy-MM-dd"), objFrom.StartTime5, objFrom.EndTime5);
                                        lstAppoFrom = BusinessLayer.GetAppointmentList(filterFrom);
                                ...
                                if (timeSlot == "0")
                                {
                                    if (objSchDateTo != null)
                                    {
                                        if (objSchDateTo.IsAppointmentByTimeSlot1 && objSchDateTo.StartTime1 != "")
                                        {
                                            ...
                                            filterGetAllQueue = String.Format("isWaitingList = 0 AND ParamedicID = {2} AND HealthcareServiceUnitID = {3} AND CONVERT(DATETIME,CONVERT(VARCHAR,StartDate) + ' ' + StartTime) >= CONVERT(DATETIME,CONVERT(VARCHAR,'{4}') + ' ' + '{5}') AND CONVERT(DATETIME,CONVERT(VARCHAR,EndDate) + ' ' + EndTime) <= CONVERT(DATETIME,CONVERT(VARCHAR,'{4}') + ' ' + '{6}')", Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED, ParamedicIDTo, Convert.ToInt32(cboServiceUnitRescheduleTo.Value), selectedDateTo.ToString("yyyy-MM-dd"), objSchDateTo.StartTime1, objSchDateTo.EndTime1);
                            ...
                            if (isValidTo)
                            {
                                ...
                                if (isValidFromVisitTpe)
                                {
                                    ...
                                    if (lstAppoTo.Count() > 0)
                                    {
                                        ...
                                        int QueueTemp = 1;
                                        lstAppoTo = BusinessLayer.GetAppointmentList(filterGetAllQueue).OrderBy(o => o.QueueNo).ToList(); ;
                                        ...
                                        foreach (Appointment a in lstAppoFrom)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                start = start.AddMinutes(a.VisitDuration);
                                                newAppoTo.BusinessPartnerID = a.BusinessPartnerID;
                                        ...
                                        else
                                        {
                                            ...
                                            BusinessLayer.OnUpdateQueueLastNo(appoEND.HealthcareServiceUnitID, appoEND.ParamedicID, Convert.ToInt32(appoEND.Session), Convert.ToInt32(appoEND.QueueNo), appoEND.StartDate, Convert.ToInt32(cboServiceUnitRescheduleFrom.Value), Convert.ToInt32(hdnParamedicIDCtlFrom.Value), Convert.ToInt32(timeSlot) + 1, Helper.GetDatePickerValue(hdnCalAppointmentSelectedDateRescheduleCtlFrom.Value), ctx);
