<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DraftAppointmentInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.DraftAppointmentInfoCtl" %>
...
<style type="text/css">
    ...
    .chkIsSelected{display:none;}
    .chkSelectAll{display:none;}
    .chkIsSelectedTestOrder{display:none;}
    #tdToolbarButton{display:none;}
</style>
...
<div>
    <input type="hidden" runat="server" id="hdnAppointmentCtlID" value="" />
