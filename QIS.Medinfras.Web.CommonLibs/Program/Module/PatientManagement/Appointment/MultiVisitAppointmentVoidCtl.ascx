<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiVisitAppointmentVoidCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.MultiVisitAppointmentVoidCtl" %>
...
<input type="hidden" runat="server" id="hdnIsUsingMultiVisitSchedule" value="" />
<table style="margin-top: 10px; text-align: left; width: 100%;">
    ...
    <tr>
        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Tindakan ke")%></label></td>
        <td colspan="2"><asp:TextBox ID="txtSequenceNo" ReadOnly="true" Width="350px" runat="server" /></td>
    </tr>  
    <tr>
        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Nama Tindakan")%></label></td>
        <td colspan="2"><asp:TextBox ID="txtItemName" ReadOnly="true" Width="350px" runat="server" /></td>
    </tr>  
    <tr>
