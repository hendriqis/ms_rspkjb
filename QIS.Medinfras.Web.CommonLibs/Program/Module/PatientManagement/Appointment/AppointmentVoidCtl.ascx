<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointmentVoidCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.AppointmentVoidCtl" %>
...
<input type="hidden" runat="server" id="hdnIsBridgingToMobileJKN" value="" />
<input type="hidden" runat="server" id="hdnIsBridgingToSistemAntrian" value="" />
