...
{
    public partial class AppointmentChangeDateV2Ctl : BaseViewPopupCtl
    {
        ...
        private void CreateNewAppointment(Appointment NewAppo, Appointment oldAppo, AppointmentDao entityDao, IDbContext ctx)
        {
            ...
            entityNewAppo.QueueNo = Convert.ToInt16(BusinessLayer.GetQueueNo(entityNewAppo.HealthcareServiceUnitID, Convert.ToInt32(entityNewAppo.ParamedicID), entityNewAppo.StartDate, Convert.ToInt32(entityNewAppo.Session), false, isBPJS, 1, 0, ctx));
