<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointmentVoidDiagnosticCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.AppointmentVoidDiagnosticCtl" %>
...
<table style="margin-top: 10px; text-align: left; width: 100%;">
    ...
    <tr style="display:none">
        <td colspan=2 class="tdLabel"><label class="lblNormal"><%=GetLabel("Appointment Yang Akan Di Batalkan")%></label></td>
        <td><asp:TextBox ID="txtAppointmentNo" ReadOnly="true" Width="20px" runat="server" /></td>
    </tr>  
    <tr>
        <td colspan=3>
            <asp:CheckBox ID="chkIsVoidAppointmentRequest" runat="server" /><%=GetLabel("  Hanya membatalkan perjanjian pasien saja?")%>
        </td>
    </tr>
   <%-- <tr>
