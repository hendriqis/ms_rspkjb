<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointmentRequestVoidCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.AppointmentRequestVoidCtl" %>
