<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true"
    CodeBehind="PatientManagementTransactionDetailAIO.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientManagementTransactionDetailAIO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onBeforeLoadRightPanelContent(code) {
            ...
            else if (code == 'sendOrderToRIS' || code == 'changeDetailRemarks' || code == 'inputSerialNumber' || code == 'inputFixedAsset') {
                return $('#<%:hdnTransactionHdID.ClientID %>').val();
            }
        ...
        $(function () {
            ...
            $('#<%=btnClinicTransactionTestOrder.ClientID %>').click(function () {
                ...
                if (isOT == "1") {
                    ...
                    openUserControlPopup(url, ID, 'Order Pelayanan Detail AIO', 800, 600);
                }
            });
        ...
        function onLoad() {
            ...
            $('#<%=btnClinicTransactionBack.ClientID %>').click(function () {
                ...
                if (getDepartmentID() == 'DIAGNOSTIC') {
                    document.location = ResolveUrl('~/Libs/Program/Module/MedicalDiagnostic/WorkList/MDOrder/MDOrderAIOList.aspx');
                }
                else {
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            else if (code == 'PM-00138' || code == 'PM-00509') {
