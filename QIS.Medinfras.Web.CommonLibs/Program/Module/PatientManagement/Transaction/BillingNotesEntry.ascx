<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BillingNotesEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.BillingNotesEntry" %>
...
<script type="text/javascript" id="dxss_patientvisitnotesctl">
    ...
    $('.imgEdit.imgLink').live('click', function () {
        ...
        cboGCNoteType.SetValue(entity.GCNoteType);
                            ...
                            <tr>
                                <td class="tdlabel">
                                    <label class="lblMandatory">
                                        <%=GetLabel("Jenis Catatan Pasien")%></label>
                                </td>
                                <td>
                                    <dxe:ASPxComboBox ID="cboGCNoteType" ClientInstanceName="cboGCNoteType" Width="100%"
                                                    runat="server" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <asp:Panel runat="server" ID="pnlPatientVisitTransHdGrdView" Style="width: 100%;
                                ...
                                <asp:GridView ID="grdVisitNotes" runat="server" CssClass="grdView notAllowSelect"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderStyle-Width="100px" DataField="NoteDateInString" HeaderText="Tanggal" HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField HeaderStyle-Width="80px" DataField="NoteTime" HeaderText="Waktu" HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField HeaderStyle-Width="150px" DataField="NoteType" HeaderText="Jenis Catatan" HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="NoteText" HeaderText="Catatan" HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField HeaderStyle-Width="180px" DataField="CreatedByName" HeaderText="Dibuat Oleh" HeaderStyle-HorizontalAlign="Left" />
                                    </Columns>
                                    <EmptyDataTemplate>
