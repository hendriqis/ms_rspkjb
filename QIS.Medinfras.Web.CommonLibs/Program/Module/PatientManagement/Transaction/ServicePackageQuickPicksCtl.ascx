<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServicePackageQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ServicePackageQuickPicksCtl" %>
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="cfItemName1" HeaderText="Pelayanan yang tersedia :" ItemStyle-CssClass="tdItemName1"
                                                HeaderStyle-HorizontalAlign="Left" />
                                            <asp:BoundField DataField="Quantity" HeaderText="Qty" ItemStyle-CssClass="tdItemName1"
                                                HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
<%--                                            <asp:BoundField DataField="cfExpiredDate" HeaderText="ED" ItemStyle-CssClass="tdItemName1"
