<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChargesLabQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ChargesLabQuickPicksCtl" %>
    ...
    function onBeforeSaveRecord(errMessage) {
        ...
        if ($('#<%=hdnSelectedMember.ClientID %>').val() != "") {
            if ($('#<%=hdnServicePhysicianID.ClientID %>').val() != "") {
                ...
                var oTransactionDate = $('#<%=hdnTransactionDateCtl.ClientID %>').val();
                if (oTransactionDate != null && oTransactionDate != "") {
                    var oCountData = 0;
                    var lstItemID = $('#<%=hdnSelectedMember.ClientID %>').val().split(',');
                    var itemID = '';
                    ...
                    if (oTransactionDate != null && oTransactionDate != "") {
                        ...
                        var filterChargesDt = "VisitID = " + oVisitID + " AND CONVERT(VARCHAR(10), TransactionDate, 112) = '" + oTransactionDate + "' AND ItemID IN (" + itemID + ")";
                ...
                displayErrorMessageBox("Order Pemeriksaan", "Pilih Dokter Pelaksana terlebih dahulu.");
                return false;
            }
        }
        else {
            errMessage.text = 'Harus ada item pemeriksaan yang dipilih sebelum disimapan';
            return false;
        }
    }
...
<div style="padding: 10px; height: 450px; overflow-x: hidden; overflow-y: scroll">
    ...
    <input type="hidden" id="hdnIsPATest" runat="server" value="" />
    ...
    <table style="width:100%">
        ...
        <tr>
            ...
            <td class="tdLabel">
                <label class="lblDiagnose lblLink" id="lblDiagnose">
