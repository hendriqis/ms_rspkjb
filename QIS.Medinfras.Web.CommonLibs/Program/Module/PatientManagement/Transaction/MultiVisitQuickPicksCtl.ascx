<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiVisitQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.MultiVisitQuickPicksCtl" %>
...
<script type="text/javascript" id="dxss_servicequickpicksctl">
    ...
    function onCboTestOrderValueChanged() {
        cbpView.PerformCallback('refresh');
    }
...
<div style="padding: 10px;">
    ...
    <input type="hidden" id="hdnAppointmentID" runat="server" value="0" />
    <input type="hidden" id="hdnTotalTestOrderCount" runat="server" value="" />
    <fieldset id="fsEntryPopup" style="margin: 0">
        <table>
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxComboBox ID="cboTestOrder" ClientInstanceName="cboTestOrder"
                        Width="100%" runat="server">
                        <ClientSideEvents ValueChanged="function(s,e){ onCboTestOrderValueChanged(); }" />
                    </dxe:ASPxComboBox>
                </td>
            </tr>
