<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DrugsLogisticsQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.DrugsLogisticsQuickPicksCtl" %>
...
<script type="text/javascript" id="dxss_drugslogisticsquickpicksctl">
    ...
    function onCboStockStatusValueChanged() {
        getCheckedMember();
        cbpView.PerformCallback('refresh');
    }
...
<div style="padding: 10px;">
    ...
    <table>
        ...
        <tr>
            <td>
                <label class="lblNormal" id="lblStock">
                    ...
                    <tr>
                        <td>
                            <dxe:ASPxComboBox ID="cboStockStatus" ClientInstanceName="cboStockStatus" Width="200px"
                                runat="server">
                                <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }" EndCallback="function(s,e){ hideLoadingPanel(); }"
                                    ValueChanged="function(s,e){ onCboStockStatusValueChanged(e) }" />
                            </dxe:ASPxComboBox>
                        </td>
                    </tr>
                </table>
