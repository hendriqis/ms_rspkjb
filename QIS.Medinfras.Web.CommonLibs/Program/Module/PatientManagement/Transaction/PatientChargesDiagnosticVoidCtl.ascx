<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientChargesDiagnosticVoidCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientChargesDiagnosticVoidCtl" %>
