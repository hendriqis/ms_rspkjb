...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public abstract class BasePageTrxPatientManagement : BasePageTrx
    {
        ...
        public abstract String GetTransactionDate2();
        public abstract String GetTransactionTime2();
        public abstract String GetGCTransactionStatus();
        public abstract String GetGCCustomerType();
        public abstract String GetRemarksHd();
        public abstract String GetReferenceNoHd();
        public abstract Boolean GetIsCorrectionTransactionHd();
        public abstract Boolean GetIsAIOTransactionHd();
