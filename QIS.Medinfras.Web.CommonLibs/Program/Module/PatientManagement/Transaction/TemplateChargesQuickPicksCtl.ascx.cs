...
{
    public partial class TemplateChargesQuickPicksCtl : BaseEntryPopupCtl
    {
        ...
        protected void grdView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                ChargesTemplateHd entity = e.Row.DataItem as ChargesTemplateHd;
                CheckBox chkIsSelected = e.Row.FindControl("chkIsSelected") as CheckBox;
                if (lstSelectedMember.Contains(entity.ChargesTemplateID.ToString()))
                {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetChargesTemplateHdRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, 10);
            }

            lstSelectedMember = hdnSelectedMember.Value.Split(',');
            List<ChargesTemplateHd> lstEntity = BusinessLayer.GetChargesTemplateHdList(filterExpression, 10, pageIndex, "ChargesTemplateName ASC");
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                {
                    string filterTemplate = string.Format("ChargesTemplateID IN ({0})", x);
