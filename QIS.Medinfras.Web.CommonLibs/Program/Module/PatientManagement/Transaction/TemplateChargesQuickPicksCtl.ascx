<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TemplateChargesQuickPicksCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TemplateChargesQuickPicksCtl" %>
...
<script type="text/javascript" id="dxss_servicequickpicksctl">
    ...
    $('#<%=grdView.ClientID %> .chkIsSelected input').live('change', function () {
        if ($(this).is(':checked')) {
            ...
            $newTr = $newTr.replace(/\$\{ChargesTemplateName}/g, $selectedTr.find('.tdChargesTemplateName').html());
            $newTr = $newTr.replace(/\$\{ChargesTemplateID}/g, $selectedTr.find('.keyField').html());
            $newTr = $($newTr);
    ...
    <script id="tmplSelectedTestItem" type="text/x-jquery-tmpl">
        <tr class="trSelectedItem">
            <td align="center">
                ...
                <input type="hidden" class="keyField" value='${ChargesTemplateID}' />
            </td>
            <td>${ChargesTemplateName}</td>
        </tr>
    </script>
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ChargesTemplateName" HeaderText="Template yang tersedia :" ItemStyle-CssClass="tdChargesTemplateName"
