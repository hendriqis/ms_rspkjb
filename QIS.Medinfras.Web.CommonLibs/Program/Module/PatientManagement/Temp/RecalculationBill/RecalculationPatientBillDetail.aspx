<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="RecalculationPatientBillDetail.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.RecalculationPatientBillDetail" %>
    ...
    <script type="text/javascript" id="dxss_generatebilldtctl">
        function onLoad() {
            ...
            $('#<%=btnRecalculationPatientBillRecalculate.ClientID %>').click(function () {
                ...
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/RecalculationBill/RecalculationPatientBillProcessCtl.ascx");
