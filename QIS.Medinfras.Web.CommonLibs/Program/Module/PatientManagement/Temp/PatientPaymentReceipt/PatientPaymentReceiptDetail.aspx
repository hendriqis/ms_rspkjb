<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="PatientPaymentReceiptDetail.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPaymentReceiptDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
        ...
        $(function () {
            ...
            $('#<%=btnProcessPaymentReceipt.ClientID %>').click(function () {
                if ($('#<%=hdnKode.ClientID %>').val() == 'r') {
                    ...
                    showLoadingPanel();
                    var url = ResolveUrl('~/Libs/Program/Module/PatientManagement/PatientPaymentReceipt/PatientPaymentReceiptVoidCtl.ascx');
                    var receiptID = $('#<%=hdnPaymentReceiptID.ClientID %>').val();
            ...
            $('.lnkPaymentReceipt').click(function () {
                ...
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientPaymentReceipt/PaymentReceiptDtCtl.ascx");
    ...
    <div style="height:435px;overflow-y:auto;">
        <div class="pageTitle">
            <div style="font-size: 1.1em"><%=GetLabel("Cetak Ulang Kwitansi Pasien")%></div>
        </div>
