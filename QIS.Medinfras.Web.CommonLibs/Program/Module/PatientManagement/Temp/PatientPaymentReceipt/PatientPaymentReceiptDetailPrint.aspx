<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="PatientPaymentReceiptDetailPrint.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPaymentReceiptDetailPrint" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPaymentReceiptBack" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/back.png")%>' alt="" /><div><%=GetLabel("Back")%></div></li>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    ...
    <script type="text/javascript">
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            var paymentID = $('#<%=hdnPaymentID.ClientID %>').val();
            if (paymentID == '') {
        ...
        $(function () {
            ...
            grd.init('<%=grdView.ClientID %>', '<%=hdnPaymentID.ClientID %>', '<%=pnlService.ClientID %>', cbpView);

            $('#<%=btnPaymentReceiptBack.ClientID %>').click(function () {
                document.location = ResolveUrl('~/Program/PatientList/RegistrationList.aspx?id=pprp');
            });
            $('#<%=btnProcessPaymentReceipt.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Libs/Program/Module/PatientManagement/PatientPaymentReceipt/PatientPaymentReceiptDetailPrintCtl.ascx');
            ...
            $('.lnkPaymentNo').click(function () {
                ...
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/PatientPaymentReceipt/PaymentDetailDtCtl.ascx");
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td>
                                                            <div style="padding:3px;text-align:right;">
                                                                <input type="hidden" class="hdnPaymentAmount" value='<%#: Eval("TotalPaymentAmount")%>' />
                                                                <div><%#: Eval("TotalPaymentAmount", "{0:N}")%></div>                                                   
                                                            </div>   
                                                        </td>
                                                     </tr>
                                                 </ItemTemplate>
