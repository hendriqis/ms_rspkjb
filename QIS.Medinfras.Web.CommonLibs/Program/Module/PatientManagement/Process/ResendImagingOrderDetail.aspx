<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.master"
    AutoEventWireup="true" CodeBehind="ResendImagingOrderDetail.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ResendImagingOrderDetail" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        $('#<%=btnBack.ClientID %>').live('click', function () {
            showLoadingPanel();
            var url = "~/Libs/Program/Module/PatientManagement/Process/ResendImagingOrderList.aspx";
