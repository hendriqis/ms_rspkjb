<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="PrescriptionReprintList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PrescriptionReprintList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding:15px;">
        ...
        <div style="padding:2px;display:none;" id="containerDaftar" class="containerOrder">
            ...
            <div class="pageTitle"><%=GetLabel("Cetak Ulang Etiket")%> : <%=GetLabel("Pilih Pasien")%></div>
