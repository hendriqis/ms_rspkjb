<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="ResendLaboratoryOrderList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ResendLaboratoryOrderList" %>
    ...
    <div style="padding:15px;">
        <div class="containerUlTabPage">
           <ul class="ulTabPage" id="ulTabLabResult">
                ...
                <li contentid="containerDaftar"><%=GetLabel("Pendaftaran Pasien")%></li>
           </ul>
        </div>
