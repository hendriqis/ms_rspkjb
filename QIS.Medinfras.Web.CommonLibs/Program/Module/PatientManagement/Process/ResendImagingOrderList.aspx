<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="ResendImagingOrderList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ResendImagingOrderList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        ...
        function onBeforeRightPanelPrint(code, filterExpression) {
            if (code == 'IS-00004') {
                var Dept = "-";
                if (cboMedicalDiagnosticOrder.GetValue() != null) {
                    Dept = cboMedicalDiagnosticOrder.GetValue();
                }

                var Unit = "-";
                if ($('#<%:txtServiceUnitOrderCode.ClientID %>').val() != null) {
                    Unit = $('#<%:txtServiceUnitOrderCode.ClientID %>').val();
                }

                var Type = "-";
                Type = cboOrderResultType.GetValue();

                if ($('#<%:chkIsPreviousEpisodePatientOrder.ClientID %>').is(':checked')) {
                    filterExpression.text = Dept + "|" + Unit + "|" + "-" + "|" + Type + "|";
                }
                else {
                    var Tgl = $('#<%:txtOrderDate.ClientID %>').val();
            ...
            } else if (code == 'MD-00005') {
                var Medis = "-";
                if (cboMedicalDiagnosticOrder.GetValue() != null) {
                    Medis = cboMedicalDiagnosticOrder.GetValue();
                }

                var Dept = "-";
                if (cboPatientFromOrder.GetValue() != null) {
                    Dept = cboPatientFromOrder.GetValue();
                }
                ...
                if ($('#<%:chkIsPreviousEpisodePatientOrder.ClientID %>').is(':checked')) {
                    filterExpression.text = Medis + "|" + Dept + "|" + Unit + "|" + "-" + "|" + Type + "|";
                }
                else {
                    var Tgl = $('#<%:txtOrderDate.ClientID %>').val();
                    filterExpression.text = Medis + "|" + Dept + "|" + Unit + "|" + Tgl + "|" + Type + "|";
                }
                if (filterExpression != "") {
                    return true;
                } else {
                        ...
                        <fieldset id="fsPatientList">
                            <table class="tblEntryContent" style="width: 60%;">
                                ...
                                <tr id="trServiceUnit" runat="server">
                                    ...
                                    <td>
                                        <dxe:ASPxComboBox ID="cboMedicalDiagnosticOrder" ClientInstanceName="cboMedicalDiagnosticOrder"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxComboBox ID="cboPatientFromOrder" ClientInstanceName="cboPatientFromOrder"
                                    ...
                                    <td>
                                        ...
                                        <table style="width: 100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtServiceUnitOrderName" ReadOnly="true" Width="272px" runat="server" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr id="trOrderDate">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtOrderDate" Width="120px" runat="server" CssClass="datepicker" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <qis:QISIntellisenseTextBox runat="server" ClientInstanceName="txtSearchViewOrder"
                                            ID="txtSearchViewOrder" Width="400px" Watermark="Search">
...
<%--                                            <IntellisenseHints>
                                ...
                                <tr>
                                    <td class="tdLabel">
                                        <label class="lblNormal">
                                            <%=GetLabel("Filter status order")%></label>
                                    </td>
                                    <td>
        ...
        <div id="containerDaftar" class="containerOrder" style="display: none">
            <div class="pageTitle">
                                ...
                                <tr id="trServiceUnitOrder" runat="server">
                                    ...
                                    <td>
                                        <dxe:ASPxComboBox ID="cboMedicalDiagnostic" ClientInstanceName="cboMedicalDiagnostic"
                                            runat="server" Width="350px">
                                            <ClientSideEvents ValueChanged="function(s,e) { onCboMedicalDiagnosticValueChanged(); }" />
                                        </dxe:ASPxComboBox>
                                    </td>
                                </tr>
                                <tr>
