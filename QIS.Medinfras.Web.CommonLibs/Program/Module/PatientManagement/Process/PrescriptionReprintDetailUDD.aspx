<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.master"
    AutoEventWireup="true" CodeBehind="PrescriptionReprintDetailUDD.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PrescriptionReprintDetailUDD" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('#<%=btnPrintDrugLabel.ClientID %>').live('click', function () {
