<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="RecalculationPatientBillMDDetail.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.RecalculationPatientBillMDDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnRecalculationPatientBillBack" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/back.png")%>' alt="" /><div><%=GetLabel("Back")%></div></li>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    <script type="text/javascript" id="dxss_generatebilldtctl">
        function onLoad() {
            ...
            $('#<%=btnRecalculationPatientBillBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/PatientList/RegistrationList.aspx?id=rpb');
            });
            ...
            $('#<%=btnRecalculationPatientBillRecalculate.ClientID %>').click(function () {
                ...
                var url = ResolveUrl("~/Libs/Program/Module/MedicalDiagnostic/RecalculationBill/RecalculationPatientBillMDProcessCtl.ascx");
            ...
            $('#<%=btnRecalculationPatientBillUpdatePayer.ClientID %>').click(function () {
                ...
                var id = $('#<%=hdnRegistrationID.ClientID %>').val();
                var url = ResolveUrl("~/Libs/Program/Module/PatientManagement/RecalculationBill/RecalculationPatientBillUpdatePayerCtl.ascx");
