<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewSurgeryTimeOutCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewSurgeryTimeOutCtl" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>

<script type="text/javascript" id="dxss_ViewSurgeryTimeOutCtl">
    $(function () {
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDate" Width="120px" Style="text-align: center" runat="server" ReadOnly="true" />
                        </td>
                        <td>
