<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingPostOperativeFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.NursingPostOperativeFormEntry" %>
