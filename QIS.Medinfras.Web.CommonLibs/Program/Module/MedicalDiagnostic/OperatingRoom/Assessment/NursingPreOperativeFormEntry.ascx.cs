...
{
    public partial class NursingPreOperativeFormEntry : BaseEntryPopupCtl
    {
        ...
        private void PopulateFormContent()
        {
            ...
            string fileName = string.Format(@"{0}\medicalForm\OperatingRoom\perioperativePreEntry.html", filePath);
        ...
        {
            entity.PreOperativeDate = Helper.GetDatePickerValue(txtDate);
            entity.PreOperativeTime = txtTime.Text;
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retVal)
        {
            ...
            try
            {
                ...
                entity.PreOperativeLayout = hdnDivHTML.Value;
                entity.PreOperativeValues = hdnFormValues.Value;
                entity.PreOperativeRemarks = txtRemarks.Text;
                entity.PreOperativeWardNurseID = Convert.ToInt32(cboParamedicID2.Value);
                entity.PreOperativeSurgeryNurseID = Convert.ToInt32(cboParamedicID.Value);
                entity.PreOperativeUserID = AppSession.UserLogin.UserID;
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retVal)
        {
            ...
            try
            {
                ...
                entity.PreOperativeSurgeryNurseID = Convert.ToInt32(cboParamedicID.Value);
                entity.PreOperativeUserID = AppSession.UserLogin.UserID;
                entity.PreOperativeLastUpdatedDate = DateTime.Now.Date;
