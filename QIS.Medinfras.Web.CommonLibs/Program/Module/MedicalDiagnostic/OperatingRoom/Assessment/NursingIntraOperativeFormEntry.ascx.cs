...
{
    public partial class NursingIntraOperativeFormEntry : BaseEntryPopupCtl
    {
        ...
        private void PopulateFormContent()
        {
            ...
            string fileName = string.Format(@"{0}\medicalForm\OperatingRoom\perioperativeIntraEntry.html", filePath);
        ...
        private void SetControlProperties(string[] paramInfo)
        {
            ...
            Methods.SetComboBoxField<vParamedicMaster>(cboParamedicID3, lstParamedic, "ParamedicName", "ParamedicID");
            ...
            else
            {
                ...
                cboParamedicID3.Value = paramInfo[6];
        ...
        {
            entity.IntraOperativeDate = Helper.GetDatePickerValue(txtDate);
            entity.IntraOperativeTime = txtTime.Text;
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retVal)
        {
            ...
            try
            {
                ...
                entity.IntraOperativeLayout = hdnDivHTML.Value;
                entity.IntraOperativeValues = hdnFormValues.Value;
                entity.IntraOperativeRemarks = txtRemarks.Text;
                entity.IntraOperativeRecoveryRoomNurseID = Convert.ToInt32(cboParamedicID2.Value);
                entity.IntraOperativeCircularNurseID = Convert.ToInt32(cboParamedicID.Value);
                if (cboParamedicID3.Value != null)
                {
                    if (!string.IsNullOrEmpty(cboParamedicID3.Value.ToString()))
                        entity.IntraOperativeInstrumentNurseID = Convert.ToInt32(cboParamedicID3.Value);
                }
                entity.IntraOperativeUserID = AppSession.UserLogin.UserID;
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retVal)
        {
            ...
            try
            {
                ...
                entity.IntraOperativeUserID = AppSession.UserLogin.UserID;
                entity.IntraOperativeLastUpdatedDate = DateTime.Now.Date;
