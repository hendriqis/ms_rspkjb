<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingIntraOperativeFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.NursingIntraOperativeFormEntry" %>
...
<div style="height: 480px">
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblNormal">
                                <%=GetLabel("Perawat Instrument")%></label>
                        </td>
                        <td colspan="2">
                            <dxe:ASPxComboBox ID="cboParamedicID3" Width="350px" runat="server" />
                        </td>
                    </tr>
                    <tr>
    ...
    <table class="tblContentArea" border="0">
        <tr>
            <td>
                <div id="divFormContent" runat="server" style="height: 320px;overflow-x: hidden;overflow-y: auto;"></div>
            </td>
        </tr>
    </table>
</div>
