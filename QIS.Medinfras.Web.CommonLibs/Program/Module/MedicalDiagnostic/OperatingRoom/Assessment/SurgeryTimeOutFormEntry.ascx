<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SurgeryTimeOutFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SurgeryTimeOutFormEntry" %>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblMandatory">
                                <%=GetLabel("Perawat Sirkuler")%></label>
                        </td>
                        <td colspan="2">
