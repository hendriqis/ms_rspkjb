<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewSurgerySignOutCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewSurgerySignOutCtl" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>

<script type="text/javascript" id="dxss_ViewSurgerySignOutCtl">
    $(function () {
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDate" Width="120px" runat="server" Style="text-align: center" ReadOnly="true" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtNurseInfo" Width="350px" runat="server" ReadOnly="true" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtPhysicianInfo" Width="350px" runat="server" ReadOnly="true" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtAnesthesiInfo" Width="350px" runat="server" ReadOnly="true" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                        ...
                        <td>
                            <asp:TextBox ID="txtSurgeryEndDate" Width="120px" runat="server" Style="text-align: center" ReadOnly="true" />
                        </td>
                        <td>
