<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewSurgerySignInCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewSurgerySignInCtl" %>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSignInDate" Width="120px" runat="server" Style="text-align: center" ReadOnly="true" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtSignInTime" Width="80px" CssClass="time" runat="server"
