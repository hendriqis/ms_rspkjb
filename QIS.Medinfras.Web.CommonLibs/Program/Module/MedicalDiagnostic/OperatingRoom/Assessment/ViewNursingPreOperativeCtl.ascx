<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewNursingPreOperativeCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ViewNursingPreOperativeCtl" %>
