<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="ProcedureSurgeryReportEntry1.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ProcedureSurgeryReportEntry1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        $(function () {
                    ...
                    if (validateTime($('#<%=txtReportTime.ClientID %>').val())) {
                        if (validateTime($('#<%=txtStartTime.ClientID %>').val())) {
                            if ($('#<%=rblIsUsingProfilaksis.ClientID %> ').val() == "1") {
                                ...
                                {
                                    displayErrorMessageBox('Laporan Tindakan', 'Format Waktu pengisian Waktu Pemberian yang diinput salah');    
                                }
                            }
                        }
                        else
                        {
                            displayErrorMessageBox('Laporan Tindakan', 'Format Waktu pengisian Jam Mulai Tindakan yang diinput salah');    
                        }
                    }
                    else {
                        displayErrorMessageBox('Laporan Tindakan', 'Format Waktu pengisian Jam Laporan yang diinput salah');                      
                    }
                }
                else {
                    showLoadingPanel();
            ...
            $('#<%=txtReportDate.ClientID %>').datepicker('option', 'maxDate', '0');
                ...
                Methods.getObject('GetvPhysicianTextList', filterExpression, function (obj) {
                    if (obj != null)
                        if ($('#<%=txtRemarks.ClientID %>').val() != '') {
                            var message1 = "Ganti text di uraian Tindakan dengan text dari template ?";
        ...
        var pageCount = parseInt('<%=gridImplantPageCount %>');
        $(function () {
        ...
        $('#lblAddImplantDevice').live('click', function (evt) {
            ...
            if (allow) {
                ...
                var param = "0" + "|" + $('#<%=hdnVisitID.ClientID %>').val() + "|" + $('#<%=hdnMRN.ClientID %>').val() + "|" + $('#<%=hdnPatientChargesDtID.ClientID %>').val();
        ...
        $('.imgEditDevice.imgLink').live('click', function (evt) {
            ...
            var url = ResolveUrl("~/libs/Controls/EMR/_PopupEntry/PatientMedicalDevice/PatientMedicalDeviceEntryCtl.ascx");
            var param = recordID + "|" + $('#<%=hdnVisitID.ClientID %>').val() + "|" + $('#<%=hdnMRN.ClientID %>').val() + "|" + $('#<%=hdnPatientChargesDtID.ClientID %>').val();
            openUserControlPopup(url, param, "Pemasangan Implant", 700, 500);
        });
        ...
        $('.imgDeleteDevice.imgLink').live('click', function () {
            ...
            var message = "Hapus informasi implant " + itemName + " dari Pengkajian Kamar Tindakan untuk pasien ini ?";
        ...
        var pageCount = parseInt('<%=gridParamedicTeamPageCount %>');
        $(function () {
        ...
        $('#lblAddTeamFromOrder').live('click', function (evt) {
            ...
            if (reportID != '0') {
                ...
                var param = "0|" + testOrderID + "|" + reportID + "|" + visitID;
                openUserControlPopup("~/libs/Controls/EMR/_PopupEntry/Surgery/SurgeryParamedicTeamLookupCtl1.ascx", param, "Salin Team Pelaksana : Tindakan Tindakan", 700, 500);
            }
            else {
                displayMessageBox("Laporan Tindakan","Mohon simpan data terlebih dahulu, sebelum melakukan proses ini.");
            }
        });
        ...
        function onCbpParamedicTeamDeleteEndCallback(s) {
            ...
            if (param[0] == '1') {
                ...
                displayErrorMessageBox("Laporan Tindakan - Team Pelaksana", 'Error Message : ' + param[1]);
            }
        }
        ...
        $('#lblAddProcedureFromOrder').live('click', function (evt) {
            ...
            if (reportID != '0') {
                ...
                var visitID = $('#<%=hdnVisitID.ClientID %>').val();
                var param = "0|" + testOrderID + "|" + reportID + "|" + visitID;
                openUserControlPopup("~/libs/Controls/EMR/_PopupEntry/Surgery/SurgeryProcedureGroupLookupCtl1.ascx", param, "Salin Tindakan Tindakan", 700, 500);
                $('#<%=hdnIsChanged.ClientID %>').val('1');
            }
            else {
                displayMessageBox("Laporan Tindakan","Mohon simpan data terlebih dahulu, sebelum melakukan proses ini.");
        ...
        $('.btnApplyProcedure').die('click');
        $('.btnApplyProcedure').live('click', function (evt) {
            submitProcedureGroup();
            $('#<%=ledProcedure.ClientID %>').focus();
            $('#trProcedureGroupEntry').attr('style', 'display:none');
        });

        $('.btnCancelProcedure').die('click');
        $('.btnCancelProcedure').live('click', function (evt) {
            $('#trProcedureGroupEntry').attr('style', 'display:none');
        ...
        function submitProcedureGroup() { 
            if ($('#<%=hdnReportID.ClientID %>').val() != '') {
                if ($('#<%=hdnEntryProcedureID.ClientID %>').val() != '') {
                    ...
                    displayErrorMessageBox("ERROR", "Jenis prosedur Tindakan harus dipilih sebelum diproses !");
                }
            } else {
                displayErrorMessageBox("ERROR", "Harap simpan laporan Tindakan (tombol di toolbar) terlebih dahulu !");
            }
        }
    ...
    function onledProcedureLostFocus(s) {
        var procedureGroupID = s.GetValueText();
        $('#<%=hdnEntryProcedureID.ClientID %>').val(procedureGroupID);
        $('#<%=hdnEntryProcedureText.ClientID %>').val(s.GetDisplayText());
    }
    ...
    function SetProcedureGroupEntityToControl(param) {
        ...
        $('#<%=hdnEntryProcedureID.ClientID %>').val(selectedObj.ProcedureGroupID);
    }
    ...
    $('.imgDeleteProcedureGroup.imgLink').live('click', function () {
        ...
        var message = "Hapus Prosedur Tindakan <b>'" + procedureGroupName + "'</b> untuk pasien ini ?";
        displayConfirmationMessageBox('Prosedur Tindakan', message, function (result) {
            if (result) {
    ...
    function onCbpProcedureGroupEndCallback(s) {
        ...
        if (param[0] == '1') {
            ...
            displayErrorMessageBox('Prosedur Tindakan', param[2]);
        }
        else
            $('#<%=grdProcedureGroupView.ClientID %> tr:eq(1)').click();
    }
    ...
    <div>
        ...
        <input type="hidden" runat="server" id="hdnChargesParamedicID" value="" />
        <input type="hidden" runat="server" id="hdnChargesParamedicName" value="" />
                ...
                <tr>
                    <td style="vertical-align: top">
                        <div id="leftPageNavPanel" class="w3-border">
                            <ul>
                                <li contentid="divPage1" title="Data Tindakan (Informasi umum mengenai Tindakan)" class="w3-hover-red">
                                    Data Tindakan</li>
                                <li contentid="divPage2" title="Diagnosa dan Prosedur Tindakan" class="w3-hover-red">
                                    Diagnosa dan Prosedur Tindakan</li>
                                <li contentid="divPage3" title="Team Pelaksana" class="w3-hover-red" style="display:none">Team Pelaksana</li>
                                <li contentid="divPage4" title="Pemasangan Implant" class="w3-hover-red" style="display:none">Pemasangan
                                    Implant</li>
                                <li contentid="divPage5" title="Uraian Tindakan" class="w3-hover-red">Uraian Tindakan</li>
                                ...
                                <li contentid="divPage8" title="Penandaan Lokasi Tindakan" class="w3-hover-red" style="display: none">
                                    Penandaan Lokasi Tindakan</li>
                            </ul>
                        </div>
                    </td>
                    <td style="vertical-align: top">
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                                                        ...
                                                        <tr>
                                                            <td class="tdLabel">
                                                                <label id="lblChargesParamedicInfo"><%:GetLabel("Operator Tindakan") %></label>
                                                            </td>
                                                            <td colspan="2">
                                                                <asp:TextBox ID="txtChargesParamedicName" Width="225px" runat="server" Enabled="false" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tdLabel">
                                                        ...
                                                        <tr>
                                                            <td class="tdLabel">
                                                                <label class="lblMandatory">
                                                                    <%=GetLabel("Tanggal Tindakan")%></label>
                                                            </td>
                                                            <td colspan="3">
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    <colgroup>
                            ...
                            <table border="0" cellpadding="1" cellspacing="0" width="100%" style="margin-top: 5px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <br />
                                        <label class="lblNormal">
                                            <%=GetLabel("Pengkodean Prosedur Tindakan :")%></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="4">
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="1" style="width: 100%">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <qis:QISSearchTextBox ID="ledProcedure" ClientInstanceName="ledProcedure"
                                                                                runat="server" Width="99%" ValueText="ProcedureID" FilterExpression=""
                                                                                DisplayText="ProcedureName" MethodName="GetvProceduresList">
                                                                                <ClientSideEvents ValueChanged="function(s){ onledProcedureLostFocus(s); }" />
                                                                                <Columns>
                                                                                    <qis:QISSearchTextBoxColumn Caption="Tindakan (Kode)" FieldName="ProcedureName"
                                                                                        Description="i.e. Hecting" Width="500px" />
                                                                                </Columns>
                                                                            </qis:QISSearchTextBox>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <asp:GridView ID="grdProcedureGroupView" runat="server" CssClass="grdSelected grdPatientPage"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderStyle-HorizontalAlign="center" ItemStyle-Width="20px">
                                                                                    <HeaderTemplate>
                                                                                        <img class="imgAddProcedureGroup imgLink" title='<%=GetLabel("+ Prosedur Tindakan")%>'
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <img class="imgEditProcedureGroup imgLink" title='<%=GetLabel("Edit")%>' src='<%# ResolveUrl("~/Libs/Images/Button/edit.png")%>'
                                                                                                        alt="" recordid="ID" procedureID="ProcedureID" procedureName="ProcedureName" />
                                                                                                </td>
                                                                                                <td style="width: 1px">
                                                                                                    &nbsp;
                                                                                                </td>
                                                                                                <td>
                                                                                                    <img class="imgDeleteProcedureGroup imgLink" title='<%=GetLabel("Delete")%>' src='<%# ResolveUrl("~/Libs/Images/Button/delete.png")%>'
                                                                                                        alt="" recordid="<%#:Eval("ID") %>" procedureID="<%#:Eval("ProcedureID") %>"
                                                    ...
                                                    <asp:Panel runat="server" ID="Panel2" CssClass="pnlContainerGrid" Style="height: 300px">
                                                        <asp:GridView ID="grdImplantView" runat="server" CssClass="grdSelected grdPatientPage"
                                                            ...
                                                            <EmptyDataTemplate>
                                                                <div>
                                                                    <div>
                                                                        <%=GetLabel("Belum ada informasi pemasangan implant untuk tindakan Tindakan di pasien ini") %></div>
                                                                    <br />
                                            ...
                                            <tr>
                                                <td class="tdLabel" valign="top" style="width: 150px">
                                                    <label class="lblLink lblMandatory" id="lblSurgeryRemarks">
                                                        <%=GetLabel("Uraian Tindakan")%></label>
                                                </td>
                                                <td>
