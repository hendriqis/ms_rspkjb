<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="PatientVisitHistoryList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientVisitHistoryList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding: 15px">
        <div class="pageTitle">
            <%=GetLabel("Informasi History Kunjungan Pasien")%></div>
