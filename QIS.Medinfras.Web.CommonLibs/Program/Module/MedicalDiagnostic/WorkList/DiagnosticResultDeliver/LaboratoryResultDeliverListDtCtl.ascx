<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LaboratoryResultDeliverListDtCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.LaboratoryResultDeliverListDtCtl" %>
...
<script type="text/javascript" id="dxss_LaboratoryResultDeliverListDtCtl">
    $(function () {
