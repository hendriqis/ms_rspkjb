...
{
    public partial class LaboratoryResultDeliverListDtCtl : BaseEntryPopupCtl
    {
        private LaboratoryResultDeliverList DetailPage
        {
            get { return (LaboratoryResultDeliverList)Page; }
        }
