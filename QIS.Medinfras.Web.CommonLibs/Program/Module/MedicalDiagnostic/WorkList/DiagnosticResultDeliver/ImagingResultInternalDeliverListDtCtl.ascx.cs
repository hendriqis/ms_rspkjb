...
{
    public partial class ImagingResultInternalDeliverListDtCtl : BaseEntryPopupCtl
    {
        private ImagingResultInternalDeliverList DetailPage
        {
            get { return (ImagingResultInternalDeliverList)Page; }
        }
