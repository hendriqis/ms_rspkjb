<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="ImagingResultDeliverList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ImagingResultDeliverList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('.imgDelivered.imgDelivered').live('click', function (evt) {
            ...
            var paramResult = selectedID;
            var url = ResolveUrl("~/Libs/Program/Module/MedicalDiagnostic/WorkList/DiagnosticResultDeliver/ImagingResultDeliverListDtCtl.ascx");
