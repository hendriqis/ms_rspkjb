...
{
    public partial class LaboratoryResultInternalDeliverList : BasePageTrx
    {
        protected int PageCount = 1;
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Laboratory.RESULT_DELIVERY_INTERNAL;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvLaboratoryResultHdRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_ITEM);
            }
            List<vLaboratoryResultHd> lstEntity = BusinessLayer.GetvLaboratoryResultHdList(filterExpression, Constant.GridViewPageSize.GRID_ITEM, pageIndex, "ID DESC");
