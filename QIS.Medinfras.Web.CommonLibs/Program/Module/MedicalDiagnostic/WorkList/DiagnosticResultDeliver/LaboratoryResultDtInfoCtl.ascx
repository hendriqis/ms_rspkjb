<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LaboratoryResultDtInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.LaboratoryResultDtInfoCtl" %>
...
<script type="text/javascript" id="dxss_LaboratoryResultDtInfoCtl">
</script>
