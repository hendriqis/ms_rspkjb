<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="ImagingResultInternalDeliverList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ImagingResultInternalDeliverList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('.imgResultDt.imgResultDt').live('click', function (evt) {
            ...
            var url = ResolveUrl("~/Libs/Program/Module/MedicalDiagnostic/WorkList/DiagnosticResultDeliver/ImagingResultDtInfoCtl.ascx");
        ...
        $('.imgDelivered.imgDelivered').live('click', function (evt) {
            ...
            var paramResult = selectedID;
            var url = ResolveUrl("~/Libs/Program/Module/MedicalDiagnostic/WorkList/DiagnosticResultDeliver/ImagingResultInternalDeliverListDtCtl.ascx");
