<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImagingResultInternalDeliverListDtCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.ImagingResultInternalDeliverListDtCtl" %>
...
<script type="text/javascript" id="dxss_ImagingResultInternalDeliverListDtCtl">
    $(function () {
