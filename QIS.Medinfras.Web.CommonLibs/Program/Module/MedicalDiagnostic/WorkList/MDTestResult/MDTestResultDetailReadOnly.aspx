<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="MDTestResultDetailReadOnly.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.MDTestResultDetailReadOnly" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if (resultID == '') {
                ...
                if (hdnIsResultVerified == '0' && iscontrolPrint == "1") {
                    ...
                    if (code == 'IS-00003' || code == 'IS-00007' || code == 'MD-00004') {
                        filterExpression.text = "VisitID = " + visitID;
                        return true;
                    }
                    else if (code == 'PM-00138' || code == 'PM-00189') {
    ...
    <style>
    #ctl00_ctl00_ctl00_plhMPBase_plhMPMain_btnMPEntrySave{display: none !important;}
    #ctl00_ctl00_ctl00_plhMPBase_plhMPMain_btnMPEntryPropose{display: none !important;}
                ...
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDiagnosa" ReadOnly="false" Width="100%" runat="server" TextMode="MultiLine"
                                    Rows="2" />
                            </td>
                        </tr>
                        <tr>
                                                ...
                                                <ItemTemplate>
                                                   <%-- <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img class="imgEdit <%# IsEditable.ToString() == "True" ? "imgLink" : "imgDisabled"%>"
                                                                    title='<%=GetLabel("Edit")%>' src='<%# IsEditable.ToString() == "True" ? ResolveUrl("~/Libs/Images/Button/edit.png") : ResolveUrl("~/Libs/Images/Button/edit_disabled.png")%>'
                                                                    alt="" />
                                                            </td>
                                                        </tr>
                                                    </table>--%>
