<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="MDOrderAIOList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.MDOrderAIOList" %>
        ...
        <div class="containerUlTabPage" style="margin-bottom: 3px;">
            <ul class="ulTabPage" id="ulTabLabResult">
                <li class="selected" contentid="containerByOrder">
                    <%=GetLabel("Order Pemeriksaan AIO")%></li>
<%--                <li contentid="containerDaftar">
        ...
        <div id="containerByOrder" class="containerOrder">
            <div class="pageTitle">
                <%=GetLabel("Order Pemeriksaan AIO")%>
                :
