<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="PreHDAssessmentList1.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PreHDAssessmentList1" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="No. Registrasi" HeaderStyle-HorizontalAlign="Left"
                                ...
                                <asp:BoundField DataField="AssessmentTime" HeaderText="Jam " HeaderStyle-Width="60px"
                                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="noteTime" />
                                <asp:BoundField DataField="HDNo" HeaderText="HD Ke- " HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="hdType" />
                                ...
                                <asp:BoundField DataField="QB" HeaderText="QB" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Right"
                                    ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="qb" />
                                <asp:BoundField DataField="QD" HeaderText="QD" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Right"
                                    ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="qd" />
                                <asp:BoundField DataField="UFGoal" HeaderText="UF" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Right"
                                    ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="uf" />
                                <asp:BoundField DataField="ParamedicName" HeaderText="Dikaji oleh " HeaderStyle-Width="200px"
