<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master" AutoEventWireup="true" 
    CodeBehind="EDocumentList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.EDocumentList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript">
        ...
        $('.lnkOpenDocument a').live('click', function () {
            ...
            var fileName = $(this).closest('tr').find('.hiddenColumn').html();
            var param = id + '|' + fileName;
            cbpOpenDocument.PerformCallback(param);
        });
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="FileName" HeaderText="File Name" HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="hiddenColumn" />
