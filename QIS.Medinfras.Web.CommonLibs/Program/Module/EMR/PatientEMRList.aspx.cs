...
{
    public partial class PatientEMRList : BasePageList
    {
        protected int PageCount = 1;
        protected int CurrPage = 1;
        public override string OnGetMenuCode()
        {
            string moduleID = Page.Request.QueryString["id"];
            switch (moduleID)
            {
        ...
        protected void btnOpenTransactionDt_Click(object sender, EventArgs e)
        {
            if (hdnID.Value.ToString() != "")
            {
                ...
                Response.Redirect("~/Libs/Program/Module/EMR/PatientEMRView.aspx");
            }
        }
    }
}