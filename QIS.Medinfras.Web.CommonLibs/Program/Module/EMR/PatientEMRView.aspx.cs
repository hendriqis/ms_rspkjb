...
{
    public partial class PatientEMRPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string parentMenuCode = Constant.MenuCode.EMR.PATIENT_EMR_VIEW;
            switch (ModuleID)
            {
                case Constant.Module.EMR:
                    parentMenuCode = Constant.MenuCode.EMR.PATIENT_EMR_VIEW;
                    break;
                default:
                    parentMenuCode = Constant.MenuCode.EMR.PATIENT_EMR_VIEW;
                    break;
            }
            string filterExpression = string.Format("ParentCode = '{0}'", parentMenuCode);
