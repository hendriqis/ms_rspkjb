<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="DiagnosticResultList1.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.DiagnosticResultList1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPFrame" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.btnViewReport').live('click', function () {
                var hdnMD0028 = $('#<%=hdnMD0028.ClientID %>').val();
                if (hdnMD0028 == "1") {
                    var ResultGCTransactionStatus = $(this).closest('tr').find('.ResultGCTransactionStatus').html();
                    if (ResultGCTransactionStatus == "X121^001") //open
                    {
                ...
                if (itemID != '' && testOrderID != '') {
                    ...
                    openUserControlPopup(url, id, 'Hasil Pemeriksaan Penunjang', 1000, 500);
                }
    ...
    <input type="hidden" value="" id="hdnRISVendorCBCtl" runat="server" />
    <input type="hidden" value="" id="hdnIsRISUsingPDFResultCBCtl" runat="server" />
    <input type="hidden" value="" id="hdnMedicalNoCBCtl" runat="server" />
    <input type="hidden" value="0" id="hdnMD0028" runat="server" />
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <div><%#: Eval("TransactionNo")%>, <%#: Eval("ServiceUnitName")%></div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataTemplate>
