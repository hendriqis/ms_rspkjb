...
{
    public partial class EpisodeSummary1 : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                hdnVisitIDPopUpCtl.Value = AppSession.RegisteredPatient.VisitID.ToString();
                ...
                if (oHc != null)
                {
                    ...
                    else if (oHc.Initial == "RSSEB" || oHc.Initial == "RSSEBK" || oHc.Initial == "RSSEBS")
                    {
                ...
                vConsultVisit9 registeredPatient = BusinessLayer.GetvConsultVisit9List(string.Format("VisitID = {0}", hdnVisitIDPopUpCtl.Value))[0];
        ...
        private void LoadContentInformation1(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation2(vConsultVisit9 registeredPatient)
        {
            vChiefComplaint obj = BusinessLayer.GetvChiefComplaintList(string.Format("VisitID = {0} AND IsDeleted = 0", registeredPatient.VisitID)).LastOrDefault();
            if (obj != null)
            {
            ...
            string filterExpression = string.Format("VisitID = {0} AND IsDeleted = 0", registeredPatient.VisitID);
        ...
        private void LoadContentInformation3(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation4(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation5(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation6(vConsultVisit9 registeredPatient)
        {
            BindGridViewPatientReferral(1, true, ref PageCountPatientReferralList);
        }

        private void LoadContentInformation7(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation8(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation9(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation10_11_12(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation13(vConsultVisit9 registeredPatient)
        {
        ...
        private void LoadContentInformation14(vConsultVisit9 registeredPatient)
        {
        ...
        {
            string filterExpression = string.Format("RegistrationID = {0} AND IsDeleted = 0", hdnRegistrationID.Value);
            ...
            List<vPatientNurseTransfer> lstDt = BusinessLayer.GetvPatientNurseTransferList(string.Format("RegistrationID = {0} AND IsDeleted = 0", hdnRegistrationID.Value));
        ...
        private void BindGridViewLaboratory(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            {
                filterExpression += string.Format(" AND VisitID = {0}", AppSession.RegisteredPatient.VisitID.ToString());
            }
