<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="EpisodeSummary1_BookVersion.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.EpisodeSummary1_BookVersion" EnableViewState="false" %>
...
//            getDataEpisodeSummaryCtl("~/Libs/Controls/PatientPage/EpisodeSummary/EpisodeSummaryContent/EpisodeSummaryFollowUpVisitCtl.ascx", visitID, 'page10');
            ...
            if ($("#<%=hdnIDBodyDiagram.ClientID %>").val() != '') {
                ...
                for (var i = 0; i < lstID.length; i++) {
                    if (i == 0) {
                        $section = $('<div title="Episode Body Diagram" rel="Section 2" id="episodeBodyDiagram"></div>');
...
<div style="width:1200px;margin:0 auto; height:1000px">
    ...
    <div id="mybook" style="border:0px solid #AAA; display:none;">
        ...
        <div rel="Diagnosa Pasien"> 
	        <div class="contentEpisodeSummary" id="page6"> 
            </div>
        </div>
        <div title="Catatan Terintegrasi" rel="Catatan Terintegrasi"> 
	        <div class="contentEpisodeSummary" id="page7"> 
            </div>
        </div>
        <div title="Konsultasi/Rawat Bersama" rel="Konsultasi/Rawat Bersama"> 
	        <div class="contentEpisodeSummary" id="page7"> 
            </div>
        </div>
        <div title="Pemeriksaan Laboratorium" rel="Pemeriksaan Laboratorium">
            <div class="contentEpisodeSummary" id="page8"> 
            </div>
        </div>
        <div title="Instruksi Dokter" id="sectionDischargeInformation"> 
	        <div class="contentEpisodeSummary" id="page9"> 
            </div>
        </div>
        <div></div>
    </div>
