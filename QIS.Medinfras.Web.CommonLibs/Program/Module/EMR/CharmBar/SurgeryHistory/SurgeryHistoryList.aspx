<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true"
    CodeBehind="SurgeryHistoryList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.SurgeryHistoryList1" %>
    ...
    <script type="text/javascript" id="dxss_SurgeryHistoryList">
        $('#<%=grdView.ClientID %> tr:gt(0):not(.trEmpty)').live('click', function () {
            ...
            if ($('#<%=hdnID.ClientID %>').val() != "") {
                ...
                cbpViewDt9.PerformCallback('refresh');
            }
        });
        $(function () {
        ...
        function onCbpViewDt9EndCallback(s) {
            $('#containerImgLoadingViewDt9').hide();
            ...
            if (param[0] == 'refresh') {
                ...
                if (pageCount1 > 0)
                    $('#<%=grdViewDt9.ClientID %> tr:eq(1)').click();

                setPaging($("#pagingDt9"), pageCount1, function (page) {
                    cbpViewDt8.PerformCallback('changepage|' + page);
                });
            }
            else
                        ...
                        <td>
                            <div class="containerUlTabPage" style="margin-bottom: 3px;">
                                <ul class="ulTabPage" id="ulTabOrderDetail">
                                    ...
                                    <li contentid="postSurgeryInstruction">
                                        <%=GetLabel("Instruksi Paska Bedah")%></li>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="containerOrderDt" id="postSurgeryInstruction" style="display : none">
                                 <dxcp:ASPxCallbackPanel ID="cbpViewDt9" runat="server" Width="100%" ClientInstanceName="cbpViewDt9"
                                    ShowLoadingPanel="false" OnCallback="cbpViewDt9_Callback">
                                    <ClientSideEvents BeginCallback="function(s,e){ $('#containerImgLoadingViewDt9').show(); }"
                                        EndCallback="function(s,e){ onCbpViewDt9EndCallback(s); }" />
                                    <PanelCollection>
                                        <dx:PanelContent ID="PanelContent10" runat="server">
                                            <asp:Panel runat="server" ID="Panel10" CssClass="pnlContainerGridPatientPage">
                                                <asp:GridView ID="grdViewDt9" runat="server" CssClass="grdSelected grdPatientPage"
                                                    AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                                    <Columns>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="center" HeaderStyle-Width="60px" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="center">
                                                            <HeaderTemplate>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <table cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td>
                                                                            <img class="imgViewInstruction imgLink" title='<%=GetLabel("View")%>' src='<%# ResolveUrl("~/Libs/Images/Button/search.png")%>'
                                                                                alt="" recordID = "<%#:Eval("PostSurgeryInstructionID") %>" testOrderID = "<%#:Eval("TestOrderID") %>" visitid="<%#:Eval("VisitID") %>" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="PostSurgeryInstructionID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                                        <asp:BoundField DataField="TestOrderID" HeaderStyle-CssClass="hiddenColumn testOrderID" ItemStyle-CssClass="hiddenColumn testOrderID" />
                                                        <asp:BoundField DataField="cfInstructionDate" HeaderText="Tanggal" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="cfInstructionDate" ItemStyle-CssClass="cfInstructionDate" HeaderStyle-Width="100px" />
                                                        <asp:BoundField DataField="InstructionTime" HeaderText="Jam" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="InstructionTime" ItemStyle-CssClass="InstructionTime" HeaderStyle-Width="60px" />
                                                        <asp:BoundField DataField="ParamedicName" HeaderText="Dibuat oleh" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"  HeaderStyle-CssClass="paramedicName" ItemStyle-CssClass="paramedicName" />
                                                    </Columns>
                                                    <EmptyDataTemplate>
                                                        <div>
                                ...
                                <div class="imgLoadingGrdView" id="containerImgLoadingViewDt9">
                                    <img src='<%= ResolveUrl("~/Libs/Images/loading_small.gif")%>' alt='' />
                                </div>
                                <div class="containerPaging">
                                    <div class="wrapperPaging">
