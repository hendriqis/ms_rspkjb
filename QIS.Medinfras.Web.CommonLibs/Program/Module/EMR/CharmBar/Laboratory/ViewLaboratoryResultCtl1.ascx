<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewLaboratoryResultCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientPage.ViewLaboratoryResultCtl1" %>
...
<script type="text/javascript" id="dxss_ViewLaboratoryResultCtl1">
    $(function () {
        //#region Service Unit
    ...
    $('.btnPreview').click(function () {
        $btnPreview = $(this);
        if ($('#<%:hdnReferenceNoCBCtl.ClientID %>').val() == "") {
...
<input type="hidden" id="hdnItemIDCBCtl" value="" runat="server" />
<input type="hidden" id="hdnTransactionIDCBCtl" value="" runat="server" />
<input type="hidden" id="hdnTestOrderIDCBCtl" value="" runat="server" />
<input type="hidden" id="hdnIDCBCtl" value="" runat="server" />
<input type="hidden" id="hdnReferenceNoCBCtl" value="" runat="server" />
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="padding-left :10px;">
                            <input type="button" class="btnPreview" value="PACS Viewer" style="width:100px; height:22px;" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
