...
{
    public partial class MultiVisitScheduleOrderHistoryCtl : BasePage
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            grdView.DataSource = lstOrderMultiVisit.Where(w => w.MRN == AppSession.RegisteredPatient.MRN).GroupBy(g => g.FromTestOrderID).Select(s => s.FirstOrDefault()).OrderBy(o => o.PatientName).OrderByDescending(o => o.FromTestOrderID).ToList();
            grdView.DataBind();
