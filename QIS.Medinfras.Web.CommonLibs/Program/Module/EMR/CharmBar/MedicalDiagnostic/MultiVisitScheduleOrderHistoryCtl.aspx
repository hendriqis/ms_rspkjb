<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPFrame.master"
    AutoEventWireup="true" CodeBehind="MultiVisitScheduleOrderHistoryCtl.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.MultiVisitScheduleOrderHistoryCtl" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="plhMPFrame" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=grdView.ClientID %> > tbody > tr:gt(0):not(.trEmpty)').live('click', function () {
                if ($(this).attr('class') != 'selected') {
                    ...
                    $('#<%=hdnMRN.ClientID %>').val($(this).find('.hiddenColumn').html());
        ...
        function OpenPopupWindow(type, id) {
            switch (type) {
                ...
                case 'processRegis':
                    //                    var url = ResolveUrl("~/libs/Program/Module/PatientManagement/Appointment/ProcessMultiVisitScheduleOrderCtl.ascx");
                    //                    var param = id
                    //                    openUserControlPopup(url, param, 'Proses Registrasi', 550, 250);
                    //                    alert(type + id);
                    break;
                case 'info':
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            filterExpression.text = "TestOrderID = " + testOrderID + " AND IsDeleted = 0";
            return true;
        }
    </script>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage2">
                                <asp:GridView runat="server" ID="grdView" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MRN" HeaderStyle-CssClass="hiddenColumn"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdDrugInfoValue" colspan="5">
                                                            <%#: Eval("FromRegistrationNo")%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="tdDrugInfoLabel">
                                                            <%=GetLabel("Unit Pelayanan Order")%>
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                            ...
                                                            <table class="rptMedicationTimeDetail" border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        ...
                                                                        <div class="divMultiVisitSTATUS divOPEN" <%# Eval("DiagnosticScheduleStatus").ToString() != "OPEN" ? "Style='display:none'":"" %>>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    <td style="width: 80%">
                                                                                        <%#: Eval("cfScheduleSequence") %>
                                                                        ...
                                                                        <div class="divMultiVisitSTATUS divSchedule" <%# Eval("DiagnosticScheduleStatus").ToString() != "STARTED" ? "Style='display:none'":"" %>>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    <td style="width: 80%">
                                                                                        <%#: Eval("cfScheduleSequence") %>
                                                                        ...
                                                                        <div class="divMultiVisitSTATUS divTaken" <%# Eval("DiagnosticScheduleStatus").ToString() != "COMPLETED" ? "Style='display:none'":"" %>>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    <td style="width: 80%">
                                                                                        <%#: Eval("cfScheduleSequence") %>
