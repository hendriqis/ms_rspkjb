<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="VisitTransactionDetail.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.VisitTransactionDetail" %>
...
//////            });
    ...
    <div>
        <asp:ListView ID="lvwCharges" runat="server">
            <EmptyDataTemplate>
                <table id="tblView" runat="server" class="grdCharges grdNormal" cellspacing="0" rules="all">
                    <tr>
    ...
    <%--<div id="containerPelayanan" class="containerMain">
    ...
    <%--<div id="containerObatMedis" style="display: none" class="containerMain">
    ...
    <%--<div id="containerBarangUmum" style="display: none" class="containerMain">
    ...
    <%--<div id="containerRadiologi" style="display: none" class="containerMain">
    ...
    <%--<div id="containerLaboratorium" style="display: none" class="containerMain">
    ...
    <%--<div id="containerOtherDiagnose" style="display: none" class="containerMain">
