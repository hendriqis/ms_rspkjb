...
{
    public partial class AppointmentInformationDashboardCtl : BaseViewPopupCtl
    {
        ...
        {
            List<GetDetailInformationAppointmentDashboardEMR> lstEntity = null;

            lstEntity = BusinessLayer.GetDetailInformationAppointmentDashboardEMR(
