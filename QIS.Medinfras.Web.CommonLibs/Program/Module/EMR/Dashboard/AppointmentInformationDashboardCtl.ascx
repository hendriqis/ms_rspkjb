<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointmentInformationDashboardCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.AppointmentInformationDashboardCtl" %>
...
<script type="text/javascript" id="dxss_appointmentinformationdashboardCtl">
    //#region Paging
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="width: 100%;
                                ...
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected notAllowSelect"
                                    AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        <asp:BoundField DataField="AppointmentNo" HeaderText="No. Appointment" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="160px" />
                                        <asp:BoundField DataField="StartDateInString" HeaderText="Tanggal Appointment" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:BoundField DataField="QueueNo" HeaderText="No. Antrian" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
                                        <asp:BoundField DataField="AppointmentStatus" HeaderText="Status Appointment" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
                                    </Columns>
                                    <EmptyDataTemplate>
