<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="PatientDataList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.PatientDataList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnMPListView" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbnotes.png")%>' alt="" /><div><%=GetLabel("Riwayat Kunjungan")%></div></li>
</asp:Content>
