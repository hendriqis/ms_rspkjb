<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SendInventoryNotificationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SendInventoryNotificationCtl" %>
...
<script type="text/javascript" id="dxss_sendInventoryNotificationCtl">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:DropDownList ID="ddlNotificationType" runat="server" Width="100%" Enabled="false">
                                    <asp:ListItem Text="Kirim data PR" Value="00" />
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
