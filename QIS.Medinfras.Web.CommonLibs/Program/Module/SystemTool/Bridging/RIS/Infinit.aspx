<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true" 
    CodeBehind="WynacomLIS.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.Infinit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lblResult').live('click', function () {
            ...
            var url = ResolveUrl("~/Libs/Program/Module/SystemTool/Bridging/RIS/InfinitResultCtl.ascx");
            openUserControlPopup(url, id, 'Log Infinit', 650, 600);
        });
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="ReferenceNo" HeaderText="No. Referensi RIS" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="150px" />
                                ...
                                <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Message">
                                    <ItemTemplate>
                                            <label class="lblResult lblLink">
                                               <%=GetLabel("Message Log")%>
                                             <input type="hidden" id="TransactionID" value="<%#:Eval("TransactionID") %>" bindingfield="TransactionID" />
                                            </label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
