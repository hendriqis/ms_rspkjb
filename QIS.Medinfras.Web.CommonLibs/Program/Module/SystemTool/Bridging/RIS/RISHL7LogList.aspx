<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true" 
    CodeBehind="RISHL7LogList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.RISHL7LogList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <script type="text/javascript">
        ...
        function onCbpSendToRISEndCallback(s) {
            ...
            var param = s.cpResult.split('|');
            if (param[0] == 'success') {
                showToast('SEND TO RIS : SUCCESS', 'Proses Notifikasi Perubahan Data Pasien ke RIS sukses dilakukan (' + param[1] + ')');
            }
            else {
