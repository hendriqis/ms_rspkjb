...
{
    public partial class Infinit : BasePageTrx
    {
        ...
        public override string OnGetMenuCode()
        {
            switch (hdnModuleID.Value)
            {
                case Constant.Module.SYSTEM_SETUP:
                    return Constant.MenuCode.SystemSetup.RIS_Infinit;
                default:
                    return Constant.MenuCode.SystemSetup.RIS_Infinit;
            }
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            String filterExpression = String.Format("TransactionCode = '{0}'  AND CONVERT(date, TransactionDate) BETWEEN '{1}' AND '{2}'", Constant.TransactionCode.IMAGING_CHARGES, fromDate, toDate);
