<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WynacomLISDetailResultCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.WynacomLISDetailResultCtl" %>
            ...
            <asp:TemplateField HeaderText="Hasil" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                ...
                <ItemTemplate>
                    <div class='<%#: Eval("IsNormal").ToString() == "False" ?  (Eval("cfIsPanicRange").ToString() == "False" ? "isAbnormalColor" : "isPanicRangeColor") : "" %>'
                        ...
                        <asp:Literal ID="literal" Text='<%# Eval("cfTestResultValue") %>' Mode="PassThrough" runat="server" /></div>
                </ItemTemplate>
            </asp:TemplateField>
