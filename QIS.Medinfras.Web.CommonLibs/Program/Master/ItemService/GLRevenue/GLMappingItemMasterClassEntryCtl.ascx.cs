...
{
    public partial class GLMappingItemMasterClassEntryCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vGLRevenueItemClass> lst = BusinessLayer.GetvGLRevenueItemClassList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemClassDao entityDao = new GLRevenueItemClassDao(ctx);
            try
            {
                GLRevenueItemClass entity = new GLRevenueItemClass();
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemClass entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
