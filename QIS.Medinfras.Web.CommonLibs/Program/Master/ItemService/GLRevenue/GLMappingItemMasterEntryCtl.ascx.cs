...
{
    public partial class GLMappingItemMasterEntryCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vGLRevenueItem> lst = BusinessLayer.GetvGLRevenueItemList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemDao entityDao = new GLRevenueItemDao(ctx);
            try
            {
                GLRevenueItem entity = new GLRevenueItem();
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItem entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
