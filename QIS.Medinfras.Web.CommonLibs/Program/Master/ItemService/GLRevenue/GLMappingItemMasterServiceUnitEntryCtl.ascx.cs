...
{
    public partial class GLMappingItemMasterServiceUnitEntryCtl : BaseViewPopupCtl
    {
        protected int PageCount = 1;

        public override void InitializeDataControl(string param)
        {
            hdnItemIDCtlCOA.Value = param;

            ItemMaster entity = BusinessLayer.GetItemMaster(Convert.ToInt32(hdnItemIDCtlCOA.Value));
            txtItemCodeCtl.Text = entity.ItemCode;
            txtItemNameCtl.Text = entity.ItemName1;
        ...
        private void BindGridView()
        {
            ...
            filterExpression += string.Format("ItemID = {0}", hdnItemIDCtlCOA.Value);

            List<vGLRevenueItemServiceUnit> lst = BusinessLayer.GetvGLRevenueItemServiceUnitList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemServiceUnitDao entityDao = new GLRevenueItemServiceUnitDao(ctx);
            try
            {
                GLRevenueItemServiceUnit entity = new GLRevenueItemServiceUnit();
                
                entity.ItemID = Convert.ToInt32(hdnItemIDCtlCOA.Value);
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemServiceUnit entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
