...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class SupplierItemEntryCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            vBusinessPartners hsu = BusinessLayer.GetvBusinessPartnersList(string.Format("BusinessPartnersID = {0}", param)).FirstOrDefault();
            txtSupplierName.Text = string.Format("{0} - {1}", hsu.BusinessPartnersCode, hsu.BusinessPartnersName);
            txtAddress.Text = hsu.BusinessPartnersAddress;
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vSupplierItem> lstEntity = BusinessLayer.GetvSupplierItemList(filterExpression, Constant.GridViewPageSize.GRID_MATRIX, pageIndex, "ItemName1 ASC");
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                string filter = string.Format("BusinessPartnerID = {0} AND ItemID = {1} AND GCPurchaseUnit = '{2}' AND IsDeleted = 0 AND StartDate = '{3}'",
                                                entity.BusinessPartnerID, entity.ItemID, entity.GCPurchaseUnit, entity.StartDate);
        ...
        private bool OnSaveEditRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                string filter = string.Format("BusinessPartnerID = {0} AND ItemID = {1} AND GCPurchaseUnit = '{2}' AND IsDeleted = 0 AND ID != {3} AND StartDate = '{4}'",
                                                entity.BusinessPartnerID, entity.ItemID, entity.GCPurchaseUnit, entity.ID, entity.StartDate);
                List<SupplierItem> lst = BusinessLayer.GetSupplierItemList(filter);
                if (lst.Count() == 0)
                {
