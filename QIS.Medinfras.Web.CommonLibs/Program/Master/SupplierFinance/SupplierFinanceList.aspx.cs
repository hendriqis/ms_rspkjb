...
{
    public partial class SupplierFinanceList : BasePageList
    {
        ...
        protected override bool OnAddRecord(ref string url, ref string errMessage)
        {
            ...
            url = ResolveUrl(string.Format("~/Libs/Program/Master/SupplierFinance/SupplierFinanceEntry.aspx?menu={0}", MenuID));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                String MenuID = Request.QueryString["id"];
                url = ResolveUrl(string.Format("~/Libs/Program/Master/SupplierFinance/SupplierFinanceEntry.aspx?menu={0}&id={1}", MenuID, hdnID.Value));
                return true;
            }
            return false;
        }
