...
{
    public partial class SupplierFinanceEntry : BasePageEntry
    {
        public override string OnGetMenuCode()
        {
            ...
            if (menu == "FN")
            {
                return Constant.MenuCode.Finance.SUPPLIER_FINANCE;
            }
            else
            {
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(txtExternalCode, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtSupplierName, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtShortName, new ControlEntrySetting(false, false, false));
            #endregion

            #region Contact Person
            SetControlEntrySetting(txtContactPersonName, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtContactPersonPhoneNumber, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtContactPersonEmail, new ControlEntrySetting(false, false, false));
            #endregion

            #region Supplier Information
            SetControlEntrySetting(cboHealthcare, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtVATRegistrationNo, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(cboTerm, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtMaxPOAmount, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtLeadTime, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(hdnSupplierLineID, new ControlEntrySetting(false, false));
            SetControlEntrySetting(txtSupplierLineCode, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtSupplierLineName, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(cboSupplierType, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(chkIsPharmacySupplier, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(chkIsLogisticSupplier, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtGLAccountSegmentNo, new ControlEntrySetting(false, false, false));
            #endregion
