<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierFinanceItemEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.SupplierFinanceItemEntryCtl" %>
...
<script type="text/javascript" id="dxss_SupplierFinanceItemEntryCtl">
    $(function () {
    ...
    $('.imgEdit.imgLink').live('click', function () {
        ...
        $('#<%=txtDiscountPercentage1.ClientID %>').val(discountPercentage1);
        $('#<%=txtDiscountPercentage2.ClientID %>').val(discountPercentage2);
            ...
            if (result != null) {
                ...
                Methods.getObject('GetItemPlanningList', filterExpression2, function (resultIP) {
                    if (resultIP != null) {
                        ...
                        var conversion = parseFloat($('#<%=txtConversionFactor.ClientID %>').val());
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Item" HeaderStyle-Width="200px" HeaderText="Item" />
                                        <asp:BoundField DataField="SupplierItem" HeaderStyle-Width="200px" HeaderText="Item Pemasok" />
