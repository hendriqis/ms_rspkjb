<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TemplateChargesEntryItemCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TemplateChargesEntryItemCtl" %>
