<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemGroupEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.GLMappingItemGroupEntryCtl" %>
...
<script type="text/javascript" id="dxss_GLMappingItemGroupEntryCtl">
