<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemGroupClassEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.GLMappingItemGroupClassEntryCtl" %>
