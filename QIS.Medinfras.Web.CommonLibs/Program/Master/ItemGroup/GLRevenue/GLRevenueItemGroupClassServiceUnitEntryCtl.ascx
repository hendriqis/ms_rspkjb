<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLRevenueItemGroupClassServiceUnitEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.GLRevenueItemGroupClassServiceUnitEntryCtl" %>
...
<script type="text/javascript" id="dxss_GLRevenueItemGroupClassServiceUnitEntryCtl">
