<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLRevenueItemGroupServiceUnitbyClassbyParamedicCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.GLRevenueItemGroupServiceUnitbyClassbyParamedicCtl" %>
...
<script type="text/javascript" id="dxss_GLRevenueItemGroupServiceUnitbyClassbyParamedicCtl">
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; position: relative;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="EmployeeStatus" ItemStyle-CssClass="EmployeeStatus"
                                            HeaderText="EmployeeStatus" HeaderStyle-Width="150px" />
