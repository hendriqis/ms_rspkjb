<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PSScheduleWithDateEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PSScheduleWithDateEntryCtl" %>
...
<script type="text/javascript" id="dxss_PSScheduleWithDateEntryCtl1">
    setDatePicker('<%=txtScheduleDate.ClientID %>');
    $('#<%=txtScheduleDate.ClientID %>').datepicker('option', 'maxDate', '1000');
    $('#<%=txtScheduleDate.ClientID %>').datepicker('option', 'minDate', '0');

    $('#lblEntryPopupAddDataScheduleWithDate').live('click', function () {
        $('#<%=hdnIsChangeDifferentQueueNo.ClientID %>').val("0");
        $('#<%=txtScheduleDate.ClientID %>').val($('#<%=hdnDatePickerToday.ClientID %>').val());
        ...
        $('#<%=txtStart1.ClientID %>').val('');
        $('#<%=txtStart2.ClientID %>').val('');
        $('#<%=txtStart3.ClientID %>').val('');
        $('#<%=txtStart4.ClientID %>').val('');
        $('#<%=txtStart5.ClientID %>').val('');

        $('#<%=txtEnd1.ClientID %>').val('');
        $('#<%=txtEnd2.ClientID %>').val('');
        $('#<%=txtEnd3.ClientID %>').val('');
        $('#<%=txtEnd4.ClientID %>').val('');
        $('#<%=txtEnd5.ClientID %>').val('');
    ...
    $('#<%=chkIsBPJS1.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsBPJS2.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsBPJS3.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsBPJS4.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsBPJS5.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsNonBPJS1.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsNonBPJS2.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsNonBPJS3.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsNonBPJS4.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    $('#<%=chkIsNonBPJS5.ClientID %>').change(function () {
        $('#<%=hdnIsChkBPJSChanged.ClientID %>').val('1');
    });
    //#endregion
    ...
    $('.imgDelete.imgLink').live('click', function () {
        if (confirm("Are You Sure Want To Delete This Data?")) {
            ...
            var ScheduleDate = $row.find('.hdnScheduleDate').val();

            $('#<%=hdnScheduleDate.ClientID %>').val(ScheduleDate);
    ...
    $('.imgEdit.imgLink').live('click', function () {
        ...
        var Remarks = $row.find('.hdnParamedicScheduleDateRemarks').val();

        var OperationalTimeIDEntry = $row.find('.hdnOperationalTimeIDEntry').val();
        var OperationalTimeCodeEntry = $row.find('.hdnOperationalTimeCodeEntry').val();
        var OperationalTimeNameEntry = $row.find('.hdnOperationalTimeNameEntry').val();
        ...
        var MaximumAppointment1BPJS = $row.find('.tdMaximumAppointmentBPJS1').val();
        var MaximumAppointment2BPJS = $row.find('.tdMaximumAppointmentBPJS2').val();
        var MaximumAppointment3BPJS = $row.find('.tdMaximumAppointmentBPJS3').val();
        var MaximumAppointment4BPJS = $row.find('.tdMaximumAppointmentBPJS4').val();
        var MaximumAppointment5BPJS = $row.find('.tdMaximumAppointmentBPJS5').val();
        ...
        $('#<%=hdnBeforeDatePicker.ClientID %>').val(ScheduleDateInString);
        $('#<%=txtScheduleDate.ClientID %>').val(ScheduleDateInString);
        ...
        if (IsAppointmentByTimeSlot1 == 'True' || IsAppointmentByTimeSlot2 == 'True' || IsAllowWaitingList3 == 'True' || IsAllowWaitingList4 == 'True' || IsAllowWaitingList5 == 'True') {
            ...
            if (MaximumAppointment1BPJS != '0') {
                $('#<%=txtMaximumAppointment1BPJS.ClientID %>').val(MaximumAppointment1BPJS);
            } else {
                $('#<%=txtMaximumAppointment1BPJS.ClientID %>').val('');
            }
            ...
            if (MaximumAppointment2BPJS != '0') {
                $('#<%=txtMaximumAppointment2BPJS.ClientID %>').val(MaximumAppointment2BPJS);
            } else {
                $('#<%=txtMaximumAppointment2BPJS.ClientID %>').val('');
            }
            ...
            if (MaximumAppointment3BPJS != '0') {
                $('#<%=txtMaximumAppointment3BPJS.ClientID %>').val(MaximumAppointment3BPJS);
            } else {
                $('#<%=txtMaximumAppointment3BPJS.ClientID %>').val('');
            }
            ...
            if (MaximumAppointment4BPJS != '0') {
                $('#<%=txtMaximumAppointment4BPJS.ClientID %>').val(MaximumAppointment4BPJS);
            } else {
                $('#<%=txtMaximumAppointment4BPJS.ClientID %>').val('');
            }
            ...
            if (MaximumAppointment5BPJS != '0') {
                $('#<%=txtMaximumAppointment5BPJS.ClientID %>').val(MaximumAppointment5BPJS);
            } else {
                $('#<%=txtMaximumAppointment5BPJS.ClientID %>').val('');
            }
        } else {
        ...
        $('#<%=txtStart1.ClientID %>').val(StartTime1);
        $('#<%=txtStart2.ClientID %>').val(StartTime2);
        $('#<%=txtStart3.ClientID %>').val(StartTime3);
        $('#<%=txtStart4.ClientID %>').val(StartTime4);
        $('#<%=txtStart5.ClientID %>').val(StartTime5);

        $('#<%=txtEnd1.ClientID %>').val(EndTime1);
        $('#<%=txtEnd2.ClientID %>').val(EndTime2);
        $('#<%=txtEnd3.ClientID %>').val(EndTime3);
        $('#<%=txtEnd4.ClientID %>').val(EndTime4);
        $('#<%=txtEnd5.ClientID %>').val(EndTime5);
        ...
        if (MobileAppointment1BPJS != '0') {
            ...
            $('#<%=txtMobileAppointment1BPJS.ClientID %>').removeAttr('readonly', 'readonly');
        } else {
            $('#<%=txtMobileAppointment1BPJS.ClientID %>').val('');
        }
        ...
        if (MobileAppointment2BPJS != '0') {
            ...
            $('#<%=txtMobileAppointment2BPJS.ClientID %>').removeAttr('readonly', 'readonly');
        } else {
            $('#<%=txtMobileAppointment2BPJS.ClientID %>').val('');
        }
        ...
        if (MobileAppointment3BPJS != '0') {
            ...
            $('#<%=txtMobileAppointment3BPJS.ClientID %>').removeAttr('readonly', 'readonly');
        } else {
            $('#<%=txtMobileAppointment3BPJS.ClientID %>').val('');
        }
        ...
        if (MobileAppointment4BPJS != '0') {
            ...
            $('#<%=txtMobileAppointment4BPJS.ClientID %>').removeAttr('readonly', 'readonly');
        } else {
            $('#<%=txtMobileAppointment4BPJS.ClientID %>').val('');
        }
        ...
        if (MobileAppointment5BPJS != '0') {
            $('#<%=txtMobileAppointment5BPJS.ClientID %>').val(MobileAppointment5BPJS);
            $('#<%=txtMobileAppointment5BPJS.ClientID %>').removeAttr('readonly', 'readonly');
        } else {
            $('#<%=txtMobileAppointment5BPJS.ClientID %>').val('');
        }
        //#endregion
        ...
        if (IsAllowWaitingList5 == 'True') {
            $('#<%=chkIsAllowWaitingList5.ClientID %>').prop('checked', IsAllowWaitingList1);
            $('#<%:chkIsAllowWaitingList5.ClientID %>').removeAttr("disabled");
            $('#<%=txtMaximumWaitingList5.ClientID %>').removeAttr('readonly');
            $('#<%=txtWaiting5.ClientID %>').removeAttr('readonly');
            $('#<%=txtWaiting5BPJS.ClientID %>').removeAttr('readonly');
            ...
            $('#<%=txtMobileAppointment1.ClientID %>').keypress(function (e) {
                ...
                if (keyCode == 9 || keyCode == 13) {
                    if ($('#<%=txtMobileAppointment1.ClientID %>').val() == 0 || $('#<%=txtMobileAppointment1.ClientID %>').val() == '') {
                        ...
                        return $('#<%=txtMaximumAppointment1.ClientID %>').val();
                    }
                    else {
    ...
    function getCalculateResultWaitingList() {
        ...
        //#region calculate for 1st session
        $(function () {
            $('#<%=txtWaiting1.ClientID %>').keypress(function (e) {
                var keyCode = e.keyCode || e.which;

                if (keyCode == 9 || keyCode == 13) {
                    if ($('#<%=txtWaiting1.ClientID %>').val() == 0 || $('#<%=txtWaiting1.ClientID %>').val() == '') {
                        finalResult = $('#<%=txtMaximumWaitingList1.ClientID %>').val();
                    }
                    else {
                        result = $('#<%=txtMaximumWaitingList1.ClientID %>').val() * ($('#<%=txtWaiting1.ClientID %>').val() / 100);
                        finalResult = Math.round(result);
                    }
                };
            });
        ...
        //#region calculate for 2nd session
        $(function () {
            $('#<%=txtWaiting2.ClientID %>').keypress(function (e) {
                var keyCode = e.keyCode || e.which;

                if (keyCode == 9 || keyCode == 13) {
                    if ($('#<%=txtWaiting2.ClientID %>').val() == 0 || $('#<%=txtWaiting2.ClientID %>').val() == '') {
                        finalResult = $('#<%=txtMaximumWaitingList2.ClientID %>').val();
                    }
                    else {
                        result = $('#<%=txtMaximumWaitingList2.ClientID %>').val() * ($('#<%=txtWaiting2.ClientID %>').val() / 100);
                        finalResult = Math.round(result);
                    }
                };
            });
        ...
        //#region calculate for 3rd session
        $(function () {
            $('#<%=txtWaiting3.ClientID %>').keypress(function (e) {
                var keyCode = e.keyCode || e.which;

                if (keyCode == 9 || keyCode == 13) {
                    if ($('#<%=txtWaiting3.ClientID %>').val() == 0 || $('#<%=txtWaiting3.ClientID %>').val() == '') {
                        finalResult = $('#<%=txtMaximumWaitingList3.ClientID %>').val();
                    }
                    else {
                        result = $('#<%=txtMaximumWaitingList3.ClientID %>').val() * ($('#<%=txtWaiting3.ClientID %>').val() / 100);
                        finalResult = Math.round(result);
                    }
                };
            });
        ...
        //#region calculate for 4th session
        $(function () {
            $('#<%=txtWaiting4.ClientID %>').keypress(function (e) {
                var keyCode = e.keyCode || e.which;

                if (keyCode == 9 || keyCode == 13) {
                    if ($('#<%=txtWaiting4.ClientID %>').val() == 0 || $('#<%=txtWaiting4.ClientID %>').val() == '') {
                        finalResult = $('#<%=txtMaximumWaitingList4.ClientID %>').val();
                    }
                    else {
                        result = $('#<%=txtMaximumWaitingList4.ClientID %>').val() * ($('#<%=txtWaiting4.ClientID %>').val() / 100);
                        finalResult = Math.round(result);
                    }
                };
            });
        ...
        //#region calculate for 5th session
        $(function () {
            $('#<%=txtWaiting5.ClientID %>').keypress(function (e) {
                var keyCode = e.keyCode || e.which;

                if (keyCode == 9 || keyCode == 13) {
                    if ($('#<%=txtWaiting5.ClientID %>').val() == 0 || $('#<%=txtWaiting5.ClientID %>').val() == '') {
                        finalResult = $('#<%=txtMaximumWaitingList5.ClientID %>').val();
                    }
                    else {
                        result = $('#<%=txtMaximumWaitingList5.ClientID %>').val() * ($('#<%=txtWaiting5.ClientID %>').val() / 100);
                        finalResult = Math.round(result);
                    }
                };
            });
...
<div style="height: 440px; overflow-y: auto">
    ...
    <input type="hidden" id="hdnMaxAppointmentChanged" runat="server" value="0" />
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                    ...
                    <fieldset id="fsEntryPopup" style="margin: 0">
                        <table class="tblEntryDetail" style="width: 100%">
                            ...
                            <tr>
                                <td class="tdLabel">
                                    <label class="lblMandatory">
                                        <%=GetLabel("Schedule Date")%></label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtScheduleDate" Width="108px" runat="server" CssClass="datepicker" />
                                </td>
                            </tr>
                            <tr>
                                <td class="tdLabel">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtRemarks" Width="90%" TextMode="MultiLine" Rows="4" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            </tr><tr id="trIsAllowDifferentQueueNo" runat="server">
                                <td>
                                    <label class="lblNormal">
                            ...
                            <tr>
                                ...
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:TextBox ID="txtStart1" CssClass="time start" Width="60px" ReadOnly="true"
                                                    runat="server" MaxLength="5" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtEnd1" CssClass="time end" Width="60px" ReadOnly="true" runat="server"
                                                    MaxLength="5" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment1" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment1BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment1" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment1BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo1" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo1" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo1BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo1BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList1" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList1BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting1" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting1BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:TextBox ID="txtStart2" CssClass="time start" Width="60px" ReadOnly="true"
                                                    runat="server" MaxLength="5" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtEnd2" CssClass="time end" Width="60px" ReadOnly="true" runat="server"
                                                    MaxLength="5" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment2" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment2BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment2" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment2BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo2" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo2" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo2BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo2BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList2" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList2BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting2" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting2BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:TextBox ID="txtStart3" CssClass="time start" Width="60px" ReadOnly="true"
                                                    runat="server" MaxLength="5" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtEnd3" CssClass="time end" Width="60px" ReadOnly="true" runat="server"
                                                    MaxLength="5" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment3" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment3BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment3" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment3BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo3" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo3" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo3BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo3BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList3" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList3BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting3" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting3BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:TextBox ID="txtStart4" CssClass="time start" Width="60px" ReadOnly="true"
                                                    runat="server" MaxLength="5" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtEnd4" CssClass="time end" Width="60px" ReadOnly="true" runat="server"
                                                    MaxLength="5" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment4" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment4BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment4" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment4BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo4" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo4" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo4BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo4BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList4" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList4BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting4" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting4BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:TextBox ID="txtStart5" CssClass="time start" Width="60px" ReadOnly="true"
                                                    runat="server" MaxLength="5" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtEnd5" CssClass="time end" Width="60px" ReadOnly="true" runat="server"
                                                    MaxLength="5" />
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment5" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumAppointment5BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment5" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMobileAppointment5BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo5" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo5" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueStartNo5BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtReservedQueueEndNo5BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            ...
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList5" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtMaximumWaitingList5BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting5" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="txtWaiting5BPJS" CssClass="number" Width="60px"
                                                    runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                ...
                                                <img class="imgDelete imgLink" src='<%# ResolveUrl("~/Libs/Images/Button/delete.png")%>'
                                                    alt="" />
                                                <input type="hidden" class="hdnScheduleDate" value="<%#: Eval("ScheduleDate")%>" />
                                                ...
                                                <input type="hidden" class="hdnParamedicScheduleDateRemarks" value="<%#: Eval("Remarks")%>" />
                                                ...
                                                <input type="hidden" class="hdnOperationalTimeNameEntry" value="<%#: Eval("OperationalTimeName")%>" />
                                        ...
                                        <asp:BoundField HeaderStyle-Width="80px" DataField="cfScheduleDateInStringDatePicker"
                                            ItemStyle-CssClass="tdScheduleDate" HeaderText="Schedule Date" HeaderStyle-HorizontalAlign="Center"
                ...
                <div style="width: 100%; text-align: center" id="divContainerAddData" runat="server">
                    <span class="lblLink" id="lblEntryPopupAddDataScheduleWithDate">
