<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PSleaveScheduleEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.PSleaveScheduleEntryCtl" %>
...
//    });
    ...
    $('.imgEdit.imgLink').live('click', function () {
        ...
        var LeaveOtherReason = $row.find('.hdnLeaveOtherReason').val(); 
        ...
        $('#<%=txtOtherLeaveReason.ClientID %>').val(LeaveOtherReason);
                                    ...
                                    <columns>
                                        <asp:TemplateField HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                ...
                                                <input type="hidden" class="hdnLeaveOtherReason" value="<%#: Eval("LeaveOtherReason")%>" />
