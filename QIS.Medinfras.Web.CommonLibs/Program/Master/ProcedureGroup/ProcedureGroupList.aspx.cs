...
{
    public partial class ProcedureGroupList : BasePageList
    {
        ...
        public override void SetFilterParameter(ref string[] fieldListText, ref string[] fieldListValue)
        {
            ...
            fieldListValue = new string[] { "ProcedureGroupCode", "ProcedureGroupName" };
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetProcedureGroupRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_MASTER);
            }

            List<ProcedureGroup> lstEntity = BusinessLayer.GetProcedureGroupList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "ProcedureGroupCode ASC");
