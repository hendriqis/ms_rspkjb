...
{
    public partial class ProcedureGroupEntry : BasePageEntry
    {
        ...
        {
            String filterExpression4 = string.Format("ParentID IN ('{0}')", Constant.StandardCode.SURGERY_CLASSIFICATION);
            List<StandardCode> lstSurgeryClassification = BusinessLayer.GetStandardCodeList(filterExpression4);
            lstSurgeryClassification.Insert(0, new StandardCode { StandardCodeID = "", StandardCodeName = "" });
            Methods.SetComboBoxField<StandardCode>(cboSurgeryClassification, lstSurgeryClassification, "StandardCodeName", "StandardCodeID");
        }
        ...
        private void EntityToControl(ProcedureGroup entity)
        {
            ...
            cboSurgeryClassification.Value = entity.GCSurgeryClassification;
        ...
        private void ControlToEntity(ProcedureGroup entity)
        {
            ...
            {
                if (cboSurgeryClassification.Value.ToString() != string.Empty)
                {
                    entity.GCSurgeryClassification = cboSurgeryClassification.Value.ToString();
                }
            }
        ...
        protected override bool OnBeforeSaveAddRecord(ref string errMessage)
        {
            ...
            if (lst.Count > 0)
                errMessage = " Kode Jenis Tindakan " + txtProcedureGroupCode.Text + " sudah digunakan!";
