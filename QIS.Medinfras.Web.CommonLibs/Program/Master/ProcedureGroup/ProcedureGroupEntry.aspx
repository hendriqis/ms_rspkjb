<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPEntry.master" AutoEventWireup="true" 
    CodeBehind="ProcedureGroupEntry.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ProcedureGroupEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <input type="hidden" id="hdnProcedureGroupID" runat="server" value="" />
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:50%">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtProcedureGroupCode" Width="100px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Nama Tindakan")%></label></td>
                        <td><asp:TextBox ID="txtProcedureGroupName" Width="100%" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                            <label>
