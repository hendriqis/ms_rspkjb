...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class StandardCodeList : BasePageList
    {
        ...
        {
            hdnParentID.Value = Request.QueryString["id"];
        ...
        {
            url = ResolveUrl(string.Format("~/Libs/Program/Master/StandardCode/StandardCodeEntry.aspx?id=add|{0}", hdnParentID.Value));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Libs/Program/Master/StandardCode/StandardCodeEntry.aspx?id=edit|{0}", hdnID.Value));
                return true;
            }
            return false;
        }
