<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true"
    CodeBehind="TemplatePharmacyChargesList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.TemplatePharmacyChargesList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkItemDrug a').live('click', function () {
            ...
            var url = ResolveUrl('~/Libs/Program/Master/TemplatePharmacyCharges/TemplatePharmacyChargesEntryItemCtl.ascx');
            var width = 1000;
