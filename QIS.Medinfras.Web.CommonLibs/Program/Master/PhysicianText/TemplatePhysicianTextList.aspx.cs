...
{
    public partial class TemplatePhysicianTextList : BasePageList
    {
        protected int PageCount = 1;
        protected int CurrPage = 1;
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.EMR.MASTER_PHYSICIAN_SOAP_TEMPLATE;
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vPhysicianText> lstEntity = BusinessLayer.GetvPhysicianTextList(string.Format(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex));
        ...
        {
            url = ResolveUrl("~/Libs/Program/Master/PhysicianText/TemplatePhysicianTextEntry.aspx");
            return true;
        }
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Libs/Program/Master/PhysicianText/TemplatePhysicianTextEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
