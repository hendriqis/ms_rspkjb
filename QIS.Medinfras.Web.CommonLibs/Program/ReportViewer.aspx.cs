...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class ReportViewer : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //string rptFolder = HttpContext.Current.Request.MapPath("~/Libs/App_Data/Report/");
            //string RptLoc = rptFolder + "Custom/" + reportClassName;
            //string RptConfigLoc = rptFolder + "Config/" + reportClassName+".rdl";
            //if (!File.Exists(RptLoc))
            //{
            ...
            //{
            //rpt = new XtraReport();
            //    //rpt.LoadLayoutFromXml(RptLoc);

            //    //if (reportMaster.GCDataSourceType == Constant.DataSourceType.VIEW)
            //    //    BindingView(param);
            //    //else
            //    //    BindingStoredProcedure(param);
            //    //dict = new Dictionary<string, object>();
            //    //dynamic rptConfig = JObject.Parse(File.ReadAllText(RptConfigLoc));
            //    //#region InitializeDataSource
            //    //JArray sources = rptConfig.Sources;
            //    //foreach (dynamic src in sources)
            //    //{
            //    //    string dtSource = src.DataSource;
            //    //    string condition = src.Condition;
            //    //    string conditionType = src.ConditionType;
            //    //    string[] usedData = src.UsedData.ToObject<string[]>();
            //    //    dynamic obj = null;
            //    //    switch (conditionType)
            //    //    {
            //    //        case "Param":
            //    //            {
            //    //                int paramCount = src.ConditionParams.ToObject<int>();
            //    //                int skipVal = src.ParamSkip.ToObject<int>();
            //    //                string[] conditionParams = param.Skip(skipVal).Take(paramCount).ToArray();
            //    //                MethodInfo method = typeof(BusinessLayer).GetMethod(dtSource, new[] { typeof(string) });
            //    //                string filterExp = string.Format(condition, conditionParams);
            //    //                obj = method.Invoke(null, new string[] { filterExp });
            //    //            }
            //    //            break;
            //    //        case "ParamSingleEntity":
            //    //            {
            //    //                int paramTemp = src.ConditionParams.ToObject<int>();
            //    //                Int32 conditionParam = Convert.ToInt32(param[paramTemp]);
            //    //                MethodInfo method = typeof(BusinessLayer).GetMethod(dtSource, new[] { typeof(int) });
            //    //                obj = method.Invoke(null, new object[] { conditionParam });
            //    //            }
            //    //            break;
            //    //        case "AppSession":
            //    //            {
            //    //                string paramTemp = src.ConditionParams.ToObject<string>();
            //    //                string conditionParam = Convert.ToString(AppSession.UserLogin.GetType().GetProperty(paramTemp).GetValue(AppSession.UserLogin, null));
            //    //                MethodInfo method = typeof(BusinessLayer).GetMethod(dtSource, new[] { typeof(string) });
            //    //                string filterExp = string.Format(condition, conditionParam);
            //    //                obj = method.Invoke(null, new string[] { filterExp });
            //    //            }
            //    //            break;
            //    //        case "DataSourceProp":
            //    //            {
            //    //                string conditionParam = Convert.ToString(GetValueFromDictionary(src.ConditionParams.ToObject<string>()));
            //    //                MethodInfo method = typeof(BusinessLayer).GetMethod(dtSource, new[] { typeof(string) });
            //    //                if (method == null)
            //    //                {
            //    //                    method = typeof(BusinessLayer).GetMethod(dtSource, new[] { typeof(int) });
            //    //                }
            //    //                string filterExp = string.Format(condition, conditionParam);
            //    //                obj = method.Invoke(null, new object[] { filterExp });
            //    //            }
            //    //            break;
            //    //    }

            //    //    if (usedData != null && obj != null)
            //    //    {
            //    //        if (obj is IList && obj.GetType().IsGenericType)
            //    //        {
            //    //            obj = obj[0];
            //    //        }
            //    //        foreach (string data in usedData)
            //    //        {
            //    //            dict.Add(data, obj.GetType().GetProperty(data).GetValue(obj, null));
            //    //        }
            //    //    }
            //    //}

            //    //#endregion IntializeDataSource
            //    //#region LoadDataSourceToLabel
            //    //JArray fields = rptConfig.Fields;
            //    //foreach (dynamic field in fields)
            //    //{
            //    //    string labelName = field.LabelName;
            //    //    string[] usedSources = field.Source.ToObject<string[]>();
            //    //    string[] operations = field.Operator.ToObject<string[]>();
            //    //    dynamic o = null;
            //    //    int idx = 0;
            //    //    foreach (string source in usedSources)
            //    //    {
            //    //        if (o == null)
            //    //        {
            //    //            o = GetValueFromDictionary(source);
            //    //        }
            //    //        else
            //    //        {
            //    //            string operation = operations[idx - 1];
            //    //            switch (operation)
            //    //            {
            //    //                case "-": o = o - Convert.ToDecimal(GetValueFromDictionary(source)); break;
            //    //                case "+": o = o + Convert.ToDecimal(GetValueFromDictionary(source)); break;
            //    //                case "/": o = o / Convert.ToDecimal(GetValueFromDictionary(source)); break;
            //    //                case "*": o = o * Convert.ToDecimal(GetValueFromDictionary(source)); break;
            //    //                case "s+": o = o + Convert.ToString(GetValueFromDictionary(source)); break;
            //    //            }
            //    //        }
            //    //        idx++;
            //    //    }
            ...
            //    //    {
            //    //        dict.Add(field.Name.ToString(), o);
            //    //    }
            //    //    string txtToDisplay = "";
            //    //    if (field.Format == null)
            //    //    {
            //    //        txtToDisplay = o.ToString();
            //    //    }
            //    //    else if (field.Format.ToString().Equals("N"))
            //    //    {
            //    //        txtToDisplay = string.Format("{0:0.00}", o);
            //    //    }
            //    //    rpt.Report.FindControl(labelName, false).Text = txtToDisplay;
            //    //}
            //    //#endregion LoadDataSourceToLabel
            //    //#region callNeededReportMethod
            //    //JArray rptMethods = rptConfig.Methods;
            //    //foreach (dynamic mtd in rptMethods)
            //    //{
            //    //    string methodName = mtd.MethodName;
            //    //    string methodFormat = mtd.MethodFormat;
            //    //    string lblTarget = mtd.LabelName;
            //    //    string txtToDisplay = "";
            //    //    switch (methodName)
            //    //    {
            //    //        case "ParamSplitter":
            //    //            int paramIndex = mtd.ParameterIndex.ToObject<int>();
            //    //            char separator = mtd.Separator.ToObject<char>();
            //    //            string[] splitResult = param[paramIndex].Split(separator);
            //    //            switch (methodFormat)
            //    //            {
            //    //                case "PeriodDate":
            //    //                    txtToDisplay = string.Format("Periode : {0} s/d {1}",
            //    //                                        Helper.YYYYMMDDToDate(splitResult[0]).ToString(Constant.FormatString.DATE_FORMAT),
            //    //                                        Helper.YYYYMMDDToDate(splitResult[1]).ToString(Constant.FormatString.DATE_FORMAT)
            //    //                                        );
            //    //                    break;
            //    //            }
            //    //            break;
            //    //        case "GetDepartmentName":
            //    //            string src = mtd.Source;
            //    //            string DepartmentID = Convert.ToString(GetValueFromDictionary(src));
            //    //            switch (DepartmentID)
            //    //            {
            //    //                case Constant.Facility.INPATIENT:
            //    //                    txtToDisplay = "Rawat Jalan";
            //    //                    break;
            //    //                case Constant.Facility.OUTPATIENT:
            //    //                    txtToDisplay = "Rawat Inap";
            //    //                    break;
            //    //                case Constant.Facility.EMERGENCY:
            //    //                    txtToDisplay = "Rawat Darurat";
            //    //                    break;
            //    //                default:
            //    //                    txtToDisplay = "Penunjang Medis";
            //    //                    break;
            //    //            }
            //    //            break;
            //    //        case "GetUserFullName":
            //    //            txtToDisplay = AppSession.UserLogin.UserFullName;
            //    //            break;
            //    //    }
            //    //    rpt.Report.FindControl(lblTarget, false).Text = txtToDisplay;
            //    //}
            //    //#endregion callNeededReportMethod
