<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" CodeBehind="InformationLabList.aspx.cs" 
Inherits="QIS.Medinfras.Web.CommonLibs.Program.InformationLabList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="ItemCode" HeaderText="Kode Pemeriksaan" HeaderStyle-Width="250px" HeaderStyle-HorizontalAlign="Left" />
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="lnkDetailItem"
                                 HeaderText="Nama Pemeriksaan">
                                    <ItemTemplate>
