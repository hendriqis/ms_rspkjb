<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="InformationRegisteredPatientBPJSList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.InformationRegisteredPatientBPJSList" %>

<%@ Register Src="~/Libs/Controls/PatientGrid/GridInpatientRegistrationBPJSCtlNew.ascx"
    TagName="ctlGrdInpatientRegBPJS" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding: 15px">
        <div class="pageTitle">
            <%=GetLabel("Informasi Pendaftaran Pasien BPJS")%></div>
        <table class="tblContentArea" style="width: 100%">
            <tr>
                <td style="padding: 5px; vertical-align: top">
                    ...
                    <uc1:ctlGrdInpatientRegBPJS runat="server" ID="grdInpatientRegBPJS" />
                </td>
            </tr>
        </table>
    </div>
