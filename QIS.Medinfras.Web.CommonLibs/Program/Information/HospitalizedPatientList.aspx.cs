...
{
    public partial class HospitalizedPatientList : BasePageRegisteredPatient
    {
        public override string OnGetMenuCode()
        {
            if (Page.Request.QueryString["id"] != null)
            {
                ...
                {
                    return Constant.MenuCode.EmergencyCare.HOSPITALIZED_PATIENT_LIST;
                }
                else
                {
                    return Constant.MenuCode.Outpatient.HOSPITALIZED_PATIENT_LIST;
                }
            }
            return "";
        }
