<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformationCustomerPayerCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Information.InformationCustomerPayerCtl" %>
