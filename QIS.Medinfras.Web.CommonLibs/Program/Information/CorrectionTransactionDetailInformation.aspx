<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="CorrectionTransactionDetailInformation.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.CorrectionTransactionDetailInformation" %>
    ...
    <div style="height: 435px; overflow-y: auto;">
        <table class="tblContentArea" style="width: 100%">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtServiceUnitOrderName" ReadOnly="true" Width="250%" runat="server" /></td>
                <td>&nbsp;</td>
           </tr>
                                 </table>
        <table class="tblContentArea" style="width: 100%">
