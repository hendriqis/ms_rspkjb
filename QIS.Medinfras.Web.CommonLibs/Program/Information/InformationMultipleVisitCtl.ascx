<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformationMultipleVisitCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.InformationMultipleVisitCtl" %>
...
<div style="height: 440px; overflow-y: auto">
    ...
    <table class="tblContentArea">
            ...
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtNoSEP" ReadOnly="true" Width="150px" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <dxcp:ASPxCallbackPanel ID="cbpViewMultipleVisitCtl" runat="server" Width="100%" ClientInstanceName="cbpViewMultipleVisitCtl"
                    ShowLoadingPanel="false">
                    <ClientSideEvents BeginCallback="function(s,e){ $('#containerImgLoadingView').show(); }"
                        EndCallback="function(s,e){ oncbpViewMultipleVisitCtlEndCallback(s); }" />
                    <PanelCollection>
