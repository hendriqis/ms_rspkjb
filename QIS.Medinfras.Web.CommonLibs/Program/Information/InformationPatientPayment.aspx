<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/PatientPage/MPBasePatientPageTrx.master"
    AutoEventWireup="true" CodeBehind="InformationPatientPayment.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.InformationPatientPayment" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="plhMenuTitle" runat="server">
    <div style="font-size: 1.4em">
        <%=GetLabel("Informasi Pembayaran Pasien")%></div>
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnChangeTransactionStatusBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Libs/Program/Information/InformationPatientPaymentList.aspx');
                                        ...
                                        <asp:ListView ID="lvwView" runat="server">
                                                ...
                                                <table id="tblView" runat="server" class="grdSelected notAllowSelect grdBilling"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="width: 150px" align="right">
                                                            <%=GetLabel("Total Pembayaran Pasien")%>
                                                        </th>
                                                        <th style="width: 150px" align="right">
                                                            <%=GetLabel("Total Pembayaran Instansi")%>
                                                        </th>
                                                        <th style="width: 150px">
                                            ...
                                            <ItemTemplate>
                                                <tr runat="server" id="trItem">
                                                    ...
                                                    <td align="right">
                                                        <div>
                                                            <%#: Eval("cfTotalPatientBillAmount", "{0:N}")%></div>
                                                    </td>
                                                    <td align="right">
                                                        <div>
                                                            <%#: Eval("TotalPayerBillAmount", "{0:N}")%></div>
                                                    </td>
                                                    <td align="center">
                                                        <div>
