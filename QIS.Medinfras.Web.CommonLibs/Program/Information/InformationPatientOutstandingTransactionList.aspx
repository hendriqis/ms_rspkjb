<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="InformationPatientOutstandingTransactionList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.InformationPatientOutstandingTransactionList" %>

<%@ Register Src="~/Libs/Controls/PatientGrid/GridPatientOutstandingTransactionCtl.ascx"
    TagName="ctlGrdPatientOutstanding" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding: 15px">
        <div class="pageTitle">
            <%=GetLabel("Informasi Transaksi Pasien Di Rawat")%></div>
        <table class="tblContentArea" style="width: 100%">
            <tr>
                <td style="padding: 5px; vertical-align: top">
                    ...
                    <uc1:ctlGrdPatientOutstanding runat="server" ID="grdPatientOutstanding" />
                </td>
            </tr>
        </table>
    </div>
