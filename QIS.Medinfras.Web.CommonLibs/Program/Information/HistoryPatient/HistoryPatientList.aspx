...
CodeBehind="HistoryPatientList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.HistoryPatientList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding:15px">
        ...
        <div class="pageTitle"><%=GetLabel("Informasi History Transaksi Pasien")%></div>
