<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoHistoryLockDownCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.InfoHistoryLockDownCtl" %>
                                ...
                                <asp:ListView runat="server" ID="lvwView">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#: Eval("OldLockDownByName")%>
                                            </td>
                                            <td align="center">
                                                <%#: Eval("OldLockDownDate")%>
                                            </td>
                                            <td align="center">
                                                <%#: Eval("NewIsLockDown")%>
                                            </td>
                                            <td>
                                                <%#: Eval("NewLockDownByName")%>
                                            </td>
                                            <td align="center">
                                                <%#: Eval("NewLockDownDate")%>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
