<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformationDrugAlertCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Information.InformationDrugAlertCtl" %>
