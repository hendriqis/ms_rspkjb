<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="HistoryWalletPatient.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.HistoryWalletPatient" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkPatientDepositHistory').live('click', function () {
            var MRN = $(this).closest('tr').find('.keyField').html();
            ...
            openUserControlPopup(url, data, 'History Deposit Balance', 1000, 500);
        });
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="overflow-y: scroll;">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MedicalNo" HeaderStyle-CssClass="MedicalNo" ItemStyle-CssClass="MedicalNo" />
                                <asp:BoundField DataField="PatientName" HeaderStyle-CssClass="PatientName" ItemStyle-CssClass="PatientName" />
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <div style="vertical-align: middle">
                                            <img class="lnkPatientDepositHistory imgLink" title="<%=GetLabel("View") %>" src='<%# ResolveUrl("~/Libs/Images/Toolbar/registration_notes.png")%>'
                                                alt="" width="30px" style="padding-left: 2px; display: inline" />
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
