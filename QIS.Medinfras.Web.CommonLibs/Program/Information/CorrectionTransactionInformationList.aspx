<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="CorrectionTransactionInformationList.aspx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.CorrectionTransactionInformationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding: 15px">
        ...
        <div class="pageTitle">
            <%=GetLabel("Ubah Status Transaksi")%></div>
