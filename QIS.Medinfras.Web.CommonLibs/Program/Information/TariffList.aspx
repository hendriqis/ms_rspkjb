<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="TariffList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.TariffList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <div style="padding: 15px">
        <div class="pageTitle"><%=GetLabel("Informasi Tarif Pelayanan") %></div>
                    ...
                    <fieldset id="fsTariffList">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxComboBox ID="cboItemType" ClientInstanceName="cboItemType" Width="200px" runat="server">
