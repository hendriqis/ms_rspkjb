...
namespace QIS.Medinfras.Web.Finance.Program
{
    public partial class TariffApprovalItemList : BasePageListEntry
    {
        ...
        {
            return "Persetujuan Item Tarif";
        }

        public override string OnGetCustomBreadcrumbs(string breadCrumbs)
        {
            return string.Format("{0} > Persetujuan Item Tarif", breadCrumbs);
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            if (hdnListClassID.Value == "")
            {
                ...
                //{
                //    divProposedComponentLabel.Attributes.Add("style", "display:none");
                //    divApprovedComponentLabel.Attributes.Add("style", "display:none");
                //}
        ...
        protected void rptClassCareProposed_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                {
                    HtmlGenericControl divProposedComponent = (HtmlGenericControl)e.Item.FindControl("divProposedComponent");
                    divProposedComponent.Attributes.Add("style", "display:none");
                }
            }
        }

        protected void rptClassCareApproved_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                if (hdnGCItemType.Value == Constant.ItemGroupMaster.DRUGS || hdnGCItemType.Value == Constant.ItemGroupMaster.LOGISTIC)
                {
                    HtmlGenericControl divApprovedComponent = (HtmlGenericControl)e.Item.FindControl("divApprovedComponent");
                    divApprovedComponent.Attributes.Add("style", "display:none");
                }
            }
        }
            ...
            try
            {
                ...
                foreach (RepeaterItem item in rptClassCareApproved.Items)
                {
                    ...
                    if (entity != null)
                    {
                        ...
                        entity.ApprovedTariffComp1 = Convert.ToDecimal(Request.Form[txtComponent1.UniqueID]);
                        entity.ApprovedTariffComp2 = Convert.ToDecimal(Request.Form[txtComponent2.UniqueID]);
                        entity.ApprovedTariffComp3 = Convert.ToDecimal(Request.Form[txtComponent3.UniqueID]);
