<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPListEntry.master" AutoEventWireup="true" 
    CodeBehind="EditTariffBookItemList.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.EditTariffBookItemList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhScript" runat="server">
    <script type="text/javascript">
        ...
        function onSelectedRowChanged(value) {
            var idx = $('#grdView tr').index($('#grdView tr.selected'));
            idx += value;
            if (idx < 2)
                idx = 2;
        ...
        $(function () {
            $('#<%=btnCreateTariffBookItemBack.ClientID %>').click(function () {
                showLoadingPanel();
                var url = ResolveUrl('~/Program/TariffManagement/EditTariffBook/EditTariffBookList.aspx');
                ...
                <table style="width:100%">
                    ...
                    <tr>
                        <td class="tdLabel" valign="top">
                            ...
                            <div style="margin-top: 28px;" id="divComponentLabel" runat="server">
                            ...
                            <asp:Repeater id="rptClassCare" runat="server" OnItemDataBound="rptClassCare_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <li>
                                        ...
                                        <span><input type="button" class="btnEditItemCost" title='<%=GetLabel("Item Cost") %>' value="..." style="width:15px"  /></span>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:300px">
                        <table id="grdView" class="grdSelected grdPatientPage" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:120px; display:none" rowspan="2" align="right"><%=GetLabel("Suggested Tariff")%></th>
                                <th style="width:120px; display:none" rowspan="2" align="right"><%=GetLabel("Base Tariff")%></th>
                                <th colspan="<%=ClassCount %>"><%=GetLabel("KELAS TAGIHAN") %></th>
                                <th style="width:80; display:none" rowspan="2"><%=GetLabel("Approved")%></th>
                            </tr>
                            <tr>                                
                        ...
                        <asp:ListView ID="lvwView" runat="server" OnItemDataBound="lvwView_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="right" style="display:none"><%#: DataBinder.Eval(Container.DataItem, "SuggestedTariff", "{0:N}")%></td>
                                    <td align="right" style="display:none"><%#: DataBinder.Eval(Container.DataItem, "DisplayBaseTariff", "{0:N}")%></td>
                                    <asp:Repeater ID="rptTariffBookClass" runat="server">
                                        <ItemTemplate>
                                            <td align="right"><%#: String.Format("{0, 0:N2}", Container.DataItem)%></td>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                    <td align="center" style="display:none"><asp:CheckBox ID="chkIsApproved" runat="server" Enabled="false" /></td>
                                </tr>
                            </ItemTemplate>
                            <EmptyDataTemplate>
                                <tr class="trEmpty">
