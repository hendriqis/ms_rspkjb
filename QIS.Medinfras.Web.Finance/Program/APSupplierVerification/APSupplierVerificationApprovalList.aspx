<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx2.master" AutoEventWireup="true"
    CodeBehind="APSupplierVerificationApprovalList.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.APSupplierVerificationApprovalList" %>
            ...
            $('#<%=btnProcess.ClientID %>').click(function (evt) {
                ...
                if ($('#<%=hdnSelectedMember.ClientID %>').val() == '') {
                    ...
                    if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                        ...
                        if ($('#<%=hdnIsAllowApproved.ClientID %>').val() == '0') {
                            onCustomButtonClick('propose');
                            showToast('Propose Success', "Proses Propose pada No. Pembayaran <b>" + suppPaymentNo + "</b> Sudah Berhasil Dilakukan");
                        }
                        else {
