<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="EKlaimSendOnlineIndividual.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.EKlaimSendOnlineIndividual" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnSendClaimIndividual" runat="server" crudmode="R">
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('#<%=btnSendClaimIndividual.ClientID %>').click(function (evt) {
            var isBridgingToEKlaim = $('#<%=hdnIsBridgingToEKlaim.ClientID %>').val();
            if (isBridgingToEKlaim == "1") {
                var messageBeforeSendClaim = '<b>' + 'Proses mengirim klaim individual ke data center INACBGs.' + '</b>' + ' Lanjutkan ?';
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNoSEP" Width="250px" runat="server" />
                            </td>
                        </tr>
                    </table>
                </td>
