...
{
    public partial class InfoSurgeryReportListCtl : BaseViewPopupCtl
    {
        ...
        protected void cbpViewSurgey_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            BindGridDetail();
        }     
    }
