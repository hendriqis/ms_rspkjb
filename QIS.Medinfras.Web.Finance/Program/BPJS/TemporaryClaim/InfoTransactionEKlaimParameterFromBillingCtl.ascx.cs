...
{
    public partial class InfoTransactionEKlaimParameterFromBillingCtl : BaseContentPopupCtl
    {
        ...
        {
            List<GetPatientChargesHdDtEKlaimParameterPerBilling> lstEntity = BusinessLayer.GetPatientChargesHdDtEKlaimParameterPerBillingList(Convert.ToInt32(hdnRegistrationID.Value));
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            {
                GetPatientChargesHdDtEKlaimParameterPerBilling entity = e.Item.DataItem as GetPatientChargesHdDtEKlaimParameterPerBilling;
