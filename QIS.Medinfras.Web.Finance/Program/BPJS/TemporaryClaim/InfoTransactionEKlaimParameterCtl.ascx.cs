...
{
    public partial class InfoTransactionEKlaimParameterCtl : BaseContentPopupCtl
    {
        ...
        {
            List<GetPatientChargesHdDtEKlaimParameter> lstEntity = BusinessLayer.GetPatientChargesHdDtEKlaimParameterList(Convert.ToInt32(hdnRegistrationID.Value));
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            {
                GetPatientChargesHdDtEKlaimParameter entity = e.Item.DataItem as GetPatientChargesHdDtEKlaimParameter;
