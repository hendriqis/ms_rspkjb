<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfoPatientDocumentListCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.InfoPatientDocumentListCtl" %>
...
<script type="text/javascript" id="dxss_PatientDocumentListCtl">
    ...
    $('.imgDelete.imgLink').live('click', function (evt) {
        ...
        if (confirm("Are You Sure Want To Delete This Data?")) {
            ...
            cbpViewPatientList.PerformCallback('delete');
        }
    });
    ...
    function onCbpViewEndCallback(s) {
        ...
        if (param[0] == 'delete') {
            if (param[1] == 'fail') {
                ...
                cbpViewPatientList.PerformCallback('refresh');
            }
            else {
    ...
    function setPagingDetailItem(pageCount) {
        ...
        setPaging($("#pagingPopup"), pageCount, function (page) {
            cbpViewPatientList.PerformCallback('changepage|' + page);
        }, 8);
    }
    //#endregion 
    ...
    <table class="tblContentArea">
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <div>
                    <dxcp:ASPxCallbackPanel ID="cbpViewPatientList" runat="server" Width="100%" ClientInstanceName="cbpViewPatientList"
                        ShowLoadingPanel="false" OnCallback="cbpViewPatientList_Callback">
                        <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }" EndCallback="function(s,e){ onCbpViewPatientListEndCallback(s); }" />
                        <PanelCollection>
