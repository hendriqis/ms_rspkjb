<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="DiagnoseEKlaimList.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.DiagnoseEKlaimList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SearchDiagnose(diagnoseSearch) {
            EKlaimService.searchDiagnosisReinsertBPJSReference(diagnoseSearch, function (result) {
                if (result != null) {
