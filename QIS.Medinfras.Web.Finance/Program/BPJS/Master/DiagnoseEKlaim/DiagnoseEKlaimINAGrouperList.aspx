<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="DiagnoseEKlaimINAGrouperList.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.DiagnoseEKlaimINAGrouperList" %>
    ...
    <script type="text/javascript">
        ...
        $('#<%=btnImportDiagnose.ClientID %>').live('click', function (evt) {
            ...
            if (isBridgingToEKlaim == "1") {
                var diagnoseSearch = "a";
                SearchDiagnose(diagnoseSearch);
            } else {
                showToast('INFORMATION', 'Status bridging dengan e-klaim sedang nonaktif.');
            }
        });

        function SearchDiagnose(diagnoseSearch) {
            EKlaimService.searchDiagnosisINAGrouperReinsertBPJSReference(diagnoseSearch, function (result) {
                if (result != null) {
