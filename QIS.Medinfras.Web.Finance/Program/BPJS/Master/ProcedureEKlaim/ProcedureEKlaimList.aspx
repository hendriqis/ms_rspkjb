<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ProcedureEKlaimList.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.ProcedureEKlaimList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SearchProcedure(procedureSearch) {
            EKlaimService.searchProceduresReinsertBPJSReference(procedureSearch, function (result) {
                if (result != null) {
