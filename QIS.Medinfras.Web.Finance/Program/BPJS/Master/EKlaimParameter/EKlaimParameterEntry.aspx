<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master"
    AutoEventWireup="true" CodeBehind="EKlaimParameterEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.EKlaimParameterEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <table class="tblContentArea">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtParameterCode" Width="100px" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="tdLabel">
