<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="ChangePatientBillSummaryPayment.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.ChangePatientBillSummaryPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=chkIsClosedRegistration.ClientID %>').die();
            $('#<%=chkIsClosedRegistration.ClientID %>').live('change', function () {
                onRefreshGrdReg();
            });
        });
    ...
    <div style="padding: 15px">
        ...
        <div class="pageTitle">
            <%=GetLabel("Ubah Metode Pembayaran Pasien")%></div>
                    ...
                    <fieldset id="fsPatientList">
                        <table class="tblEntryContent" style="width: 60%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="chkIsClosedRegistration" runat="server" Text="Termasuk Status Closed" />
                                </td>
                            </tr>
                        </table>
                    </fieldset>
