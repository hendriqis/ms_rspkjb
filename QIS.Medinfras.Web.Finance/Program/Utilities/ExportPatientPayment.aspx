...
CodeBehind="ExportPatientPayment.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.ExportPatientPayment" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#btnProcess').click(function () {
                showToastConfirmation('Proses Export Transaksi Pembayaran?', function (result) {
                    if (result) {
        ...
        function onCbpProcesEndCallback(s) {
            ...
            if (param[0] == 'fail')
                ...
                showToast('Process Success', 'Proses Export Transaksi Pembayaran Berhasil Dilakukan dengan Nama File ' + param[1]);
            ...
            <tr>
                <td>
                    <div style="width: 450px;">
                        <div class="lblComponent" style="text-align:center"><%=GetLabel("Konfigurasi Export Transaksi") %></div>
                        <div style="background-color: #EAEAEA;">
                            <table width="300px" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td align="center">:</td>
                                    <td><div runat="server" id="divFileName">HIS_AR_MISC_yyyymmdd_hh_mm.csv</div></td>
                                </tr>
                            </table>
                        </div>
                    </div>
