<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TreasuryEditDirectPurchaseCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.TreasuryEditDirectPurchaseCtl" %>
