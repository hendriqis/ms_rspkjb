<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx5.master"
    AutoEventWireup="true" CodeBehind="TreasuryTransactionEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.TreasuryTransactionEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        function onLoad() {
            ...
            var gcTreasuryGroup = $('#<%=hdnTreasuryGroup.ClientID %>').val();
            if (gcTreasuryGroup == Constant.TreasuryGroup.AR_RECEIVING) {
                $('#btnChangeBusinessPartners').removeAttr('enabled');
            } else {
                $('#btnChangeBusinessPartners').attr('enabled', 'false');
            }
            ...
            $('#btnSave').click(function (evt) {
                if (IsValid(evt, 'fsTrxPopup', 'mpTrxPopup')) {
                    ...
                    var hdnTreasuryGroup = $('#<%=hdnTreasuryGroup.ClientID %>').val();
                    var hdnARPaymentMethod = $('#<%=hdnARPaymentMethod.ClientID %>').val();

                    if (hdnIsReferenceNoMandatory == "1" && txtReferenceNo == "") {
                        displayErrorMessageBox('MEDINFRAS', "Harap isi terlebih dahulu Nomor Referensi nya.");
                    }
                    else if (hdnTreasuryGroup == Constant.TreasuryGroup.AR_RECEIVING && (hdnARPaymentMethod == null || hdnARPaymentMethod == "")) {
                        displayErrorMessageBox('MEDINFRAS', "Harap pilih terlebih dahulu Metode Pembayaran nya.");
                    }
                    else {
        ...
        function setLabelLinkVisibility() {
            var value = $('#<%=hdnTreasuryGroup.ClientID %>').val();
            if (value == Constant.TreasuryGroup.SUPPLIER_PAYMENT) {
                if ($('#<%=hdnIsEditable.ClientID %>').val() == '1') {
                    if ($('#<%=hdnID.ClientID %>').val() != '0' && $('#<%=hdnID.ClientID %>').val() != '') {
                        $('#lblAddData').show();
                        $('#lblCopySupplierPayment').show();
                        $('#lblCopyDirectPurchase').hide();
                        $('#lblCopyRevenueSharing').hide();
                        $('#lblCopyUserPatientPaymentBalance').hide();
                        $('#lblCopyPaymentDetailReconciliation').hide();
                    } else {
                        $('#lblAddData').hide();
                        $('#lblCopySupplierPayment').hide();
                        $('#lblCopyDirectPurchase').hide();
                        $('#lblCopyRevenueSharing').hide();
                        $('#lblCopyUserPatientPaymentBalance').hide();
                        $('#lblCopyPaymentDetailReconciliation').hide();
                ...
                $('#<%=trARPaymentMethod.ClientID %>').attr('style', 'display:none');
                $('#<%=trDocument.ClientID %>').removeAttr('style');
            } else if (value == Constant.TreasuryGroup.AR_RECEIVING) {
                if ($('#<%=hdnIsEditable.ClientID %>').val() == '1') {
                    if ($('#<%=hdnID.ClientID %>').val() != '0' && $('#<%=hdnID.ClientID %>').val() != '') {
                        $('#lblAddData').show();
                        $('#lblCopySupplierPayment').hide();
                        ...
                        $('#<%=trARPaymentMethod.ClientID %>').removeAttr('style');
                        $('#<%=trDocument.ClientID %>').attr('style', 'display:none');
                    } else {
                        $('#lblAddData').hide();
                        $('#lblCopySupplierPayment').hide();
                        $('#lblCopyDirectPurchase').hide();
            ...
            } else if (value == Constant.TreasuryGroup.DIRECT_PURCHASE) {
                if ($('#<%=hdnIsEditable.ClientID %>').val() == '1') {
                    if ($('#<%=hdnID.ClientID %>').val() != '0' && $('#<%=hdnID.ClientID %>').val() != '') {
                        $('#lblAddData').show();
                        $('#lblCopySupplierPayment').hide();
                        $('#lblCopyDirectPurchase').show();
                        $('#lblCopyRevenueSharing').hide();
                        $('#lblCopyUserPatientPaymentBalance').hide();
                        $('#lblCopyPaymentDetailReconciliation').hide();
                    } else {
                ...
                $('#<%=trARPaymentMethod.ClientID %>').attr('style', 'display:none');
                $('#<%=trDocument.ClientID %>').removeAttr('style');
            } else if (value == Constant.TreasuryGroup.REVENUE_SHARING) {
                if ($('#<%=hdnIsEditable.ClientID %>').val() == '1') {
                    if ($('#<%=hdnID.ClientID %>').val() != '0' && $('#<%=hdnID.ClientID %>').val() != '') {
                        $('#lblAddData').hide();
                        $('#lblCopySupplierPayment').hide();
                        $('#lblCopyDirectPurchase').hide();
                        $('#lblCopyRevenueSharing').show();
                        $('#lblCopyUserPatientPaymentBalance').hide();
                        $('#lblCopyPaymentDetailReconciliation').hide();
                    } else {
                        $('#lblAddData').hide();
                ...
                $('#<%=trARPaymentMethod.ClientID %>').attr('style', 'display:none');
                $('#<%=trDocument.ClientID %>').removeAttr('style');
            } else if (value == Constant.TreasuryGroup.SETORAN_KASIR) {
                if ($('#<%=hdnIsEditable.ClientID %>').val() == '1') {
                    if ($('#<%=hdnID.ClientID %>').val() != '0' && $('#<%=hdnID.ClientID %>').val() != '') {
                        $('#lblAddData').show();
                        $('#lblCopySupplierPayment').hide();
                        $('#lblCopyDirectPurchase').hide();
                        $('#lblCopyRevenueSharing').hide();
                        $('#lblCopyUserPatientPaymentBalance').show();
                        $('#lblCopyPaymentDetailReconciliation').hide();
                    } else {
                        $('#lblAddData').hide();
                        $('#lblCopySupplierPayment').hide();
                ...
                $('#<%=trARPaymentMethod.ClientID %>').attr('style', 'display:none');
                $('#<%=trDocument.ClientID %>').removeAttr('style');
            } else if (value == Constant.TreasuryGroup.SETORAN_KASIR_REKONSILIASI) {
                if ($('#<%=hdnIsEditable.ClientID %>').val() == '1') {
                    if ($('#<%=hdnID.ClientID %>').val() != '0' && $('#<%=hdnID.ClientID %>').val() != '') {
                        $('#lblAddData').show();
                        $('#lblCopySupplierPayment').hide();
                        ...
                        $('#lblCopyRevenueSharing').hide();
                        $('#lblCopyUserPatientPaymentBalance').hide();
                        $('#lblCopyPaymentDetailReconciliation').show();
                    } else {
                        $('#lblAddData').hide();
                        $('#lblCopySupplierPayment').hide();
                        $('#lblCopyDirectPurchase').hide();
        ...
        $('#lblAddData').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                ...
                var value = $('#<%=hdnTreasuryGroup.ClientID %>').val();
                if (value == Constant.TreasuryGroup.AR_RECEIVING) {
                    if ($('#<%=hdnCOAKontraPiutangID.ClientID %>').val() != "" && $('#<%=hdnCOAKontraPiutangID.ClientID %>').val() != "0") {
                        $('#<%=hdnGLAccountID.ClientID %>').val($('#<%=hdnCOAKontraPiutangID.ClientID %>').val());
                        $('#<%=txtGLAccountCode.ClientID %>').val($('#<%=hdnCOAKontraPiutangNo.ClientID %>').val());
                        $('#<%=txtGLAccountName.ClientID %>').val($('#<%=hdnCOAKontraPiutangName.ClientID %>').val());
                    } else {
                    ...
                    $('#<%=hdnARPaymentMethod.ClientID %>').val('');
                    $('#<%=txtARPaymentMethod.ClientID %>').val('');
                    $('#<%=hdnARBank.ClientID %>').val('');
                    $('#<%=txtARBank.ClientID %>').val('');
                }
                ...
                $('#<%=hdnIsReferenceNoGeneratedBySystem.ClientID %>').val("0");
                ...
                $('#<%=hdnGLARReceivingID.ClientID %>').val('');
                ...
                $('#lblGLAccount').attr('class', 'lblLink');
                $('#<%:txtGLAccountCode.ClientID %>').removeAttr('readonly');
                $('#btnGLAccount').attr('enabled', 'true');

                $('#<%:lblSubLedgerDt.ClientID %>').attr('class', 'lblLink');
                $('#<%:txtSubLedgerDtCode.ClientID %>').removeAttr('readonly');
                $('#btnSubLedger').attr('enabled', 'true');

                $('#<%:lblDepartment.ClientID %>').attr('class', 'lblLink');
                $('#<%:txtDepartmentID.ClientID %>').removeAttr('readonly');

                $('#<%:lblServiceUnit.ClientID %>').attr('class', 'lblLink');
                $('#<%:txtServiceUnitCode.ClientID %>').removeAttr('readonly');

                $('#lblRevenueCostCenter').attr('class', 'lblLink');
                $('#<%:txtRevenueCostCenterCode.ClientID %>').removeAttr('readonly');

                $('#lblCustomerGroup').attr('class', 'lblLink');
                $('#<%:txtCustomerGroupCode.ClientID %>').removeAttr('readonly');

                $('#lblBusinessPartner').attr('class', 'lblLink');
                $('#<%:txtBusinessPartnerCode.ClientID %>').removeAttr('readonly');

                $('#lblMRN').attr('class', 'lblLink');
                $('#<%:txtMedicalNo.ClientID %>').removeAttr('readonly');

                $('#lblARPaymentMethod').attr('class', 'lblLink');
                $('#<%:txtARPaymentMethod.ClientID %>').removeAttr('readonly');

                $('#lblParamedicMaster').attr('class', 'lblLink');
                $('#<%:txtParamedicCode.ClientID %>').removeAttr('readonly');

                $('#lblVoucherAmount').attr('class', 'lblLink');
                cboPosition.SetEnabled(true);
                $('#<%:txtVoucherAmount.ClientID %>').removeAttr('readonly');

                $('#<%:txtDisplayOrder.ClientID %>').removeAttr('readonly');
        ...
        $('#<%=grdView.ClientID %> .imgEdit.imgLink').live('click', function () {
            ...
            if (entity.IsReferenceNoGeneratedBySystem == "True") {
                $('#<%=hdnIsReferenceNoGeneratedBySystem.ClientID %>').val("1");
            } else {
                $('#<%=hdnIsReferenceNoGeneratedBySystem.ClientID %>').val("0");
            }

            if ((entity.GCTreasuryGroup == Constant.TreasuryGroup.SUPPLIER_PAYMENT) && entity.ReferenceNo != null && entity.ReferenceNo != "") {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glTransactionDtID = entity.TransactionDtID;
                var param = glTransactionID + "|" + glTransactionDtID;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryEditSupplierPaymentCtl.ascx');
                openUserControlPopup(url, param, 'Edit Pembayaran Hutang', 600, 400);
            } else if (entity.GCTreasuryGroup == Constant.TreasuryGroup.DIRECT_PURCHASE) {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glTransactionDtID = entity.TransactionDtID;
                var param = glTransactionID + "|" + glTransactionDtID;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryEditDirectPurchaseCtl.ascx');
                openUserControlPopup(url, param, 'Edit Pembelian Tunai', 600, 400);
            } else if (entity.GCTreasuryGroup == Constant.TreasuryGroup.REVENUE_SHARING) {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glTransactionDtID = entity.TransactionDtID;
                var param = glTransactionID + "|" + glTransactionDtID;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryEditRevenueSharingCtl.ascx');
                openUserControlPopup(url, param, 'Edit Pembayaran Jasa Medis', 600, 400);
            } else if (entity.GCTreasuryGroup == Constant.TreasuryGroup.SETORAN_KASIR && entity.ReferenceNo != null && entity.ReferenceNo != "") {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glTransactionDtID = entity.TransactionDtID;
                var param = glTransactionID + "|" + glTransactionDtID;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryEditSetoranKasirCtl.ascx');
                openUserControlPopup(url, param, 'Edit Setoran Kasir', 600, 400);
            } else if (entity.GCTreasuryGroup == Constant.TreasuryGroup.SETORAN_KASIR_REKONSILIASI && entity.ReferenceNo != null && entity.ReferenceNo != "") {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glTransactionDtID = entity.TransactionDtID;
                var param = glTransactionID + "|" + glTransactionDtID;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryEditSetoranKasirRekonsiliasiCtl.ascx');
                openUserControlPopup(url, param, 'Edit Setoran Kasir Rekonsiliasi', 600, 400);
            } else if (entity.GCTreasuryGroup == Constant.TreasuryGroup.AR_RECEIVING) {
                //#region ARReceiving
                ...
                $('#<%=hdnCashFlowTypeID.ClientID %>').val(entity.CashFlowTypeID);
                $('#<%=txtCashFlowTypeCode.ClientID %>').val(entity.CashFlowTypeCode);
                $('#<%=txtCashFlowTypeName.ClientID %>').val(entity.CashFlowTypeName);
                ...
                $('#<%=hdnGLARReceivingID.ClientID %>').val(entity.GLARPaymentID);
                $('#<%=hdnARPaymentMethod.ClientID %>').val(entity.GCARPaymentMethod);
                $('#<%=txtARPaymentMethod.ClientID %>').val(entity.ARPaymentMethod);
                $('#<%=hdnARBank.ClientID %>').val(entity.BankID);
                $('#<%=txtARBank.ClientID %>').val(entity.BankName);
                ...
                if (displayOrder == 1) {
                    ...
                    $('#lblGLAccount').attr('class', 'lblDisabled');
                    $('#<%:txtGLAccountCode.ClientID %>').attr('readonly', 'readonly');
                    $('#btnGLAccount').attr('enabled', 'false');
                    ...
                    $('#<%:lblDepartment.ClientID %>').attr('class', 'lblDisabled');
                    $('#<%:txtDepartmentID.ClientID %>').attr('readonly', 'readonly');

                    $('#<%:lblServiceUnit.ClientID %>').attr('class', 'lblDisabled');
                    $('#<%:txtServiceUnitCode.ClientID %>').attr('readonly', 'readonly');

                    $('#lblRevenueCostCenter').attr('class', 'lblDisabled');
                    $('#<%:txtRevenueCostCenterCode.ClientID %>').attr('readonly', 'readonly');

                    $('#lblCustomerGroup').attr('class', 'lblDisabled');
                    $('#<%:txtCustomerGroupCode.ClientID %>').attr('readonly', 'readonly');
                    ...
                    $('#<%:txtMedicalNo.ClientID %>').attr('readonly', 'readonly');

                    $('#lblARPaymentMethod').attr('class', 'lblDisabled');
                    $('#<%:txtARPaymentMethod.ClientID %>').attr('readonly', 'readonly');

                    $('#lblParamedicMaster').attr('class', 'lblDisabled');
                    $('#<%:txtParamedicCode.ClientID %>').attr('readonly', 'readonly');

                    $('#lblVoucherAmount').attr('class', 'lblDisabled');
                    cboPosition.SetEnabled(false);
                    $('#<%:txtVoucherAmount.ClientID %>').attr('readonly', 'readonly');

                    $('#<%:txtDisplayOrder.ClientID %>').attr('readonly', 'readonly');
                }
                else {
                    cboHealthcare.SetEnabled(true);
        ...
        $('#lblJournalNo.lblLink').live('click', function () {
            ...
            var treasuryAccount = $('#<%=hdnGLAccountTreasuryID.ClientID %>').val();
            if (treasuryAccount != "" && treasuryAccount != "0") {
                filterExpression += " AND GLTransactionID IN (SELECT GLTransactionID FROM GLTransactionDt WHERE IsDeleted = 0 AND GCItemDetailStatus != 'X121^999' AND GLAccount = " + treasuryAccount + ")";
            }

            openSearchDialog('treasurytransactionhdcustom', filterExpression, function (value) {
        ...
        function onCboTransactionCodeValueChanged(s) {
            ...
            $('#<%=hdnTreasuryType.ClientID %>').val('');
            $('#<%=txtTreasuryType.ClientID %>').val('');
            $('#<%=hdnTreasuryGroup.ClientID %>').val('');
            $('#<%=txtTreasuryGroup.ClientID %>').val('');
        }

        $('#btnGLAccountTreasury').live('click', function () {
            if ($(this).attr('enabled') == null) {
                var accountID = $('#<%=hdnGLAccountTreasuryID.ClientID %>').val();
        ...
        //#region Treasury Type
        function onTreasuryTypeFilterExpression() {
            var filterExpression = "ParentID = 'X291' AND IsDeleted = 0 AND IsActive = 1 AND TagProperty = '1'";
            filterExpression += " AND StandardCodeID IN (SELECT ttm.GCTreasuryType FROM TreasuryTransactionMapping ttm WITH(NOLOCK) WHERE ttm.TransactionCode = '" + cboTransactionCode.GetValue() + "' AND ttm.IsDeleted = 0)";

            return filterExpression;
        }

        $('#<%=lblTreasuryType.ClientID %>.lblLink').live('click', function () {
            var transactionCode = cboTransactionCode.GetValue();
            if (transactionCode != null && transactionCode != "") {
                openSearchDialog('stdcode', onTreasuryTypeFilterExpression(), function (value) {
                    onTreasuryTypeChanged(value);
                });
            } else {
                alert("Harap pilih Sumber Data terlebih dahulu.");
            }
        });

        $('#<%=txtTreasuryType.ClientID %>').change(function () {
            onTreasuryTypeChanged($(this).val());
        });

        function onTreasuryTypeChanged(value) {
            var filterExpression = onTreasuryTypeFilterExpression() + " AND StandardCodeID LIKE '%^" + value + "'";
            Methods.getObject('GetStandardCodeList', filterExpression, function (result) {
                if (result != null) {
                    $('#<%=hdnTreasuryType.ClientID %>').val(result.StandardCodeID);
                    $('#<%=txtTreasuryType.ClientID %>').val(result.StandardCodeName);
                }
                else {
                    $('#<%=hdnTreasuryType.ClientID %>').val('');
                    $('#<%=txtTreasuryType.ClientID %>').val('');
        ...
        //#region Treasury Group
        function onTreasuryGroupFilterExpression() {
            var filterExpression = "ParentID = 'X290' AND IsDeleted = 0 AND IsActive = 1 AND TagProperty = '1'";
            filterExpression += " AND StandardCodeID IN (SELECT ttm.GCTreasuryGroup FROM TreasuryTransactionMapping ttm WITH(NOLOCK) WHERE ttm.TransactionCode = '" + cboTransactionCode.GetValue() + "' AND ttm.GCTreasuryType = '" + $('#<%=hdnTreasuryType.ClientID %>').val() + "' AND ttm.IsDeleted = 0)";

            return filterExpression;
        }

        $('#<%=lblTreasuryGroup.ClientID %>.lblLink').live('click', function () {
            var transactionCode = cboTransactionCode.GetValue();
            var treasuryType = $('#<%=hdnTreasuryType.ClientID %>').val();
            if (transactionCode != null && transactionCode != "") {
                if (treasuryType != null && treasuryType != "") {
                    openSearchDialog('stdcode', onTreasuryGroupFilterExpression(), function (value) {
                        onTreasuryGroupChanged(value);
                    });
                } else {
        ...
        $('#<%=txtTreasuryGroup.ClientID %>').change(function () {
            onTreasuryGroupChanged($(this).val());
        });

        function onTreasuryGroupChanged(value) {
            var filterExpression = onTreasuryGroupFilterExpression() + " AND StandardCodeID LIKE '%^" + value + "'";
            Methods.getObject('GetStandardCodeList', filterExpression, function (result) {
                if (result != null) {
                    $('#<%=hdnTreasuryGroup.ClientID %>').val(result.StandardCodeID);
                    $('#<%=txtTreasuryGroup.ClientID %>').val(result.StandardCodeName);
                }
                else {
                    $('#<%=hdnTreasuryGroup.ClientID %>').val('');
                    $('#<%=txtTreasuryGroup.ClientID %>').val('');
        ...
        function onGetGLAccountTreasuryFilterExpression() {
            var transactionCode = cboTransactionCode.GetValue() != null ? cboTransactionCode.GetValue().toString() : "";
            var treasuryType = $('#<%=hdnTreasuryType.ClientID %>').val() != null ? $('#<%=hdnTreasuryType.ClientID %>').val() : "";
            var treasuryGroup = $('#<%=hdnTreasuryGroup.ClientID %>').val() != null ? $('#<%=hdnTreasuryGroup.ClientID %>').val() : "";

            var filterExpression = "IsHeader = 0 AND IsDeleted = 0 AND IsUsedAsTreasury = 1";

            filterExpression += " AND GLAccountID IN (SELECT GLAccountID FROM UserRoleCOA WITH(NOLOCK) WHERE IsDeleted = 0 AND IsActive = 1 AND IsUsedAsTreasury = 1 AND RoleID IN (SELECT RoleID FROM UserInRole WITH(NOLOCK) WHERE UserID = " + $('#<%=hdnUserLoginID.ClientID %>').val() + "))";

            filterExpression += " AND GLAccountID IN (SELECT GLAccountID FROM TreasuryTransactionMapping WITH(NOLOCK) WHERE IsDeleted = 0 AND TransactionCode = '" + transactionCode + "' AND GCTreasuryType = '" + treasuryType + "' AND GCTreasuryGroup = '" + treasuryGroup + "')";
        ...
        $('#<%=lblGLAccountTreasury.ClientID %>.lblLink').live('click', function () {
            ...
            if (transactionCode != "" && treasuryType != "" && treasuryGroup != "") {
                ...
                displayMessageBox('MEDINFRAS', "Silahkan pilih Sumber Data, Tipe Transaksi, dan Sumber Transaksi terlebih dahulu.");
            }
        });
        ...
        function ontxtGLAccountTreasuryCodeChanged(value) {
            ...
            Methods.getObject('GetvChartOfAccountList', filterExpression, function (result) {
                if (result != null) {
                    ...
                    $('#<%=hdnGLAccountTreasuryPosition.ClientID %>').val(result.Position);

                    $('#btnGLAccountTreasury').removeAttr('enabled');
                }
                else {
                    $('#<%=hdnGLAccountTreasuryID.ClientID %>').val('');
                    $('#<%=txtGLAccountCodeTreasury.ClientID %>').val('');
                    $('#<%=txtGLAccountNameTreasury.ClientID %>').val('');
                    $('#<%=hdnGLAccountTreasuryPosition.ClientID %>').val('');

                    $('#btnGLAccountTreasury').attr('enabled', 'false');
                }
            });
        }
        //#endregion

        //#region Cash Flow Type (Tipe Arus Kas)
        function onGetCashFlowTypeFilterExpression() {
            var filterExpression = "IsHeader = 0 AND IsDeleted = 0";
            return filterExpression;
        }

        $('#<%=lblCashFlowType.ClientID %>.lblLink').live('click', function () {
            openSearchDialog('cashflowtype', onGetCashFlowTypeFilterExpression(), function (value) {
                $('#<%=txtCashFlowTypeCode.ClientID %>').val(value);
                ontxtCashFlowTypeCodeChanged(value);
            });
        });

        $('#<%=txtCashFlowTypeCode.ClientID %>').live('change', function () {
            ontxtCashFlowTypeCodeChanged($(this).val());
        });

        function ontxtCashFlowTypeCodeChanged(value) {
            var filterExpression = onGetCashFlowTypeFilterExpression() + " AND CashFlowTypeCode = '" + value + "'";
            Methods.getObject('GetvCashFlowTypeList', filterExpression, function (result) {
                if (result != null) {
                    $('#<%=hdnCashFlowTypeID.ClientID %>').val(result.CashFlowTypeID);
                    $('#<%=txtCashFlowTypeName.ClientID %>').val(result.CashFlowTypeName);
                }
                else {
                    $('#<%=hdnCashFlowTypeID.ClientID %>').val('');
                    $('#<%=txtCashFlowTypeCode.ClientID %>').val('');
                    $('#<%=txtCashFlowTypeName.ClientID %>').val('');
                }
            });
        }
        //#endregion

        //#region Copy Supplier Payment
        $('#lblCopySupplierPayment').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glAccountTreasuryID = $('#<%=hdnGLAccountTreasuryID.ClientID %>').val();
                var treasuryType = $('#<%=hdnTreasuryType.ClientID %>').val();
                ...
                var cashFlowTypeID = $('#<%=hdnCashFlowTypeID.ClientID %>').val();
                var txtJournalDate = $('#<%=txtJournalDate.ClientID %>').val();
                var journalDate = txtJournalDate.substring(10, 6) + txtJournalDate.substring(5, 3) + txtJournalDate.substring(0, 2);
                var param = glTransactionID + "|" + glAccountTreasuryID + "|" + treasuryType + "|" + deptID + "|" + srvUnitID + "|" + bpID + '|' + cashFlowTypeID + '|' + journalDate;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryCopySupplierPaymentCtl.ascx');
                openUserControlPopup(url, param, 'Pilih Pembayaran Hutang', 1200, 600);
            }
        });
        //#endregion

        //#region Copy Direct Purchase
        $('#lblCopyDirectPurchase').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                showLoadingPanel();
                ...
                if (coaDirectPurchase != "0" && coaDirectPurchase != "") {
                    ...
                    var bpID = $('#<%=hdnDefaultBusinessPartnerID.ClientID %>').val();
                    var cashFlowTypeID = $('#<%=hdnCashFlowTypeID.ClientID %>').val();
                    var param = glTransactionID + "|" + glAccountTreasuryID + "|" + treasuryType + "|" + deptID + "|" + srvUnitID + "|" + bpID + '|' + cashFlowTypeID + "|" + coaDirectPurchase;
                    var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryCopyDirectPurchaseCtl.ascx');
                    openUserControlPopup(url, param, 'Pilih Pembelian Tunai', 1200, 600);
                } else {
        ...
        //#region Copy Revenue Sharing
        $('#lblCopyRevenueSharing').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                showLoadingPanel();
                var coaAPRevenueSharing = $('#<%=hdnCOAAPRevenueSharing.ClientID %>').val();
                if (coaAPRevenueSharing != "0" && coaAPRevenueSharing != "") {
                    var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                    var glAccountTreasuryID = $('#<%=hdnGLAccountTreasuryID.ClientID %>').val();
                    var treasuryType = $('#<%=hdnTreasuryType.ClientID %>').val();
                    var deptID = $('#<%=hdnDepartmentID.ClientID %>').val();
                    ...
                    var bpID = $('#<%=hdnDefaultBusinessPartnerID.ClientID %>').val();
                    var cashFlowTypeID = $('#<%=hdnCashFlowTypeID.ClientID %>').val();
                    var param = glTransactionID + "|" + glAccountTreasuryID + "|" + treasuryType + "|" + deptID + "|" + srvUnitID + "|" + bpID + '|' + cashFlowTypeID + "|" + coaAPRevenueSharing;
                    var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryCopyRevenueSharingCtl.ascx');
                    openUserControlPopup(url, param, 'Pilih Pembayaran Jasa Medis', 1200, 600);
                } else {
                    displayErrorMessageBox('WARNING', "COA Pembayaran Jasa Medis (coaAPDoctorFee) belum di-setting di L1 - General Sistem Perkiraan !");
                    hideLoadingPanel();
                }
            }
        });
        ...
        //#region Copy Setoran Kasir
        $('#lblCopyUserPatientPaymentBalance').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glAccountTreasuryID = $('#<%=hdnGLAccountTreasuryID.ClientID %>').val();
                ...
                var bpID = $('#<%=hdnDefaultBusinessPartnerID.ClientID %>').val();
                var cashFlowTypeID = $('#<%=hdnCashFlowTypeID.ClientID %>').val();
                var param = glTransactionID + "|" + glAccountTreasuryID + "|" + treasuryType + "|" + deptID + "|" + srvUnitID + "|" + bpID + '|' + cashFlowTypeID;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryCopyUserPatientPaymentBalanceCtl.ascx');
                openUserControlPopup(url, param, 'Pilih Setoran Kasir - per Kasir', 1200, 600);
            }
        });
        //#endregion

        //#region Copy Setoran Kasir Rekonsiliasi
        $('#lblCopyPaymentDetailReconciliation').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                showLoadingPanel();
                var glTransactionID = $('#<%=hdnID.ClientID %>').val();
                var glAccountTreasuryID = $('#<%=hdnGLAccountTreasuryID.ClientID %>').val();
                ...
                var cashFlowTypeID = $('#<%=hdnCashFlowTypeID.ClientID %>').val();
                var param = glTransactionID + "|" + glAccountTreasuryID + "|" + treasuryType + "|" + deptID + "|" + srvUnitID + "|" + bpID + '|' + cashFlowTypeID;
                var url = ResolveUrl('~/Program/Treasury/TreasuryTransaction/TreasuryCopyPaymentDetailReconciliationCtl.ascx');
                openUserControlPopup(url, param, 'Pilih Setoran Kasir Rekonsiliasi', 1200, 600);
            }
        });
        //#endregion
        ...
        function onGetGLAccountFilterExpression() {
            var filterExpression = "IsHeader = 0 AND IsDeleted = 0 AND IsActive = 1 AND GLAccountID != '" + $('#<%=hdnGLAccountTreasuryID.ClientID %>').val() + "'";
            ...
            Methods.getObject('GetvChartOfAccountList', filterExpression, function (result) {
                if (result != null) {
                    ...
                    if (result.IsUsingDocumentControl == "1") {
                        ...
                        if ($('#<%=hdnIsReferenceNoGeneratedBySystem.ClientID %>').val() == "0") {
                            $('#<%=txtReferenceNo.ClientID %>').removeAttr("readonly");
                        } else {
                            $('#<%=txtReferenceNo.ClientID %>').attr("readonly", "readonly");
                        }
        ...
        //#region AR Payment Method
        function onGetARPaymentMethodFilterExpression() {
            var filterExpression = "IsDeleted = 0 AND GLAccount = " + $('#<%=hdnGLAccountTreasuryID.ClientID %>').val();
            return filterExpression;
        }

        $('#lblARPaymentMethod.lblLink').live('click', function () {
            openSearchDialog('glarpayment', onGetARPaymentMethodFilterExpression(), function (value) {
                $('#<%=hdnGLARReceivingID.ClientID %>').val(value);
                ontxtPaymentMethodChanged(value);
            });
        });

        function ontxtPaymentMethodChanged(value) {
            var filterExpression = onGetARPaymentMethodFilterExpression() + " AND ID = " + $('#<%=hdnGLARReceivingID.ClientID %>').val();
            Methods.getObject('GetvGLARPaymentList', filterExpression, function (result) {
                if (result != null) {
                    $('#<%=hdnARPaymentMethod.ClientID %>').val(result.GCARPaymentMethod);
                    $('#<%=txtARPaymentMethod.ClientID %>').val(result.ARPaymentMethod);
                    $('#<%=hdnARBank.ClientID %>').val(result.BankID);
                    $('#<%=txtARBank.ClientID %>').val(result.BankName);
                }
                else {
                    $('#<%=hdnGLARReceivingID.ClientID %>').val('');
                    $('#<%=hdnARPaymentMethod.ClientID %>').val('');
        ...
        function onGetDocumentFilterExpression() {
            var filterExpression = "ReferenceNo IS NOT NULL AND BalanceEND != 0 AND ReferenceNo != '' AND GLAccount = " + $('#<%=hdnGLAccountID.ClientID %>').val();
            return filterExpression;
        }

        $('#lblDocument').live('click', function () {
            if ($('#<%=hdnIsReferenceNoGeneratedBySystem.ClientID %>').val() == "1") {
                displayErrorMessageBox('ERROR', "Tidak bisa mengubah nomor referensi karena hasil salin/generate sistem.");
            } else {
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if (transactionID == '' || transactionID == '0') {
                ...
                if (code == "FN-00053" || code == "FN-00055" || code == "FN-00186" || code == "FN-00209" || code == "FN-00211" || code == "FN-00230") {
                    ...
                    if (status == "<%=GetGCTransactionStatusOpen() %>") {
                        ...
                        if (code == "FN-00020" || code == "FN-00051" || code == "FN-00049" || code == "FN-00050" || code == "FN-00054" || code == "FN-00187" || code == "FN-00210" || code == "FN-00229") {
                            filterExpression.text = 'GLTransactionID = ' + transactionID;
                            return true;
                        } else {
        ...
        function onBeforeLoadRightPanelContent(code) {
            ...
            if (transactionID == '' || transactionID == '0') {
                ...
                if (code == 'changeBusinessPartners') {
    ...
    <input type="hidden" id="hdnIsARReceivingCanDeleteOrVoid" runat="server" value="" />
    ...
    <input type="hidden" id="hdnCOAAPRevenueSharing" runat="server" value="" />
    <input type="hidden" id="hdnCOAKontraPiutangID" runat="server" value="" />
    <input type="hidden" id="hdnCOAKontraPiutangNo" runat="server" value="" />
    <input type="hidden" id="hdnCOAKontraPiutangName" runat="server" value="" />
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblLink lblMandatory" id="lblTreasuryType" runat="server">
                                <%=GetLabel("Tipe Transaksi")%></label>
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtTreasuryType" Width="100%" ReadOnly="true" />
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblLink lblMandatory" id="lblTreasuryGroup" runat="server">
                                <%=GetLabel("Sumber Transaksi")%></label>
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtTreasuryGroup" Width="100%" ReadOnly="true" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="button" id="btnGLAccountTreasury" value="..." title="Lihat Informasi Mutasi Detail untuk COA ini."
                                style="width: 100%;" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                            <label class="lblLink lblMandatory" id="lblCashFlowType" runat="server">
                                <%=GetLabel("Tipe Arus Kas")%></label>
                        </td>
                        <td id="td5" runat="server">
                            <input type="hidden" id="hdnCashFlowTypeID" runat="server" />
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <colgroup>
                                    <col style="width: 100px" />
                                    <col style="width: 3px" />
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtCashFlowTypeCode" Width="100%" />
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtCashFlowTypeName" Width="100%" ReadOnly="true" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td style="display: none;" id="td6" runat="server">
                            <asp:TextBox runat="server" ID="TextBox3" Width="100%" />
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <tr>
                                <td style="vertical-align: top">
                                    <table style="width: 100%">
                                        ...
                                        <tr style="padding-top: 2px; padding-left: 0px" id="trARPaymentMethod" runat="server">
                                            <td class="tdLabel">
                                                <label class="lblLink lblMandatory" id="lblARPaymentMethod">
                                                    <%=GetLabel("Metode Pembayaran")%></label>
                                            </td>
                                            <td>
                                                <input type="hidden" id="hdnGLARReceivingID" runat="server" />
                                                <input type="hidden" id="hdnARPaymentMethod" runat="server" />
                                                <input type="hidden" id="hdnARBank" runat="server" />
                                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                                    <colgroup>
                                                        <col style="width: 120px" />
                                                        <col style="width: 3px" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtARPaymentMethod" ReadOnly="true" Width="100%" />
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtARBank" ReadOnly="true" Width="100%" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr style="padding-top: 2px; padding-left: 0px; display: none" id="trDocument" runat="server">
                                            ...
                                            <td>
                                                <input type="hidden" id="hdnIsReferenceNoGeneratedBySystem" runat="server" />
                                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                                    <colgroup>
                                                        <col style="width: 250px" />
                                                        <col style="width: 3px" />
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px">
                                            <ItemTemplate>
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <img class="imgEdit <%# IsEditable() == "0" ? "imgDisabled" : "imgLink"%>"
                                                                title='<%=GetLabel("Edit")%>' src='<%# IsEditable() == "0" ? ResolveUrl("~/Libs/Images/Button/edit_disabled.png") : ResolveUrl("~/Libs/Images/Button/edit.png")%>'
                                                                alt="" />
                                                        </td>
                                                        <td style="width: 1px">
                                                            &nbsp;
                                                        ...
                                                        <td>
                                                            <img class="imgDelete <%# IsEditable() == "0" || Eval("DisplayOrder").ToString() == "1" ? "imgDisabled" : "imgLink"%>"
                                                                title='<%=GetLabel("Delete")%>' src='<%# IsEditable() == "0" || Eval("DisplayOrder").ToString() == "1" ? ResolveUrl("~/Libs/Images/Button/delete_disabled.png") : ResolveUrl("~/Libs/Images/Button/delete.png")%>'
                                                                alt="" />
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <input type="hidden" value="<%#:Eval("GLARPaymentID") %>" bindingfield="GLARPaymentID" />
                                                <input type="hidden" value="<%#:Eval("GCARPaymentMethod") %>" bindingfield="GCARPaymentMethod" />
                                                <input type="hidden" value="<%#:Eval("ARPaymentMethod") %>" bindingfield="ARPaymentMethod" />
                                                ...
                                                <input type="hidden" value="<%#:Eval("IsReferenceNoGeneratedBySystem") %>" bindingfield="IsReferenceNoGeneratedBySystem" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                ...
                <div style="width: 100%; text-align: center">
                    <div style="width: 100%; text-align: center">
                        <span class="lblLink" id="lblAddData" style="margin-right: 300px; margin-left: 300px">
                            <%= GetLabel("Tambah Data")%></span><span class="lblLink" id="lblCopySupplierPayment"
                                style="margin-right: 300px; margin-left: 300px">
                                <%= GetLabel("Salin Pembayaran Hutang")%></span> <span class="lblLink" id="lblCopyDirectPurchase"
                                    style="margin-right: 300px; margin-left: 300px">
                                    <%= GetLabel("Salin Pembelian Tunai")%></span><span class="lblLink" id="lblCopyRevenueSharing"
                                        style="margin-right: 300px; margin-left: 300px">
                                        <%= GetLabel("Salin Pembayaran Jasa Medis")%></span> <span class="lblLink" id="lblCopyUserPatientPaymentBalance"
                                            style="margin-right: 300px; margin-left: 300px">
                                            <%= GetLabel("Salin Setoran Kasir per Kasir")%></span><span class="lblLink" id="lblCopyPaymentDetailReconciliation"
                                                style="margin-right: 300px; margin-left: 300px; display: none">
                                                <%= GetLabel("Salin Setoran Rekonsiliasi")%></span>
                    </div>
                </div>
                <div>
                    <table width="100%">
