<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TreasuryEditSupplierPaymentCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.TreasuryEditSupplierPaymentCtl" %>
