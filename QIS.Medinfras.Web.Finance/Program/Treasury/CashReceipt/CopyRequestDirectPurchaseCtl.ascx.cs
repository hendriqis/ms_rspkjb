...
{
    public partial class CopyRequestDirectPurchaseCtl : BaseEntryPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            hdnCOADirectPurchaseCtl.Value = paramList[5];
        ...
        {
            string filterExpression = string.Format("GCTransactionStatus = '{0}' AND GLTransactionIDRequest IS NULL AND GLTransactionDtIDRequest IS NULL AND GLTransactionID IS NULL AND GLTransactionDtID IS NULL", Constant.TransactionStatus.APPROVED);
            ...
            List<vDirectPurchaseHd> lstEntity = BusinessLayer.GetvDirectPurchaseHdList(filterExpression, int.MaxValue, 1, "PurchaseDate, DirectPurchaseNo");
        ...
        private void ControlToEntity(IDbContext ctx, List<GLTransactionDt> lstEntity)
        {
            ...
            foreach (vDirectPurchaseHd entity in lstHd)
            {
                ...
                directPurchaseHd.GLTransactionIDRequest = treasuryHd.GLTransactionID;
                directPurchaseHd.GLTransactionDtIDRequest = glDtID;
