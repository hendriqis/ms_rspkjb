<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyRealizationDirectPurchaseCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.CopyRealizationDirectPurchaseCtl" %>
...
<script type="text/javascript" id="dxss_CopyRealizationDirectPurchaseCtl">
    ...
    function getCheckedDirectPurchase() {
        ...
        $('.chkSelectDirectPurchase input').each(function () {
            if ($(this).is(':checked')) {
                ...
                var txtDebitAmount = parseFloat($tr.find('.txtDebitAmount').val().replace(",", ""));
                var txtCreditAmount = parseFloat($tr.find('.txtCreditAmount').val().replace(",", ""));
