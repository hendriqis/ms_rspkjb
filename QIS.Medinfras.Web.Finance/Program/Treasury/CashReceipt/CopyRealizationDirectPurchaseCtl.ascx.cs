...
{
    public partial class CopyRealizationDirectPurchaseCtl : BaseEntryPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("GCTransactionStatus = '{0}' AND GLTransactionIDRequest IS NOT NULL AND GLTransactionDtIDRequest IS NOT NULL AND GLTransactionID IS NULL AND GLTransactionDtID IS NULL", Constant.TransactionStatus.APPROVED);
