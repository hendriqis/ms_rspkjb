<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CopyRequestDirectPurchaseCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.CopyRequestDirectPurchaseCtl" %>
...
<script type="text/javascript" id="dxss_CopyRequestDirectPurchaseCtl">
