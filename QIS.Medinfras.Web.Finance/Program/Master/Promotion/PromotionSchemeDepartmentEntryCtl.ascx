<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PromotionSchemeDepartmentEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.PromotionSchemeDepartmentEntryCtl" %>
...
<script type="text/javascript" id="dxss_promotionTypeDepartmentEntryCtl">
    ...
    //#region Department
    function onGetDepartmentCodeFilterExpression() {
        var filterExpression = "DepartmentID NOT IN (SELECT DepartmentID FROM PromotionSchemeDepartment WHERE PromotionSchemeID = " + $('#<%=hdnPromotionSchemeID.ClientID %>').val() + " AND IsDeleted = 0) AND IsActive = 1 AND IsHasRegistration = 1";
        return filterExpression;
    }

    $('#lblDepartment.lblLink').click(function () {
        openSearchDialog('department', onGetDepartmentCodeFilterExpression(), function (value) {
    ...
    function onTxtDepartmentCodeChanged(value) {
        var filterExpression = onGetDepartmentCodeFilterExpression() + " AND DepartmentID = '" + value + "'";
                                    ...
                                    <table cellpadding="1" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="padding-bottom: 2px">
                                                <div class="lblComponent">
                                                    <%=GetLabel("Tindakan / Pelayanan")%></div>
                                            </td>
                                            <td colspan="2" style="padding-bottom: 2px">
                                                <div class="lblComponent">
                                                    <%=GetLabel("Obat dan Persediaan Medis")%></div>
                                            </td>
                                            <td colspan="2" style="padding-bottom: 2px">
                                                <div class="lblComponent">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <asp:CheckBox ID="chkIsUsePromotionPrice1" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtTariff1" CssClass="txtCurrency" runat="server" Width="100%" />
                                            </td>
                                            <td style="text-align: center">
                                                <asp:CheckBox ID="chkIsUsePromotionPrice2" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtTariff2" CssClass="txtCurrency" runat="server" Width="100%" />
                                            </td>
                                            <td style="text-align: center">
                                                <asp:CheckBox ID="chkIsUsePromotionPrice3" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtTariff3" CssClass="txtCurrency" runat="server" Width="100%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTariff1Comp1" CssClass="txtCurrency" runat="server" Width="100%" />
                                            </td>
                                            <td>
                                                &nbsp
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTariff1Comp2" CssClass="txtCurrency" runat="server" Width="100%" />
                                            </td>
                                            <td>
                                                &nbsp
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTariff1Comp3" CssClass="txtCurrency" runat="server" Width="100%" />
                                            </td>
                                            <td>
                                                &nbsp
                                            </td>
