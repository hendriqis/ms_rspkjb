...
{
    public partial class CustomerItemEntryCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvCustomerItemRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, 8);
            }

            List<vCustomerItem> lstEntity = BusinessLayer.GetvCustomerItemList(filterExpression, 8, pageIndex, "ItemName1 ASC");
        ...
        private void ControlToEntity(CustomerItem entity)
        {
            entity.ItemID = Convert.ToInt32(hdnItemID.Value);
            entity.CustomerItemCode = txtCustomerItemCode.Text;
            entity.CustomerItemName = txtCustomerItemName.Text;
        ...
        private bool OnSaveEditRecord(ref string errMessage)
        {
            ...
            try
            {
                CustomerItem entity = BusinessLayer.GetCustomerItem(Convert.ToInt32(hdnID.Value));
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateCustomerItem(entity);
            }
            catch (Exception ex)
            {
                result = false;
