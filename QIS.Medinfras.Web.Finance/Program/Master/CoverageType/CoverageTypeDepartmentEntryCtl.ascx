<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeDepartmentEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.CoverageTypeDepartmentEntryCtl" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_CoverageTypeDepartmentEntryCtl">

    //#region Department
    function onGetCoverageTypeDepartmentCodeFilterExpression() {
        var filterExpression = "DepartmentID NOT IN (SELECT DepartmentID FROM CoverageTypeDepartment WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeIDCtlDept.ClientID %>').val() + " AND IsDeleted = 0) AND IsActive = 1 AND IsHasRegistration = 1";
        return filterExpression;
    }

    $('#lblDepartment.lblLink').click(function () {
        openSearchDialog('department', onGetCoverageTypeDepartmentCodeFilterExpression(), function (value) {
            $('#<%=txtDepartmentCode.ClientID %>').val(value);
            onTxtCoverageTypeDepartmentCodeChanged(value);
        });
    });

    $('#<%=txtDepartmentCode.ClientID %>').change(function () {
        onTxtCoverageTypeDepartmentCodeChanged($(this).val());
    });

    function onTxtCoverageTypeDepartmentCodeChanged(value) {
        var filterExpression = onGetCoverageTypeDepartmentCodeFilterExpression() + " AND DepartmentID = '" + value + "'";
    ...
    $('#lblEntryPopupAddData').live('click', function () {
        ...
        $('#<%=chkIsDiscount1UsedComp.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscount1UsedComp.ClientID %>').removeAttr('disabled');
        $('#<%=chkIsDiscountInPercentage1.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage1.ClientID %>').removeAttr('disabled');
        $('#<%=txtDiscountAmount1.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage1Comp1.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage1Comp1.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount1Comp1.ClientID %>').attr('readonly', 'readonly');
        $('#<%=txtDiscountAmount1Comp1.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage1Comp2.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage1Comp2.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount1Comp2.ClientID %>').attr('readonly', 'readonly');
        $('#<%=txtDiscountAmount1Comp2.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage1Comp3.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage1Comp3.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount1Comp3.ClientID %>').attr('readonly', 'readonly');
        ...
        $('#<%=chkIsDiscount2UsedComp.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscount2UsedComp.ClientID %>').removeAttr('disabled');
        $('#<%=chkIsDiscountInPercentage2.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage2.ClientID %>').removeAttr('disabled');
        $('#<%=txtDiscountAmount2.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage2Comp1.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage2Comp1.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount2Comp1.ClientID %>').attr('readonly', 'readonly');
        $('#<%=txtDiscountAmount2Comp1.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage2Comp2.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage2Comp2.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount2Comp2.ClientID %>').attr('readonly', 'readonly');
        $('#<%=txtDiscountAmount2Comp2.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage2Comp3.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage2Comp3.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount2Comp3.ClientID %>').attr('readonly', 'readonly');
        ...
        $('#<%=chkIsDiscount3UsedComp.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscount3UsedComp.ClientID %>').removeAttr('disabled');
        $('#<%=chkIsDiscountInPercentage3.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage3.ClientID %>').removeAttr('disabled');
        $('#<%=txtDiscountAmount3.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage3Comp1.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage3Comp1.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount3Comp1.ClientID %>').attr('readonly', 'readonly');
        $('#<%=txtDiscountAmount3Comp1.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage3Comp2.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage3Comp2.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount3Comp2.ClientID %>').attr('readonly', 'readonly');
        $('#<%=txtDiscountAmount3Comp2.ClientID %>').val('0').trigger('changeValue');
        $('#<%=chkIsDiscountInPercentage3Comp3.ClientID %>').prop('checked', false);
        $('#<%=chkIsDiscountInPercentage3Comp3.ClientID %>').attr("disabled", "true");
        $('#<%=txtDiscountAmount3Comp3.ClientID %>').attr('readonly', 'readonly');
    ...
    $('.imgEdit.imgLink').live('click', function () {
        $row = $(this).closest('tr').parent().closest('tr');
        var ID = $row.find('.hdnID').val();
        var departmentID = $row.find('.hdnDepartmentID').val();
        var departmentName = $row.find('.tdDepartmentName').html().trim();

        var markupAmount1 = $row.find('.tdMarkupAmount1').html();
        var discountAmount1 = $row.find('.tdDiscountAmount1').html();
        var isDiscount1UsedComp = $row.find('.IsDiscount1UsedComp').val() == "True" ? true : false;
        ...
        var isDiscount2UsedComp = $row.find('.IsDiscount2UsedComp').val() == "True" ? true : false;
        ...
        var isDiscount3UsedComp = $row.find('.IsDiscount3UsedComp').val() == "True" ? true : false;
        ...
        $('#<%=hdnID.ClientID %>').val(ID);
        $('#<%=txtDepartmentCode.ClientID %>').val(departmentID);
        $('#<%=txtDepartmentName.ClientID %>').val(departmentName);

        $('#<%=chkIsMarkupInPercentage1.ClientID %>').prop('checked', markupAmount1.indexOf("%") > -1);
        $('#<%=txtMarkupAmount1.ClientID %>').val(markupAmount1.replace('%', '').replace(/,/g, '')).trigger('changeValue');
        $('#<%=chkIsDiscount1UsedComp.ClientID %>').prop('checked', isDiscount1UsedComp);
        $('#<%=chkIsDiscount1UsedComp.ClientID %>').change();
        ...
        $('#<%=txtMarkupAmount2.ClientID %>').val(markupAmount2.replace('%', '').replace(/,/g, '')).trigger('changeValue');
        $('#<%=chkIsDiscount2UsedComp.ClientID %>').prop('checked', isDiscount2UsedComp);
        $('#<%=chkIsDiscount2UsedComp.ClientID %>').change();
        ...
        $('#<%=txtMarkupAmount3.ClientID %>').val(markupAmount3.replace('%', '').replace(/,/g, '')).trigger('changeValue');
        $('#<%=chkIsDiscount3UsedComp.ClientID %>').prop('checked', isDiscount3UsedComp);
        $('#<%=chkIsDiscount3UsedComp.ClientID %>').change();
    ...
    $('#<%=chkIsDiscountInPercentage1.ClientID %>').live('change', function () {
        if ($(this).is(':checked')) {
            $('#<%=chkIsDiscount1UsedComp.ClientID %>').attr("disabled", "true");
        }
        else {
            $('#<%=chkIsDiscount1UsedComp.ClientID %>').removeAttr('disabled');
        }
    ...
    $('#<%=chkIsDiscountInPercentage2.ClientID %>').live('change', function () {
        if ($(this).is(':checked')) {
            $('#<%=chkIsDiscount2UsedComp.ClientID %>').attr("disabled", "true");
        }
        else {
            $('#<%=chkIsDiscount2UsedComp.ClientID %>').removeAttr('disabled');
        }
    ...
    $('#<%=chkIsDiscountInPercentage3.ClientID %>').live('change', function () {
        if ($(this).is(':checked')) {
            $('#<%=chkIsDiscount3UsedComp.ClientID %>').attr("disabled", "true");
        }
        else {
            $('#<%=chkIsDiscount3UsedComp.ClientID %>').removeAttr('disabled');
        }
    ...
    $('#<%=chkIsDiscount1UsedComp.ClientID %>').live('change', function () {
        if ($(this).is(':checked')) {
            $('#<%=chkIsDiscountInPercentage1.ClientID %>').attr("disabled", "true");
            $('#<%=txtDiscountAmount1.ClientID %>').attr('readonly', 'readonly');
            $('#<%=chkIsDiscountInPercentage1Comp1.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount1Comp1.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage1Comp2.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount1Comp2.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage1Comp3.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount1Comp3.ClientID %>').removeAttr('readonly');
        }
        else {
            $('#<%=chkIsDiscountInPercentage1.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount1.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage1Comp1.ClientID %>').attr("disabled", "true");
            $('#<%=txtDiscountAmount1Comp1.ClientID %>').attr('readonly', 'readonly');
            $('#<%=chkIsDiscountInPercentage1Comp2.ClientID %>').attr("disabled", "true");
            $('#<%=txtDiscountAmount1Comp2.ClientID %>').attr('readonly', 'readonly');
    ...
    $('#<%=chkIsDiscount2UsedComp.ClientID %>').live('change', function () {
        if ($(this).is(':checked')) {
            $('#<%=chkIsDiscountInPercentage2.ClientID %>').attr("disabled", "true");
            $('#<%=txtDiscountAmount2.ClientID %>').attr('readonly', 'readonly');
            $('#<%=chkIsDiscountInPercentage2Comp1.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount2Comp1.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage2Comp2.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount2Comp2.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage2Comp3.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount2Comp3.ClientID %>').removeAttr('readonly');
        }
        else {
            $('#<%=chkIsDiscountInPercentage2.ClientID %>').removeAttr('disabled');
    ...
    $('#<%=chkIsDiscount3UsedComp.ClientID %>').live('change', function () {
        if ($(this).is(':checked')) {
            $('#<%=chkIsDiscountInPercentage3.ClientID %>').attr("disabled", "true");
            $('#<%=txtDiscountAmount3.ClientID %>').attr('readonly', 'readonly');
            $('#<%=chkIsDiscountInPercentage3Comp1.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount3Comp1.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage3Comp2.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount3Comp2.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage3Comp3.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount3Comp3.ClientID %>').removeAttr('readonly');
        }
        else {
            $('#<%=chkIsDiscountInPercentage3.ClientID %>').removeAttr('disabled');
            $('#<%=txtDiscountAmount3.ClientID %>').removeAttr('readonly');
            $('#<%=chkIsDiscountInPercentage3Comp1.ClientID %>').attr("disabled", "true");
            $('#<%=txtDiscountAmount3Comp1.ClientID %>').attr('readonly', 'readonly');
            $('#<%=chkIsDiscountInPercentage3Comp2.ClientID %>').attr("disabled", "true");
            $('#<%=txtDiscountAmount3Comp2.ClientID %>').attr('readonly', 'readonly');
    ...
    //region validate
    $('#<%:txtMarkupAmount1.ClientID %>').live('change', function () {
        var value = $('#<%:txtMarkupAmount1.ClientID %>').val();
        var isPercentage = $('#<%:chkIsMarkupInPercentage1.ClientID %>').is(':checked');

        if (isNaN(value)) {
            $('#<%:txtMarkupAmount1.ClientID %>').val('0');
        }
    ...
    $('#<%:chkIsMarkupInPercentage1.ClientID %>').live('change', function () {
        var value = $('#<%:txtMarkupAmount1.ClientID %>').val();
        var token = ",";
        var newToken = "";
    ...
    $('#<%:txtMarkupAmount2.ClientID %>').live('change', function () {
        var value = $('#<%:txtMarkupAmount2.ClientID %>').val();
        var isPercentage = $('#<%:chkIsMarkupInPercentage2.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsMarkupInPercentage2.ClientID %>').live('change', function () {
        var value = $('#<%:txtMarkupAmount2.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtMarkupAmount3.ClientID %>').live('change', function () {
        var value = $('#<%:txtMarkupAmount3.ClientID %>').val();
        var isPercentage = $('#<%:chkIsMarkupInPercentage3.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsMarkupInPercentage3.ClientID %>').live('change', function () {
        var value = $('#<%:txtMarkupAmount3.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount1Comp1.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount1Comp1.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage1Comp1.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage1Comp1.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount1Comp1.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount2Comp1.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount2Comp1.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage2Comp1.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage2Comp1.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount2Comp1.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount3Comp1.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount3Comp1.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage3Comp1.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage3Comp1.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount3Comp1.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount1Comp2.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount1Comp2.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage1Comp2.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage1Comp2.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount1Comp2.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount2Comp2.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount2Comp2.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage2Comp2.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage2Comp2.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount2Comp2.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount3Comp2.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount3Comp2.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage3Comp2.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage3Comp2.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount3Comp2.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount1Comp3.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount1Comp3.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage1Comp3.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage1Comp3.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount1Comp3.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount2Comp3.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount2Comp3.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage2Comp3.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage2Comp3.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount2Comp3.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtDiscountAmount3Comp3.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount3Comp3.ClientID %>').val();
        var isPercentage = $('#<%:chkIsDiscountInPercentage3Comp3.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsDiscountInPercentage3Comp3.ClientID %>').live('change', function () {
        var value = $('#<%:txtDiscountAmount3Comp3.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtCoverageAmount1.ClientID %>').live('change', function () {
        var value = $('#<%:txtCoverageAmount1.ClientID %>').val();
        var isPercentage = $('#<%:chkIsCoverageInPercentage1.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsCoverageInPercentage1.ClientID %>').live('change', function () {
        var value = $('#<%:txtCoverageAmount1.ClientID %>').val().replace("/{,/g", "");
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
        var isPercentage = $('#<%:chkIsCoverageInPercentage1.ClientID %>').is(':checked');
    ...
    $('#<%:txtCoverageAmount2.ClientID %>').live('change', function () {
        var value = $('#<%:txtCoverageAmount2.ClientID %>').val();
        var isPercentage = $('#<%:chkIsCoverageInPercentage2.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsCoverageInPercentage2.ClientID %>').live('change', function () {
        var value = $('#<%:txtCoverageAmount2.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtCoverageAmount3.ClientID %>').live('change', function () {
        var value = $('#<%:txtCoverageAmount3.ClientID %>').val();
        var isPercentage = $('#<%:chkIsCoverageInPercentage3.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsCoverageInPercentage3.ClientID %>').live('change', function () {
        var value = $('#<%:txtCoverageAmount3.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtCashBackAmount1.ClientID %>').live('change', function () {
        var value = $('#<%:txtCashBackAmount1.ClientID %>').val();
        var isPercentage = $('#<%:chkIsCashBackInPercentage1.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsCashBackInPercentage1.ClientID %>').live('change', function () {
        var value = $('#<%:txtCashBackAmount1.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtCashBackAmount2.ClientID %>').live('change', function () {
        var value = $('#<%:txtCashBackAmount2.ClientID %>').val();
        var isPercentage = $('#<%:chkIsCashBackInPercentage2.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsCashBackInPercentage2.ClientID %>').live('change', function () {
        var value = $('#<%:txtCashBackAmount2.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
    ...
    $('#<%:txtCashBackAmount3.ClientID %>').live('change', function () {
        var value = $('#<%:txtCashBackAmount3.ClientID %>').val();
        var isPercentage = $('#<%:chkIsCashBackInPercentage3.ClientID %>').is(':checked');
    ...
    $('#<%:chkIsCashBackInPercentage3.ClientID %>').live('change', function () {
        var value = $('#<%:txtCashBackAmount3.ClientID %>').val();
        var token = ",";
        var newToken = "";
        value = value.split(token).join(newToken);
...
<div style="height: 450px; overflow-y: auto">
    <input type="hidden" id="hdnCoverageTypeIDCtlDept" value="" runat="server" />
                ...
                <div id="containerPopupEntryData" style="margin-top: 10px; display: none;">
                    ...
                    <fieldset id="fsEntryPopup" style="margin: 0">
                        <table class="tblEntryDetail" style="width: 100%">
                            ...
                            <tr>
                                <td class="tdLabel">
                                    <label class="lblMandatory lblLink" id="lblDepartment">
                                ...
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtDepartmentCode" CssClass="required" Width="100%" runat="server" />
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtDepartmentName" ReadOnly="true" Width="100%" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:CheckBox ID="chkIsDiscount1UsedComp" runat="server" />
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                            ...
                                            <td align="center">
                                                <asp:CheckBox ID="chkIsDiscount2UsedComp" runat="server" />
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                            ...
                                            <td align="center">
                                                <asp:CheckBox ID="chkIsDiscount3UsedComp" runat="server" />
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                ...
                                <asp:ListView runat="server" ID="lvwView">
                                    <EmptyDataTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 250px" rowspan="2" align="left">
                                                    <%=GetLabel("Instalasi")%>
                                                </th>
                                                ...
                                                <th colspan="4" align="center">
                                                    <%=GetLabel("Peralatan dan Bahan Medis")%>
                                                </th>
                                                <th colspan="4" align="center">
                                    ...
                                    <LayoutTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0"
                                            rules="all">
                                            <tr>
                                                <th style="width: 70px" rowspan="2" align="center">
                                                    &nbsp;
                                                </th>
                                                <th style="width: 250px" rowspan="2" align="left">
                                                    <%=GetLabel("Instalasi")%>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                ...
                                                <input type="hidden" class="hdnDepartmentID" value="<%#: Eval("DepartmentID")%>" />
                                                <input type="hidden" class="IsDiscount1UsedComp" value="<%#: Eval("IsDiscount1UsedComp")%>" />
                                                ...
                                                <input type="hidden" class="IsDiscount2UsedComp" value="<%#: Eval("IsDiscount2UsedComp")%>" />
                                                ...
                                                <input type="hidden" class="IsDiscount3UsedComp" value="<%#: Eval("IsDiscount3UsedComp")%>" />
                                            ...
                                            <td class="tdDepartmentName">
                                                <%#: Eval("DepartmentName")%>
                                            </td>
                                            <td class="tdMarkupAmount1" align="right">
                                                <%#: Eval("DisplayMarkupAmount1")%>
                                            </td>
                                            <td class="tdDiscountAmount1" align="right">
                                                <%#: Eval("DisplayDiscountAmount1")%>
                                            </td>
                                            <td class="tdCoverageAmount1" align="right">
                                                <%#: Eval("DisplayCoverageAmount1")%>
                                            </td>
                                            <td class="tdCashBackAmount1" align="right">
                                                <%#: Eval("DisplayCashBackAmount1")%>
                                            </td>
                                            <td class="tdMarkupAmount2" align="right">
                                                <%#: Eval("DisplayMarkupAmount2")%>
                                            </td>
                                            <td class="tdDiscountAmount2" align="right">
                                                <%#: Eval("DisplayDiscountAmount2")%>
                                            </td>
                                            <td class="tdCoverageAmount2" align="right">
                                                <%#: Eval("DisplayCoverageAmount2")%>
                                            </td>
                                            <td class="tdCashBackAmount2" align="right">
                                                <%#: Eval("DisplayCashBackAmount2")%>
                                            </td>
                                            <td class="tdMarkupAmount3" align="right">
                                                <%#: Eval("DisplayMarkupAmount3")%>
                                            </td>
                                            <td class="tdDiscountAmount3" align="right">
                                                <%#: Eval("DisplayDiscountAmount3")%>
                                            </td>
                                            <td class="tdCoverageAmount3" align="right">
                                                <%#: Eval("DisplayCoverageAmount3")%>
                                            </td>
                                            <td class="tdCashBackAmount3" align="right">
                                                <%#: Eval("DisplayCashBackAmount3")%>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
