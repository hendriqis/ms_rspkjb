<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeItemGroupEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.CoverageTypeItemGroupEntryCtl" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_CoverageTypeItemGroupEntryCtl">

    //#region Item Group
    function onGetCoverageTypeItemGroupCodeFilterExpression() {
        var filterExpression = "ItemGroupID NOT IN (SELECT ItemGroupID FROM CoverageTypeItemGroup WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeIDCtlIGM.ClientID %>').val() + " AND IsDeleted = 0) AND IsDeleted = 0";
...
<div style="height: 450px; overflow-y: auto">
    <input type="hidden" id="hdnCoverageTypeIDCtlIGM" value="" runat="server" />
                                    ...
                                    <asp:ListView runat="server" ID="lvwView">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="tdItemName">
                                                    <%#: Eval("ItemGroupName1")%> (<%#: Eval("ItemGroupCode")%>)
                                                </td>
