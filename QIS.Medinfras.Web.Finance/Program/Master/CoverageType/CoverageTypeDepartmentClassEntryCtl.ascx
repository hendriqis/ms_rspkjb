<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeDepartmentClassEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.CoverageTypeDepartmentClassEntryCtl" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_CoverageTypeDepartmentClassEntryCtl">

    //#region Class
    function onGetCoverageTypeDepartmentClassCodeFilterExpression() {
        var filterExpression = "ClassID NOT IN (SELECT ClassID FROM CoverageTypeDepartmentClass WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeIDCtlDeptClass.ClientID %>').val() + " AND DepartmentID = '" + $('#<%=hdnDepartmentID.ClientID %>').val() + "' AND IsDeleted = 0) AND IsDeleted = 0";
        return filterExpression;
    }

    $('#lblClass.lblLink').click(function () {
        openSearchDialog('classcare', onGetCoverageTypeDepartmentClassCodeFilterExpression(), function (value) {
    ...
    function onTxtCoverageTypeDepartmentClassCodeChanged(value) {
        var filterExpression = onGetCoverageTypeDepartmentClassCodeFilterExpression() + " AND ClassCode = '" + value + "'";
...
<div style="height: 450px; overflow-y: auto">
    <input type="hidden" id="hdnCoverageTypeIDCtlDeptClass" value="" runat="server" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td colspan="3" style="padding-bottom: 2px" align="center">
                                    ...
                                    <EmptyDataTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="4" align="center">
                                                    <%=GetLabel("Peralatan dan Barang Umum")%>
                                                </th>
                                                <th colspan="4" align="center">
