<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeServiceUnitEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.CoverageTypeServiceUnitEntryCtl" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_CoverageTypeServiceUnitEntryCtl">

    //#region Service Unit
    function onGetCoverageTypeServiceUnitCodeFilterExpression() {
        var filterExpression = "DepartmentID = '" + $('#<%=hdnDepartmentID.ClientID %>').val() + "' AND ServiceUnitID NOT IN (SELECT ServiceUnitID FROM CoverageTypeServiceUnit WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeIDCtlSU.ClientID %>').val() + " AND IsDeleted = 0) AND IsDeleted = 0";
    ...
    $('.imgEdit.imgLink').live('click', function () {
        ...
        var serviceUnitName = $row.find('.tdServiceUnitName').html().trim();
...
<div style="height: 450px; overflow-y: auto">
    <input type="hidden" id="hdnCoverageTypeIDCtlSU" value="" runat="server" />
                                    ...
                                    <EmptyDataTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 250px" rowspan="2" align="lft">
