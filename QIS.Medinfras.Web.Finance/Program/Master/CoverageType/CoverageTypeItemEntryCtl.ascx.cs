...
namespace QIS.Medinfras.Web.Finance.Program
{
    public partial class CoverageTypeItemEntryCtl : BaseViewPopupCtl
    {
        ...
        {
            hdnCoverageTypeIDCtlIM.Value = param;
            CoverageType entity = BusinessLayer.GetCoverageType(Convert.ToInt32(hdnCoverageTypeIDCtlIM.Value));
        ...
        {
            string filterExpression = string.Format("CoverageTypeID = {0} AND IsDeleted = 0", hdnCoverageTypeIDCtlIM.Value);
            ...
            List<vCoverageTypeItem> lstEntity = BusinessLayer.GetvCoverageTypeItemList(filterExpression, Constant.GridViewPageSize.GRID_CTL, pageIndex, "ItemName1 ASC");
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            try
            {
                ...
                entity.CoverageTypeID = Convert.ToInt32(hdnCoverageTypeIDCtlIM.Value);
