<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeDepartmentClassUploadCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Finance.Program.CoverageTypeDepartmentClassUploadCtl" %>
...
<div style="height:450px; overflow-y:auto">
    ...
    <div class="pageTitle"><%=GetLabel("Tipe Jaminan Kelas Instalasi")%></div>
                                    ...
                                    <EmptyDataTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0" rules="all" >
                                            <tr>
                                                ...
                                                <th style="width:250px" rowspan="2" align="left"><%=GetLabel("Kelas")%></th>
                                                <th colspan="4" align="center"><%=GetLabel("Pelayanan")%></th>
                                                <th colspan="4" align="center"><%=GetLabel("Peralatan dan Barang Umum")%></th>
