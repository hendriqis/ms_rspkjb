<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeDepartmentUploadCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Finance.Program.CoverageTypeDepartmentUploadCtl" %>
...
<script type="text/javascript" id="dxss_serviceunithealthcareentryctl">
    ...
    function onGetCoverageTypeDepartmentCodeFilterExpression() {
        var filterExpression = "DepartmentID NOT IN (SELECT DepartmentID FROM CoverageTypeDepartment WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeID.ClientID %>').val() + " AND IsDeleted = 0) AND IsActive = 1";
...
<div style="height:450px; overflow-y:auto">
    ...
    <div class="pageTitle"><%=GetLabel("Tipe Jaminan Instalasi")%></div>
                                ...
                                <asp:ListView runat="server" ID="lvwView">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="tdDepartmentName"><%#: Eval("DepartmentName")%></td> 
