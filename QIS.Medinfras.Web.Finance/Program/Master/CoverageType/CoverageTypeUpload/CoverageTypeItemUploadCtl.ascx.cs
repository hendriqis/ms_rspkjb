...
{
    public partial class CoverageTypeItemUploadCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vCoverageTypeItemUpload> lstEntity = BusinessLayer.GetvCoverageTypeItemUploadList(filterExpression, 8, pageIndex, "ItemName1 ASC");
        ...
        private void ControlToEntity(CoverageTypeItemUpload entity)
        {
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            try
            {
                CoverageTypeItemUpload entity = new CoverageTypeItemUpload();
                ControlToEntity(entity);
                entity.CoverageTypeUploadID = Convert.ToInt32(hdnCoverageTypeID.Value);
                entity.CreatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.InsertCoverageTypeItemUpload(entity);
                return true;
            }
            catch (Exception ex)
            {
        ...
        private bool OnSaveEditRecord(ref string errMessage)
        {
            try
            {
                CoverageTypeItemUpload entity = BusinessLayer.GetCoverageTypeItemUpload(Convert.ToInt32(hdnID.Value));
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateCoverageTypeItemUpload(entity);
                return true;
            }
            catch (Exception ex)
            {
