...
{
    public partial class CoverageTypeServiceUnitUploadCtl : BaseViewPopupCtl
    {
        ...
        {
            lvwView.DataSource = BusinessLayer.GetvCoverageTypeServiceUnitUploadList(string.Format("CoverageTypeUploadID = {0} AND DepartmentID = '{1}' AND IsDeleted = 0 ORDER BY ServiceUnitName ASC", hdnCoverageTypeID.Value, hdnDepartmentID.Value));
            lvwView.DataBind();
        }
        ...
        private void ControlToEntity(CoverageTypeServiceUnitUpload entity)
        {
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            try
            {
                CoverageTypeServiceUnitUpload entity = new CoverageTypeServiceUnitUpload();
                ControlToEntity(entity);
                entity.CoverageTypeUploadID = Convert.ToInt32(hdnCoverageTypeID.Value);
                entity.CreatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.InsertCoverageTypeServiceUnitUpload(entity);
                return true;
            }
            catch (Exception ex)
            {
        ...
        private bool OnSaveEditRecord(ref string errMessage)
        {
            try
            {
                CoverageTypeServiceUnitUpload entity = BusinessLayer.GetCoverageTypeServiceUnitUpload(Convert.ToInt32(hdnID.Value));
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateCoverageTypeServiceUnitUpload(entity);
                return true;
            }
            catch (Exception ex)
            {
