...
{
    public partial class CoverageTypeDepartmentUploadCtl : BaseViewPopupCtl
    {
        ...
        {
            lvwView.DataSource = BusinessLayer.GetvCoverageTypeDepartmentUploadList(string.Format("CoverageTypeUploadID = {0} AND IsDeleted = 0", hdnCoverageTypeID.Value));
            lvwView.DataBind();
        }
        ...
        private void ControlToEntity(CoverageTypeDepartmentUpload entity)
        {
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            try
            {
                CoverageTypeDepartmentUpload entity = new CoverageTypeDepartmentUpload();
                ControlToEntity(entity);
                entity.CoverageTypeUploadID = Convert.ToInt32(hdnCoverageTypeID.Value);
                entity.CreatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.InsertCoverageTypeDepartmentUpload(entity);
                return true;
            }
            catch (Exception ex)
            {
        ...
        private bool OnSaveEditRecord(ref string errMessage)
        {
            try
            {
                CoverageTypeDepartmentUpload entity = BusinessLayer.GetCoverageTypeDepartmentUpload(Convert.ToInt32(hdnID.Value));
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateCoverageTypeDepartmentUpload(entity);
                return true;
            }
            catch (Exception ex)
            {
