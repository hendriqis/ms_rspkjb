<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeItemGroupUploadCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Finance.Program.CoverageTypeItemGroupUploadCtl" %>
...
<script type="text/javascript" id="dxss_serviceunithealthcareentryctl">
    ...
    $('.imgEdit.imgLink').live('click', function () {
        $row = $(this).closest('tr').parent().closest('tr');
        var ID = $row.find('.hdnID').val();
        var itemID = $row.find('.hdnItemGroupID').val();
        var itemCode = $row.find('.hdnItemGroupCode').val();
        ...
        $('#<%=hdnID.ClientID %>').val(ID);
        $('#<%=hdnItemGroupID.ClientID %>').val(itemID);
        $('#<%=txtItemGroupCode.ClientID %>').val(itemCode);
        $('#<%=txtItemGroupName.ClientID %>').val(itemName);
        $('#<%=hdnGCItemType.ClientID %>').val(GCItemType);
    ...
    //#region Item Group
    function onGetCoverageTypeItemGroupCodeFilterExpression() {
        var filterExpression = "ItemGroupID NOT IN (SELECT ItemGroupID FROM CoverageTypeItemGroup WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeID.ClientID %>').val() + " AND IsDeleted = 0) AND IsDeleted = 0";
        return filterExpression;
    }

    $('#lblItemGroup.lblLink').click(function () {
        openSearchDialog('itemgroup', onGetCoverageTypeItemGroupCodeFilterExpression(), function (value) {
            $('#<%=txtItemGroupCode.ClientID %>').val(value);
            onTxtCoverageTypeItemGroupCodeChanged(value);
        });
    });

    $('#<%=txtItemGroupCode.ClientID %>').change(function () {
        onTxtCoverageTypeItemGroupCodeChanged($(this).val());
    });

    function onTxtCoverageTypeItemGroupCodeChanged(value) {
        var filterExpression = onGetCoverageTypeItemGroupCodeFilterExpression() + " AND ItemGroupCode = '" + value + "'";
...
<div style="height:450px; overflow-y:auto">
    ...
    <div class="pageTitle"><%=GetLabel("Kelompok Item")%></div>
                ...
                <div id="containerPopupEntryData" style="margin-top: 10px; display: none;">
                    ...
                    <fieldset id="fsEntryPopup" style="margin: 0">
                        <table class="tblEntryDetail" style="width: 100%">
                            ...
                            <tr>
                                <td class="tdLabel">
                                    <label class="lblMandatory lblLink" id="lblItemGroup">
                                ...
                                <td>
                                    ...
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtItemGroupCode" CssClass="required" Width="100%" runat="server" />
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                    ...
                                    <asp:ListView runat="server" ID="lvwView">
                                        <EmptyDataTemplate>
                                            <table id="tblView" runat="server" class="grdView notAllowSelect grdPopup" cellspacing="0" rules="all" >
                                                <tr>  
                                                    ...
                                                    <th style="width:350px" align="left"><%=GetLabel("Kelompok Item")%></th>
                                        ...
                                        <LayoutTemplate>
                                            <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0" rules="all" >
                                                <tr>  
                                                    <th style="width:40px">&nbsp;</th>
                                                    <th style="width:350px" align="left"><%=GetLabel("Kode Kelompok")%></th>
                                                    <th style="width:350px" align="left"><%=GetLabel("Nama Kelompok")%></th>
                                                    <th style="width:120px" align="right"><%=GetLabel("Kenaikan Harga")%></th>
                                                    <th style="width:120px" align="right"><%=GetLabel("Diskon")%></th>
                                                    <th style="width:120px" align="right"><%=GetLabel("Jaminan")%></th>
                                                    <th style="width:120px" align="right"><%=GetLabel("Cashback")%></th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="tdItemName"><%#: Eval("ItemGroupCode")%></td>
                                                <td class="tdItemName"><%#: Eval("ItemGroupName1")%></td>
