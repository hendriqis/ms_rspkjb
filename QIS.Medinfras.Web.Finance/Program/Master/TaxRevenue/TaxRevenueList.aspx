<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" CodeBehind="TaxRevenueList.aspx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.TaxRevenueList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#<%=grdView.ClientID %> tr:gt(0) td.tdExpand').live('click', function () {
            ...
            if ($trDetail.attr('class') != 'trDetail') {
                ...
                CbpViewDetailTaxRevenueRange.PerformCallback();
            }
            else {
        ...
        $('.imgDelete.imgLink').live('click', function () {
            if (confirm("Are You Sure Want To Delete This Data?")) {
                ...
                CbpViewDetailTaxRevenueRange.PerformCallback('delete');
            }
        });
        ...
        $('.imgEdit.imgLink').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/Master/TaxRevenue/TaxRevenueDtEntryCtl.ascx");
            openUserControlPopup(url, filter, 'Tax Revenue Range Detail', 600, 300);
        });
        ...
        function onAfterSaveAddRecordEntryPopup() {
            CbpViewDetailTaxRevenueRange.PerformCallback('refresh');
        }
        ...
        function onCbpViewDetailTaxRevenueRangeEndCallback(s) {
            CbpViewDetailTaxRevenueRange.PerformCallback('refresh');
        }
                ...
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                <asp:BoundField DataField="TaxRevenueID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                ...
                                <asp:BoundField DataField="TaxRevenueCode" HeaderText="Kode Pajak" HeaderStyle-Width="100px"
                                    HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="TaxRevenueName" HeaderText="Nama Pajak" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left" />
                                <asp:CheckBoxField DataField="IsInPercentage" HeaderText="%" HeaderStyle-Width="50px"
    ...
    <div id="tempContainerGrdDetail" style="display: none">
        <div id="containerGrdDetail" class="borderBox" style="width: 100%; padding: 10px 5px;">
            <div style="position: relative;">
                <dxcp:ASPxCallbackPanel ID="CbpViewDetailTaxRevenueRange" runat="server" Width="100%" ClientInstanceName="CbpViewDetailTaxRevenueRange"
                    ShowLoadingPanel="false" OnCallback="CbpViewDetailTaxRevenueRange_Callback" EndCallback="function(s,e){ onCbpViewDetailTaxRevenueRangeEndCallback(s); }">
                                ...
                                <asp:GridView ID="grdDetail" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="cfEndingValueInString" HeaderText="Ending Value" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="150px" />
                                        <asp:BoundField DataField="cfTaxAmountInString" HeaderText="Tax Amount" ItemStyle-HorizontalAlign="Right"
