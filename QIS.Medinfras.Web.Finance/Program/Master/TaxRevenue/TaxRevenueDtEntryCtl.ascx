<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaxRevenueDtEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.TaxRevenueDtEntryCtl" %>
...
<script type="text/javascript" id="dxss_taxrevenuedtentry">
    $(function () {
...
<div style="height: 300px; overflow-y: auto">
    <input type="hidden" id="hdnTaxRevenueIDCtl" value="" runat="server" />
                ...
                <fieldset id="fsEntryPopup" style="margin: 0">
                    <table class="tblEntryContent" cellpadding="0" cellspacing="1">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal">
                                    <%=GetLabel("Kode Pajak")%></label>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                            <td>
                                <asp:TextBox ID="txtTaxRevenueCodeCtl" Width="100px" runat="server" ReadOnly="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal">
                                    <%=GetLabel("Nama Pajak")%></label>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                            <td>
                                <asp:TextBox ID="txtTaxRevenueNameCtl" Width="250px" runat="server" ReadOnly="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTaxRevenueAmount" CssClass="txtCurrency" Width="150px" runat="server" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
