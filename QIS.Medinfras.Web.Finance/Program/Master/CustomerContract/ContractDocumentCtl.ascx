<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContractDocumentCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ContractDocumentCtl" %>
            ...
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent" style="width: 70%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtContractNo" Width="160px" runat="server" ReadOnly="true" />
                        </td>
                    </tr>
                </table>
