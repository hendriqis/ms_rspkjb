...
CodeBehind="CreditCardFeeEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.CreditCardFeeEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <%--<div class="pageTitle"><%=GetLabel("Kartu Kredit")%></div>--%>
        ...
        <tr>
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:50%">
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Mesin EDC")%></label></td>
                        <td><dxe:ASPxComboBox ID="cboEDCMachine" Width="300px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Tipe Kartu")%></label></td>
                        <td><dxe:ASPxComboBox ID="cboCardType" Width="300px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Penyedia Kartu")%></label></td>
                        <td><dxe:ASPxComboBox ID="cboCardProvider" Width="300px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Biaya Kartu")%> (%)</label></td>
