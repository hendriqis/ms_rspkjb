...
{
    public partial class ARInvoicePatientToolbarCtl : BaseUserControlCtl
    {
        string menuCode = "";
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                List<GetUserMenuAccess> lstMenu = BusinessLayer.GetUserMenuAccess(Constant.Module.FINANCE, AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID, string.Format("ParentCode = '{0}'", Constant.MenuCode.Finance.AR_INVOICE_PATIENT)).OrderBy(p => p.MenuIndex).ToList();
