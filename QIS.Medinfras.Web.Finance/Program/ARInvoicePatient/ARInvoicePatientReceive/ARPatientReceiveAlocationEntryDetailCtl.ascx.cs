...
{
    public partial class ARPatientReceiveAlocationEntryDetailCtl : BaseEntryPopupCtl
    {
        private string[] lstSelectedMember = null;

        private ARPatientReceiveAlocationEntry DetailPage
        {
            get { return (ARPatientReceiveAlocationEntry)Page; }
        }
        ...
        {
            string filterExpression = string.Format("MRN = {0} AND GCTransactionStatus IN ('{1}','{2}')",
                                        AppSession.PatientDetail.MRN, Constant.TransactionStatus.APPROVED, Constant.TransactionStatus.PROCESSED);
