<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARPatientReceiveAlocationEntryDetailCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ARPatientReceiveAlocationEntryDetailCtl" %>
...
<script type="text/javascript" id="dxss_arpatientalocationctl">
...
<div style="height: 400px; overflow-y: auto; overflow-x: hidden" id="containerPopup">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <dxe:ASPxComboBox ID="cboFilterBy" ClientInstanceName="cboFilterBy" Width="200px" runat="server">
