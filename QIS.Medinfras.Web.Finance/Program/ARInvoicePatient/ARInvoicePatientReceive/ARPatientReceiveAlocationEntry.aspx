<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/libs/MasterPage/PatientDtPage/MPBasePatientDtPageTrx.master"
    CodeBehind="ARPatientReceiveAlocationEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.ARPatientReceiveAlocationEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('#lblARReceivingNo.lblLink').live('click', function () {
            var filterExpression = "GCTransactionStatus IN ('" + Constant.TransactionStatus.APPROVED + "','" + Constant.TransactionStatus.PROCESSED + "','" + Constant.TransactionStatus.CLOSED + "') AND MRN = " + $('#<%=hdnMRN.ClientID %>').val();
        ...
        $('#<%=txtARReceivingNo.ClientID %>').live('change', function () {
            var val = $(this).val();
            var filterExpression = 'MRN = ' + $('#<%=hdnMRN.ClientID %>').val() + " AND ARReceivingNo = '" + val + "'";
        ...
        $('#lblAddData').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                ...
                var url = ResolveUrl('~/Program/ARInvoicePatient/ARInvoicePatientReceive/ARPatientReceiveAlocationEntryDetailCtl.ascx');
        ...
        $('.tdARInvoiceNo a').live('click', function () {
            ...
            var id = entity.ARInvoiceID;
            var url = ResolveUrl("~/Program/ARInvoicePatient/ARInvoicePatientEdit/ARInvoicePatientAlocationCtl.ascx");
            var headerText = "Alokasi Invoice Detail : " + $(this).html();
            openUserControlPopup(url, id, headerText, 1100, 500);
        });
