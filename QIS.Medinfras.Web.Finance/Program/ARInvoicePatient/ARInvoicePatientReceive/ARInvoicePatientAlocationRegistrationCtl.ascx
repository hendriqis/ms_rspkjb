<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARInvoicePatientAlocationRegistrationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ARInvoicePatientAlocationRegistrationCtl" %>
...
<script type="text/javascript" id="dxss_alocationarinvoicepatiententryctl">
    $(function () {
        setTimeout(function () {
