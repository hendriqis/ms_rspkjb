...
{
    public partial class ARInvoicePatientUpdateDocDate : BaseViewPopupCtl
    {
        ...
        protected void cbpUpdateDocDatePatient_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            string result = "";
            string errMessage = "";
        ...
        {
            txtDocumentDate.Text = arHD.DocumentDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
        }
        ...
        private bool OnSaveRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                if (entityLock.LockedUntilDate != null)
                {
                    ...
                    if (DateNow > DateLock)
                    {
                        arHD.DocumentDate = Helper.GetDatePickerValue(txtDocumentDate);
                        ...
                        DateTime tempdue1 = arHD.DocumentDate.AddDays(term.TermDay);
