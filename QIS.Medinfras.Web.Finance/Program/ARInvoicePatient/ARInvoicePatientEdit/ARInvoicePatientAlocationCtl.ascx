<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARInvoicePatientAlocationCtl.ascx.cs"
...
<script type="text/javascript" id="dxss_alocationarinvoice2patiententryctl">
    $(function () {
        setTimeout(function () {
