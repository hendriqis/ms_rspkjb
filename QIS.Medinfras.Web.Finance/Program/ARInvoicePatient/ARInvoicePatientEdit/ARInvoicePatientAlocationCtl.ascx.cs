...
{
    public partial class ARInvoicePatientAlocationCtl : BaseEntryPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            txtInvoiceTotal.Text = lstARParam.Sum(a => a.TotalPaymentAmount).ToString();
        ...
        private void BindGridView()
        {
            ...
            List<vARInvoiceDt> lstarDT = BusinessLayer.GetvARInvoiceDtList(string.Format("ARInvoiceID IN ({0}) AND GCTransactionStatus != '{1}' ORDER BY ARInvoiceID, PaymentID, PaymentDetailID", hdnARInvoiceID.Value, Constant.TransactionStatus.VOID));
