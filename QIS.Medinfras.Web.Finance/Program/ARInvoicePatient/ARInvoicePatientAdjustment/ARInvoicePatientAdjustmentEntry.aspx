<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientDtPage/MPBasePatientDtPageTrx.master"
    AutoEventWireup="true" CodeBehind="ARInvoicePatientAdjustmentEntry.aspx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ARInvoicePatientAdjustmentEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function getTransactionNonOperationalFilterExpression() {
            var filterExpression = "IsDeleted = 0 AND TransactionCode IN ('5111')";
            return filterExpression;
        }
