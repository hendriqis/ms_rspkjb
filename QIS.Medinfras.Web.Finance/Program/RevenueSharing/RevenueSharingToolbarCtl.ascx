<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RevenueSharingToolbarCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.RevenueSharingToolbarCtl" %>
...
<script type="text/javascript">
    function onGetUrlReferrer() {
        return ResolveUrl("~/Program/RevenueSharing/ParamedicList.aspx");
    }
</script>
