<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/ParamedicPage/MPBaseParamedicPageTrx.master"
    AutoEventWireup="true" CodeBehind="RevenueSharingSummaryReopen.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.RevenueSharingSummaryReopen" %>
        ...
        function onLoad() {
            ...
            $('#<%=btnRSSummaryApproval.ClientID %>').click(function () {
                ...
                if ($('#<%=hdnSelectedMember.ClientID %>').val() == '') {
                    showToast('Warning', 'Pilih No Rekap Terlebih Dahulu');
                }
                else {
                        ...
                        <tr>
                            <td style="width: 150px;">
                                <label class="lblNormal">
                                    <%=GetLabel("Periode Approval") %></label>
                            </td>
                            <td>
                                <table>
                                    <colgroup>
                                    ...
                                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="overflow-y: scroll;">
                                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="cfApprovedDateInString" HeaderText="Approve pada" HeaderStyle-HorizontalAlign="Center"
                                                    ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="120px" />
                                                <asp:BoundField DataField="ApprovedByName" HeaderText="Approve oleh" HeaderStyle-HorizontalAlign="Center"
                                                    ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" />
                                            </Columns>
                                            <EmptyDataTemplate>
                                                No Data To Display
