<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APInvoiceSupplierProcessReturnDtCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierProcessReturnDtCtl" %>
...
<div class="pageTitle">
    <%=GetLabel("Detil Retur Pembelian")%></div>
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        <td class="tdLabel">
                            <%=GetLabel("Tanggal Retur") %>
                        </td>
                        <td>
                            <asp:TextBox ID="txtPurchaseReturnDate" Width="120px" ReadOnly="true" CssClass="datepicker"
                                runat="server" />
                        </td>
                    </tr>
                    <tr>
            ...
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtReturnType" Width="100%" ReadOnly="true" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="text-align: center">
                                            <asp:TextBox ID="txtReferenceDate" CssClass="datepicker" Width="120px" runat="server"
                                                ReadOnly="true" /></div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="chkIsAutoUpdateStock" Enabled="false" Width="100%" runat="server"
                                ReadOnly="true" Text="Otomatis Mengurangi Stok" />
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <dxcp:ASPxCallbackPanel ID="cbpView" runat="server" Width="100%" ClientInstanceName="cbpView"
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" Style="max-height: 350px; overflow-y: auto;
                                width: 100%; margin-left: auto; margin-right: auto; position: relative; font-size: 0.95em;">
                                ...
                                <td valign="top">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtNotes" Width="100%" runat="server" ReadOnly="true" TextMode="MultiLine"
                                                    Rows="3" />
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td>
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:CheckBox ID="chkPPN" Enabled="false" Width="100%" runat="server" ReadOnly="true" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
