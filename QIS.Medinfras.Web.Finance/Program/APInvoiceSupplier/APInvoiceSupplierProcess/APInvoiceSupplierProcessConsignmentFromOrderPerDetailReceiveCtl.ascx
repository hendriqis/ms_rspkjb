<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APInvoiceSupplierProcessConsignmentFromOrderPerDetailReceiveCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierProcessConsignmentFromOrderPerDetailReceiveCtl" %>
