<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APInvoiceSupplierProcessEditOrderCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierProcessEditOrderCtl" %>
...
<script type="text/javascript" id="dxss_APInvoiceSupplierProcessEditOrderCtl">
    ...
    function onBeforeSaveRecord(errMessage) {
        ...
        $('.grdPurchaseOrder > tbody > tr:gt(1)').each(function () {
...
<input type="hidden" id="hdnIsChangedAPAmountFromRoundingInvoice" runat="server" value="1" />
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent">
                    ...
                    <tr>
                        <td class="tdLabel">
                            <%=GetLabel("Tanggal Pemesanan") %>
                        </td>
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-right: 1px; width: 145px">
                                        <asp:TextBox ID="txtPurchaseOrderDate" ReadOnly="true" Width="120px" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                                    ...
                                    <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <asp:TextBox ID="txtLineAmount" runat="server" Width="100%" CssClass="txtCurrency txtLineAmount"
                                                        ReadOnly="true" />
                                                </td>
                                                <td>
                                                    <%#: Eval("CreatedByName")%>
                        ...
                        <td valign="top">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTotalOrder" CssClass="txtCurrency" Width="180px"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPPN" CssClass="txtCurrency" Width="180px" runat="server"
                                            ReadOnly="true" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTotalOrderSaldo" CssClass="txtCurrency" Width="180px"
                                            runat="server" ReadOnly="true" />
                                    </td>
                                </tr>
                                <tr>
