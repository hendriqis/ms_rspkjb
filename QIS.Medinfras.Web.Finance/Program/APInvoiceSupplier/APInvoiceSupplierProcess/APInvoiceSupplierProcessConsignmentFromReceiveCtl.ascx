<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APInvoiceSupplierProcessConsignmentFromReceiveCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierProcessConsignmentFromReceiveCtl" %>
