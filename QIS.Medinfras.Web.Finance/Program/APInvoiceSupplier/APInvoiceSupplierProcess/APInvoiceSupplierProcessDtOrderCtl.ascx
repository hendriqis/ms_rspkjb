<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APInvoiceSupplierProcessDtOrderCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierProcessDtOrderCtl" %>
...
<script type="text/javascript" id="dxss_APInvoiceSupplierProcessDtOrderCtl">
...
<div class="pageTitle">
    <%=GetLabel("Detil Pemesanan Konsinyasi")%></div>
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblNormal">
                                <%=GetLabel("No PO")%></label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtPurchaseOrderNo" ReadOnly="true" Width="200px" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-right: 1px; width: 145px">
                                        <asp:TextBox ID="txtPurchaseOrderDate" ReadOnly="true" Width="120px" CssClass="datepicker"
                                            runat="server" />
                                    </td>
                                    <td style="width: 5px">
                                        &nbsp;
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPurchaseOrderTime" Width="60px" ReadOnly="true" CssClass="time"
                            ...
                            <dx:PanelContent ID="PanelContent1" runat="server">
                                <asp:Panel runat="server" ID="pnlView">
                                    <asp:ListView runat="server" ID="lvwView">
                                        ...
                                        <LayoutTemplate>
                                            <table id="tblView" runat="server" class="grdPurchaseOrder grdView notAllowSelect"
