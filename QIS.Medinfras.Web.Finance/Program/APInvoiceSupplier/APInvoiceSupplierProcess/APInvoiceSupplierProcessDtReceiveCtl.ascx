<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APInvoiceSupplierProcessDtReceiveCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierProcessDtReceiveCtl" %>
...
<script type="text/javascript" id="dxss_APInvoiceSupplierProcessDtReceiveCtl">
...
<input type="hidden" id="hdnIDCtl" runat="server" />
<input type="hidden" id="hdnPurchaseReceiveIDCtl" runat="server" />
<input type="hidden" id="hdnPurchaseOrderIDCtl" runat="server" />
<input type="hidden" id="hdnVATPercentage" runat="server" />
<div class="pageTitle">
    <%=GetLabel("Detil Penerimaan Pembelian")%></div>
<div style="height: 450px; overflow-y: auto" id="containerPopup">
            ...
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtReferenceNo" ReadOnly="true" CssClass="required" ValidationGroup="mpEntry"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDateReferrence" ReadOnly="true" Width="120px" CssClass="datepicker"
                                runat="server" />
                        </td>
                    </tr>
                </table>
            ...
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <dxe:ASPxComboBox ID="cboTerm" ClientEnabled="false" ClientInstanceName="cboTerm"
                    ...
                    <tr style="display: none">
                        ...
                        <td>
                            <asp:TextBox ID="txtKurs" ReadOnly="true" Width="120px" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                                    ...
                                    <asp:ListView runat="server" ID="lvwView">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" class="hdnIDCtl" value='<%#: Eval("ID")%>' />
                                                ...
                                                <td align="right">
                                                    <%#:Eval("DiscountPercentage1", "{0:N}")%>
                                                </td>
                                                <td align="right">
                                                    <%#:Eval("DiscountAmount1", "{0:N}")%>
                                                </td>
                                                <td align="right">
                                                    <%#:Eval("DiscountPercentage2", "{0:N}")%>
                                                </td>
                                                <td align="right">
                                                    <%#:Eval("DiscountAmount2", "{0:N}")%>
                                                </td>
                                                <td align="right">
                                                    <%#:Eval("CustomSubTotal", "{0:N}")%>
                                                </td>
                                                <td>
                                                    <%#: Eval("CreatedByName")%>
                                                </td>
                        ...
                        <td valign="top">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNotes" Width="300px" runat="server" TextMode="MultiLine" Rows="5" ReadOnly="true" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td valign="top">
                            <table style="width: 100%;">
                                ...
                                <tr id='trDiskonFinal' runat='server'>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtFinalDiscountInPercentage" ReadOnly="true" CssClass="txtCurrency"
                                ...
                                <tr id='trDiskonFinal1' runat='server'>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtFinalDiscount" ReadOnly="true" CssClass="txtCurrency" Width="180px"
                                            runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPPN" ReadOnly="true" CssClass="txtCurrency" Width="180px" runat="server" />
                                    </td>
                                </tr>
                                <tr id='trPph' runat='server'>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPPH" ReadOnly="true" CssClass="txtCurrency" Width="180px"
                                            runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDPReferrenceNo" ReadOnly="true" Width="180px" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdLabel">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDP" ReadOnly="true" CssClass="txtCurrency" Width="180px" runat="server" />
                                    </td>
                                </tr>
                                ...
                                <tr id='trOngkosKirim' runat='server'>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCharges" ReadOnly="true" CssClass="txtCurrency" Width="180px"
                                            runat="server" />
                                    </td>
                                </tr>
                                <tr id='trBiayaMaterai' runat='server'>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtStamp" ReadOnly="true" CssClass="txtCurrency" Width="180px"
                                            runat="server" />
                                    </td>
                                </tr>
                                <tr>
