<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APInvoiceSupplierPaymentVerificationDtCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierPaymentVerificationDtCtl" %>
...
<input type="hidden" id="hdnSupplierPaymentID" runat="server" />
        ...
        <td>
            <table class="tblEntryContent" style="width:70%">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtSupplierPaymentNo" ReadOnly="true" Width="100%" runat="server" /></td>
                </tr>  
            </table>
                                    ...
                                    <asp:ListView runat="server" ID="lvwView">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="left"><%#:Eval("PurchaseInvoiceDateInString")%></td>
                                                <td align="left"><%#:Eval("DueDateInString")%></td>
