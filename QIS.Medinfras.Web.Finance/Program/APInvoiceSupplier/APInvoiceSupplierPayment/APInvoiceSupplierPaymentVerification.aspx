<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/libs/MasterPage/SupplierPage/MPBaseSupplierPageTrx.master"
    CodeBehind="APInvoiceSupplierPaymentVerification.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.APInvoiceSupplierPaymentVerification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('.lblSupplierPaymentNo').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/APInvoiceSupplier/APInvoiceSupplierPayment/APInvoiceSupplierPaymentVerificationDtCtl.ascx");
                        ...
                        <PanelCollection>
                            <dx:PanelContent ID="PanelContent1" runat="server">
                                <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto;
                                    margin-right: auto; position: relative; font-size: 0.95em; height: 300px; overflow-y: auto;">
                                    <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <input type="hidden" value="0" class="hdnBankID" id="hdnBankID" runat="server"/>
                                                    <label runat="server" id="lblBank" class="lblLink lblBank"><%#: Eval("BankName") %></label>
                                                </td>
                                                <td align="center">
