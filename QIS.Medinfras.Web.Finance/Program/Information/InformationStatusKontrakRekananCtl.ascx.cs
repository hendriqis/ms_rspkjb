...
{
    public partial class InformationStatusKontrakRekananCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = String.Format("BusinessPartnersID = {0}", hdnBusinessPartnersID.Value);
            if (isCountPageCount)
            {
            ...
            List<vBusinessPartnersInformationContract> lstBusinessPartners = BusinessLayer.GetvBusinessPartnersInformationContractList(filterExpression, 10, pageIndex);
