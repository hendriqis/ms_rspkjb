<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformationSkemaPenjaminPerBussinesPartnetCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.InformationSkemaPenjaminPerBussinesPartnetCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:400px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CoverageTypeName" HeaderText="Coverage TypeName" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px"  />
                                    </Columns>
                                    <EmptyDataTemplate>
