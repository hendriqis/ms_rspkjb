<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistoryPembatalanTransaksi.aspx.cs" MasterPageFile="~/libs/MasterPage/MPMain.master"
    Inherits="QIS.Medinfras.Web.Finance.Program.HistoryPembatalanTransaksi" %>
...
<%@ Register Src="~/Libs/Controls/PatientGrid/GridPatientRegOrderCtl.ascx" TagName="ctlGrdPatient" TagPrefix="uc1" %>
        ...
        <table class="tblContentArea" style="width:100%">
            <tr>
                <td style="padding:5px;vertical-align:top">
                    ...
                    <uc1:ctlGrdPatient runat="server" id="grdPatient" />
                </td>
            </tr>            
        </table>
    </div>
