...
{
    public partial class PurchaseInvoiceInformationDtCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<GetPurchaseInvoiceInformationDt> lstEntity = BusinessLayer.GetPurchaseInvoiceInformationDtList(DetailPage.GetMovementDate(), Convert.ToInt32(hdnBusinessPartnerID.Value), Convert.ToInt32(hdnDateFrom.Value), Convert.ToInt32(hdnDateTo.Value));
