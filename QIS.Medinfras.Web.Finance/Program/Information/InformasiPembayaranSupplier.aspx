<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="InformasiPembayaranSupplier.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.InformasiPembayaranSupplier" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PurchaseInvoiceID" HeaderStyle-CssClass="hiddenColumn"
                                        ...
                                        <asp:BoundField DataField="cfPurchaseInvoiceDateInString" HeaderText="Tgl Tukar Faktur"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="110px" />
                                        <asp:BoundField DataField="cfDueDateInString" HeaderText="Tgl Jatuh Tempo" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="Total Transaksi" ItemStyle-HorizontalAlign="Right"
                                            ...
                                            <ItemTemplate>
                                                <label class="lblNormal">
                                                    <%#:Eval("TotalTransactionAmount", "{0:N}")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
