...
{
    public partial class InformasiPembayaranSupplier : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.Finance.INFORMASI_PEMBAYARAN_HUTANG;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vInformationSupplierPaymentHeader> lstEntity = BusinessLayer.GetvInformationSupplierPaymentHeaderList(filterExpression, Constant.GridViewPageSize.GRID_ITEM, pageIndex, "PurchaseInvoiceID");
