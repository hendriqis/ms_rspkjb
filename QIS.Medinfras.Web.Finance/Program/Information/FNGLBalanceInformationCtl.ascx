<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FNGLBalanceInformationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.FNGLBalanceInformationCtl" %>
...
<script type="text/javascript" id="dxss_fnglbalanceinfoctl">
    $(function () {
...
<div style="padding: 10px;">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" ReadOnly="true" ID="txtGLAccountNo" Width="100%" />
            </td>
            <td>
                <asp:TextBox runat="server" ReadOnly="true" ID="txtGLAccountName" Width="100%" />
            </td>
        </tr>
        <tr>
            <td colspan="3">
