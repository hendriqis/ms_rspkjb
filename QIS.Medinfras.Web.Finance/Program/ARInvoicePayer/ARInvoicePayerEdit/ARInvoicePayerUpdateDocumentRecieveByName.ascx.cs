...
{
    public partial class ARInvoicePayerUpdateDocumentRecieveByName : BaseViewPopupCtl
    {
        ...
        protected void cbpUpdateARDocRecieveByNamePayer_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            string result = "";
            string errMessage = "";
        ...
        {
            txtARDocumentReceiveByName.Text = arHD.ARDocumentReceiveByName;
        }
        ...
        private bool OnSaveRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                if (entityLock.LockedUntilDate != null)
                {
                    ...
                    if (DateNow > DateLock)
                    {
                        arHD.ARDocumentReceiveByName = txtARDocumentReceiveByName.Text;
