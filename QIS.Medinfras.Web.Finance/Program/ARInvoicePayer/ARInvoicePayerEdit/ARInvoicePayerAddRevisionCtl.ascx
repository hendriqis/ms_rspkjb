<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARInvoicePayerAddRevisionCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ARInvoicePayerAddRevisionCtl" %>
...
<script type="text/javascript" id="dxss_ARInvoicePayerAddRevisionCtl">
