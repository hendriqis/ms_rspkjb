<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARReceiptPerInvoiceInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ARReceiptPerInvoiceInfoCtl" %>
...
<script type="text/javascript" id="dxss_ARReceiptPerInvoiceInfoCtl">
    $(function () {
...
<table style="width: 100%; height:200px; overflow-y:auto">
    <tr>
        <td valign="top">
                        ...
                        <dx:PanelContent ID="PanelContent2" runat="server">
                            <asp:panel runat="server" id="Panel1" cssclass="pnlContainerGridPatientPage">
                                <asp:gridview id="grdView" runat="server" cssclass="grdSelected grdView" autogeneratecolumns="false"
                                    ...
                                    <columns>
                                        <asp:BoundField DataField="ARReceiptID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                        <asp:BoundField DataField="ARReceiptNo" HeaderText="No. Kwitansi"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="cfARReceiptDateInString" HeaderText="Tanggal Kwitansi" HeaderStyle-Width="120px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="CreatedByName" HeaderText="Dibuat Oleh" HeaderStyle-Width="250px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="cfCreatedDateTimeInString" HeaderText="Dibuat Pada" HeaderStyle-Width="250px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                    </columns>
                                    <emptydatatemplate>
