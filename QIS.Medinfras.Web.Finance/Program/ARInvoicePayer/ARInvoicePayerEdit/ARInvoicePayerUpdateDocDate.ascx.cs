...
{
    public partial class ARInvoicePayerUpdateDocDate : BaseViewPopupCtl
    {
        ...
        protected void cbpUpdateDocDatePayer_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            string result = "";
            string errMessage = "";
