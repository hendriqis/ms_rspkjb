<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARInvoiceReceivingInformationPerReceiveCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ARInvoiceReceivingInformationPerReceiveCtl" %>
...
<script type="text/javascript" id="dxss_ARInvoiceReceivingInformationPerReceiveCtl">
    $(function () {
    });
            ...
            <div style="position: relative;">
                <table style="width: 50%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtARReceiveNo" ReadOnly="true" Width="30%" runat="server" />
                        </td>
                    </tr>
                </table>
                            ...
                            <asp:Panel runat="server" ID="Panel1" CssClass="pnlContainerGridPatientPage">
                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdView" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ARInvoiceNo" HeaderText="No. Invoice" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="cfARReceivingDateInString" HeaderText="Tanggal Invoice"
                                            HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="cfTotalTransactionAmountInString" HeaderText="Total Transaksi" HeaderStyle-Width="150px"
                                            ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="cfTotalClaimedAmountInString" HeaderText="Total Klaim" HeaderStyle-Width="150px"
                                            ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
