<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARInvoiceNonOperationalAlocationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.ARInvoiceNonOperationalAlocationCtl" %>
...
<script type="text/javascript" id="dxss_ARInvoiceNonOperationalAlocationCtl">
    $(function () {
        setTimeout(function () {
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtInvoiceTotal" CssClass="txtCurrency" ReadOnly="true" Width="200px"
                                            Style="text-align: right; color: Blue" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdLabel">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPaymentAmount" CssClass="txtCurrency" ReadOnly="true" Width="200px"
                                            Style="text-align: right; color: Green" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtInvoiceDetailPaymentTotal" CssClass="txtCurrency" ReadOnly="true"
                                            Width="200px" Style="text-align: right; color: Purple" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdLabel">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtInvoiceDetailOutstandingPaymentTotal" CssClass="txtCurrency"
                                            ReadOnly="true" Width="200px" Style="text-align: right; color: Red" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdLabel">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtInvoiceDetailTotal" CssClass="txtCurrency" ReadOnly="true" Width="200px"
                                            Style="text-align: right; color: Black" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
