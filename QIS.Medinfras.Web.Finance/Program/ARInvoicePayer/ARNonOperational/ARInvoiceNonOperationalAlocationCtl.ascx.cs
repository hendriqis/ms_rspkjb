...
{
    public partial class ARInvoiceNonOperationalAlocationCtl : BaseEntryPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            string filterDt = string.Format("ARInvoiceID IN ({0}) AND GCTransactionStatus != '{1}' AND GCTransactionDetailStatus != '{1}' ORDER BY ARInvoiceID, ID", hdnARInvoiceID.Value, Constant.TransactionStatus.VOID);
            List<vARInvoiceDtNonOperational> lstarDT = BusinessLayer.GetvARInvoiceDtNonOperationalList(filterDt);
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            {
                vARInvoiceDtNonOperational entity = e.Item.DataItem as vARInvoiceDtNonOperational;
