<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ARInvoicePayerList.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.ARInvoicePayerList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnMPListView" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbitems.png")%>' alt="" /><div><%=GetLabel("View")%></div></li>
</asp:Content>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="overflow-y: scroll;">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="BusinessPartnerCode" HeaderText="Kode Instansi" HeaderStyle-Width="150px" />
                                <asp:BoundField DataField="BusinessPartnerName" HeaderText="Nama Instansi" />
