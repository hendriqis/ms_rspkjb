<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/libs/MasterPage/CustomerPage/MPBaseCustomerPageTrx3.master"
    CodeBehind="ARPayerReceiveAlocationPerDetailEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Finance.Program.ARPayerReceiveAlocationPerDetailEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onGetFilterExpressionARReceiving() {
            ...
            var filterExpression = "(VoucherNo IS NULL AND GCTransactionStatus = '" + Constant.TransactionStatus.OPEN + "' AND ((BusinessPartnerID = " + businessPartnerID + ") OR (CustomerGroupID = " + customerGroupID + " AND BusinessPartnerID IS NULL) OR (CustomerGroupID = " + customerGroupID + " AND BusinessPartnerID = " + businessPartnerID + "))) OR (GCTransactionStatus = '" + Constant.TransactionStatus.APPROVED + "' AND ((BusinessPartnerID = " + businessPartnerID + ") OR (VoucherNo IS NOT NULL AND CustomerGroupID = " + customerGroupID + " AND BusinessPartnerID IS NULL) OR (CustomerGroupID = " + customerGroupID + " AND BusinessPartnerID = " + businessPartnerID + ")))";
        ...
        $('#lblAddData').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                ...
                var url = ResolveUrl('~/Program/ARInvoicePayer/ARInvoicePayerReceive/ARPayerReceiveAlocationPerDetailEntryDetailCtl.ascx');
    ...
    <div>
        ...
        <input type="hidden" value="" id="hdnARInvoiceDtID" runat="server" />
