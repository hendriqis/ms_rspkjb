...
{
    public partial class ARInvoicePayerAdjustmentEntry : BasePageTrx
    {
        protected int PageCount = 1;
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Finance.AR_INVOICE_PAYER_ADJUSTMENT;
        }
        ...
        protected string onGetARInvoiceFilterExpression()
        {
            return string.Format("BusinessPartnerID = {0} AND TransactionCode = {1}",
                                    ...
                                    Constant.TransactionCode.AR_INVOICE_PAYER_ADJUSTMENT);
        }
        ...
        public void SaveARInvoiceHd(IDbContext ctx, ref int ARInvoiceID)
        {
            ...
            if (hdnARInvoiceID.Value == "0" || hdnARInvoiceID.Value == "")
            {
                ...
                entityHd.TransactionCode = Constant.TransactionCode.AR_INVOICE_PAYER_ADJUSTMENT;
                entityHd.ARInvoiceNo = BusinessLayer.GenerateTransactionNo(Constant.TransactionCode.AR_INVOICE_PAYER_ADJUSTMENT, entityHd.ARInvoiceDate, ctx);
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retval)
        {
            try
            {
                ...
                bool isLocked = false;
                TransactionTypeLock entityLock = BusinessLayer.GetTransactionTypeLock(Constant.TransactionCode.AR_INVOICE_PAYER_ADJUSTMENT);
        ...
        protected override bool OnCustomButtonClick(string type, ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                TransactionTypeLock entityLock = entityLockDao.Get(Constant.TransactionCode.AR_INVOICE_PAYER_ADJUSTMENT);
                if (entityLock.LockedUntilDate != null)
                {
                    DateTime DateLock = Convert.ToDateTime(entityLock.LockedUntilDate);
                    DateTime DateNow = entity.ARInvoiceDate;
