<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InformasiKelengkapanBerkasMedisPasienCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Finance.Program.InformasiKelengkapanBerkasMedisPasienCtl" %>
...
<script type="text/javascript" id="dxss_InformasiKelengkapanBerkasMedisPasienCtl">

    function onCboMedicalFileChanged() {
        cbpViewMedicalRecordDocument.PerformCallback('refresh');
    }

    function oncbpViewMedicalRecordDocumentEndCallback(s) {
        hideLoadingPanel();
    }
     ...
     <div style="position: relative;">
        <tr>
            <td colspan="2">
                ...
                <div style="position: relative;">
                    <dxcp:ASPxCallbackPanel ID="cbpViewMedicalRecordDocument" runat="server" Width="100%"
                        ClientInstanceName="cbpViewMedicalRecordDocument" ShowLoadingPanel="false" OnCallback="cbpViewMedicalRecordDocument_Callback">
                        <ClientSideEvents BeginCallback="function(s,e){ showLoadingPanel(); }" EndCallback="function(s,e){ oncbpViewMedicalRecordDocumentEndCallback(s); }" />
                        <PanelCollection>
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                                HeaderText="Ada">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkIsExist" CssClass="chkIsExist" runat="server" Enabled="False"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderText="Tanggal Berkas">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtFormDate" Width="120px" runat="server" Style="text-align: center" ReadOnly="true" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtFormTime" runat="server" Width="60px" Style="text-align: center" ReadOnly="true" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                                HeaderText="Lengkap">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkIsCompleted" CssClass="chkIsCompleted" runat="server" Enabled="False" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Jenis Catatan">                                               
                                                <ItemTemplate>
                                                    <asp:DropDownList runat="server" ID="cboMRStatusNotes" CssClass="cboNotesType" Width="100%" Enabled="False"></asp:DropDownList>
                                                </ItemTemplate>
                                            </asp:TemplateField>
