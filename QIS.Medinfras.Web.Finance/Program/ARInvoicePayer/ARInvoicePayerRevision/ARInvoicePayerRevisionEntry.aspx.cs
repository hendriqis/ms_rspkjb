...
{
    public partial class ARInvoicePayerRevisionEntry : BasePageTrx
    {
        protected int PageCount = 1;
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Finance.AR_INVOICE_PAYER_APPROVAL;
        }
        ...
        {
            IsAllowAdd = IsAllowVoid = IsAllowProposed = false;
        }
        ...
        {
            return string.Format("BusinessPartnerID = {0} AND GCTransactionStatus IN ('{1}','{2}') AND TotalPaymentAmount = 0 AND TransactionCode = '{3}'",
                                    AppSession.BusinessPartnerID,
                                    Constant.TransactionStatus.APPROVED,
                                    Constant.TransactionStatus.PROCESSED,
                                    Constant.TransactionCode.AR_INVOICE_PAYER);
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref decimal transactionAmount, ref decimal claimedAmount, ref decimal varianceAmount, ref decimal discountAmount)
        {
            ...
            List<vARInvoiceDtRevision> lstInvoiceDt = BusinessLayer.GetvARInvoiceDtRevisionList(filterExpression, rowCount, pageIndex, "ARInvoiceID, RegistrationID, PaymentDetailID ASC");
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            {
                vARInvoiceDtRevision entity = e.Item.DataItem as vARInvoiceDtRevision;
