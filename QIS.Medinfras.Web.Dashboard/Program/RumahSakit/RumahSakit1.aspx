<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrxDashboard.master" AutoEventWireup="true"
    CodeBehind="RumahSakit1.aspx.cs" Inherits="QIS.Medinfras.Web.Dashboard.Program.RumahSakit1" %>
...
<%@ Register Src="~/Program/RumahSakit/BedInformationCtl.ascx" TagName="BedInformationCtl"
    TagPrefix="uc1" %>
<%@ Register Src="~/Program/RumahSakit/MasterRSCtl.ascx" TagName="MasterRSCtl"
    TagPrefix="uc2" %>
<%@ Register Src="~/Program/RumahSakit/FormCtl.ascx" TagName="FormCtl"
    TagPrefix="uc3" %>
    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body" id="leftPageNavPanelDashboard">
            <ul class="sidebar-body-menu">
                ...
                <li class="nav-item" contentid="bedInformation">
                    <a href="#" contentid="bedInformation"><span class="icon home" aria-hidden="true"></span>Bed</a>
                </li>
                <li class="nav-item" contentid="form">
                    <a href="#" contentid="form"><span class="icon paper" aria-hidden="true"></span>Form</a>
                </li>
                <li>
...
<div class="main-wrapper">
    <nav class="main-nav--bg">
        ...
        <div id="bedInformation" class="divPageNavPanelContent w3-animate-left" style='display:none'>
            <uc1:BedInformationCtl ID="ctlBedInformation" runat="server" />
        </div>
        <div id="masterRS" class="divPageNavPanelContent w3-animate-left">
            <uc2:MasterRSCtl ID="ctlMasterRS" runat="server" />
        </div>
        <div id="form" class="divPageNavPanelContent w3-animate-left" style='display:none'>
            <uc3:FormCtl ID="ctlForm" runat="server" />
        </div>
    </div>
    </div>
</div>
