<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrxDashboard.master" AutoEventWireup="true"
    CodeBehind="Example2.aspx.cs" Inherits="QIS.Medinfras.Web.Dashboard.Program.Example2" %>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <img id="imgPatient" class="card-img" runat="server" title="Patient" />
                            </div>
                            <div class="col-md-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="text-xs text-center font-weight-bold text-success text-uppercase mb-1">
                                    Doctors</div>
                                <div class="h5 text-center mb-0 font-weight-bold text-gray-800">
                                    39</div>
                            </div>
                            <div class="col">
                                <div class="text-xs text-center font-weight-bold text-success text-uppercase mb-1">
                ...
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <img id="img1" class="card-img" runat="server" title="Patient" />
                            </div>
                            <div class="col-md-8">
                                <div class="text-xs text-center fw-bolder text-info text-uppercase mb-1">
                                    Pasien hari ini</div>
                                <div class="h1 text-center mb-0 fw-bolder text-info">
                                    <label class="lblTodayPatient" runat="server" id="lblTodayPatient">
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            <a class="dropdown-toggle"data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"></a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
