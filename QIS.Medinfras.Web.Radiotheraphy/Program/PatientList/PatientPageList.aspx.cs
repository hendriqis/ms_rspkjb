...
{
    public partial class PatientPageList : BasePageRegisteredPatient2
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Radiotheraphy.PATIENT_PAGE;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                hdnPageHSUID.Value = AppSession.RT0001;
                ...
                ((GridPatientRegOrderCtl1)grdRegisteredPatient).InitializeControl();
                ((GridPatientRegOrderCtl2)grdRegisteredPatient2).InitializeControl();
        ...
        public override string GetFilterExpression2()
        {
            ...
            if (chkIsHasOrder.Checked)
            {
                filterExpression += string.Format(" AND HealthcareServiceUnitIDTestOrder = {0} AND IsHasTestOrder = 1", hdnPageHSUID.Value);
            }
        ...
        public override void OnGrdRowClick(string transactionNo)
        {
            ...
            pt.PatientName = entity.cfPatientNameSalutation;
            ...
            AppSession.HealthcareServiceUnitID = hdnPageHSUID.Value;

            string parentCode = "";
            parentCode = Constant.MenuCode.Radiotheraphy.PATIENT_PAGE;
            string filterExpression = string.Format("ParentCode = '{0}'", parentCode);
            List<GetUserMenuAccess> lstMenu = BusinessLayer.GetUserMenuAccess(Constant.Module.RADIOTHERAPHY, AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID, filterExpression);
            ...
            lstMenu = BusinessLayer.GetUserMenuAccess(Constant.Module.RADIOTHERAPHY, AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID, filterExpression);
