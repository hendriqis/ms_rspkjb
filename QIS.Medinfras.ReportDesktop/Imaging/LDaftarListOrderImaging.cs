...
{
    public partial class LDaftarListOrderImaging : BaseCustomDailyLandscapeRpt
    {
        public LDaftarListOrderImaging()
        {
            InitializeComponent();
        }
        public override void InitializeReport (String[] param)
        {
            ...
            vSettingParameterDt entityVS = BusinessLayer.GetvSettingParameterDtList(String.Format("ParameterCode = '{0}'", Constant.SettingParameter.IS_KODE_PENUNJANG_RADIOLOGI)).FirstOrDefault(); 
