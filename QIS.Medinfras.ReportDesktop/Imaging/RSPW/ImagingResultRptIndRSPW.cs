...
{
    public partial class ImagingResultRptIndRSPW : BaseNewCustomDailyPotraitRpt
    {
        private string sv_Email = "";
        private string sv_Sign = "0";

        public ImagingResultRptIndRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            base.IsHideHeader(reportMaster.ReportCode == Constant.PrintCode.HASIL_PEMERIKSAAN_RAD_DENGAN_KOP_RSPW ? false : true);
        }
