...
{
    public partial class ImagingResultRptIndRSSM : BaseNewCustomDailyPotraitRpt
    {
        private string sv_Email = "";
        private string sv_Sign = "0";

        public ImagingResultRptIndRSSM()
        {
            InitializeComponent();
        }
        ...
        {
            vImagingResultReport entity = BusinessLayer.GetvImagingResultReportList(param[0]).FirstOrDefault();
