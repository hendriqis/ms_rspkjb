...
{
    public partial class LNeracaPercobaanDetilAllAccount : BaseDailyPortraitRpt
    {
        string coa = "";
        int year = 0;
        int month = 0;
        ...
        public LNeracaPercobaanDetilAllAccount()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            try
            {
                this.AdditionalReportSubTitle = string.Format("(All Account)");
            }
            catch (Exception ex)
            {
            ...
            List<GetGLBalancePerGLAccountGRANOSTIC> listentity = BusinessLayer.GetGLBalancePerGLAccountGRANOSTICList(GLAccountID, year, month, PageIndex, NumRows);
            ...
            {
                foreach (GetGLBalancePerGLAccountGRANOSTIC item in listentity)
                {
