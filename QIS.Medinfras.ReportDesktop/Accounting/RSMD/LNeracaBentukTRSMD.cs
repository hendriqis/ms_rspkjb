...
{
    public partial class LNeracaBentukTRSMD : BaseDailyPortraitRpt
    {
        public LNeracaBentukTRSMD()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            Int32 lastDay = DateTime.DaysInMonth(Convert.ToInt32(param[1]), Convert.ToInt32(param[2]));
