...
{
    public partial class BMutasiAsetDanInventaris : BaseDailyPortraitRpt
    {
        public BMutasiAsetDanInventaris()
        {
            InitializeComponent();
        }
        ...
        {
            vFAItemMovementHd entityHd = BusinessLayer.GetvFAItemMovementHdList(param[0])[0];
