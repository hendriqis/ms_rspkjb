...
{
    public partial class LNeracaBentukTDetailPasiva : DevExpress.XtraReports.UI.XtraReport
    {
        List<GetGLBalancePerPeriodPerLevel> lstTemp = new List<GetGLBalancePerPeriodPerLevel>();

        public LNeracaBentukTDetailPasiva()
        {
            InitializeComponent();
        }
        ...
        private void rowTablePasiva_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
