...
{
    public partial class BFormPermohonanRawatBersamaRSBL : BaseCustomDailyPotraitRpt
    {
        public BFormPermohonanRawatBersamaRSBL()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            ParamedicMaster entityParamedic = BusinessLayer.GetParamedicMasterList(string.Format("ParamedicID = '{0}'", oPatientReferral.FromPhysicianID))[0];
