...
{
    public partial class LStatistikCatatanTerintegrasiSudahVerifikasiRSCK : BaseCustomDailyLandscapeRpt
    {
        public LStatistikCatatanTerintegrasiSudahVerifikasiRSCK()
        {
            InitializeComponent();
        }
