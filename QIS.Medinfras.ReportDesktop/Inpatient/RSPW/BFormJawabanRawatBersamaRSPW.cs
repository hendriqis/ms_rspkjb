...
{
    public partial class BFormJawabanRawatBersamaRSPW : BaseCustomDailyPotraitRpt
    {
        public BFormJawabanRawatBersamaRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            ttdDokter.ImageUrl = string.Format("{0}{1}/Signature/{2}.png", AppConfigManager.QISPhysicalDirectory, AppConfigManager.QISParamedicImagePath, oPatientReferral.ToPhysicianCode);
