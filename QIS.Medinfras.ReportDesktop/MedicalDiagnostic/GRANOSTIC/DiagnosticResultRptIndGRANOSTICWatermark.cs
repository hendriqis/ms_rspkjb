...
{
    public partial class DiagnosticResultRptIndGRANOSTICWatermark : BaseRpt
    {
        ...
        public DiagnosticResultRptIndGRANOSTICWatermark()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (reportMaster.IsShowHeader)
            {
                ...
                if (oHealthcare != null)
                {
                    ...
                    xrAddress.ImageUrl = ResolveUrl("~/SystemSetup/Libs/Images/Watermark_Tulisan.png");
