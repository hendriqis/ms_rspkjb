...
{
    public partial class BJobOrderRealizationMedicalPrescriptionA4 : BaseCustomDailyPotraitRpt
    {
        public BJobOrderRealizationMedicalPrescriptionA4()
        {
            InitializeComponent();
        }
            ...
            public override void InitializeReport(string[] param)
            {
                ...
                xrTableCell59.Text = entity.BusinessPartnerName;
                xrTableCell7.Text = entity.TransactionNo;
                xrTableCell32.Text = entity.PrescriptionOrderNo;
                xrTableCell52.Text = entity.RegistrationNo;
                xrTableCell62.Text = entity.ParamedicName;
                #endregion
