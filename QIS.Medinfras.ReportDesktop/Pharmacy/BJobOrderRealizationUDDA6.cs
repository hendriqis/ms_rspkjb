...
{
    public partial class BJobOrderRealizationUDDA6 : BaseCustomPharmacyA6v2Rpt
    {
        public BJobOrderRealizationUDDA6()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity.PrescriptionOrderID != null || entity.PrescriptionOrderID != '0')
            {
                ...
                if (entity.ServiceUnitName != "" || entity.RoomName !="")
                {
                cRuangan.Text = string.Format("{0} | {1}", entity.ServiceUnitName, entity.RoomName);
                }
                else
                {
                    cRuangan.Text = "";
        ...
        private void cTakenQty_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                cTakenQty.Text = GetCurrentColumnValue("ChargeQty").ToString();
            }
        }
