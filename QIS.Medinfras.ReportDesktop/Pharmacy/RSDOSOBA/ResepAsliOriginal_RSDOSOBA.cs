...
{
    public partial class ResepAsliOriginal_RSDOSOBA : BaseCustomA6Rpt

    {
        public ResepAsliOriginal_RSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cPhone.Text = oHealthcare.PhoneNo1;
            cFax.Text = oHealthcare.FaxNo1;
