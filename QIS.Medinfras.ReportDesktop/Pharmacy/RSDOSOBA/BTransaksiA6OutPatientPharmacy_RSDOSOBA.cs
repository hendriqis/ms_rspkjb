...
{
    public partial class BTransaksiA6OutPatientPharmacy_RSDOSOBA : BaseCustomA6Rpt
    {
        ...
        public BTransaksiA6OutPatientPharmacy_RSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cHealthcareAddress.Text = string.Format("{0} {1} {2}", entityHealthcare.StreetName, entityHealthcare.City, entityHealthcare.ZipCode);
            ...
            cVisitServiceUnitName.Text = string.Format("{0}", entity.VisitServiceUnitName);
            ...
            //}
            cParamedicName.Text = entityPres.ParamedicName;
            ...
            //lblReportProperties2.Text = string.Format("Print Date/Time:{0}, User:{1}", DateTime.Now.ToString("dd-MMM-yyyy/HH:mm:ss"), appSession.UserFullName);
