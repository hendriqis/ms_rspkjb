...
{
    public partial class LNarkotikaPerLokasiPerItem : BaseCustomDailyLandscapeRpt
    {
        public LNarkotikaPerLokasiPerItem()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            ItemMaster im = BusinessLayer.GetItemMaster(Convert.ToInt32(param[3].ToString()));
