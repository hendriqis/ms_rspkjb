...
{
    public partial class EPrescription_RSMM : BaseCustomPharmacyA5Rpt
    {
        public EPrescription_RSMM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cSU.Text = string.Format("{0}", entity.ServiceUnitName);
            cAllergy.Text = string.Format("{0}", entity.cfAllergy);
