...
{
    public partial class EPrescriptionA6RSSES : BaseCustomPharmacyA6v3Rpt
    {
        public EPrescriptionA6RSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            string sendOrderDatetime = string.Empty;
            if (entity.SendOrderDateTime != null && entity.SendOrderDateTime.ToString(Constant.FormatString.DATE_TIME_FORMAT) != "01-Jan-1900 00:00:00")
            {
                sendOrderDatetime =  entity.SendOrderDateTime.ToString(Constant.FormatString.DATE_TIME_FORMAT_2);
            }
            cServisUnitName.Text = string.Format("{0}|{1}", entity.ServiceUnitName, sendOrderDatetime);
