...
{
    public partial class ResepAsli_RSSES : BaseCustomPharmacyNoloopHeaderA6Rpt

    {
        public ResepAsli_RSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                if (entity.Salutation == null)
                {
                    cPatient.Text = string.Format("{0}| {1} | {2}", entity.PatientName, entity.MedicalNo, entity.Gender);
                }
                else
                {
                    cPatient.Text = string.Format("{0} {1} | {2} | {3}", entity.PatientName, entity.Salutation, entity.MedicalNo, entity.Gender);
                }
                ...
                if (lstRegPayer.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            payer += string.Format("{0}, ", rowdata.BusinessPartnerName);
                        }
                ...
                cServisUnitName.Text = string.Format("{0} | {1}", entity.ServiceUnitName, entity.cfSendOrderDateTime);
                cPrescription.Text = entity.JenisResep;
                cPrescriptionNo.Text = entity.TransactionNo;
                cSEPNo.Text = entity.NoSEP;
