...
{
    public partial class EPrescriptionRSSES : BaseCustomPharmacyA5Rpt
    {
        public EPrescriptionRSSES()
        {
            InitializeComponent();
        }
        ...
        {
            List<GetPrescriptionOrderDtCustom9> entityList = BusinessLayer.GetPrescriptionOrderDtCustom9List(param[0]);

            if (entityList.Count() > 0)
            {
                GetPrescriptionOrderDtCustom9 entity = entityList.FirstOrDefault();
        ...
        private void lblSignaLabel_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (GetCurrentColumnValue("GCDosingFrequency") != null)
            {
