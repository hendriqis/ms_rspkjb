...
{
    public partial class NotaResep1RptRSSES : BaseReceipt1Rpt
    {
        private int isCompound = 0;
        public NotaResep1RptRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            PatientChargesHd oData = BusinessLayer.GetPatientChargesHd(entity.TransactionID);
            if (oData != null) {
                lblQueueNo.Text = oData.ReferenceNo;
            }
        }
