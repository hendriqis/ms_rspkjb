...
{
    public partial class BJobOrderRealizationSignaRSSBB : BaseDailyPortraitRpt
    {
        public BJobOrderRealizationSignaRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vPatientChargesHd entityChargesHd = BusinessLayer.GetvPatientChargesHdList(string.Format("PrescriptionOrderID = {0}", entity.PrescriptionOrderID)).FirstOrDefault();
            ...
            if (entityReg.MRN != null && entityReg.MRN != 0)
            {
                ...
                cBPJSTransactionType.Text = entityChargesHd.BPJSTransactionType;
                ...
                if (String.IsNullOrEmpty(entity.AppointmentNo))
                {
                    contents = string.Format(@"{0},{1},{2},{3},{4};",
                        entity.ReferenceNoPrefix, entity.TransactionDateInString, entity.QueueNo, entity.MedicalNo, entity.RegistrationNo);
                }
