...
{
    public partial class BJobOrderRealizationSignaJWCC : BaseDailyPortraitRpt
    {
        public BJobOrderRealizationSignaJWCC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityReg.MRN != null && entityReg.MRN != 0)
            {
                ...
                {
                    string[] strData = entityOrderHd.ReferenceNo.Split('|');
                    if (strData.Length <= 2)
                    {
                        lblAntrian.Text = strData[1];
                        barCode.Text = lblAntrian.Text;
                    }
                }
                else {
                    lblAntrian.Visible = false;
                    barCode.Visible = false;
                }
                 #endregion
                //barCode = new XRBarCode()
                //{
                //    HeightF = 150,
                //    WidthF = 550,
