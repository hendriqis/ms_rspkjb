...
{
    public partial class ResepAsliOriginal_RSBL : BaseDailyPortraitRpt
    {
        public ResepAsliOriginal_RSBL()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                cNoHP.Text = entityPatient.cfMobilePhoneNo;

                cServiceUnitName.Text = string.Format("{0}", entity.ServiceUnitName);
