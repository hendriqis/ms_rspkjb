...
{
    public partial class EPrescriptionA6_RSSC : BaseCustomPharmacyA6Rpt
    {
        public EPrescriptionA6_RSSC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cRegistrationNo.Text = string.Format("{0} | {1} {2} | {3}", entity.RegistrationNo, entity.ActualVisitDateInString, entity.ActualVisitTime, entity.MedicalNo);
            ...
            cLocation.Text = entity.LocationName;
