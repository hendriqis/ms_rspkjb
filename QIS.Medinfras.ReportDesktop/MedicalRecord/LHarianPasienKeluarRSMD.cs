...
{
    public partial class LHarianPasienKeluarRSMD : BaseRpt
    {
        ...
        public LHarianPasienKeluarRSMD()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblReportProperties.Text = string.Format("MEDINFRAS - {0} | {1}, Print Date/Time:{2}, User ID:{3}",
