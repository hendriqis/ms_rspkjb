...
{
    public partial class MedicalAssesmentRpt : BaseRpt
    {

        public MedicalAssesmentRpt()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            episodeSummaryChiefComplaintRptNew1.InitializeReport(entityCV.VisitID);

            subPatientAllergies.CanGrow = true;
            episodeSummaryAllergyRptNew1.InitializeReport(entityCV.VisitID);

            #endregion

            #region Vital Sign
            subVitalSign.CanGrow = true;
            episodeSummaryVitalSignRptNew1.InitializeReport(entityCV.VisitID);
            #endregion

            #region Review of System
            subReviewOfSystem.CanGrow = true;
            episodeSummaryReviewOfSystemRptNew1.InitializeReport(entityCV.VisitID);
            #endregion

            #region Body Diagram
            subBodyDiagram.CanGrow = true;
            episodeSummaryBodyDiagramRptNew1.InitializeReport(entityCV.VisitID);
            #endregion

            #region Diagnosis
            subDiagnosis.CanGrow = true;
            episodeSummaryDiagnosisRptNew1.InitializeReport(entityCV.VisitID);
            #endregion

            #region Test Order
            subTestOrder.CanGrow = true;
            episodeSummaryTestOrderRptNew1.InitializeReport(entityCV.VisitID);
            #endregion

            #region Prescription
            subPrescription.CanGrow = true;
            episodeSummaryPrescriptionRptNew1.InitializeReport(entityCV.VisitID);
            #endregion
