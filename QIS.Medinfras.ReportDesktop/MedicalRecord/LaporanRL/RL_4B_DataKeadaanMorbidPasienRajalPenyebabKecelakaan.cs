...
{
    public partial class RL_4B_DataKeadaanMorbidPasienRajalPenyebabKecelakaan : BaseCustomDailyLandscapeA3Rpt
    {
        public RL_4B_DataKeadaanMorbidPasienRajalPenyebabKecelakaan()
        {
            InitializeComponent();
        }
