...
{
    public partial class MRDiagnoseClaimInformationNewInRSSES : DevExpress.XtraReports.UI.XtraReport
    {
        public MRDiagnoseClaimInformationNewInRSSES()
        {
            InitializeComponent();
        }
        ...
        {
            string filterExpression = string.Format("VisitID IN ({0}) AND GCDiagnoseType IN ('{1}') AND ClaimDiagnosisID IS NOT NULL AND IsDeleted = 0", VisitID, Constant.DiagnoseType.EARLY_DIAGNOSIS);
