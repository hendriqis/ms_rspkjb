...
{
    public partial class BResumeMedisKlaimRSSES : BaseRpt
    {
        public BResumeMedisKlaimRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vMedicalResume entity = BusinessLayer.GetvMedicalResumeList(string.Format("VisitID = {0} AND IsDeleted = 0 AND ISNULL(GCMedicalResumeStatus,'') NOT IN ('{1}')", entityCV.VisitID, Constant.MedicalResumeStatus.REVISED)).FirstOrDefault();
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis.Count() > 0)
                {
                    ...
                    MRDiagnoseClaimInformationNewInRSSES.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis2.Count() > 0)
                {
                    ...
                    MRDiagnoseClaimInformationNewOutRSSES.InitializeReport(entityCV.VisitID);
                }
                else
                {
