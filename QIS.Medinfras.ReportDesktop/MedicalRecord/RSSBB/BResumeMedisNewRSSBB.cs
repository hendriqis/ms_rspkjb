...
{
    public partial class BResumeMedisNewRSSBB : BaseRpt
    {
        public BResumeMedisNewRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (oHealthcare != null)
            {
                RSSBBKop.ImageUrl = ResolveUrl("~/SystemSetup/Libs/Images/PictureReportRSSBB.png");
            }
            #endregion
            ...
            if (entity != null)
            {
                ...
                if (lstBd.Count() > 0)
                {
                    ...
                    mrBodyDiagramNew.InitializeReport(entityCV.VisitID);
                }
                else
                {
