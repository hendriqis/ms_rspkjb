...
{
    public partial class BResumeMedisRSSK : BaseRpt
    {
        public BResumeMedisRSSK()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                subReviewOfSystemInRSSK.CanGrow = true;
                mrReviewOfSystemNewInRSSK.InitializeReport(entityCV.VisitID);
            }
            else
            {
                subReviewOfSystemInRSSK.Visible = false;
            }
            #endregion
            ...
            if (entity != null)
            {
                ...
                {
                    subReviewOfSystemOutRSSK.CanGrow = true;
                    mrReviewOfSystemNewOutRSSK.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
                    subReviewOfSystemOutRSSK.Visible = false;
                }
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                if (lstBd.Count() > 0)
                {
                    subBodyDiagramRSSK.CanGrow = true;
                    mrBodyDiagramRSSK.InitializeReport(entityCV.VisitID);
                }
                else
                {
                    subBodyDiagramRSSK.Visible = false;
