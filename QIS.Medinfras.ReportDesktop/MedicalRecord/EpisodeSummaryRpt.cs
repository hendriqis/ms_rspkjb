...
{
    public partial class EpisodeSummaryRpt : QIS.Medinfras.ReportDesktop.BaseRpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            episodeSummaryVitalSignRpt1.InitializeReport(entity.VisitID, 2);
            ...
            bool result = episodeSummaryBodyDiagramRpt1.InitializeReport(entity.VisitID);
            if (!result) lblBodyDiagram.Visible = false;

            sbrTestOrder.CanGrow = true;
            episodeSummaryTestOrderRpt1.InitializeReport(entity.VisitID);

            sbrPrescription.CanGrow = true;
            episodeSummaryPrescriptionRpt1.InitializeReport(entity.VisitID);
        }
    }
}
