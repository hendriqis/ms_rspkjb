...
{
    public partial class MRPrescriptionDischargeRSDI : DevExpress.XtraReports.UI.XtraReport
    {
        public MRPrescriptionDischargeRSDI()
        {
            InitializeComponent();
        }
        ...
        {
            string filterExpressionHD = string.Format("VisitID = {0} AND GCPrescriptionType = '{1}'",
                                                            VisitID,
