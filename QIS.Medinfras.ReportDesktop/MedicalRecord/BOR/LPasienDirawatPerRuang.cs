...
{
    public partial class LPasienDirawatPerRuang : BaseCustomDailyLandscapeA3Rpt
    {
        int Year = 0;
        int Month = 0;
        public LPasienDirawatPerRuang()
        {
            InitializeComponent();
        }
        ...
        private void lblBOR_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            List<GetIndicatorHospitalServiceUnitPerMonthPerYear> lst = BusinessLayer.GetIndicatorHospitalServiceUnitPerMonthPerYear(Year, Month);

            foreach (GetIndicatorHospitalServiceUnitPerMonthPerYear hd in lst)
            {
