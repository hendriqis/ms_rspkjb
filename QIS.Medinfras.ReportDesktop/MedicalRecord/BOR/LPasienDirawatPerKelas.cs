...
{
    public partial class LPasienDirawatPerKelas : BaseCustomDailyLandscapeA3Rpt
    {
        int Year = 0;
        int Month = 0;
        public LPasienDirawatPerKelas()
        {
            InitializeComponent();
        }
        ...
        private void lblBOR_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            List<GetIndicatorHospitalClassCarePerMonthPerYear> lst = BusinessLayer.GetIndicatorHospitalClassCarePerMonthPerYear(Year, Month);

            foreach (GetIndicatorHospitalClassCarePerMonthPerYear hd in lst)
            {
            ...
            {
                decimal jmlTTPerHari = (decimal)jmlhTempatTidur * (decimal)jmlHari;
        ...
        private void lblTOI_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (jmlhPasienKeluarLP != 0)
            {
                ...
                TOI = ((decimal)jmlTTPerHariPerawatan / jmlhPasienKeluarLP);
            } 
        ...
        private void lblNDR_P_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void lblGDR_L_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void lblGDR_P_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
