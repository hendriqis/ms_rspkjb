...
{
    public partial class BMedicalRecordRSSEB : BaseRpt
    {
        public BMedicalRecordRSSEB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityCV.DepartmentID == Constant.Facility.EMERGENCY)
            {
                xrLabel1.Text = string.Format("SURAT BUKTI PELAYANAN KESEHATAN (SBPK) IGD");
            }
            else
            {
                xrLabel1.Text = string.Format("SURAT BUKTI PELAYANAN KESEHATAN (SBPK)");
            }
            ...
            mrPhysicalExamRSSEB.InitializeReport(entityCV.VisitID);
            #endregion
