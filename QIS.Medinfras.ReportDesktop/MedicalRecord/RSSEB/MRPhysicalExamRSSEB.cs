...
{
    public partial class MRPhysicalExamRSSEB : DevExpress.XtraReports.UI.XtraReport
    {
        public MRPhysicalExamRSSEB()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(int visitID)
        {
            ...
            if (lstROSHd.Count() > 0)
            {
                ...
                mrdtReviewOfSystemRSSEB.InitializeReport(visitID);
            }
            else
            {
            ...
            if (lstTTVHd.Count() > 0)
            {
                ...
                mrdtVitalSignRSSEB.InitializeReport(visitID);
            }
            else
            {
