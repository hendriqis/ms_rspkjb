...
{
    public partial class BKajianIGD_Triase_RSDOSKA : DevExpress.XtraReports.UI.XtraReport
    {
        public BKajianIGD_Triase_RSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(int RegistrationID)
        {
            ...
            if (entityReg != null)
            {
                if (entityReg.ReferrerParamedicID != 0)
                {
                    xrTableCell8.Text = string.Format("{0} - {1}", entityReg.ReferrerGroup, entityReg.ReferrerParamedicName);
                }
                else if (entityReg.ReferrerID != 0)
                {
                    xrTableCell8.Text = string.Format("{0} - {1}", entityReg.ReferrerGroup, entityReg.ReferrerName);
                }
                else {
