...
{
    public partial class EREpisodeSummaryRSAJ : BaseRpt
    {

        public EREpisodeSummaryRSAJ()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cRPD.Text = entityMedical != null ? entityMedical.MedicalSummary : entityComplaint.PastMedicalHistory;
            cOtherHistory.Text = entityMedical != null ? entityMedical.MedicationSummary : entityComplaint.PastMedicationHistory;
