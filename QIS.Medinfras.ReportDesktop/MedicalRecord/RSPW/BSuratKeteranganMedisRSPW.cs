...
{
    public partial class BSuratKeteranganMedisRSPW : BaseRpt
    {

        public BSuratKeteranganMedisRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            #region Subjektif
            List<PatientAllergy> lstAllergy = BusinessLayer.GetPatientAllergyList(string.Format("MRN = {0} AND IsDeleted = 0", entityCV.MRN));
            ...
            List<PatientVisitNote> lstEntityVisit = BusinessLayer.GetPatientVisitNoteList(filterExpressionIN);
            ...
            #region Vital Sign
            List<VitalSignHd> lstVitalSignHdLast = BusinessLayer.GetVitalSignHdList(string.Format("VisitID = {0} AND IsDeleted = 0", entityCV.VisitID));
