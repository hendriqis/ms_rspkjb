...
{
    public partial class LCatatanPerkembanganPasienTerintegrasiRSPW : BaseRpt
    {

        public LCatatanPerkembanganPasienTerintegrasiRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            episodeSummaryIntegratedNotesRptRSPW.InitializeReport(entityCV.VisitID);
            #endregion
