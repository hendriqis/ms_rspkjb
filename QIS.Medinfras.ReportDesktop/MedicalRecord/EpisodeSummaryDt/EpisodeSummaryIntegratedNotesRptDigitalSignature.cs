...
{
    public partial class EpisodeSummaryIntegratedNotesRptDigitalSignature : DevExpress.XtraReports.UI.XtraReport
    {
        public EpisodeSummaryIntegratedNotesRptDigitalSignature()
        {
            InitializeComponent();
        }
