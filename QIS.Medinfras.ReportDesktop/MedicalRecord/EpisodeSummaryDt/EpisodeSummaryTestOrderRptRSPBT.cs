...
{
    public partial class EpisodeSummaryTestOrderRptRSPBT : DevExpress.XtraReports.UI.XtraReport
    {
        public EpisodeSummaryTestOrderRptRSPBT()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(int VisitID)
        {
            ...
            string filterExpressionHD = string.Format("VisitID = {0} AND GCTransactionStatus != '{1}' AND TestTo = '{2}'", VisitID, Constant.TransactionStatus.VOID , Constant.Module.LABORATORY);
            ...
            DetailReport.DataMember = "TestOrderHds.TestOrderDts";
        }
