...
{
    public partial class EpisodeSummaryBodyDiagramRpt : DevExpress.XtraReports.UI.XtraReport
    {
        public EpisodeSummaryBodyDiagramRpt()
        {
            InitializeComponent();
        }
        ...
        private void sbrBodyDiagramDt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (GetCurrentColumnValue("ID") != null)
            {
                ...
                ((EpisodeSummaryBodyDiagramDtRpt)subreport.ReportSource).InitializeReport(lstDt.Where(p => p.ID == ID).ToList());
                //subreport.In
            }
        }
