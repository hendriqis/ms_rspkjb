...
{
    public partial class BResumeMedisNewRSSM : BaseRpt
    {

        public BResumeMedisNewRSSM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                mrReviewOfSystemNewInRSSM.InitializeReport(entityCV.VisitID);
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                if (lstHdReviewOfSystem.Count() > 0)
                {
                    ...
                    mrReviewOfSystemNewOutRSSM.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewInRSSM.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis2.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewOutRSSM.InitializeReport(entityCV.VisitID);
                }
                else
                {
