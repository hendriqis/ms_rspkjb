...
{
    partial class LMorbiditasPasien
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LMorbiditasPasien));
            ...
            this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 412.75F);
            ...
            this.xrTableCell133.Text = "[MaleLessThan6]";
            ...
            this.GroupFooter2.HeightF = 5.08F;
            ...
            // mLess6D
            // 
            this.mLess6D.Expression = "iif([AgeInYear] = 0 \r\nAND [AgeInMonth] = 0\r\nAND [AgeInDay] <=6\r\nAND [GCSex]=\'0003" +
    "^M\',1,0)";
            this.mLess6D.Name = "mLess6D";
            // 
            // m7to27D
            // 
            this.m7to27D.Expression = "iif([AgeInYear] = 0 \r\nAND [AgeInMonth] = 0\r\nAND [AgeInDay] >6\r\nAND [AgeInDay] <=2" +
    "7\r\nAND [GCSex]=\'0003^M\',1,0)";
            ...
            // m1to4Y
            // 
            this.m1to4Y.Expression = "iif([AgeInYear]>=1\r\nAND [AgeInYear]<=4\r\nAND [GCSex]=\'0003^M\',1,0)";
            this.m1to4Y.Name = "m1to4Y";
            // 
            // m5to14Y
            // 
            this.m5to14Y.Expression = "iif([AgeInYear]>=5\r\nAND [AgeInYear]<=14\r\nAND [GCSex]=\'0003^M\',1,0)";
            this.m5to14Y.Name = "m5to14Y";
            // 
            // m15to24Y
            // 
            this.m15to24Y.Expression = "iif([AgeInYear]>=15\r\nAND [AgeInYear]<=24\r\nAND [GCSex]=\'0003^M\',1,0)";
            this.m15to24Y.Name = "m15to24Y";
            // 
            // m25to44Y
            // 
            this.m25to44Y.Expression = "iif([AgeInYear]>=25\r\nAND [AgeInYear]<=44\r\nAND [GCSex]=\'0003^M\',1,0)";
            this.m25to44Y.Name = "m25to44Y";
            // 
            // m45to64Y
            // 
            this.m45to64Y.Expression = "iif([AgeInYear]>=45\r\nAND [AgeInYear]<=64\r\nAND [GCSex]=\'0003^M\',1,0)";
            this.m45to64Y.Name = "m45to64Y";
            // 
            // mMore65Y
            // 
            this.mMore65Y.Expression = "iif([AgeInYear]>=65\r\nAND [GCSex]=\'0003^M\',1,0)";
            this.mMore65Y.Name = "mMore65Y";
            // 
            // fLess6D
            // 
            this.fLess6D.Expression = "iif([AgeInYear] = 0 \r\nAND [AgeInMonth] = 0\r\nAND [AgeInDay] <=6\r\nAND [GCSex]=\'0003" +
    "^F\',1,0)";
            this.fLess6D.Name = "fLess6D";
            // 
            // f7to27D
            // 
            this.f7to27D.Expression = "iif([AgeInYear] = 0 \r\nAND [AgeInMonth] = 0\r\nAND [AgeInDay] >6\r\nAND [AgeInDay] <=2" +
    "7\r\nAND [GCSex]=\'0003^F\',1,0)";
            ...
            // f1to4Y
            // 
            this.f1to4Y.Expression = "iif([AgeInYear]>=1\r\nAND [AgeInYear]<=4\r\nAND [GCSex]=\'0003^F\',1,0)";
            this.f1to4Y.Name = "f1to4Y";
            // 
            // f5to14Y
            // 
            this.f5to14Y.Expression = "iif([AgeInYear]>=5\r\nAND [AgeInYear]<=14\r\nAND [GCSex]=\'0003^F\',1,0)";
            this.f5to14Y.Name = "f5to14Y";
            // 
            // f15to24Y
            // 
            this.f15to24Y.Expression = "iif([AgeInYear]>=15\r\nAND [AgeInYear]<=24\r\nAND [GCSex]=\'0003^F\',1,0)";
            this.f15to24Y.Name = "f15to24Y";
            // 
            // f25to44Y
            // 
            this.f25to44Y.Expression = "iif([AgeInYear]>=25\r\nAND [AgeInYear]<=44\r\nAND [GCSex]=\'0003^F\',1,0)";
            this.f25to44Y.Name = "f25to44Y";
            // 
            // f45to64Y
            // 
            this.f45to64Y.Expression = "iif([AgeInYear]>=45\r\nAND [AgeInYear]<=64\r\nAND [GCSex]=\'0003^F\',1,0)";
            this.f45to64Y.Name = "f45to64Y";
            // 
            // fMore65Y
            // 
            this.fMore65Y.Expression = "iif([AgeInYear]>=65\r\nAND [GCSex]=\'0003^F\',1,0)";
            this.fMore65Y.Name = "fMore65Y";
            // 
            // sumDeath
            // 
            this.sumDeath.Expression = "iif([PatientDied] = \'1\',1,0)";
            this.sumDeath.Name = "sumDeath";
            // 
            // sumMale
            // 
            this.sumMale.Expression = "iif([GCSex]=\'0003^M\',1,0)";
            this.sumMale.Name = "sumMale";
            // 
            // sumFemale
            // 
            this.sumFemale.Expression = "iif([GCSex]=\'0003^F\',1,0)";
            ...
            this.xrLabel1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 317.5F);
            this.xrLabel1.Name = "xrLabel1";
            this.xrLabel1.Padding = new DevExpress.XtraPrinting.PaddingInfo(5, 5, 0, 0, 254F);
            this.xrLabel1.SizeF = new System.Drawing.SizeF(2825.75F, 31.75F);
            this.xrLabel1.StylePriority.UseFont = false;
            this.xrLabel1.StylePriority.UseTextAlignment = false;
            this.xrLabel1.Text = "Tanggal : [StartDate!dd-MMM-yyyy]";
