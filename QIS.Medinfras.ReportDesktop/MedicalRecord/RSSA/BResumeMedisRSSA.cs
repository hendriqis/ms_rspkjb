...
{
    public partial class BResumeMedisRSSA : BaseRpt
    {

        public BResumeMedisRSSA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            string contents2 = string.Format(@"{0}\r\n{1}",
                entityPM.FullName, entityPM.LicenseNo);
            ...
            if (entity != null)
            {
                List<vMedicalResume> lstMedicalResume = BusinessLayer.GetvMedicalResumeList(string.Format("VisitID = {0} AND IsDeleted = 0 AND IsRevised = 0 ORDER BY ID DESC", entityCV.VisitID));
            ...
            if (entity != null)
            {
                List<vMedicalResume> lstMedicalResume2 = BusinessLayer.GetvMedicalResumeList(string.Format("VisitID = {0} AND IsDeleted = 0 AND IsRevised = 0 ORDER BY ID DESC", entityCV.VisitID));
            ...
            if (entity != null)
            {
                List<vMedicalResume> lstMedicalResume5 = BusinessLayer.GetvMedicalResumeList(string.Format("VisitID = {0} AND IsDeleted = 0 AND IsRevised = 0 ORDER BY ID DESC", entityCV.VisitID));

                if (lstMedicalResume5.Count() > 0)
                {
                    subSummaryNew.CanGrow = true;
                    mrSummaryNewRSSA.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
                    subSummaryNew.Visible = false;
                }
            }
            else
            {
            ...
            if (entity != null)
            {
                List<vMedicalResume> lstMedicalResume4 = BusinessLayer.GetvMedicalResumeList(string.Format("VisitID = {0} AND IsDeleted = 0 AND IsRevised = 0 ORDER BY ID DESC", entityCV.VisitID));
