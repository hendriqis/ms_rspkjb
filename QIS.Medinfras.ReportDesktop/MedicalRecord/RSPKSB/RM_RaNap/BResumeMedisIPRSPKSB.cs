...
{
    public partial class BResumeMedisIPRSPKSB : BaseRpt
    {
        public BResumeMedisIPRSPKSB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                if (lstMedicalResume.Count() > 0)
                {
                    if (lstMedicalResume.FirstOrDefault().SubjectiveResumeText != null)
                    {
                        ...
                        mrSummaryRSPKSB.InitializeReport(entityCV.VisitID, entity.ID);
                    }
                    else
                    {
            ...
            if (entity != null)
            {
                ...
                mrReviewOfSystemNewInRSPKSB.InitializeReport(entityCV.VisitID);
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                mrVitalSignNewMRInRSPKSB.InitializeReport(entityCV.VisitID);
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewInIPRSPKSB.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis2.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewOutIPRSPKSB.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstCV1.Count() > 0)
                {
                    ...
                    mrDischargeRSPKSB.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
