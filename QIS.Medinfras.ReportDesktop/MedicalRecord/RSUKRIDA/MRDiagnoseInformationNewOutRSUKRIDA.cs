...
{
    public partial class MRDiagnoseInformationNewOutRSUKRIDA : DevExpress.XtraReports.UI.XtraReport
    {
        public MRDiagnoseInformationNewOutRSUKRIDA()
        {
            InitializeComponent();
        }
        ...
        {
            string filterExpression = string.Format("VisitID IN ({0}) AND GCDiagnoseType IN ('{1}','{2}') AND IsDeleted = 0 ORDER BY GCDiagnoseType ASC", VisitID, Constant.DiagnoseType.MAIN_DIAGNOSIS, Constant.DiagnoseType.COMPLICATION);
