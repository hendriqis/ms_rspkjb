...
{
    public partial class BResumeMedisNewRSUKRIDA : BaseRpt
    {
        public BResumeMedisNewRSUKRIDA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                mrReviewOfSystemNewInRSUKRIDA.InitializeReport(entityCV.VisitID);
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                if (lstHdReviewOfSystem.Count() > 0)
                {
                    ...
                    mrReviewOfSystemNewOutRSUKRIDA.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                mrVitalSignNewMRInRSUKRIDA.InitializeReport(entityCV.VisitID);
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                if (lstHdVitalSign.Count() > 0)
                {
                    ...
                    mrVitalSignNewMROutRSUKRIDA.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewInRSUKRIDA.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis2.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewOutRSUKRIDA.InitializeReport(entityCV.VisitID);
                }
                else
                {
