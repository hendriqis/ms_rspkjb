...
{
    public partial class LPasienMasukKeluarPerUsiaPerSMF : BaseCustomDailyLandscapeA3Rpt
    {
        public LPasienMasukKeluarPerUsiaPerSMF()
        {
            InitializeComponent();
        }
        public override void InitializeReport(string[] param)
        {
            if (reportMaster.ObjectTypeName == "GetPatientVisitPerAgePerSMF")
            {
                List<GetPatientVisitPerAgePerSMF> lstEntity = BusinessLayer.GetPatientVisitPerAgePerSMFList(Convert.ToInt32(param[0]), Convert.ToInt32(param[1]));
            ...
            else if (reportMaster.ObjectTypeName == "GetPatientDischargePerAgePerSMF")
            {
                List<GetPatientDischargePerAgePerSMF> lstEntity = BusinessLayer.GetPatientDischargePerAgePerSMFList(Convert.ToInt32(param[0]), Convert.ToInt32(param[1]));
