...
{
    public partial class MRVitalSignNew : DevExpress.XtraReports.UI.XtraReport
    {
        public MRVitalSignNew()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(int VisitID, int MedicalResumeID)
        {
            ...
            List<vVitalSignHd> lstHd = BusinessLayer.GetvVitalSignHdList(filterExpression);
            List<vVitalSignDt> lstDt = BusinessLayer.GetvVitalSignDtList(filterExpression);
            ...
            var lst = (from p in lstHd
                       select new
                       {
                           ...
                           Remarks = string.Format("{0}", p.Remarks),
