...
{
    public partial class MRPrescriptionOriginal : DevExpress.XtraReports.UI.XtraReport
    {
        public MRPrescriptionOriginal()
        {
            InitializeComponent();
        }
        ...
        {
            string filterExpressionHD = string.Format("VisitID = {0} AND GCTransactionStatus != '{1}' AND GCPrescriptionType != '{2}'", VisitID, Constant.TransactionStatus.VOID, Constant.PrescriptionType.DISCHARGE_PRESCRIPTION);
            List<vPrescriptionOrderHdOriginal> lstEntityHd = BusinessLayer.GetvPrescriptionOrderHdOriginalList(filterExpressionHD);
            ...
            List<vPrescriptionOrderDtOriginal> lstEntityDt = BusinessLayer.GetvPrescriptionOrderDtOriginalList(filterExpressionDT);
