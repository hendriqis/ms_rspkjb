...
{
    public partial class BResumeMedisNewRSAJ : BaseRpt
    {
        public BResumeMedisNewRSAJ()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblReportReferenceNo.Text = reportMaster.ReportReferenceNo;
            ...
            {
                if (entityCV.PlanDischargeDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) == Constant.ConstantDate.DEFAULT_NULL)
                {
                ...
                {
                    cDischargeDateTime.Text = string.Format("Tgl & Jam Keluar** : {0}", entityCV.cfPlanDischargeDate);
                }
            }
            else
            {
            ...
            if (entityCV.PhysicianDischargedDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != Constant.ConstantDate.DEFAULT_NULL || entityCV.DischargeDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != Constant.ConstantDate.DEFAULT_NULL || entityCV.PlanDischargeDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != Constant.ConstantDate.DEFAULT_NULL)
            {
            ...
            if (entity != null)
            {
                subReviewOfSystemInRSSC.CanGrow = true;
                mrReviewOfSystemNewInRSSC.InitializeReport(entityCV.VisitID);
            }
            else
            {
                subReviewOfSystemInRSSC.Visible = false;
            }
            #endregion
            ...
            if (entity != null)
            {
                ...
                {
                    subReviewOfSystemOutRSSC.CanGrow = true;
                    mrReviewOfSystemNewOutRSSC.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
                    subReviewOfSystemOutRSSC.Visible = false;
                }
            }
            else
            {
            ...
            if (entity != null)
            {
                subVitalSignInRSSC.CanGrow = true;
                mrVitalSignNewMRInRSSC.InitializeReport(entityCV.VisitID);
            }
            else
            {
                subVitalSignInRSSC.Visible = false;
            }
            #endregion
            ...
            if (entity != null)
            {
                ...
                {
                    subVitalSignOutRSSC.CanGrow = true;
                    mrVitalSignNewMROutRSSC.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
                    subVitalSignOutRSSC.Visible = false;
                }
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                {
                    subDiagnoseInRSSC.CanGrow = true;
                    mrDiagnoseInformationNewInRSSC.InitializeReport(entityCV.VisitID);
                }
                else
                {
                    subDiagnoseInRSSC.Visible = false;
                }
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                {
                    subDiagnoseOutRSSC.CanGrow = true;
                    mrDiagnoseInformationNewOutRSSC.InitializeReport(entityCV.VisitID);
                }
                else
                {
                    subDiagnoseOutRSSC.Visible = false;
                }
            }
            else
            {
            ...
            lblReportProperties.Text = string.Format("MEDINFRAS - {0}, Print Date/Time:{1}, User ID:{2}", reportMaster.ReportCode, DateTime.Now.ToString("dd-MMM-yyyy/HH:mm:ss"), appSession.UserFullName);
            #endregion
        }
    }
}
