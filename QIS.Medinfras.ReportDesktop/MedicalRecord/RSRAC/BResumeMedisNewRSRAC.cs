...
{
    public partial class BResumeMedisNewRSRAC : BaseRpt
    {
        public BResumeMedisNewRSRAC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            //ConsultVisit entityLinkedCV = new ConsultVisit();
            ...
            cUmur.Text = entityCV.PatientAge;
            ...
            {
                xrLabel23.Text = string.Format("RINGKASAN PASIEN PULANG IGD\n(DISCHARGE SUMMARY)");
            }
            else
            {
            ...
            else if (entityReg.LinkedRegistrationID != null)
            {
                ...
                if (entityLinkedCV.ParamedicID != null || entityLinkedCV.ParamedicID != 0)
                {
            ...
            else
            {
                if (entityCV.DischargeDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) == Constant.ConstantDate.DEFAULT_NULL)
                {
                    cDischargeDateTime.Text = string.Format("Tgl & Jam Keluar* : {0} {1}", entityCV.cfPhysicianDischargedDateOrderInString, entityCV.PhysicianDischargeOrderTime);
                }
                else
                {
                    cDischargeDateTime.Text = string.Format("Tgl & Jam Keluar** : {0}", entityCV.cfDischargeDateTimeInString);
            ...
            if (entity != null)
            {
                List<vPatientTransferHistoryRegistration> lstPatientTransfer = BusinessLayer.GetvPatientTransferHistoryRegistrationList(string.Format("RegistrationID = {0}", entityCV.RegistrationID));

                if (lstPatientTransfer.Count() > 0)
                {
                    subPatientTransfer.CanGrow = true;
                    mrPatientTransfer.InitializeReport(entityCV.RegistrationID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstRosHd.Count() > 0)
                {
                    ...
                    mrReviewOfSystemNewInRSRAC.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entityCV.DepartmentID == Constant.Facility.INPATIENT)
            {
                if (entity != null)
                {
                    ...
                    if (lstHdReviewOfSystem.Count() > 0)
                    {
                        ...
                        mrReviewOfSystemNewOutRSRAC.InitializeReport(entityCV.VisitID, entity.ID);
                    }
                    else
                    {
            ...
            if (entity != null)
            {
                ...
                if (lstHdVitalSign.Count() > 0)
                {
                    ...
                    mrVitalSignNewMRInRSRAC.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entityCV.DepartmentID == Constant.Facility.INPATIENT)
            {
                if (entity != null)
                {
                    ...
                    if (lstHdVitalSign.Count() > 0)
                    {
                        ...
                        mrVitalSignNewMROutRSRAC.InitializeReport(entityCV.VisitID, entity.ID);
                    }
                    else
                    {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewInRSRAC.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis2.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewOutRSRAC.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientReferral.Count() > 0)
                {
                    ...
                    mrReferralRSRAC.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            {
                lblTTDTanggal.Text = string.Format("{0}, {1} {2}", oHealthcare.City, entityCV.cfPhysicianDischargedDateOrderInString, entityCV.PhysicianDischargeOrderTime);
            }
