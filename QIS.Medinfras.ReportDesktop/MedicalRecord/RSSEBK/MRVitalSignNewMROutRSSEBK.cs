...
{
    public partial class MRVitalSignNewMROutRSSEBK : DevExpress.XtraReports.UI.XtraReport
    {
        public MRVitalSignNewMROutRSSEBK()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(int VisitID, int MedicalResumeID)
        {
            ...
            if (entityHd != null)
            {
                ...
                List<vVitalSignDt> lstDt = BusinessLayer.GetvVitalSignDtList(string.Format("ID = {0} AND IsDeleted = 0 ORDER BY DisplayOrder", entityHd.ID));
