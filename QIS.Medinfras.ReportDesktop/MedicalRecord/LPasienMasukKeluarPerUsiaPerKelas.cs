...
{
    public partial class LPasienMasukKeluarPerUsiaPerKelas : BaseCustomDailyLandscapeA3Rpt
    {
        public LPasienMasukKeluarPerUsiaPerKelas()
        {
            InitializeComponent();
        }
        public override void InitializeReport(string[] param)
        {
            if (reportMaster.ObjectTypeName == "GetPatientVisitPerAgePerClass")
            {
                List<GetPatientVisitPerAgePerClass> lstEntity = BusinessLayer.GetPatientVisitPerAgePerClassList(Convert.ToInt32(param[0]), Convert.ToInt32(param[1]));
            ...
            else if (reportMaster.ObjectTypeName == "GetPatientDischargePerAgePerClass")
            {
                List<GetPatientDischargePerAgePerClass> lstEntity = BusinessLayer.GetPatientDischargePerAgePerClassList(Convert.ToInt32(param[0]), Convert.ToInt32(param[1]));
