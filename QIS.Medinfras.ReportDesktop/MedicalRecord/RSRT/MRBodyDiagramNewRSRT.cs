...
{
    public partial class MRBodyDiagramNewRSRT : DevExpress.XtraReports.UI.XtraReport
    {
        public MRBodyDiagramNewRSRT()
        {
            InitializeComponent();
        }
        ...
        private void sbrMRBodyDiagramDtNew_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (GetCurrentColumnValue("ID") != null)
            {
                ...
                ((MRBodyDiagramDtNew)subreport.ReportSource).InitializeReport(lstDt.Where(p => p.ID == ID).ToList());
                //subreport.In
            }
        }
