...
{
    public partial class BResumeMedisNewRSRT : BaseRpt
    {

        public BResumeMedisNewRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<PatientAllergy> lstPatientAllergy = BusinessLayer.GetPatientAllergyList(string.Format("MRN = {0} AND IsDeleted = 0", entityCV.MRN));
            if (lstPatientAllergy.Count > 0) {
                int total = lstPatientAllergy.Count;
                string txtAllergy = string.Empty;
                foreach (PatientAllergy row in lstPatientAllergy) {

                    txtAllergy += string.Format("{0},", row.Allergen);
                }
                lblPatientlAlergy.Text = txtAllergy.Remove(txtAllergy.Length - 1);
            }
            ...
            if (entity != null)
            {
                ...
                if (lstMedicalResume.Count() > 0)
                {
                    ...
                    mrSummaryNewRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                mrReviewOfSystemNewInRSRT.InitializeReport(entityCV.VisitID);
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                if (lstHdReviewOfSystem.Count() > 0)
                {
                    ...
                    mrReviewOfSystemNewOutRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                mrVitalSignNewMRInRSRT.InitializeReport(entityCV.VisitID);
            }
            else
            {
            ...
            if (entity != null)
            {
                ...
                if (lstHdVitalSign.Count() > 0)
                {
                    ...
                    mrVitalSignNewMROutRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstMedicalResume1.Count() > 0)
                {
                    ...
                    mrDiagnosticExamNewMRRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewInRSRT.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientDiagnosis2.Count() > 0)
                {
                    ...
                    mrDiagnoseInformationNewOutRSRT.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientReferral.Count() > 0)
                {
                    ...
                    mrReferralRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstBd.Count() > 0)
                {
                    ...
                    mrBodyDiagramRSRT.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstMedicalResume2.Count() > 0)
                {
                    ...
                    mrTherapyPengobatanNewRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstMedicalResume4.Count() > 0)
                {
                    ...
                    mrSurgeryNewRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstCV1.Count() > 0)
                {
                    ...
                    mrDischargeRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
            ...
            if (entity != null)
            {
                ...
                if (lstMedicalResume5.Count() > 0)
                {
                    ...
                    mrInstructionNewRSRT.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
