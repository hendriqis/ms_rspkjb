...
{
    public partial class BResumeMedisNewRSRA : BaseRpt
    {
        public BResumeMedisNewRSRA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                if (lstRosHd.Count() > 0)
                {
                    ...
                    mrReviewOfSystemNewInRSRA.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entityCV.DepartmentID == Constant.Facility.INPATIENT)
            {
                if (entity != null)
                {
                    ...
                    if (lstHdReviewOfSystem.Count() > 0)
                    {
                        ...
                        mrReviewOfSystemNewOutRSRA.InitializeReport(entityCV.VisitID, entity.ID);
                    }
                    else
                    {
            ...
            if (entity != null)
            {
                ...
                if (lstHdVitalSign.Count() > 0)
                {
                    ...
                    mrVitalSignNewMRInRSRA.InitializeReport(entityCV.VisitID);
                }
                else
                {
            ...
            if (entityCV.DepartmentID == Constant.Facility.INPATIENT)
            {
                if (entity != null)
                {
                    ...
                    if (lstHdVitalSign.Count() > 0)
                    {
                        ...
                        mrVitalSignNewMROutRSRA.InitializeReport(entityCV.VisitID, entity.ID);
                    }
                    else
                    {
            ...
            if (entity != null)
            {
                ...
                if (lstPatientReferral.Count() > 0)
                {
                    ...
                    mrReferralRSRA.InitializeReport(entityCV.VisitID, entity.ID);
                }
                else
                {
