...
{
    public partial class BNew2MCUResultKKDI : BaseCustomDailyPotraitRpt
    {
        public BNew2MCUResultKKDI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            #region MCU Result2
            subMCUResult2.CanGrow = true;
            BMCUResultResultDt2.InitializeReport(cv.VisitID);
            #endregion
