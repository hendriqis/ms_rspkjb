...
{
    public partial class BNew2MCUResultResultDt : DevExpress.XtraReports.UI.XtraReport
    {
        public BNew2MCUResultResultDt()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(int visitID)
        {
            ...
            List<vMCUResult2> lst = BusinessLayer.GetvMCUResult2List(filterExpression);
            this.DataSource = lst;
        }
    }
}
