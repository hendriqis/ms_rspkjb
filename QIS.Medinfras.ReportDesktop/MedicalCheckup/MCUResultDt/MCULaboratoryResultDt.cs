...
{
    public partial class MCULaboratoryResultDt : DevExpress.XtraReports.UI.XtraReport
    {
        public MCULaboratoryResultDt()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(int VisitID)
        {
            ...
            string filterExpressionDT = string.Format("VisitID = {0} AND IsDeleted = 0 AND IsNormal = 0", VisitID);
