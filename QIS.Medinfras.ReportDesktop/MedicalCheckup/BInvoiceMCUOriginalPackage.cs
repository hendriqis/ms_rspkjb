...
{
    public partial class BInvoiceMCUOriginalPackage : BaseCustomDailyPotraitRpt
    {
        public BInvoiceMCUOriginalPackage()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetMCUDetailOriginalPackageTariff> lstHDDT = BusinessLayer.GetMCUDetailOriginalPackageTariffList(entityReg.RegistrationID);
            ...
            bInvoiceMCUOriginalPackageDetailRpt.InitializeReport(lstHDDT);
            #endregion
