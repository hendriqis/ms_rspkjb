...
{
    public partial class BFormHasilMCUInternalRSP : BaseCustomDailyPotraitMCURptRSRT
    {
        public int _lineNumber;
        public BFormHasilMCUInternalRSP()
        {
            InitializeComponent();
        }
        ...
        { 
            ...
            vConsultVisitItemPackage CVIP = BusinessLayer.GetvConsultVisitItemPackageList(string.Format("RegistrationID = {0}", cv.RegistrationID), 1, 1, "ID ASC").FirstOrDefault();
            if (CVIP != null)
            {
                lblItemName.Text = CVIP.ItemName1;
            }
            ...
            if (lst.Count > 0)
            {
                ...
                foreach (vMCUResultFormReport row in lst)
                {
                    ...
                    if (data.Length > 0)
                    {
                        ...
                        oData.Posisi = row.MaritalStatus;
                            ...
                            if (field.Length > 1)
                            {
                                ...
                                switch (field[0])
                                {
                                    ...
                                    case "215":
                                        ...
                                        break;
                                    case "216":
                                        oData.Col216 = dataFieldValue;
                                        break;
                                    case "217":
                                        oData.Col217 = dataFieldValue;
                                        break;
                                    case "218":
                                        oData.Col218 = dataFieldValue;
                                        break;
                                    case "219":
                                        oData.Col219 = dataFieldValue;
                                        break;
                                    case "220":
                                        oData.Col220 = dataFieldValue;
                                        break;
                                    case "221":
                                        oData.Col221 = dataFieldValue;
                                        break;
                                    case "222":
                                        oData.Col222 = dataFieldValue;
                                        break;
                                    case "223":
                                        oData.Col223 = dataFieldValue;
                                        break;
                                    case "224":
                                        oData.Col224 = dataFieldValue;
                                        break;
                                    case "225":
                                        oData.Col225 = dataFieldValue;
                                        break;
                                    case "226":
                                        oData.Col226 = dataFieldValue;
                                        break;
                                    case "227":
                                        oData.Col227 = dataFieldValue;
                                        break;
                                    case "228":
                                        oData.Col228 = dataFieldValue;
                                        break;
                                    case "229":
                                        oData.Col229 = dataFieldValue;
                                        break;
                                    case "230":
                                        oData.Col230 = dataFieldValue;
                                        break;
                                    case "231":
                                        oData.Col231 = dataFieldValue;
                                        break;
                                    case "232":
                                        oData.Col232 = dataFieldValue;
                                        break;
                                    case "233":
                                        oData.Col233 = dataFieldValue;
                                        break;
                                    case "234":
                                        oData.Col234 = dataFieldValue;
                                        break;
                                    case "235":
                                        oData.Col235 = dataFieldValue;
                                        break;
                                    case "236":
                                        oData.Col236 = dataFieldValue;
                                        break;
                                    case "237":
                                        oData.Col237 = dataFieldValue;
                                        break;
                                    case "238":
                                        oData.Col238 = dataFieldValue;
                                        break;
                                    case "239":
                                        oData.Col239 = dataFieldValue;
                                        break;
                                    case "240":
                                        oData.Col240 = dataFieldValue;
                                        break;
                                    case "241":
                                        oData.Col241 = dataFieldValue;
                                        break;
                                    case "242":
                                        oData.Col242 = dataFieldValue;
                                        break;
                                    case "243":
                                        oData.Col243 = dataFieldValue;
                                        break;
                                    case "244":
                                        oData.Col244 = dataFieldValue;
                                        break;
                                    case "245":
                                        oData.Col245 = dataFieldValue;
                                        break;
                                    case "246":
                                        oData.Col246 = dataFieldValue;
                                        break;
                                    case "247":
                                        oData.Col247 = dataFieldValue;
                                        break;
                                    case "248":
                                        oData.Col248 = dataFieldValue;
                                        break;
                                    case "249":
                                        oData.Col249 = dataFieldValue;
                                        break;
                                    case "250":
                                        oData.Col250 = dataFieldValue;
                                        break;
                                    case "251":
                                        oData.Col251 = dataFieldValue;
                                        break;
                                    case "252":
                                        oData.Col252 = dataFieldValue;
                                        break;
                                    case "253":
                                        oData.Col253 = dataFieldValue;
                                        break;
                                    case "254":
                        ...
                        Col39.Text = oData.Col39;
                        if (!string.IsNullOrEmpty(oData.Col39))
                        {
                            Col39.Text = new CultureInfo("en-US").TextInfo.ToTitleCase(oData.Col39);
                        }
                        ...
                        Col72.Text = string.Format("{0} {1}", oData.Col72, oData.Col211);
                        Col73.Text = string.Format("{0} {1}", oData.Col73, oData.Col212);
                        Col76.Text = oData.Col76;
                        string strCol68 = oData.Col68;
                        ...
                        //    Col89.Checked = true;
                        //}
                        Col90.Text = string.Format("{0} {1} {2}", oData.Col90, oData.Col91, oData.Col211);
                        ...
                        Col94.Text = string.Format("{0} {1} {2}", oData.Col94, oData.Col95, oData.Col213);
                        ...
                        Col101.Text = string.Format("{0} {1}",oData.Col101, oData.Col162);
                        ...
                        Col112.Text = string.Format("{0} {1}",oData.Col112, oData.Col162);
                        Col113.Text = string.Format("{0} {1}", oData.Col113, oData.Col163);
                        Col114.Text = string.Format("{0} {1}", oData.Col114, oData.Col164);
                        Col115.Text = string.Format("{0} {1}", oData.Col115, oData.Col165);
                        Col116.Text = string.Format("{0} {1}", oData.Col116, oData.Col166);
                        Col117.Text = string.Format("{0} {1}", oData.Col117, oData.Col167);
                        Col118.Text = string.Format("{0} {1} {2}", oData.Col118, oData.Col119, oData.Col168);
                        ...
                        Col120.Text = string.Format("{0} {1}", oData.Col120, oData.Col219);
                        Col121.Text = string.Format("{0} {1}", oData.Col121, oData.Col220);
                        Col122.Text = string.Format("{0} {1}", oData.Col122, oData.Col221);
                        Col123.Text = string.Format("{0} {1}", oData.Col123, oData.Col257);
                        Col124.Text = string.Format("{0} {1}", oData.Col124, oData.Col218);

                        Col125.Text = string.Format("{0} {1}", oData.Col125, oData.Col81);
                        Col126.Text = string.Format("{0} {1}", oData.Col126, oData.Col82);
                        Col127.Text = string.Format("{0} {1}", oData.Col127, oData.Col83);
                        Col128.Text = string.Format("{0} {1}", oData.Col128, oData.Col84);
                        Col129.Text = string.Format("{0} {1} {2}", oData.Col129, oData.Col130, oData.Col85);
                        ...
                        Col138.Text = string.Format("{0} {1}", oData.Col138, oData.Col215);
                        Col139.Text = string.Format("{0} {1}", oData.Col139, oData.Col216);
                        Col140.Text = string.Format("{0} {1}", oData.Col140, oData.Col217);
                        ...
                        Col203.Text = oData.Col203;
                        Col204.Text = oData.Col204;
                        Col205.Text = oData.Col205;
                        Col206.Text = oData.Col206;
                        Col207.Text = oData.Col207;
                        Col208.Text = oData.Col208;


                        string lblHipertensi = string.Format("{0}", oData.Col152);
                        if (oData.Col152 == "Ya")
                        {
                            lblHipertensi = string.Format("{0}, {1}", oData.Col152, oData.Col153);
                        }
                        Col152.Text = lblHipertensi;

                        //string lblDiabetes = string.Format("{0}", oData.Col154);
                        //if (oData.Col154 == "Ya")
                        //{
                        //    lblDiabetes = string.Format("{0}, {1}", oData.Col154, oData.Col210);
                        //}
                       /// Col154.Text = lblDiabetes;

                       /// Col159.Text = oData.Col158;
                        Col155.Text = oData.Col155;
                        if (!string.IsNullOrEmpty(oData.Col156))
                        {
                            Col155.Text = string.Format("{0},{1}", oData.Col155, oData.Col156);
                        }
                        ...
                        //#endregion
                        if (!string.IsNullOrEmpty(oData.Col222))
                        {
                            Col222.Text = oData.Col222;
                        }
                        else {
                            Col222.Text = ""; 
                        }

                        Col223.Text = oData.Col223;
                        Col224.Text = oData.Col224;
                        Col225.Text = oData.Col225;
                        Col226.Text = oData.Col226;
                        Col227.Text = oData.Col227;
                        Col228.Text = oData.Col228;
                        Col229.Text = oData.Col229;
                        Col230.Text = oData.Col230;

                        Col231.Text = oData.Col231;
                        Col232.Text = oData.Col232;
                        Col233.Text = oData.Col233;
                        Col234.Text = oData.Col234;
                        Col235.Text = oData.Col235;
                        Col236.Text = oData.Col236;
                        Col237.Text = oData.Col237;
                        Col238.Text = oData.Col238;

                        Col239.Text = oData.Col239;
                        Col240.Text = oData.Col240;
                        Col241.Text = oData.Col241;
                        Col242.Text = oData.Col242;
                        Col243.Text = oData.Col243;
                        Col244.Text = oData.Col244;
                        Col245.Text = oData.Col245;
                        Col246.Text = oData.Col246;
                        Col247.Text = oData.Col247;

                        Col250.Text = oData.Col250;
                        Col251.Text = oData.Col251;
                        Col252.Text = oData.Col252;
                        Col253.Text = oData.Col253;
                        Col254.Text = oData.Col254;
                        Col255.Text = oData.Col255;
                        Col256.Text = oData.Col256;

                        Col210.Text = oData.Col210;
        ...
        private void xrLine1_AfterPrint(object sender, EventArgs e)
        {
