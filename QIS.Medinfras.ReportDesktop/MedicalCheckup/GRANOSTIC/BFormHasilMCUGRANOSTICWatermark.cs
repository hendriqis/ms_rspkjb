...
{
    public partial class BFormHasilMCUGRANOSTICWatermark : BaseCustomDailyPotraitRpt
    {
        public BFormHasilMCUGRANOSTICWatermark()
        {
            InitializeComponent();
        }
            ...
            if (lst.Count > 0)
            {
                ...
                foreach (vMCUResultFormReport row in lst)
                {
                    ...
                    if (data.Length > 0)
                    {
                            ...
                            if (field.Length > 1)
                            {
                                ...
                                switch (field[0])
                                {
                                    ...
                                    case "259":
                                        ...
                                        break;
                                    case "263":
                                        oData.Col263 = dataFieldValue;
                                        break;
                                    case "265":
                                        oData.Col265 = dataFieldValue;
                                        break;
                                    case "267":
                                        oData.Col267 = dataFieldValue;
                                        break;
                                    case "269":
                                        oData.Col269 = dataFieldValue;
                                        break;
                                    case "271":
                                        oData.Col271 = dataFieldValue;
                                        break;
                                    case "273":
                                        oData.Col273 = dataFieldValue;
                                        break;
                                    case "275":
                                        oData.Col275 = dataFieldValue;
                                        break;
                                    case "277":
                                        oData.Col277 = dataFieldValue;
                                        break;
                                    case "279":
                                        oData.Col279 = dataFieldValue;
                                        break;
                                    case "282":
                                        oData.Col282 = dataFieldValue;
                                        break;
                                    case "285":
                                        oData.Col285 = dataFieldValue;
                                        break;
                                    case "286":
                                        oData.Col286 = dataFieldValue;
                                        break;
                                }
                                #endregion
                            }
                        ...
                        lblDOB.Text = string.Format("{0} / {1} Thn", oData.TglLahir, ageInYear);
                        ...
                        lblDuaDuaEmpat.Text = oData.Col224;
                        lblDuaDuaEnam.Text = oData.Col226;
                        lblDuaDuaDelapan.Text = oData.Col228;
                        ...
                        if (oData.Col240 == "Ya")
                        {
                            Col240.Text = string.Format("{0} , {1}", oData.Col240, oData.Col242);
                        }
                        else
                        {
                       ...
                       //Col38.Text = oData.Col38;
                        ...
                        Col248.Text = oData.Col248;
                        Col250.Text = oData.Col250;
                        Col252.Text = oData.Col252;
                        Col254.Text = oData.Col254;
                        Col259.Text = oData.Col259;
                        Col263.Text = oData.Col263;
                        Col265.Text = oData.Col265;
                        Col267.Text = oData.Col267;
                        Col269.Text = oData.Col269;
                        Col271.Text = oData.Col271;
                        Col273.Text = oData.Col273;
                        Col275.Text = oData.Col275;
                        Col277.Text = oData.Col277;
                        Col279.Text = oData.Col279;
                        Col282.Text = oData.Col282;
                        Col285.Text = oData.Col285;
                        //Col286.Text = oData.Col286;
                        if (!string.IsNullOrEmpty(oData.Col142))
                        {
                            Col286.Text = string.Format("({0}) {1}", oData.Col142, oData.Col286);
                        }
                        else
                        {
                            Col286.Text = oData.Col286;
                        ...
                        Col218.Text = oData.Col218;
                        Col67.Text = oData.Col67;
                        Col69.Text = oData.Col69;
                        Col219.Text = oData.Col219;
                        ...
                        Col220.Text = oData.Col220;

                        Col150.Text = string.Format("{0}", oData.Col150);
