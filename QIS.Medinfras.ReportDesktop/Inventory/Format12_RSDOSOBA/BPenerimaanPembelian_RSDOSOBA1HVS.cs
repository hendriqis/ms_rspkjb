...
{
    public partial class BPenerimaanPembelian_RSDOSOBA1HVS : BaseDailyPortraitRpt
    {
        public BPenerimaanPembelian_RSDOSOBA1HVS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            decimal pph = 0;
            if (entityHd.IsPPHInPercentage)
            {
                pph = entityHd.TransactionAmount * entityHd.PPHPercentage / 100;
            }
            else
            {
                pph = entityHd.PPHAmount;
            }
            ...
            if (entityHd.ApprovedBy != null && entityHd.ApprovedBy != 0)
            {
