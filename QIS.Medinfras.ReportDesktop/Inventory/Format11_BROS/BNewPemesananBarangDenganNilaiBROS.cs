...
{
    public partial class BNewPemesananBarangDenganNilaiBROS : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilaiBROS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblCharges.Text = entity.ChargesAmount.ToString("N2");
