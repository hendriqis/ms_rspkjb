...
{
    public partial class BNewPemesananBarangDenganNilai_RSPBT : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilai_RSPBT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity.GCPurchaseOrderType != Constant.PurchaseOrderType.LOGISTIC && entity.GCPurchaseOrderType != Constant.PurchaseOrderType.ASSET)
            {
                ...
                if (entity.GCPurchaseOrderType == Constant.PurchaseOrderType.FOOD)
                {
                    lblReportTitle.Text = "SURAT PEMESANANAN BAHAN MAKANAN";
                }
