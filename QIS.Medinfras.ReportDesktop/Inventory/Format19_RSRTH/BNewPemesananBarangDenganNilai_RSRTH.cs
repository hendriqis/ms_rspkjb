...
{
    public partial class BNewPemesananBarangDenganNilai_RSRTH : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilai_RSRTH()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                totalPemesanan = total + ppn + pph - totalDiskon - downpayment + charges;
                lblPPH.Text = string.Format("{0}", pph.ToString("N2"));
            }
            else
            {
                totalPemesanan = total + ppn - pph - totalDiskon - downpayment + charges;
            ...
            {
                if (entity.ProductLineID == 2 || entity.ProductLineID == 28)
                {
                    ...
                    xrPictureBox1.ImageUrl = ResolveUrl("~/SystemSetup/Libs/Images/Stample.png");
                }
                else 
                {
                    lblReportTitle.Text = "SURAT PEMESANAN OBAT DAN ALKES";
