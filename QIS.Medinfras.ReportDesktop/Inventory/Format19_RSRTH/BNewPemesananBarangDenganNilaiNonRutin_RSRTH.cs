...
{
    public partial class BNewPemesananBarangDenganNilaiNonRutin_RSRTH : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilaiNonRutin_RSRTH()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity.GCPurchaseOrderType != Constant.PurchaseOrderType.LOGISTIC && entity.GCPurchaseOrderType != Constant.PurchaseOrderType.ASSET && entity.LocationID.ToString() == oLocation)
            {
                ...
                lblKepalaLogistik.Text = stafPembelian.ParameterValue;
                lblJabatan.Text = stafPembelian.ParameterName;
                ...
                lblJabatan2.Text = direkturUtama.ParameterName;
            }
            else
            {
