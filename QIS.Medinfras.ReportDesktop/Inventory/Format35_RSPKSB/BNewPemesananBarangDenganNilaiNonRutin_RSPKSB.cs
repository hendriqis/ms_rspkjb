...
{
    public partial class BNewPemesananBarangDenganNilaiNonRutin_RSPKSB : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilaiNonRutin_RSPKSB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity.GCPurchaseOrderType != Constant.PurchaseOrderType.LOGISTIC && entity.GCPurchaseOrderType != Constant.PurchaseOrderType.ASSET && entity.GCPurchaseOrderType != Constant.PurchaseOrderType.FOOD)
            {
                ...
                lblPengadaan.Text = entity.CreatedByName;
                lblJabatan1.Text = "Purchasing";
            ...
            else
            {
                ...
                lblPengadaan.Text = entity.CreatedByName;
                lblJabatan1.Text = "Purchasing Umum";
