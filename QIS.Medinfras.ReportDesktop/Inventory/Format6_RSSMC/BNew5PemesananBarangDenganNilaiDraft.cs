...
{
    public partial class BNew5PemesananBarangDenganNilaiDraft : BaseDailyPortraitRpt
    {
        public BNew5PemesananBarangDenganNilaiDraft()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            decimal transAmount = entity.TransactionAmount;
            decimal discAmount = (entity.TransactionAmount * entity.FinalDiscount / 100);
            decimal ppnAmount = entity.IsIncludeVAT ? (entity.TransactionAmount * entity.VATPercentage / 100) : 0;
            decimal totalTransAmount = (transAmount - discAmount + ppnAmount);

            lblTotal.Text = transAmount.ToString(Constant.FormatString.NUMERIC_2);
            lblDiskon.Text = discAmount.ToString(Constant.FormatString.NUMERIC_2);
            lblPPN.Text = ppnAmount.ToString(Constant.FormatString.NUMERIC_2);
            lblTotalPemesanan.Text = totalTransAmount.ToString(Constant.FormatString.NUMERIC_2);
