...
{
    public partial class BNewPembelianTunaiRSRT : BaseDailyPortraitRpt
    {
        public BNewPembelianTunaiRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                totalDiskon = (entity.FinalDiscountAmount) + (entity.FinalDiscount / 100 * entity.TransactionAmount);
            }
