...
{
    public partial class BPenerimaanPembelianNHS : BaseDailyPortraitRpt
    {
        public BPenerimaanPembelianNHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblItemType.Text = entityHd.ItemType;
            ...
            lblDownPayment.Text = entityHd.DownPaymentAmount.ToString("N2");
