...
{
    public partial class BNewPemesananBarangDenganNilaiNHS : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilaiNHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblOngkosKirim.Text = charges.ToString("N2");
                    ...
                    || entity.GCPurchaseOrderType == Constant.PurchaseOrderType.ALKES_RAJAL || entity.GCPurchaseOrderType == Constant.PurchaseOrderType.ALKES_RANAP)
            {
                ...
                string filterExpression2 = string.Format("ParameterCode IN ('{0}')", Constant.SettingParameter.IM_NAMA_JABATAN_DIREKTUR);
                SettingParameterDt lstParam2 = BusinessLayer.GetSettingParameterDtList(filterExpression2).FirstOrDefault();
                lblJabatanDirektur.Text = string.Format("{0},", lstParam2.ParameterValue);
