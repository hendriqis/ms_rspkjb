...
{
    public partial class BStockOpnameRSRT : BaseCustomDailyPotraitRpt
    {
        public BStockOpnameRSRT()
        {
            InitializeComponent();
        }
        ...
        {
            vStockTakingHd entityHd = BusinessLayer.GetvStockTakingHdList(String.Format("StockTakingID = {0}", param)).FirstOrDefault();
