...
{
    public partial class BCycleCountingDifference2 : BaseCustomDailyPotraitRpt
    {
        public BCycleCountingDifference2()
        {
            InitializeComponent();
        }
        ...
        {
            vStockTakingDt entityDt = BusinessLayer.GetvStockTakingDtList(param[0]).FirstOrDefault();
            vStockTakingHd entityHd = BusinessLayer.GetvStockTakingHdList(String.Format("StockTakingID = {0}", entityDt.StockTakingID)).FirstOrDefault();
