...
{
    public partial class BPenerimaanPembelianTanpaHarga : BaseDailyPortraitRpt
    {
        public BPenerimaanPembelianTanpaHarga()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if(entityHd.IsIncludeVAT)
            {
                ...
                lblPPN.Text = entityHd.VATPercentage + "%";
            }
            else 
            {
                //lblPPN.Text = "0.00";
            ...
            {
                Location loc = BusinessLayer.GetLocationList(string.Format("LocationCode = '{0}'", logistic.ParameterValue)).FirstOrDefault();
