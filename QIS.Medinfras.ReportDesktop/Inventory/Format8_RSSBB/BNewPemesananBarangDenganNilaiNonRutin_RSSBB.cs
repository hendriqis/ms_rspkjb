...
{
    public partial class BNewPemesananBarangDenganNilaiNonRutin_RSSBB : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilaiNonRutin_RSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            else
            {
                ...
                lblJabatan.Text = "Kasir Pembelian";
