...
{
    public partial class BPemesananBarangKonsinyasiDenganNilaiRSSBB : BaseDailyPortraitRpt
    {
        public BPemesananBarangKonsinyasiDenganNilaiRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblPrintDate.Text = string.Format("Bandung, {0}", DateTime.Now.ToString(Constant.FormatString.DATE_FORMAT));
