...
{
    public partial class BNew4PemesananBarangDenganNilai : BaseDailyPortraitRpt
    {
        public BNew4PemesananBarangDenganNilai()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                lblNo.Text = string.Format("7.");
                lblNotes.Text = string.Format("{0}", entity.Remarks);
            }
            ...
            if (entity.LocationID.ToString() == locationLF.ParameterValue)
            {
                //lblHormatKami.Text = "Supplier";
                //lnHormatKami.Visible = true;
                if (entity.GCPurchaseOrderType == Constant.PurchaseOrderType.DRUGMS)
                {
                    lblMengetahui2.Text = "Apoteker";
                    lblApoteker.Text = lstParam1.ParameterValue;
                    lblSIPA.Text = lstParam2.ParameterValue;
                    lblApoteker2.Text = string.Empty;
                    lblSIPA2.Text = string.Empty;
                }
                else
                {
                    lblMengetahui2.Text = "Apoteker";
                    lblApoteker2.Text = lstParam1.ParameterValue;
                    lblSIPA2.Text = lstParam2.ParameterValue;
