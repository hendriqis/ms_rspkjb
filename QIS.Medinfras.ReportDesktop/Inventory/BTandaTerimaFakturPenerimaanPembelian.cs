...
{
    public partial class BTandaTerimaFakturPenerimaanPembelian : BaseDailyPortraitRpt
    {
        public BTandaTerimaFakturPenerimaanPembelian()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            decimal netAmount = entityHd.TransactionAmount - entityHd.FinalDiscount
                                ...
                                + entityHd.ChargesAmount + entityHd.StampAmount + entityHd.PPHAmount - entityHd.DownPaymentAmount;
            ...
            {
                vLocation loc = BusinessLayer.GetvLocationList(string.Format("LocationCode = '{0}'", entityHd.LocationCode)).FirstOrDefault();
