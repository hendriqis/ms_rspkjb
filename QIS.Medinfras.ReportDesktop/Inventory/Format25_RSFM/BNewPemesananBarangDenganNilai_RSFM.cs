...
{
    public partial class BNewPemesananBarangDenganNilai_RSFM : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilai_RSFM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            else if (entity.GCPurchaseOrderType == Constant.PurchaseOrderType.LOGISTIC)
            {
                ...
                lblDisetujui3.Text = "";
                lblJabatanDisetujui3.Text = "Atasan Langsung";
