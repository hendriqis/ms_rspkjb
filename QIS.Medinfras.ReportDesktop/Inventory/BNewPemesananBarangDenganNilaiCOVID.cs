...
{
    public partial class BNewPemesananBarangDenganNilaiCOVID : BaseDailyPortraitRpt
    {
        public BNewPemesananBarangDenganNilaiCOVID()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            decimal pph = entity.PPHAmount;
            decimal DP = entity.DownPaymentAmount;
            ...
            {
                totalPemesanan = (total - totalDiskon) + ppn + pph - DP + ongkosKirim;
            }
            else
            {
                totalPemesanan = (total - totalDiskon) + ppn - (pph * -1) - DP + ongkosKirim;
            }
            ...
            lblOngkosKirim.Text = ongkosKirim.ToString("N2");
