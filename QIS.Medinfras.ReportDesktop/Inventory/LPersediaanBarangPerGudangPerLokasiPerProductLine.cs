...
{
    public partial class LPersediaanBarangPerGudangPerLokasiPerProductLine : BaseDailyPortraitRpt
    {
        public LPersediaanBarangPerGudangPerLokasiPerProductLine()
        {
            InitializeComponent();
        }
        ...
        {
            String ItemGroupID = "0";
            String ItemGroupName1 = "";
            String ItemType = "";

            if (GetCurrentColumnValue("ItemGroupID") != null)
            {
                ItemGroupID = GetCurrentColumnValue("ItemGroupID").ToString();
            }

            if (GetCurrentColumnValue("ItemGroupName1") != null)
            {
                ItemGroupName1 = GetCurrentColumnValue("ItemGroupName1").ToString();
            }

            if (GetCurrentColumnValue("ItemType") != null)
            {
                ItemType = GetCurrentColumnValue("ItemType").ToString();
            }
