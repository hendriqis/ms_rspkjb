...
{
    public partial class BNew6PemesananBarangDenganNilai : BaseDailyPortraitRpt
    {
        public BNew6PemesananBarangDenganNilai()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity.GCPurchaseOrderType == "X145^001" || entity.GCPurchaseOrderType == "X145^002" || entity.GCPurchaseOrderType == "X145^006")
            {
