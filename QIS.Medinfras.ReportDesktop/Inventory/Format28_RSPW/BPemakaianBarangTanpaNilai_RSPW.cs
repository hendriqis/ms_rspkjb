...
{
    public partial class BPemakaianBarangTanpaNilai_RSPW : BaseDailyPortraitRpt
    {
        public BPemakaianBarangTanpaNilai_RSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                lblNoRegistrasi.Text = string.Format("{0} | {1} | ({2}) {3}", entity.RegistrationNo, entity.ServiceUnitName, entity.MedicalNo, entity.PatientName);
            }
