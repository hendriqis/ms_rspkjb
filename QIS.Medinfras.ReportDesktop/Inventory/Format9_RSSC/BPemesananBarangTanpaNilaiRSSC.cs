...
{
    public partial class BPemesananBarangTanpaNilaiRSSC : BaseDailyPortraitRpt
    {
        public BPemesananBarangTanpaNilaiRSSC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            Tanggal.Text = string.Format(DateTime.Now.ToString("dd-MMM-yyyy"));
