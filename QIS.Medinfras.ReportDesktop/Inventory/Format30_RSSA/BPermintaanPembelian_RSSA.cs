...
{
    public partial class BPermintaanPembelian_RSSA : BaseDailyPortraitRpt
    {
        public BPermintaanPembelian_RSSA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                string filterExpressionApprover = string.Format("ParameterCode IN ('{0}', '{1}', '{2}', '{3}', '{4}','{5}')", Constant.SettingParameter.DIREKTUR_YANMED, Constant.SettingParameter.IM_NAMA_JABATAN_DIREKTUR, Constant.SettingParameter.SA0134,
                ...
                SettingParameter kepalaKeuanganAkuntansi = lstSettingParameter.Where(p => p.ParameterCode == Constant.SettingParameter.SA0134).FirstOrDefault();
                SettingParameter jabatanKepalaKeuanganAkuntansi = lstSettingParameter.Where(p => p.ParameterCode == Constant.SettingParameter.SA0134).FirstOrDefault();
                ...
                //lblSIPA.Text = appSession.UserFullName;
            ...
            {
                string filterExpressionApprover = string.Format("ParameterCode IN ('{0}', '{1}', '{2}', '{3}', '{4}')", Constant.SettingParameter.DIREKTUR_YANMED, Constant.SettingParameter.IM_NAMA_JABATAN_DIREKTUR, Constant.SettingParameter.SA0134,
                ...
                //lblMinta2.Text = appSession.UserFullName;
