...
{
    public partial class LaboratoryResultRptRSRT : BaseDailyPortraitRpt
    {
        public LaboratoryResultRptRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblTglLahir.Text = entityChargesHdVisit.DateOfBirthInString;
        ...
        private void cFractionName_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (!isNormal)
            {
                cell.Font = new Font("Tahoma", 9, FontStyle.Bold);
            }
            else
            {
        ...
        private void cLabResult_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                cell.Font = new Font("Tahoma", 9, FontStyle.Italic);
                cell.Text = "Menyusul";
            }
        }       
