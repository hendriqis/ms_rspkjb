...
{
    public partial class LaboratoryResultRptRSSM : BaseDailyPortraitRpt
    {
        public LaboratoryResultRptRSSM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity[0].RemarksFraction != "" || entity[0].RemarksFraction != null)
            {
                xrLabel10.Text = string.Format("Spesimen : {0}", entity[0].SpecimenName);
                xrLabel11.Text = string.Format("Catatan :");
                xrLabel12.Text = string.Format("{0}", entity[0].RemarksFraction);
            }
            else
            {
