...
{
    public partial class LaboratoryResultRptRSSAv2 : BaseDailyPortrait2Rpt
    {
        public LaboratoryResultRptRSSAv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblPemeriksa.Text = string.Format("{0}", appSession.UserFullName);
