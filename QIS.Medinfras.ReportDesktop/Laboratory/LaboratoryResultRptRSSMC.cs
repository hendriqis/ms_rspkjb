...
{
    public partial class LaboratoryResultRptRSSMC : BaseDailyPortraitRpt
    {
        public LaboratoryResultRptRSSMC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            string filterExpressionSetPar = string.Format(" ParameterCode IN ('{0}')", "LB0009");
            SettingParameterDt paramSetPar = BusinessLayer.GetSettingParameterDtList(filterExpressionSetPar)[0];
            Int32 ParamedicID = Convert.ToInt32(paramSetPar.ParameterValue);
            ParamedicMaster entityParamedic = BusinessLayer.GetParamedicMaster(ParamedicID);
            lblPenanggungJawab.Text = entityParamedic.FullName;
