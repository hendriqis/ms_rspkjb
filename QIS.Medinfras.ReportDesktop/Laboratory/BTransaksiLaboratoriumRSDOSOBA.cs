...
{
    public partial class BTransaksiLaboratoriumRSDOSOBA : BaseA6Rpt
    {
        ...
        public BTransaksiLaboratoriumRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vPatientChargesDt entityDt = BusinessLayer.GetvPatientChargesDtList(string.Format("TransactionID = {0}", entity.TransactionID)).FirstOrDefault();
            ...
            ClassCare entityClass = BusinessLayer.GetClassCareList(string.Format("ClassID = {0} AND ClassCode LIKE '%RJK%'", entityDt.ChargeClassID)).FirstOrDefault();
            if (entityClass == null)
            {
                cRefererrClass.Visible = false;
                xrTableCell33.Visible = false;
                xrTableCell34.Visible = false;
            }
            else
            {
                cRefererrClass.Text = entityClass.ClassName;
            }
