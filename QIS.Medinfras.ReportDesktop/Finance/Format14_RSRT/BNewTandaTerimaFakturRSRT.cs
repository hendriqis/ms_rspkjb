...
{
    public partial class BNewTandaTerimaFakturRSRT : BaseCustomDailyPotraitRpt
    {
        public BNewTandaTerimaFakturRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                subCN.CanGrow = true;
                bNewTandaTerimaFakturDtCNRSRT.InitializeReport(entity.PurchaseInvoiceID);
            } else {
