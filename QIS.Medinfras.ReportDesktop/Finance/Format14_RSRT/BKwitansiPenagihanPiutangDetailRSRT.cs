...
{
    public partial class BKwitansiPenagihanPiutangDetailRSRT : BaseCustomDailyPotraitRptRSRT
    {
        public BKwitansiPenagihanPiutangDetailRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vUser ouser = BusinessLayer.GetvUserList(string.Format("UserID='{0}'", arInvoiceHd.CreatedBy)).FirstOrDefault();
            ...
            lblTTD1.Text = user; // setvardt.ParameterValue;
