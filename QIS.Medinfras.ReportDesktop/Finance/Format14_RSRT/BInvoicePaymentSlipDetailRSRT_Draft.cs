...
{
    public partial class BInvoicePaymentSlipDetailRSRT_Draft : BaseCustomDailyPotraitRSRTRpt
    {
        public BInvoicePaymentSlipDetailRSRT_Draft()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            string createdBy = entity.CreatedByName;
