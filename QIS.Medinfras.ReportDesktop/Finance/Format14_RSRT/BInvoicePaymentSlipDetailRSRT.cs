...
{
    public partial class BInvoicePaymentSlipDetailRSRT : BaseCustomDailyPotraitRSRTRpt
    {
        public BInvoicePaymentSlipDetailRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblTTD1.Text = entity.CreatedByName; ///setvardt.ParameterValue;
