...
{
    public partial class BTandaTerimaBerkasPenagihanRSRT : BaseRpt
    {
        private string HealthcareName = "";
        private string Address = "";
        private string City = "";

        public BTandaTerimaBerkasPenagihanRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
           ...
           // vARInvoiceDt entityDt = BusinessLayer.GetvARInvoiceDtList(temp[0]).FirstOrDefault();
           /// lblPatient.Text = entityDt.PatientName;
           /// 
            string CreatedByName = ""; 
            if (lstEntity.FirstOrDefault() != null) 
            { 
                CreatedByName = lstEntity.FirstOrDefault().CreatedByName;
            }
            lblUser.Text = CreatedByName; 
        }
