...
{
    public partial class BAPPaymentPlanRSSBBv1 : BaseCustomDailyPotraitRpt
    {
        private decimal totalAmount = 0, stampAmount = 0, grandTotalAmount = 0;

        public BAPPaymentPlanRSSBBv1()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cPlanningPaymentDate.Text = entity.PlanningPaymentDateInString;
