...
{
    public partial class LUmurPiutangRekapPribadi : BaseDailyLandscapeRpt
    {
        public LUmurPiutangRekapPribadi()
        {
            InitializeComponent();
        }
        public override void InitializeReport(string[] param)
        {
            lblTanggal.Text = string.Format("Tanggal Analisa : {0}", Helper.YYYYMMDDToDate(param[0]).ToString(Constant.FormatString.DATE_FORMAT));
