...
{
    public partial class BNew8SuratPenagihanPiutangNonOperasional : BaseCustomDailyPotraitRpt
    {
        public BNew8SuratPenagihanPiutangNonOperasional()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (h != null)
            {
                ...
                lblHealthcareAddress.Text = h.StreetName;
                lblHealthcareCityZipCodes.Text = string.Format("{0} {1}", h.City, h.ZipCode);
                lblHealthcarePhone.Text = h.PhoneNo1;
                lblHealthcareFax.Text = h.FaxNo1;
