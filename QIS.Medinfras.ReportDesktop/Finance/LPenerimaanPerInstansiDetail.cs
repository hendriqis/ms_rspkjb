...
{
    public partial class LPenerimaanPerInstansiDetail : BaseDailyLandscapeRpt
    {
        public LPenerimaanPerInstansiDetail()
        {
            InitializeComponent();
        }
        ...
        {
            if (this.GetNextColumnValue("DepartmentName") != this.GetCurrentColumnValue("DepartmentName"))
            {
