...
{
    public partial class BSuratPenagihanPiutangRekapRSUKI : BaseCustomDailyPotraitRpt
    {
        public BSuratPenagihanPiutangRekapRSUKI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblKeterangan1.Text = string.Format("Sehubungan dengan tagihan saudara No.{0} tanggal {1}", invoiceHd.ARInvoiceNo, invoiceHd.DocumentDateInString);
            lblKeterangan2.Text = string.Format("akan kami bayar pada tanggal : ...................");
