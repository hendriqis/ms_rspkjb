...
{
    public partial class BKwitansiPenagihanPiutangDetailRSUKI : BaseCustomDailyPotraitRpt
    {
        public BKwitansiPenagihanPiutangDetailRSUKI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cReceiptHealhcareEmail.Text = h.Email;
