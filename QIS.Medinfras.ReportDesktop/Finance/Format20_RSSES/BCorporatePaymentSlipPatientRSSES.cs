...
{
    public partial class BCorporatePaymentSlipPatientRSSES : BaseCustomDailyPotraitRpt
    {
        public BCorporatePaymentSlipPatientRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cInstansi.Text = string.Format("({0}) {1}", entity.MedicalNo, entity.PatientName);
            ...
            #region Receive DT
            List<vARReceivingDt> lstDT = BusinessLayer.GetvARReceivingDtList(string.Format("ARReceivingID = {0} AND IsDeleted = 0", entity.ARReceivingID));
            ...
            cTTDCorporate.Text = entity.PatientName;
