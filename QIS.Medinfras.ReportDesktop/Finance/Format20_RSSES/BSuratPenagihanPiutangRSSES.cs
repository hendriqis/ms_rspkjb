...
{
    public partial class BSuratPenagihanPiutangRSSES : BaseCustomDailyPotraitRpt
    {
        public BSuratPenagihanPiutangRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            bSuratPenagihanPiutangRSSESDetailBank.InitializeReport(lstBPVA);
