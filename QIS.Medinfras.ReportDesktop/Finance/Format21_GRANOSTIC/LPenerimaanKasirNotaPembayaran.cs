...
{
    public partial class LPenerimaanKasirNotaPembayaran : BaseCustomDailyLandscapeA3Rpt
    {
        public LPenerimaanKasirNotaPembayaran()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                xrLabel15.Text = "Status Transaksi : NON VOID";
            }
            else
            {
                xrLabel15.Text = "Status Transaksi : VOID";
            }
