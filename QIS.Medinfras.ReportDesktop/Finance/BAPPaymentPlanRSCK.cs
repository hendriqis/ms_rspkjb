...
{
    public partial class BAPPaymentPlanRSCK : BaseCustomDailyPotraitRpt
    {
        private decimal totalAmount = 0, stampAmount = 0, grandTotalAmount = 0;

        public BAPPaymentPlanRSCK()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                cCaraPembayaran.Text = entity.PaymentMethod + " | " + entity.BankName + " | " + entity.BankAccountNo;
            }
            else
            {
