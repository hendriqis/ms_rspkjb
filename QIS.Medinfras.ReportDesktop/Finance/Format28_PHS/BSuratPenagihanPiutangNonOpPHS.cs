...
{
    public partial class BSuratPenagihanPiutangNonOpPHS : BaseCustomDailyPotraitRpt
    {
        public BSuratPenagihanPiutangNonOpPHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            bSuratPenagihanPiutangNonOpPHSDt.InitializeReport(invoiceHd.ARInvoiceID);
