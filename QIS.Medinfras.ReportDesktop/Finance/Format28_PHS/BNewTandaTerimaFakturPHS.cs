...
{
    public partial class BNewTandaTerimaFakturPHS : BaseCustomDailyPotraitRpt
    {
        public BNewTandaTerimaFakturPHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cProductLine.Text = entity.ProductLineName;
            ...
            cNamePPH.Text = "PPH"; 
            if (!string.IsNullOrEmpty(entity.PPHType)) {
                cNamePPH.Text = entity.PPHType;
            }
            
            string RoundingAmount = "0.00"; 
            if (entity.RoundingAmount != null || entity.RoundingAmount > 0) 
            {
                RoundingAmount = entity.RoundingAmount.ToString("N2"); 
            }
            cRoundingAmount.Text = RoundingAmount; 
