...
{
    public partial class BSuratPenagihanPiutangPHSDt : DevExpress.XtraReports.UI.XtraReport
    {
        public BSuratPenagihanPiutangPHSDt()
        {
            InitializeComponent();
        }
        ...
        {
            string referenceno = "";
            if (GetCurrentColumnValue("ReferenceNo") != null)
            {
                referenceno= GetCurrentColumnValue("ReferenceNo").ToString();
            }
