...
{
    public partial class BCorporatePaymentSlip : BaseCustomDailyPotraitRpt
    {
        public BCorporatePaymentSlip()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cash += lstDT.Where(a => a.GCARPaymentMethod == Constant.AR_PAYMENT_METHODS.CASH).Sum(a => a.PaymentAmount + a.CardFeeAmount) + entity.CashBackAmount;
