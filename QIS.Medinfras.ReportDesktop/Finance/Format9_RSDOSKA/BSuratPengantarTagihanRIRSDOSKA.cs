...
{
    public partial class BSuratPengantarTagihanRIRSDOSKA : BaseDailyPortraitRpt
    {
        public BSuratPengantarTagihanRIRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vARInvoiceDtTagihan entity = BusinessLayer.GetvARInvoiceDtTagihanList(param[0]).FirstOrDefault();
            lblSuratPengantarTagihanRI.Text = string.Format("No: {0}", entity.cfNoTagihanRIRSDOSKA);
            #endregion
        }
    }
}
