...
{
    public partial class BPengeluaranCek : BaseCustomDailyLandscapeA5Rpt
    {
        decimal subTotalPembayaran = 0;

        public BPengeluaranCek()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblVerificationDate.Text = string.Format("Tanggal Bayar : {0}", entity.PlanningPaymentDate.ToString(Constant.FormatString.DATE_FORMAT));
            ...
            List<SettingParameter> lstentity = BusinessLayer.GetSettingParameterList(String.Format("ParameterCode IN ('{0}','{1}','{2}')", Constant.SettingParameter.FN_KEPALABAGIAN_KEUANGAN, Constant.SettingParameter.FN_DIREKTUR_KEUANGAN, Constant.SettingParameter.MANAGER_KEUANGAN));
            lblDirectorCaption.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.FN_DIREKTUR_KEUANGAN).FirstOrDefault().ParameterName;
            lblDirectorSignName.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.FN_DIREKTUR_KEUANGAN).FirstOrDefault().ParameterValue;
            ...
            lblSupervisorSignName.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.FN_KEPALABAGIAN_KEUANGAN).FirstOrDefault().ParameterValue;
