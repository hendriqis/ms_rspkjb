...
{
    public partial class BSuratPenagihanPiutangNonOpRSAJ : BaseCustomDailyPotraitRpt
    {
        public BSuratPenagihanPiutangNonOpRSAJ()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblTTD1.Text = setvarAR.Where(a => a.ParameterCode == Constant.SettingParameter.MANAGER_KEUANGAN).FirstOrDefault().ParameterValue;
