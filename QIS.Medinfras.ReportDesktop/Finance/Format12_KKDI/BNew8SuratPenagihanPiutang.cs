...
{
    public partial class BNew8SuratPenagihanPiutang : BaseCustomDailyPotraitRpt
    {
        public BNew8SuratPenagihanPiutang()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetTransferAccountBank> lstVirtualAccount = BusinessLayer.GetTransferAccountBankList(invoiceHd.ARInvoiceID);

            #region Transaction
            subVirtualAccount.CanGrow = true;
            BNew9SuratPenagihanPiutangKKDI.InitializeReport(lstVirtualAccount);
            #endregion
