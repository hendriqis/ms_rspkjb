...
{
    public partial class LPenerimaanHarianPerKasirRSSY : BaseDailyLandscapeRpt
    {
        public LPenerimaanHarianPerKasirRSSY()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            UserAttribute ua = BusinessLayer.GetUserAttributeList(string.Format("UserID = {0}", Convert.ToInt32(param[3]))).FirstOrDefault();
            lblPetugas.Text = ua.FullName;

            subCN.CanGrow = true;


            List<GetPatientPaymentDtRekapReportRSSY> lstData = BusinessLayer.GetPatientPaymentDtRekapReportRSSY(param[0], param[1], param[2], Convert.ToInt32(param[3]));
            bTotalRekapPembayaranPerkasirRSSY.InitializeReport(lstData);
