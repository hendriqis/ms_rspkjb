...
{
    public partial class BAlokasiPenerimaanPiutangPribadi : BaseCustomDailyPotraitRpt
    {
        public BAlokasiPenerimaanPiutangPribadi()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            txtCustomer.Text = String.Format( "{0}||{1}",entity.MedicalNo,entity.PatientName);
