...
{
    public partial class BSuratPenagihanPiutangGabunganRSSBB : BaseCustomDailyPotraitRpt
    {
        public BSuratPenagihanPiutangGabunganRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            ARReceiptHd invoiceHd = BusinessLayer.GetARReceiptHdList(param[0]).FirstOrDefault();
            ...
            lblHeaderTTD1.Text = string.Format("{0}, {1}", h.City, invoiceHd.ARReceiptDate.ToString(Constant.FormatString.DATE_FORMAT));
            ...
            bSuratPenagihanPiutangGabunganDt.InitializeReport(invoiceHd.ARReceiptID);
