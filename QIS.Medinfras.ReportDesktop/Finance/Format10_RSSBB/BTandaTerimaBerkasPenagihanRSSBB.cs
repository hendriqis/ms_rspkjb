...
{
    public partial class BTandaTerimaBerkasPenagihanRSSBB : BaseRpt
    {
        private string HealthcareName = "";
        private string Address = "";
        private string City = "";

        public BTandaTerimaBerkasPenagihanRSSBB()
        {
            InitializeComponent();
        }
        ...
        private void lblTanggal_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            string signatureDate = Convert.ToDateTime(GetCurrentColumnValue("SignatureDate")).ToString(Constant.FormatString.DATE_FORMAT);

            if (signatureDate != "01-Jan-1900")
            {
                lblTanggal.Text = string.Format("{0}, {1}", City, signatureDate);
            }
            else
            {
