...
{
    public partial class BKwitansiPenagihanPiutangRekapRSSBB : BaseCustomDailyPotraitA5Rpt
    {
        public BKwitansiPenagihanPiutangRekapRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vARInvoiceHd1 entity = BusinessLayer.GetvARInvoiceHd1List(ARInvoiceID).FirstOrDefault();
