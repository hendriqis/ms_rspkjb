...
{
    public partial class BBuktiKasdanBankDraftRSBL : BaseCustomDailyPotraitRpt
    {
        public BBuktiKasdanBankDraftRSBL()
        {
            InitializeComponent();
        }
        ...
        private void lblJudul_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            String GCTreasuryGroup = GetCurrentColumnValue("GCTreasuryGroup").ToString();

            if (TransactionCode == "7282" || TransactionCode == "7283")
            {
                if (GCTreasuryType == Constant.TreasuryType.PENERIMAAN)
                {
                    if (GCTreasuryGroup == Constant.TreasuryGroup.KAS_BON)
                    {
                ...
                else if (GCTreasuryType == Constant.TreasuryType.PENGELUARAN)
                {
                    ...
                    if (GCTreasuryGroup == Constant.TreasuryGroup.KAS_BON || GCTreasuryGroup == Constant.TreasuryGroup.CASH_ADVANCE)
                    {
                        lblJudul.Text = "KAS BON";
