...
{
    public partial class BInvoicePaymentSlipDetailRSBL : BaseCustomDailyPotraitRpt
    {
        public BInvoicePaymentSlipDetailRSBL()
        {
            InitializeComponent();
        }
        ...
        {
            vARInvoiceHd3 entity = BusinessLayer.GetvARInvoiceHd3List(param[0]).FirstOrDefault();
            ...
            cBankAccountName.Text = entity.BankNameDisplay;
            cBankBranch.Text = entity.BankBranch;
