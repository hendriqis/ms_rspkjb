...
{
    public partial class LPenerimaanPiutangPerStatusPerPenjaminBayarDetailPayment : DevExpress.XtraReports.UI.XtraReport
    {
        public LPenerimaanPiutangPerStatusPerPenjaminBayarDetailPayment()
        {
            InitializeComponent();
        }
