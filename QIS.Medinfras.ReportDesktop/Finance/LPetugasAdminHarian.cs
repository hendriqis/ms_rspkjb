...
{
    public partial class LPetugasAdminHarian : BaseCustomDailyLandscapeRpt
    {
        public LPetugasAdminHarian()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                UserAttribute ua = BusinessLayer.GetUserAttribute(Convert.ToInt32(param[4]));
                if (ua != null)
                {
