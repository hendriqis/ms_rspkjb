...
{
    public partial class BNewTandaTerimaFakturRSSC : BaseCustomDailyPotraitRpt
    {
        public BNewTandaTerimaFakturRSSC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                subCN.CanGrow = true;
                bNewTandaTerimaFakturDtCNRSSC.InitializeReport(entity.PurchaseInvoiceID);
            } else {
            ...
            cPembulatan.Text = entity.RoundingAmount.ToString("N2");
