...
{
    public partial class BNewKwitansiPenagihanPiutangDetail : BaseCustomDailyPotraitRpt
    {
        public BNewKwitansiPenagihanPiutangDetail()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            SettingParameter setvar = BusinessLayer.GetSettingParameterList(string.Format(
                    "ParameterCode = '{0}'", Constant.SettingParameter.FN_KEPALABAGIAN_PELAYANAN_ADMINISTRASI_PASIEN_JAMINAN)).FirstOrDefault();
