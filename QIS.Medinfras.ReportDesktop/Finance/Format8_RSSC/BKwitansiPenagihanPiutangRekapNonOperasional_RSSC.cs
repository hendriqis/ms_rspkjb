...
{
    public partial class BKwitansiPenagihanPiutangRekapNonOperasional_RSSC : BaseCustomDailyPotraitA5Rpt
    {
        public BKwitansiPenagihanPiutangRekapNonOperasional_RSSC()
        {
            InitializeComponent();
        }
