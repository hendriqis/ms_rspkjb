...
{
    public partial class BKwitansiPenagihanPiutangDenganDendaRSSC : BaseCustomDailyPotraitRpt
    {
        public BKwitansiPenagihanPiutangDenganDendaRSSC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vARInvoiceHd1 arInvoice = BusinessLayer.GetvARInvoiceHd1List(param[0]).FirstOrDefault();
