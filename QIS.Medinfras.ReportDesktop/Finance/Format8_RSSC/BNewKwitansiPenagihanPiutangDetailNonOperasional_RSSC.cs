...
{
    public partial class BNewKwitansiPenagihanPiutangDetailNonOperasional_RSSC : BaseCustomDailyPotraitA5Rpt
    {
        public BNewKwitansiPenagihanPiutangDetailNonOperasional_RSSC()
        {
            InitializeComponent();
        }
