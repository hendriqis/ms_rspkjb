...
{
    public partial class BNewTandaTerimaFakturDetailDM : BaseCustomDailyPotraitRpt
    {
        public BNewTandaTerimaFakturDetailDM()
        {
            InitializeComponent();
        }
        ...
        {
            string filter = string.Format("PurchaseInvoiceID = {0}", param[0]);
            vPurchaseInvoiceHd entity = BusinessLayer.GetvPurchaseInvoiceHdList(filter)[0];
