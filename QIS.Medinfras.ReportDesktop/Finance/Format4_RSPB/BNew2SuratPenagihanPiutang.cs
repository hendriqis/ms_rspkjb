...
{
    public partial class BNew2SuratPenagihanPiutang : BaseCustomDailyPotraitRpt
    {
        public BNew2SuratPenagihanPiutang()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblFaxRS.Text = setvarFax.ParameterValue;
            ...
            bNew2SuratPenagihanPiutangDt.InitializeReport(invoiceHd.ARInvoiceID);
