...
{
    public partial class LPembayaranHutangPerDetailPenerimaanPembelianV2 : BaseCustomDailyLandscapeRpt
    {
        public LPembayaranHutangPerDetailPenerimaanPembelianV2()
        {
            InitializeComponent();
        }
