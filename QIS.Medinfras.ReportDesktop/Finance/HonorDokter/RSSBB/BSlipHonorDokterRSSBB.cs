...
{
    public partial class BSlipHonorDokterRSSBB : BaseCustomDailyPotraitRpt
    {
        public BSlipHonorDokterRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subTransRegistrationDetailRSSBB.CanGrow = true;
            subTransRegistrationDetailRSSBB.InitializeReport(lstDetail);
