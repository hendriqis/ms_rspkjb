...
{
    public partial class BRincianHonorDokter : BaseCustomDailyPotraitRpt
    {
        public BRincianHonorDokter()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            srTransRegistrationDetailNew.CanGrow = true;
            SubTransRegistrationDetailNew.InitializeReport(lstDetail);
