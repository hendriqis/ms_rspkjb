...
{
    public partial class BHonorDokterRSPBT : BaseCustomDailyPotraitRpt
    {
        public BHonorDokterRSPBT()
        {
            InitializeComponent();
        }
        ...
        {
            vTransRevenueSharingHd entity = BusinessLayer.GetvTransRevenueSharingHdList(string.Format("RSTransactionID = {0}", param[0])).FirstOrDefault();
