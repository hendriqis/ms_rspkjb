...
{
    public partial class BSlipHonorDokterRSBL : BaseCustomDailyPotraitRpt
    {
        public BSlipHonorDokterRSBL()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subTransRegistrationDetailRSBL.InitializeReport(lstDetail);
