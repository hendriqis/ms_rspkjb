...
{
    public partial class BRincianHonorDokterRSASIH : BaseCustomDailyPotraitRpt
    {
        public BRincianHonorDokterRSASIH()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            // Detail List
            List<GetTRSSummaryDtTransRegistrationDetailRSASIH> lstDetail = BusinessLayer.GetTRSSummaryDtTransRegistrationDetailRSASIHList(entity.RSSummaryID);            
            srTransRegistrationDetailRSASIH.CanGrow = true;
            SubTransRegistrationDetailRSASIH.InitializeReport(lstDetail);
            ...
            SubTransSummaryAdjustmentDetailPlusRSDO.InitializeReport(lstAdj.Where(a => a.GCRSAdjustmentGroup == Constant.RevenueSharingAdjustmentGroup.PENAMBAHAN && a.GCRSAdjustmentType != Constant.RevenueSharingAdjustmentType.PENYESUAIAN_PAJAK_PENAMBAHAN && !a.IsTaxed).ToList());

            srTransSummaryAdjustmentDetailMinusRSDO.CanGrow = true;
            SubTransSummaryAdjustmentDetailMinusRSDO.InitializeReport(lstAdj.Where(a => a.GCRSAdjustmentGroup == Constant.RevenueSharingAdjustmentGroup.PENGURANGAN && a.GCRSAdjustmentType != Constant.RevenueSharingAdjustmentType.PENYESUAIAN_PAJAK_PENGURANGAN && !a.IsTaxed).ToList());
