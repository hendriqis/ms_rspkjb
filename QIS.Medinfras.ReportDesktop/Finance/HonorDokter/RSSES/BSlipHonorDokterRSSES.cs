...
{
    public partial class BSlipHonorDokterRSSES : BaseCustomDailyPotraitRpt
    {
        public BSlipHonorDokterRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subTransRegistrationDetailRSSES.InitializeReport(lstDetail);
            ...
            subTransRevenueDetailRSSES.InitializeReport(lstPerRevenue);
            ...
            subParamedicTaxBalanceRSSES.InitializeReport(lstTaxBalance);
            ...
            {
                totalTaxBalance = lstTaxBalance.Sum(a => a.cfTotalHonorSetelahPajakRSPBT);
            }
            else
            {
