...
{
    public partial class BRincianHonorDokterRSSES : BaseCustomDailyPotraitRpt
    {
        public BRincianHonorDokterRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            // Detail List
            List<GetTRSSummaryDtTransRegistrationDetailRSSES> lstDetail = BusinessLayer.GetTRSSummaryDtTransRegistrationDetailRSSESList(entity.RSSummaryID);            
            srTransRegistrationDetailRSSES.CanGrow = true;
            SubTransRegistrationDetailRSSES2.InitializeReport(lstDetail);
