...
{
    public partial class BSlipJasaMedisRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BSlipJasaMedisRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            srTransRegistrationDetailRSDOSOBA.CanGrow = true;
            subTransRegistrationDetailRSDOSOBA.InitializeReport(lstDetail);
