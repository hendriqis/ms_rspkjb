...
{
    public partial class BRincianTandaTerimaHonorDokterRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BRincianTandaTerimaHonorDokterRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            #region Tanda Terima
            string filterSub = string.Format("RSSummaryID = {0}", entity.RSSummaryID);
            List<vTransRevenueSharingSummaryHd> lstSubReport = BusinessLayer.GetvTransRevenueSharingSummaryHdList(filterSub);
            slipHonorDokterRSDOSOBAA6.CanGrow = true;
            subSlipHonorDokterRSDOSOBAA6.InitializeReport(lstSubReport, param[0]);
            #endregion
