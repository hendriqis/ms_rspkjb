...
{
    public partial class BSlipHonorDokterRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BSlipHonorDokterRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subTransRegistrationDetailRSDOSKA.InitializeReport(lstDetail);
            ...
            subTransRevenueDetailRSDOSKA.InitializeReport(lstPerRevenue);
            ...
            subTransSummaryAdjustmentDetailPlusRSDOSKA.InitializeReport(lstAdj.Where(a => a.GCRSAdjustmentGroup == Constant.RevenueSharingAdjustmentGroup.PENAMBAHAN).ToList());

            srTransSummaryAdjustmentDetailMinus.CanGrow = true;
            subTransSummaryAdjustmentDetailMinusRSDOSKA.InitializeReport(lstAdj.Where(a => a.GCRSAdjustmentGroup == Constant.RevenueSharingAdjustmentGroup.PENGURANGAN).ToList());
            ...
            subParamedicTaxBalanceRSDOSKA.InitializeReport(lstTaxBalance);
            ...
            subTransRevenueAdjustmentFondsRSDOSKA.InitializeReport(lstFonds);
