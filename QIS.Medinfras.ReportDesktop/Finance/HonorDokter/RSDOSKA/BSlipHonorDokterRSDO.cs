...
{
    public partial class BSlipHonorDokterRSDO : BaseCustomDailyPotraitRpt
    {
        public BSlipHonorDokterRSDO()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            SubTransRegistrationDetailRSDO.InitializeReport(lstDetail);
