...
{
    public partial class BRekapRevenueSharingAdjMinus : DevExpress.XtraReports.UI.XtraReport
    {
        public BRekapRevenueSharingAdjMinus()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(string param)
        {
            string filterExpression = string.Format("IsDeleted = 0 AND ParamedicID = {0} AND GCRSAdjustmentGroup = '{1}'",
                                            AppSession.ParamedicID, Constant.RevenueSharingAdjustmentGroup.PENGURANGAN);
