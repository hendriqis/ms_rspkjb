...
{
    public partial class BSlipHonorDokterRSSM : BaseCustomDailyPotraitRpt
    {
        public BSlipHonorDokterRSSM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subTransRegistrationDetailRSSM.InitializeReport(lstDetail);
            ...
            subTransRevenueDetailRSSM.InitializeReport(lstPerRevenue);
