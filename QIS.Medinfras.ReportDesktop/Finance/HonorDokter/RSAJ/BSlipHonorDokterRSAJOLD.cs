...
{
    public partial class BSlipHonorDokterRSAJOLD : BaseCustomDailyPotraitRpt
    {
        public BSlipHonorDokterRSAJOLD()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subTransRegistrationDetailRSAJ.CanGrow = true;
            subTransRegistrationDetailRSAJ.InitializeReport(lstDetail);
            ...
            srTransRevenueDetailRSAJ.CanGrow = true;
            subTransRevenueDetailRSAJ.InitializeReport(lstPerRevenue);
            ...
            srTransSummaryAdjustmentDetailPlusRSAJ.CanGrow = true;
            subTransSummaryAdjustmentDetailPlusRSAJ.InitializeReport(lstAdj.Where(a => a.GCRSAdjustmentGroup == Constant.RevenueSharingAdjustmentGroup.PENAMBAHAN).ToList());

            srTransSummaryAdjustmentDetailMinusRSAJ.CanGrow = true;
            subTransSummaryAdjustmentDetailMinusRSAJ.InitializeReport(lstAdj.Where(a => a.GCRSAdjustmentGroup == Constant.RevenueSharingAdjustmentGroup.PENGURANGAN).ToList());
            ...
            srParamedicTaxBalanceRSAJ.CanGrow = true;
            ...
            srTransSummaryAdjustmentFondsRSAJ.CanGrow = true;
            subTransRevenueAdjustmentFondsRSAJ.InitializeReport(lstFonds);
            ...
            {
                totalTaxBalance = lstTaxBalance.Sum(a => a.Total);
            }
            else
            {
            ...
            decimal honorKenaPotongan = entity.RevenueSharingAmountAfterTaxWithHospitalFee;
