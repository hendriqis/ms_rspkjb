...
{
    public partial class LAktivitasBukuKasbyAccountRSDOSOBA : BaseDailyPortraitRpt
    {
        public LAktivitasBukuKasbyAccountRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblAkun.Text = string.Format("Akun Treasury : ({0}) {1}", BusinessLayer.GetChartOfAccount(Convert.ToInt16(param[1])).GLAccountNo , BusinessLayer.GetChartOfAccount(Convert.ToInt16(param[1])).GLAccountName);
