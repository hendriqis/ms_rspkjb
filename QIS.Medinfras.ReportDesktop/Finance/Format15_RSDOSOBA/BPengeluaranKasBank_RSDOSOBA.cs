...
{
    public partial class BPengeluaranKasBank_RSDOSOBA : BaseCustomDailyLandscapeA5Rpt
    {
        decimal subTotalPembayaran = 0;

        public BPengeluaranKasBank_RSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        private void lblPaymentAmountText_SummaryGetResult(object sender, SummaryGetResultEventArgs e)
        {
            ...
            {
                lblDirectorName.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.ASISTEN_MANAGER_KEUANGAN).FirstOrDefault().ParameterValue;
                lblDirectorCaption.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.ASISTEN_MANAGER_KEUANGAN).FirstOrDefault().Notes;

                xrLabel6.Visible = false;
                xrLine5.Visible = false;
                lblManagerName.Visible = false;
                lblManagerCaption.Visible = false;
            ...
            {
                lblDirectorName.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.MANAGER_KEUANGAN).FirstOrDefault().ParameterValue;
                lblDirectorCaption.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.MANAGER_KEUANGAN).FirstOrDefault().ParameterName;
                lblManagerName.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.ASISTEN_MANAGER_KEUANGAN).FirstOrDefault().ParameterValue;
                lblManagerCaption.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.ASISTEN_MANAGER_KEUANGAN).FirstOrDefault().Notes;
                lblSupervisorName.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.FN_KEPALABAGIAN_KEUANGAN).FirstOrDefault().ParameterValue;
                lblSupervisorCaption.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.FN_KEPALABAGIAN_KEUANGAN).FirstOrDefault().ParameterName;
            }
            else if (subTotalPembayaran > 20000000)
            {
                ...
                lblSupervisorName.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.ASISTEN_MANAGER_KEUANGAN).FirstOrDefault().ParameterValue;
                lblSupervisorCaption.Text = lstentity.Where(t => t.ParameterCode == Constant.SettingParameter.ASISTEN_MANAGER_KEUANGAN).FirstOrDefault().Notes;
            }
        }
