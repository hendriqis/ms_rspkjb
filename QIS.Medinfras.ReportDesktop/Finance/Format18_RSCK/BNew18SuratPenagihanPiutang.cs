...
{
    public partial class BNew18SuratPenagihanPiutang : BaseCustomDailyPotraitRpt
    {
        public BNew18SuratPenagihanPiutang()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            Term term = BusinessLayer.GetTermList(string.Format("TermID = {0}",invoiceHd.TermID)).FirstOrDefault();
            cTerm.Text = term.TermName;
