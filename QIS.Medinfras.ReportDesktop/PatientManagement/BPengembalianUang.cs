...
{
    public partial class BPengembalianUang : BaseDailyPortraitRpt
    {
        public BPengembalianUang()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblTotalAmountString.Text = "# " + entityPayment.TotalPaymentRefundAmountInString + " #";
