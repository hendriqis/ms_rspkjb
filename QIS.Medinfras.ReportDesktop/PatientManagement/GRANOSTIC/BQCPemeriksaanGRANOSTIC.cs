...
{
    public partial class BQCPemeriksaanGRANOSTIC : BaseCustomDailyPotraitA5Rpt
    {

        public BQCPemeriksaanGRANOSTIC()
        {
            InitializeComponent();
        }
        public override void InitializeReport(string[] param)
        {
            ...
            lblJenisP.Text = string.Format("{0} ({1})",entity.VisitTypeName, entity.ReferrerName);
