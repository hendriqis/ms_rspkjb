...
{
    public partial class BQCPemeriksaanGRANOSTICPerDetail : BaseCustomDailyPotraitA5Rpt
    {

        public BQCPemeriksaanGRANOSTICPerDetail()
        {
            InitializeComponent();
        }
        public override void InitializeReport(string[] param)
        {
            ...
            bqcPemeriksaanGRANOSTICJenis.InitializeReport(lstResultLab.FirstOrDefault().RegistrationID);
            #endregion
