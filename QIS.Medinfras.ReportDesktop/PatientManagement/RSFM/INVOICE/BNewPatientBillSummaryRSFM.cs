...
{
    public partial class BNewPatientBillSummaryRSFM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSFM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cHeaderPatient.Text = string.Format("{0} | {1} | {2} thn {3} bln {4} hr",
            ...
            billPaymentSummaryTransactionRSFM.InitializeReport(lstHDDT);
            #endregion
            ...
            #region Payment All
            subPaymentAllDMRSFM.CanGrow = true;
            billPaymentDetailPaymentAllDMRSFM.InitializeReport(lstPaymentHdDt);
            #endregion
