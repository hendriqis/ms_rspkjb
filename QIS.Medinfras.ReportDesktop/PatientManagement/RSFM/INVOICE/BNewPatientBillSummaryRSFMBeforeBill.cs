...
{
    public partial class BNewPatientBillSummaryRSFMBeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSFMBeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll10BeforeBill> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll10BeforeBillList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionRSFMBeforeBill.InitializeReport(lstHDDT);
            #endregion

            #region Payment All
            subPaymentAllDMRSFM.CanGrow = true;
            billPaymentDetailPaymentAllDMRSFM.InitializeReport(lstPaymentHdDt.Where(a => a.GCPaymentType == Constant.PaymentType.DOWN_PAYMENT).ToList());
            #endregion
