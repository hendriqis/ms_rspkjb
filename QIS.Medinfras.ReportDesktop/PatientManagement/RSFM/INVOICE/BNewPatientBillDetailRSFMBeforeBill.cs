...
{
    public partial class BNewPatientBillDetailRSFMBeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSFMBeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSFMBeforeBill.InitializeReport(lstHDDT);
            #endregion
