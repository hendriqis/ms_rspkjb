...
{
    public partial class BillPaymentSummaryTransactionRSFMBeforeBill : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSFMBeforeBill()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll10BeforeBill> lst)
        {
            this.DataSource = lst;
        }
