...
{
    public partial class BSEPRSDO : BaseDailyPortrait1Rpt
    {
        public BSEPRSDO()
        {
            InitializeComponent();
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            User entityUser = BusinessLayer.GetUser(Convert.ToInt32(entityReg.CreatedBy));
            ...
            lblUserName.Text = entityUser.UserName;
