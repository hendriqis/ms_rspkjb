...
{
    public partial class BPenerimaanUangMuka2 : BaseDailyPortraitRpt
    {
        public BPenerimaanUangMuka2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subPaymentDt.CanGrow = true;
            bPenerimaanUangMuka2Dt.InitializeReport(entityPayment.PaymentID);
