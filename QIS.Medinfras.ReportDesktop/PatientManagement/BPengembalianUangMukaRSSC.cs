...
{
    public partial class BPengembalianUangMukaRSSC : BaseDailyPortraitRpt
    {
        public BPengembalianUangMukaRSSC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblPatientName2.Text = entityHealthcare.HealthcareName;
