...
{
    public partial class BillPaymentDetailTransactionLineAmountWithoutDiscount : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionLineAmountWithoutDiscount()
        {
            InitializeComponent();
        }
