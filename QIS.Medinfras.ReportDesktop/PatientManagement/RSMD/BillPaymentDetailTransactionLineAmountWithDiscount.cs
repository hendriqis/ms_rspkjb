...
{
    public partial class BillPaymentDetailTransactionLineAmountWithDiscount : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionLineAmountWithDiscount()
        {
            InitializeComponent();
        }
