...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerateLineAmount2 : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerateLineAmount2()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBeforeBill> lst)
        {
            this.DataSource = lst;
        }
