...
{
    public partial class BNewPatientBillDetailBeforeGenerate3 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerate3()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerateLineAmount21.InitializeReport(lstHDDT);
            #endregion
