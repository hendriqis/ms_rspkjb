...
{
    public partial class BNewPatientBillDetail2RSMD : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetail2RSMD()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionLineAmount.InitializeReport(lstHDDT);
            #endregion
            ...
            else
            {
                ...
                billPaymentDetailDiscountAllLineAmount.Visible = false;
            }
            #endregion
