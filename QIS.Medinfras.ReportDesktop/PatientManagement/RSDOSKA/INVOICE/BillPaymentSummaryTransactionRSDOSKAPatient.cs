...
{
    public partial class BillPaymentSummaryTransactionRSDOSKAPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSDOSKAPatient()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll5> lst)
        {
            this.DataSource = lst;
        }
