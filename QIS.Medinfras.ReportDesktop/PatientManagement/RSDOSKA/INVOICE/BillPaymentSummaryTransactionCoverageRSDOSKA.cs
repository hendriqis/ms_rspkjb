...
{
    public partial class BillPaymentSummaryTransactionCoverageRSDOSKA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionCoverageRSDOSKA()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll4> lst)
        {
            this.DataSource = lst;
        }
