...
{
    public partial class BillPaymentDetailTransactionPerBillingRSDOSKA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSDOSKA()
        {
            InitializeComponent();
        }
