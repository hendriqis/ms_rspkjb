...
{
    public partial class BNewPatientBillSummaryPerBillingRSDOSKAPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSDOSKAPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingRSDOSKAPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
