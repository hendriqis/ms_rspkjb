...
{
    public partial class BNewPatientBillDetailPerBillingRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingRSDOSKA.InitializeReport(lstHDDT);
            #endregion
