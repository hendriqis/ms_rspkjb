...
{
    public partial class BillPaymentDetailTransactionPerBillingRSDOSKAPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSDOSKAPatient()
        {
            InitializeComponent();
        }
