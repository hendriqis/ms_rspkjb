...
{
    public partial class BNewPatientBillSummaryPerBillingRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingRSDOSKA.InitializeReport(lstHDDT);
            #endregion
