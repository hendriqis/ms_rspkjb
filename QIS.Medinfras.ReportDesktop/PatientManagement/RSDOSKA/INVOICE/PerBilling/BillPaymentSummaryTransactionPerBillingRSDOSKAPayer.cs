...
{
    public partial class BillPaymentSummaryTransactionPerBillingRSDOSKAPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingRSDOSKAPayer()
        {
            InitializeComponent();
        }
