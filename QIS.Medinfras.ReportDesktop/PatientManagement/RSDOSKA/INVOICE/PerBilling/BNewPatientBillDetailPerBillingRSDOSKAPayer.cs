...
{
    public partial class BNewPatientBillDetailPerBillingRSDOSKAPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSDOSKAPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingRSDOSKAPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
