...
{
    public partial class BillPaymentDetailTransactionPerBillingRSDOSKAPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSDOSKAPayer()
        {
            InitializeComponent();
        }
