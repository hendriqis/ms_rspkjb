...
{
    public partial class BNewPatientBillDetailPerBillingRSDOSKAPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSDOSKAPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingRSDOSKAPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
