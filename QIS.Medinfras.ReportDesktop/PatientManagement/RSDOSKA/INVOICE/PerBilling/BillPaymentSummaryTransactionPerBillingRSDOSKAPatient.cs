...
{
    public partial class BillPaymentSummaryTransactionPerBillingRSDOSKAPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingRSDOSKAPatient()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtPatientBill5> lst)
        {
            this.DataSource = lst;
        }
