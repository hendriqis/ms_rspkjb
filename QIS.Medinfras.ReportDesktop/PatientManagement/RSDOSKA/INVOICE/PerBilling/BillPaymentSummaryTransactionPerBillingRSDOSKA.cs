...
{
    public partial class BillPaymentSummaryTransactionPerBillingRSDOSKA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingRSDOSKA()
        {
            InitializeComponent();
        }
