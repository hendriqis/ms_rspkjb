...
{
    public partial class BillPaymentSummaryTransactionRekananRSDOSKA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRekananRSDOSKA()
        {
            InitializeComponent();
        }
