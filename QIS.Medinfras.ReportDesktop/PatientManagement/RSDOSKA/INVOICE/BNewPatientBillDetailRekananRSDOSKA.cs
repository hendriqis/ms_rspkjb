...
{
    public partial class BNewPatientBillDetailRekananRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRekananRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRekananRSDOSKA.InitializeReport(lstHDDT);
            #endregion
