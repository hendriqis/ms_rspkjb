...
{
    public partial class BillPaymentSummaryTransactionAllBillRSDOSKA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionAllBillRSDOSKA()
        {
            InitializeComponent();
        }
