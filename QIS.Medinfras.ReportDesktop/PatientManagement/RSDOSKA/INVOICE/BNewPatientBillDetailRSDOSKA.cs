...
{
    public partial class BNewPatientBillDetailRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSDOSKA.InitializeReport(lstHDDT);
            #endregion
