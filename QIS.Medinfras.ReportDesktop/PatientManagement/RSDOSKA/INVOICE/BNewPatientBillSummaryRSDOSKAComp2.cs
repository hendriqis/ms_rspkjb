...
{
    public partial class BNewPatientBillSummaryRSDOSKAComp2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSKAComp2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (lstHDDTComp2.Count() > 0)
            {
                ...
                billPaymentSummaryTransactionComp2RSDOSKA.InitializeReport(lstHDDTComp2);
            }
            else
            {
