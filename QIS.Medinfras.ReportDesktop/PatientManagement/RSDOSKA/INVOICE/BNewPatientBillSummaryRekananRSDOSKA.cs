...
{
    public partial class BNewPatientBillSummaryRekananRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRekananRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRekananRSDOSKA.InitializeReport(lstHDDT);
            #endregion
            ...
            decimal totalTransaction = transP + transC;
            cTotalTransactionC.Text = totalTransaction.ToString("N2");
            ...
            cBalanceC.Text = Balance.ToString("N2");
