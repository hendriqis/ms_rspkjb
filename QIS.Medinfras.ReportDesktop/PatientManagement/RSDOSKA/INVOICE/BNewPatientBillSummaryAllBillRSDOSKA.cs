...
{
    public partial class BNewPatientBillSummaryAllBillRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            ////List<GetPatientChargesHdDtAllBill2Comp2> lstHDDTComp2 = BusinessLayer.GetPatientChargesHdDtAllBill2Comp2List(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionAllBillRSDOSKA.InitializeReport(lstHDDT);
            #endregion
