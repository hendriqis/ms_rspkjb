...
{
    public partial class BNewPatientBillSummaryRSDOSKAPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSKAPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSDOSKAPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
