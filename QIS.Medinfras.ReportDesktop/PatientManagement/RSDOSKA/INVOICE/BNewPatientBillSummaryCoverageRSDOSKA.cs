...
{
    public partial class BNewPatientBillSummaryCoverageRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryCoverageRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll4> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll4List(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionCoverageRSDOSKA.InitializeReport(lstHDDT);
            #endregion
