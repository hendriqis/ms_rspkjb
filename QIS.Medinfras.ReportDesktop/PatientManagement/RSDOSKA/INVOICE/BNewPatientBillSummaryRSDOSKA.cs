...
{
    public partial class BNewPatientBillSummaryRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSDOSKA.InitializeReport(lstHDDT);
            #endregion
