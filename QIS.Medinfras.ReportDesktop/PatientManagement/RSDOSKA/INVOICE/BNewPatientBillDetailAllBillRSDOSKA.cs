...
{
    public partial class BNewPatientBillDetailAllBillRSDOSKA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionAllBillRSDOSKA.InitializeReport(lstHDDT);
            #endregion
