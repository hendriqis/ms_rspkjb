...
{
    public partial class BNewPatientBillDetailRSDOSKAPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSKAPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSDOSKAPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
