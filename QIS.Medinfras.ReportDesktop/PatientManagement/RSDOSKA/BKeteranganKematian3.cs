...
{
    public partial class BKeteranganKematian3 : BaseRpt
    {

        public BKeteranganKematian3()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                lblKematian.Text = String.Format("Tanggal {0} pukul {1}", entity.DateOfDeath.ToString(Constant.FormatString.DATE_FORMAT), entity.TimeOfDeath);
            }
            else
            {
                lblKematian.Text = String.Format("Tanggal {0} pukul {1}", "", entity.TimeOfDeath);
            }
