...
{
    public partial class BTransaksiA6_RSDOSKA : BaseA6Rpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if ( !string.IsNullOrEmpty(entityReg.GCReferrerGroup)) 
            {
                if (!string.IsNullOrEmpty(entityReg.ReferrerParamedicName)) {
                    cParamedicName.Text = entityReg.ReferrerParamedicName;
                }
                else if (!string.IsNullOrEmpty(entityReg.ReferrerName)) {
            ...
            //if (entityReg.GCCustomerType == custTypeBPJS && entity.DepartmentID == "PHARMACY")
            //{
