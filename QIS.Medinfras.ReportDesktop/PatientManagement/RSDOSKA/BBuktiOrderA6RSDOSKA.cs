...
{
    public partial class BBuktiOrderA6RSDOSKA : BaseA6Rpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vTestOrderHd entityHd = BusinessLayer.GetvTestOrderHdList(param[0]).FirstOrDefault();
            ...
            ParamedicMaster entityPar = BusinessLayer.GetParamedicMasterList(string.Format("ParamedicID = {0}", entityHd.ParamedicID)).FirstOrDefault();
            ...
            //cParamedicName2.Text = entityPar.FullName;
            cTransaction.Text = string.Format("{0} | {1}", entityHd.TestOrderNo, entityHd.TestOrderDateInString);
           ...
           // cReferenceNo.Text = entityHd.Remarks;
            ...
            StandardCode entityStandardCode = BusinessLayer.GetStandardCodeList(String.Format("StandardCodeID = '{0}'", entityHd.GCToBePerformed)).FirstOrDefault();
            string standardCodeName = entityStandardCode != null ? entityStandardCode.StandardCodeName : string.Empty;
            cSEPNo.Text = entityReg.NoSEP;
            cTestOrderDateTime.Text = string.Format("{0} | {1}", standardCodeName, entityHd.cfScheduledDateInString);
            #endregion
          ...
          //  cHeaderPatient.Text = string.Format("{0}", entityReg.MedicalNo);
           // cHeaderRegTrans.Text = string.Format("{0} | {1}", entityReg.RegistrationNo, entityHd.TestOrderNo);
            ...
            //{
            //    lblLastUpdatedBy.Text = BusinessLayer.GetUserAttribute(entityHd.LastUpdateBy).FullName;
            //}
            //else
            //{
