...
{
    public partial class BSuratKeteranganPerkiraanLahirKaryawanRSDOSKA : BaseDailyPortraitRpt
    {
        public BSuratKeteranganPerkiraanLahirKaryawanRSDOSKA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblDate.Text = string.Format("Saat ini dalam keadaan hamil dan diperkirakan akan melahirkan pada tanggal : {0}", param[3]);
