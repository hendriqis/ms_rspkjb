...
{
    public partial class BNewPatientBillSummaryRSSMP : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSMP()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailDiscountAllRSSMP.InitializeReport(entityReg.RegistrationID);
            #endregion
