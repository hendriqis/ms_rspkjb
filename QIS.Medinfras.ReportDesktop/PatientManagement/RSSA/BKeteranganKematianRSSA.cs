...
{
    public partial class BKeteranganKematianRSSA : BaseRpt
    {

        public BKeteranganKematianRSSA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblDiagnose.Text = String.Format("{0}", param[4]);
            ...
            String noSuratKematian = string.Format("..../RM/{0}/..../20....", entityH1.Initial);
            lblSuratKematian.Text = string.Format("NO : ");
            #endregion
        }
    }
}