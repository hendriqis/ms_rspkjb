...
{
    public partial class BPatientItemPerBillingGroup_RSSBB : BaseCustomDailyPotraitRpt
    {
        public BPatientItemPerBillingGroup_RSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentPerBillingGroupRSSBB1.InitializeReport(lstHDDT);
            #endregion
