...
{
    public partial class BSuratKeteranganKelahiranFPHS : BaseCustomDailyLandscapeA5Rpt
    {
        public BSuratKeteranganKelahiranFPHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            #region Detail
           lblSklNo.Text = string.Format("{0}", entity.ReferenceNo);
           cellTTD.Text = string.Format("( {0} )", entityVisitMom.ParamedicName);
            ...
            string cellHari = string.Format("{0}", dobData[0].ToUpper());
            //cellHariEng.Text = dobData[1].ToUpper();
            cellTanggalLahir.Text = string.Format("{0}, {1}", cellHari, entity.DateOfBirth.ToString(Constant.FormatString.DATE_FORMAT_1));
           ...
           // cellKelainanBawaan.Text = entity.HerediateryDefectRemarks.ToUpper();
            ...
            cSaksi.Text = string.Format("( {0} )", entity.FatherFullName);
