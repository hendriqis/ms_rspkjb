...
{
    public partial class BE_SEP_PHS : BaseRpt
    {
        public BE_SEP_PHS()
        {
            InitializeComponent();
        ...
        public override void InitializeReport(string[] param)
        {
          ...
          /////  lblKlsRawat.Text = entity.BPJSClassName;
            ...
            string VClaimAssessmenPelayanan = "";
            if (!string.IsNullOrEmpty(entity.VClaimAssessmenPelayanan))
            {
                StandardCode oStandardcode = BusinessLayer.GetStandardCode(entity.VClaimAssessmenPelayanan);
                if (oStandardcode != null)
                {
                    VClaimAssessmenPelayanan = oStandardcode.StandardCodeName;
                }
            }
            lblAsesmentPelayanaan.Text = VClaimAssessmenPelayanan;
