...
{
    public partial class LPendaftaranPasienPerPenjaminBayarPerServisUnit : BaseCustomDailyLandscapeRpt
    {
        public LPendaftaranPasienPerPenjaminBayarPerServisUnit()
        {
            InitializeComponent();
        }
