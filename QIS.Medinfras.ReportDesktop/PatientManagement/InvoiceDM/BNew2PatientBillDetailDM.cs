...
{
    public partial class BNew2PatientBillDetailDM : BaseCustomDailyPotraitRpt
    {
        public BNew2PatientBillDetailDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            new2BillPaymentDetailTransactionDM1.InitializeReport(lstHDDT);
            #endregion
