...
{
    public partial class New2BillPaymentDetailTransactionDM : DevExpress.XtraReports.UI.XtraReport
    {
        public New2BillPaymentDetailTransactionDM()
        {
            InitializeComponent();
        }
        ...
        private void xrLabel1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                xrLabel1.Text = string.Format("{0} | {1}", Convert.ToString(GetCurrentColumnValue("ItemType")), Convert.ToString(GetCurrentColumnValue("ItemGroupCode")));
            }
