...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateDM()
        {
            InitializeComponent();
        }
