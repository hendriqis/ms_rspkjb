...
{
    public partial class BNewPatientBillPaymentSummaryMCUDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentSummaryMCUDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentSummaryTransactionByPaymentMCUDM.InitializeReport(lstHDDT);
            }
            else
            {
            ...
            billPaymentDetailPaymentDM.InitializeReport(lstPaymentHdDt.Where(t => t.PaymentID == entityPayment.PaymentID).ToList());
            #endregion
