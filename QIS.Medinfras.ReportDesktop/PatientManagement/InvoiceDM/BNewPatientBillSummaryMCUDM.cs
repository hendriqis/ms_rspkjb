...
{
    public partial class BNewPatientBillSummaryMCUDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryMCUDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionMCUDM.InitializeReport(lstHDDT);
            #endregion
