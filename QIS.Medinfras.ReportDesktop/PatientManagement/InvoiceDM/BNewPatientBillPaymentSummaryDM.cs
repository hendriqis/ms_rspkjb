...
{
    public partial class BNewPatientBillPaymentSummaryDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentSummaryDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentSummaryTransactionDM.InitializeReport(lstHDDT);
            }
            else
            {
