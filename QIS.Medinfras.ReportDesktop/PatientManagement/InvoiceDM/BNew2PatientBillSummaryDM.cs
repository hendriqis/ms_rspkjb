...
{
    public partial class BNew2PatientBillSummaryDM : BaseCustomDailyPotraitRpt
    {
        public BNew2PatientBillSummaryDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            newBillPaymentSummaryTransactionDM1.InitializeReport(lstHDDT);
            #endregion
