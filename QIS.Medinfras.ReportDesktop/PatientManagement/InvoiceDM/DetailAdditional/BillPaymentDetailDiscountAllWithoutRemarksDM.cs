...
{
    public partial class BillPaymentDetailDiscountAllWithoutRemarksDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailDiscountAllWithoutRemarksDM()
        {
            InitializeComponent();
        }
