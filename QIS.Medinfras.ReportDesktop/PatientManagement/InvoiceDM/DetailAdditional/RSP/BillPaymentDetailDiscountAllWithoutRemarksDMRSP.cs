...
{
    public partial class BillPaymentDetailDiscountAllWithoutRemarksDMRSP : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailDiscountAllWithoutRemarksDMRSP()
        {
            InitializeComponent();
        }
