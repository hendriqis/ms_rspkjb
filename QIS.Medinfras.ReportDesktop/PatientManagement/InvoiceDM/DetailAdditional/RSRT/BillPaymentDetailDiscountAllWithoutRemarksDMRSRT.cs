...
{
    public partial class BillPaymentDetailDiscountAllWithoutRemarksDMRSRT : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailDiscountAllWithoutRemarksDMRSRT()
        {
            InitializeComponent();
        }
