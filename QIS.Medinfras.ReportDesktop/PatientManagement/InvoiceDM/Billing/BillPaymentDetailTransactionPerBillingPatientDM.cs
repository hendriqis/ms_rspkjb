...
{
    public partial class BillPaymentDetailTransactionPerBillingPatientDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingPatientDM()
        {
            InitializeComponent();
        }
