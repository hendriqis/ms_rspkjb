...
{
    public partial class BNewPatientBillDetailPerBillingPatientDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingPatientDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingPatientDM.InitializeReport(lstHDDT);
            #endregion
