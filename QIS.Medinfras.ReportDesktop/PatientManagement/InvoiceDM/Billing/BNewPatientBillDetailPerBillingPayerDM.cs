...
{
    public partial class BNewPatientBillDetailPerBillingPayerDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingPayerDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingPayerDM.InitializeReport(lstHDDT);
            #endregion
