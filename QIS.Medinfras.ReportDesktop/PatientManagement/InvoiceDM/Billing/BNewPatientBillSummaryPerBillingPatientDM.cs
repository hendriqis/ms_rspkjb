...
{
    public partial class BNewPatientBillSummaryPerBillingPatientDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingPatientDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtPatientBill> lstHDDT = BusinessLayer.GetPatientChargesHdDtPatientBillList(entityReg.RegistrationID, lstBill.FirstOrDefault().PatientBillingID);
            ...
            if (entityReg.LinkedRegistrationID != null)
            {
                cNotes.Text = string.Format("Transfer Rawat Inap ({0})", entityReg.LinkedRegistrationNo);
            }
            else
            {
                cNotes.Text = "-";
            ...
            billPaymentSummaryTransactionPerBillingPatientDM.InitializeReport(lstHDDT);
            #endregion
            ...
            #region Footer
            lblTanggal.Text = string.Format("{0}, {1}", entityHealthcare.City, lstBill.FirstOrDefault().BillingDate.ToString(Constant.FormatString.DATE_FORMAT));
            lblTandaTangan.Text = lstBill.FirstOrDefault().CreatedByFullName;
            #endregion
