...
{
    public partial class BNewPatientBillDetailPerBillingDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingDM.InitializeReport(lstHDDT);
            #endregion
