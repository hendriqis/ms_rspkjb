...
{
    public partial class BillPaymentDetailTransactionPerBillingPayerDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingPayerDM()
        {
            InitializeComponent();
        }
