...
{
    public partial class BNewPatientBillSummaryPerBillingPayerDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingPayerDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingPayerDM.InitializeReport(lstHDDT);
            #endregion
