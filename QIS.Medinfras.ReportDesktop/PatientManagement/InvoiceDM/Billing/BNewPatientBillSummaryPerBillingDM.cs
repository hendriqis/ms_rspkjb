...
{
    public partial class BNewPatientBillSummaryPerBillingDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingDM.InitializeReport(lstHDDT);
            #endregion
