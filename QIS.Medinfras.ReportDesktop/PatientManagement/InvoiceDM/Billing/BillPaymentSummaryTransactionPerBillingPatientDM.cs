...
{
    public partial class BillPaymentSummaryTransactionPerBillingPatientDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingPatientDM()
        {
            InitializeComponent();
        }
