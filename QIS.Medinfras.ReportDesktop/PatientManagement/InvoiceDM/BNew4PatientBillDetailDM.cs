...
{
    public partial class BNew4PatientBillDetailDM : BaseCustomDailyPotraitRpt
    {
        public BNew4PatientBillDetailDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            string FilterExpression = String.Format("RegistrationID = {0} AND BusinessPartnerID IN ('{1}','{2}')", entityReg.RegistrationID, bpjskesehatan, bpjsketenagakerjaan);
            List<RegistrationPayer> lstregPayer = BusinessLayer.GetRegistrationPayerList(FilterExpression);

            bool isBPJSPayer = false;
            ...
            new3BillPaymentDetailTransactionDM.InitializeReport(lstHDDT);
            #endregion
            ...
            New4BillPaymentDetailPaymentAllDM.InitializeReport(lstPaymentHdDt, isBPJSPayer);
            #endregion
