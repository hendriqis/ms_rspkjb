...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerateDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerateDM()
        {
            InitializeComponent();
        }
