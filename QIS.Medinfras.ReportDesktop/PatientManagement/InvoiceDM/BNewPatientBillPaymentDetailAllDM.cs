...
{
    public partial class BNewPatientBillPaymentDetailAllDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailAllDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentDetailTransactionDM.InitializeReport(lstHDDT);
            }
            else
            {
