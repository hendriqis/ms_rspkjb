...
{
    public partial class MRPatientMainDiagnosisRSPKSB : DevExpress.XtraReports.UI.XtraReport
    {
        public MRPatientMainDiagnosisRSPKSB()
        {
            InitializeComponent();
        }
        ...
        {
            List<vPatientDiagnosis> entityD = BusinessLayer.GetvPatientDiagnosisList(string.Format("VisitID = {0} AND GCDiagnoseType = '{1}' AND IsDeleted = 0", VisitID, Constant.DiagnoseType.MAIN_DIAGNOSIS));
