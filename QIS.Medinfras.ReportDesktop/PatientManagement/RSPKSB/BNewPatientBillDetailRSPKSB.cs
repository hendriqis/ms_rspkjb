...
{
    public partial class BNewPatientBillDetailRSPKSB : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSPKSB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSBBv2.InitializeReport(lstDetail);
            #endregion
