...
{
    public partial class BNewPatientBillSummaryAllBillRSPKSB : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillRSPKSB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllBill2> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllBill2List(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionAllBillRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
            ...
            decimal balanceP = amountP - paymentP;
