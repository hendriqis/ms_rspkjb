...
{
    public partial class BLembarHasilTindakanUjiFungsi : BaseRpt
    {

        public BLembarHasilTindakanUjiFungsi()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblStreetName.Text = string.Format("{0} / {1}", entity.StreetName, entityP.MobilePhoneNo1);
            ...
            if (entityDiagnose != null)
            {
                ...
                if (diagcompl != null)
                {
                    if (diagcompl.DiagnoseID != "")
                    {
                        ...
                        lblKesimpulan.Text = string.Format("{0} - {1}", diagcompl.DiagnoseID, diagcompl.DiagnoseName);
                    }
                    else
                    {
                        lblDiagnoseSekunder.Text = string.Format("{0}", diagcompl.DiagnosisText);
                        lblKesimpulan.Text = string.Format("{0}", diagcompl.DiagnosisText);
                    }
                }
                else
                {
