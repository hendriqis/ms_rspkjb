...
{
    public partial class BNewPaymentReceipt34DtRekap2 : BaseRpt
    {
        private int _lineNumber = 0;
        public BNewPaymentReceipt34DtRekap2()
        {
            _lineNumber = 0;
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtALLPerPayment3> lst, List<vPatientBill> lstBill)
        {
            decimal totalDiscount = 0;
            decimal totalBruto = 0;
            this.DataSource = lst;
            GetPatientChargesHdDtALLPerPayment3 entity = lst.FirstOrDefault();
