...
{
    public partial class BPenerimaanUangMukaRSPW : BaseCustomA6Rpt
    {
        ...
        public BPenerimaanUangMukaRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityHealthcare != null)
            {
                ...
                lblPatientName.Text = entityHealthcare.HealthcareName;
            }
            ...
            lblTotalAmountString.Text = "# " + entityPayment.FirstOrDefault().TotalPaymentAmountInString + " #";

            txtCityAndDate.Text = entityHealthcare.City + ", " + entityPayment.FirstOrDefault().PaymentDate.ToString(Constant.FormatString.DATE_FORMAT);
            lblLastUpdatedBy.Text = appSession.UserFullName;


            vRegistration entityReg = BusinessLayer.GetvRegistrationList(string.Format("RegistrationID = {0}", entityPayment.FirstOrDefault().RegistrationID)).FirstOrDefault();
