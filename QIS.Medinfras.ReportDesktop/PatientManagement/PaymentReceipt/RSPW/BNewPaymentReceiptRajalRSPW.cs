...
{
    public partial class BNewPaymentReceiptRajalRSPW : BaseCustomA6Rpt
    {
        ...
        public BNewPaymentReceiptRajalRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            xrLabel3.Text = Function.NumberInWords(Convert.ToInt64(totalPatientAmount), true);
            txtTotal.Text = string.Format("Terbilang Rp. {0}", totalPatientAmount.ToString("N2"));
