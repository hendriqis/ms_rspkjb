...
{
    public partial class BNewPaymentReceipt_RSCK : BaseRpt
    {
        private string city = "";

        public BNewPaymentReceipt_RSCK()
        {
            InitializeComponent();
        }
        ...
        private void lblPrintNumber_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Param.ParameterValue == "1")
            {
                ...
                if (PrintNumber > 0)
                {
                    Int32 PrintNote = Convert.ToInt32((GetCurrentColumnValue("PrintNumber")).ToString());
                    ...
                    if (PrintNote == 1)
                    {
                        ...
                        lblprintnote.Text = "yang dianggap sah adalah cetakan ke - 1";
                    }
                    else
                    {
                        lblprintnote.Text = "perlu legalisir kembali";
                    }
