...
{
    public partial class BNewPaymentReceipt3 : BaseRpt
    {
        private string city = "";

        public BNewPaymentReceipt3()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            #region Payment All
            List<vPatientPaymentHd> lstPayment = BusinessLayer.GetvPatientPaymentHdList(string.Format("PaymentReceiptID = {0} AND GCTransactionStatus != '{1}'",
                Convert.ToInt32(param[0]), Constant.TransactionStatus.VOID));
            subPaymentReceiptDt.CanGrow = true;
            bNewPaymentReceipt2Dt.InitializeReport(lstPayment);
            #endregion
        ...
        private void lblTanggal_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            //}
            lblTanggal.Text = DateTime.Now.ToString(Constant.FormatString.DATE_FORMAT);
        }

        private void lblDiagnosa_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (GetCurrentColumnValue("Diagnose1").ToString() != "")
            {
