...
{
    public partial class BNewPaymentReceiptGRANOSTICWatermark : BaseCustomDailyLandscapeA5Rpt
    {
        private string city = "";
        private string healthcareName = "";

        public BNewPaymentReceiptGRANOSTICWatermark()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPaymentReceiptCustomDetailTransactionGRANOSTIC> lstHDDT = BusinessLayer.GetPaymentReceiptCustomDetailTransactionGRANOSTICList(lstReceipt.FirstOrDefault().PaymentReceiptID);
