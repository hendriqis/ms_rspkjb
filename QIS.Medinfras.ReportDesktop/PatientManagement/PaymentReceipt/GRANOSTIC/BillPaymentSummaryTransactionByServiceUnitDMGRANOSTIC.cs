...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitDMGRANOSTIC : BaseCustomDailyLandscapeA5Rpt
    {
        public BillPaymentSummaryTransactionByServiceUnitDMGRANOSTIC()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPaymentReceiptCustomDetailTransactionGRANOSTIC> lst)
        {
            this.DataSource = lst;
