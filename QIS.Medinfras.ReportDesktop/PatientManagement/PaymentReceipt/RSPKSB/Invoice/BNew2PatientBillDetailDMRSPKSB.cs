...
{
    public partial class BNew2PatientBillDetailDMRSPKSB : BaseCustomDailyPotraitRpt
    {
        public BNew2PatientBillDetailDMRSPKSB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            new2BillPaymentDetailTransactionDMRSPKSB.InitializeReport(lstHDDT);
            #endregion
