...
{
    public partial class BNewPaymentReceipt35 : BaseRpt
    {
        private string City = "";

        public BNewPaymentReceipt35()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblTime.Text = DateTime.Now.ToString(Constant.FormatString.DATE_TIME_FORMAT_2);
            ...
            subPaymentReceipt35Dt.CanGrow = true;
            bNewPaymentReceipt35Dt.InitializeReport(lstPayment);
            #endregion
        ...
        private void lblPrintNumber_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Param.ParameterValue == "1")
            {
                ...
                if (PrintNumber > 0)
                {
                    lblPrintNumber.Text = string.Format("Print No. {0}", GetCurrentColumnValue("PrintNumber").ToString());
                }
                else
                {
                    lblPrintNumber.Text = "";
