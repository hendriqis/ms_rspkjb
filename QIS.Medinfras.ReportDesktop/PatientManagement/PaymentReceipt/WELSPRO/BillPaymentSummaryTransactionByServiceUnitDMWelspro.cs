...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitDMWelspro : BaseCustomDailyLandscapeA5Rpt
    {
        public BillPaymentSummaryTransactionByServiceUnitDMWelspro()
        {
            InitializeComponent();
        }
