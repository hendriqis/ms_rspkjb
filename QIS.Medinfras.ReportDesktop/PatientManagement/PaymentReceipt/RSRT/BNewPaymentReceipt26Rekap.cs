...
{
    public partial class BNewPaymentReceipt26Rekap : BaseRpt
    {
        public BNewPaymentReceipt26Rekap()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(List<vPatientBill> lstBill)
        {
            ...
            decimal roundP = lstBill.Sum(p => p.PatientRoundingAmount);
            decimal roundC = lstBill.Sum(p => p.PayerRoundingAmount);
            ...
            cRoundingP.Text = roundP.ToString("N2");
            cRoundingC.Text = roundC.ToString("N2");
