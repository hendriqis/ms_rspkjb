...
{
    public partial class BNewPaymentReceiptTemplate : BaseRpt
    {
        private string city = "";

        public BNewPaymentReceiptTemplate()
        {
            InitializeComponent();
        }
        ...
        private void lblTanggal_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                lblTanggal.Text = string.Format("{0}",  receiptDate);
            }
            else
            {
                lblTanggal.Text = string.Format("{0}", createdDate);
            }
        }
