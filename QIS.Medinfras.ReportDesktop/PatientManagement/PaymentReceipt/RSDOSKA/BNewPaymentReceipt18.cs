...
{
    public partial class BNewPaymentReceipt18 : BaseRpt
    {
        private string City = "";

        public BNewPaymentReceipt18()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subPaymentReceipt18Dt.CanGrow = true;
            bNewPaymentReceipt18Dt.InitializeReport(lstPayment);
            #endregion
