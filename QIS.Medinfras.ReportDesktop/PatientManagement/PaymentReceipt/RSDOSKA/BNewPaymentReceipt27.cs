...
{
    public partial class BNewPaymentReceipt27 : BaseRpt
    {
        private string City = "";

        public BNewPaymentReceipt27()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPaymentReceiptCustomDetailTransactionMCU> lstPayment = BusinessLayer.GetPaymentReceiptCustomDetailTransactionMCUList(lstEntity.FirstOrDefault().PaymentReceiptID);
            subPaymentReceipt27Dt.CanGrow = true;
            bNewPaymentReceipt27Dt.InitializeReport(lstPayment);
            #endregion
