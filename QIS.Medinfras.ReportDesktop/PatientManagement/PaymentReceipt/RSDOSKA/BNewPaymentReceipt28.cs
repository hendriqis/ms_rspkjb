...
{
    public partial class BNewPaymentReceipt28 : BaseRpt
    {
        private string City = "";

        public BNewPaymentReceipt28()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            subPaymentReceipt28Dt.CanGrow = true;
            bNewPaymentReceipt28Dt.InitializeReport(lstPayment);
            #endregion
