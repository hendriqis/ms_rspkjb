...
{
    public partial class BPembayaranCostSharing : BaseDailyPortraitRpt
    {
        public BPembayaranCostSharing()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblTotalAmountString.Text = "# " + entityPayment.TotalReceiveAmountInString + " #";
