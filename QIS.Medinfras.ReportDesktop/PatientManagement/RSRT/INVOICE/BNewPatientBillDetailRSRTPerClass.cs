...
{
    public partial class BNewPatientBillDetailRSRTPerClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSRTPerClass()
        {
            InitializeComponent();
        }
        ...
        {
            string[] paramSplit = param[0].Split('|');
            string[] par = new string[1];
            //par[0] = string.Format("RegistrationID = {0}",param[0]);
            par[0] = string.Format("RegistrationID = {0}", paramSplit[0]);

            vRegistration entityReg = BusinessLayer.GetvRegistrationList(string.Format("RegistrationID = {0}", paramSplit[0])).FirstOrDefault();
            ...
            List<GetPatientChargesHdDtChargesClass> lstHDDT = BusinessLayer.GetPatientChargesHdDtChargesClassList(entityReg.RegistrationID, Convert.ToInt32(param[1]));
            ...
            billPaymentDetailTransactionRSRTPerClass.InitializeReport(lstHDDT);
            #endregion
