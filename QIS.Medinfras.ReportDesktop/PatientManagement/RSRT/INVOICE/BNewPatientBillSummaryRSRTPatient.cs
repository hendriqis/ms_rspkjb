...
{
    public partial class BNewPatientBillSummaryRSRTPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSRTPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSRTPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
