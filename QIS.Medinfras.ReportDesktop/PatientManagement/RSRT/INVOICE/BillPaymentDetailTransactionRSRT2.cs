...
{
    public partial class BillPaymentDetailTransactionRSRT2 : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSRT2()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllRSRT2> lst)
        {
            this.DataSource = lst;
        }
