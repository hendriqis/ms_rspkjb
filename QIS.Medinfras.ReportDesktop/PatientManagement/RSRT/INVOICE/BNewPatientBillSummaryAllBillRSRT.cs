...
{
    public partial class BNewPatientBillSummaryAllBillRSRT : BaseCustomDailyPotraitRSRTRpt
    {
        public BNewPatientBillSummaryAllBillRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionAllBillRSRT.InitializeReport(lstHDDT);
            #endregion
