...
{
    public partial class BNewPatientBillDetailRSRTPatient : BaseCustomDailyPotraitRSRTRpt
    {
        public BNewPatientBillDetailRSRTPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSRTPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllDMPatientRSRT.InitializeReport(entityReg.RegistrationID);
            #endregion
