...
{
    public partial class BNewPatientBillDetailAllBillRSRT : BaseCustomDailyPotraitRSRTRpt
    {
        public BNewPatientBillDetailAllBillRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllBillRSRT> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllBillRSRTList(entityReg.RegistrationID);
            ...
            billPaymentDetailTransactionAllBillRSRT.InitializeReport(lstHDDT);
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllDMRSRT.InitializeReport(entityReg.RegistrationID);
            #endregion
            ...
            billPaymentDetailPaymentAllDMRSRT.InitializeReport(lstPaymentHdDt);
            #endregion
            ...
            billPaymentDetailDiscComp2TransactionAllBillRSRT.InitializeReport(lstHDDT.Where(a => a.cfDiscountAmountComp2 != 0).ToList());
            #endregion
