...
{
    public partial class BNewPatientBillSummaryRSRT : BaseCustomDailyPotraitRSRTRpt
    {
        public BNewPatientBillSummaryRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSRT.InitializeReport(lstHDDT);
            #endregion
