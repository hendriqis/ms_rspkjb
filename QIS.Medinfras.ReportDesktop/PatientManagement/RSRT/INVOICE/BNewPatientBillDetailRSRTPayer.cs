...
{
    public partial class BNewPatientBillDetailRSRTPayer : BaseCustomDailyPotraitRSRTRpt
    {
        public BNewPatientBillDetailRSRTPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailPaymentAllDMRSRT.InitializeReport(lstPaymentHdDt.Where(a => a.GCPaymentType == Constant.PaymentType.AR_PAYER).ToList());
            #endregion
            ...
            billPaymentDetailDiscComp2TransactionRSRT.InitializeReport(lstHDDT.Where(a => a.cfDiscountAmountComp2 != 0).ToList());
            #endregion
