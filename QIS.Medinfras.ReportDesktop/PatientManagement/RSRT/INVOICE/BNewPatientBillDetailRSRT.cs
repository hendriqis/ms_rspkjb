...
{
    public partial class BNewPatientBillDetailRSRT : BaseCustomDailyPotraitRSRTRpt
    {
        public BNewPatientBillDetailRSRT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllRSRT2> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllRSRT2List(entityReg.RegistrationID);
            ...
            List<GetPatientChargesHdDtAllRSRT2> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentDetailTransactionRSRT2.InitializeReport(lstDetail);
            #endregion
