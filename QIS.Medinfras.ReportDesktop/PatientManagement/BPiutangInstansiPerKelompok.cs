...
{
    public partial class BPiutangInstansiPerKelompok : BaseDailyPortraitRpt
    {
        List<PatientBill> lstEntityBill = null;
        String custType;

        public BPiutangInstansiPerKelompok()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblServiceUnitName.Text = entityReg.ServiceUnitName;
