...
{
    public partial class BNewPatientBillDetailPerBillingRSPBTDetailKelasTagihan : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSPBTDetailKelasTagihan()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSPBTDetailKelasTagihan.InitializeReport(lstHDDT);
            #endregion
