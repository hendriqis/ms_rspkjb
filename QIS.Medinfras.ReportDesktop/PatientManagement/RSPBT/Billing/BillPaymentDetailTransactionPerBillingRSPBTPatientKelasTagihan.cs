...
{
    public partial class BillPaymentDetailTransactionPerBillingRSPBTPatientKelasTagihan : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSPBTPatientKelasTagihan()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtALLChargeClass> lst)
        {
            this.DataSource = lst;
        }
