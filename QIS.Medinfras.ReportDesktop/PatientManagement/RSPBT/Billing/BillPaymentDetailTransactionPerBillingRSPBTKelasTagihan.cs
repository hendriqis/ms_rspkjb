...
{
    public partial class BillPaymentDetailTransactionPerBillingRSPBTKelasTagihan : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSPBTKelasTagihan()
        {
            InitializeComponent();
        }
