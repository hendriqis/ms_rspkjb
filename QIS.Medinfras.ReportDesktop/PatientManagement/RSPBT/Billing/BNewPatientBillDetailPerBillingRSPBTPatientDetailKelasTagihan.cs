...
{
    public partial class BNewPatientBillDetailPerBillingRSPBTPatientDetailKelasTagihan : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSPBTPatientDetailKelasTagihan()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSPBTPatientKelasTagihan.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
