...
{
    public partial class BillPaymentDetailTransactionPerBillingRSPBTPayerKelasTagihan : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSPBTPayerKelasTagihan()
        {
            InitializeComponent();
        }
