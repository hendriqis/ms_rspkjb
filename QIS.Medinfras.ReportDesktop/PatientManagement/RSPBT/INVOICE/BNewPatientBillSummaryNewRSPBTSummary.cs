...
{
    public partial class BNewPatientBillSummaryNewRSPBTSummary : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryNewRSPBTSummary()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSPBTSummary.InitializeReport(lstHDDT);
            #endregion
