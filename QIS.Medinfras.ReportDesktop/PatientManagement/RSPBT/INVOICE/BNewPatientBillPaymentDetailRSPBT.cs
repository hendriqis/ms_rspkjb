...
{
    public partial class BNewPatientBillPaymentDetailRSPBT : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailRSPBT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            #region Footer
            cPrintDate.Text = string.Format("{0}" ,DateTime.Now.ToString(Constant.FormatString.DATE_FORMAT));
            cTTDPatient.Text = string.Format("({0})", entityReg.PatientName);
            cTTDPrintedBy.Text = string.Format("({0})", appSession.UserFullName);
            #endregion
