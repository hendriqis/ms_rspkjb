...
{
    public partial class BNewPatientBillSummaryNewRSPBT : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryNewRSPBT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitDMRSPBT.InitializeReport(lstHDDT);
            #endregion
