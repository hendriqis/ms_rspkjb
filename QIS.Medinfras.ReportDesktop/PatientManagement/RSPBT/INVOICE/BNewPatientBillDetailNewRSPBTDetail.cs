...
{
    public partial class BNewPatientBillDetailNewRSPBTDetail : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailNewRSPBTDetail()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSPBTDetail.InitializeReport(lstHDDT);
            #endregion
