...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitDMRSPBT : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionByServiceUnitDMRSPBT()
        {
            InitializeComponent();
        }
