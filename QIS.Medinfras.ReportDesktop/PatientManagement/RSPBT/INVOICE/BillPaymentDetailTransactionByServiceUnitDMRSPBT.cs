...
{
    public partial class BillPaymentDetailTransactionByServiceUnitDMRSPBT : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitDMRSPBT()
        {
            InitializeComponent();
        }
