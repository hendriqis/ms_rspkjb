...
{
    public partial class BNewPatientBillDetailNewRSPBTPatientDetailKelasTagihan : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailNewRSPBTPatientDetailKelasTagihan()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSPBTPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
