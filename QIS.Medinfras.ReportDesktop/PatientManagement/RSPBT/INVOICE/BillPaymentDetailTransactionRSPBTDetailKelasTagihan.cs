...
{
    public partial class BillPaymentDetailTransactionRSPBTDetailKelasTagihan : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSPBTDetailKelasTagihan()
        {
            InitializeComponent();
        }
