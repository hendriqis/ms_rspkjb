...
{
    public partial class BNewPatientBillSummaryBeforeGenerateDMRSPBT : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBeforeGenerateDMRSPBT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBeforeGenerateDM.InitializeReport(lstHDDT);
            #endregion
