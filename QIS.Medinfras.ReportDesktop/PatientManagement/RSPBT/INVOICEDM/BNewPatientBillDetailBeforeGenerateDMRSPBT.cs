...
{
    public partial class BNewPatientBillDetailBeforeGenerateDMRSPBT : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerateDMRSPBT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerateDM.InitializeReport(lstHDDT);
            #endregion
