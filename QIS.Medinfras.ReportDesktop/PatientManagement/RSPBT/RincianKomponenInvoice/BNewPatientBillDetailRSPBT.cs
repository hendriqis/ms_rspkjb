...
{
    public partial class BNewPatientBillDetailRSPBT : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSPBT()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll6Comp2> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll6Comp2List(entityReg.RegistrationID);
            ...
            billPaymentDetailTransactionComp2RSPBT.InitializeReport(lstHDDT);
            #endregion
