...
{
    public partial class BillPaymentDetailTransactionComp2RSPBT : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionComp2RSPBT()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll6Comp2> lst)
        {
            this.DataSource = lst;
        }
