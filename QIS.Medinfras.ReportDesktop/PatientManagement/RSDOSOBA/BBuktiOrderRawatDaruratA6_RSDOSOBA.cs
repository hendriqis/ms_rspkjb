...
{
    public partial class BBuktiOrderRawatDaruratA6_RSDOSOBA : BaseA6Rpt
    {
        ...
        public BBuktiOrderRawatDaruratA6_RSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vServiceOrderHd entityHd = BusinessLayer.GetvServiceOrderHdList(param[0]).FirstOrDefault();
            vServiceOrderDt entityDt = BusinessLayer.GetvServiceOrderDtList(param[0]).FirstOrDefault();
            ServiceOrderDt entityDt2 = BusinessLayer.GetServiceOrderDtList(param[0]).FirstOrDefault();
            ...
            UserAttribute entityUA = BusinessLayer.GetUserAttributeList(string.Format("UserID={0}", entityDt2.CreatedBy)).FirstOrDefault();
            string gender = "";
            ...
            cVisitServiceUnitName.Text = entityHd.FromServiceUnitName;
            ...
            cParamedicName2.Text = entityHd.OrderParamedicName;
            cTransaction.Text = string.Format("{0} | {1}", entityHd.ServiceOrderNo, entityHd.ServiceOrderDateInString);
            cServiceUnitName.Text = entityHd.ServiceUnitName;
            cDiagnosa.Text = entityHd.Remarks;
           // cReferenceNo.Text = entityHd.Remarks;
          ...
          //  cHeaderPatient.Text = string.Format("{0}", entityReg.MedicalNo);
           // cHeaderRegTrans.Text = string.Format("{0} | {1}", entityReg.RegistrationNo, entityHd.TestOrderNo);
            ...
            //{
                lblLastUpdatedBy.Text = BusinessLayer.GetUserAttribute(entityDt2.CreatedBy).FullName;
            //}
            //else
            //{
            //    lblLastUpdatedBy.Text = BusinessLayer.GetUserAttribute(entityHd.CreatedBy).FullName;
            //}
            //lblLastUpdatedBy.Text = string.Format("{0}", entityHd.CreatedBy);
                lblLastUpdatedDate.Text = string.Format("{0}, {1}", entityHealthcare.City, entityHd.ServiceOrderDateInString);
            #endregion
