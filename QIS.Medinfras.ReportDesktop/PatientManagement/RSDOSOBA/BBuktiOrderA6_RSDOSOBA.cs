...
{
    public partial class BBuktiOrderA6_RSDOSOBA : BaseA6Rpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vConsultVisit entityVisit = BusinessLayer.GetvConsultVisitList(string.Format("RegistrationID = {0}", entityReg.RegistrationID)).FirstOrDefault();
            ...
            cVisitServiceUnitName.Text = entityVisit.ServiceUnitName;
            ...
            cScheduledDate.Text = string.Format("{0}, {1}", entityHd.cfScheduledDateInString, entityHd.ScheduledTime);
