...
{
    public partial class BSuratPerintahRI : BaseA6Rpt
    {

        public BSuratPerintahRI()
        {
            InitializeComponent();
        }
        public override void InitializeReport(string[] param)
        {
            ...
            vRegistration entity = BusinessLayer.GetvRegistrationList(string.Format("RegistrationID = {0}", entityCV.RegistrationID)).FirstOrDefault();
            ...
            lblParamedicVisit.Text = entityCV.ParamedicName;
