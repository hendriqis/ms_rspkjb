...
{
    public partial class BillPaymentSummaryTransactionCoverageRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionCoverageRSDOSOBA()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll8> lst)
        {
            this.DataSource = lst;
        }
