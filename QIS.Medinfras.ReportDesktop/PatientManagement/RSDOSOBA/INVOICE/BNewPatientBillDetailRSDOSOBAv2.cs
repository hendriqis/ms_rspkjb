...
{
    public partial class BNewPatientBillDetailRSDOSOBAv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSOBAv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSDOSOBAv2.InitializeReport(lstHDDT);
            #endregion
