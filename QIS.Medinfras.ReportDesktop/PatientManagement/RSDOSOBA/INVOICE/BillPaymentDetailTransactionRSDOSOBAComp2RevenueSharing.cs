...
{
    public partial class BillPaymentDetailTransactionRSDOSOBAComp2RevenueSharing : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSDOSOBAComp2RevenueSharing()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll7Comp2> lst)
        {
            this.DataSource = lst;
        }
