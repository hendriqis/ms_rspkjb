...
{
    public partial class BillPaymentSummaryTransactionRSDOSOBAPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSDOSOBAPatient()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll7> lst)
        {
            this.DataSource = lst;
        }
