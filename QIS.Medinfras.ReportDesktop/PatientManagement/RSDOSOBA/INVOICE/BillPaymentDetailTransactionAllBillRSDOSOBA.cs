...
{
    public partial class BillPaymentDetailTransactionAllBillRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionAllBillRSDOSOBA()
        {
            InitializeComponent();
        }
