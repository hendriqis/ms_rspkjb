...
{
    public partial class BillPaymentDetailTransactionRSDOSOBAPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSDOSOBAPatient()
        {
            InitializeComponent();
        }
