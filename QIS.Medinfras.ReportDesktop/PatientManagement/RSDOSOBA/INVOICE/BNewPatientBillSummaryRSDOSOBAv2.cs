...
{
    public partial class BNewPatientBillSummaryRSDOSOBAv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSOBAv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSDOSOBAv2.InitializeReport(lstHDDT);
            #endregion
