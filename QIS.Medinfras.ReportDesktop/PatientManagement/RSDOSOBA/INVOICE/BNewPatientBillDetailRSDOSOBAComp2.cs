...
{
    public partial class BNewPatientBillDetailRSDOSOBAComp2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSOBAComp2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (lstHDDTComp2.Count() > 0)
            {
                ...
                billPaymentDetailTransactionComp2RSDOSOBA.InitializeReport(lstHDDTComp2);
            }
            else
            {
