...
{
    public partial class BNewPatientBillDetailRSDOSOBAChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSOBAChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSDOSOBAChargesClass.InitializeReport(lstHDDT);
            #endregion
