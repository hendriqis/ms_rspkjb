...
{
    public partial class BNewPatientBillDetailAllBillChargesClassRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillChargesClassRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionAllBillChargesClassRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
