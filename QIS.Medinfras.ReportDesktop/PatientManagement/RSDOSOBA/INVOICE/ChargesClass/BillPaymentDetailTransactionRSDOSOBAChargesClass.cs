...
{
    public partial class BillPaymentDetailTransactionRSDOSOBAChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSDOSOBAChargesClass()
        {
            InitializeComponent();
        }
