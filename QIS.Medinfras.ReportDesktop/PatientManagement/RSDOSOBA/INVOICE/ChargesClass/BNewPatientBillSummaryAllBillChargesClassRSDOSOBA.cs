...
{
    public partial class BNewPatientBillSummaryAllBillChargesClassRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillChargesClassRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll2BeforeBillChargesClass> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll2BeforeBillChargesClassList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionAllBillChargesClassRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
