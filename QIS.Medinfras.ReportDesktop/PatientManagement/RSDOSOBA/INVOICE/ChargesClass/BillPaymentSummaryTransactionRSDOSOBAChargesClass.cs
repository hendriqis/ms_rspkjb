...
{
    public partial class BillPaymentSummaryTransactionRSDOSOBAChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSDOSOBAChargesClass()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll3ChargesClass> lst)
        {
            this.DataSource = lst;
        }
