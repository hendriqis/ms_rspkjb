...
{
    public partial class BNewPatientBillSummaryRSDOSOBAChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSOBAChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll3ChargesClass> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll3ChargesClassList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionRSDOSOBAChargesClass.InitializeReport(lstHDDT);
            #endregion
