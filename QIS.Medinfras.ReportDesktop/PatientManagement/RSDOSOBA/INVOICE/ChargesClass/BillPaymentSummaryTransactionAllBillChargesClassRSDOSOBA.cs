...
{
    public partial class BillPaymentSummaryTransactionAllBillChargesClassRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionAllBillChargesClassRSDOSOBA()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll2BeforeBillChargesClass> lst)
        {
            this.DataSource = lst;
        }
        ...
        //{
        //    String LocationCode = Convert.ToString(GetCurrentColumnValue("LocationCode"));
        //    if (LocationCode == "")
        //    {
        //        tableLocation.Visible = false;
        //    }
        //    else
        //    {
        //        tableLocation.Visible = true;
        //    }
        //}
    }
}
