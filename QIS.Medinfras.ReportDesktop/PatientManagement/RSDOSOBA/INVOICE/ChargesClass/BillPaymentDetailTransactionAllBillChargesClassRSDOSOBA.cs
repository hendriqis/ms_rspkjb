...
{
    public partial class BillPaymentDetailTransactionAllBillChargesClassRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionAllBillChargesClassRSDOSOBA()
        {
            InitializeComponent();
        }
