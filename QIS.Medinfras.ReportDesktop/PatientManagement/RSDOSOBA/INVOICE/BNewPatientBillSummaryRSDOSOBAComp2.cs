...
{
    public partial class BNewPatientBillSummaryRSDOSOBAComp2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSOBAComp2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (lstHDDTComp2.Count() > 0)
            {
                ...
                billPaymentSummaryTransactionComp2RSDOSOBA.InitializeReport(lstHDDTComp2);
            }
            else
            {
