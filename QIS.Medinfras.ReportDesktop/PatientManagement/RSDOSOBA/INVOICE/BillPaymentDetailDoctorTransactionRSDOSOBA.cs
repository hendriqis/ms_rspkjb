...
{
    public partial class BillPaymentDetailDoctorTransactionRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailDoctorTransactionRSDOSOBA()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll3Comp2> lst)
        {
            this.DataSource = lst;
        }
        ...
        private void cSubServiceUnit_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                cSubServiceUnit1.Text = "Sub Total " + Convert.ToString(GetCurrentColumnValue("DepartmentID"));
            }
            else
            {
                cSubServiceUnit1.Text = "Sub Total " + Convert.ToString(GetCurrentColumnValue("FromDepartmentID"));
            }
        }
