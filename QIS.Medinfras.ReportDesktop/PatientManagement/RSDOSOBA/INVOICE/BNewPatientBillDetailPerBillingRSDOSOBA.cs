...
{
    public partial class BNewPatientBillDetailPerBillingRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityReg.LinkedToRegistrationID != 0 && entityReg.LinkedToRegistrationID != null)
            {
            ...
            billPaymentDetailTransactionPerBillingRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
