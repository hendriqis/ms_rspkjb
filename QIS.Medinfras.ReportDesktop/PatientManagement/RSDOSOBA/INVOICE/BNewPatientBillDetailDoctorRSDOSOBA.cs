...
{
    public partial class BNewPatientBillDetailDoctorRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailDoctorRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll3Comp2> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll3Comp2List(entityReg.RegistrationID);
            ...
            billPaymentDetailDoctorTransactionRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
