...
{
    public partial class BNewPatientBillSummaryRSDOSOBAPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSOBAPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSDOSOBAPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
