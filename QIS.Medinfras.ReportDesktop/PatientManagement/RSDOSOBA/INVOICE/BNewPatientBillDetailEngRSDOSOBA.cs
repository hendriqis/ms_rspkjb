...
{
    public partial class BNewPatientBillDetailEngRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailEngRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionEngRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
