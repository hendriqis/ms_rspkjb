...
{
    public partial class BNewPatientBillDetailRSDOSOBAComp2RevenueSharing : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSOBAComp2RevenueSharing()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll7Comp2> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll7Comp2List(entityReg.RegistrationID);
            ...
            billPaymentDetailTransactionRSDOSOBAComp2RevenueSharing.InitializeReport(lstHDDT);
            #endregion
