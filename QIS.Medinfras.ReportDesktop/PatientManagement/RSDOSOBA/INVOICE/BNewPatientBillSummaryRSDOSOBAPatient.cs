...
{
    public partial class BNewPatientBillSummaryRSDOSOBAPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSOBAPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSDOSOBAPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
