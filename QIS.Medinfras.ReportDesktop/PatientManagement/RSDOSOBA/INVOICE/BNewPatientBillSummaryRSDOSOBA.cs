...
{
    public partial class BNewPatientBillSummaryRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
