...
{
    public partial class BillPaymentSummaryTransactionRekananRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRekananRSDOSOBA()
        {
            InitializeComponent();
        }
