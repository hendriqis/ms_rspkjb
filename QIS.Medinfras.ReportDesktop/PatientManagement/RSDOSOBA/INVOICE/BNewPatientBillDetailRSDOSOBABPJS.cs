...
{
    public partial class BNewPatientBillDetailRSDOSOBABPJS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSOBABPJS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSDOSOBABPJS.InitializeReport(lstHDDT);
            #endregion
