...
{
    public partial class BNewPatientBillSummaryPerBillingRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
