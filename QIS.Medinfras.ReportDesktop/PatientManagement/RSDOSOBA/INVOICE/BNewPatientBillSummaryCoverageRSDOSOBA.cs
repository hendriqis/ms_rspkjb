...
{
    public partial class BNewPatientBillSummaryCoverageRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryCoverageRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll8> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll8List(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionCoverageRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
            ...
            decimal transP = lstHDDT.Sum(p => p.CoveragePatientAmount);
            decimal transC = lstHDDT.Sum(p => p.CoveragePayerAmount);
