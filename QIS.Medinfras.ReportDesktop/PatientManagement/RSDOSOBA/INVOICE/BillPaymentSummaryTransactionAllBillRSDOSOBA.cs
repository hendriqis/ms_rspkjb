...
{
    public partial class BillPaymentSummaryTransactionAllBillRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionAllBillRSDOSOBA()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBill2> lst)
        {
            this.DataSource = lst;
        }
