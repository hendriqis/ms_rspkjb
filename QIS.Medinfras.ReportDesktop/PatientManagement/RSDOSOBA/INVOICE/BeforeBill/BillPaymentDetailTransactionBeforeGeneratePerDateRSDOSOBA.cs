...
{
    public partial class BillPaymentDetailTransactionBeforeGeneratePerDateRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGeneratePerDateRSDOSOBA()
        {
            InitializeComponent();
        }
