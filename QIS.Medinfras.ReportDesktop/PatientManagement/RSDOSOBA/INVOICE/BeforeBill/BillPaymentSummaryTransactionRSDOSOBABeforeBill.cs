...
{
    public partial class BillPaymentSummaryTransactionRSDOSOBABeforeBill : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSDOSOBABeforeBill()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll7BeforeBill> lst)
        {
            this.DataSource = lst;
        }
