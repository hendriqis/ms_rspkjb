...
{
    public partial class BNewPatientBillSummaryRSDOSOBABeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSDOSOBABeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSDOSOBABeforeBill.InitializeReport(lstHDDT);
            #endregion
