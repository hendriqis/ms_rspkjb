...
{
    public partial class BNewPatientBillDetailBeforeGeneratePerDateRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGeneratePerDateRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGeneratePerDate1RSDOSOBA.InitializeReport(lstHDDT);
            #endregion
