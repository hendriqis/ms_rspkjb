...
{
    public partial class BillPaymentDetailTransactionRSDOSOBABeforeBill : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSDOSOBABeforeBill()
        {
            InitializeComponent();
        }
