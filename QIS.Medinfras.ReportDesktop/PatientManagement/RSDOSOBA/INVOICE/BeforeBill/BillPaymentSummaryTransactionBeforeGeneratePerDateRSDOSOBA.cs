...
{
    public partial class BillPaymentSummaryTransactionBeforeGeneratePerDateRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGeneratePerDateRSDOSOBA()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBeforeBillPerDate2> lst)
        {
            this.DataSource = lst;
        }
