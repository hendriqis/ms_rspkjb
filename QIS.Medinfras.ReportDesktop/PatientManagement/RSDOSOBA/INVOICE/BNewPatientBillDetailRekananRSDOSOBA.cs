...
{
    public partial class BNewPatientBillDetailRekananRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRekananRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRekananRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
