...
{
    public partial class BNewPatientBillDetailAllBillRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionAllBillRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
