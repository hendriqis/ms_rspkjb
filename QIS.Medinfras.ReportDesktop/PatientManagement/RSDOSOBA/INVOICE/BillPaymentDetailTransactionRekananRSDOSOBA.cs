...
{
    public partial class BillPaymentDetailTransactionRekananRSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRekananRSDOSOBA()
        {
            InitializeComponent();
        }
