...
{
    public partial class BNewPatientBillSummaryRekananRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRekananRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRekananRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
