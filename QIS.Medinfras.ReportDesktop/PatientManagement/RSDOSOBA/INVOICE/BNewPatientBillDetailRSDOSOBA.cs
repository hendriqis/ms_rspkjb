...
{
    public partial class BNewPatientBillDetailRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
