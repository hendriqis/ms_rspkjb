...
{
    public partial class BillPaymentSummaryTransactionComp2RSDOSOBA : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionComp2RSDOSOBA()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll5Comp2> lst)
        {
            this.DataSource = lst;
        }
