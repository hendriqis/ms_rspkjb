...
{
    public partial class BNewPatientBillDetailRSDOSOBAPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSDOSOBAPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSDOSOBAPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
