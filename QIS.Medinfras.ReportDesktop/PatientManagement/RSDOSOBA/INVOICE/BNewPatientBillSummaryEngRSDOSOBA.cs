...
{
    public partial class BNewPatientBillSummaryEngRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryEngRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionEngRSDOSOBA.InitializeReport(lstHDDT);
            #endregion
