...
{
    public partial class BNewPatientBillDetailEngRSDOSOBAv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailEngRSDOSOBAv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionEngRSDOSOBAv2.InitializeReport(lstHDDT);
            #endregion
