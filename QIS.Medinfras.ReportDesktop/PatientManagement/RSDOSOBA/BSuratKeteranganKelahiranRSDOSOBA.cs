...
{
    public partial class BSuratKeteranganKelahiranRSDOSOBA : BaseRpt
    {
        public BSuratKeteranganKelahiranRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cellAlamatIbu.Text = entity.cfMotherAddress;
            ...
            if (entity.ParamedicID1 != null && entity.ParamedicID1.ToString() != "" && entity.ParamedicID1 != 0)
            {
                lblTglTTD.Text = string.Format("{0}, {1}", entityHealthcare.City, entity.CreatedDateInString);
                lblTTD.Text = entity.ParamedicName1;
            }
            else if (entity.ParamedicID3 != null && entity.ParamedicID3.ToString() != "" && entity.ParamedicID3 != 0)
            {
                lblTglTTD.Text = string.Format("{0}, {1}", entityHealthcare.City, entity.CreatedDateInString);
                lblTTD.Text = entity.ParamedicName3;
            }
            else
            {
                lblTglTTD.Text = string.Format("{0}, {1}", entityHealthcare.City, entity.CreatedDateInString);
