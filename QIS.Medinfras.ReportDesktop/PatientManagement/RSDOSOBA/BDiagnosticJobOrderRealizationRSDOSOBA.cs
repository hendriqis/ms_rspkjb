...
{
    public partial class BDiagnosticJobOrderRealizationRSDOSOBA : BaseCustomDailyPotraitRpt
    {
        public BDiagnosticJobOrderRealizationRSDOSOBA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cDeptServiceUnit.Text = cv.ParamedicName;
            ctxt.Text = cv.cfServiceUnitRoomBed;
            //txtRemaks.Text = entityHD.Remarks;
