...
{
    public partial class BLaporanOperasiRSSK : BaseRpt
    {
        public BLaporanOperasiRSSK()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                if (lstSurgery.Count() > 0)
                {
                    ...
                    mrSurgeryReportRSSK.InitializeReport(entityCV.VisitID, Convert.ToInt32(param[1]));
                }
                else
                {
