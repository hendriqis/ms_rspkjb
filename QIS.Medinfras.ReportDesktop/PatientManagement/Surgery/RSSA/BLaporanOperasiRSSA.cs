...
{
    public partial class BLaporanOperasiRSSA : BaseRpt
    {
        public BLaporanOperasiRSSA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            ParamedicMaster entityPM2 = BusinessLayer.GetParamedicMasterList(string.Format("ParamedicID = {0}", entity.ParamedicID)).FirstOrDefault();
            ...
            if (entityPM.ParamedicID != entity.ParamedicID)
            {
                cDokterPengirim.Text = entityPM.FullName;
            }
            else
            {
            ...
            string contents2 = string.Format(@"{0}\r\n{1}",
                entityPM2.FullName, entityPM2.LicenseNo);
