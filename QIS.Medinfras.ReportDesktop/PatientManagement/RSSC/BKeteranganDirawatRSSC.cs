...
{
    public partial class BKeteranganDirawatRSSC : BaseCustomDailyPotraitRpt
    {
        public BKeteranganDirawatRSSC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                lblTgl.Text = string.Format("{0} mulai tanggal {1} s/d tanggal", entityH2.HealthcareName, startDate);
            }
            else
            {
