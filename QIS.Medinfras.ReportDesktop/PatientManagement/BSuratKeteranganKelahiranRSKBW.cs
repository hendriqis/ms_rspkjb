...
{
    public partial class BSuratKeteranganKelahiranRSKBW : BaseRpt
    {
        public BSuratKeteranganKelahiranRSKBW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cellTwinSingle.Text = entity.TwinSingle;
            cellBornCondition.Text = entity.BornCondition;
            cellBirthMethod.Text = entity.BirthMethod;
