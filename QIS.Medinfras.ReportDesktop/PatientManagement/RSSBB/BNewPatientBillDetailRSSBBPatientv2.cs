...
{
    public partial class BNewPatientBillDetailRSSBBPatientv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSBBPatientv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSBBPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
