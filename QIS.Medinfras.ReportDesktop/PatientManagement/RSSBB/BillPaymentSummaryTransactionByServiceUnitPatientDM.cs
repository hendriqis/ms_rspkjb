...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitPatientDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionByServiceUnitPatientDM()
        {
            InitializeComponent();
        }
