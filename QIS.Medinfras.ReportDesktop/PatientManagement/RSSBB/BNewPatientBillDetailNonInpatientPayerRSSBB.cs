...
{
    public partial class BNewPatientBillDetailNonInpatientPayerRSSBB : BaseCustomDailyPotraitA5Rpt
    {
        public BNewPatientBillDetailNonInpatientPayerRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionByServiceUnitPayerDM.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
