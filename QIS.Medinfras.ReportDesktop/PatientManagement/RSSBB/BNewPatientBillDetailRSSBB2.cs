...
{
    public partial class BNewPatientBillDetailRSSBB2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSBB2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSBB2.InitializeReport(lstDetail);
            #endregion
