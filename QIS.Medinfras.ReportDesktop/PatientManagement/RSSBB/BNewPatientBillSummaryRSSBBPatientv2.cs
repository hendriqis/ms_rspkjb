...
{
    public partial class BNewPatientBillSummaryRSSBBPatientv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSBBPatientv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSBBPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
