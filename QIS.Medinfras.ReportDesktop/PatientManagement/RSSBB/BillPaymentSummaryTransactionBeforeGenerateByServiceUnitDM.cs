...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerateByServiceUnitDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerateByServiceUnitDM()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBeforeBillPerServiceUnit> lst)
        {
            this.DataSource = lst;
        }
