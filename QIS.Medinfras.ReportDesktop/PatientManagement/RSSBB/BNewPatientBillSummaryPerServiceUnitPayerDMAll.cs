...
{
    public partial class BNewPatientBillSummaryPerServiceUnitPayerDMAll : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerServiceUnitPayerDMAll()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitPayerDM.InitializeReport(lst.Where(a => a.PayerAmount != 0).ToList());
            #endregion
