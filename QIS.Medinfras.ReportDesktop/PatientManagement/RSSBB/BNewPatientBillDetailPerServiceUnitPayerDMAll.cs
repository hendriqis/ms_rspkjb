...
{
    public partial class BNewPatientBillDetailPerServiceUnitPayerDMAll : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerServiceUnitPayerDMAll()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionByServiceUnitPayerDM.InitializeReport(lst.Where(a => a.PayerAmount != 0).ToList());
            #endregion
