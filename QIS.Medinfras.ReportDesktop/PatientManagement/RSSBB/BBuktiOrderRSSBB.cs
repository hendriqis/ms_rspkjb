...
{
    public partial class BBuktiOrderRSSBB : BaseDailyPortraitRpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            //cTglOrder.Text = entityHd.cfScheduledDateInString;
            cRemarks.Text = entityHd.Remarks;
            if (entityHd.ScheduledDate.ToString("dd-MM-yyyy") == null || entityHd.ScheduledDate.ToString("dd-MM-yyyy") == Constant.ConstantDate.DEFAULT_NULL)
            {
                cTglOrder.Visible = false;
            }
            else
            {
                cTglOrder.Text = entityHd.cfScheduledDateInString;
