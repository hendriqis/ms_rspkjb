...
{
    public partial class BNewPatientBillDetailNonInpatientRSSBB : BaseCustomDailyPotraitA5Rpt
    {
        public BNewPatientBillDetailNonInpatientRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionByServiceUnitDM.InitializeReport(lstHDDT);
            #endregion
