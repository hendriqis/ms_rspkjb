...
{
    public partial class BillPaymentDetailTransactionByServiceUnitPayerDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitPayerDM()
        {
            InitializeComponent();
        }
