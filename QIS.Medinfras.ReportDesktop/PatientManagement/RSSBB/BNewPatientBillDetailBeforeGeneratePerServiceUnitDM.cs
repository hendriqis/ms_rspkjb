...
{
    public partial class BNewPatientBillDetailBeforeGeneratePerServiceUnitDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGeneratePerServiceUnitDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerateByServiceUnitDM.InitializeReport(lst);
            #endregion
