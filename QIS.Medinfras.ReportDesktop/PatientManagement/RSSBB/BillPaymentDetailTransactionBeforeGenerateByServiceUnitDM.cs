...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateByServiceUnitDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateByServiceUnitDM()
        {
            InitializeComponent();
        }
