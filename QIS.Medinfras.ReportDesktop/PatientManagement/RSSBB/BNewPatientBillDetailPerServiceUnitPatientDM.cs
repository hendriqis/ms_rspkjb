...
{
    public partial class BNewPatientBillDetailPerServiceUnitPatientDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerServiceUnitPatientDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionByServiceUnitPatientDM.InitializeReport(lst.Where(a => a.PatientAmount != 0).ToList());
            #endregion
