...
{
    public partial class BBuktiOrderFarmasiFreeTextRSSBB : BaseDailyPortraitRpt
    {
        ...
        public BBuktiOrderFarmasiFreeTextRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cTransaction.Text = entityHd.PrescriptionOrderNo;
            cServiceUnitName.Text = entityHd.ServiceUnitName;
            cRemark.Text = entityHd.Remarks;
           // cReferenceNo.Text = entityHd.Remarks;
            if (entityHd.PrescriptionDate.ToString("dd-MM-yyyy") == null || entityHd.PrescriptionDate.ToString("dd-MM-yyyy") == Constant.ConstantDate.DEFAULT_NULL)
            {
                xrTableRow20.Visible = false;
            }
            else
            {
                cTglOrder.Text = entityHd.PrescriptionOrderDateTimeInString;
            }
