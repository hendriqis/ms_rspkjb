...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitPayerDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionByServiceUnitPayerDM()
        {
            InitializeComponent();
        }
