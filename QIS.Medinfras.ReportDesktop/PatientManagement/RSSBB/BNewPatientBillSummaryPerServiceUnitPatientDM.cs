...
{
    public partial class BNewPatientBillSummaryPerServiceUnitPatientDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerServiceUnitPatientDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitPatientDM.InitializeReport(lst.Where(a => a.PatientAmount != 0).ToList());
            #endregion
