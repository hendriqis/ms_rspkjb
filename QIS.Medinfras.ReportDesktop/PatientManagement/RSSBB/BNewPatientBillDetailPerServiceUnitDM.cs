...
{
    public partial class BNewPatientBillDetailPerServiceUnitDM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerServiceUnitDM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionByServiceUnitDM.InitializeReport(lst);
            #endregion
