...
{
    public partial class BNewPatientBillDetailNonInpatientPatientRSSBB : BaseCustomDailyPotraitA5Rpt
    {
        public BNewPatientBillDetailNonInpatientPatientRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityReg.Salutation != "" && entityReg != null)
            {
            ...
            billPaymentDetailTransactionByServiceUnitPatientDM.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllRSSBB.InitializeReport(entityReg.RegistrationID);
            #endregion
            ...
            if (entityReg.DepartmentID != Constant.Facility.OUTPATIENT || entityReg.DepartmentID != Constant.Facility.PHARMACY)
            {
