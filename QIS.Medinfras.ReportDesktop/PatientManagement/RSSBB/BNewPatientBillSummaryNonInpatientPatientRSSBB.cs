...
{
    public partial class BNewPatientBillSummaryNonInpatientPatientRSSBB : BaseCustomDailyPotraitA5Rpt
    {
        public BNewPatientBillSummaryNonInpatientPatientRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitPatientDM.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
