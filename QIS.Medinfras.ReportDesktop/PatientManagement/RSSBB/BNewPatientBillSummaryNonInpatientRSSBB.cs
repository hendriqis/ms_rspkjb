...
{
    public partial class BNewPatientBillSummaryNonInpatientRSSBB : BaseCustomDailyPotraitA5Rpt
    {
        public BNewPatientBillSummaryNonInpatientRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitDM.InitializeReport(lstHDDT);
            #endregion
