...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitDM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionByServiceUnitDM()
        {
            InitializeComponent();
        }
