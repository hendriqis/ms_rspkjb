...
{
    public partial class BNewPatientBillDetailRSSBBPayerv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSBBPayerv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityReg.BusinessPartnerID != 1)
            {
                billPaymentDetailTransactionRSSBBPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount < 0 || a.PayerAmount > 0 || (a.PatientAmount + a.PayerAmount) == 0).ToList());
            }
            else
            {
                billPaymentDetailTransactionRSSBBPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            }
            #endregion
