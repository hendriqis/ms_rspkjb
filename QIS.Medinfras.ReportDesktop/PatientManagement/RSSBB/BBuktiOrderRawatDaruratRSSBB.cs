...
{
    public partial class BBuktiOrderRawatDaruratRSSBB : BaseDailyPortraitRpt
    {
        ...
        public BBuktiOrderRawatDaruratRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cTransaction.Text = entityHd.ServiceOrderNo;
            cServiceUnitName.Text = entityHd.ServiceUnitName;
           // cReferenceNo.Text = entityHd.Remarks;
            if (entityHd.ServiceOrderDate.ToString("dd-MM-yyyy") == null || entityHd.ServiceOrderDate.ToString("dd-MM-yyyy") == Constant.ConstantDate.DEFAULT_NULL)
            {
                xrTableRow20.Visible = false;
            }
            else
            {
                cTglOrder.Text = entityHd.ServiceOrderDateTimeInString;
            }
