...
{
    public partial class BillPaymentDetailTransactionPerBillingRSSBB : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSSBB()
        {
            InitializeComponent();
        }
