...
{
    public partial class BNewPatientBillSummaryPerBillingRSSBBPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSSBBPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingRSSBBPatient.InitializeReport(lstHDDT);
            #endregion
