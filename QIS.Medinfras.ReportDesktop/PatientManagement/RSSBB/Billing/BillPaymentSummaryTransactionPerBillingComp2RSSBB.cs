...
{
    public partial class BillPaymentSummaryTransactionPerBillingComp2RSSBB : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingComp2RSSBB()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtPatientBill2> lst)
        {
            this.DataSource = lst;
        }
