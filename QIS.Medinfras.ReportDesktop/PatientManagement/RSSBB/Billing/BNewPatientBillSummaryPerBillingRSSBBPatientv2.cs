...
{
    public partial class BNewPatientBillSummaryPerBillingRSSBBPatientv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSSBBPatientv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingRSSBBPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllDMPatient.InitializeReport(entityReg.RegistrationID);
            #endregion
            ...
            cAccountReceivable.Text = 0.ToString("N2");
            ...
            if (lstHDDT.Where(a => a.PatientAmount != 0 && a.TariffComp2 != 0).ToList().Count() > 0)
            {
                subTariffComp2.CanGrow = true;
                billPaymentSummaryTransactionPerBillingComp2RSSBB.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0 && a.TariffComp2 != 0).ToList());
            }
            else
            {
