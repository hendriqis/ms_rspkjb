...
{
    public partial class BNewPatientBillDetailPerBillingRSSBBPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSSBBPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingRSSBBPatient.InitializeReport(lstHDDT);
            #endregion
