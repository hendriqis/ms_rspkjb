...
{
    public partial class BillPaymentDetailTransactionPerBillingRSSBBPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSSBBPayer()
        {
            InitializeComponent();
        }
