...
{
    public partial class BNewPatientBillDetailPerBillingRSSBBPatientv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSSBBPatientv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingRSSBBPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
            ...
            if (lstHDDT.Where(a => a.PatientAmount != 0 && a.TariffComp2 != 0).ToList().Count() > 0)
            {
                ...
                billPaymentDetailTransactionPerBillingComp2RSSBB.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0 && a.TariffComp2 != 0).ToList());
            }
            else
            {
