...
{
    public partial class BillPaymentDetailTransactionPerBillingComp2RSSBB : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingComp2RSSBB()
        {
            InitializeComponent();
        }
