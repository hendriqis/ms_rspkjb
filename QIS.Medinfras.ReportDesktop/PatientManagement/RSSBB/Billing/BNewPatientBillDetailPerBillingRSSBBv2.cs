...
{
    public partial class BNewPatientBillDetailPerBillingRSSBBv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSSBBv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingRSSBB.InitializeReport(lstHDDT);
            #endregion
            ...
            if (lstHDDT.Where(a => a.TariffComp2 != 0).ToList().Count() > 0)
            {
                ...
                billPaymentDetailTransactionPerBillingComp2RSSBB.InitializeReport(lstHDDT.Where(a => a.TariffComp2 != 0).ToList());
            }
            else
            {
