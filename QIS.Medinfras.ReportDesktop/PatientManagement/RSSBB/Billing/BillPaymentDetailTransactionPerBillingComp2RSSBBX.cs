...
{
    public partial class BillPaymentDetailTransactionPerBillingComp2RSSBBX : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingComp2RSSBBX()
        {
            InitializeComponent();
        }
