...
{
    public partial class BillPaymentSummaryTransactionPerBillingRSSBBPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingRSSBBPayer()
        {
            InitializeComponent();
        }
