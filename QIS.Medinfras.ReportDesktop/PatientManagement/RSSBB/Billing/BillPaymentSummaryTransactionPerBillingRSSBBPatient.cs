...
{
    public partial class BillPaymentSummaryTransactionPerBillingRSSBBPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingRSSBBPatient()
        {
            InitializeComponent();
        }
