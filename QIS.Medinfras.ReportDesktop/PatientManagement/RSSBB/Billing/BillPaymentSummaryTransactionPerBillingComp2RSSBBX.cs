...
{
    public partial class BillPaymentSummaryTransactionPerBillingComp2RSSBBX : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPerBillingComp2RSSBBX()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll2Comp2> lst)
        {
            this.DataSource = lst;
        }
