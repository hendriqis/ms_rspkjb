...
{
    public partial class BNewPatientBillSummaryPerBillingRSSBBPayerv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSSBBPayerv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityReg.BusinessPartnerID != 1)
            {
                billPaymentSummaryTransactionPerBillingRSSBBPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount < 0 || a.PayerAmount > 0 || (a.PatientAmount + a.PayerAmount) == 0).ToList());
            }
            else
            {
                billPaymentSummaryTransactionPerBillingRSSBBPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            }
            #endregion
            ...
            //decimal balanceC = transC - discC - paymentC;
            ...
            if (lstHDDT.Where(a => a.PayerAmount != 0 && a.TariffComp2 != 0).ToList().Count() > 0)
            {
                ...
                billPaymentSummaryTransactionPerBillingComp2RSSBB.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0 && a.TariffComp2 != 0).ToList());
            }
            else
            {
