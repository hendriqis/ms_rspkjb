...
{
    public partial class BNewPatientBillDetailPerBillingRSSBBPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingRSSBBPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPerBillingRSSBBPayer.InitializeReport(lstHDDT);
            #endregion
