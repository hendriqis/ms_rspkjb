...
{
    public partial class BillPaymentDetailTransactionPerBillingRSSBBPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPerBillingRSSBBPatient()
        {
            InitializeComponent();
        }
