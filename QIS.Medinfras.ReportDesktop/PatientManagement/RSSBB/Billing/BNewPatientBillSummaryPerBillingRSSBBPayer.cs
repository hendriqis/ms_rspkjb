...
{
    public partial class BNewPatientBillSummaryPerBillingRSSBBPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSSBBPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingRSSBBPayer.InitializeReport(lstHDDT);
            #endregion
