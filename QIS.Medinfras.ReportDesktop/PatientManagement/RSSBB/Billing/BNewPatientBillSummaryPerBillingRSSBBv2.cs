...
{
    public partial class BNewPatientBillSummaryPerBillingRSSBBv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerBillingRSSBBv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPerBillingRSSBB.InitializeReport(lstHDDT);
            #endregion
            ...
            if (lstHDDT.Where(a => a.TariffComp2 != 0).ToList().Count() > 0)
            {
                subTariffComp2.CanGrow = true;
                billPaymentSummaryTransactionPerBillingComp2RSSBB.InitializeReport(lstHDDT.Where(a => a.TariffComp2 != 0).ToList());
            }
            else
            {
