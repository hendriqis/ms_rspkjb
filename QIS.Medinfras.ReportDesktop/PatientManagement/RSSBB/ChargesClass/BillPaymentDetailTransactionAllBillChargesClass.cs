...
{
    public partial class BillPaymentDetailTransactionAllBillChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionAllBillChargesClass()
        {
            InitializeComponent();
        }
