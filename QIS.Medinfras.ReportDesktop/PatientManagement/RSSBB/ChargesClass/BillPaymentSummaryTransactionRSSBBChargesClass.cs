...
{
    public partial class BillPaymentSummaryTransactionRSSBBChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSSBBChargesClass()
        {
            InitializeComponent();
        }
