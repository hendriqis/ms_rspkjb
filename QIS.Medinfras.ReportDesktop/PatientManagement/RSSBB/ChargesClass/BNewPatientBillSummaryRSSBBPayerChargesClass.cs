...
{
    public partial class BNewPatientBillSummaryRSSBBPayerChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSBBPayerChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll2ChargesClass> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll2ChargesClassList(entityReg.RegistrationID);
            ...
            lblCalculateClassCaption.Text = string.Format("Kelas Hitung : {0}", lstHDDT.FirstOrDefault().ChargeClassName);
            ...
            billPaymentSummaryTransactionRSSBBPayerChargesClass.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
