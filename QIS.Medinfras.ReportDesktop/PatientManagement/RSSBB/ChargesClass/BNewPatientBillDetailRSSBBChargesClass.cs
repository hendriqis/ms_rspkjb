...
{
    public partial class BNewPatientBillDetailRSSBBChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSBBChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSBBChargesClass.InitializeReport(lstHDDT);
            #endregion
