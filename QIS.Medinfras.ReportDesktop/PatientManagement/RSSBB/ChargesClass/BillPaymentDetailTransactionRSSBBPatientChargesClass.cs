...
{
    public partial class BillPaymentDetailTransactionRSSBBPatientChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSSBBPatientChargesClass()
        {
            InitializeComponent();
        }
