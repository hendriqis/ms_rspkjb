...
{
    public partial class BillPaymentDetailTransactionRSSBBPayerChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSSBBPayerChargesClass()
        {
            InitializeComponent();
        }
