...
{
    public partial class BillPaymentDetailTransactionComp2RSSBBChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionComp2RSSBBChargesClass()
        {
            InitializeComponent();
        }
