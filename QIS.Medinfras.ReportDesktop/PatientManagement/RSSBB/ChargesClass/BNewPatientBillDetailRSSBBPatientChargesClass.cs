...
{
    public partial class BNewPatientBillDetailRSSBBPatientChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSBBPatientChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSBBPatientChargesClass.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
