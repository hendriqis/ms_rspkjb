...
{
    public partial class BillPaymentSummaryTransactionAllBillChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionAllBillChargesClass()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBillChargesClass> lst)
        {
            this.DataSource = lst;
        }
