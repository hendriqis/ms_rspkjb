...
{
    public partial class BNewPatientBillDetailRSSBBPayerChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSBBPayerChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSBBPayerChargesClass.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
