...
{
    public partial class BNewPatientBillSummaryRSSBBComp2ChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSBBComp2ChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll2Comp2ChargesClass> lstHDDTComp2 = BusinessLayer.GetPatientChargesHdDtAll2Comp2ChargesClassList(entityReg.RegistrationID);
            ...
            lblCalculateClassCaption.Text = string.Format("Kelas Hitung : {0}", lstHDDTComp2.FirstOrDefault().ChargeClassName);
            ...
            if (lstHDDTComp2.Count() > 0)
            {
                ...
                billPaymentSummaryTransactionComp2RSSBBChargesClass.InitializeReport(lstHDDTComp2);
            }
            else
            {
