...
{
    public partial class BNewPatientBillDetailAllBillChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionAllBillChargesClass.InitializeReport(lstHDDT);
            #endregion
