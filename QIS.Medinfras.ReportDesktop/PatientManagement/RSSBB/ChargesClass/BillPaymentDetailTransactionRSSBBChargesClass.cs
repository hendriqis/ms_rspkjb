...
{
    public partial class BillPaymentDetailTransactionRSSBBChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSSBBChargesClass()
        {
            InitializeComponent();
        }
