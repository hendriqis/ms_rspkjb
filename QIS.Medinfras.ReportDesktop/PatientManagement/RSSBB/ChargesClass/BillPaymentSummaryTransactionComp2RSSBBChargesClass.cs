...
{
    public partial class BillPaymentSummaryTransactionComp2RSSBBChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionComp2RSSBBChargesClass()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll2Comp2ChargesClass> lst)
        {
            this.DataSource = lst;
        }
        ...
        {
            String ItemParamedicName = Convert.ToString(GetCurrentColumnValue("ItemParamedicName"));
            if (ItemParamedicName == "")
            {
