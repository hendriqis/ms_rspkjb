...
{
    public partial class BNewPatientBillSummaryAllBillChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllBillChargesClass> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllBillChargesClassList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionAllBillChargesClass.InitializeReport(lstHDDT);
            #endregion
