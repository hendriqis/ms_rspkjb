...
{
    public partial class BillPaymentSummaryTransactionRSSBBPatientChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSSBBPatientChargesClass()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll2ChargesClass> lst)
        {
            this.DataSource = lst;
        }
