...
{
    public partial class BillPaymentSummaryTransactionRSSBBPayerChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSSBBPayerChargesClass()
        {
            InitializeComponent();
        }
