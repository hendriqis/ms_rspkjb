...
{
    public partial class BNewPatientBillSummaryRSSBBPatientChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSBBPatientChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSBBPatientChargesClass.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
