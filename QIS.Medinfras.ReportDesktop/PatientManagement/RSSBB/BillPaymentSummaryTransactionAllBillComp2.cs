...
{
    public partial class BillPaymentSummaryTransactionAllBillComp2 : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionAllBillComp2()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBillComp2> lst)
        {
            this.DataSource = lst;
        }
