...
{
    public partial class BNewPatientBillSummaryNonInpatientPayerRSSBB : BaseCustomDailyPotraitA5Rpt
    {
        public BNewPatientBillSummaryNonInpatientPayerRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitPayerDM.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
