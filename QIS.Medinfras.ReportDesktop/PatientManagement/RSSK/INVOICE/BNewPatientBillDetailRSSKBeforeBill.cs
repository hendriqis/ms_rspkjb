...
{
    public partial class BNewPatientBillDetailRSSKBeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSKBeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSKBeforeBill.InitializeReport(lstHDDT);
            #endregion
