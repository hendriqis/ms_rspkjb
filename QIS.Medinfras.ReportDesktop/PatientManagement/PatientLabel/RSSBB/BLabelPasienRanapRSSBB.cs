...
{
    public partial class BLabelPasienRanapRSSBB : BaseRpt
    {
        public BLabelPasienRanapRSSBB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            bLabelPasienRanapRSSBBSection11.InitializeReport(lstEntity);
            #endregion

            #region Section 2
            subSection2.CanGrow = true;
            bLabelPasienRanapRSSBBSection21.InitializeReport(lstEntity);
            #endregion

            #region Section 3
            subSection3.CanGrow = true;
            bLabelPasienRanapRSSBBSection31.InitializeReport(lstEntity);
            #endregion

            #region Section 4
            subSection4.CanGrow = true;
            bLabelPasienRanapRSSBBSection41.InitializeReport(lstEntity);
            #endregion
        }
    }
}
