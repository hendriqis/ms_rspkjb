...
{
    public partial class BNewPatientBillDetailRSRTH : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSRTH()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtALL11> lstHDDT = BusinessLayer.GetPatientChargesHdDtALL11List(entityReg.RegistrationID);
            ...
            #region Discount Comp2 Custom RSRTH
            subDiscountComp2.CanGrow = true;
            billPaymentDetailDiscComp2TransactionRSRTH.InitializeReport(lstHDDT.Where(a => a.cfDiscountAmountComp2 != 0).ToList());
            #endregion
