...
{
    public partial class BPatientItemPerBillingGroup : BaseCustomDailyPotraitRpt
    {
        ...
        public BPatientItemPerBillingGroup()
        {
            InitializeComponent();
        }
        ...
        {
            decimal gt = lstPatientBill.Sum(b => b.TotalPayerAmount) - lstPatientBill.Sum(a => a.PayerDiscountAmount);
        ...
        {
            string test = GetCurrentColumnValue("ItemCode").ToString();
            if (GetCurrentColumnValue("ItemCode").ToString() == "" || GetCurrentColumnValue("ItemCode").ToString() == null)
            {
                e.Cancel = false;
            }
            else
        ...
        private void cPayerAmount_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (GetCurrentColumnValue("ItemCode").ToString() == "" || GetCurrentColumnValue("ItemCode").ToString() == null)
            {
                e.Cancel = true;
