...
{
    public partial class BTransaksiA6_RSUKI : BaseA6Rpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            {
                lblCreatedByName.Text = BusinessLayer.GetUserAttribute(entity.LastUpdatedBy).FullName;
            }
            else
            {
                lblCreatedByName.Text = BusinessLayer.GetUserAttribute(entity.CreatedBy).FullName;
            }
            #endregion
