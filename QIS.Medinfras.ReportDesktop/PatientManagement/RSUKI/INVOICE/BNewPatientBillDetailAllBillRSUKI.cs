...
{
    public partial class BNewPatientBillDetailAllBillRSUKI : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillRSUKI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionAllBill.InitializeReport(lstHDDT);
            #endregion
