...
{
    public partial class BNewPatientBillDetailRSUKI : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSUKI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll2> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentDetailTransactionRSSBB.InitializeReport(lstDetail);
            #endregion
