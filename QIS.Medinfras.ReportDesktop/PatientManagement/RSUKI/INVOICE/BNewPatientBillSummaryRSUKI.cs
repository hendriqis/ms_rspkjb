...
{
    public partial class BNewPatientBillSummaryRSUKI : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSUKI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSBB.InitializeReport(lstHDDT);
            #endregion
