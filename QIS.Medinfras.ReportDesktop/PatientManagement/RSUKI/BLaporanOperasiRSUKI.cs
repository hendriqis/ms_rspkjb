...
{
    public partial class BLaporanOperasiRSUKI : BaseRpt
    {
        public BLaporanOperasiRSUKI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vTestOrderDtParamedicTeam entityOPT = BusinessLayer.GetvTestOrderDtParamedicTeamList(string.Format("VisitID = {0} AND GCParamedicRole = 'X451^01' AND IsDeleted = 0", entityCV.VisitID)).FirstOrDefault();
            vPatientSurgeryTeam entityPT = BusinessLayer.GetvPatientSurgeryTeamList(string.Format("VisitID = {0} AND GCParamedicRole = 'X451^01' AND IsDeleted = 0", entityCV.VisitID)).FirstOrDefault();
            ...
            {
                lblSignParamedicName.Text = entityOPT.ParamedicName;
            }
