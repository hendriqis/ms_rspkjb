...
{
    public partial class BSuratKeteranganKelahiranRSASIH : BaseRpt
    {
        public BSuratKeteranganKelahiranRSASIH()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (oHealthcare != null)
            {
                cHealthcareName.Text = string.Format("JWCCasih Hospital");
            }
