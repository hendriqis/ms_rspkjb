...
{
    public partial class BRincianBiayaObat : BaseCustomDailyPotraitA5Rpt
    {
        public BRincianBiayaObat()
        {
            InitializeComponent();
        }
...
//                lblOrderNotes.Text = entity.Remarks;
            ...
            //        {
            //            lblNamex.Text = string.Format("{0} {1} {2} ({3} {4})", ItemName, ChargeQty, ResultQty, CoenamRule, SignaLabel);
            //        }
            //        else
            //        {
            //            lblNamex.Text = string.Format("{0} {1} {2}", ItemName, ChargeQty, ResultQty);
            //        }
            //    }
            //    else
            //    {
