...
{
    public partial class BNewPatientBillSummaryMCU : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryMCU()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionMCU.InitializeReport(lstHDDT);
            #endregion
