...
{
    public partial class BNewPatientBillDetailBeforeGenerate2_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerate2_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerateLineAmount_Eng.InitializeReport(lstHDDT);
            #endregion
