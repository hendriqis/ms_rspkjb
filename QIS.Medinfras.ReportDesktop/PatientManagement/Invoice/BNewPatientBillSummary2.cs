...
{
    public partial class BNewPatientBillSummary2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummary2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionLineAmount.InitializeReport(lstHDDT);
            #endregion
