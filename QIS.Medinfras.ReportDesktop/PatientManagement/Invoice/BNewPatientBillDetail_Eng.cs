...
{
    public partial class BNewPatientBillDetail_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetail_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransaction_Eng.InitializeReport(lstHDDT);
            #endregion
