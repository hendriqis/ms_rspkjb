...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionByServiceUnitPatient()
        {
            InitializeComponent();
        }
