...
{
    public partial class BillPaymentSummaryTransactionLineAmount_Eng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionLineAmount_Eng()
        {
            InitializeComponent();
        }
