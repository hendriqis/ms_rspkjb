...
{
    public partial class BillPaymentSummaryTransaction_Eng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransaction_Eng()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtALLEng> lst)
        {
            this.DataSource = lst;
        }
        ...
        private void cItemGroupName_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                cItemGroupName.Text = string.Format("{0} | {1}", Convert.ToString(GetCurrentColumnValue("ItemType")), Convert.ToString(GetCurrentColumnValue("ItemGroupName2")));
            }
        }

        private void BillPaymentSummaryTransaction_Eng_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
