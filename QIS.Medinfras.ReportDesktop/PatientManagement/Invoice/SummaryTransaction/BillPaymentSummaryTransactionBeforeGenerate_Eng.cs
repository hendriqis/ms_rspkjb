...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerate_Eng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerate_Eng()
        {
            InitializeComponent();
        }
