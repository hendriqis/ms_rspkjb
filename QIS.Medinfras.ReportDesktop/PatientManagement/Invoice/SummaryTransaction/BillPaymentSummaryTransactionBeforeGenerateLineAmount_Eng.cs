...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerateLineAmount_Eng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerateLineAmount_Eng()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBeforeBillEng> lst)
        {
            this.DataSource = lst;
        }
