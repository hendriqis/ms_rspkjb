...
{
    public partial class BNewPatientBillPaymentDetailMCU : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailMCU()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentDetailTransactionByPaymentMCU.InitializeReport(lstHDDT);
            }
            else
            {
