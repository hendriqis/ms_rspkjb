...
{
    public partial class BillPaymentDetailTransactionByServiceUnitPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitPatient()
        {
            InitializeComponent();
        }
