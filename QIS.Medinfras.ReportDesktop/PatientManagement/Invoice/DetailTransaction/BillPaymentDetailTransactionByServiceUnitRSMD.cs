...
{
    public partial class BillPaymentDetailTransactionByServiceUnitRSMD : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitRSMD()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllPerServiceUnitRSMD> lst)
        {
            this.DataSource = lst;
        }
