...
{
    public partial class BillPaymentDetailTransaction_Eng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransaction_Eng()
        {
            InitializeComponent();
        }
        ...
        private void xrLabel1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                xrLabel1.Text = string.Format("{0} | {1}", Convert.ToString(GetCurrentColumnValue("ItemType")), Convert.ToString(GetCurrentColumnValue("ItemGroupName2")));
            }
        ...
        private void BillPaymentDetailTransaction_Eng_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
