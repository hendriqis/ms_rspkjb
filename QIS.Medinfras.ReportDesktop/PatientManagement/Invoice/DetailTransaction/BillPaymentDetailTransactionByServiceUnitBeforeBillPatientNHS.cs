...
{
    public partial class BillPaymentDetailTransactionByServiceUnitBeforeBillPatientNHS : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitBeforeBillPatientNHS()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllPerServiceUnitBeforeBill> lst)
        {
            this.DataSource = lst;
        }
