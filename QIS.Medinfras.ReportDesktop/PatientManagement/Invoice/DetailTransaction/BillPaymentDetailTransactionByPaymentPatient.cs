...
{
    public partial class BillPaymentDetailTransactionByPaymentPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByPaymentPatient()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllPerBilling> lst)
        {
            this.DataSource = lst;
        }
