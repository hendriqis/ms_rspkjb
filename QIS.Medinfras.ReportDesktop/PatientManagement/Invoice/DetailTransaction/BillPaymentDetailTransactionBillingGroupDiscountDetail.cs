...
{
    public partial class BillPaymentDetailTransactionBillingGroupDiscountDetail : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBillingGroupDiscountDetail()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtBillingGroupDiscountALL> lst)
        {
            this.DataSource = lst;
        }
