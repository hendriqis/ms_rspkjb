...
{
    public partial class BillPaymentDetailTransactionBillingGroupDiscount : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBillingGroupDiscount()
        {
            InitializeComponent();
        }
