...
{
    public partial class BillPaymentDetailTransactionByServiceUnitBeforeBillPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitBeforeBillPatient()
        {
            InitializeComponent();
        }
