...
{
    public partial class BillPaymentDetailTransactionByServiceUnitPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitPayer()
        {
            InitializeComponent();
        }
