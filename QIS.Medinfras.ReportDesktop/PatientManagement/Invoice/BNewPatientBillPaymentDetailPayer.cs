...
{
    public partial class BNewPatientBillPaymentDetailPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentDetailTransactionByPaymentPayer.InitializeReport(lstHDDT);
            }
            else
            {
