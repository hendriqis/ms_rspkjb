...
{
    public partial class BNewPatientBillPaymentSummaryPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentSummaryPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentSummaryTransactionPayer.InitializeReport(lstHDDT);
            }
            else
            {
