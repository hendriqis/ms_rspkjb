...
{
    public partial class BNewPatientBillDetailPerServiceUnitRSMD : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerServiceUnitRSMD()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllPerServiceUnitRSMD> lst;
            if (Convert.ToInt32(newParam[1]) != 0)
            {
                lst = BusinessLayer.GetPatientChargesHdDtAllPerServiceUnitRSMDList(entityReg.RegistrationID, Convert.ToInt32(newParam[1]));
            }
            else
            {
                lst = BusinessLayer.GetPatientChargesHdDtAllPerServiceUnitRSMDList(entityReg.RegistrationID, 0);
            }
            ...
            billPaymentDetailTransactionByServiceUnit.InitializeReport(lst);
            #endregion
