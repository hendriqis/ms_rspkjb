...
{
    public partial class BNewPatientBillDetailMCU : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailMCU()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionMCU.InitializeReport(lstHDDT);
            #endregion
