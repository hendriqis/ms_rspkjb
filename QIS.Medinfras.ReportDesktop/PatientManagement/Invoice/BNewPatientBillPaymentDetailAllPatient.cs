...
{
    public partial class BNewPatientBillPaymentDetailAllPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailAllPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentDetailTransactionPatient.InitializeReport(lstHDDT);
            }
            else
            {
