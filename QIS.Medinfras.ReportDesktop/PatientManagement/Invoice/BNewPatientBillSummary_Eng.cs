...
{
    public partial class BNewPatientBillSummary_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummary_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransaction_Eng.InitializeReport(lstHDDT);
            #endregion
