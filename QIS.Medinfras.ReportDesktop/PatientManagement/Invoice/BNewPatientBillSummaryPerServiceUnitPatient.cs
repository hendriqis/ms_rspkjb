...
{
    public partial class BNewPatientBillSummaryPerServiceUnitPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerServiceUnitPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitPatient.InitializeReport(lst);
            #endregion
