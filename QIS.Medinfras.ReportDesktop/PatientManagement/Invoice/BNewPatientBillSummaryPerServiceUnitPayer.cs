...
{
    public partial class BNewPatientBillSummaryPerServiceUnitPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerServiceUnitPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitPayer.InitializeReport(lst);
            #endregion
