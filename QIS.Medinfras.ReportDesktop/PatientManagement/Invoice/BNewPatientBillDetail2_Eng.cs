...
{
    public partial class BNewPatientBillDetail2_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetail2_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionLineAmount_Eng.InitializeReport(lstHDDT);
            #endregion
