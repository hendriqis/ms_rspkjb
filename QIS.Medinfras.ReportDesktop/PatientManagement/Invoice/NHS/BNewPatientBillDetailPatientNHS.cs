...
{
    public partial class BNewPatientBillDetailPatientNHS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPatientNHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
