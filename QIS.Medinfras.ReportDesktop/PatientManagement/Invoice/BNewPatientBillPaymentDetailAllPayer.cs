...
{
    public partial class BNewPatientBillPaymentDetailAllPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailAllPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentDetailTransactionPayer.InitializeReport(lstHDDT);
            }
            else
            {
