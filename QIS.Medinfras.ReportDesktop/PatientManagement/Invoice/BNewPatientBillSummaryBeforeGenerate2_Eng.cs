...
{
    public partial class BNewPatientBillSummaryBeforeGenerate2_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBeforeGenerate2_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllBeforeBillEng> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllBeforeBillEngList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionBeforeGenerateLineAmount_Eng.InitializeReport(lstHDDT);
            #endregion
