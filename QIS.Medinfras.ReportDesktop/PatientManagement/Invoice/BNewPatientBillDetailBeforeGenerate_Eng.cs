...
{
    public partial class BNewPatientBillDetailBeforeGenerate_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerate_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerate_Eng.InitializeReport(lstHDDT);
            #endregion
