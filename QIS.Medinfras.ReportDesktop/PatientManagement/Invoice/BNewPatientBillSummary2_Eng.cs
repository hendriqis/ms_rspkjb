...
{
    public partial class BNewPatientBillSummary2_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummary2_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtALLEng> lstHDDT = BusinessLayer.GetPatientChargesHdDtALLEngList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionLineAmount_Eng.InitializeReport(lstHDDT);
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllLineAmount.InitializeReport(entityReg.RegistrationID);
            #endregion
