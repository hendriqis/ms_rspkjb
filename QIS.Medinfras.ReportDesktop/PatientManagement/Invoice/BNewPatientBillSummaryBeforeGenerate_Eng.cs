...
{
    public partial class BNewPatientBillSummaryBeforeGenerate_Eng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBeforeGenerate_Eng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBeforeGenerate_Eng.InitializeReport(lstHDDT);
            #endregion
