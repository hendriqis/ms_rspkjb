...
{
    public partial class BNewPatientBillPaymentDetailPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentDetailTransactionByPaymentPatient.InitializeReport(lstHDDT);
            }
            else
            {
