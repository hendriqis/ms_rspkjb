...
{
    public partial class BNewPatientBillSummaryPerServiceUnit : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryPerServiceUnit()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnit.InitializeReport(lst);
            #endregion
