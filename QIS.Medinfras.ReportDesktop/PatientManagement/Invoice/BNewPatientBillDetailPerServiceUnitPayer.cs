...
{
    public partial class BNewPatientBillDetailPerServiceUnitPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerServiceUnitPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionByServiceUnitPayer.InitializeReport(lst);
            #endregion
