...
{
    public partial class BNewPatientBillPaymentSummaryMCU : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentSummaryMCU()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentSummaryTransactionByPaymentMCU.InitializeReport(lstHDDT);
            }
            else
            {
