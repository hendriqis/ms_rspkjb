...
{
    public partial class BNewPatientBillDetailBeforeGenerateChargesClass : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerateChargesClass()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllBeforeBillChargesClass> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllBeforeBillChargesClassList(entityReg.RegistrationID);
            ...
            billPaymentDetailTransactionBeforeGenerateChargesClass1.InitializeReport(lstHDDT);
            #endregion
