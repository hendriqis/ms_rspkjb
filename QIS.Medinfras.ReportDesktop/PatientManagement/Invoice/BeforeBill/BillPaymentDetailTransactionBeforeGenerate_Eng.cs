...
{
    public partial class BillPaymentDetailTransactionBeforeGenerate_Eng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerate_Eng()
        {
            InitializeComponent();
        }
