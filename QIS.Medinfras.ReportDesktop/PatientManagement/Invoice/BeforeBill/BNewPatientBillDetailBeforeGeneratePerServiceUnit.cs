...
{
    public partial class BNewPatientBillDetailBeforeGeneratePerServiceUnit : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGeneratePerServiceUnit()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerateByServiceUnit.InitializeReport(lst);
            #endregion
