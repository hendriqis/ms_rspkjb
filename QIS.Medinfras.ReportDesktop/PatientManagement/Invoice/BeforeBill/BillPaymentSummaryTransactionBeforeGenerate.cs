...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerate : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerate()
        {
            InitializeComponent();
        }
