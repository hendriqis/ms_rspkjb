...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerateByServiceUnit : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerateByServiceUnit()
        {
            InitializeComponent();
        }
