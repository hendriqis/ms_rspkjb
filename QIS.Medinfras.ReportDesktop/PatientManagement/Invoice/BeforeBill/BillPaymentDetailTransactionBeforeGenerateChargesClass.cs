...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateChargesClass : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateChargesClass()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBeforeBillChargesClass> lst)
        {
            this.DataSource = lst;
        }
