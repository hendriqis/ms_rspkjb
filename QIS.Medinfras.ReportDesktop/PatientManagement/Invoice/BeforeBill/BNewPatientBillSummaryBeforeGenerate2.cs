...
{
    public partial class BNewPatientBillSummaryBeforeGenerate2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBeforeGenerate2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBeforeGenerateLineAmount.InitializeReport(lstHDDT);
            #endregion
