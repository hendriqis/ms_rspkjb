...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateByServiceUnit : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateByServiceUnit()
        {
            InitializeComponent();
        }
