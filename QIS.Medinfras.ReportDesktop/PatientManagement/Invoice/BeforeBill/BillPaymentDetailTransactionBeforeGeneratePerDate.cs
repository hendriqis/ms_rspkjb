...
{
    public partial class BillPaymentDetailTransactionBeforeGeneratePerDate : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGeneratePerDate()
        {
            InitializeComponent();
        }
