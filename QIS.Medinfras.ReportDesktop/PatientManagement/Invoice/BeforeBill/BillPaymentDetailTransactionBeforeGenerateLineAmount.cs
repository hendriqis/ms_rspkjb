...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateLineAmount : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateLineAmount()
        {
            InitializeComponent();
        }
