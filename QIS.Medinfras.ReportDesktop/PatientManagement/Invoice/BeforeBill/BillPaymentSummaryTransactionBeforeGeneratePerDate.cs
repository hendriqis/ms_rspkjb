...
{
    public partial class BillPaymentSummaryTransactionBeforeGeneratePerDate : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGeneratePerDate()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBeforeBillPerDate> lst)
        {
            this.DataSource = lst;
        }
