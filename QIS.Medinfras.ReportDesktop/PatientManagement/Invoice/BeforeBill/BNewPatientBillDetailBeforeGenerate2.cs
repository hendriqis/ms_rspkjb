...
{
    public partial class BNewPatientBillDetailBeforeGenerate2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerate2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerateLineAmount.InitializeReport(lstHDDT);
            #endregion
