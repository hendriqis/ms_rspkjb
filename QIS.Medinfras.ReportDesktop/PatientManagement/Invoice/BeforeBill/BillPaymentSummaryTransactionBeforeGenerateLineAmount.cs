...
{
    public partial class BillPaymentSummaryTransactionBeforeGenerateLineAmount : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionBeforeGenerateLineAmount()
        {
            InitializeComponent();
        }
