...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateLineAmount_Eng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateLineAmount_Eng()
        {
            InitializeComponent();
        }
