...
{
    public partial class BNewPatientBillSummaryBeforeGeneratePerDate : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBeforeGeneratePerDate()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBeforeGeneratePerDate1.InitializeReport(lstHDDT);
            #endregion
