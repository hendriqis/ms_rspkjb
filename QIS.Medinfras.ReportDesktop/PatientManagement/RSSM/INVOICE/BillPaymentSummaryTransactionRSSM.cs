...
{
    public partial class BillPaymentSummaryTransactionRSSM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSSM()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll10> lst)
        {
            this.DataSource = lst;
        }
