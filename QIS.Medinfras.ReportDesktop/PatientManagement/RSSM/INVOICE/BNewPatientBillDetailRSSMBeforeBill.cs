...
{
    public partial class BNewPatientBillDetailRSSMBeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSMBeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSMBeforeBill.InitializeReport(lstHDDT);
            #endregion
