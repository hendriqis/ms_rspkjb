...
{
    public partial class BNewPatientBillSummaryRSSMComp2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSMComp2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (lstHDDTComp2.Count() > 0)
            {
                ...
                billPaymentSummaryTransactionComp2RSSM.InitializeReport(lstHDDTComp2);
            }
            else
            {
