...
{
    public partial class BNewPatientBillSummaryRSSMBeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSMBeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSMBeforeBill.InitializeReport(lstHDDT);
            #endregion

            #region Payment All
            subPaymentAllDM.CanGrow = true;
            billPaymentDetailPaymentAllDM.InitializeReport(lstPaymentHdDt.Where(a => a.GCPaymentType == Constant.PaymentType.DOWN_PAYMENT).ToList());
            #endregion
