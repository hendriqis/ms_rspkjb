...
{
    public partial class BNewPatientBillDetailRSSMPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSMPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSMPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
