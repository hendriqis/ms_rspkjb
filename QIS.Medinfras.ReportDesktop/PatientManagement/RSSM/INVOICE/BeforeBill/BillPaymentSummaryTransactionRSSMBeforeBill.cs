...
{
    public partial class BillPaymentSummaryTransactionRSSMBeforeBill : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSSMBeforeBill()
        {
            InitializeComponent();
        }
