...
{
    public partial class BNewPatientBillDetailRSSMPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSMPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSMPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
