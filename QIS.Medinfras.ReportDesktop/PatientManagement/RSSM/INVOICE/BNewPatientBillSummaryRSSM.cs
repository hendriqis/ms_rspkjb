...
{
    public partial class BNewPatientBillSummaryRSSM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSM.InitializeReport(lstHDDT);
            #endregion
