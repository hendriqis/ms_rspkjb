...
{
    public partial class BNewPatientBillSummaryRSSMPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSMPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSMPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
