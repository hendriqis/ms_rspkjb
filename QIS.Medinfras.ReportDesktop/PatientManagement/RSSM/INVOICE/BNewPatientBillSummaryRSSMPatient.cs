...
{
    public partial class BNewPatientBillSummaryRSSMPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSMPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSMPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
