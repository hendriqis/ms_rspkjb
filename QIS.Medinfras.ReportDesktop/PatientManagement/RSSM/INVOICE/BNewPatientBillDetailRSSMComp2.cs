...
{
    public partial class BNewPatientBillDetailRSSMComp2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSMComp2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (lstHDDTComp2.Count() > 0)
            {
                ...
                billPaymentDetailTransactionComp2RSSM.InitializeReport(lstHDDTComp2);
            }
            else
            {
