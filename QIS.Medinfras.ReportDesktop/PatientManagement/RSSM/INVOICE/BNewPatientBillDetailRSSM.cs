...
{
    public partial class BNewPatientBillDetailRSSM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSM.InitializeReport(lstHDDT);
            #endregion
