...
{
    public partial class BNewPatientBillSummaryNewRSCK : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryNewRSCK()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionByServiceUnitDMRSCK.InitializeReport(lstHDDT);
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllRSCK.InitializeReport(entityReg.RegistrationID);
            #endregion
            ...
            billPaymentDetailPaymentAllRSCK.InitializeReport(lstPaymentHdDt);
            #endregion
