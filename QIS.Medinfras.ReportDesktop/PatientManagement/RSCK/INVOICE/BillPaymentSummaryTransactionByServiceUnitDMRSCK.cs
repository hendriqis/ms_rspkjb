...
{
    public partial class BillPaymentSummaryTransactionByServiceUnitDMRSCK : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionByServiceUnitDMRSCK()
        {
            InitializeComponent();
        }
