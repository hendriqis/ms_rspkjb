...
{
    public partial class BTransaksiPMI : BaseDailyPortrait1Rpt
    {
        public BTransaksiPMI()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblLastUpdatedDate.Text = string.Format("{0}", entity.LastUpdatedDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT));
