...
{
    public partial class BPatientItemPerBillingGroupBPJS_RSAJ : BaseCustomDailyPotraitRpt
    {
        ...
        public BPatientItemPerBillingGroupBPJS_RSAJ()
        {
            InitializeComponent();
        }
        ...
        private void lblBPJS_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            lblBPJS.Text = coverageLimitAmount.ToString("N2");
        }

        private void lblGTPasien_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            decimal gt = lstPatientBill.Sum(b => b.TotalPatientAmount) - lstPatientBill.Sum(b => b.PatientDiscountAmount);
