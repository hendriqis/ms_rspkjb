...
{
    public partial class BPatientBillDetail_RSAJ : BaseDailyPortraitRpt
    {
        List<PatientBill> lstPatientBill = null;
        vRegistrationBillingReport entity = null;
        string customer = "";

        public BPatientBillDetail_RSAJ()
        {
            InitializeComponent();
        }
        ...
        {
            GetPatientChargesDtPerDetail en = BusinessLayer.GetPatientChargesDtPerDetail(Convert.ToInt32(param[0]))[0];
