...
{
    public partial class BPendaftaran3 : BaseRpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            foreach (vConsultVisit entity in lstEntity)
            {
                ...
                if (count > 0)
                {
                    ...
                    lstPatientChargesDt = BusinessLayer.GetvPatientChargesDtList(string.Format("ItemID IN ({0}) AND VisitID = {1} AND IsDeleted = 0 AND GCTransactionStatus != '{1}' AND ISNULL(GCTransactionDetailStatus,'') != '{1}'", listID, entity.VisitID, Constant.TransactionStatus.VOID));
                }
                ...
                List<vPhysicianItem> lstPI = BusinessLayer.GetvPhysicianItemList(string.Format("ParamedicID = {0}", entity.ParamedicID));
    ...
    public class CBuktiPendaftaran
    {
