...
{
    public partial class BSuratRujukanKeRSLainRSARC : BaseDailyPortrait2Rpt
    {
        public BSuratRujukanKeRSLainRSARC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vPatientAllergy entityAllergy = BusinessLayer.GetvPatientAllergyList(string.Format("MRN = {0} AND IsDeleted = 0", entity.MRN)).FirstOrDefault();
            ...
            lblActualVisitDate.Text = string.Format("{0} {1}" , entity.ActualVisitDateInString, entity.ActualVisitTime);
            ...
            if (entityAllergy == null)
            {
                lblAlergy.Text = string.Format("-");
            }
            else
            {
                lblAlergy.Text = entityAllergy.Allergen;
            }
