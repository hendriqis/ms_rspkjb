...
{
    public partial class BNew2PatientBillDetailDMRSRAC : BaseCustomDailyPotraitRpt
    {
        public BNew2PatientBillDetailDMRSRAC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtALL12> lstHDDT = BusinessLayer.GetPatientChargesHdDtALL12List(entityReg.RegistrationID);
            ...
            new2BillPaymentDetailTransactionDMRSRAC.InitializeReport(lstHDDT);
            #endregion
