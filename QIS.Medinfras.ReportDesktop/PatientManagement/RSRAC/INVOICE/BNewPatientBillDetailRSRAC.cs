...
{
    public partial class BNewPatientBillDetailRSRAC : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSRAC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            //    cReferrerPhysician.Visible = true;
            //}
            ...
            string physicianOrderDischarge = entityReg.PhysicianDischargeOrderDate.ToString(Constant.FormatString.DATE_FORMAT);
            string physicianDischarge = entityReg.PhysicianDischargedDate.ToString(Constant.FormatString.DATE_FORMAT);
            ...
            {
                dischargeDateInfo = physicianDischarge + " " + entityReg.PhysicianDischargeOrderTime;
            }
