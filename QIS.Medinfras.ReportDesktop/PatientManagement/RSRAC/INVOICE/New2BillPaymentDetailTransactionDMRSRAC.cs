...
{
    public partial class New2BillPaymentDetailTransactionDMRSRAC : DevExpress.XtraReports.UI.XtraReport
    {
        public New2BillPaymentDetailTransactionDMRSRAC()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtALL12> lst)
        {
            this.DataSource = lst;
        }
