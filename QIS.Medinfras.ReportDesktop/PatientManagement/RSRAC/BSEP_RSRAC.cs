...
{
    public partial class BSEP_RSRAC : BaseRpt
    {
        public BSEP_RSRAC()
        {
            InitializeComponent();
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblDOB.Text = string.Format("{0}",entity.DateOfBirth.ToString(Constant.FormatString.DATE_FORMAT));
            
            if(entity.GCSex == Constant.Gender.MALE)
            {
                lblGender.Text = "Kelamin : Laki-Laki";
            }
            else if (entity.GCSex == Constant.Gender.FEMALE) {
                lblGender.Text = "Kelamin : Perempuan";            
            }
            ...
            //}
            lblDiagnose.Text = string.Format("{0} - {1}", entity.KodeDiagnosa, entity.NamaDiagnosa);
