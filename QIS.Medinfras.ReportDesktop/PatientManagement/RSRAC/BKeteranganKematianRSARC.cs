...
{
    public partial class BKeteranganKematianRSARC : BaseRpt
    {

        public BKeteranganKematianRSARC()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lbl2.Text = String.Format("Datang dalam keadaan sudah meninggal di {0} Pada Tanggal {1} Pukul {2}:{3}", entityH1.HealthcareName, Date.ToString(Constant.FormatString.DATE_FORMAT), param[2], param[3]);
