...
namespace QIS.Medinfras.ReportDesktop
{
    public partial class BPembayaranPerKelompok : BaseDailyPortraitRpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblPasien.Text = entityReg.PatientName;
            ...
            if (entityPayment.TotalPatientBillAmount != 0)
            {
                lblTerbilang.Text = string.Format("# {0} #", Function.NumberInWords(Convert.ToInt32(entityPayment.TotalPatientBillAmount), true));
            }
            else
            {
