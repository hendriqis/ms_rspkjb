...
{
    public partial class BRingkasanMasukKeluarRSSM : BaseCustomDailyPotraitRpt
    {
        public BRingkasanMasukKeluarRSSM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblBusinessPartners.Text = entityVisit.BusinessPartnerName;
            if (entityBPJS != null)
            {
