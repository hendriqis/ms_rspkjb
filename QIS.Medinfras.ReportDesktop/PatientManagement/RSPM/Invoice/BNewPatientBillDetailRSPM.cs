...
{
    public partial class BNewPatientBillDetailRSPM : BaseCustom3DailyPotraitRpt
    {
        public BNewPatientBillDetailRSPM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllRSPM> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentDetailTransactionRSPM.InitializeReport(lstDetail);
            #endregion
            ...
            cAdminAll.Text = (adminC + adminP).ToString("N2");

            cServiceAll.Text = (serviceC + serviceP).ToString("N2");
