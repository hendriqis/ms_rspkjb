...
{
    public partial class BillPaymentDetailPaymentAllDMRSPM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailPaymentAllDMRSPM()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(List<vPatientPaymentHdDtRSPM> lst)
        {
            ...
            List<vPatientPaymentHdDtRSPM> lst2 = lst.OrderBy(a => a.PaymentID).ToList();
            foreach (vPatientPaymentHdDtRSPM dt in lst2)
            {
