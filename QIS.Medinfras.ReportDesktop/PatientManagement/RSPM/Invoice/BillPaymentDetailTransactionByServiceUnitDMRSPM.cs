...
{
    public partial class BillPaymentDetailTransactionByServiceUnitDMRSPM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitDMRSPM()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllPerServiceUnit1> lst)
        {
            this.DataSource = lst;
        }
