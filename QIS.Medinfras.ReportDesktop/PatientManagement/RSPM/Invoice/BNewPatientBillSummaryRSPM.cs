...
{
    public partial class BNewPatientBillSummaryRSPM : BaseCustom3DailyPotraitRpt
    {
        public BNewPatientBillSummaryRSPM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSPM.InitializeReport(lstHDDT);
            #endregion
