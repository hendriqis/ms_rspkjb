...
{
    public partial class BillPaymentSummaryTransactionRSPMPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSPMPatient()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllRSPM> lst)
        {
            this.DataSource = lst;
        }
