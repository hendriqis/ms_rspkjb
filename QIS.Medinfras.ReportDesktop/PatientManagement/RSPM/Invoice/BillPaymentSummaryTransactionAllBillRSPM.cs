...
{
    public partial class BillPaymentSummaryTransactionAllBillRSPM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionAllBillRSPM()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllBillRSPM> lst)
        {
            this.DataSource = lst;
        }
