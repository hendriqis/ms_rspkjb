...
{
    public partial class BNewPatientBillSummaryRSPMPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSPMPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllRSPM> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllRSPMList(entityReg.RegistrationID);
            ...
            if (entityReg.BusinessPartnerID != 1)
            {
                billPaymentSummaryTransactionRSPMPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount < 0 || a.PayerAmount > 0 || (a.PatientAmount + a.PayerAmount) == 0).ToList());
            }
            else
            {
                billPaymentSummaryTransactionRSPMPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            }
            #endregion
