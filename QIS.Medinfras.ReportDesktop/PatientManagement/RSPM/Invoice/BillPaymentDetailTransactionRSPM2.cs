...
{
    public partial class BillPaymentDetailTransactionRSPM2 : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSPM2()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAll13> lst)
        {
            this.DataSource = lst;
        }
