...
{
    public partial class BillPaymentPerBillingSummaryTransactionRSPMPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingSummaryTransactionRSPMPatient()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtPerBillingRSPM> lst)
        {
            this.DataSource = lst;
        }
