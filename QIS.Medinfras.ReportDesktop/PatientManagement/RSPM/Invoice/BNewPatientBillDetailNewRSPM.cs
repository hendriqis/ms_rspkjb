...
{
    public partial class BNewPatientBillDetailNewRSPM : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailNewRSPM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllPerServiceUnit1> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllPerServiceUnit1List(entityReg.RegistrationID, 0);
            ...
            billPaymentDetailTransactionByServiceUnitDMRSPM.InitializeReport(lstHDDT);
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllRSPM.InitializeReport(entityReg.RegistrationID);
            #endregion
            ...
            billPaymentDetailPaymentAllRSPM.InitializeReport(lstPaymentHdDt);
            #endregion
