...
{
    public partial class BNewPatientBillPerBillingSummaryRSPMPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPerBillingSummaryRSPMPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentPerBillingSummaryTransactionRSPMPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
