...
{
    public partial class BNewPatientBillSummaryRSPMPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSPMPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSPMPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
