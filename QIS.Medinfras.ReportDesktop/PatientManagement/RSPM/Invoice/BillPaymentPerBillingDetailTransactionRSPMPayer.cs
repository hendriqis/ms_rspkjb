...
{
    public partial class BillPaymentPerBillingDetailTransactionRSPMPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingDetailTransactionRSPMPayer()
        {
            InitializeComponent();
        }
