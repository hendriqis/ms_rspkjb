...
{
    public partial class BillPaymentPerBillingSummaryTransactionRSPMPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingSummaryTransactionRSPMPayer()
        {
            InitializeComponent();
        }
