...
{
    public partial class BNewPatientBillDetailAllBillRSPM : BaseCustom3DailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillRSPM()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionAllBillRSPM.InitializeReport(lstHDDT);
            #endregion
            ...
            cDisc.Text = (transP + adminP + serviceP + transC + adminC + serviceC).ToString("N2");
