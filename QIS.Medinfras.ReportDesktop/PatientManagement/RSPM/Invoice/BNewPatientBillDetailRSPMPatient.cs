...
{
    public partial class BNewPatientBillDetailRSPMPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSPMPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSPMPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
