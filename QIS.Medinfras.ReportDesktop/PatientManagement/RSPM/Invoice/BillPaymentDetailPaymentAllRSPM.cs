...
{
    public partial class BillPaymentDetailPaymentAllRSPM : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailPaymentAllRSPM()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(List<vPatientPaymentHdDtRSPM> lst)
        {
            ...
            foreach (vPatientPaymentHdDtRSPM dt in lst)
            {
        ...
        private void tabDetail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                if (GetCurrentColumnValue("GCPaymentType").ToString() != Constant.PaymentType.AR_PAYER || GetCurrentColumnValue("GCPaymentType").ToString() != Constant.PaymentType.SETTLEMENT)
                {
                    e.Cancel = true;
                }
                else
