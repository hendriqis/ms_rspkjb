...
{
    public partial class BNewPatientBillDetailNewRSUKRIDADetail : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailNewRSUKRIDADetail()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSUKRIDADetail.InitializeReport(lstHDDT);
            #endregion
            ...
            billPaymentDetailPaymentAllDMRSUKRIDA.InitializeReport(lstPaymentHdDt);
            #endregion
