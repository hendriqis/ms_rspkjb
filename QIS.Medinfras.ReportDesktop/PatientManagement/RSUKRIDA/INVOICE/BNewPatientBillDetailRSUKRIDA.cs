...
{
    public partial class BNewPatientBillDetailRSUKRIDA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSUKRIDA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSUKRIDA.InitializeReport(lstHDDT);
            #endregion
            ...
            billPaymentDetailPaymentAllDMRSUKRIDA2.InitializeReport(lstPaymentHdDt);
            #endregion
