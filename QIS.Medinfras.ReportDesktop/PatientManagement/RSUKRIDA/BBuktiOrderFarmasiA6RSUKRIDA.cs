...
{
    public partial class BBuktiOrderFarmasiA6RSUKRIDA : BaseA6Rpt
    {
        ...
        public BBuktiOrderFarmasiA6RSUKRIDA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            vHealthcareServiceUnit entityH = BusinessLayer.GetvHealthcareServiceUnitList(string.Format("HealthcareServiceUnitID = {0}", AppSession.HealthcareServiceUnitID)).FirstOrDefault();
            ...
            cServiceUnitName.Text = entityH.ServiceUnitName;
