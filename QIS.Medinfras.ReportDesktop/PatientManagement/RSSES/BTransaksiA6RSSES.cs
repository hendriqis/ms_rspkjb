...
{
    public partial class BTransaksiA6RSSES : BaseA6Rpt
    {
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (!string.IsNullOrEmpty(entityCv.ReferralPhysicianCode))
            {
                cParamedicOrderName.Text = entityCv.ReferralPhysicianName;
            }
            else
            {
                cParamedicOrderName.Text = string.Format("-");
            }
          ...
          ////  cTransaction.Text = string.Format("{0} | {1}", entity.TransactionNo, entity.TransactionDateInString);
            ...
            if (!string.IsNullOrEmpty(entity.ReferenceNo)) {
                refno = string.Format("{0}", entity.ReferenceNo);
            }
            cTransaction.Text = string.Format("{0} / {1}", entity.TransactionNo, refno);
          ...
          ///  cReferenceNo.Text = entity.ReferenceNo;
            ...
            lblLastUpdatedDate.Text = string.Format("{0}", entity.TransactionDateInString);
            xrLabel2.Text = entity.CreatedByName;
            #endregion
