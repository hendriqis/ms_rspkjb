...
{
    public partial class BJadwalPemeriksaanFisioBPJS_RSSES : BaseCustomDailyPotraitA5Rpt
    {

        public BJadwalPemeriksaanFisioBPJS_RSSES()
        {
            InitializeComponent();
        }
        public override void InitializeReport(string[] param)
        {
            ...
            if (entity != null)
            {
                ...
                bPemeriksaanFisioBPJSDetail.InitializeReport(lstResultFisio.FirstOrDefault().AppointmentID, dateFrom, dateTo);
                #endregion
            }
