...
{
    public partial class BNewPatientBillPaymentAllSummaryRSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentAllSummaryRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionPaymentAllRSSES.InitializeReport(lstHDDT);
            #endregion
