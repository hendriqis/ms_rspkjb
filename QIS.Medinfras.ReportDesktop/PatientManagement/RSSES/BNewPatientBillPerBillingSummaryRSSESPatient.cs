...
{
    public partial class BNewPatientBillPerBillingSummaryRSSESPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPerBillingSummaryRSSESPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentPerBillingSummaryTransactionRSSESPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
