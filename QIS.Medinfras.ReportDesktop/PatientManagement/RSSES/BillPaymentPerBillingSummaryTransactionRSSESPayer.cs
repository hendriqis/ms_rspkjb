...
{
    public partial class BillPaymentPerBillingSummaryTransactionRSSESPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingSummaryTransactionRSSESPayer()
        {
            InitializeComponent();
        }
