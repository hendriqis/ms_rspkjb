...
{
    public partial class BNewPatientBillSummaryRSSESPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSESPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSSESPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
