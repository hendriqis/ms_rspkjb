...
{
    public partial class BNewPatientBillDetailRSSESPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSESPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSSESPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
