...
{
    public partial class BNewPatientBillDetailAllBillRSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionAllBillRSSES.InitializeReport(lstHDDT);
            #endregion
