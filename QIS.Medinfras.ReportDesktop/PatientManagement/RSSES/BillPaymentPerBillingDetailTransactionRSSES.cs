...
{
    public partial class BillPaymentPerBillingDetailTransactionRSSES : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingDetailTransactionRSSES()
        {
            InitializeComponent();
        }
