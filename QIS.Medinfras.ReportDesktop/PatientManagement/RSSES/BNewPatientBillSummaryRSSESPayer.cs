...
{
    public partial class BNewPatientBillSummaryRSSESPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSSESPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllRSSES> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllRSSESList(entityReg.RegistrationID);
            ...
            if (entityReg.BusinessPartnerID != 1)
            {
                billPaymentSummaryTransactionRSSESPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount < 0 || a.PayerAmount > 0 || (a.PatientAmount + a.PayerAmount) == 0).ToList());
            }
            else
            {
                billPaymentSummaryTransactionRSSESPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            }
            #endregion
            ...
            //billPaymentDetailDiscComp2TransactionRSSES.InitializeReport(lstHDDT.Where(a => a.cfDiscountAmountComp2 != 0).ToList());
            //#endregion
