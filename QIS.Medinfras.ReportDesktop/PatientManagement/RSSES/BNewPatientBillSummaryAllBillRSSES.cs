...
{
    public partial class BNewPatientBillSummaryAllBillRSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllBillRSSES> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllBillRSSESList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionAllBillRSSES.InitializeReport(lstHDDT);
            #endregion
