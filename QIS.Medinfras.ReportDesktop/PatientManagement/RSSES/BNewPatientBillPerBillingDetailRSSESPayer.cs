...
{
    public partial class BNewPatientBillPerBillingDetailRSSESPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPerBillingDetailRSSESPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityReg.BusinessPartnerID != 1)
            {
                billPaymentPerBillingDetailTransactionRSSESPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount < 0 || a.PayerAmount > 0 || (a.PatientAmount + a.PayerAmount) == 0).ToList());
            }
            else
            {
                billPaymentPerBillingDetailTransactionRSSESPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            }
            #endregion
