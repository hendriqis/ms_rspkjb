...
{
    public partial class BNewPatientBillDetailRSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllRSSES> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentDetailTransactionRSSES.InitializeReport(lstDetail);
            #endregion
