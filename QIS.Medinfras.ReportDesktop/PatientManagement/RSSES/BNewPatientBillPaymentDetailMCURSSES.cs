...
{
    public partial class BNewPatientBillPaymentDetailMCURSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailMCURSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (entityPayment.GCPaymentType != Constant.PaymentType.DOWN_PAYMENT)
            {
                ...
                billPaymentDetailTransactionByPaymentMCURSSES.InitializeReport(lstHDDT);
            }
            else
            {
            ...
            transP = lstHDDT.Sum(p => p.DetailPatientAmount);
            transC = lstHDDT.Sum(p => p.DetailPayerAmount);
