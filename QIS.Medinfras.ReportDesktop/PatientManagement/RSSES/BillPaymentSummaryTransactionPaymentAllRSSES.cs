...
{
    public partial class BillPaymentSummaryTransactionPaymentAllRSSES : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionPaymentAllRSSES()
        {
            InitializeComponent();
        }
