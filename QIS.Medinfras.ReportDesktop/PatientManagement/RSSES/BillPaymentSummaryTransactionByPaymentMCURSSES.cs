...
{
    public partial class BillPaymentSummaryTransactionByPaymentMCURSSES : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionByPaymentMCURSSES()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllPerBillingMCURSSES> lst)
        {
            decimal mainTarifPatient = 0, mainTarifPayer = 0;

            //List<GetPatientChargesHdDtAllPerBillingMCURSSES> lstTemp = (from a in lst orderby a.ItemName1 select a).GroupBy(y => y.ItemName1).Select(x => x.FirstOrDefault()).ToList();
        ...
        private void cGroupQuantity_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
