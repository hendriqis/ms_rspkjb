...
{
    public partial class BNewPatientBillPerBillingDetailRSSESPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPerBillingDetailRSSESPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentPerBillingDetailTransactionRSSESPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
