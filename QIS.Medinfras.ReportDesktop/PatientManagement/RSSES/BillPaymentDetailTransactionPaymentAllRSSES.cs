...
{
    public partial class BillPaymentDetailTransactionPaymentAllRSSES : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionPaymentAllRSSES()
        {
            InitializeComponent();
        }
