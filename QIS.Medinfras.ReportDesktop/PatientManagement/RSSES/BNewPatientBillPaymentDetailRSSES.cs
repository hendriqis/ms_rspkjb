...
{
    public partial class BNewPatientBillPaymentDetailRSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtPerPaymentRSSES> lstHDDT = BusinessLayer.GetPatientChargesHdDtPerPaymentRSSESList(entityReg.RegistrationID, entityPayment.PaymentID);
            ...
            List<GetPatientChargesHdDtPerPaymentRSSES> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentDetailTransactionPaymentRSSES.InitializeReport(lstDetail);
            #endregion
            ...
            //billPaymentDetailDiscComp2TransactionPaymentRSSES.InitializeReport(lstHDDT.Where(a => a.cfDiscountAmountComp2 != 0).ToList());
            //#endregion
