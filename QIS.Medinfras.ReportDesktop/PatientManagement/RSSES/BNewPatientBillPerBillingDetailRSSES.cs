...
{
    public partial class BNewPatientBillPerBillingDetailRSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPerBillingDetailRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtPerBillingRSSES> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentPerBillingDetailTransactionRSSES.InitializeReport(lstDetail);
            #endregion
