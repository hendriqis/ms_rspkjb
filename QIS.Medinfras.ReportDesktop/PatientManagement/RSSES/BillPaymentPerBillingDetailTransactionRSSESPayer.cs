...
{
    public partial class BillPaymentPerBillingDetailTransactionRSSESPayer : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingDetailTransactionRSSESPayer()
        {
            InitializeComponent();
        }
