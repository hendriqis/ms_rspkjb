...
{
    public partial class BNewPatientBillPaymentAllDetailRSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentAllDetailRSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllPaymentRSSES> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllPaymentRSSESList(entityReg.RegistrationID);
            ...
            List<GetPatientChargesHdDtAllPaymentRSSES> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentDetailTransactionPaymentAllRSSES.InitializeReport(lstDetail);
            #endregion
            ...
            //billPaymentDetailDiscComp2TransactionPaymentAllRSSES.InitializeReport(lstHDDT.Where(a => a.cfDiscountAmountComp2 != 0).ToList());
            //#endregion
