...
{
    public partial class BillPaymentPerBillingSummaryTransactionRSSES : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingSummaryTransactionRSSES()
        {
            InitializeComponent();
        }
