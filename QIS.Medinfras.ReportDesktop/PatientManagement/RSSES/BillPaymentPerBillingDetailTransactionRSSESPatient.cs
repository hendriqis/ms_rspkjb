...
{
    public partial class BillPaymentPerBillingDetailTransactionRSSESPatient : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentPerBillingDetailTransactionRSSESPatient()
        {
            InitializeComponent();
        }
