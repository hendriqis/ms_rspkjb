...
{
    public partial class BNewPatientBillDetailMCURSSES : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailMCURSSES()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionMCURSSES.InitializeReport(lstHDDT);
            #endregion
