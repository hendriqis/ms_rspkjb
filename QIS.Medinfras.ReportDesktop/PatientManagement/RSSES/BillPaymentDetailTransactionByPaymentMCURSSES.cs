...
{
    public partial class BillPaymentDetailTransactionByPaymentMCURSSES : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByPaymentMCURSSES()
        {
            InitializeComponent();
        }
