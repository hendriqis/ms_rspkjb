...
{
    public partial class BillPaymentSummaryTransactionRSRABeforeBill : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentSummaryTransactionRSRABeforeBill()
        {
            InitializeComponent();
        }
