...
{
    public partial class BNewPatientBillSummaryRSRABeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSRABeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAll9BeforeBill> lstHDDT = BusinessLayer.GetPatientChargesHdDtAll9BeforeBillList(entityReg.RegistrationID);
            ...
            billPaymentSummaryTransactionRSRABeforeBill.InitializeReport(lstHDDT);
            #endregion
