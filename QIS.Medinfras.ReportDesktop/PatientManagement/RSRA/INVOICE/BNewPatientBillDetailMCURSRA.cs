...
{
    public partial class BNewPatientBillDetailMCURSRA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailMCURSRA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllMCU2> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllMCU2List(entityReg.RegistrationID);
            ...
            billPaymentDetailTransactionMCURSRA.InitializeReport(lstHDDT);
            #endregion
            ...
            List<GetPatientChargesHdDtAllMCU2> lstTemp = (from a in lstHDDT orderby a.ItemName1 select a).GroupBy(y => y.ItemName1).Select(x => x.FirstOrDefault()).ToList();
