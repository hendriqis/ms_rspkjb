...
{
    public partial class BNewPatientBillDetailRSRABeforeBill : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSRABeforeBill()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSRABeforeBill.InitializeReport(lstHDDT);
            #endregion
