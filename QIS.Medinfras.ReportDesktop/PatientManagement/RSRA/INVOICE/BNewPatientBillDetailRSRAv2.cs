...
{
    public partial class BNewPatientBillDetailRSRAv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSRAv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSRA.InitializeReport(lstHDDT);
            #endregion
