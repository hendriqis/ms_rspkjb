...
{
    public partial class BRincianKomponenPaketMCURSRA : BaseCustomDailyPotraitRpt
    {
        public BRincianKomponenPaketMCURSRA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesDetailKomponenMCU> lstHDDT = BusinessLayer.GetPatientChargesDetailKomponenMCUList(entityReg.RegistrationID);
            ...
            billRincianKomponenDetailMCURSRA.InitializeReport(lstHDDT);
            #endregion
