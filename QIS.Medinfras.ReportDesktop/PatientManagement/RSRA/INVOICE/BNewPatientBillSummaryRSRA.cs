...
{
    public partial class BNewPatientBillSummaryRSRA : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSRA()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSRA.InitializeReport(lstHDDT);
            #endregion
