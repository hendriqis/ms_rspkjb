...
{
    public partial class BPengembalianUangJaminanNHS : BaseDailyPortraitRpt
    {
        public BPengembalianUangJaminanNHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblAdminPrintBy.Text = appSession.UserFullName;
            ...
            lblPatientNameSign.Text = entityReg.PatientName;
