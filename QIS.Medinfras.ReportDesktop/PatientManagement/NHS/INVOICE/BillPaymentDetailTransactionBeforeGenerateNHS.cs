...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateNHS : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateNHS()
        {
            InitializeComponent();
        }
