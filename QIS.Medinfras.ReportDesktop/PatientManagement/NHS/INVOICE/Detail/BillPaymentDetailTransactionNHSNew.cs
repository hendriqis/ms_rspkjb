...
{
    public partial class BillPaymentDetailTransactionNHSNew : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionNHSNew()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(List<GetPatientChargesHdDtALLNHS> lst, String registrationID)
        {
            ...
            if (oHealthcare != null)
            {
                ...
                lblReportSubTitle.Text = "Transaction Detail";
            }
            ...
            decimal point7 = Convert.ToDecimal(lst.Where(z => z.GroupInvoice == "GROUP02"
                            && (z.GCItemType == Constant.ItemType.OBAT_OBATAN || z.GCItemType == Constant.ItemType.BARANG_MEDIS)).Sum(a => a.LineAmount));
