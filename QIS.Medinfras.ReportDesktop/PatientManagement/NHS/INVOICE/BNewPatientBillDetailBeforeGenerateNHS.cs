...
{
    public partial class BNewPatientBillDetailBeforeGenerateNHS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerateNHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerate.InitializeReport(lstHDDT);
            #endregion
