...
{
    public partial class BillPaymentDetailTransactionByServiceUnitNHS : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByServiceUnitNHS()
        {
            InitializeComponent();
        }
