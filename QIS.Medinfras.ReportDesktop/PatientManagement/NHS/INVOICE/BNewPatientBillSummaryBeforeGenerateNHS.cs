...
{
    public partial class BNewPatientBillSummaryBeforeGenerateNHS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBeforeGenerateNHS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBeforeGenerate.InitializeReport(lstHDDT);
            #endregion
