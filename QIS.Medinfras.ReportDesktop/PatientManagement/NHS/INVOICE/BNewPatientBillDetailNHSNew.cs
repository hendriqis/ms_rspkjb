...
{
    public partial class BNewPatientBillDetailNHSNew : BaseRpt
    {
        public BNewPatientBillDetailNHSNew()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransaction.InitializeReport(lstHDDT, param[0]);
            #endregion
