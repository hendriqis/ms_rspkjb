...
{
    public partial class BNewPatientBillDetailAllBillRSP : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillRSP()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllBillRSP> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllBillRSPList(entityReg.RegistrationID);
            ////List<GetPatientChargesHdDtAllBillComp2> lstHDDTComp2 = BusinessLayer.GetPatientChargesHdDtAllBillComp2List(entityReg.RegistrationID);
            ...
            billPaymentDetailTransactionAllBillRSP.InitializeReport(lstHDDT);
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllDMRSP.InitializeReport(entityReg.RegistrationID);
            #endregion
            ...
            billPaymentDetailPaymentAllDMRSP.InitializeReport(lstPaymentHdDt);
            #endregion
            ...
            billPaymentDetailDiscComp2TransactionAllBillRSP.InitializeReport(lstHDDT.Where(a => a.cfDiscountAmountComp2 != 0).ToList());
            #endregion
            ...
            ////    billPaymentDetailTransactionAllBillComp2.InitializeReport(lstHDDTComp2);
            ////}
            ////else
            ////{
