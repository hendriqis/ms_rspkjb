...
{
    public partial class BNewPatientBillSummaryRSPPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSPPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSPPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
            ...
            #region Payment All
            List<vPatientPaymentHdDtRSP> lstPaymentHdDt = BusinessLayer.GetvPatientPaymentHdDtRSPList(string.Format("RegistrationID IN ({0}) AND GCTransactionStatus != '{1}'",
               entityReg.RegistrationID, Constant.TransactionStatus.VOID));
