...
{
    public partial class BillPaymentDetailTransactionRSP2 : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionRSP2()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllRSP2> lst)
        {
            this.DataSource = lst;
        }
