...
{
    public partial class BNewPatientBillDetailRSPPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSPPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionRSPPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion

            #region Discount
            subDiscount.CanGrow = true;
            billPaymentDetailDiscountAllDMPatientRSP.InitializeReport(entityReg.RegistrationID);
            #endregion
