...
{
    public partial class BNewPatientBillSummaryRSP : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryRSP()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionRSP.InitializeReport(lstHDDT);
            #endregion
            ...
            #region Discount Comp2 Custom RSRT
