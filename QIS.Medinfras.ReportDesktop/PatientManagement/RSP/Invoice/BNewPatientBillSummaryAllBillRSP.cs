...
{
    public partial class BNewPatientBillSummaryAllBillRSP : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillRSP()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionAllBillRSP.InitializeReport(lstHDDT);
            #endregion
            ...
            PatientBill oBill = lstBill.FirstOrDefault();
            string ttdBy = appSession.UserFullName;
            if (oBill != null) {
                vUser ouser = BusinessLayer.GetvUserList(string.Format("UserID='{0}'", oBill.CreatedBy)).FirstOrDefault();
                ttdBy = ouser.FullName;
            }
            lblTandaTangan.Text = ttdBy;
            #endregion
