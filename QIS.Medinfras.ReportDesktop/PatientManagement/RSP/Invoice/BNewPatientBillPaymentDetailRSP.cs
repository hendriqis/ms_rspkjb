...
{
    public partial class BNewPatientBillPaymentDetailRSP : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillPaymentDetailRSP()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailDiscountByBilling.InitializeReport(entityReg.RegistrationID, billID);
            #endregion
