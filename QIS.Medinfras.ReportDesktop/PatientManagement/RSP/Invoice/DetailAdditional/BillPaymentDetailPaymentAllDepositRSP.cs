...
{
    public partial class BillPaymentDetailPaymentAllDepositRSP : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailPaymentAllDepositRSP()
        {
            InitializeComponent();
        }
        ...
        public void InitializeReport(List<vPatientPaymentHdDtRSP> lst)
        {
            ...
            foreach (vPatientPaymentHdDtRSP dt in lst2)
            {
