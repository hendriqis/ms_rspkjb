...
{
    public partial class BNewPatientBillDetailRSP : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSP()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtAllRSP2> lstHDDT = BusinessLayer.GetPatientChargesHdDtAllRSP2List(entityReg.RegistrationID);
            ...
            List<GetPatientChargesHdDtAllRSP2> lstDetail = lstHDDT.OrderBy(lst => lst.ItemCreatedDate).OrderBy(lst => lst.ItemCreatedTime).ToList();
            billPaymentDetailTransactionRSP2.InitializeReport(lstDetail);
            #endregion
