...
{
    public partial class BillPaymentDetailTransactionByPaymentReceiptRSP : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionByPaymentReceiptRSP()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPatientChargesHdDtAllPerBillingByPaymentReceiptID> lst)
        {
            this.DataSource = lst;
        }
