...
{
    public partial class BLaporanKematianRSSEB : BaseRpt
    {

        public BLaporanKematianRSSEB()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            ParamedicMaster entityRMO = BusinessLayer.GetParamedicMasterList(string.Format("ParamedicID = {0}", param[6]))[0];
            ...
            lblDirektur.Text = string.Format("Direktur {0}", entityH1.HealthcareName);
            ...
            lblKematian.Text = String.Format("{0} / {1} / {2}:{3}",test, Date.ToString(Constant.FormatString.DATE_FORMAT), param[2], param[3]);

            lblServiceUnitName.Text = string.Format("{0}", entity.ServiceUnitName);
            lblPenyebabKematian.Text = param[4];
            lblDiagnose.Text = param[5];
            lblParamedicNameDPJP.Text = entity.ParamedicName;
            lblParamedicNameRMO.Text = entityRMO.FullName;
