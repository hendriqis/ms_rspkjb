...
{
    public partial class BNewPatientBillSummaryBROSPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBROSPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBROSPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
