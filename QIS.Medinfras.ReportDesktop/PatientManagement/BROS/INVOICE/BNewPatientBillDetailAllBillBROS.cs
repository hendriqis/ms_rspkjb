...
{
    public partial class BNewPatientBillDetailAllBillBROS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailAllBillBROS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtALLWithOutDPAllBill> lstHDDT = BusinessLayer.GetPatientChargesHdDtALLWithOutDPAllBillList(entityReg.RegistrationID);
            ...
            cPatientName.Text = string.Format("{0} ({1})", entityReg.cfPatientNameSalutation, entityReg.cfGenderInitial);
            lblPatientName.Text = entityReg.cfPatientNameSalutation;
            cDOB.Text = string.Format("{0} ({1} Tahun {2} Bulan {3} Hari)", entityReg.DateOfBirthInString, entityReg.AgeInYear, entityReg.AgeInMonth, entityReg.AgeInDay);
            ...
            billPaymentDetailTransactionAllBillBROS.InitializeReport(lstHDDT);
            #endregion
