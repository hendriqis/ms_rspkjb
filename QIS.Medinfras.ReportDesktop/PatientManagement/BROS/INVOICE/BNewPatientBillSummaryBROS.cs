...
{
    public partial class BNewPatientBillSummaryBROS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBROS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBROS.InitializeReport(lstHDDT);
            #endregion
