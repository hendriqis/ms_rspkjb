...
{
    public partial class BNewPatientBillDetailBROSv3 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBROSv3()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBROSv3.InitializeReport(lstHDDT);
            #endregion
