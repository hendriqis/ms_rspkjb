...
{
    public partial class BNewPatientBillDetailBeforeGenerateDMBROSIng : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBeforeGenerateDMBROSIng()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBeforeGenerateDMBROSIng.InitializeReport(lstHDDT);
            #endregion
            ...
            decimal balanceP = paymentP - transP;
            decimal balanceC = paymentC - transC;
