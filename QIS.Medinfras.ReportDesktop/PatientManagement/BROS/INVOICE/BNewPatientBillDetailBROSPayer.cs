...
{
    public partial class BNewPatientBillDetailBROSPayer : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBROSPayer()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBROSPayer.InitializeReport(lstHDDT.Where(a => a.PayerAmount != 0).ToList());
            #endregion
