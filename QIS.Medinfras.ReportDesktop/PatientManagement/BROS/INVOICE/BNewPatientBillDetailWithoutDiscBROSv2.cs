...
{
    public partial class BNewPatientBillDetailWithoutDiscBROSv2 : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailWithoutDiscBROSv2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesHdDtWithDetailPackage> lstHDDT = BusinessLayer.GetPatientChargesHdDtWithDetailPackageList(entityReg.RegistrationID);
            ...
            billPaymentDetailTransactionWithoutDiscBROSv2.InitializeReport(lstHDDT);
            #endregion
