...
{
    public partial class BNewPatientBillDetailPerBillingBROS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailPerBillingBROS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            cMedicalNo.Text = entityReg.MedicalNo;
            ...
            billPaymentDetailTransactionPerBillingBROS.InitializeReport(lstHDDT);
            #endregion
