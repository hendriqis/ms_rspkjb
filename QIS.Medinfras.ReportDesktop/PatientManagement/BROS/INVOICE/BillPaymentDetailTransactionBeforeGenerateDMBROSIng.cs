...
{
    public partial class BillPaymentDetailTransactionBeforeGenerateDMBROSIng : DevExpress.XtraReports.UI.XtraReport
    {
        public BillPaymentDetailTransactionBeforeGenerateDMBROSIng()
        {
            InitializeComponent();
        }
        ...
        private void xrLabel1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                xrLabel1.Text = string.Format("{0}", Convert.ToString(GetCurrentColumnValue("ItemGroupName2")));
            }
