...
{
    public partial class BRincianKomponenPaketBROS : BaseCustomDailyPotraitRpt
    {
        public BRincianKomponenPaketBROS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            List<GetPatientChargesDetailKomponen> lstHDDT = BusinessLayer.GetPatientChargesDetailKomponenList(entityReg.RegistrationID);
            ...
            billRincianKomponenDetail.InitializeReport(lstHDDT);
            #endregion
