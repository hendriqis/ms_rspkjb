...
{
    public partial class BNewPatientBillSummaryBROSPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryBROSPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionBROSPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
