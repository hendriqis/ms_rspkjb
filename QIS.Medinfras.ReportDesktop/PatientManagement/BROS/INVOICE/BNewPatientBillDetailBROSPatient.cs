...
{
    public partial class BNewPatientBillDetailBROSPatient : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailBROSPatient()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentDetailTransactionBROSPatient.InitializeReport(lstHDDT.Where(a => a.PatientAmount != 0).ToList());
            #endregion
