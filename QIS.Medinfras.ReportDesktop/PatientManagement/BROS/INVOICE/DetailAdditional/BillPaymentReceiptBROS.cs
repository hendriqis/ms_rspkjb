...
{
    public partial class BillPaymentReceiptBROS : BaseRpt
    {
        private string HealthcareName = "";
        private string Address = "";
        private string City = "";

        public BillPaymentReceiptBROS()
        {
            InitializeComponent();
        }

        public void InitializeReport(List<GetPaymentReceiptCustomBROS> lstEntity)
        {
