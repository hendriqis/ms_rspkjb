...
{
    public partial class BNewPatientBillSummaryAllBillBROS : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillBROS()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            billPaymentSummaryTransactionAllBillBROS.InitializeReport(lstHDDT);
            #endregion
