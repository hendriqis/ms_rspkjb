...
{
    public partial class BRincianBiayaPerawatanDetailBPJSRSPW : BaseDailyPortraitRpt
    {
        public BRincianBiayaPerawatanDetailBPJSRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            decimal sisaTagihanP = lstBill.Sum(a => a.TotalAmount - a.TotalPatientPaymentAmount - a.PatientDiscountAmount);
            decimal sisaTagihanC = lstBill.Sum(a => a.TotalAmount - a.TotalPayerPaymentAmount - a.PayerDiscountAmount);
