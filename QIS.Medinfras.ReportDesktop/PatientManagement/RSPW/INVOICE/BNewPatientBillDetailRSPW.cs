...
{
    public partial class BNewPatientBillDetailRSPW : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillDetailRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            decimal temp = billC + adminC + serviceC;
            decimal amountP = 0;
            decimal amountC = 0;
            if (temp > coverC)
            {
            ...
            //decimal gtP = transP + adminP + serviceP + amountP - discP;
