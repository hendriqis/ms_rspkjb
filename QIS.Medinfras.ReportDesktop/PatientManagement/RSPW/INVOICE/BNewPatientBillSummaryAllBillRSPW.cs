...
{
    public partial class BNewPatientBillSummaryAllBillRSPW : BaseCustomDailyPotraitRpt
    {
        public BNewPatientBillSummaryAllBillRSPW()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            decimal temp = transC + adminC + serviceC;
