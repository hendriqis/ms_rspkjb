...
{
    public partial class BaseCustomDailyPotrait2Rpt : BaseRpt
    {
        ...
        public BaseCustomDailyPotrait2Rpt()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            if (reportMaster.IsShowHeader)
            {
                ...
                if (oHealthcare != null)
                {
                    ...
                    cHealthcareAddress.Text = string.Format("{0} Telp. : {1}/{2} Fax. {3}", oHealthcare.StreetName, oHealthcare.PhoneNo1, oHealthcare.PhoneNo2, oHealthcare.FaxNo1);
                    cEmail.Text = oHealthcare.Email;
                    cHealthcareZipCode.Text = string.Format("{0} {1}", oHealthcare.City, oHealthcare.ZipCode);
                }
            }
            if (!IsSkipBinding())
            {
