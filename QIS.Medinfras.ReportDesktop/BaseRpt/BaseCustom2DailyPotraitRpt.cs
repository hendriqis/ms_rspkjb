...
{
    public partial class BaseCustom2DailyPotraitRpt : BaseRpt
    {
        ...
        private string GetFilterExpression(string value)
        {
            ...
            sbResult.Replace("@ParamedicID", Convert.ToString(appSession.ParamedicID));
        ...
        public BaseCustom2DailyPotraitRpt()
        {
            InitializeComponent();
        }
