...
{
    public partial class Base_1per3_F4LanscapeRpt : BaseRpt
    {
        ...
        public Base_1per3_F4LanscapeRpt()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblReportProperties1.Text = string.Format("MEDINFRAS-{0}|{1}", reportMaster.ReportCode, reportMaster.ReportTitle1);
            ...
            {
                lblReportProperties2.Text = string.Format("Print Date/Time:{0}, User:{1}", DateTime.Now.ToString("dd-MMM-yyyy/HH:mm:ss"), appSession.UserName);
            }
            else
            {
