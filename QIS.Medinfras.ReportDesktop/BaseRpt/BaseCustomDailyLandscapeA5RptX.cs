...
{
    public partial class BaseCustomDailyLandscapeA5RptX : BaseRpt
    {
        ...
        public BaseCustomDailyLandscapeA5RptX()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            string reportSubTitle = string.IsNullOrEmpty(this.AdditionalReportSubTitle) ? reportMaster.ReportTitle2 : string.Format("{0} ({1})",reportMaster.ReportTitle2,this.AdditionalReportSubTitle);
            lblReportTitle.Text = reportMaster.ReportTitle1;              
            lblReportSubtitle.Text = reportSubTitle;
