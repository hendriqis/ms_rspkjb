...
namespace QIS.Medinfras.ReportDesktop
{
    public partial class BaseDailyLandscapeRpt : BaseRpt
    {
        private string GetFilterExpression(string value)
        {
            ...
            if (value.Contains("@narkotika"))
                sbResult.Replace("@narkotika", "X123^O");
            sbResult.Replace("@directpurchase", Constant.TransactionCode.DIRECT_PURCHASE);
            sbResult.Replace("@purchasereceive", Constant.TransactionCode.PURCHASE_RECEIVE);
            sbResult.Replace("@psikotropika", "X123^P");
            sbResult.Replace("@morphin", "X123^M");
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            this.ReportFooter.Visible = reportMaster.IsShowParameter;
        }

        private void BindingView(ReportMaster reportMaster, string[] param, bool isReportBasedOnUserLogin = false)
        {
            ...
            if (filterExpression != "" && reportMaster.IsReportBasedOnUserLogin)
