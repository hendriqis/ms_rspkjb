<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientInformationPerDoctorDtPerDate.ascx.cs" 
Inherits="QIS.Medinfras.Web.EMR.Program.PatientInformationPerDoctorDtPerDate" %>
...
<input type="hidden" runat="server" value="" id="hdnVisitDay" />
<input type="hidden" runat="server" value="" id="hdnVisitYear" />
<input type="hidden" runat="server" value="" id="hdnVisitMonth" />
<input type="hidden" runat="server" value="" id="hdnVisitStatus" />
