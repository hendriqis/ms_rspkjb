<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true"
    CodeBehind="LabResultSummary.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.LabResultSummary" %>
        ...
        $(function () {
            ...
            function createThumbChart() {
                ...
                $('#draggableScroller  .content').each(function () {
                    ...
                    {
                        alert('draggableScroller');
                        alert(allSeriesData[ctrThumbChart].length);
        ...
        <tr>
            <td>
                <div class="container" style="height: 540px">
                    <table style="width: 100%; height: auto; border-collapse: collapse;" cellpadding="0"
                        cellspacing="0" class="boxShadow">
                        <tr>
                            <td style="min-width: 150px; width: 150px; height: 520px; border: 1px solid #EAEAEA"
                                id="tdDraggableImage">
                                        ...
                                        <table>
                                            <tr>
                                                <td style="text-align: right;">
                                                    <div id="chart" style="height: 500px; width: 800px; border: 1px solid #EAEAEA; float: left;"
                                                        class="boxShadow">
                                                    </div>
                                                </td>
