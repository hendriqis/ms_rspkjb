<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="PatientVisitHistory1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.PatientVisitHistory1" EnableViewState="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPFrame" runat="server">
    ...
    <style type="text/css">
        #ulAreaDrop         { margin: 0; padding: 0; height: 650px;}
                                ...
                                <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage2">
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" RowStyle-CssClass="trDraggable" EmptyDataRowStyle-CssClass="trEmpty">
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField HeaderText="View" Text="Details" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" ItemStyle-CssClass="lnkMedicalRecordSummary" Visible="true" />
