<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="ImagingResultList1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.ImagingResultList1" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.btnViewReport').live('click', function () {
                ...
                $('#<%=hdnItemID.ClientID %>').val($(this).closest('tr').find('.keyField').html());
...
//                var postData = "?code=d57ada2e648c49d19b58f20fd21c5b93&number=" + "U-ID53189";
