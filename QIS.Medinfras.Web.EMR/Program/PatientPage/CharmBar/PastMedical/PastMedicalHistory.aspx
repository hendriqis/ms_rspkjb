<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="PastMedicalHistory.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.PastMedicalHistory" EnableViewState="false" %>
            ...
            $('#ulAreaDrop > li').droppable({
                drop: function (event, ui) {
                    ...
                    if ($('#ulAreaDrop > li .hdnMedicalHistoryVisitID[value=' + visitID + ']').length < 1) {
                        ...
                        var url = ResolveUrl('~/Program/PatientPage/HealthRecord/PastMedical/PastMedicalHistoryContentCtl.ascx');
