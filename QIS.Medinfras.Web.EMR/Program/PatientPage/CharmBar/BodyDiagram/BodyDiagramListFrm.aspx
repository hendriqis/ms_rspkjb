<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="BodyDiagramListFrm.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.BodyDiagramListFrm" EnableViewState="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPFrame" runat="server">
    ...
    <div style="clear:both;width:100%; height:100%; padding:5px;" class="borderBox" id="containerCharmBarBodyDiagramCtn">
