<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.Master" AutoEventWireup="true" 
    CodeBehind="CDCGrowthChartFrm.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.CDCGrowthChartFrm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPFrame" runat="server">
    ...
    <script type="text/javascript">
        function initializeChart(chartData) {
            ...
            var plot = $.jqplot('chart', seriesData, CreateChart(title, xLabel, yLabel, seriesLabel)).replot();
        }
        ...
        function CreateChart(title, xLabel, yLabel, seriesLabel) {
