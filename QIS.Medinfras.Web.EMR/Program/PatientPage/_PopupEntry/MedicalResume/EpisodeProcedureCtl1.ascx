<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EpisodeProcedureCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.EMR.Program.EpisodeProcedureCtl1" %>
...
<script type="text/javascript" id="dxss_Referralctl">
    ...
    function onAfterProcessPopupEntry(param) {
        if (typeof onAfterLookUpProcedure == 'function') {
            onAfterLookUpProcedure(param);
        }
    }
</script>
                                ...
                                <asp:Panel runat="server" ID="pnlRujukan" Style="width: 100%; margin-left: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdView" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ItemName" HeaderText="Prosedur/Tindakan" HeaderStyle-CssClass="itemName" ItemStyle-CssClass="itemName" />
                                        </Columns>
                                    </asp:GridView>
