...
{
    public partial class ResidualMedicationPicksCtl1 : BaseProcessPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("MRN = {0} AND VisitID = {1} AND IsHasResidualEffect = 1 AND GCTransactionStatus NOT IN ('{3}','{4}')", AppSession.RegisteredPatient.MRN, hdnPopupVisitID.Value, Constant.TransactionStatus.OPEN, Constant.TransactionStatus.VOID);
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            try
            {
                ...
                List<PatientResidualMedicationSummary> lstEntity = BusinessLayer.GetPatientResidualMedicationSummaryList(AppSession.RegisteredPatient.RegistrationID, displayMode, cboMedicationStatus.Value.ToString());
