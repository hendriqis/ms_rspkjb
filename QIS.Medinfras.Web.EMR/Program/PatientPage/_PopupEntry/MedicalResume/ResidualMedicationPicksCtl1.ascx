<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ResidualMedicationPicksCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.EMR.Program.ResidualMedicationPicksCtl1" %>
...
<script type="text/javascript" id="dxss_drugsquickpicksHistoryCtl1">
    ...
    function onAfterProcessPopupEntry(param) {
        if (typeof onAfterLookUpPrescriptionResidualEffect == 'function') {
            onAfterLookUpPrescriptionResidualEffect(param);
        }
    }
