<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TestOrderLabQuickPicksCtl1.ascx.cs"
    Inherits="QIS.Medinfras.Web.EMR.Program.TestOrderLabQuickPicksCtl1" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            ...
            <td colspan="2" rowspan="2">
                <asp:TextBox ID="txtRemarks" runat="server" Width="100%" TextMode="Multiline" Rows="2" onkeyUp="return MaxCount(this,event,500);" />
            </td>
        </tr>
        <tr>
            <td class="tdLabel" valign="top">
