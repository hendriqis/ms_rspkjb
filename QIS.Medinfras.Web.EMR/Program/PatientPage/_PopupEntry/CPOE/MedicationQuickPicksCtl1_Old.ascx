<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MedicationQuickPicksCtl1_Old.ascx.cs" 
    ...
    <script id="tmplSelectedTestItem" type="text/x-jquery-tmpl">
        <tr class="trSelectedItem">
            ...
            <td style="text-align:right">
                <input type="text" validationgroup="mpDrugsQuickPicks" class="txtQty number min" value="1" style="width:40px;" />
            </td>
            ...
            <td style="text-align:right"><input type="text" validationgroup="mpDrugsQuickPicks" class="txtDispenseQty number min" min="1" value="1" style="width:40px" /></td>
            <td style="text-align:left"><input type="text" validationgroup="mpDrugsQuickPicks" class="txtMedicationAdministration" style="width:150px" value="${MedicationAdministration}" /></td>
        </tr>
    </script>
...
<%--                                <asp:ListItem Text="Obat Karyawan" Value="3" />--%>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
