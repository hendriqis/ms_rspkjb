<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditPrescriptionDtCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.EMR.Program.EditPrescriptionDtCtl" %>
...
<script type="text/javascript" id="dxss_patiententryctl">
    ...
    $('#btnMPEntryProcess').click(function () {
        ...
        displayConfirmationMessageBox("Change Signa", message, function (result) {
            if (IsValid(result, 'fsvPrescriptionOrderDt1', 'mpvPrescriptionOrderDt1')) {
    ...
    $('#<%=txtDispenseQty.ClientID %>').live('change', function () {
        var dispQty = $('#<%=txtDispenseQty.ClientID %>').val();
        $('#<%=txtDispenseQty.ClientID %>').val(dispQty);
    });
    ...
    <div>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td colspan="5">
                <fieldset id="fsvPrescriptionOrderDt1" style="margin: 0">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="width: 15%">
                ...
                <td style="vertical-align:top" colspan="6">
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                        <tr>
                            ...
                            <td><asp:CheckBox ID="chkIsGenerateJournal" runat="server" Text=" Generate Jurnal Farmasi" ToolTip="Generate Jurnal" Checked="true" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
