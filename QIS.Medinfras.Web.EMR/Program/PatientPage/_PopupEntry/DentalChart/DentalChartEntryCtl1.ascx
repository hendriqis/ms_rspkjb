<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DentalChartEntryCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.EMR.Program.PatientPage.DentalChartEntryCtl1" %>
...
<script type="text/javascript" id="dxss_dentalChartEntryctl">
    setDatePicker('<%=txtTreatmentDate.ClientID %>');
    $('#<%=txtTreatmentDate.ClientID %>').datepicker('option', 'maxDate', '0');
            ...
            <td style="padding:5px;vertical-align:top;">
                <table class="tblEntryContent" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><dxe:ASPxComboBox ID="cboParamedicID" Width="300px" runat="server" /></td>
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Gigi")%></label></td>
                        <td colspan="2"><asp:TextBox ID="txtTooth" Width="300px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Masalah Gigi")%></label></td>
                        <td colspan="2"><dxe:ASPxComboBox ID="cboToothProblem" Width="300px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Status saat ini")%></label></td>
                        <td colspan="2"><dxe:ASPxComboBox ID="cboCurrentStatus" Width="300px" runat="server" /></td>
                    </tr>
                    <tr style="display:none">
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Tindakan")%></label></td>
                        <td colspan="4">
                            ...
                            <qis:QISSearchTextBox ID="ledProcedure" ClientInstanceName="ledProcedure" runat="server" Width="99%"
                                ValueText="ProcedureID" FilterExpression="1 = 0" DisplayText="ProcedureName" MethodName="GetvProceduresList" >
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Rencana Status Perawatan")%></label></td>
                        <td colspan="2"><dxe:ASPxComboBox ID="cboNextStatus" Width="200px" runat="server" /></td>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Tanggal Rencana")%></label></td>
                        <td><asp:TextBox ID="txtNextDate" Width="120px" CssClass="datepicker" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel" style="vertical-align: top; padding-top: 5px;"><label class="lblNormal"><%=GetLabel("Catatan Perawatan")%></label></td>
