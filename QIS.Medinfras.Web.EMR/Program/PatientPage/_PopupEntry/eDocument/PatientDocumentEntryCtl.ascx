<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientDocumentEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.EMR.Program.PatientPage.PatientDocumentEntryCtl" %>
...
<script id="dxss_PatientFolderUploadDocument" type="text/javascript">
    $(function () {
        ...
        function onAfterSaveRecordPatientPageEntry(result) {
            if (typeof onRefreshDocumentGrid == 'function')
                onRefreshDocumentGrid();
        }
    });
        ...
        <td>
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="padding-left:1px"><input type="button" class="w3-btn w3-hover-blue" id="btnUploadFile" value="Upload" style="width:80px"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align:top">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>          
                                <td><%=GetLabel("Allowed extension") %> : jpg,jpeg,png,txt,doc,docx,pdf,mp4</td>
                            </tr>
                            <tr>                                
