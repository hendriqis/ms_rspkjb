<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BodyDiagramSOAPEdit1Ctl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.EMR.Program.BodyDiagramSOAPEdit1Ctl" %>
...
<div class="editContainer" style="height:430px">
    ...
    <div class="editContentFooter">
        <table cellpadding="0" cellspacing="10" style="margin-left:auto;margin-right:auto;text-align:left">
            <tr>
                <td><input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("SAVE")%>' id="btnSave" style="width:80px;" /></td>
                <td><input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("CANCEL")%>' id="btnCancel" style="width:80px;" /></td>
            </tr>
        </table>
    </div>    
</div> 
