...
{
    public partial class FollowUpPlanListOld : BasePagePatientPageListEntry
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            string.Format("FromVisitID = {0} AND GCAppointmentStatus NOT IN ('{1}','{2}')", AppSession.RegisteredPatient.VisitID, Constant.AppointmentStatus.DELETED, Constant.AppointmentStatus.CANCELLED);
        ...
        protected override void SetControlProperties()
        {
            ...
            List<vHealthcareServiceUnit> lstServiceUnit = BusinessLayer.GetvHealthcareServiceUnitList("DepartmentID = 'OUTPATIENT' AND IsDeleted = 0");
            Methods.SetComboBoxField<vHealthcareServiceUnit>(ddlClinic, lstServiceUnit, "ServiceUnitName", "HealthcareServiceUnitID");
        }

        protected override void OnControlEntrySetting()
        {
            //SetControlEntrySetting(ledVisitType, new ControlEntrySetting(false, false, false));
            //SetControlEntrySetting(txtPhysician, new ControlEntrySetting(false, false, false));
           // SetControlEntrySetting(txtPhysician, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtVisitDate, new ControlEntrySetting(true, true, false));
            //SetControlEntrySetting(cboVisitTime, new ControlEntrySetting(true, true, false));
        ...
        private void ControlToEntity(Appointment entity)
        {
            ...
            entity.StartTime = hdnVisitTime.Value;
            entity.Notes = txtRemarks.Text;
            entity.VisitDuration = Convert.ToByte(hdnVisitDuration.Value);
