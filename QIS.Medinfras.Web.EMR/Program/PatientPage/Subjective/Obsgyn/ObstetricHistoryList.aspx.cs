...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class ObstetricHistoryList : BasePagePatientPageList
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            switch (deptType)
            {
                case "EMERGENCY": MenuCode = Constant.MenuCode.EMR.OBSTETRIC_HISTORY; break;
                case "OUTPATIENT": MenuCode = Constant.MenuCode.EMR.OBSTETRIC_HISTORY; break;
                case "INPATIENT": MenuCode = Constant.MenuCode.EMR.OBSTETRIC_HISTORY; break;
                case "DIAGNOSTIC": MenuCode = Constant.MenuCode.EMR.OBSTETRIC_HISTORY; break;
                default: MenuCode = Constant.MenuCode.EMR.OBSTETRIC_HISTORY; break;
            }
            #endregion
        ...
        {
            url = ResolveUrl("~/Program/PatientPage/Subjective/Obsgyn/ObstetricHistoryEntryCtl.ascx");
            queryString = "";
            popupWidth = 680;
            popupHeight = 500;
