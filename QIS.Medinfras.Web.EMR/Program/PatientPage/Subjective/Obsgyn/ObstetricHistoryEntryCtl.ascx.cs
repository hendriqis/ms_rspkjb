...
namespace QIS.Medinfras.Web.CommonLibs.Program
{
    public partial class ObstetricHistoryEntryCtl : BasePagePatientPageEntryCtl
    {
        ...
        {
            List<StandardCode> lstStandardCode = BusinessLayer.GetStandardCodeList(string.Format("ParentID IN ('{0}','{1}','{2}','{3}','{4}') AND IsActive = 1 AND IsDeleted = 0 ORDER BY StandardCodeName ASC",
                   Constant.StandardCode.BIRTH_METHOD, Constant.StandardCode.CAESAR_METHOD, Constant.StandardCode.BORN_CONDITION, Constant.StandardCode.HEALTHCARE_PROFESSIONAL_TYPE, Constant.StandardCode.GENDER));
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(cboBirthMethod, new ControlEntrySetting(true, true, false));
            ...
            SetControlEntrySetting(txtWeight, new ControlEntrySetting(true, true, false));
