                ...
                <table style="width: 100%" id="tblEntryContent">
                    ...
                    <tr>
                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="width:33.33%"><asp:CheckBox ID="chkIsAntepartumBleeding" runat="server" Text=" Pendarahan sebelum" Checked="false" /></td>
                                    <td style="width:33.33%"><asp:CheckBox ID="chkIsPostpartumBleeding" runat="server" Text=" Pendarahan sesudah" Checked="false" /></td>
                                    <td style="width:33.33%"><asp:CheckBox ID="chkIsPreclampsia" runat="server" Text=" Pre Eclampsia" Checked="false" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="width:33.33%"><asp:CheckBox ID="chkIsEclampsia" runat="server" Text=" Eclampsia" Checked="false" /></td>
                                    <td style="width:33.33%"><asp:CheckBox ID="chkIsHasInfectious" runat="server" Text=" Infeksi" Checked="false" /></td>
                                    <td style="width:33.33%"><asp:CheckBox ID="chkIsOtherComplication" runat="server" Text=" Lain-lain" Checked="false" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <dxe:ASPxComboBox runat="server" ID="cboSex" ClientInstanceName="cboSex"
                                Width="100%" />
                        </td>
                    </tr>
                    <tr>
