<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientAssessmentFormEntry.ascx.cs"
    Inherits="QIS.Medinfras.Web.EMR.Program.PatientAssessmentFormEntry" %>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    <colgroup>
                      ...
                      <tr>
                        <td class="tdLabel">
                            <label><%=GetLabel("Medical No")%></label>
                         </td> 
                         <td class="tdLabel">
                           <asp:TextBox ID="txtMedicalNo" Width="120px" CssClass="datepicker" runat="server" />
                         </td>
                    </tr>
                     <tr>
                        <td class="tdLabel">
                            <label><%=GetLabel("Nama Pasien")%></label>
                         </td> 
                         <td class="tdLabel">
                           <asp:TextBox ID="txtPatientName" Width="120px" CssClass="datepicker" runat="server" />
                         </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
