<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master" AutoEventWireup="true" 
    CodeBehind="SurgeryReportList.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.SurgeryReportList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript">
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if (code == 'PM-00567' || code == 'PM-00577' || code == 'PM-00591' || code == 'PM-00673' || code == 'PM-00598' || code == 'PM-005671'
                || code == 'PM-90086' || code == 'PM-90128') {
