...
{
    public partial class VitalSignList : BasePagePatientPageList
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            switch (departmentID)
            {
                case Constant.Facility.EMERGENCY: return Constant.MenuCode.EMR.VITAL_SIGN_EMERGENCY;
                default: return Constant.MenuCode.EMR.VITAL_SIGN;
            }
        }
        ...
        {
            url = ResolveUrl("~/Program/PatientPage/Objective/VitalSign/VitalSignEntryCtl.ascx");
            queryString = "";
            popupWidth = 700;
            popupHeight = 500;
