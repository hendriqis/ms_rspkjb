<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master" AutoEventWireup="true" 
    CodeBehind="ImagingTestResultList.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.ImagingTestResultList" %>
        ...
        $(function () {
            ...
            $('.btnViewReport').live('click', function () {
                ...
                if (itemID != '' && testOrderID != '') {
                    ...
                    var url = ResolveUrl("~/Libs/Program/Module/EMR/TestResult/Imaging/ViewImagingResultCtl.ascx");
