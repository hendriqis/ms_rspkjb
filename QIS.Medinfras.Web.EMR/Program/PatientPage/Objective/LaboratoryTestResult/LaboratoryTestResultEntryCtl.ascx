<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LaboratoryTestResultEntryCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.EMR.Program.PatientPage.LaboratoryTestResultEntryCtl" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<script type="text/javascript" id="dxss_chiefcomplaintentryEMRctl">
           ...
           <asp:TemplateField HeaderText="Hasil" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                 <ItemTemplate>
                     ...
                     <div <%# Eval("cfIsResultInPDF").ToString() == "False" ? "Style='display:none'" : "" %>>
                                <asp:Label ID="Label1" class="lblViewPDF lblLink" runat="server"><%#: Eval("cfTestReferenceValue") %></asp:Label>
                     </div>
                </ItemTemplate>
             </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Nilai Referensi" ItemStyle-Width="140px" HeaderStyle-HorizontalAlign="Center"
                ...
                <ItemTemplate>
                    <div>
                        <%#: Eval("cfReferenceRangeCustom") %></div>
                </ItemTemplate>
            </asp:TemplateField>
