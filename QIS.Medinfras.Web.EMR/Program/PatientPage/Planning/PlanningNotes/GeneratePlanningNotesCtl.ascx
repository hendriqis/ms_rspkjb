<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GeneratePlanningNotesCtl.ascx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.PatientPage.GeneratePlanningNotesCtl" %>
