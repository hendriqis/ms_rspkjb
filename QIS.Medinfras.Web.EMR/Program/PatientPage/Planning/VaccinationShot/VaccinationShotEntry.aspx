<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageListEntry.master" AutoEventWireup="true" 
    CodeBehind="VaccinationShotEntry.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.VaccinationShotEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnBackVaccinationShotList" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/back.png")%>' alt="" /><div><%=GetLabel("View")%></div></li>
</asp:Content>
            ...
            <td valign="top">
                <table style="width:100%">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtVaccinationNo" Width="80px" runat="server"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <qis:QISSearchTextBox ID="ledItem" ClientInstanceName="ledItem" runat="server" Width="500px"
                                ValueText="ItemID" FilterExpression="GCItemType = 'X001^002' AND IsDeleted = 0 AND ISNULL(GCItemStatus,'') != 'X181^999'" DisplayText="ItemName1" MethodName="GetvDrugInfoList" >
