<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionEntryQuickPicksCtl1.ascx.cs" 
    Inherits="QIS.Medinfras.Web.EMR.Program.PrescriptionEntryQuickPicksCtl1" %>
...
<input type="hidden" runat="server" id="hdnDefaultStartDate" />
