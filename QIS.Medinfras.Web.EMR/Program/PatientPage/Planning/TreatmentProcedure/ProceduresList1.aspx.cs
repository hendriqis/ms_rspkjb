...
{
    public partial class ProceduresList1 : BasePagePatientPageList
    {
        ...
        protected override bool OnAddRecord(ref string url, ref string errMessage)
        {
            ...
            var ItemName = hdnItemName.Value.Replace("&lt;", "<").Replace("&gt;", ">");
            hdnItemName.Value = ItemName;
            ...
            switch (hdnSelectedTab.Value)
            {
                case "preSurgeryAssessment":
                    url = ResolveUrl("~/Program/PatientPage/SOAP/ProcedureReporting/AssessmentPreProcedureEntry1.aspx?id=" + id);
                    break;
                case "preSurgeryAnesthesy":
                    url = ResolveUrl("~/Program/PatientPage/SOAP/ProcedureReporting/ProcedurePreAnesthesyEntry1.aspx?id=" + id);
                    break;
                case "anesthesyStatus":
                    url = ResolveUrl("~/Program/PatientPage/SOAP/ProcedureReporting/ProcedureAnesthesyStatusEntry1.aspx?id=" + id);
                    break;
                case "surgeryReport":
                    url = ResolveUrl("~/Program/PatientPage/SOAP/ProcedureReporting/ProcedureSurgeryReportEntry1.aspx?id=" + id);
                    break;
        ...
        private void BindGridViewDt5(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (filterExpression != "")
                filterExpression += " AND ";
            filterExpression += string.Format("VisitID = {0} AND TestOrderID = {1} AND IsDeleted = 0", AppSession.RegisteredPatient.VisitID, hdnLinkedID.Value);
