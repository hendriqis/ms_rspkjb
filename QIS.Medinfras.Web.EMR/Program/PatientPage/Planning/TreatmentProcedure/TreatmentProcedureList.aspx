...
<asp:Content ID="ctnEntry" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <table style="width:100%" class="tblEntryDetail">
        ...
        <tr>
            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Kode Prosedur")%></label></td>
            <td colspan="2">
        ...
        <tr>
            ...
            <td colspan="2"><asp:TextBox ID="txtRemarks" Width="100%" runat="server" TextMode="MultiLine" /></td>
        </tr>
    </table>
</asp:Content>
                        ...
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <%=GetLabel("Pengkodean Prosedur Tindakan") %>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        ...
                                        <div style="clear:both;"><%#: Eval("ProcedureName")%> (<%#: Eval("ProcedureID")%>)</div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
                                <%=GetLabel("Tidak ada informasi pengkodean prosedur tindakan untuk pasien ini") %>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </asp:Panel>
                </dx:PanelContent>
