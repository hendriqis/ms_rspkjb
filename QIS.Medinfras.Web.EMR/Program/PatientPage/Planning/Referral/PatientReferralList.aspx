<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master" AutoEventWireup="true"
    CodeBehind="PatientReferralList.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.PatientReferralList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript">
        $(function () {
            $('#<%=grdView.ClientID %> tr:gt(0):not(.trEmpty)').live('click', function () {
                ...
                $('#<%=hdnFromPhysicianID.ClientID %>').val($(this).find('.FromPhysicianID').html());
            });
    ...
    <input type="hidden" id="hdnFromPhysicianID" runat="server" value="0" />
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="IsReply" HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="IsReply hiddenColumn" />
                                <asp:BoundField DataField="FromPhysicianID" HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="FromPhysicianID hiddenColumn" />
                                ...
                                <asp:BoundField DataField="ReferralTime" HeaderText="Jam" HeaderStyle-Width="50px"
                                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="ReferralType" HeaderText="Jenis Rujukan" HeaderStyle-HorizontalAlign="Left"
                                ...
                                <asp:TemplateField HeaderText="Catatan Medis" HeaderStyle-HorizontalAlign="Left"
                                ...
                                <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <div <%# Eval("IsReply").ToString() == "False" ? "Style='display:none'":"" %>>
                                            <input type="button" id="btnResponse" runat="server" class="btnResponse w3-btn w3-hover-green"
                                                value="Baca Respon" style="height: 35px; width: 100px; background-color: Red;
                                                color: White;" />
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
