<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master" AutoEventWireup="true" 
    CodeBehind="PhysicianTransferEntry.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.PhysicianTransferEntry" %>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <dxe:ASPxComboBox runat="server" ID="cboPhysician2" ClientInstanceName="cboPhysician2" Width="300px">
