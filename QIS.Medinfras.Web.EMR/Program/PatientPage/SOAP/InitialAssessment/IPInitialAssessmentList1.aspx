<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="IPInitialAssessmentList1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.IPInitialAssessmentList1" %>
...
<%--                                <asp:BoundField DataField="cfIsAllowRevision" HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="hiddenColumn isAllowRevision" />--%>
                                ...
                                <asp:BoundField DataField="ObservationTime" HeaderText="Jam " HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center"
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="noteTime" />
                                <asp:BoundField DataField="ParamedicName" HeaderText="Dikaji oleh " HeaderStyle-Width="250px" HeaderStyle-HorizontalAlign="Left"
                                ...
                                <asp:TemplateField HeaderText="Keluhan Pasien" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <div style="height: 130px; overflow-y: auto;">
                                            <%#Eval("ChiefComplaintText").ToString().Replace("\n","<br />")%><br />
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
