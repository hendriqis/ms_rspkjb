<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="ERInitialAssessment3.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.ERInitialAssessment3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        ...
        function onCbpAllergyEndCallback(s) {
            ...
            if (param[0] == '1') {
                ...
                displayErrorMessageBox("Alergi", param[2]);
            }
            else
                $('#<%=grdAllergyView.ClientID %> tr:eq(1)').click();
        }
        ...
        $('#lblAddVitalSign').live('click', function (evt) {
            ...
            var filter = "VisitID = '" + visitID + "' AND GCPatientNoteType = 'X011^002' AND IsDeleted = 0";
                Methods.getObject("GetPatientVisitNoteList", filter, function (result) {
                    if (result != null) {
                        visitNoteID = result.ID;
                    }
                });                      
            var param = "0||" + visitNoteID + "|1|2";
        ...
        function onCbpProcedureEndCallback(s) {
            var param = s.cpResult.split('|');
            if (param[1] == 'refresh') {
                cbpProcedureView.PerformCallback('changepage|1');
            }
            else
                cbpProcedureView.PerformCallback('changepage|1');
        }
        ...
        function onBeforeLoadRightPanelContent(code) {
            ...
            else if (code == 'keteranganSehat' || code == 'keteranganSehat1') {
        ...
        function onBeforeChangePage() {
            if ($('#<%=hdnIsSaved.ClientID %>').val() == '0' && $('#<%=hdnIsChanged.ClientID %>').val() == '1') {
                var message = "Terjadi perubahan terhadap data, tetapi belum disimpan, Apakah dilanjutkan dengan Proses Simpan terlebih dahulu ?";
                displayConfirmationMessageBox("MEDINFRAS", message, function (result) {
                    if (result) {
                        onCustomButtonClick('save');
                        $('#<%=hdnIsChanged.ClientID %>').val('0');
                    }
    ...
    <div>
        ...
        <input type="hidden" id="hdnChiefComplaintParamedicID" value="" runat="server" />
        ...
        <input type="hidden" value="" id="hdnIsHPIShow" runat="server" />
                ...
                <tr>
                    <td style="padding: 5px; vertical-align: top">
                        <table class="tblEntryContent">
                            ...
                            <tr id="trHPI" runat="server" style="display: none">
