<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="ERInitialAssessment1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.ERInitialAssessment1" %>
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        $(function () {
            ...
            $('.btnApplyDiagnosis').click(function () {
                if ((cboDiagnosisType.GetValue() != '' && $('#<%=txtDiagnosisText.ClientID %>').val() != '' && cboDiagnosisStatus.GetValue() != '')) {
        ...
        //#regionHistory of Present Illness
        ...
        //#region Planning Instruction
        $('#lblPlanningInstruction').die('click');
        $('#lblPlanningInstruction').live('click', function () {
        ...
        function onAfterSelectFromInstructionTemplate(param) {
            if (param != '') {
                ...
                var newText = item;
                if ($('#<%=txtPlanningNotes.ClientID %>').val() != "") {
                    newText = $('#<%=txtPlanningNotes.ClientID %>').val() + "\n" + item;
                }               
                $('#<%=txtPlanningNotes.ClientID %>').val(newText);
            }
        }
        //#endregion Planning Instruction
                    ...
                    <td style="vertical-align: top">
                        ...
                        <div class="containerTblEntryContent">
                            <table id="tblNurseAnamnesis" style="width: 100%" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <dxe:ASPxComboBox runat="server" ID="cboAdmissionRoute" ClientInstanceName="cboAdmissionRoute" Width="100%" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdLabel">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <dxe:ASPxComboBox runat="server" ID="cboBreathing" ClientInstanceName="cboBreathing" Width="100%" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="2">
                                        <dxe:ASPxComboBox runat="server" ID="cboCirculation" ClientInstanceName="cboCirculation" Width="100%" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="2">
                                        <dxe:ASPxComboBox runat="server" ID="cboDisability" ClientInstanceName="cboDisability" Width="100%" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="2">
                                        <dxe:ASPxComboBox runat="server" ID="cboExposure" ClientInstanceName="cboExposure" Width="100%" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdLabel">
                                                                    ...
                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                                        <HeaderTemplate>
                                                                            <div>
                                                                                <%=GetLabel("Order Date") %>
                                                                                -
                                                                                <%=GetLabel("Time") %>, <span style="color: blue">
                                                                                    <%=GetLabel("Ordered By") %></span></div>
                                                                            <div style="font-weight: bold">
                                                                                <%=GetLabel("Service Unit") %>,
                                                                                <%=GetLabel("Test Order No.") %>, <span style="font-style: italic">
                                                                                    <%=GetLabel("Charges No.") %></span></div>
                                                                        </HeaderTemplate>
                                                                        <ItemTemplate>
                                                                            <table width="100%">
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="right" <%# Eval("IsEditable").ToString() == "False" ? "Style='display:none'":"" %>>
                                                                                        <div>
                                                                                            <input type="button" class="btnPropose" value="Send Order" /></div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </ItemTemplate>
                        ...
                        <div class="containerTblEntryContent">
                            <table border="0" cellpadding="1" cellspacing="0" width="100%" style="margin-top: 2px">
                                ...
                                <tr>
                                    <td class="tdLabel" valign="top" style="padding-top: 5px;">
                                        <label class="lblNormal lblLink" id="lblPlanningInstruction">
                                                            ...
                                                            <asp:GridView ID="grdProcedureView" runat="server" CssClass="grdSelected grdPatientPage"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <HeaderTemplate>
                                                                            <div style="text-align: right">
                                                                                <span class="lblLink" id="lblAddProcedure">
                                                                                    <%= GetLabel("+ Tambah Procedure")%></span>
                                                                            </div>
                                                                        </HeaderTemplate>
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <div style="margin-left: 300px; margin-top: -3px;" class="createSystem-<%#: DataBinder.Eval(Container.DataItem, "IsCreatedBySystem")%>">
                                                                                <input type="checkbox" disabled="disabled" checked="checked" /><div style="margin-top: -16px;
                                                                                    margin-left: 140px;">
                                                                                    <%=GetLabel("Created By System ")%>
                                                                                </div>
                                                                            </div>
