<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="IPInitialAssessmentEntry1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.IPInitialAssessmentEntry1" %>
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        ...
        $('#lblAddROS').live('click', function (evt) {
            if (UserLoginParamedicIsRegisteredPhysician()) {
                if ($('#<%=hdnPatientVisitNoteID.ClientID %>').val() != "0") {
                    ...
                    var chiefComplaintID = $('#<%=hdnChiefComplaintID.ClientID %>').val();
                    var visitNoteID = $('#<%=hdnPatientVisitNoteID.ClientID %>').val();
                    var param = "|" + visitNoteID + "|1|1||||"+ chiefComplaintID;            
        ...
        $('.imgEditROS.imgLink').live('click', function () {
            if (UserLoginParamedicIsRegisteredPhysician()) {
                ...
                var chiefComplaintID = $('#<%=hdnChiefComplaintID.ClientID %>').val();
                var visitNoteID = $('#<%=hdnPatientVisitNoteID.ClientID %>').val();
                var param = $('#<%=hdnReviewOfSystemID.ClientID %>').val() + "|" + visitNoteID + "|1|1||||"+ chiefComplaintID;        
                openUserControlPopup("~/Program/PatientPage/_PopupEntry/ROSEntry1Ctl.ascx", param, "Pemeriksaan Fisik", 700, 500);
            }
        });
        ...
        function onAfterLookUpSOAPTemplate(value) {
         ...
         function onAfterCustomClickSuccess(type, retval) {
            ...
            $('#<%=hdnChiefComplaintID.ClientID %>').val(result[0]);
            $('#<%=hdnPatientVisitNoteID.ClientID %>').val(result[1]);
        }           
    </script>
    <div>
                                                    ...
                                                    <dx:PanelContent ID="PanelContent1" runat="server">
                                                        <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                                                            <asp:GridView ID="grdVitalSignView" runat="server" CssClass="grdSelected grdPatientPage"
                                                                ...
                                                                <EmptyDataTemplate>
                                                                    <%=GetLabel("Belum ada Pemeriksaan Tanda Vital untuk Asesmen Awal") %>
                                                                    <div style="text-align: center">
