<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="MCUAssessment1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.MCUAssessment1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <style type="text/css">
        ...
        #divOpenShortcutPreviousVisit
        {
            cursor: pointer;
        }
        #divContainerShortcutPreviousVisit
        {
            bottom: 0;
            right: 470px;
            position: fixed;
        ...
        #divContainerShortcutPreviousVisit > div
        {
        ...
        div.containerPreviousVisitUl ul
        {
            margin: 0;
            padding: 0;
            margin-left: 25px;
        }
        div.containerPreviousVisitUl ul:not(:first-child)
        {
            margin-top: 10px;
        }
        div.containerPreviousVisitUl ul li
        {
            list-style-type: none;
            font-size: 12px;
            padding-bottom: 5px;
        }
        div.containerPreviousVisitUl ul li span
        {
            color: #3E3EE3;
        }
        div.containerPreviousVisitUl a
        {
            font-size: 12px;
            color: #3E93E3;
            cursor: pointer;
        ...
        div.containerPreviousVisitUl a:hover
        {
...
//            }
        ...
        function onTxtChiefComplaintChanged(value) {
            ...
            Methods.getObject('GetvPhysicianTextList', filterExpression, function (obj) {
                if (obj != null)
                    if ($('#<%=txtChiefComplaint.ClientID %>').val() != '') {
                        var message = "Ganti catatan di keluhan utama dengan teks dari template ?";
                        showToastConfirmation(message, function (result) {
                            if (result) {
        ...
        function onBeforeLoadRightPanelContent(code) {
            ...
            else if (code == 'healthyinformation' || code == 'medicalSickLeave' || code == 'medicalSickLeaveBilingual') {
                    ...
                    <td style="padding: 5px; vertical-align: top">
                        <table class="tblEntryContent">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtChiefComplaint" runat="server" TextMode="MultiLine" Rows="2"
                                        Width="100%" />
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    ...
                                                    <qis:QISSearchTextBox ID="ledDiagnose" ClientInstanceName="ledDiagnose" runat="server"
                                                        Width="99%" ValueText="DiagnoseID" FilterExpression="IsDeleted = 0" DisplayText="DiagnoseName"
                        ...
                        <div class="containerTblEntryContent">
                            <table id="tblFollowupVisit" style="width: 100%" runat="server">
                                ...
                                <tr>
                                    <td class="tdLabel">
                                        <label class="lblNormal">
                                            <%=GetLabel("Tanggal Kunjungan Berikutnya")%></label>
                                    </td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtFollowupVisitDate" CssClass="datepicker" Width="120px" />
                                    </td>
                                </tr>
                                <tr>
    ...
    <div id="divContainerShortcutPreviousVisit">
        <div>
            <div id="divCloseShortcutPreviousVisit">
                X</div>
            <div id="divOpenShortcutPreviousVisit">
                <b>Kunjungan Sebelumnya : <span style="color: Blue;">
                    <asp:Label ID="lblVisitHistoryInfo" runat="server" Text="dd-MMM-yyyy, Physician Name" /></span></b></div>
            <div id="divVisitDetailInfo" style="margin-top: 5px">
                <b>Diagnosis: <span style="color: Red;">
                    <asp:Label ID="lblPreviousDiagnosis" runat="server" Text="" /></span></b></div>
            <div style="padding: 2px; width: 100%; height: 100%">
                <div class="accordion" id="listInstruction" style="display: none; text-align: left;">
                    ...
                    <div class="containerPreviousVisitUl">
                        <div class="divPreviousVisitContentTitle">
                            <%= GetLabel("KELUHAN UTAMA:")%></div>
                        ...
                        <div class="divPreviousVisitContentTitle" style="margin-top: 10px; margin-bottom: 5px">
                            <%= GetLabel("HPI:")%></div>
                        <div id="divHPI" class="divPreviousVisitContent" runat="server" style="white-space: nowrap;
                            overflow: auto">
                        </div>
                    </div>
                    <a style="font-size: 12px;">
                    ...
                    <a style="font-size: 12px;">
                        <%= GetLabel("PEMERIKSAAN : PENUNJANG MEDIS LAINNYA")%></a>
                    <div class="containerPreviousVisitUl">
                        ...
                        <div id="div1" class="divNotAvailableContent" runat="server">
                            This information is not available</div>
                    </div>
                    <a style="font-size: 12px;">
                    ...
                    <a style="font-size: 12px; display: none">
                        <%= GetLabel("CATATAN TERINTEGRASI")%></a>
                    <div class="containerPreviousVisitUl">
                    ...
                    <a style="font-size: 12px; display: none">
                        <%= GetLabel("DISCHARGE DAN JADWAL KUNJUNGAN BERIKUTNYA")%></a>
                    <div class="containerPreviousVisitUl">
                    ...
                    <div style="padding: 5px;">
                        <table cellpadding="0" cellspacing="10" style="margin-left: auto; margin-right: auto;
                            ...
                            <tr>
                                <td>
                                    <input type="button" value='<%= GetLabel("SOAP COPY")%>' onclick="pcSOAPCopy.Show();"
    ...
    <dx:ASPxPopupControl ID="pcSOAPCopy" runat="server" ClientInstanceName="pcSOAPCopy"
        EnableHierarchyRecreation="True" FooterText="" HeaderText="Copy SOAP From Previous Visit"
        HeaderStyle-HorizontalAlign="Left" Height="250px" Modal="True" PopupHorizontalAlign="WindowCenter"
                                ...
                                <asp:Panel ID="Panel1" Style="width: 100%;" runat="server" Height="200px">
                                        ...
                                        <tr>
                                            <td>
                                                <h4 style="background-color: transparent; color: red; font-weight: bold">
                                                    <%=GetLabel("Please select the option :")%></h4>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px; vertical-align: top">
                                                <table class="tblEntryContent" style="width: 100%">
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox runat="server" ID="chkIsCopyChiefComplaint" Text="Chief Complaint"
                                                                Checked="true" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox runat="server" ID="chkIsCopyHPI" Text="History of Present Illness"
                                                                Checked="true" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox runat="server" ID="chkIsCopyVitalSign" Text="Vital Sign" Checked="true" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox runat="server" ID="chkIsCopyROS" Text="Review of System" Checked="true" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="10" style="margin-left: auto; margin-right: auto;
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="button" value='<%= GetLabel("COPY")%>' onclick="onCopyFromPreviousVisit();"
                                                        style="width: 100px; height: 25px" />
                                                </td>
                                                <td>
                                                    <input type="button" value='<%= GetLabel("CANCEL")%>' onclick="pcSOAPCopy.Hide();"
                                                        style="width: 100px; height: 25px" />
                                                </td>
                                            </tr>
                                        </table>
