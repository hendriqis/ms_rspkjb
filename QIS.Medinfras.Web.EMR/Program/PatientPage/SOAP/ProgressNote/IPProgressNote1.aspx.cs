...
{
    public partial class IPProgressNote1 : BasePagePatientPageListEntry
    {
        ...
        {
            return Constant.MenuCode.EMR.SOAP_TEMPLATE_INPATIENT_PROGRESS_NOTE_1;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            ConsultVisit entityLinkedRegistration = BusinessLayer.GetConsultVisitList(string.Format("RegistrationID = {0} AND IsMainVisit = 1", AppSession.RegisteredPatient.LinkedRegistrationID)).FirstOrDefault();
            int cvLinkedID = 0;
            ...
            filterExpression += string.Format(" AND GCPatientNoteType NOT IN ('{0}','{1}')", Constant.PatientVisitNotes.REGISTRATION_NOTES, Constant.PatientVisitNotes.NURSE_NOTES);
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(txtInstructionSummary, new ControlEntrySetting(true, true, true));
        }
