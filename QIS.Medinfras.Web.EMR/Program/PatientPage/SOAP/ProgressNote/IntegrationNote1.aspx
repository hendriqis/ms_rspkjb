<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageListEntry.master"
    AutoEventWireup="true" CodeBehind="IntegrationNote1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.IntegrationNote1" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlViewType" runat="server">
                    ...
                    <asp:ListItem Text="Need my confirmation Only" Value="4" />
                </asp:DropDownList>
            </td>
        </tr>
    </table>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhScript" runat="server">
    <script id="dxis_nursingNotesBookctl1" src='<%= ResolveUrl("~/Libs/Scripts/jquery/ui/jquery-ui.js")%>' type='text/javascript'></script>
    <script id="dxis_nursingNotesBookctl2" src='<%= ResolveUrl("~/Libs/Scripts/jquery/booklet/jquery.easing.1.3.js")%>' type='text/javascript'></script>
    <script id="dxis_nursingNotesBookctl3" src='<%= ResolveUrl("~/Libs/Scripts/jquery/booklet/jquery.booklet.1.3.1.js")%>' type='text/javascript'></script>
...
//        });
        ...
        function onCbpVerifyAllEndCallback(s) {
            ...
            if (param[0] == '1') {
                if (param[1] != '') {
                    displayMessageBox('VERIFIKASI', param[1]);
                }
                cbpView.PerformCallback('refresh');
            }
            else {
                                        ...
                                        <div>
                                            <table border="0" cellpadding="0" cellspacing="1" width="100%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span style="font-style: italic">: <%#:Eval("cfLastUpdatedDate") %></span>
                                                    </td>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div>
                                            <b><label id="lblParamedicName" class='<%# Eval("cfIsHasSignature1").ToString() == "True" ? "lblLink lblParamedicName": "lblNormal" %>'>
                                                <%#:Eval("cfLastUpdatedByName") %></label></b>                                            
                                        </div>
