<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageListEntry.master" AutoEventWireup="true" 
    CodeBehind="ERProgressAssessment1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.ERProgressAssessment1" %>
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent">
                    ...
                    <tr>
                        <td class="tdLabel" style="font-weight:bold; margin-bottom:10px; vertical-align:top"><label class="lblNormal"><%=GetLabel("Subjective")%></label></td>
                        <td colspan="2"><asp:TextBox ID="txtSubjectiveText" Width="100%" runat="server" TextMode="MultiLine" Rows="6" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel" valign="top">
                            <table border="0" cellpadding="0" cellspacing="1">
                                <tr>
                                    <td colspan="3"><label id="lblObjective" class="lblMandatory" style="font-weight:bold; margin-bottom:10px"><%=GetLabel("Objective")%></label></td>
                                </tr>
                                <tr>
                                    <td style="width:50px;display:none"><label class="lblNormal"><%=GetLabel("TTV")%></label></td>
                                    <td style="display:none"><img class="imgLink" id="btnLookupVitalSign" title='<%=GetLabel("Select")%>' src='<%= ResolveUrl("~/Libs/Images/button/search.png")%>' alt="" /></td>
                                    <td style="display:none"><img class="imgLink" id="btnAddVitalSign" title='<%=GetLabel("Add")%>' src='<%= ResolveUrl("~/Libs/Images/button/vitalsign.png")%>' alt="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:50px;display:none"><label class="lblNormal"><%=GetLabel("ROS")%></label></td>
                                    <td style="display:none"><img class="btnAddROS imgLink" title='<%=GetLabel("Add")%>' src='<%= ResolveUrl("~/Libs/Images/status/done.png")%>' alt="" /></td>
                                    <td style="display:none"><img class="btnLookupROS imgLink" title='<%=GetLabel("Select")%>' src='<%= ResolveUrl("~/Libs/Images/button/search.png")%>' alt="" /></td>
                                </tr>
                            </table>
                        </td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="tdLabel" valign="top">
                            <table border="0" cellpadding="0" cellspacing="1">
                                <tr>
                                    <td colspan="3"><label class="lblMandatory" style="font-weight:bold; margin-bottom:10px"><%=GetLabel("Planning")%></label></td>
                                </tr>
                                <tr style="display:none">
                                    <td style="width:50px"><label class="lblNormal"><%=GetLabel("LAB")%></label></td>
                                    <td><img class="btnAddLabOrder imgLink" title='<%=GetLabel("Apply")%>' src='<%= ResolveUrl("~/Libs/Images/status/done.png")%>' alt="" /></td>
                                    <td><img class="btnLookupLabOrder imgLink" title='<%=GetLabel("Cancel")%>' src='<%= ResolveUrl("~/Libs/Images/status/cancel.png")%>' alt="" /></td>
                                </tr>
                                <tr style="display:none">
                                    <td style="width:50px"><label class="lblNormal"><%=GetLabel("IMG")%></label></td>
                                    <td><img class="btnAddImagingOrder imgLink" title='<%=GetLabel("Apply")%>' src='<%= ResolveUrl("~/Libs/Images/status/done.png")%>' alt="" /></td>
                                    <td><img class="btnLookupImagingOrder imgLink" title='<%=GetLabel("Cancel")%>' src='<%= ResolveUrl("~/Libs/Images/status/cancel.png")%>' alt="" /></td>
                                </tr>
                            </table>
                        </td>
                        <td colspan="2">
