<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master" ValidateRequest="false" 
    AutoEventWireup="true" CodeBehind="PopulationAssessmentForm.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.PopulationAssessmentForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <input type="hidden" runat="server" id="hdnPagePatientDOB" value="" />
    <input type="hidden" runat="server" id="hdnPageRegistrationNo" value="" />
                                ...
                                <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ParamedicName" HeaderText = "Dikaji Oleh" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                ...
                                                <ItemTemplate>
                                                    <div>
                                                        <a class="lnkView" recordid="<%#:Eval("AssessmentID") %>"
                                                            ...
                                                            paramedicName="<%#:Eval("ParamedicName") %>" isInitialAssessment="<%#:Eval("IsInitialAssessment") %>">View</a>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
