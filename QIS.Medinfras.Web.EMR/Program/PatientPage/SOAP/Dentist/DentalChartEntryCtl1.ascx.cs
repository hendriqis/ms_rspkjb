...
{
    public partial class DentalChartEntryCtl1 : BasePagePatientPageEntryCtl
    {
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            //SetControlEntrySetting(ddeToothSurfaces, new ControlEntrySetting(true, true, false));
            SetControlEntrySetting(cboCurrentStatus, new ControlEntrySetting(true, true, true));
            //SetControlEntrySetting(ledProcedure, new ControlEntrySetting(true, true, true));
