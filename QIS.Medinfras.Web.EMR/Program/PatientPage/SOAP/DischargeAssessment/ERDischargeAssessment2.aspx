<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master" AutoEventWireup="true"
    CodeBehind="ERDischargeAssessment2.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.ERDischargeAssessment2" %>
                ...
                <td style="vertical-align: top;">
                    <table id="tblDischarge" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblMandatory">
                                    <%=GetLabel("Patient Outcome")%></label>
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblMandatory">
                                    <%=GetLabel("Discharge Routine")%></label>
                            </td>
                            <td colspan="3">
                        ...
                        <tr class="trInpatientPhysician" style="display: none">
                            <td class="tdLabel">
                                <label class="lblNormal lblLink" id="lblParamedic2">
                                    <%=GetLabel("Registered Physician")%></label>
                            </td>
                            <td colspan="4">
