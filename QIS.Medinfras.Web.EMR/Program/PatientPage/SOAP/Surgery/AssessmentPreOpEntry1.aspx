<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="AssessmentPreOpEntry1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.AssessmentPreOpEntry1" %>
                    ...
                    <td style="vertical-align:top">
                        ...
                        <div id="divPage2" class="w3-border divPageNavPanelContent w3-animate-left" style="display:none"> 
                            <table class="tblEntryContent" border="0" cellpadding="1" cellspacing="0" width="100%" style="margin-top: 5px">
                                ...
                                <tr>
                                    <td class="tdLabel" valign="top" style="padding-top: 5px;">
                                        <%=GetLabel("Riwayat Operasi Sebelumnya") %>
                                    </td>
                                    <td>
