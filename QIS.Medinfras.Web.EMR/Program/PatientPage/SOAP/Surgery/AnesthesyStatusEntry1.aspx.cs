...
{
    public partial class AnesthesyStatusEntry1 : BasePagePatientPageList
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            //Helper.SetControlEntrySetting(txtAssessmentDate, new ControlEntrySetting(true, false, true), "mpPatientStatus");
            //Helper.SetControlEntrySetting(txtAssessmentTime, new ControlEntrySetting(true, false, true), "mpPatientStatus");
            //Helper.SetControlEntrySetting(txtStartAnesthesyDate, new ControlEntrySetting(true, false, true), "mpPatientStatus");
            //Helper.SetControlEntrySetting(txtStartAnesthesyTime, new ControlEntrySetting(true, false, true), "mpPatientStatus");
            //Helper.SetControlEntrySetting(txtStopSurgeryDate, new ControlEntrySetting(true, false, true), "mpPatientStatus");
            //Helper.SetControlEntrySetting(txtStopSurgeryTime, new ControlEntrySetting(true, false, true), "mpPatientStatus");                
            //Helper.SetControlEntrySetting(txtStopAnesthesyDate, new ControlEntrySetting(true, false, true), "mpPatientStatus");
            //Helper.SetControlEntrySetting(txtStopAnesthesyTime, new ControlEntrySetting(true, false, true), "mpPatientStatus");                
            //Helper.SetControlEntrySetting(txtAnesthesyDuration, new ControlEntrySetting(true, false, true), "mpPatientStatus");
            //Helper.SetControlEntrySetting(txtDuration, new ControlEntrySetting(true, false, true), "mpPatientStatus");                
        ...
        private void SetEntityToControl()
        {
            ...
            vPreSurgeryAssessment obj1 = BusinessLayer.GetvPreSurgeryAssessmentList(string.Format("TestOrderID  = {0} AND IsDeleted = 0", hdnTestOrderID.Value)).FirstOrDefault();
            if (obj1 != null)
            {
            ...
            vPreAnesthesyAssessment objPreAnesthesy = BusinessLayer.GetvPreAnesthesyAssessmentList(string.Format("TestOrderID  = {0} AND IsDeleted = 0", hdnTestOrderID.Value)).FirstOrDefault();
            ...
            List<vTestOrderDtProcedureGroup> lstProcedure = BusinessLayer.GetvTestOrderDtProcedureGroupList(string.Format("TestOrderID = {0} AND IsDeleted = 0", hdnTestOrderID.Value));
            ...
            string filterExpression = string.Format("TestOrderID = {0} AND GCOrderStatus NOT IN ('{1}','{2}')", hdnTestOrderID.Value, Constant.OrderStatus.OPEN, Constant.OrderStatus.CANCELLED);
            vSurgeryTestOrderHd1 objOrder = BusinessLayer.GetvSurgeryTestOrderHd1List(filterExpression).FirstOrDefault();
            if (objOrder != null)
            {
                txtStartDate.Text = objOrder.ScheduledDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
                txtStartTime.Text = objOrder.ScheduledTime;
                txtDuration.Text = objOrder.EstimatedDuration.ToString();
                txtStartAnesthesyDate.Text = objOrder.ScheduledDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
                txtStartAnesthesyTime.Text = objOrder.ScheduledTime;
                txtStartIncisionDate.Text = objOrder.ScheduledDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
                txtStartIncisionTime.Text = objOrder.ScheduledTime;
            }

            vSurgeryAnesthesyStatus obj = BusinessLayer.GetvSurgeryAnesthesyStatusList(string.Format("TestOrderID = {0} AND IsDeleted = 0", hdnTestOrderID.Value)).FirstOrDefault();
            if (obj != null)
            {
            ...
            else
            {
                if (objOrder != null)
                {
                    txtStartAnesthesyDate.Text = objOrder.ScheduledDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
                    txtStartAnesthesyTime.Text = objOrder.ScheduledTime;
                    txtPremedicationDate.Text = objOrder.ScheduledDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
                    txtPremedicationTime.Text = objOrder.ScheduledTime;
                }
    ...
    Constant.StandardCode.ALLERGEN_TYPE, Constant.StandardCode.REGIONAL_ANESTHESIA_TYPE);
        ...
        protected override bool OnCustomButtonClick(string type, ref string message)
        {
            if (type == "save")
            {
                ...
                try
                {
                    SurgeryAnesthesyStatus obj = BusinessLayer.GetSurgeryAnesthesyStatusList(string.Format("VisitID = {0} AND TestOrderID = {1} AND IsDeleted = 0", AppSession.RegisteredPatient.VisitID, hdnTestOrderID.Value), ctx).FirstOrDefault();
                    if (obj != null)
