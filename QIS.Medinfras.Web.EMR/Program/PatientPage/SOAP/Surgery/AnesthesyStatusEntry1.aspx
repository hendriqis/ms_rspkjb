<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="AnesthesyStatusEntry1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.AnesthesyStatusEntry1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript" id="dxss_anesthesyStatus1">
        $(function () {
            ...
            $('#<%=txtStartFastingDate.ClientID %>').datepicker('option', 'maxDate', new Date(getDateNow()));

            setDatePicker('<%=txtStartAnesthesyDate.ClientID %>');
            $('#<%=txtStartAnesthesyDate.ClientID %>').datepicker('option', 'maxDate', new Date(getDateNow()));
    ...
    $('#<%=txtStartTime.ClientID %>').die('change');
    ...
    $('#<%=txtStartAnesthesyTime.ClientID %>').die('change');
    $('#<%=txtStartAnesthesyTime.ClientID %>').live('change', function () {
        var duration = parseInt($('#<%=txtAnesthesyDuration.ClientID %>').val());
        if (duration < 0) {
            $('#<%=txtAnesthesyDuration.ClientID %>').val("0");
        };
                    ...
                    <td style="vertical-align:top">
                        ...
                        <div id="divPage10" class="w3-border divPageNavPanelContent w3-animate-left formContainer" style="display:none">
                            <table class="tblContentArea">
                                ...
                                <tr>
                                    <td colspan="2" style="vertical-align:top">
                                        <div id="divFormContent6" runat="server" style="height: 480px;overflow-y: auto; overflow-x: auto;"></div>
                                    </td>
                                </tr>
                            </table>
                        </div>
