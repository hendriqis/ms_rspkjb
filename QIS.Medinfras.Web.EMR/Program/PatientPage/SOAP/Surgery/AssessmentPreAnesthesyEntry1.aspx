<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="AssessmentPreAnesthesyEntry1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.AssessmentPreAnesthesyEntry1" %>
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        ...
        $('#lblAddVitalSign').live('click', function (evt) {
            ...
            if (assessmentID != '0') {
                ...
                var param = "0|0|0|0|0|0|0|0|" + assessmentID + "|0|";
