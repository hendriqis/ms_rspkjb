<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="OPGeneralAssessment2.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.OPGeneralAssessment2" %>
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        ...
        function onTxtSubjectiveTextChanged(value) {
            if (value == 'OMD;' || value == 'omd;') {
                $('#<%:txtSubjectiveText.ClientID %>').val("Oesophagus Maag Duodenum");
            }
            else if (value == 'lab1;') {
                $('#<%:txtSubjectiveText.ClientID %>').val("Kontrol konsultasi hasil laboratorik. Batuk sudah sembuh. Sumer2 tinggal sedikit.");
            } 
            else if (value == 'j20;') {
                $('#<%:txtSubjectiveText.ClientID %>').val("Pilek beringus, dada panas. Kepala bagian belakang dan leher belakang panas. Nyeri telan dan panas. Batuk sedikit, tak berdahak. BAK : panas. BAB : tak murus. Badan panas.");
            }            
        }
        ...
        $('.imgAddDiagnosticOrderDt.imgLink').live('click', function () {
            ...
            var param = "X001^006|" + $('#<%=hdnTestOrderHealthcareServiceUnitID.ClientID %>').val() + "|"+ $('#<%=hdnDiagnosticTestOrderID.ClientID %>').val();
                ...
                <tr>
                    <td style="padding: 5px; vertical-align: top">
                        <table class="tblEntryContent">
                            ...
                            <tr>
                                <td class="tdLabel" valign="top">
                                    <label class="lblMandatory" id = "lblCCLink" style="font-weight:bold">
                            ...
                            <tr>
                                <td class="tdLabel" valign="top">
                                    <label class="lblNormal" id = "lblObjective" style="font-weight:bold">
                            ...
                            <tr>
                                <td class="tdLabel" valign="top">
                                    <label class="lblNormal" id = "lblAssessmentLink" style="font-weight:bold">
                            ...
                            <tr>
                                <td class="tdLabel" valign="top">
                                    <label class="lblNormal" id = "lblPlanningLink" style="font-weight:bold">
                    ...
                    <td style="vertical-align: top">
                        <h4 class="h4expanded">
                            ...
                            <b><span style="color:Red;"><asp:Label ID="lblVisitHistoryInfo" runat="server" Text=" : dd-MMM-yyyy, Physician Name" /></span></b>
                        </h4>
                        ...
                        <h4 class="h4collapsed">
                            <%=GetLabel("Jenis Kunjungan dan Rujukan Dari")%></h4>
                        <div class="containerTblEntryContent">
