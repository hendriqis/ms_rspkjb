<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="OPAssessment4.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.OPAssessment4" %>
...
//                        openUserControlPopup(url, '', 'Doctor Fee Entry', 800, 600);
            ...
            $('#<%=grdObstetricHistory.ClientID %> tr:gt(0):not(.trEmpty)').live('click', function () {
                $('#<%=grdObstetricHistory.ClientID %> tr.selected').removeClass('selected');
                $(this).addClass('selected');
                $('#<%=hdnObstetricHistoryID.ClientID %>').val($(this).find('.keyField').html());
            });
            $('#<%=grdObstetricHistory.ClientID %> tr:eq(1)').click();

            $('#<%=grdAntenatalRecord.ClientID %> tr:gt(0):not(.trEmpty)').live('click', function () {
                $('#<%=grdAntenatalRecord.ClientID %> tr.selected').removeClass('selected');
                $(this).addClass('selected');
                $('#<%=hdnAntenatalRecordID.ClientID %>').val($(this).find('.keyField').html());
            });
            $('#<%=grdAntenatalRecord.ClientID %> tr:eq(1)').click();
...
//////            location.reload(true);
        ...
        //region Obstetric History Paging
        var pageCount = parseInt('<%=gridObstetricHistoryPageCount %>');
        $(function () {
            setPaging($("#ObstetricHistoryPagging"), pageCount, function (page) {
                cbpObstetricHistory.PerformCallback('changepage|' + page);
            });
        });

        $('#lblAddObstetricHistory').die('click');
        $('#lblAddObstetricHistory').live('click', function (evt) {
            onBeforeOpenTrxPopup();                
            var param = "";
            openUserControlPopup("~/Libs/Program/Module/PatientManagement/TransactionPage/Assessment/Obsgyn/ObstetricHistoryEntryCtl.ascx", param, "Riwayat Persalinan", 680, 500);
        });

        $('.imgEditObstetricHistory.imgLink').die('click');
        $('.imgEditObstetricHistory.imgLink').live('click', function () {
            onBeforeOpenTrxPopup();
            $row = $(this).closest('tr').parent().closest('tr');
            var obj = rowToObject($row);
            $('#<%=hdnObstetricHistoryID.ClientID %>').val(obj.ID);
            openUserControlPopup("~/Libs/Program/Module/PatientManagement/TransactionPage/Assessment/Obsgyn/ObstetricHistoryEntryCtl.ascx", $('#<%=hdnObstetricHistoryID.ClientID %>').val(), "Riwayat Persalinan", 680, 500);
        });

        $('.imgDeleteObstetricHistory.imgLink').die('click');
        $('.imgDeleteObstetricHistory.imgLink').live('click', function () {
            var message = "Are you sure to delete this Obstetric History record ?";
            showToastConfirmation(message, function (result) {
                if (result) {
                    cbpDeleteObstetricHistory.PerformCallback();
                }
            });
        });

        function onCbpObstetricHistoryEndCallback(s) {
        ...
        function onCbpDeleteObstetricHistoryEndCallback(s) {
            var param = s.cpResult.split('|');
            if (param[0] == '1') {
                cbpObstetricHistory.PerformCallback('refresh');
            }
            else {
        ...
        function onAfterSaveRecordPatientPageEntry() {
            cbpObstetricHistory.PerformCallback('refresh');
            cbpAntenatalRecord.PerformCallback('refresh');
        }
        //#endregion

        //region Antenatal Record Paging
        var pageCount = parseInt('<%=gridAntenatalRecordPageCount %>');
        $(function () {
            setPaging($("#antenatalPaging"), pageCount, function (page) {
                cbpAntenatalRecord.PerformCallback('changepage|' + page);
            });
        });

        $('#lblAddAntenatalRecord').die('click');
        $('#lblAddAntenatalRecord').live('click', function (evt) {
            onBeforeOpenTrxPopup();                
            var param = "antenatalForm01";
            openUserControlPopup("~/Libs/Program/Module/PatientManagement/TransactionPage/Assessment/MedicalForm/AntenatalRecordFormEntry.ascx", param, "Antenatal Record", 680, 500);
        });

        $('.imgEditAntenatalRecord.imgLink').die('click');
        $('.imgEditAntenatalRecord.imgLink').live('click', function () {
            onBeforeOpenTrxPopup();
            $row = $(this).closest('tr').parent().closest('tr');
            var obj = rowToObject($row);
            $('#<%=hdnAntenatalRecordID.ClientID %>').val(obj.ID);
            var param = "antenatalForm01|" + $('#<%=hdnAntenatalRecordID.ClientID %>').val();
            openUserControlPopup("~/Libs/Program/Module/PatientManagement/TransactionPage/Assessment/MedicalForm/AntenatalRecordFormEntry.ascx", param, "Antenatal Record", 680, 500);
        });

        $('.imgDeleteAntenatalRecord.imgLink').die('click');
        $('.imgDeleteAntenatalRecord.imgLink').live('click', function () {
            var message = "Are you sure to delete this Obstetric History record ?";
            showToastConfirmation(message, function (result) {
                if (result) {
                    cbpDeleteAntenatalRecord.PerformCallback();
                }
            });
        });
        ...
        $('.imgViewHistoryAntenatalRecord.imgLink').live('click', function () {
            ...
            var obj = rowToObject($row);
            $('#<%=hdnAntenatalRecordID.ClientID %>').val(obj.ID);
            var param = $('#<%=hdnAntenatalRecordID.ClientID %>').val();
        ...
        function onCbpAntenatalRecordEndCallback(s) {
            $('#containerImgLoadingView').hide();            
            var hdnPregAge = $('#<%=hdnPregAge.ClientID %>').val();
            if(hdnPregAge != '' && hdnPregAge != '0') {
                $('#<%=txtPregancyAge.ClientID %>').val(hdnPregAge + " Weeks");        
            }
            else {
                $('#<%=txtPregancyAge.ClientID %>').val("");                    
            }
        ...
        function onCbpDeleteAntenatalRecordEndCallback(s) {
            var param = s.cpResult.split('|');
            if (param[0] == '1') {
                cbpAntenatalRecord.PerformCallback('refresh');
            }
    ...
    <div>
        ...
        <input type="hidden" value="" id="hdnObstetricHistoryID" runat="server" />             
            ...
            <table class="tblContentArea">
                ...
                <tr>
                    <td style="padding: 5px; vertical-align: top">
                        <table class="tblEntryContent">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPregancyAge" runat="server" Width="20%" ReadOnly="true" />
                                </td>
                            </tr>
                            <tr>
                                <td class="tdLabel" valign="top">
                    ...
                    <td style="vertical-align: top">
                        ...
                        <h4 class="h4expanded">
                        <%=GetLabel("Riwayat Persalinan")%></h4>
                        <div class="containerTblEntryContent">
                            <table border="0" cellpadding="1" cellspacing="0" width="100%" style="margin-top: 5px">
                                ...
                                <td colspan="2">                                 
                                    <div style="text-align: right">
                                        <span class="lblLink" id="lblAddObstetricHistory">
                                            <%= GetLabel("+ Tambah Riwayat Persalinan")%></span>
                                    </div>
                                </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div>
                                            <dxcp:ASPxCallbackPanel ID="cbpObstetricHistory" runat="server" Width="100%" ClientInstanceName="cbpObstetricHistory"
                                                ShowLoadingPanel="false" OnCallback="cbpObstetricHistory_Callback">
                                                <ClientSideEvents EndCallback="function(s,e){ onCbpObstetricHistoryEndCallback(s); }" />
                                                <PanelCollection>
                                                    <dx:PanelContent ID="PanelContent2" runat="server">
                                                        <asp:Panel runat="server" ID="Panel9" CssClass="pnlContainerGridPatientPage">
                                                            <asp:GridView ID="grdObstetricHistory" runat="server" CssClass="grdSelected grdPatientPage"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="20px">
                                                                        <ItemTemplate>
                                                                            <table cellpadding="0" cellspacing="0">
                                                                                <tr>
                                                                                    <td>
                                                                                        <img class="imgEditObstetricHistory imgLink" title='<%=GetLabel("Edit")%>' src='<%# ResolveUrl("~/Libs/Images/Button/edit.png")%>'
                                                                                            alt="" />
                                                                                    </td>
                                                                                    <td style="width: 1px">
                                                                                        &nbsp;
                                                                                    ...
                                                                                    <td>
                                                                                        <img class="imgDeleteObstetricHistory imgLink" title='<%=GetLabel("Delete")%>' src='<%# ResolveUrl("~/Libs/Images/Button/delete.png")%>'
                                                                                            alt="" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                    ...
                                                                    <asp:BoundField DataField="PregnancyNo" HeaderText="Hamil Ke-" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                                                    <asp:BoundField DataField="PregnancyDuration" HeaderText="Usia Kehamilan (Minggu)" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left"/>
                                                                    <asp:BoundField DataField="BirthMethod" HeaderText="Jenis Persalinan" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField DataField="CaesarMethod" HeaderText="Tipe Caesar" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField DataField="BornCondition" HeaderText="Kondisi Persalinan" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField DataField="ParamedicType" HeaderText="Penolong Persalinan" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left"/>
                                                                    <asp:BoundField DataField="Weight" HeaderText="BBL (gram)" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                                                    <asp:BoundField DataField="Length" HeaderText="PBL (cm)" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                                                    <asp:BoundField DataField="CreatedByName" HeaderText="Dientry Oleh" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField DataField="LastUpdatedByName" HeaderText="Terakhir Update" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                                </Columns>
                                                                <EmptyDataTemplate>
                                            ...
                                            <div class="containerPaging">
                                                <div class="wrapperPaging">
                                                    <div id="ObstetricHistoryPagging">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="containerTblEntryContent">
                            <table border="0" cellpadding="1" cellspacing="0" width="100%" style="margin-top: 5px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div>
                                            <dxcp:ASPxCallbackPanel ID="cbpAntenatalRecord" runat="server" Width="100%" ClientInstanceName="cbpAntenatalRecord"
                                                ShowLoadingPanel="false" OnCallback="cbpAntenatalRecord_Callback">
                                                <ClientSideEvents EndCallback="function(s,e){ onCbpAntenatalRecordEndCallback(s); }" />
                                                <PanelCollection>
                                                    <dx:PanelContent ID="PanelContent10" runat="server">
                                                        <asp:Panel runat="server" ID="Panel10" CssClass="pnlContainerGridPatientPage">
                                                            <input type="hidden" runat="server" id="hdnPregAge" value="" />
                                                         <asp:GridView ID="grdAntenatalRecord" runat="server" CssClass="grdSelected grdPatientPage"
                                                                AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                                                <Columns>
                                                                    <asp:BoundField DataField="ID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="20px">
                                                                        <ItemTemplate>
                                                                            <table cellpadding="0" cellspacing="0">
                                                                                <tr>
                                                                                    <td>
                                                                                        <img class="imgEditAntenatalRecord imgLink" title='<%=GetLabel("Edit")%>' src='<%# ResolveUrl("~/Libs/Images/Button/edit.png")%>'
                                                                                            alt="" />
                                                                                    </td>
                                                                                    <td style="width: 1px">
                                                                                        &nbsp;
                                                                                    ...
                                                                                    <td>
                                                                                        <img class="imgDeleteAntenatalRecord imgLink" title='<%=GetLabel("Delete")%>' src='<%# ResolveUrl("~/Libs/Images/Button/delete.png")%>'
                                                                                            alt="" />
                                                                                    </td>
                                                                                    <td style="width: 1px">
                                                                                        &nbsp;
                                                                                    ...
                                                                                    <td>
                                                                                        <img class="imgViewHistoryAntenatalRecord imgLink" title='<%=GetLabel("History")%>' src='<%# ResolveUrl("~/Libs/Images/Button/list.png")%>'
                                                                                            alt="" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                    ...
                                                                    <asp:BoundField DataField="PregnancyNo" HeaderText="Kehamilan Ke-" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Left" />
                                                                    
                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="LMP" HeaderStyle-Width="150px" ItemStyle-Width="150px">
                                                                        <ItemTemplate>
                                                                            <div>
                                                                                <%#: Eval("cfLMP")%>
                                                                                <BR>
                                                                                <%#: Eval("LMPPeriod")%> (<%#: Eval("LMPDays")%> Days)
                                                                            </div>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="cfEDB" HeaderText="EDB" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                                                                    <asp:BoundField DataField="Gravida" HeaderText="Gravida" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="60px"/>
                                                                    <asp:BoundField DataField="Para" HeaderText="Para" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="60px"/>
                                                                    <asp:BoundField DataField="Abortion" HeaderText="Abortion" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="60px"/>
                                                                    <asp:BoundField DataField="Life" HeaderText="Life" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="60px"/>
                                                                </Columns>
                                                                <EmptyDataTemplate>
                                                                    <%=GetLabel("Belum ada data") %>
                                                                    <br />
                                                                    <span class="lblLink" id="lblAddAntenatalRecord">
                                                                        <%= GetLabel("+ Tambah Antenatal Record")%></span>
                                                                        <br />
                                                                </EmptyDataTemplate>
                                                            </asp:GridView>
                                                        </asp:Panel>
        ...
        <div style="display: none">
            <dxcp:ASPxCallbackPanel ID="cbpDeleteObstetricHistory" runat="server" Width="100%" ClientInstanceName="cbpDeleteObstetricHistory"
                ShowLoadingPanel="false" OnCallback="cbpDeleteObstetricHistory_Callback">
                <ClientSideEvents EndCallback="function(s,e){ onCbpDeleteObstetricHistoryEndCallback(s); }" />
            </dxcp:ASPxCallbackPanel>
        </div>
        <div style="display: none">
            <dxcp:ASPxCallbackPanel ID="cbpDeleteAntenatalRecord" runat="server" Width="100%" ClientInstanceName="cbpDeleteAntenatalRecord"
                ShowLoadingPanel="false" OnCallback="cbpDeleteAntenatalRecord_Callback">
                <ClientSideEvents EndCallback="function(s,e){ onCbpDeleteAntenatalRecordEndCallback(s); }" />
            </dxcp:ASPxCallbackPanel>
        </div>
        <div style="display: none">
