...
{
    public partial class OPAssessment4 : BasePagePatientPageList
    {
        ...
        protected int gridObstetricHistoryPageCount = 1;
        protected int gridAntenatalRecordPageCount = 1;
        ...
        {
            return Constant.MenuCode.EMR.OUTPATIENT_SOAP_OBGYN_ASSESSMENT;
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            {
                string pregancyAge = BusinessLayer.GetPregancyAge(entityVisit.VisitID).FirstOrDefault().PregancyAge.ToString();
                if(pregancyAge != "0") 
                {
                    txtPregancyAge.Text = string.Format("{0} Weeks", pregancyAge);
                }
                ...
                BindGridViewObstetricHistory(1, true, ref gridObstetricHistoryPageCount);
                BindGridViewAntenatalRecord(1, true, ref gridAntenatalRecordPageCount);
        ...
        private void SetSettingParameter()
        {
            ...
            string FilterExpressionDt = string.Format("HealthcareID = '{0}' AND ParameterCode IN ('{1}','{2}','{3}','{4}','{5}')",
        ...
        #region ObstetricHistory
        protected void cbpObstetricHistory_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            int pageCount = 1;
            string result = "";
            if (e.Parameter != null && e.Parameter != "")
            {
                ...
                if (param[0] == "changepage")
                {
                    BindGridViewObstetricHistory(Convert.ToInt32(param[1]), false, ref pageCount);
                    result = "changepage";
                }
                else // refresh
                {
                    BindGridViewObstetricHistory(1, true, ref pageCount);
                    result = "refresh|" + pageCount;
                }
                ASPxCallbackPanel panel = sender as ASPxCallbackPanel;
                panel.JSProperties["cpResult"] = result;
        ...
        protected void cbpDeleteObstetricHistory_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            string result = "1|";

            if (hdnObstetricHistoryID.Value != "")
            {
                ObstetricHistory entity = BusinessLayer.GetObstetricHistory(Convert.ToInt32(hdnObstetricHistoryID.Value));
                entity.IsDeleted = true;
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
        ...
        private void BindGridViewObstetricHistory(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            grdObstetricHistory.DataSource = lstEntity;
            grdObstetricHistory.DataBind();
        }
        #endregion

        #region AntenatalRecord
        protected void cbpAntenatalRecord_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            int pageCount = 1;
            string result = "";
            if (e.Parameter != null && e.Parameter != "")
            {
                ...
                if (param[0] == "changepage")
                {
                    BindGridViewAntenatalRecord(Convert.ToInt32(param[1]), false, ref pageCount);
                    result = "changepage";
                }
                else // refresh
                {
                    BindGridViewAntenatalRecord(1, true, ref pageCount);
                    result = "refresh|" + pageCount;
                }

                hdnPregAge.Value = BusinessLayer.GetPregancyAge(AppSession.RegisteredPatient.VisitID).FirstOrDefault().PregancyAge.ToString();
        ...
        protected void cbpDeleteAntenatalRecord_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            string result = "1|";

            if (hdnAntenatalRecordID.Value != "")
            {
                Antenatal entity = BusinessLayer.GetAntenatal(Convert.ToInt32(hdnAntenatalRecordID.Value));
                entity.IsDeleted = true;
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
        ...
        private void BindGridViewAntenatalRecord(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            string filterExpression = string.Format("MRN = {0} AND IsDeleted = 0 AND IsBorn = 0", AppSession.RegisteredPatient.MRN, Constant.FileType.IMAGE);
            ...
            List<vAntenatalRecord> lstEntity = BusinessLayer.GetvAntenatalRecordList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "ID DESC");
            grdAntenatalRecord.DataSource = lstEntity;
            grdAntenatalRecord.DataBind();
        }
        #endregion
