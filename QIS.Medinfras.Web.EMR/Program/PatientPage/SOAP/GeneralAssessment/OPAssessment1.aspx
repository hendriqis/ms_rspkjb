<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPPatientPageList.master"
    AutoEventWireup="true" CodeBehind="OPAssessment1.aspx.cs" Inherits="QIS.Medinfras.Web.EMR.Program.OPAssessment1" %>
...
//////            location.reload(true);
        ...
        $('#lblAddFromReviewOfSystemLookup').die('click');
        $('#lblAddFromReviewOfSystemLookup').live('click', function (evt) {
            onBeforeOpenTrxPopup();
            var chiefComplaintID = $('#<%=hdnChiefComplaintID.ClientID %>').val();
            var visitNoteID = $('#<%=hdnPatientVisitNoteID.ClientID %>').val();
            var param = "0|" + visitNoteID + "|1|1|" + chiefComplaintID + "|";
                                        ...
                                        <td>
                                            <table border="0" cellpadding="1" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="lblNormal" id="lblAllergenName" runat="server">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                                        <HeaderTemplate>
                                                                            ...
                                                                            <div style="text-align: right">
                                                                                <span class="lblLink" id="lblAddFromReviewOfSystemLookup">
