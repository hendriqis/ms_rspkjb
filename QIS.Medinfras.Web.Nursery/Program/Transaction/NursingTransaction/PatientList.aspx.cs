...
{
    public partial class PatientList : BasePageContent
    {
        ...
        private string GetResponseRedirectUrl(vConsultVisit entity)
        {
            ...
            url = string.Format("~/Program/Transaction/NursingTransaction/NursingTransactionEntry.aspx?id={1}|{0}", entity.VisitID, id);
            return url;
        }
