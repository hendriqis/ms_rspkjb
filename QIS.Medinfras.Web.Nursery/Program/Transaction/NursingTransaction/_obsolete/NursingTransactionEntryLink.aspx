<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true" 
    CodeBehind="NursingTransactionEntryLink.aspx.cs" Inherits="QIS.Medinfras.Web.Nursing.Program.NursingTransactionEntryLink" %>

<%@ Register Src="~/Libs/Controls/PatientBannerCtl.ascx" TagName="PatientBannerCtl" TagPrefix="uc1" %>
<%@ Register Src="~/Program/Transaction/NursingTransaction/NursingTransactionEntryDiagnosisItemCtlLink.ascx" TagName="DiagnoseItemCtl" TagPrefix="uc1" %>
<%@ Register Src="~/Program/Transaction/NursingTransaction/NursingTransactionEntryInterventionCtlLink.ascx" TagName="InterventionCtl" TagPrefix="uc1" %>
<%@ Register Src="~/Program/Transaction/NursingTransaction/NursingTransactionEntryOutcomeCtlLink.ascx" TagName="OutcomeCtl" TagPrefix="uc1" %>
<%@ Register Src="~/Program/Transaction/NursingTransaction/NursingTransactionEntryImplementationCtlLink.ascx" TagName="ImplementationCtl" TagPrefix="uc1" %>
<%@ Register Src="~/Program/Transaction/NursingTransaction/NursingTransactionEntryEvaluationCtlLink.ascx" TagName="EvaluationCtl" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    ...
    <div style="height:435px;overflow-y:auto;">
        <div class="pageTitle">
            <div style="font-size: 1.1em"><%=GetLabel("Transaksi Keperawatan")%></div>
        </div>
            ...
            <tr>
                <td style="padding:5px;vertical-align:top">
                    <table class="tblEntryContent" style="width:100%">
                        ...
                        <tr>
                            <td class="tdLabel"><label id="lblTransactionNo" class="lblLink"><%=GetLabel("No Transaksi")%></label></td>
                            <td><asp:TextBox ID="txtTransactionNo" Width="150px" runat="server" CssClass="txtTransactionNo" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="tdLabel"><%=GetLabel("Diagnosa Medis") %></td>
                            <td><asp:TextBox ID="txtDiagnoseText" Width="400px" runat="server" /></td>
                        </tr>
                        <tr>
                            <td class="tdLabel"><label class="lblLink" id="lblNursingDiagnose" runat="server"><%=GetLabel("NANDA-I")%></label></td>
                            <td>
                ...
                <td style="padding:5px;vertical-align:top">
                    <table>
                        ...
                        <tr>
                            <td class="tdLabel"><label id="lblImportTransactionNo" class="lblLink"><%=GetLabel("Template No Transaksi")%></label></td>
                            <td>
                ...
                <td colspan="2">
                    <div class="containerUlTabPage">
                       <ul class="ulTabPage" id="ulTabWorkList">
                            <li class="selected" contentid="containerDiagnoseItem"><%=GetLabel("Diagnosa Keperawatan")%></li>
        ...
        <dxcp:ASPxCallbackPanel ID="cbpImportProcess" runat="server" Width="100%" ClientInstanceName="cbpImportProcess"
            ...
            <ClientSideEvents BeginCallback="function(s,e) { showLoadingPanel(); }"
                EndCallback="function(s,e) { onCbpImportProcessEndCallback(s); }" />
