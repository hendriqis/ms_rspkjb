<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingTransactionEntryInterventionCtlLink.ascx.cs" 
Inherits="QIS.Medinfras.Web.Nursing.Program.NursingTransactionEntryInterventionCtlLink" %>
...
<script type="text/javascript">
    ...
    function onGetInterventionFilterExpression() {
        var filterExpression = "NurseInterventionID NOT IN (SELECT NursingInterventionID FROM NursingTransactionInterventionHD WHERE TransactionID = " +  $('#<%=hdnTransactionID.ClientID %>').val() +") AND IsDeleted = 0";
        return filterExpression;
    }

    $('#lblIntervention.lblLink').die('click');
    $('#lblIntervention.lblLink').live('click',function () {
        openSearchDialog('nursingIntervention', onGetInterventionFilterExpression(), function (value) {
    ...
    function onTxtInterventionCodeChanged(value) {
        var filterExpression = onGetInterventionFilterExpression() + " AND NurseInterventionCode = '" + value + "'";
    ...
    <tr valign="top">
        <td>
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <input type="button" id="btnAddIntervention" class="btnAddIntervention" value="Add"/>
                    </td>
                </tr>
            </table>
                        ...
                        <asp:Panel runat="server" ID="pnlView1" CssClass="pnlContainerGrid">
                            ...
                            <asp:GridView ID="grdView1" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdView1_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DisplayOrder" HeaderText="Kode" />
                                    <asp:TemplateField HeaderText="Item Intervensi">
                                        <ItemTemplate>
