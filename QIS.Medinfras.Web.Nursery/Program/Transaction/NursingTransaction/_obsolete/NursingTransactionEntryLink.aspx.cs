...
{
    public partial class NursingTransactionEntryLink : BasePageTrx
    {
        ...
        protected override void InitializeDataControl()
        {
            if (Page.Request.QueryString.Count > 0)
            {
                ...
                if (menuType == "RI")
                {
                    ...
                    hdnDefaultParamedicID.Value = entity.ParamedicCode;

                    ctlPatientBanner.InitializePatientBanner(entity);
                }
                else if (menuType == "RD")
                {
                    vEmergencyPatientListLink entity = BusinessLayer.GetvEmergencyPatientListLinkList(string.Format("RegistrationNo = '{0}'", hdnVisitID.Value))[0];
                    hdnHealthcareServiceUnitID.Value = entity.ServiceUnitCode.ToString();
                    hdnDefaultChargeClassID.Value = entity.ChargeClassID.ToString();
                    hdnDefaultParamedicID.Value = entity.ParamedicCode;
                    ...
                    vOutPatientPatientListLink entity = BusinessLayer.GetvOutPatientPatientListLinkList(string.Format("RegistrationNo = '{0}'", hdnVisitID.Value))[0];
                    hdnHealthcareServiceUnitID.Value = entity.ServiceUnitCode.ToString();
                    hdnDefaultChargeClassID.Value = entity.ChargeClassID.ToString();
                    hdnDefaultParamedicID.Value = entity.ParamedicCode;
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(txtDiagnoseText, new ControlEntrySetting(true, true, true,lastDiagnoseText));
        ...
        {
            return Page.Request.QueryString["id"].Split('|')[0];
        }
        ...
        public override void OnAddRecord()
        {
            ...
            vNursingTransactionHd entityLast = BusinessLayer.GetvNursingTransactionHdList(String.Format("RegistrationNo = '{0}' ORDER BY TransactionID DESC", hdnVisitID.Value.Trim())).FirstOrDefault();
            if (entityLast != null)
        ...
        {
            return String.Format("LinkField LIKE '{0}%'", hdnVisitID.Value);
        }
        ...
        public void SaveNursingTransactionHd(IDbContext ctx, ref int TransactionID)
        {
            ...
            if (hdnTransactionID.Value == "0")
            {
                ...
                entityHd.LinkField = String.Format("{0}|{1}|{2}", hdnVisitID.Value,menuType, hdnHealthcareServiceUnitID.Value);
        ...
        private void ImportNursingOutcomeDt(IDbContext ctx, int templateTransactionID, int TransactionID)
        {
            ...
            if (lstEntityTemplate.Count > 0)
            {
                foreach(NursingTransactionOutcomeDt entityTemplate in lstEntityTemplate)
                {
                    ...
                    entity.ScaleScore = entityTemplate.ScaleScore;
