<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NursingTransactionEntryOutcomeCtlLink.ascx.cs" 
Inherits="QIS.Medinfras.Web.Nursing.Program.NursingTransactionEntryOutcomeCtlLink" %>
...
<script type="text/javascript">
    ...
    function getCheckedOutcomeItem(errMessage) {
        ...
        $('.grdSelected .chkIsSelectedOutcome input').each(function () {
            if ($(this).is(':checked')) {
                $tr = $(this).closest('tr');
                    ...
                    <dx:PanelContent ID="PanelContent2" runat="server">
                        <asp:Panel runat="server" ID="pnlView1" CssClass="pnlContainerGrid">
                            ...
                            <fieldset id="fsTrx" style="margin:0"> 
                                <table>
                                    <tr>
                                        <td><asp:Label runat="server"><%=GetLabel("Setelah dilakukan tindakan keperatawan ")%></asp:Label></td>
                                        <td><asp:TextBox runat="server" ID="txtNOCInterval" Width="20px" CssClass="txtNumeric" style="text-align:center" Text="0"></asp:TextBox></td>
                                        <td><asp:Label runat="server"><%=GetLabel(" x 24 jam masalah teratasi dengan kriteria")%></asp:Label></td>
                                    </tr>
                                </table>
                            </fieldset>
                            <asp:GridView ID="grdView1" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" OnRowDataBound="grdView1_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ket" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtRemarksOutcome" CssClass="txtRemarksOutcome" Width="100%" TextMode="MultiLine" Wrap="true" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
