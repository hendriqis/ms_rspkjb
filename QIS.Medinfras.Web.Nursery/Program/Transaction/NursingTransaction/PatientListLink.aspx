<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="PatientListLink.aspx.cs" Inherits="QIS.Medinfras.Web.Nursing.Program.PatientListLink" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        ...
        $('#btnRegistrationGo').live('click', function () {
            if ($('#<%: txtRegistrationNo.ClientID %>').val() != '') {
                showLoadingPanel();
                $('#<%=hdnTransactionNo.ClientID %>').val($('#<%: txtRegistrationNo.ClientID %>').val());
                __doPostBack('<%=btnOpenTransactionDt.UniqueID%>', '');
           }
        });
                ...
                <td style="padding:5px;vertical-align:top">
                    <fieldset id="fsPatientList">  
                        <table class="tblEntryContent" style="width:60%;">
                            ...
                            <tr>
                                <td class="tdLabel"><label id="lblRegistrationNo" class="lblLink" ><%=GetLabel("No Registrasi")%></label></td>
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td><asp:TextBox ID="txtRegistrationNo" Width="120px" runat="server" /></td>
                                            <td style="padding-left:5px"><input id="btnRegistrationGo" type="button" value="Go" style="width:50px" /></td>
                                        </tr>
                                    </table>
