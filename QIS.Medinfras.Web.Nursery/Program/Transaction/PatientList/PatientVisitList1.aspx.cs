...
{
    public partial class PatientVisitList1 : BasePageTrx
    {
        protected int PageCount = 1;
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Nursing.NURSING_PATIENT_PAGE;
        }
        ...
        protected void btnOpenTransactionDt_Click(object sender, EventArgs e)
        {
            if (hdnTransactionNo.Value != "")
            {
                ...
                //parentCode = Constant.MenuCode.Nursing.NURSING_TRANSACTION;
                ...
                url = string.Format("~/Program/Transaction/NursingTransaction/NursingTransactionEntry.aspx?id={0}|{1}", entity.VisitID, "0");
