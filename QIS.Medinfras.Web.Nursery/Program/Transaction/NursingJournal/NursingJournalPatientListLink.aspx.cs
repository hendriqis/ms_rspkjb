...
{
    public partial class NursingJournalPatientListLink : BasePageContent
    {
        ...
        private string GetResponseRedirectUrl(string registrationNo)
        {
            string url = "";
            string id = Page.Request.QueryString["id"];
            url = string.Format("~/Program/Transaction/NursingJournal/NursingJournalEntryLink.aspx?id={1}|{0}", registrationNo,id);
            return url;
        }
