...
{
    public partial class NursingJournalEntryLink : BasePageTrx
    {
        ...
        protected override void InitializeDataControl()
        {
            if (Page.Request.QueryString.Count > 0)
            {
                ...
                else if (menuType == "RD")
                {
                    ...
                    hdnHealthcareServiceUnitID.Value = "IGD";
                    hdnDefaultChargeClassID.Value = entity.ChargeClassID.ToString();
                    hdnRegistrationNo.Value = entity.RegistrationNo;
                    paramedicCode = entity.ParamedicCode;
                    ctlPatientBanner.InitializePatientBanner(entity);
        ...
        private string GetFilterExpression()
        {
            ...
            filterExpression = string.Format("LinkField LIKE '{0}%' AND IsDeleted = 0 AND ISNULL(NursingTransactionInterventionDtID,0) = 0", hdnVisitID.Value);
        ...
        private void ControlToEntity(NursingJournal entityDt)
        {
            ...
            entityDt.LinkField = String.Format("{0}|{1}|{2}", hdnVisitID.Value, menuType,hdnHealthcareServiceUnitID.Value);
        }
