<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="NursingItemGroupList.aspx.cs" Inherits="QIS.Medinfras.Web.Nursing.Program.NursingItemGroupList" %>
                        ...
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <div style='margin-left:<%#: Eval("CfMargin") %>0px;'><%#: Eval("NursingItemGroupSubGroupCode")%></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <div style="padding-left:3px">
                                            <%=GetLabel("Deskripsi/Keterangan")%>
                                        </div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
