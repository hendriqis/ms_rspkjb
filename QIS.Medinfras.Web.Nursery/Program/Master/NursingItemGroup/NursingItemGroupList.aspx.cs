...
{
    public partial class NursingItemGroupList : BasePageList
    {
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetNursingItemGroupSubGroupRowIndex(filterExpression, keyValue) + 1;
        ...
        {
            fieldListText = new string[] { "Text"};
            fieldListValue = new string[] { "NursingItemGroupSubGroupText"};
        }
        ...
        {
            url = ResolveUrl("~/Program/Master/NursingItemGroup/NursingItemGroupEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/NursingItemGroup/NursingItemGroupEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
