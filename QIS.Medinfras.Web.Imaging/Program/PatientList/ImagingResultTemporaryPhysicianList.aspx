<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="ImagingResultTemporaryPhysicianList.aspx.cs"
    Inherits="QIS.Medinfras.Web.Imaging.Program.ImagingResultTemporaryPhysicianList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <table class="tblContentArea" style="width: 0%">
        <tr>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="width: 100%;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RegistrationNo" HeaderText="No. Registrasi" HeaderStyle-Width="50px"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="MedicalNo" HeaderText="No. Rekam Medis" HeaderStyle-Width="50px"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                        ...
                                        <asp:BoundField DataField="TransactionNo" HeaderText="No. Transaksi" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50px" />
                                        ...
                                        <asp:BoundField DataField="TemporaryPhysicianText" HeaderText="Informasi Dokter" HeaderStyle-HorizontalAlign="Center"
