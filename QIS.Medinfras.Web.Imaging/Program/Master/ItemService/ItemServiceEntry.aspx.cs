...
namespace QIS.Medinfras.Web.Imaging.Program
{
    public partial class ItemServiceEntry : BasePageEntry
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            switch (MenuID)
            {
                case "SERVICES": hdnGCItemType.Value = Constant.ItemGroupMaster.SERVICE; break;
                case "IMAGING": hdnGCItemType.Value = Constant.ItemGroupMaster.RADIOLOGY; break;
                default: hdnGCItemType.Value = Constant.ItemGroupMaster.DIAGNOSTIC; break;
            }
        ...
        {
            List<StandardCode> lstSc = BusinessLayer.GetStandardCodeList(string.Format("ParentID = '{0}' AND IsDeleted = 0", Constant.StandardCode.ITEM_UNIT));
        ...
        protected override bool OnSaveEditRecord(ref string errMessage)
        {
            ...
            try
            {
                //vItemMaster entityIM = BusinessLayer.GetvItemMasterList
