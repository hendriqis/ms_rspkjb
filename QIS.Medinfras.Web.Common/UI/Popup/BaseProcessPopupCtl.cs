...
{
    public abstract class BaseProcessPopupCtl : BaseContentPopupCtl
    {
        ...
        {
            MasterControl = (BaseMPPopupEntry)LoadControl("~/Libs/Controls/MPProcessPopupCtl.ascx");
        ...
        public void OnBtnProcessClick(ref string result, ref string retval)
        {
            string errMessage = "";

            result = "process|";
            if (OnProcessRecord(ref errMessage, ref retval))
        ...
        protected virtual bool OnProcessRecord(ref string errMessage, ref string retval)
        {
            return false;
        }
        ...
        public virtual void SetProcessButtonVisibility(ref bool IsUsingProcessButton)
        {
