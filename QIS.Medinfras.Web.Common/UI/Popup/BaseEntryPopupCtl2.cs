...
{
    public abstract class BaseEntryPopupCtl2 : BaseContentPopupCtl
    {
        ...
        {
            MasterControl = (BaseMPPopupEntry)LoadControl("~/Libs/Controls/MPEntryPopupCtl2.ascx");
        ...
        public void SetControlEnabled(bool isAdd)
        {
