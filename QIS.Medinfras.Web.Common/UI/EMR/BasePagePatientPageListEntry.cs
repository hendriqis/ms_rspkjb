...
{
    public abstract class BasePagePatientPageListEntry : BasePageContent
    {
        ...
        protected void SetControlEntrySetting(Control ctrl, ControlEntrySetting setting)
        {
            ...
            if (ctrl is ASPxEdit)
            {
                ...
                ctl.ValidationSettings.ValidationGroup = "mpEntryPatientPage";
            }
            else if (ctrl is WebControl)
            {
                ...
                ((WebControl)ctrl).Attributes.Add("validationgroup", "mpEntryPatientPage");
