<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="TariffTestEstimation.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.TariffTestEstimation" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnCalculate" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbset.png")%>' alt="" /><div><%=GetLabel("Calculate")%></div></li>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#<%=btnCalculate.ClientID %>').click(function () {
                getCheckedMember();
                showLoadingPanel();
                Methods.getTariffEstimation(cboClass.GetValue(), $('#<%=hdnBusinessPartnerID.ClientID %>').val(), $('#<%=hdnCoverageTypeID.ClientID %>').val(), $('#<%=hdnSelectedMember.ClientID %>').val(), getTrxDate(), department, 1, function (result) {
                    if (result != null) {
    ...
    <div style="padding:10px;">
        ...
        <div class="pageTitle">
            <div style="font-size: 1.1em"><%=GetLabel("Estimasi Biaya Pemeriksaan")%></div>
        </div>
            ...
            <tr>
                <td style="padding:5px;vertical-align:top">
                    <table class="tblEntryContent" style="width:100%">
                        ...
                        <tr id="trServiceUnit" runat="server">
                            <td class="tdLabel"><label id="lblServiceUnit" class="lblMandatory" runat="server"><%=GetLabel("Penunjang Medis")%></label></td>
                            <td>
                                <dxe:ASPxComboBox ID="cboServiceUnit" ClientInstanceName="cboServiceUnit" Width="100%" runat="server" />
                            </td>
                       </tr>
                       <tr>
                            <td class="tdLabel"><label id="lblPenjamin" class="lblMandatory" runat="server"><%=GetLabel("Penjamin Bayar")%></label></td>
                            <td>
                                <dxe:ASPxComboBox ID="cboCustomerType" ClientInstanceName="cboCustomerType" Width="100%" runat="server">
                                        <ClientSideEvents ValueChanged="function(s,e) { onCboCustomerTypeChanged(); }" />
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel"><label class="lblLink" id="lblBusinessPartner"><%=GetLabel("Instansi")%></label></td>
                            <td>
                                ...
                                <table style="width:100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td><asp:TextBox ID="txtBusinessPartnerCode" Width="100%" runat="server" /></td>
                                        <td>&nbsp;</td>
                                        <td><asp:TextBox ID="txtBusinessPartnerName" ReadOnly="true" Width="100%" runat="server" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel"><label class="lblLink" id="lblCoverageType"><%=GetLabel("Coverage Type")%></label></td>
                            <td>
                                ...
                                <table style="width:100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td><asp:TextBox ID="txtCoverageTypeName" ReadOnly="true" Width="100%" runat="server" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                ...
                <td style="padding:5px;vertical-align:top">
                    <table class="tblEntryContent" style="width:100%">
                        ...
                        <tr>
                            <td class="tdLabel"><%=GetLabel("Jenis Pasien")%></td>
                            <td>
                                <asp:RadioButtonList ID="rblJnsPasien" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" ClientIDMode="Static">
                        ...
                        <tr>
                            ...
                            <td><dxe:ASPxComboBox ID="cboClass" ClientInstanceName="cboClass" Width="100%" runat="server" /></td>
                        </tr>
                        <tr>
                ...
                <td style="padding:5px;vertical-align:top">
                    <table id="tblSelectedItem" class="grdView notAllowSelect" cellspacing="0" rules="all" >
                        <tr>
                            ...
                            <th rowspan="2" align="center"><%=GetLabel("Item Name")%></th>
                            <th style="width:60px" rowspan="2" align="center"><%=GetLabel("Quantity")%></th>
                            <th colspan="3" align="center"><%=GetLabel("Price")%></th>    
                        </tr>
                        <tr>
                            <th style="width:120px" align="center"><%=GetLabel("Payer")%></th>
                            <th style="width:120px" align="center"><%=GetLabel("Patient")%></th>
                            <th style="width:120px" align="center"><%=GetLabel("Total")%></th>
                        </tr>
                    </table> 
                </td>
            </tr>
