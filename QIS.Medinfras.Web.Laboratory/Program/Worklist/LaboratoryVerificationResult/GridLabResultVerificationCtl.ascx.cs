...
{
    public partial class GridLabResultVerificationCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvLabResultHdPatientChargesHdVisitRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_PATIENT_LIST);
            }

            List<vLabResultHdPatientChargesHdVisit> lstEntity = BusinessLayer.GetvLabResultHdPatientChargesHdVisitList(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex);
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            {
                vLabResultHdPatientChargesHdVisit entity = (vLabResultHdPatientChargesHdVisit)e.Item.DataItem;
                HtmlGenericControl spnProcessed = e.Item.FindControl("spnProcessed") as HtmlGenericControl;
                if (entity.LabGCTransactionStatus != Constant.TransactionStatus.PROCESSED)
