...
{
    public partial class BloodBankOrderRealizationEntry : BasePagePatientPageList
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            {
                //lastCheckedInfo = string.IsNullOrEmpty(entityPatient.MedicalFileLastCheckedBy) ? string.Empty : string.Format("{0} ({1})", entityPatient.MedicalFileLastCheckedBy, entityPatient.MedicalFileLastCheckedDate.ToString(Constant.FormatString.DATE_FORMAT));
            ...
            txtParamedicName.Text = AppSession.RegisteredPatient.ParamedicName;
        ...
        protected override bool OnCustomButtonClick(string type, ref string errMessage)
        {
            ...
            try
            {
                ...
                {
                    string filterExp = string.Format("RegistrationID = {0}", AppSession.RegisteredPatient.RegistrationID);
