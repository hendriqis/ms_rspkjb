<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="BloodBankOrderList.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.BloodBankOrderList" %>
...
<%@ Register Src="~/Libs/Controls/PatientGrid/GridPatientBloodBankOrderCtl.ascx" TagName="ctlGrdOrderPatient" TagPrefix="uc1" %>
    ...
    <div style="padding:15px;">
        <div class="containerUlTabPage">
           <ul class="ulTabPage" id="ulTabLabResult">
                <li class="selected" contentid="containerByOrder"><%=GetLabel("Order Bank Darah")%></li>
                <li contentid="containerDaftar" style="display:none"><%=GetLabel("Pendaftaran Pasien")%></li>
           </ul>
        </div>
                        ...
                        <fieldset id="fsPatientList">  
                            <table class="tblEntryContent" style="width:60%;">
                                ...
                                <tr id="trTanggal" runat="server">
                                    ...
                                    <td><asp:TextBox ID="txtDate" Width="120px" runat="server" CssClass="datepicker" />&nbsp;<asp:CheckBox ID="chkIsIgnoreDate" runat="server" Checked="false" /><%:GetLabel("Abaikan Tanggal")%>&nbsp;</td>
                                </tr>
                                <tr>
                    ...
                    <td style="padding:5px;vertical-align:top">
                        <fieldset id="fsPatientListOrder">  
                            <table class="tblEntryContent" style="width:60%;">
                                ...
                                <tr>
                                    <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Tanggal")%></label></td>
                                    <td><asp:TextBox ID="txtTestOrderDate" Width="120px" runat="server" CssClass="datepicker" />&nbsp;<asp:CheckBox ID="chkIgnoreDateOrder" runat="server" Checked="false" /><%:GetLabel("Abaikan Tanggal")%>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="tdLabel"><label><%=GetLabel("Quick Filter")%></label></td>
                                    <td>
