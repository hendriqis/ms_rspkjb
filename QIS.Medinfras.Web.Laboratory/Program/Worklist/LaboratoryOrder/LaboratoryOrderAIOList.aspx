<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="LaboratoryOrderAIOList.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.LaboratoryOrderAIOList" %>
    ...
    <div style="padding:15px;">
        <div class="containerUlTabPage">
           <ul class="ulTabPage" id="ulTabLabResult">
                <li class="selected" contentid="containerByOrder"><%=GetLabel("Job Order Entry")%></li>                
           </ul>
        </div>
...
<%--                                            <IntellisenseHints>
        ...
        <div style="padding:2px;" id="containerByOrder" class="containerOrder">
            ...
            <div class="pageTitle"><%=GetLabel("Realisasi Order AIO")%> : <%=GetLabel("Pilih Pasien")%></div>
            <table class="tblContentArea" style="width:100%">
                <tr>
                    <td style="padding:5px;vertical-align:top">
