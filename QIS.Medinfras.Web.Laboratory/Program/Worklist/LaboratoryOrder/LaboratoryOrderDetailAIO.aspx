<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true"
    CodeBehind="LaboratoryOrderDetailAIO.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.LaboratoryOrderDetailAIO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            else if (code == "LB-00011" || code == "PM-00125") {
        ...
        function setRightPanelButtonEnabled() {
            ...
            if ($('#<%:hdnTransactionHdID.ClientID %>').val() != "") {
