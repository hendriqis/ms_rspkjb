<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true"
    CodeBehind="LaboratoryOrderUseDetailAIO.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.LaboratoryOrderUseDetailAIO" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (TestOrderID != "" && TestOrderID != "0") {
                ...
                if (testOrderCount > 0) {
                    ...
                    openUserControlPopup(url, ID, 'Detail Order Pelayanan', 800, 600);
                }
            }
        ...
        function onLoad() {
            ...
            $('#<%=btnClinicTransactionBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl("~/Program/Worklist/LaboratoryOrder/LaboratoryOrderAIOList.aspx"); ;
            });
        ...
        function setRightPanelButtonEnabled() {
            //            if ($('#<%=hdnGCTransactionStatus.ClientID %>').val() != 'X121^002') {
            //                $('#btnTestPartner').attr('enabled', 'false');
            //            }
            //            else {
            //                $('#btnTestPartner').removeAttr('enabled'); 
            //            }        
        }

        function onBeforeLoadRightPanelContent() {
            var param = $('#<%:hdnTransactionHdID.ClientID %>').val();
            return param;
        }
