...
{
    public partial class LaboratoryOrderAIOList : BasePagePatientOrder
    {
        ...
        public override void OnGrdRowClick(string transactionNo)
        {
            ...
            {
                url = string.Format("~/Program/Worklist/LaboratoryOrder/LaboratoryOrderUseDetailAIO.aspx?id={0}|{1}|{2}", transactionNo, hdnServiceUnitID.Value, hdnIDReg.Value);
            }
            else
            {
                url = string.Format("~/Program/Worklist/LaboratoryOrder/LaboratoryOrderDetailAIO.aspx?id={0}|{1}|{2}", transactionNo, hdnServiceUnitID.Value, hdnIDReg.Value);
            }
        ...
        public override void OnGrdRowClickTestOrder(string transactionNo, string TestOrderID)
        {
            ...
            if (hdnSetVarMenuRealisasi.Value == "0")
            {
                url = string.Format("~/Program/Worklist/LaboratoryOrder/LaboratoryOrderUseDetailAIO.aspx?id=to|{0}|{1}|{2}", transactionNo, TestOrderID, hdnID.Value);
            }
            else
            {
                url = string.Format("~/Program/Worklist/LaboratoryOrder/LaboratoryOrderDetailAIO.aspx?id=to|{0}|{1}|{2}", transactionNo, TestOrderID, hdnID.Value);
            }
            Response.Redirect(url);
        }
