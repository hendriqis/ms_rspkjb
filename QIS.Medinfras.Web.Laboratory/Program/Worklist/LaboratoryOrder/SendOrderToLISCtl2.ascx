<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SendOrderToLISCtl2.ascx.cs"
    Inherits="QIS.Medinfras.Web.Laboratory.Program.SendOrderToLISCtl2" %>
...
<script type="text/javascript" id="dxss_Referralctl">
    ...
    function getSelectedItem() {
        ...
        if (count == 0) {
            showToast("Send Order Ke LIS", "Belum ada item pemeriksaan yang dipilih !");
            return false;
        }
        else {
    ...
    function onCbpViewEndCallback(s) {
        ...
        if (param[0] == '0') {
            showToast("Send Order Ke LIS", "Error Message : <br/><span style='color:red'>" + param[1] + "</span>");
        }
        else {
            showToast("Send Order Ke LIS", "SUCCESS : <br/><span>" + "Order pemeriksaan berhasil dikirim ke LIS" + "</span>");
        }
    }
</script>
