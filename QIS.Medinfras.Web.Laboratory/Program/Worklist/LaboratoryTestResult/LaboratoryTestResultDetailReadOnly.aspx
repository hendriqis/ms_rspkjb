<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true"
    CodeBehind="LaboratoryTestResultDetailReadOnly.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.LaboratoryTestResultDetailReadOnly" %>
    ...
    <script type="text/javascript">
        ...
        $('.lnkHasil a').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                ...
                selectedParamedicID = $(this).closest('tr').ParamedicID;
                ...
                if (code == 'LB-00004' || code == 'LB-00015' || code == 'LB-00017') {
                    ...
                    if ($('#<%=hdnIsAllowByPassPrint.ClientID %>').val() == '1') {
                        ...
                        if (isVerified == '0') {
                            ...
                            if (code == 'LB-00001' || code == 'LB-00005' || code == 'LB-00006' || code == 'LB-00008' || code == 'LB-00010'
                                || code == 'LB-00012' || code == 'LB-00016' || code == 'LB-00018' || code == 'LB-00019' || code == 'LB-00020' || code == 'LB-00026') {
...
<style>
#ctl00_ctl00_ctl00_plhMPBase_plhMPMain_btnMPEntryPropose {
                                    ...
                                    <asp:Panel runat="server" ID="Panel2" CssClass="pnlContainerGrid" Style="height: 200px">
                                        <asp:GridView ID="grdView2" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Pending Hasil" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkIsPendingResult" runat="server" CssClass="chkIsPendingResult" Checked='<%# Eval("IsPendingResult")%>' Enabled="false" />                      
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="TextValue" HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="textResultValue hiddenColumn" />
                                                <asp:TemplateField HeaderText="Hasil" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="100px">
                                                    <ItemTemplate>
                                                        <div class='<%#: Eval("IsNormal").ToString() == "False" ? "isAbnormalColor" : "" %>'
                                                ...
                                                <asp:TemplateField HeaderText="Nilai Referensi" ItemStyle-Width="140px" HeaderStyle-HorizontalAlign="Left"
                                                    ...
                                                    <ItemTemplate>
                                                        <div class='<%#: Eval("cfIsReferenceAsLink").ToString() == "True" ? "lblLink lblReffRange" : "" %>'>
                                                            <asp:Literal ID="literalRefRange" Text='<%# Eval("cfReferenceRangeCustom") %>' Mode="PassThrough"
                                                                runat="server" /></div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
