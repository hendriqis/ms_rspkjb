...
{
    public partial class LaboratoryTestResultDetail : BasePageTrx
    {
        ...
        private void EntityToControl(LaboratoryResultHd entity, ref bool isShowWatermark, ref string watermarkText)
        {
            ...
            //PatientChargesHd oChargesHd = BusinessLayer.GetPatientChargesHd(entity.ChargeTransactionID);
            //txtTransactionNo.Text = oChargesHd.TransactionNo;
        }
        #endregion

        #region Save Entity
        public void SaveLaboratoryResultHd(IDbContext ctx, ref int labResultID)
        {
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            {
                int labResultID = 0;
                SaveLaboratoryResultHd(ctx, ref labResultID);
