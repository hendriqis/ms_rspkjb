<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridLabResultVerificationCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Laboratory.Program.GridLabResultVerificationCtl" %>
...
<script type="text/javascript" id="dxss_gridlabresultverificationctl">
                    ...
                    <EmptyDataTemplate>
                        <table id="tblView" runat="server" class="grdCollapsible lvwView" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:200px"><%=GetLabel("Informasi Transaksi")%></th>
                                <th style="width:200px"><%=GetLabel("Informasi Registrasi")%></th>
                                <th style="width:280px"><%=GetLabel("Informasi Pasien")%></th>
                                <th style="width:320px"><%=GetLabel("Informasi Kontak")%></th>
