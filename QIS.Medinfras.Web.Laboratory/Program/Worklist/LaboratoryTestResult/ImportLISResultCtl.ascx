<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportLISResultCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Laboratory.Program.ImportLISResultCtl" %>
...
<script type="text/javascript" id="dxss_laboratorytestresultentryctl">
    ...
    $(function () {
        ...
        $('#btnResultSave').click(function () {
            $editRow.find('.hdnTextResult').val($('#txtTestResult').val());
            pcResult.Hide();
        });
    });
...
<div style="height:440px; width:100%; overflow-y:auto; overflow-x: hidden">
                ...
                <dxcp:ASPxCallbackPanel ID="cbpProcessDetail" runat="server" Width="100%" ClientInstanceName="cbpProcessDetail"
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:1em;">
                                <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                                    <EmptyDataTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0" rules="all" >
                                            <tr>
                                                <th style="width:30px" rowspan="2" align="center"><input id="chkSelectAllPatient" type="checkbox" /></th>
                                                <th style="width:120px" rowspan="2" align="left"><%=GetLabel("PEMERIKSAAN")%></th>
                                                <th colspan="3" align="center"><%=GetLabel("CONVENTIONAL")%></th>
                                                <th colspan="3" align="center"><%=GetLabel("INTERNATIONAL (SI)")%></th>       
                                                <th style="width:80px" align="center" rowspan="2"><%=GetLabel("HASIL TEXT")%></th>
                                                <th style="width:30px" rowspan="2" align="center"><%=GetLabel("BATAL")%></th>
                                            </tr>
                                            <tr>
                                                <th style="width:60px" align="center"><%=GetLabel("NILAI")%></th>
                                                <th style="width:120px" align="center"><%=GetLabel("NORMAL RANGE")%></th>
                                                <th style="width:120px" align="center"><%=GetLabel("PANIC RANGE")%></th>
                                                <th style="width:60px" align="center"><%=GetLabel("NILAI")%></th>
                                                <th style="width:120px" align="center"><%=GetLabel("NORMAL RANGE")%></th>
                                                <th style="width:120px" align="center"><%=GetLabel("PANIC RANGE")%></th>
                                            </tr>
                                    ...
                                    <LayoutTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0" rules="all" >
                                            <tr>
                                                ...
                                                <th colspan="3" align="center"><%=GetLabel("CONVENTIONAL")%></th>
                                                <th colspan="3" align="center"><%=GetLabel("INTERNATIONAL (SI)")%></th>       
                                                <th style="width:40px" align="center" rowspan="2"><%=GetLabel("FLAG")%></th>  
                                                <th style="width:80px" align="center" rowspan="2"><%=GetLabel("HASIL TEXT")%></th>
                                            </tr>
                                            <tr>
                                                <th style="width:60px" align="center"><%=GetLabel("NILAI")%></th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td align="center">
                                                ...
                                                <input type="hidden" id="hdnDetailItemID" runat="server" value='<%#: Eval("ItemID")%>' />
                                                ...
                                                <input type="hidden" class="hdnUnitConversion" id="hdnUnitConversion" runat="server" value='<%#: Eval("ConversionFactor")%>' />
                                                ...
                                                <input type="hidden" class="hdnResultFlag" id="hdnResultFlag" runat="server" value='<%# Eval("Flag")%>' />
                                            </td>
                                            <td><%#: Eval("FractionName1")%></td>
                                            <td align="center"><asp:TextBox ID="txtMetricValue" Text="0" Width="100%" runat="server" CssClass="txtMetricValue number"/></td>
                                            <td align="right"><%#: Eval("MetricRangeLabel")%></td>
                                            <td align="right"><%#: Eval("PanicMetricRangeLabel")%></td>
                                            <td align="center"><asp:TextBox ID="txtInternationalValue" Text="0" Width="100%" runat="server" CssClass="txtInternationalValue number"/></td>
                                            <td align="right"><%#: Eval("InternationalRangeLabel")%></td>
                                            <td align="right"><%#: Eval("PanicInternationalRangeLabel")%></td>
                                            <td align="center" class='<%#: Eval("Flag").ToString() != "N" ? "isAbnormalColor" : "" %>'><%#: Eval("Flag")%></td>
                                            <td align="center"><div id="divTextResult" runat="server"><label class="lblLink" id="lblTextResult"><%=GetLabel("Text Result")%></label></div></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
                            </asp:Panel>
    ...
    <dxpc:ASPxPopupControl ID="pcResult" runat="server" ClientInstanceName="pcResult" CloseAction="CloseButton"
        Height="300px" HeaderText="Text Result" Width="600px" Modal="True" PopupAction="None"
                            ...
                            <fieldset id="fsResult" style="margin:0"> 
                                <div style="text-align: left; width: 100%;">
                                    <table>
                                        <tr>
                                            <td valign="top">
                                                <table>
                                                    <tr>
                                                        <td class="tdLabel"><label class="lblNormal lblLink" id="lblTestResult"></label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:TextBox TextMode="MultiLine" Width="100%" Height="300px" ID="txtTestResult" runat="server" CssClass="htmlEditor" ClientIDMode="Static"/></td>
                                                    </tr>  
                                                </table>  
                                            </td>
                                        </tr>
                                    ...
                                    <table style="margin-left: auto; margin-right: auto; margin-top: 10px;">
                                        <tr>
                                            <td>
                                                <input type="button" id="btnResultSave" value='' />
                                            </td>
                                            <td>
                                                <input type="button" id="btnResultCancel" value='' onclick="pcResult.Hide();" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>                                
    ...
    <dxpc:ASPxPopupControl ID="pcVerifiedResult" runat="server" ClientInstanceName="pcVerifiedResult" CloseAction="CloseButton"
        Height="300px" HeaderText="Text Result" Width="600px" Modal="True" PopupAction="None"
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter">
        <ContentCollection>
                                    ...
                                    <table>
                                        <tr>
                                            <td valign="top">
                                                <table>
                                                    <tr>
                                                        <td colspan="2"><div id="contentResult" runat="server"></div></td>
                                                    </tr>  
                                                </table>  
                                            </td>
                                        </tr>
