    ...
    public partial class LaboratoryVerificationResultList : BasePageRegisteredPatient
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                List<Department> lstDepartment = BusinessLayer.GetDepartmentList("");
        ...
        public override string GetFilterExpression()
        {
            ...
            filterExpression += string.Format("TransactionDate = '{0}' AND HealthcareServiceUnitID = {1}",
                Helper.GetDatePickerValue(txtDate).ToString(Constant.FormatString.DATE_FORMAT_112), cboServiceUnit.Value);
        ...
        {
            string url = "";
            url = string.Format("~/Program/Worklist/LaboratoryVerificationResult/LaboratoryVerificationResultDetail.aspx?id={0}", transactionNo);
