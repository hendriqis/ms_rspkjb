...
<%@ Register Src="~/Program/Worklist/LaboratoryVerificationResult/GridLabResultVerificationCtl.ascx" TagName="ctlGrdLabResultVerification" TagPrefix="ctl" %>
            ...
            <tr>
                <td style="padding:5px;vertical-align:top">
                    ...
                    <div style="padding:7px 0 0 3px;font-size:0.95em">
                        <%=GetLabel("Halaman Ini Akan")%> <span class="lblLink" id="lblRefresh">[refresh]</span> <%=GetLabel("Setiap")%>
