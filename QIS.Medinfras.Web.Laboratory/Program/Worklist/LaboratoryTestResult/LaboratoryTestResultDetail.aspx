<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true"
    CodeBehind="LaboratoryTestResultDetail.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.LaboratoryTestResultDetail" %>
    ...
    <script type="text/javascript">
        ...
        function onLoad() {
            ...
            $('#<%=btnLaboratoryResultBack.ClientID %>').click(function () {
                ...
                if ($('#<%=hdnType.ClientID %>').val() == 'to')
                    document.location = ResolveUrl('~/Program/Worklist/LaboratoryTestResult/LaboratoryTestResultList.aspx');
                else
        ...
        $('.lnkHasil a').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                ...
                var url = ResolveUrl("~/Program/WorkList/LaboratoryTestResult/LaboratoryTestResultEntryCtl.ascx");
                openUserControlPopup(url, paramResultTest, 'Hasil Pemeriksaan', 1200, 500);
            }
        });
        ...
        function onAfterSaveAddRecordEntryPopup(param) {
            $('#<%=hdnLabResultID.ClientID %>').val(param);
                    ...
                    if ($('#<%=hdnIsAllowByPassPrint.ClientID %>').val() == '1') {
                        ...
                        if (isVerified == '0') {
                            ...
                            if (code == 'LB-00001' || code == 'LB-00005' || code == 'LB-00006' || code == 'LB-00008' || code == 'LB-00010' || code == 'LB-00024'
                                ...
                                || code == 'LB-00034' || code == 'LB-00035' || code == 'LB-00037' || code == 'LB-00039') {
                                                ...
                                                <asp:TemplateField HeaderText="Hasil" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <div class='<%#: Eval("IsNormal").ToString() == "False" ? "isAbnormalColor" : "" %>'
                                                            ...
                                                            <asp:Literal ID="literal" Text='<%# GetISBridgingToLIS() == "True" ? Eval("cfTestResultValueNew") : Eval("cfTestResultValue") %>' Mode="PassThrough"
                                                                runat="server" /></div>
                                                ...
                                                <asp:TemplateField HeaderText="Nilai Referensi" ItemStyle-Width="140px" HeaderStyle-HorizontalAlign="Left"
                                                    ...
                                                    <ItemTemplate>
                                                        <div class='<%#: Eval("cfIsReferenceAsLink").ToString() == "True" ? "lblLink lblReffRange" : "" %>'>
                                                            <asp:Literal ID="literal" Text='<%# GetISBridgingToLIS() == "True" ? Eval("cfReferenceRangeCustom") : Eval("MetricUnitLabel") %>' Mode="PassThrough"
                                                                runat="server" /></div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
