...
{
    public partial class LBVisitList : BasePagePatientOrder
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Laboratory.PATIENT_PAGE;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                List<vHealthcareServiceUnitCustom> lstServiceUnit = BusinessLayer.GetvHealthcareServiceUnitCustomList(filterExpression);
                Methods.SetComboBoxField<vHealthcareServiceUnitCustom>(cboMedicalDiagnostic, lstServiceUnit, "ServiceUnitName", "HealthcareServiceUnitID");
                Methods.SetComboBoxField<vHealthcareServiceUnitCustom>(cboMedicalDiagnosticOrder, lstServiceUnit, "ServiceUnitName", "HealthcareServiceUnitID");
                cboMedicalDiagnostic.SelectedIndex = cboMedicalDiagnosticOrder.SelectedIndex = 0;
        ...
        public override void OnGrdRowClick(string transactionNo)
        {
            ...
            parentCode = Constant.MenuCode.Laboratory.PATIENT_PAGE;
            string filterExpression = string.Format("ParentCode = '{0}'", parentCode);
            List<GetUserMenuAccess> lstMenu = BusinessLayer.GetUserMenuAccess(Constant.Module.LABORATORY, AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID, filterExpression);
            ...
            lstMenu = BusinessLayer.GetUserMenuAccess(Constant.Module.LABORATORY, AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID, filterExpression);
        ...
        public override string GetFilterExpressionTestOrder()
        {
            ...
            healthcareServiceUnitID = AppSession.MedicalDiagnostic.LaboratoryHealthcareServiceUnitID.ToString();
