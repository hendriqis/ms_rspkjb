    ...
    public partial class RecalculationPatientBillProcessCtl : BasePatientManagementRecalculationBillPage
    {
        public override void InitializeDataControl(string param)
        {
            if (param != "")
            {
                ...
                ListPatientChargesDt = BusinessLayer.GetvPatientChargesDt8List(string.Format("RegistrationID = {0} AND GCTransactionStatus = '{1}' AND IsDeleted = 0", param, Constant.TransactionStatus.OPEN));
                BindGrid();
            }
        }
