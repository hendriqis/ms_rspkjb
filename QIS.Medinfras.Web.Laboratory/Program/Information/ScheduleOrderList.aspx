...
CodeBehind="ScheduleOrderList.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.ScheduleOrderList" %>
...
<%@ Register Src="~/libs/Controls/PatientGrid/GridPatientScheduledOrderCtl.ascx" TagName="ctlGrdScheduledOrderPatient" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=txtOrderDate.ClientID %>').datepicker('option', 'minDate', '0');

            function getHealthcareServiceUnitOrderFilterExpression() {
                var filterExpression = "HealthcareID = '" + AppSession.healthcareID + "' AND DepartmentID = '" + cboPatientFromOrder.GetValue() + "' AND IsUsingRegistration = 1"; ;
    ...
    <div style="padding:15px">
        <div id="containerByOrder" class="containerOrder">
            <div class="pageTitle"><%=GetLabel("Jadwal Pemeriksaan")%></div>
            <table class="tblContentArea" style="width:100%">
                <tr>
                    <td style="padding:5px;vertical-align:top">
                        ...
                        <uc1:ctlGrdScheduledOrderPatient runat="server" id="grdOrderedPatient" />
                    </td>
                </tr>
            </table>
        </div>
