...
CodeBehind="TestPartnerEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Laboratory.Program.TestPartnerEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <%--<div class="pageTitle"><%=GetLabel("Pelanggan Instasi")%></div>--%>
            ...
            <td style="padding:5px;vertical-align:top">
                ...
                <div class="containerTblEntryContent">
                    <table class="tblEntryContent" style="width:100%">
                        ...
                        <tr>
                            <td class="tdLabel"><%=GetLabel("Kode Instansi")%></label></td>
                            <td><asp:TextBox ID="txtPartnerCode" Width="200px" runat="server" /></td>
                        </tr>
                        <tr>
                            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Nama Instansi")%></label></td>
                            <td><asp:TextBox ID="txtPartnerName" Width="100%" runat="server" /></td>
                        </tr>
                        <tr>
                ...
                <div class="containerTblEntryContent">
                    <table class="tblEntryContent" style="width:100%">
                        ...
                        <tr>
                            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Tipe Partner")%></label></td>
                            <td><dxe:ASPxComboBox ID="cboTestPartnerType" Width="100%" runat="server" /></td>
                        </tr>
                    </table>
                </div>
