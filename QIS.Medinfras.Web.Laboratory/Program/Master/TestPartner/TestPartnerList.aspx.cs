...
namespace QIS.Medinfras.Web.Laboratory.Program
{
    public partial class TestPartnerList : BasePageList
    {
        ...
        private string GetFilterExpression()
        {
            ...
            filterExpression += String.Format(DEFAULT_GRDVIEW_FILTER, Constant.BusinessObjectType.LABORATORIUM_RUJUKAN, AppSession.UserLogin.HealthcareID);
        ...
        {
            url = ResolveUrl("~/Program/Master/TestPartner/TestPartnerEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/TestPartner/TestPartnerEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
