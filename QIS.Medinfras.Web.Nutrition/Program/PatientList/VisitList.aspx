<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="VisitList.aspx.cs" Inherits="QIS.Medinfras.Web.Nutrition.Program.VisitList" %>
    ...
    <script type="text/javascript">
        ...
        function onCboPatientFromValueChanged() {
            ...
            if (cboValue == Constant.Facility.INPATIENT) {
                ...
                $('#trInpatientStatus').removeAttr('style');
            }
            else {
                $('#trRegistrationDate').removeAttr('style');
                $('#trInpatientStatus').attr('style', 'display:none');
            }
                                ...
                                <td>
                                    ...
                                    <table style="width:100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><asp:TextBox ID="txtServiceUnitName" ReadOnly="true" Width="245px" runat="server" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr id="trRegistrationDate" style="display:none">
                                    ...
                                    <asp:ListView runat="server" ID="lvwView">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <img class="imgLock <%# Eval("IsNeedNutritionAssesment").ToString() == "1" ? "imgDisabled" : "imgLink"%>"
                                                        title='<%=GetLabel("Need Nutrition Assessment")%>' src=' <%# ResolveUrl("~/Libs/Images/Toolbar/registration_notes.png") %>'
                                                        style='<%# Eval("IsNeedNutritionAssesment").ToString() == "True" ? "width:25px": "width:25px;display:none" %>'
                                                        alt="" />
                                                </td>
                                                <td align="center">
                                                    <img id="imgHasNutritionAnamnesis" src='<%= ResolveUrl("~/Libs/Images/Toolbar/medical_record_summary.png")%>'
                                                        title="<%=GetLabel("Has Nutrition Anamnesis")%>" alt="" style='<%# Eval("IsHasNutritionAnamnesis").ToString() == "True" ? "cursor: pointer;width:23px": "width:25px;display:none" %>' />
                                                </td>
                                            </tr>
