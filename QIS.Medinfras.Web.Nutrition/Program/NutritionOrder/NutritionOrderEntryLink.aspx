<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true" 
    CodeBehind="NutritionOrderEntryLink.aspx.cs" Inherits="QIS.Medinfras.Web.Nutrition.Program.NutritionOrderEntryLink" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    ...
    <div style="height:435px;overflow-y:auto;">
        <div class="pageTitle">
            <div style="font-size: 1.1em"><%=GetLabel("Order Makanan")%></div>
        </div>
                    ...
                    <table style="width:100%">
                        <tr>
                            <td>
                                 <table class="tblEntryContent">
                                    ...
                                    <tr>
                                        <td class="tdLabel"><label id="lblNutritionOrder" class="lblMandatory lblLink"><%=GetLabel("No. Order")%></label></td>
                                        <td><asp:TextBox ID="txtNutritionOrderNo" Width="150px" runat="server" /></td>
                                    </tr>
                                 </table>
                            </td>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td><asp:TextBox runat="server" ID="txtDiagnoseID" Width="100%" /></td>
                                        <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td class="tdLabel" style="width:145px"><%=GetLabel("Tanggal") %> / <%=GetLabel("Jam Order") %></td>
                                        <td>
                                        <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="padding-right: 1px"><asp:TextBox ID="txtOrderDate" Width="120px" CssClass="datepicker" runat="server" /></td>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td class="tdLabel" style="width:55px"><%=GetLabel("Diagnosis Text") %></td>
                                        <td><asp:TextBox ID ="txtDiagnose" Width = "320px" runat="server" TextMode="MultiLine"/></td>
                                    </tr>
                                     <tr>
                                        <td class="tdLabel" style="width:55px"><%=GetLabel("Agama") %></td>
                                        <td><asp:TextBox ID ="txtAgama" Width = "80px" runat="server" ReadOnly ="true"/></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <fieldset id="fsTrx" style="margin:0"> 
                        ...
                        <table class="tblEntryDetail">
                            <colgroup>
                             ...
                             <tr>
                                <td style="width:10%"><label class="lblLink lblMandatory" id="lblMealPlan"><%=GetLabel("Panel Menu") %></label></td>
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td  >&nbsp;</td>
                                            <td class="tdLabel" width="190px" align="right"><label class="lblMandatory"><%=GetLabel("Menu Hari Ke-")%></label></td>
                                            <td align="right"><dxe:ASPxComboBox runat="server" ID="cboMealDay" ClientInstanceName="cboMealDay" Width="90px"/></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Jadwal Makan")%></label></td>
                                <td><dxe:ASPxComboBox runat="server" ID="cboMealTime" ClientInstanceName="cboMealTime" Width="300px"/></td>
                            </tr>
                            <tr>
                                <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Status Makan")%></label></td>
                                <td><dxe:ASPxComboBox runat="server" ID="cboMealStatus" ClientInstanceName="cboMealStatus" Width="300px"/></td>
                            </tr>
                            <tr>
                                <td style="width:10%"><label class="lblLink lblMandatory" id="lblParamedic"><%=GetLabel("Dokter") %></label></td>
                                <td>
                                   <table cellpadding="0" cellspacing="0">
                                        <colgroup>
                                            <col style="width:30%"/>
                            ...
                            <tr>
                                <td style="width:10%;" valign="top"><%=GetLabel("Catatan") %></td>
                                    ...
                                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                                        <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="MealTime" HeaderText="Jadwal Makan" />
                                                <asp:BoundField DataField="MealPlanName" HeaderText="Panel Menu" />
                                                <asp:BoundField DataField="MealDay" HeaderText="Hari Ke-" ItemStyle-HorizontalAlign="Right" />
