<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true" 
    CodeBehind="NutritionOrderListLink.aspx.cs" Inherits="QIS.Medinfras.Web.Nutrition.Program.NutritionOrderListLink" %>
                                    ...
                                    <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <div><%#: Eval("PatientName") %> (<%#: Eval("DateOfBirthInString") %>, <%#: Eval("Sex") %>, <%#: Eval("MedicalNo") %>, <%#: Eval("Religion")%>)</div>                                           
                                                </td>
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <div><asp:Label runat="server" ID="lblNutritionInformation1" /></div>
                                                            </td>
                                                        </tr>    
                                                        <tr>
                                                            <td>
                                                                <div><asp:Label runat="server" ID="lblNutritionInformation2" /></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div><asp:Label runat="server" ID="lblNutritionInformation3" /></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div><asp:Label runat="server" ID="lblNutritionInformation4" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
