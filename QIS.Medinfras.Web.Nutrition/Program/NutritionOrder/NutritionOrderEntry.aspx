<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true" 
    CodeBehind="NutritionOrderEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Nutrition.Program.NutritionOrderEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    ...
    <div style="height:435px; overflow-y:auto;">
        <div class="pageTitle">
            <div style="font-size: 1.1em"><%=GetLabel("Nutrition Order")%></div>
        </div>
                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                         <td class="tdLabel"><label class="lblLink" id="lblDiagnose"><%=GetLabel("Diagnose")%></label></td>
                                         <td>                        
                    ...
                    <fieldset id="fsTrx" style="margin:0"> 
                        ...
                        <table class="tblEntryDetail">
                            ...
                            <tr>
                                ...
                                <td><dxe:ASPxComboBox runat="server" ID="cboMealDay" ClientInstanceName="cboMealDay" Width="300px"/></td>
                            </tr>
                            <tr>
