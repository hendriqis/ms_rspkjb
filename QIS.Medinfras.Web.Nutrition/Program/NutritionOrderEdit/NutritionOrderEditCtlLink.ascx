<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NutritionOrderEditCtlLink.ascx.cs"
    Inherits="QIS.Medinfras.Web.Nutrition.Program.NutritionOrderEditCtlLink" %>
...
<div class="pageTitle"><%=GetLabel("Detail Order Makanan")%></div>
                    ...
                    <tr>
                        <td>
                            <table style="width:100%" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td class="tdLabel"><label id="Label1" class="lblNormal"><%=GetLabel("No. Order")%></label></td>
                                    <td><asp:TextBox ID="txtNutritionOrderNo" Width="190px" runat="server" ReadOnly="true" /></td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="tdLabel"><label class="lblNormal" id="lblDiagnose"><%=GetLabel("Diagnose")%></label></td>
                                    <td>                        
                                        <table style="width:100%" cellpadding="0" cellspacing="0" >
                                            <colgroup>
                                                <col style="width:30%"/>
                                            ...
                                            <tr>
                                                <td><asp:TextBox runat="server" ID="txtDiagnoseID" Width="120px" ReadOnly="true" /></td>
                                                <td>&nbsp;</td>
                                                <td><asp:TextBox runat="server" ID="txtDiagnoseName" ReadOnly="true" Width="100%" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table style="width:100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="padding-right: 1px"><asp:TextBox ID="txtOrderDate" Width="100px" CssClass="datepicker" runat="server" ReadOnly="true" /></td>
                        ...
                        <td>
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="tdLabel" style="width:55px"><%=GetLabel("Agama") %></td>
                                    <td><asp:TextBox ID ="txtReligion" Width = "80px" runat="server" ReadOnly ="true"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <div id="containerEntry" style="margin-top:4px;display:none;">
                    ...
                    <fieldset id="fsTrx" style="margin:0"> 
                        ...
                        <table class="tblEntryDetail">
                            ...
                            <tr>
                                 <td style="width:10%"><label class="lblLink lblMandatory" id="lblMealPlan"><%=GetLabel("Meal Plan") %></label></td>
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><asp:TextBox runat="server" id="txtMealPlanName" Width="200px" readonly="true" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Meal Time")%></label></td>
                                <td><dxe:ASPxComboBox runat="server" ID="cboMealTime" ClientInstanceName="cboMealTime" Width="300px"/></td>
                            </tr>
                             <tr>
                                <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Meal Status")%></label></td>
                                <td><dxe:ASPxComboBox runat="server" ID="cboMealStatus" ClientInstanceName="cboMealStatus" Width="300px"/></td>
                            </tr>
                            <tr>
                                <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Meal Day")%></label></td>
                                <td><asp:Textbox runat="server" ID="txtMealDay" Width="70px" ReadOnly="true" CssClass="number" /></td>
                            </tr>
                            <tr>
                                <td style="width:10%"><label class="lblLink lblMandatory" id="lblParamedic"><%=GetLabel("Paramedic") %></label></td>
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <colgroup>
                                            <col style="width:30%"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><asp:TextBox runat="server" id="txtParamedicName" Width="200px" readonly="true" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:10%;" valign="top"><%=GetLabel("Remarks") %></td>
                                <td><asp:TextBox runat="server" Width="300px" Rows="2" id="txtRemarks" TextMode="MultiLine" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <table width="100%">
                        ...
                        <PanelCollection>
                            <dx:PanelContent ID="PanelContent1" runat="server">
                                <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                                    <asp:GridView ID="grdPopupView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <img class="imgPopupEdit <%# Eval("GCItemDetailStatus").ToString() != "X121^002" ? "imgDisabled" : "imgLink"%>" title='<%=GetLabel("Edit")%>' 
                                                         src='<%# Eval("GCItemDetailStatus").ToString() != "X121^002" ? ResolveUrl("~/Libs/Images/Button/edit_disabled.png") : ResolveUrl("~/Libs/Images/Button/edit.png")%>' alt="" />
                                                    <img class="imgPopupDelete <%# Eval("GCItemDetailStatus").ToString() != "X121^002" ? "imgDisabled" : "imgLink"%>" title='<%=GetLabel("Delete")%>' 
                                                         src='<%# Eval("GCItemDetailStatus").ToString() != "X121^002" ? ResolveUrl("~/Libs/Images/Button/delete_disabled.png") : ResolveUrl("~/Libs/Images/Button/delete.png")%>' alt="" />
                                            ...
                                            <asp:BoundField DataField="MealDay" HeaderText="Hari Ke-" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
