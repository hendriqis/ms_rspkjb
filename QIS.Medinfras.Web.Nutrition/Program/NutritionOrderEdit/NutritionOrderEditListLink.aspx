...
CodeBehind="NutritionOrderEditListLink.aspx.cs" Inherits="QIS.Medinfras.Web.Nutrition.Program.NutritionOrderEditListLink" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.imgEdit').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/NutritionOrderEdit/NutritionOrderEditCtlLink.ascx");
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="NutritionOrderNo" HeaderText="No. Order" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left" />
                                ...
                                <asp:BoundField DataField="NutritionOrderDateInString" HeaderText="Tanggal" HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            </Columns>
                            <EmptyDataTemplate>
