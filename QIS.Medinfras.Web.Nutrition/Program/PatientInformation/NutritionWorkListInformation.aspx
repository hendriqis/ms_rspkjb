<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true"
    CodeBehind="NutritionWorkListInformation.aspx.cs" Inherits="QIS.Medinfras.Web.Nutrition.Program.NutritionWorkListInformation" %>
...
//        }
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            var serviceUnitName = cboServiceUnit.GetValue();

            if (code == 'NT090103') {
                filterExpression.text = scheduleDate + '|' + mealTime + '|' + serviceUnitName;
                return true;
            }
        }
                            ...
                            <asp:Panel runat="server" ID="Panel2" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemTemplate>
                                                <label class="lblNormal">
                                                    <%#:Eval("MealPlanCode") %>-<%#:Eval("MealPlanName") %></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="JumlahPorsi" HeaderText="Jumlah Porsi" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="120px" />
                                    </Columns>
                                    <EmptyDataTemplate>
