...
{
    public partial class NutritionIngredientsInformation : BasePageTrx
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Nutrition.NUTRITION_INGREDIENTS_INFORMATION;
        }
        ...
        {
            List<vNutritionIngredientsInformation> lstEntity = BusinessLayer.GetvNutritionIngredientsInformationList(GetFilterExpression());
