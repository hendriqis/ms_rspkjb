...
namespace QIS.Medinfras.Web.Nutrition.Program
{
    public partial class FoodList : BasePageList
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            switch (MenuID)
            {
                case Constant.ItemGroupMaster.NUTRITION: return Constant.MenuCode.Nutrition.FOOD;
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvItemFoodRowIndex(filterExpression, keyValue, "ItemCode ASC") + 1;
        ...
        {
            fieldListText = new string[] { "Nama Bahan", "Kode Bahan" };
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvItemFoodRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_MASTER);
            }

            List<vItemFood> lstEntity = BusinessLayer.GetvItemFoodList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "ItemName1 ASC");
        ...
        {
            String GCItemType = Request.QueryString["id"];
            url = ResolveUrl(string.Format("~/Program/Master/Food/FoodEntry.aspx", GCItemType));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/Food/FoodEntry.aspx?id={0}",hdnID.Value));
                return true;
            }
            return false;
        }
