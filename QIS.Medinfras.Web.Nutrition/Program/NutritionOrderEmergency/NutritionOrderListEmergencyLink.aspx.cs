...
{
    public partial class NutritionOrderListEmergencyLink : BasePageContent
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Nutrition.NUTRITION_ORDER_EMERGENCY;
        ...
        private string GetResponseRedirectUrl(vConsultVisit entity)
        {
            string url = "";
            string id = Page.Request.QueryString["id"];
            url = string.Format("~/Program/NutritionOrderEmergency/NutritionOrderEntryEmergencyLink.aspx?id={0}", entity.RegistrationNo);
            return url;
        }
