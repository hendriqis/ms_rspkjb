<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="NutritionalAssessmentList1.aspx.cs" Inherits="QIS.Medinfras.Web.Nutrition.Program.NutritionalAssessmentList1" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ADIME" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <div style="height: 130px; overflow-y: auto; <%# Eval("IsRevised").ToString() == "True" ? "font-style:italic; text-decoration: line-through": "" %>">
                                            <%#Eval("ADIMEText").ToString().Replace("\n","<br />")%><br />
                                        </div>
                            ...
                            <EmptyDataTemplate>
                                <%=GetLabel("Tidak ada pengkajian gizi untuk pasien ini") %>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </asp:Panel>
                </dx:PanelContent>
