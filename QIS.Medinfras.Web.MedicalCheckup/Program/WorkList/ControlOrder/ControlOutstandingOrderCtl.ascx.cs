...
namespace QIS.Medinfras.Web.MedicalCheckup.Program
{
    public partial class ControlOutstandingOrderCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            hdnHealthcareServiceUnitIDCtl.Value = temp[6];
            ...
            String filterExpression = string.Format("HealthcareID = '{0}' AND DepartmentID NOT IN ('{1}','{2}','{3}') AND HealthcareServiceUnitID != {4} AND IsDeleted = 0",
                    AppSession.UserLogin.HealthcareID, Constant.Facility.INPATIENT, Constant.Facility.PHARMACY, Constant.Facility.MEDICAL_CHECKUP, hdnHealthcareServiceUnitIDCtl.Value);
