<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="VisitList.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalCheckup.Program.VisitList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        ...
        $('#<%=chkIsIncludeHasBillingNotes.ClientID %>').die();
        $('#<%=chkIsIncludeHasBillingNotes.ClientID %>').live('change', function () {
            onRefreshGridView();
        });
    </script>
                ...
                <td style="padding: 5px; vertical-align: top">
                    <fieldset id="fsPatientList">
                        <table class="tblEntryContent" style="width: 60%;">
                            ...
                            <tr id="IsHasBillingNotes" runat="server" style="display:none;">
                                <td>
                                </td>
                                <td align="left" colspan="2">
                                    <asp:CheckBox ID="chkIsIncludeHasBillingNotes" runat="server" Checked="false" Text="Memiliki Catatan Billing" />
                                </td>
                            </tr>
                            <tr id="trIsShowRegistrationStatus" runat="server">
                                <td class="tdLabel">
                                    <label class="lblNormal">
                                        <%=GetLabel("Tampilan Registrasi")%></label>
                                </td>
                                <td>
