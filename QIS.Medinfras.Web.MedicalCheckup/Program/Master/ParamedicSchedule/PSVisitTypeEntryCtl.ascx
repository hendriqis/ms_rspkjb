MedicalCheckup<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PSVisitTypeEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.MedicalCheckup.Program.PSVisitTypeEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunithealthcareentryctl">
    $('#lblEntryPopupAddDataVisitType').live('click', function () {
        cboVisitType.SetEnabled(true);

        $('#<%=hdnVisitTypeID.ClientID %>').val('');
        cboVisitType.SetValue('');
    ...
    $('.imgEdit.imgLink').live('click', function () {
        ...
        cboVisitType.SetValue(visitTypeID);
        $('#<%=txtVisitDuration.ClientID %>').val(visitDuration);

        cboVisitType.SetEnabled(false);
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                    ...
                    <fieldset id="fsEntryPopup" style="margin: 0">
                        <table class="tblEntryDetail" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxComboBox ID="cboVisitType" ClientInstanceName="cboVisitType" runat="server"
                                        Width="200px" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtVisitDuration" CssClass="number required" runat="server" Width="100px" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="VisitTypeName" ItemStyle-CssClass="tdVisitTypeName" HeaderText="Visit Type" />
                                        <asp:BoundField HeaderStyle-Width="80px" DataField="VisitDuration" ItemStyle-CssClass="tdVisitDuration"
                                            HeaderText="Visit Duration" ItemStyle-HorizontalAlign="Right" />
                                    </Columns>
                                    <EmptyDataTemplate>
                ...
                <div style="width: 100%; text-align: center" id="divContainerAddData" runat="server">
                    <span class="lblLink" id="lblEntryPopupAddDataVisitType">
