<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddMCUPackageCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.MedicalCheckup.Program.AddMCUPackageCtl" %>
