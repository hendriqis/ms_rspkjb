<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AppointmentRescheduleCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.MedicalCheckup.Program.AppointmentRescheduleCtl" %>
