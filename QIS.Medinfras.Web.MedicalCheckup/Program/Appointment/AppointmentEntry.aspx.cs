    ...
    public partial class AppointmentEntry : BasePageTrx
    {
        public override string OnGetMenuCode()
        {
            switch (hdnDepartmentID.Value)
            {
                ...
                default: return Constant.MenuCode.MedicalCheckup.MCU_APPOINTMENT;
            }
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            Helper.SetControlEntrySetting(txtItemCode, new ControlEntrySetting(true, false, true), "mpAppointment");
        ...
        private void InitializeControlProperties()
        {
            ...
            serviceUnitUserCount = BusinessLayer.GetvServiceUnitUserRowCount(string.Format("DepartmentID = '{0}' AND HealthcareID = '{1}' AND UserID = {2}", Constant.Facility.MEDICAL_CHECKUP, AppSession.UserLogin.HealthcareID, AppSession.UserLogin.UserID));

             string filterExpression = string.Format("IsUsingRegistration = 1 AND HealthcareID = '{0}' AND DepartmentID = '{1}' AND IsDeleted = 0", AppSession.UserLogin.HealthcareID, Constant.Facility.MEDICAL_CHECKUP);
            ...
            List<StandardCode> lstStandardCode = BusinessLayer.GetStandardCodeList(string.Format("ParentID IN ('{0}','{1}','{2}') AND IsDeleted = 0 AND IsActive = 1", Constant.StandardCode.TITLE, Constant.StandardCode.CUSTOMER_TYPE, Constant.StandardCode.APPOINTMENT_METHOD));
            ...
            List<StandardCode> lstSc = BusinessLayer.GetStandardCodeList(string.Format("ParentID = '{0}' AND IsDeleted = 0", Constant.StandardCode.GENDER));
            Methods.SetComboBoxField<StandardCode>(cboGenderAppointment, lstSc, "StandardCodeName", "StandardCodeID");
                ...
                if (obj != null && objSchDate == null)
                {
                    ...
                    if (cboSession.Value.ToString() == "0" || cboSession.Value.ToString() == "1" || cboSession.Value.ToString() == "2" || cboSession.Value.ToString() == "3" || cboSession.Value.ToString() == "4")
                    {
                        if (cboSession.Value.ToString() == "0")
                        {
                            ...
                            {
                                txtMaximumAppointment.Text = obj.MaximumAppointment1.ToString();
                            ...
                            {
                                txtMaximumWaitingList.Text = obj.MaximumWaitingList1.ToString();
                        ...
                        else if (cboSession.Value.ToString() == "1")
                        {
                            ...
                            {
                                txtMaximumAppointment.Text = obj.MaximumAppointment2.ToString();
                                tdMaxAppointmentHeader.Style.Remove("display");
                                tdMaxAppointmentFooter.Style.Remove("display");
                            ...
                            {
                                txtMaximumWaitingList.Text = obj.MaximumWaitingList2.ToString();
                                tdMaxWaitingHeader.Style.Remove("display");
                                tdMaxWaitingFooter.Style.Remove("display");
                        ...
                        else if (cboSession.Value.ToString() == "2")
                        {
                            ...
                            {
                                txtMaximumAppointment.Text = obj.MaximumAppointment3.ToString();
                                tdMaxAppointmentHeader.Style.Remove("display");
                                tdMaxAppointmentFooter.Style.Remove("display");
                            ...
                            {
                                txtMaximumWaitingList.Text = obj.MaximumWaitingList3.ToString();
                                tdMaxWaitingFooter.Style.Remove("display");
                                tdMaxWaitingHeader.Style.Remove("display");
                        ...
                        else if (cboSession.Value.ToString() == "3")
                        {
                            ...
                            {
                                txtMaximumAppointment.Text = obj.MaximumAppointment4.ToString();
                                tdMaxAppointmentHeader.Style.Remove("display");
                                tdMaxAppointmentFooter.Style.Remove("display");
                            ...
                            {
                                txtMaximumWaitingList.Text = obj.MaximumWaitingList4.ToString();
                                tdMaxWaitingHeader.Style.Remove("display");
                                tdMaxWaitingFooter.Style.Remove("display");
                        ...
                        if (cboSession.Value.ToString() == "4")
                        {
                            ...
                            {
                                txtMaximumAppointment.Text = obj.MaximumAppointment5.ToString();
                                tdMaxAppointmentHeader.Style.Remove("display");
                                tdMaxAppointmentFooter.Style.Remove("display");
                            ...
                            {
                                txtMaximumWaitingList.Text = obj.MaximumWaitingList5.ToString();
                                tdMaxWaitingHeader.Style.Remove("display");
                                tdMaxWaitingFooter.Style.Remove("display");
                    ...
                    if (objSchDate != null)
                    {
                        ...
                        if (cboSession.Value.ToString() == "0" || cboSession.Value.ToString() == "1" || cboSession.Value.ToString() == "2" || cboSession.Value.ToString() == "3" || cboSession.Value.ToString() == "4")
                        {
                            if (cboSession.Value.ToString() == "0")
                            {
                                ...
                                {
                                    txtMaximumAppointment.Text = objSchDate.MaximumAppointment1.ToString();
                                    tdMaxAppointmentHeader.Style.Remove("display");
                                    tdMaxAppointmentFooter.Style.Remove("display");
                                ...
                                {
                                    txtMaximumWaitingList.Text = objSchDate.MaximumWaitingList1.ToString();
                                    tdMaxWaitingHeader.Style.Remove("display");
                                    tdMaxWaitingFooter.Style.Remove("display");
                            ...
                            else if (cboSession.Value.ToString() == "1")
                            {
                                ...
                                {
                                    txtMaximumAppointment.Text = objSchDate.MaximumAppointment2.ToString();
                                    tdMaxAppointmentHeader.Style.Remove("display");
                                    tdMaxAppointmentFooter.Style.Remove("display");
                                ...
                                {
                                    txtMaximumWaitingList.Text = objSchDate.MaximumWaitingList2.ToString();
                                    tdMaxWaitingHeader.Style.Remove("display");
                                    tdMaxWaitingFooter.Style.Remove("display");
                            ...
                            else if (cboSession.Value.ToString() == "2")
                            {
                                ...
                                {
                                    txtMaximumAppointment.Text = objSchDate.MaximumAppointment3.ToString();
                                    tdMaxAppointmentHeader.Style.Remove("display");
                                    tdMaxAppointmentFooter.Style.Remove("display");
                                ...
                                {
                                    txtMaximumWaitingList.Text = objSchDate.MaximumWaitingList3.ToString();
                                    tdMaxWaitingHeader.Style.Remove("display");
                                    tdMaxWaitingFooter.Style.Remove("display");
                            ...
                            else if (cboSession.Value.ToString() == "3")
                            {
                                ...
                                {
                                    txtMaximumAppointment.Text = objSchDate.MaximumAppointment4.ToString();
                                    tdMaxAppointmentHeader.Style.Remove("display");
                                    tdMaxAppointmentFooter.Style.Remove("display");
                                ...
                                {
                                    txtMaximumWaitingList.Text = objSchDate.MaximumWaitingList4.ToString();
                                    tdMaxWaitingHeader.Style.Remove("display");
                                    tdMaxWaitingFooter.Style.Remove("display");
                            ...
                            if (cboSession.Value.ToString() == "4")
                            {
                                ...
                                {
                                    txtMaximumAppointment.Text = objSchDate.MaximumAppointment5.ToString();
                                    tdMaxAppointmentHeader.Style.Remove("display");
                                    tdMaxAppointmentFooter.Style.Remove("display");
                                ...
                                {
                                    txtMaximumWaitingList.Text = objSchDate.MaximumWaitingList5.ToString();
                                    tdMaxWaitingHeader.Style.Remove("display");
                                    tdMaxWaitingFooter.Style.Remove("display");
        ...
        protected override bool OnCustomButtonClick(string type, ref string errMessage)
        {
            ...
            AppointmentItemPackageDao appointmentItemPackageDao = new AppointmentItemPackageDao(ctx);
            Appointment entity = null;
            Guest entityGuest = null;
            AppointmentItemPackage entityAppointmentItemPackage = null;
                        ...
                        else
                        {
                            if (hdnAppointmentID.Value != "")
                            {
                                ...
                                else
                                {
                                    ...
                                    if (txtDOB.Text != "")
                                    {
                                        entityGuest.DateOfBirth = Convert.ToDateTime(txtDOB.Text);
                                    }
                            ...
                            else
                            {
                                ...
                                entity.TransactionCode = Constant.TransactionCode.MCU_APPOINTMENT;
                                            ...
                                            if (AppointmentStart.TimeOfDay >= objSchStart5.TimeOfDay && AppointmentEnd.TimeOfDay <= objSchEnd5.TimeOfDay)
                                            {
                                                if (isValidMRN)
                                                {
                                                    ...
                                                    if (newQueue == 0)
                                                    {
                                                        ...
                                                        entity.QueueNo = Convert.ToInt16(BusinessLayer.GetQueueNo(entity.HealthcareServiceUnitID, Convert.ToInt32(entity.ParamedicID), entity.StartDate, (Convert.ToInt32(cboSession.Value) + 1), false, isBPJS, 0));
                                                    }
                                                    else
                                                    {
                                                    ...
                                                    apmID = entityDao.InsertReturnPrimaryKeyID(entity);

                                                    InsertAppointmentItemPackageTariff(apmID, Convert.ToInt32(hdnClassID.Value), Convert.ToInt32(hdnItemID.Value), entity.StartDate, ctx, entityAppointmentItemPackage, appointmentItemPackageDao);
