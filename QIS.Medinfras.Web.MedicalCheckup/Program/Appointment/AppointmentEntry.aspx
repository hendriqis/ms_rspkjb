<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="AppointmentEntry.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalCheckup.Program.AppointmentEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#<%=btnAppointmentSave.ClientID %>').click(function (evt) {
                if ($('.grdAppointment li.selected').length == 0) {
                    showToast('Warning', 'Tidak bisa membuat appointment karena tidak ada slot yang dipilih. Harap pilih slot.');
                }
                else {
            ...
            $('#<%=btnAppointmentChangeAppointment.ClientID %>').click(function () {
                if ($('#<%=hdnAppointmentID.ClientID %>').val() != '') {
                    if ($('#<%=hdnGCAppointmentStatus.ClientID %>').val() == Constant.AppointmentStatus.COMPLETE) {
                        ...
                        var url = ResolveUrl("~/Program/Appointment/AppointmentChangeDateCtl1.ascx");
            ...
            $('#<%=btnReschedule.ClientID %>').click(function () {
                var url = ResolveUrl("~/Program/Appointment/AppointmentRescheduleCtl.ascx");
                var departmentID = $('#<%=hdnDepartmentID.ClientID %>').val();
            ...
            $('#<%=chkIsNewPatient.ClientID %>').live('change', function (evt) {
                if ($(this).is(":checked")) {
                    ...
                    $('#<%=trDOB.ClientID %>').attr('style', 'display:none');
                    ...
                    $('#<%=trDOB.ClientID %>').removeAttr('style');
                ...
                if (appointmentID > -2) {
                    ...
                    if (appointmentID > -1) {
                        ...
                        Methods.getObject('GetvAppointmentList', filterExpression, function (result) {
                            ...
                            var dateOfBirthInString = result.cfDateOfBirthInString;
                            var mrn = result.MRN;
                            ...
                            $('#<%=txtDOB.ClientID %>').val(dateOfBirthInString);
                            ...
                            Methods.getObject('GetvAppointmentItemPackageList', filterExpression, function (resultItem) {
                                if (resultItem != null) {
                                    $('#<%=hdnItemID.ClientID %>').val(resultItem.ItemID);
                                    $('#<%=txtItemCode.ClientID %>').val(resultItem.ItemCode);
                                    $('#<%=txtItemName.ClientID %>').val(resultItem.ItemName1);
                                }
                                else {
        ...
        function onTxtMRNChanged(value) {
            ...
            Methods.getObject('GetvPatientList', filterExpression, function (result) {
                if (result != null) {
                    ...
                    var masterCorporateAccountName = result.CorporateAccountName;
                    var gender = result.Gender;
                    var dob = result.DateOfBirthInString;
        ...
        function getPayerCompanyFilterExpression() {
            var filterExpression = "<%:GetCustomerFilterExpression()%> AND GCCustomerType = '" + cboAppointmentPayer.GetValue() + "' AND IsDeleted = 0";
            return filterExpression;
        }
                                                ...
                                                <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height: 200px">
                                                    <asp:GridView ID="grdPhysician" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="ParamedicCode" HeaderText="Physician Code" ItemStyle-CssClass="tdParamedicCode" Visible=false />
                ...
                <fieldset id="fsAppointment" style="margin: 0">
                    ...
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtAppointmentHour" runat="server" Width="100%"
                                    CssClass="time" />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr id="trDOB" runat="server">
                            ...
                            <td>
                                <asp:TextBox ID="txtDOB" ReadOnly="true" Width="100%" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel" style="vertical-align: top; padding-top: 5px;">
