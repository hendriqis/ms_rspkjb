<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="PurchaseRequestApproval.aspx.cs" Inherits="QIS.Medinfras.Web.Pharmacy.Program.PurchaseRequestApproval" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPurchaseRequestApprovalProcess" CRUDMode="R" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbset.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Process")%></div></li>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">   
    ...
    <div style="height:500px;overflow-y:auto;">
        <div class="pageTitle">
            <div style="font-size: 1em"><%=GetLabel("Purchase Request Approval")%></div>
        </div>
