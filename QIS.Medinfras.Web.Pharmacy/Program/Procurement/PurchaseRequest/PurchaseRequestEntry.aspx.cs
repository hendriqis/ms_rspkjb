...
namespace QIS.Medinfras.Web.Pharmacy.Program
{
    public partial class PurchaseRequestEntry : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.Pharmacy.PURCHASE_REQUEST;
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            hdnLedItemFilterExpression.Value = string.Format("LocationID = [LocationID] AND GCItemType = '{0}' AND IsDeleted = 0", Constant.ItemGroupMaster.DRUGS);
        }

        protected void cboUoM_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            Methods.SetComboBoxField<StandardCode>(cboUoM, lst, "StandardCodeName", "StandardCodeID");
        ...
        protected override void SetControlProperties()
        {
            ...
            //hdnLedDrugMSItemFilterExpression.Value = string.Format("LocationID = [LocationID] AND GCItemType = '{0}' AND IsDeleted = 0", Constant.ItemGroupMaster.DRUGS);
            ledItem.FilterExpression = string.Format("GCItemType = '{0}' AND IsDeleted = 0", Constant.ItemGroupMaster.DRUGS);
            ledSupplier.FilterExpression = string.Format("GCBusinessPartnerType = '{0}' AND (HealthcareID = '{1}' OR HealthcareID IS NULL) AND IsDeleted = 0", Constant.BusinessObjectType.SUPPLIER, AppSession.UserLogin.HealthcareID);
        }
