...
{
    public partial class MedicationList1 : BasePagePatientPageList
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            hdnServiceUnitID.Value = AppSession.RegisteredPatient.HealthcareServiceUnitID.ToString();
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            try
            {
                ...
                hdnDisplayMode.Value = cboDisplay.Value.ToString();
                

                List<PatientMedicationSummary> lstEntity = BusinessLayer.GetPatientMedicationSummaryList(AppSession.RegisteredPatient.RegistrationID, hdnDisplayMode.Value, cboMedicationStatus.Value.ToString());
        ...
        {
            return Constant.MenuCode.Pharmacy.MEDICATION_LIST_SUMMARY;
        }
