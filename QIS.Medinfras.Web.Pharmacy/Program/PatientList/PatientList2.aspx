<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master" AutoEventWireup="true" 
    CodeBehind="PatientList2.aspx.cs" Inherits="QIS.Medinfras.Web.Pharmacy.Program.PatientList2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <div style="padding:0px; background-color:Red">
        <div style="padding:0px;background-color:Red" id="containerDaftar" class="containerOrder">
