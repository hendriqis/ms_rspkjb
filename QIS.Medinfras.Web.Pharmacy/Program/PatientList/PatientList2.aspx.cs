...
{
    public partial class PatientList2 : BasePageTrx
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                hdnPageTitle.Value = ((MPMain)Master).ListMenu.FirstOrDefault(p => p.MenuCode == OnGetMenuCode()).MenuCaption;
            }
        }
        ...
        //{
        //    vConsultVisit9 entity = BusinessLayer.GetvConsultVisit9List(string.Format("VisitID = {0}", transactionNo)).FirstOrDefault();
        //    if (entity != null)
        //    {
