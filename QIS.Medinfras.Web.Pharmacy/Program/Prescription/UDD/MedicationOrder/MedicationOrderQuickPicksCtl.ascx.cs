...
{
    public partial class MedicationOrderQuickPicksCtl : BaseEntryPopupCtl
    {
        protected int PageCount = 1;
        private string[] lstSelectedMember = null;

        private MedicationOrderEntry DetailPage
        {
            get { return (MedicationOrderEntry)Page; }
        }
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                DetailPage.SavePrescriptionHd(ctx, ref prescriptionOrderID,ref transactionID, ref transactionNo);

                PrescriptionOrderHd orderHd = entityOrderHdDao.Get(prescriptionOrderID);
                if (orderHd.GCTransactionStatus == Constant.TransactionStatus.APPROVED)
                {
                    ...
                    foreach (String itemID in lstSelectedMember)
                    {
                        ...
                        entity.IsUsingUDD = lstSelectedMemberIsUsingUDD[ct] == "1";
