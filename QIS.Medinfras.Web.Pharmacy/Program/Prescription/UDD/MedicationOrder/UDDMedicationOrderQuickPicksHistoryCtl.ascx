<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UDDMedicationOrderQuickPicksHistoryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.UDDMedicationOrderQuickPicksHistoryCtl" %>
        ...
        <tr>
            ...
            <td style="padding:2px;vertical-align:top">
                ...
                <table cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td class="tdLabel" valign="top" style="padding-top:5px;"><label><%=GetLabel("Jenis Transaksi BPJS")%></label></td>
                        <td colspan="3"><dxe:ASPxComboBox ID="cboBPJSTransType" runat="server" Width="100%"></dxe:ASPxComboBox></td>
                    </tr>
                </table>
                        ...
                        <PanelCollection>
                            <dx:PanelContent ID="PanelContent2" runat="server">
                                <asp:Panel runat="server" ID="Panel1" CssClass="pnlContainerGridPatientPage">
                                    <asp:GridView ID="grdPopupViewDt" runat="server" CssClass="grdSelected grdPatientPage" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" OnRowDataBound="grdPopupViewDt_RowDataBound" EmptyDataRowStyle-CssClass="trEmpty">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                ...
                                                <ItemTemplate>
                                                    <div id="divItemName" runat="server" style="font-weight:bold"><span class="itemName"><%#: Eval("cfMedicationName")%></span></div>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Jumlah Diorder" >
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Jumlah Diambil" >
                                                <ItemTemplate>
                                                    <input type="hidden" value='<%#:Eval("GCItemUnit")%>' class="hdnGCItemUnit" />
                                                    <input type="number" value='<%#:Eval("TakenQty")%>' validationgroup="mpMedicationOrderHistoryQty" class="txtTakenQty" min="0" value="0" style="width:40px; text-align: right" /> <%#:Eval("ItemUnit") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
