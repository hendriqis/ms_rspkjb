<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UDDMedicationOrderCompoundEntryCtl2.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.UDDMedicationOrderCompoundEntryCtl2" %>
...
<table id="tblTemplate" style="width:100%" runat="server" cellpadding="0" cellspacing="0">
    <tr>
        <td style="width:179px;" class="tdLabel"><label id="lblTemplateCode" class="lblNormal lblLink" runat="server" style="padding-left:5px"><%=GetLabel("Template")%></label></td>
    ...
    <tr>
        <td valign="top">
            <table style="width:100%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Taken Qty")%></label></td>
                    <td><asp:TextBox runat="server" ID="txtTakenQty" Width="100%" CssClass="number" /></td>
                </tr>
                <tr>
...
<qis:QISSearchTextBox ID="ledProduct" ClientInstanceName="ledProduct" runat="server" FilterExpression="IsDeleted = 0"
    ValueText="ItemID" DisplayText="ItemName1" MethodName="GetvItemBalanceQuickPickList" ClientVisible="false" Width="99.9%" >
