<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UDDMedicationOrderQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.UDDMedicationOrderQuickPicksCtl" %>
...
<script type="text/javascript" id="dxss_drugslogisticsquickpicksctl">
    ...
    $('#<%=grdView.ClientID %> .chkIsSelected input').live('change', function () {
        if ($(this).is(':checked')) {
            ...
            $newTr = $newTr.replace(/\$\{GCItemUnit}/g, $selectedTr.find('.tdGCItemUnit').html());
            ...
            if (('<%=GetPrescriptionType() %>') == Constant.PrescriptionType.DISCHARGE_PRESCRIPTION) {
                $newTr = $newTr.replace("width:20px", "display:none");
            }
...
<div style="padding: 10px;">
    ...
    <input type="hidden" id="hdnOrderNotes" runat="server" value="" />
    ...
    <table style="width: 100%">
        ...
        <tr>
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <EmptyDataTemplate>
                                        <%=GetLabel("Tidak ada item persediaan yang tersedia di lokasi ini")%>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </asp:Panel>
                        </dx:PanelContent>
            ...
            <td style="padding: 5px; vertical-align: top">
                ...
                <div style="height: 400px; overflow-y: scroll; padding-top: 12px">
