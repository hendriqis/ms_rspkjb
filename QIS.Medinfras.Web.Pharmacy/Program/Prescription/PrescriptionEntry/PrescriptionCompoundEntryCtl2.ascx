<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionCompoundEntryCtl2.ascx.cs"
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.PrescriptionCompoundEntryCtl2" %>
...
<script type="text/javascript" id="dxss_prescriptioncompoundentryctl">
    ...
    $('#<%:lblTemplateCode.ClientID %>.lblLink').live('click', function () {
        ...
        openSearchDialog('compoundtemplate', "IsDeleted = 0", function (value) {
    ...
    function cboEmbalaceChanged() {
        var embalaceID = cboEmbalace.GetValue();
        var filterExpression = "EmbalaceID = " + embalaceID;
    ...
    window.init = function () {
        ...
        if (param[0] == "edit") {
            prescriptionDetailID = parseInt(param[5]);
        }

        if (prescriptionDetailID > -1) {
            var filterExpression = "PrescriptionOrderID = " + prescriptionOrderID + " AND (PrescriptionOrderDetailID = " + prescriptionDetailID + " OR ParentID = " + prescriptionDetailID + ") AND TransactionDetailID IS NOT NULL AND IsDeleted = 0";
    ...
    function fillTableData($row, entity) {
        ...
        grdCompound.setCellHiddenValue($row, 'hdnPrescriptionOrderDtID', entity.PrescriptionOrderDetailID);
    ...
    $('#<%=txtTakenQty.ClientID %>').live('change', function () {
...
<input type="hidden" id="hdnSelectedItem" value="" runat="server" />
...
<table id="tblTemplate" style="width: 100%" runat="server" cellpadding="0" cellspacing="0">
    <tr>
        <td style="width: 154px;" class="tdLabel">
            <label id="lblTemplateCode" class="lblNormal lblLink" runat="server" style="padding-left: 5px">
        ...
        <td valign="top">
            <table style="width: 100%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxComboBox ID="cboFrequencyTimelineCompoundCtl" ClientInstanceName="cboFrequencyTimelineCompoundCtl"
                ...
                <tr>
                    <td class="tdLabel">
                        <label class="lblNormal">
                            <%=GetLabel("Embalace - Qty")%></label>
                    </td>
                    <td colspan="2">
                        <dxe:ASPxComboBox ID="cboEmbalace" ClientInstanceName="cboEmbalace" runat="server"
                            Width="100%">
                            <ClientSideEvents SelectedIndexChanged="function(s,e){cboEmbalaceChanged()}" />
                        </dxe:ASPxComboBox>
                    </td>
                    ...
                    <td>
                        <asp:CheckBox runat="server" ID="chkIsPRN" /><%=GetLabel("PRN")%>
                    </td>
                </tr>
                <tr>
                    <td class="tdLabel">
        ...
        <td valign="top">
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtMedicationAdministration" Width="250px" runat="server" TextMode="MultiLine"
                            Height="50px" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtMedicationPurpose" Width="250px" runat="server" TextMode="MultiLine"
                            Height="50px" />
                    </td>
                </tr>
            </table>
...
<div style="width: 100%; height: 300px; overflow-y: scroll;">
    <table class="grdNormal" id="tblPrescriptionCompound" style="width: 100%; font-size: 0.95em"
        ...
        <tr>
            ...
            <th align="center" colspan="3">
                <%=GetLabel("COMPOUND FORMULA")%><span style="color:Red; font-weight:bold"><%=GetLabel(" (metode d.t.d)")%></span>
            </th>
        </tr>
        <tr>
            <th align="center">
...
<qis:QISSearchTextBox ID="ledProduct" ClientInstanceName="ledProduct" runat="server" FilterExpression="IsDeleted = 0 AND ISNULL(GCItemStatus,'') != 'X181^999'"
    ValueText="ItemID" DisplayText="ItemName1" MethodName="GetvItemBalanceQuickPick1List"
    ...
    <Columns>
        <qis:QISSearchTextBoxColumn Caption="Item Name" FieldName="ItemName1" Description="i.e. Panadol"
            Width="300px" />
