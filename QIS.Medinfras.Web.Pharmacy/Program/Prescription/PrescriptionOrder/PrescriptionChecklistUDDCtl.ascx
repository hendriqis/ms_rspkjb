<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionChecklistUDDCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.PrescriptionChecklistUDDCtl" %>
...
<script type="text/javascript" id="dxss_PrescriptionChecklistUDDCtl">
