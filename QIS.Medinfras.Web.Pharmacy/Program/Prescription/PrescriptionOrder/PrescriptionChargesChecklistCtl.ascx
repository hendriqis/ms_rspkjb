<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionChargesChecklistCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.PrescriptionChargesChecklistCtl" %>
                                    ...
                                    <td valign="top">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-weight: bold;">
                                                    <asp:Label ID="lblIsADChecked" runat="server" ToolTip="(Persyatratan Administrasi)" Text="AD">Persyatratan Administrasi (AD)</asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td style="font-weight: bold;">
                                                    <asp:Label ID="lblIsFARChecked" runat="server" ToolTip="(Persyaratan Farmasetik)" Text="FAR">Persyaratan Farmasetik (FAR)</asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td style="font-weight: bold;">
                                                    <asp:Label ID="lblIsKLNChecked" runat="server" ToolTip="(Persyaratan Klinis)" Text="KLN">Persyaratan Klinis (KLN)</asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
