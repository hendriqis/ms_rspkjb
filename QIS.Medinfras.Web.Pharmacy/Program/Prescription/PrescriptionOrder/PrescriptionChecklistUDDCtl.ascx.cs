...
{
    public partial class PrescriptionChecklistUDDCtl : BaseEntryPopupCtl
    {
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                if (orderHd != null)
                {
                    ...
                    {
                        if (orderHd.GCTransactionStatus == Constant.TransactionStatus.OPEN || orderHd.GCTransactionStatus == Constant.TransactionStatus.WAIT_FOR_APPROVAL)
                        {
