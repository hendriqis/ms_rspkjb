<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionReturnVoidCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.PrescriptionReturnVoidCtl" %>
