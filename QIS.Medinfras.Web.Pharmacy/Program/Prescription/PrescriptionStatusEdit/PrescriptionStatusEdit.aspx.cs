...
{
    public partial class PrescriptionStatusEdit : BasePageTrx
    {
        ...
        {
            string filterExpression = String.Format("DispensaryServiceUnitID = {0}", cboServiceUnit.Value.ToString());
            ...
            {
                case "containerProses1":
                    filterExpression += String.Format("AND GCTransactionStatus != '{0}' AND GCOrderStatus = '{1}'", Constant.TransactionStatus.VOID, Constant.OrderStatus.OPEN);
                    break;
                case "containerProses2":
                ...
                case "containerProses4":
                    ...
                    break;
                case "containerDone":
                    filterExpression += String.Format("AND GCTransactionStatus NOT IN ('{0}','{1}') AND GCOrderStatus = '{2}'", Constant.TransactionStatus.OPEN, Constant.TransactionStatus.VOID, Constant.OrderStatus.CLOSED);
                    break;
                default:
                    filterExpression += String.Format("AND GCTransactionStatus NOT IN ('{0}','{1}') AND GCOrderStatus = '{2}'", Constant.TransactionStatus.OPEN, Constant.TransactionStatus.VOID, Constant.OrderStatus.RECEIVED);
                    break;
