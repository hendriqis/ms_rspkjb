...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class SignaEntry : BasePageEntry
    {
        ...
        {
            List<StandardCode> lst = BusinessLayer.GetStandardCodeList(String.Format("ParentID IN ('{0}','{1}','{2}','{3}') AND IsDeleted = 0", Constant.StandardCode.DRUG_FORM, Constant.StandardCode.ITEM_UNIT, Constant.StandardCode.DOSING_FREQUENCY,Constant.StandardCode.COENAM_RULE));
            ...
            Methods.SetComboBoxField<StandardCode>(cboCoenamRule, lst.Where(p => p.ParentID == Constant.StandardCode.COENAM_RULE || p.StandardCodeName == "").ToList(), "StandardCodeName", "StandardCodeID");
        ...
        private void ControlToEntity(Signa entity)
        {
            ...
            entity.GCCoenamRule = cboCoenamRule.Value != null ? cboCoenamRule.Value.ToString() : null;
        }
