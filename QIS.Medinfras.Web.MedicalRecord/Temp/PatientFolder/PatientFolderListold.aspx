<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="PatientFolderListold.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.PatientFolderListold" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnMPListView" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbsave.png")%>' alt="" /><div><%=GetLabel("View")%></div></li>
</asp:Content>
        ...
        $(function () {
            ...
            $('#<%=btnMPListView.ClientID %>').click(function () {
                if ($('#<%=grdView.ClientID %> tr.selected').length > 0) {
                    ...
                    document.location = ResolveUrl('~/Program/PatientFolder/PatientFolderDetail.aspx?id=' + $('#<%=hdnID.ClientID %>').val());
                }
            });
        });
                        ...
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-Width="470px">
                                    <HeaderTemplate><%=GetLabel("Patient Information")%></HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:BoundField DataField="BusinessPartner" HeaderText="Payer" HeaderStyle-Width="150px" ItemStyle-VerticalAlign="Top" />
                            </Columns>
                            <EmptyDataTemplate>
                                No Data To Display
                            </EmptyDataTemplate>
