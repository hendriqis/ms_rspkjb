...
{
    public partial class RekapPasienDirawatTanpaKomorbid : BasePageTrx
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.MedicalRecord.BRIDGING_SIRANAP_REKAPPASIENDIRAWATTANPAKOMORBID;
        }
        ...
        private void LoadParameterValues()
        {
            ...
            GetRekapPasienDirawatTanpaKomorbidSiranap entity = BusinessLayer.GetGetRekapPasienDirawatTanpaKomorbidSiranapList(observasiDate).FirstOrDefault();
            if (entity == null)
            {
