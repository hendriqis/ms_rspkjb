...
{
    public partial class ArchiveMedicalRecord : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.MedicalRecord.ARCHIVE_MEDICAL_RECORD;
        }
        ...
        private void BindGridView()
        {
            ...
            List<GetPatientForArchived> lstEntity = BusinessLayer.GetPatientForArchivedList(lastVisitDate, isIgnoreDate);
