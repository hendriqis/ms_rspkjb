<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="RetentionMedicalRecord.aspx.cs" Inherits="QIS.Medinfras.Web.CommonLibs.Program.RetentionMedicalRecord" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnRetention" runat="server" crudmode="R">
        <img src='<%=ResolveUrl("~/Libs/Images/Icon/tbprocess.png")%>' alt="" /><div>
            <%=GetLabel("Retensi")%></div>
    </li>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('#<%=btnRetention.ClientID %>').live('click', function () {
            getCheckedMember();
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            <td style="font-size: small; color: Red">
                                                <%=GetLabel("Harap teliti data rekam medis pasien sebelum proses retensi.")%>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
