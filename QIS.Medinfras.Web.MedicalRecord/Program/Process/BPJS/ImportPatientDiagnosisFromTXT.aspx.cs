...
{
    public partial class ImportPatientDiagnosisFromTXT : BasePageTrx
    {
        protected int PageCount = 1;
        protected int CurrPage = 1;
        private string refreshGridInterval = "1";

        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.MedicalRecord.IMPORT_PATIENT_DIAGNOSIS_BPJS;
        }
        ...
        {
            //string filterExpression = string.Format("HealthcareID = '{0}' AND DepartmentID = '{1}'", AppSession.UserLogin.HealthcareID, Constant.Facility.PHARMACY);

            //List<Department> lstDepartment = BusinessLayer.GetDepartmentList(string.Format("IsActive = 1 AND DepartmentID != '{0}'", Constant.Facility.PHARMACY));
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vPrescriptionOrderHd> lstPrescriptionOrderHD = BusinessLayer.GetvPrescriptionOrderHdList(filterExpression, 10, pageIndex);
