<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="ProcessCBG.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.ProcessCBG" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#<%=txtGrouperTariff.ClientID %>').change(function () {
                $(this).blur();
                calculateTotal();
            });
                ...
                <td style="vertical-align: top">
                    <table border="0" cellpadding="0" cellspacing="1" width="100%">
                            ...
                            <td colspan="4">
                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtGrouperName" Width="100%" runat="server" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCBGType" runat="server" Width="100%" />
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtGrouperTariff" runat="server" Width="100%" CssClass="txtCurrency" />
                            </td>
                        </tr>
                        <tr>
                            <td>
