<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="INACBGSToolbarCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.MedicalRecord.Program.INACBGSToolbarCtl" %>
...
<script type="text/javascript" id="dxss_patientbillsummarytoolbarctl">
    ...
    function onGetUrlReferrer() {
        return ResolveUrl("~/Program/PatientList/VisitList.aspx?id=ina");
    }
</script>
