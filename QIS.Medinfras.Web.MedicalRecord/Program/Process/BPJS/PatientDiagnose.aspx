<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageListEntry.master"
    AutoEventWireup="true" CodeBehind="PatientDiagnose.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.PatientDiagnose" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%=grdView.ClientID %> tr:gt(0):not(.trEmpty)').live('click', function () {
                $('#<%=grdView.ClientID %> tr.focus').removeClass('selected');
