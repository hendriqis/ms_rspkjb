...
{
    public partial class MedicalFolderStatusList : BasePageContent
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                Methods.SetComboBoxField<Department>(cboDepartment, lstServiceUnit, "DepartmentName", "DepartmentID");
                cboDepartment.SelectedIndex = 0;

                txtRegistrationDate.Text = DateTime.Today.ToString(Constant.FormatString.DATE_PICKER_FORMAT);

                Helper.SetControlEntrySetting(txtRegistrationDate, new ControlEntrySetting(false, false, false), "mpPatientList");
