...
{
    public partial class MRPatientProcedure : BasePagePatientPageListEntry
    {
        protected int PageCount = 1;
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.MedicalRecord.MEDICAL_RECORD_KONSUL;
        }
        ...
        {
            txtFinalProcedureDate.Text = DateTime.Now.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
            txtFinalProcedureTime.Text = DateTime.Now.ToString(Constant.FormatString.TIME_FORMAT);
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(txtFinalProcedureDate, new ControlEntrySetting(true, true, true));
            SetControlEntrySetting(txtFinalProcedureTime, new ControlEntrySetting(true, true, true));
            SetControlEntrySetting(txtFinalProcedureCode, new ControlEntrySetting(true, true, true));
            SetControlEntrySetting(txtFinalProcedureName, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtFinalProcedureText, new ControlEntrySetting(true, true, false));
            SetControlEntrySetting(txtRemarks, new ControlEntrySetting(true, true, false));
        }

        private void ControlToEntity(PatientProcedure entity)
        {
            entity.FinalProcedureDate = Helper.GetDatePickerValue(txtFinalProcedureDate.Text);
            entity.FinalProcedureTime = txtFinalProcedureTime.Text;
            entity.FinalProcedureID = txtFinalProcedureCode.Text;
            entity.FinalProcedureText = txtFinalProcedureText.Text;
            entity.FinalProcedureBy = AppSession.UserLogin.UserID;
