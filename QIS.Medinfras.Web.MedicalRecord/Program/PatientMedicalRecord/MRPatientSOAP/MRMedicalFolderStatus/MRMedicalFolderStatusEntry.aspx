<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="MRMedicalFolderStatusEntry.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.MRMedicalFolderStatusEntry" %>
...
<asp:Content ID="ctnEntry" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript">
        ...
        function onCboFolderTypeChanged() {
                        ...
                        <tr id="trServiceUnit" runat="server">
                            ...
                            <td>
                                <dxe:ASPxComboBox ID="cboFolderType" Width="300px" ClientInstanceName="cboFolderType"
                                    runat="server">
                                    <ClientSideEvents ValueChanged="function(s,e){ onCboFolderTypeChanged(); }" />
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
