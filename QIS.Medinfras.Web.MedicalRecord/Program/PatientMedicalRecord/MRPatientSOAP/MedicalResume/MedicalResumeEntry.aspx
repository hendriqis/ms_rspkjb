<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master"
    AutoEventWireup="true" CodeBehind="MedicalResumeEntry.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.MedicalResumeEntry" %>
    ...
    <script type="text/javascript" id="dxss_erpatientstatus1">
        $(function () {
            $('#<%=btnBackToList.ClientID %>').click(function () {
                if ($('#<%=hdnIsSaved.ClientID %>').val() == '0' && $('#<%=hdnIsChanged.ClientID %>').val() == '1') {
                    ...
                    if ($('#<%=txtHospitalIndication.ClientID %>').val() != '') {
            ...
            $('#btnAddTemplate.imgLink').click(function () {
                if ($('#<%=txtSubjectiveResumeText.ClientID %>').val() != '') {
                    ...
                    openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/UpdatePhysicianTextCtl1.ascx", "X058^01|" + text, "Physician Template Text", 700, 500);
                }
            });
            ...
            $('#btnSubjectiveResumeTest.imgLink').click(function () {
                if ($('#<%=txtSubjectiveResumeText.ClientID %>').val() != '') {
                    onBeforeOpenTrxPopup();
                    var text = $('#<%=txtSubjectiveResumeText.ClientID %>').val();
                    openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/UpdatePhysicianTextCtl1.ascx", "X058^02|" + text, "Physician Template Text", 700, 500);
                }
            });
        ...
        $('#lblAddVitalSign').live('click', function (evt) {
            ...
            if (linkID != '0' && linkID != '') {
                ...
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/VitalSignEntry1Ctl.ascx", param, "Tanda Vital & Indikator Lainnya", 700, 500);
            }
            else {
        ...
        $('.imgEditVitalSign.imgLink').live('click', function () {
            ...
            openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/VitalSignEntry1Ctl.ascx", param, "Vital Sign & Indicator", 700, 500);
        });
        ...
        $('#lblAddROS').live('click', function (evt) {
            ...
            if (linkID != '0' && linkID != '') {
                ...
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/ROSEntry1Ctl.ascx", param, "Pemeriksaan Fisik", 700, 500);
            }
            else {
                displayMessageBox("Resume Medis","Mohon simpan data terlebih dahulu, sebelum melakukan proses ini.");
            }
        ...
        $('#lblEpisodeMedication').live('click', function (evt) {
            ...
            if (visitID != '0' && visitID != '') {
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/EpisodeMedicationPicksCtl1.ascx", visitID, "Terapi selama Perawatan", 1000, 500);
            }
        });
        ...
        $('#lblDischargePrescription').live('click', function (evt) {
            var visitID = $('#<%=hdnVisitID.ClientID %>').val();
            if (visitID != '0' && visitID != '') {
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/DischargeMedicationPicksCtl1.ascx", visitID, "Resep Pulang", 700, 500);
            }
        });
        ...
        $('#lblLaboratory').live('click', function (evt) {
            ...
            if (visitID != '0' && visitID != '') {
                ...
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/EpisodeTestOrderCtl1.ascx", param, "Pemeriksaan Penunjang - Laboratorium", 1000, 500);
            }
        });
        ...
        $('#lblImaging').live('click', function (evt) {
            ...
            if (visitID != '0' && visitID != '') {
                ...
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/EpisodeTestOrderCtl1.ascx", param, "Pemeriksaan Penunjang - Radiologi", 1000, 500);
            }
        });
        ...
        $('#lblOtherDiagnostic').live('click', function (evt) {
            ...
            if (visitID != '0' && visitID != '') {
                ...
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/EpisodeTestOrderCtl1.ascx", param, "Pemeriksaan Penunjang - Lain - lain", 1000, 500);
            }
        });
        ...
        $('#lblSurgeryProcedure').live('click', function (evt) {
            ...
            if (visitID != '0' && visitID != '') {
                var param = visitID;
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/EpisodeSurgeryProcedureCtl1.ascx", param, "Tindakan Kamar Operasi", 1000, 500);
            }
        });
        ...
        $('#lblPhysicianInstruction').live('click', function (evt) {
            var visitID = $('#<%=hdnVisitID.ClientID %>').val();
            if (visitID != '0' && visitID != '') {
                openUserControlPopup("~/Program/PatientMedicalRecord/MRPatientSOAP/MedicalResume/PhysicianInstructionQuickPicks1Ctl.ascx", "", "Template Instruksi dan Rencana Tindak Lanjut", 700, 600);
            }
        });
                        ...
                        <div id="divPage1" class="w3-border divPageNavPanelContent w3-animate-left" style="display:none"> 
                            <table class="tblEntryContent" style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtHospitalIndication" runat="server" TextMode="MultiLine" Rows="2" Width="100%" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdLabel" style="width: 150px; vertical-align: top">
                                        <table border="0" cellpadding="0" cellspacing="1">
                                            <tr>
                                                ...
                                                <td style="display:none"><img class="imgLink" id="btnSubjectiveResumeTest" title='<%=GetLabel("Add to My Template")%>' src='<%= ResolveUrl("~/Libs/Images/button/vitalsign.png")%>' alt="" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td>
                                    ...
                                    <td class="tdLabel" valign="top">
                                        <table border="0" cellpadding="0" cellspacing="1">
                                            <tr>
                                                ...
                                                <td style="display:none"><img class="imgLink" id="Img1" title='<%=GetLabel("Add to My Template")%>' src='<%= ResolveUrl("~/Libs/Images/button/vitalsign.png")%>' alt="" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtComorbiditiesText" runat="server" TextMode="MultiLine" Rows="2" Width="100%" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="1">
                                            <tr>
                                                ...
                                                <td><asp:TextBox ID="txtNoOfDays" Width="60px" runat="server" CssClass="number" Text="0" /></td>
