<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MRPatientSOAPToolbarCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.MRPatientSOAPToolbarCtl" %>
