<%@ Page Language="C#" MasterPageFile="~/libs/MasterPage/PatientPage/MPBasePatientPageList.master" AutoEventWireup="true" 
    CodeBehind="MREpisodeSummary.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.MREpisodeSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <style type="text/css">
        ...
        #listSummary .divContentTitle { margin-left:25px; font-weight:bold; font-size:12px; text-decoration:underline}
        #listSummary .divContent { margin-left:25px; font-weight:bold; font-size:11px}
    
        #listSummary .divNotAvailableContent { margin-left:25px; font-size:11px; font-style:italic; color:red}
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                <div style="height: 450px;">
                    <div class="accordion" id="listSummary" style="text-align: left;">
                        <a style="font-size: 14px;"><%= GetLabel("SUBJECTIVE")%></a>
                        <div class="containerUl">
                            ...
                            <asp:Repeater ID="rptChiefComplaint" runat="server">
                                ...
                                <ItemTemplate>
                                    <li>
                                        <div><span><%#: Eval("HistoryDate")%> <%#: Eval("HistoryTime")%> <%#: Eval("ParamedicName")%></span></div>
                                        <div><textarea style="border:0; width:625px; height:250px" readonly><%#: Eval("ChiefComplaintText")%></textarea></div>
                                    </li>
                                </ItemTemplate>
                                <FooterTemplate>
                                    </ul>
                        ...
                        <div class="containerUl">
                            <asp:Repeater ID="rptDischargeInformation" runat="server">
                                ...
                                <ItemTemplate>
                                    <li>
                                        <div><span><%#: Eval("DischargeDateInString")%>, <%#: Eval("DischargeCondition")%></span></div>
            ...
            <td style="height:460px;vertical-align:top">
                <div id="rightPanel">
                    <ul>
                        <li url="~/Program/PatientMedicalRecord/MRPatientSOAP/MREpisodeSummary/VitalSignInformationCtl.ascx" title="Vital Signs">Vital Sign</li>
                        <li url="~/Program/PatientPage/Summary/EpisodeSummary/EpisodeSummaryMedicalChartContainerCtl.ascx" title="Medical Chart" style="display:none">MC</li>
                        <li url="~/Program/PatientPage/Summary/EpisodeSummary/EpisodeSummaryBodyDiagramContainerCtl.ascx" title="Body Diagram" style="display:none">Body Diagram</li>
                    </ul>
