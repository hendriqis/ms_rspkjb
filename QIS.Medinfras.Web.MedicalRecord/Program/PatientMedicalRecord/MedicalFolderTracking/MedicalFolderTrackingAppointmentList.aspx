<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="MedicalFolderTrackingAppointmentList.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.MedicalFolderTrackingAppointmentList" %>

<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<%@ Register Assembly="QIS.Medinfras.Web.CustomControl, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"
    Namespace="QIS.Medinfras.Web.CustomControl" TagPrefix="qis" %>
<%@ Register Src="~/Libs/Controls/PatientGrid/CheckGridPatientAppointmentCtl.ascx"
    TagName="ctlGrdAppointmentPatient" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#<%=txtFromRegistrationDate.ClientID %>').datepicker('option', 'maxDate', '30');

            setDatePicker('<%=txtToRegistrationDate.ClientID %>');
            $('#<%=txtToRegistrationDate.ClientID %>').datepicker('option', 'maxDate', '30');
            ...
            $('#<%=txtDateToDay.ClientID %>').datepicker('option', 'maxDate', '360');
        ...
        function GetCurrentDateTime() {
            ...
            $('#<%=txtStartTime.ClientID %>').val(currentdate.getHours() + ":" + currentdate.getMinutes());
            $('#<%=txtEndTime.ClientID %>').val(currentdate.getHours() + ":" + currentdate.getMinutes());
        }
    ...
    <input type="hidden" value="" id="hdnIsPrintWhenProcess" runat="server" />
    <table class="tblContentArea" style="width: 100%">
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <fieldset id="fsPatientList">
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtStartTime" Width="80px" CssClass="time" runat="server" />
                                        </td>
                                        <td>
                                            <%=GetLabel("s/d") %>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtEndTime" Width="80px" CssClass="time" runat="server" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <table class="tblEntryContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTimeToDay" Width="80px" CssClass="time" runat="server" />
                            </td>
                            <td>
                ...
                <uc1:ctlGrdAppointmentPatient runat="server" ID="grdAppointmentPatient" />
            </td>
        </tr>
    </table>
</asp:Content>
