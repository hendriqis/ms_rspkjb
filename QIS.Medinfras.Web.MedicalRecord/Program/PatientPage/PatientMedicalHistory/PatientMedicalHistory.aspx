<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPPatientDataPageList.master" AutoEventWireup="true" 
    CodeBehind="PatientHistoryList.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.PatientHistoryList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPatientHistoryPrint" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbprint.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Print")%></div></li>
    <li id="btnPatientHistoryEpisodeSummary" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbprint.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Episode Summary")%></div></li>
</asp:Content>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="overflow-y: scroll;">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" RowStyle-CssClass="trDraggable" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="RegistrationNo" HeaderText="Registration No" HeaderStyle-Width="160px" />
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                ...
                                <asp:BoundField DataField="DisplayPatientDiagnosis" HeaderText="Diagnosis" HeaderStyle-Width="250px" />                                
                            </Columns>
                            <EmptyDataTemplate>
