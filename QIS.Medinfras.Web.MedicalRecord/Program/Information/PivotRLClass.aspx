<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="PivotRLClass.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.PivotRLClass" %>
...
<%@ Register Src="~/Program/Information/PivotOptionCtl.ascx" TagName="PivotOptionCtl"
    TagPrefix="uc1" %>
<%@ Register Src="~/Libs/Controls/PeriodeCtl.ascx" TagName="PeriodeCtl"
    TagPrefix="uc2" %>
            ...
            <PanelCollection>
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height: 450px;">
                        <dx:ASPxPivotGrid ID="pvView" runat="server" ClientIDMode="AutoID" Width="100%" DataSourceID="odsPivotRLClass">
                            <Fields>
                                ...
                                <dx:PivotGridField Area="ColumnArea" AreaIndex="2" FieldName="ClassRL" ID="GCClassRL" 
                                    Caption="Kelas"/>
                                <dx:PivotGridField Area="DataArea" AreaIndex="1" FieldName="JumlahHariRawat" 
                                    Caption="Jumlah Hari Rawat" ID="JumlahHariRawat1" />
                                ...
                                <dx:PivotGridField Area="FilterArea" AreaIndex="3" FieldName="DepartmentID" Caption="Department"
                                    ID="departmentID" />
                                <dx:PivotGridField Area="FilterArea" AreaIndex="4" FieldName="VisitTypeName" Caption="Jenis Kunjungan"
                                    ID="visittypenameID" />
                                <dx:PivotGridField Area="FilterArea" AreaIndex="5" FieldName="ParamedicName" Caption="Dokter"
                                    ID="paramedicID" />
                                <dx:PivotGridField Area="RowArea" AreaIndex="0" FieldName="SpecialtyName" Caption="Spesialisasi" 
                                    ID="SpecialtyID">
                                    <CustomTotals>
                                        <dx:PivotGridCustomTotal SummaryType="Count" />
                                    </CustomTotals>
                        ...
                        <asp:ObjectDataSource ID="odsPivotRLClass" runat="server" SelectMethod="GetvPivotConsultVisitRLClassList"
