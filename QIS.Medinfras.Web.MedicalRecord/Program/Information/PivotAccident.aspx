...
CodeBehind="PivotAccident.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.PivotAccident" %>
                ...
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height: 450px;">
                        <dx:ASPxPivotGrid ID="pvView" runat="server" ClientIDMode="AutoID" Width="100%" DataSourceID="odsPivotRegistration">
                            <Fields>
                                <dx:PivotGridField Area="RowArea" AreaIndex="0" FieldName="DiagnoseName" Caption="Diagnose"
                                    ID="diagnoseName" ValueStyle-Wrap="False">
                                    <CustomTotals>
                                ...
                                <dx:PivotGridField Area="FilterArea" AreaIndex="3" FieldName="ParamedicName" Caption="Paramedic"
                                    ID="paramedicName" />
                                <dx:PivotGridField Area="FilterArea" AreaIndex="4" FieldName="ServiceUnitName" Caption="Service Unit"
                                    ID="serviceUnitName" />
                                <dx:PivotGridField Area="FilterArea" AreaIndex="5" FieldName="Gender" Caption="Gender"
                                    ID="gender" />
                            </Fields>
                        ...
                        <asp:ObjectDataSource ID="odsPivotRegistration" runat="server" SelectMethod="GetvPatientDiagnosisPivotList"
