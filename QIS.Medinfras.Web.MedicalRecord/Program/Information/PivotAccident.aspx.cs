...
{
    public partial class PivotAccident : BasePageList
    {
        ...
        void ChangePivotGridFieldLayout()
        {
            ...
            pvView.Fields["diagnoseName"].Area = DevExpress.XtraPivotGrid.PivotArea.RowArea;
            pvView.Fields["diagnoseName"].AreaIndex = 0;
            pvView.Fields["diagnoseName"].TotalsVisibility = DevExpress.XtraPivotGrid.PivotTotalsVisibility.AutomaticTotals;
