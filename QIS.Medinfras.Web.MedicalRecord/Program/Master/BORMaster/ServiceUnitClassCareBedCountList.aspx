<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true"
    CodeBehind="ServiceUnitClassCareBedCountList.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.ServiceUnitClassCareBedCountList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkBedCount a').live('click', function () {
            var id = $(this).closest('tr').find('.keyField').html();
            var url = ResolveUrl("~/Program/Master/BORMaster/ServiceUnitClassCareBedCountEntryCtl.ascx");
            openUserControlPopup(url, id, 'Service Unit Class Care Bed Count', 500, 300);
        });
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderText="Jumlah Bed" HeaderStyle-Width="120px" Text="Setting"
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="lnkBedCount" HeaderStyle-HorizontalAlign="Center" />
                            </Columns>
                            <EmptyDataTemplate>
