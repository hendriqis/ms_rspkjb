<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true"
    CodeBehind="ServiceUnitBedCountList.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.ServiceUnitBedCountList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkBedCount a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/Master/BORMaster/ServiceUnitBedCountEntryCtl.ascx");
            openUserControlPopup(url, id, 'Service Unit Bed Count', 500, 300);
        });
