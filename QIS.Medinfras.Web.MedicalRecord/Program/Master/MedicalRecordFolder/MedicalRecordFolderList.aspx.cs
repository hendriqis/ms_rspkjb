...
{
    public partial class MedicalRecordFolderList : BasePageList
    {
        protected int PageCount = 1;
        protected int CurrPage = 1;
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.MedicalRecord.MEDICAL_RECORD_FOLDER;
        }
        ...
        private string GetFilterExpression()
        {
            ...
            filterExpression += String.Format("ParentID = '{0}' AND IsDeleted = 0 AND IsActive = 1", Constant.StandardCode.MEDICAL_FOLDER_TYPE);
        ...
        {
            url = ResolveUrl("~/Program/Master/MedicalRecordFolder/MedicalRecordFolderEntry.aspx");
            return true;
        }
