<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuestionGroupDetailListCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.QuestionGroupDetailListCtl" %>
                            ...
                            <tr>
                                <td style="padding: 5px; vertical-align: top">
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td class="tdLabel">
                                                <label class="lblLink" id="lblProductLine">
                                            ...
                                            <td>
                                                ...
                                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtProductLineCode" Width="100%" />
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtProductLineName" Width="100%" ReadOnly="true" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
