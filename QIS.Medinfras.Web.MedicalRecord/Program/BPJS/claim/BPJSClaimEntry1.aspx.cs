...
{
    public partial class BPJSClaimEntry1 : BasePagePatientPageList
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.MedicalRecord.BPJS_PROSES_CLAIM_PROPOSE;
        }
        ...
        private void EntityToControl(ConsultVisit entity)
        {
            ...
            if (regBPJS != null)
            {
                ...
                else
                {
                    ...
                    txtKelasTanggungan.Text = string.Empty;
                }
