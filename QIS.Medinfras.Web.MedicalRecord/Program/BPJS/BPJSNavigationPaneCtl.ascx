<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BPJSNavigationPaneCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.MedicalRecord.Program.BPJSNavigationPaneCtl" %>
...
<script type="text/javascript" id="dxss_inpatientprescriptionordertoolbarctl">
    ...
    function onGetUrlReferrer() {
        return ResolveUrl("~/Program/BPJS/BPJSPatientVisitList.aspx");
    }
</script>
