<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ProposedSEPList.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalRecord.Program.ProposedSEPList" %>

<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<%@ Register Assembly="QIS.Medinfras.Web.CustomControl, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"
    Namespace="QIS.Medinfras.Web.CustomControl" TagPrefix="qis" %>
<%@ Register Src="~/Libs/Controls/PatientGrid/CheckGridPatientBPJSVisitCtl.ascx" TagName="ctlGrdRegisteredPatient"
    TagPrefix="uc1" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%=btnMPEntryPopupSave.ClientID %>').click(function () {
                ...
                if (param == '') {
                    showToast('Warning', 'Please select the patient First');
                }
                else {
                    $('#<%=hdnParam.ClientID %>').val(param);
                    if (IsValid(null, 'fsPatientList', 'mpPatientEntry')) {
                        var message = "Lanjutkan proses persetujuan SEP ?";
                        showToastConfirmation(message, function (result) {
                            if (result) onCustomButtonClick('approved');
                        });
                    }
                }
            });
