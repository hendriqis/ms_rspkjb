<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SurgeryReportListCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.MedicalRecord.Program.SurgeryReportListCtl" %>
...
<script type="text/javascript" id="dxss_surgeryreportlistctl">
    ...
    $('.btnPrintSurgeryReportList.imglink').live('click', function () {
        ...
        var reportCode = $('#<%=hdnRptCodeSurgery.ClientID %>').val(); /////"PM-00567";
...
<input type="hidden" value="PM-00567" id="hdnRptCodeSurgery" runat="server" />
