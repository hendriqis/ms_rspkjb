<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FAAcceptanceVoidCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Accounting.Program.FAAcceptanceVoidCtl" %>
...
<script type="text/javascript" id="dxss_faacceptancevoidctl">
    $(function () {
        hideLoadingPanel();
    });

    $('#<%=btnVoidAcceptance.ClientID %>').click(function (evt) {
        if (IsValid(evt, 'fsTrxPopup', 'mpTrxPopup')) {
            cbpFAAcceptanceVoid.PerformCallback('void');
        }
    });

    function onVoidFAAcceptanceSuccess() {
...
<div class="toolbarArea">
    <ul id="ulMPListToolbar" runat="server">
        <li id="btnVoidAcceptance" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbset.png")%>' alt="" /><br style="clear:both"/>
...
<div style="padding:10px;">
    <fieldset id="fsTrxPopup" style="margin:0"> 
        ...
        <dxcp:ASPxCallbackPanel ID="cbpFAAcceptanceVoid" runat="server" Width="100%" ClientInstanceName="cbpFAAcceptanceVoid"
            ShowLoadingPanel="false" OnCallback="cbpFAAcceptanceVoid_Callback">
