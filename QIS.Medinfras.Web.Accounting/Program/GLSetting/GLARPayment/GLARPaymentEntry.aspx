<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master"
    AutoEventWireup="true" CodeBehind="GLARPaymentEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Accounting.Program.GLARPaymentEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onCboARPaymentMethodValueChanged() {
            if (cboARPaymentMethod.GetValue() == '<%=OnGetARPaymentMethodTransfer() %>') {
            ...
            if (cboARPaymentMethod.GetValue() == '<%=OnGetARPaymentMethodCredit() %>' || cboARPaymentMethod.GetValue() == '<%=OnGetARPaymentMethodDebit() %>') {
        ...
        <tr>
            <td style="padding: 5px; vertical-align: top">
                <table class="tblEntryContent" style="width: 50%">
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblMandatory">
                                <%=GetLabel("Cara Penerimaan Piutang")%></label>
                        </td>
                        <td>
                            <dxe:ASPxComboBox ID="cboARPaymentMethod" ClientInstanceName="cboARPaymentMethod"
                                runat="server" Width="100%">
                                <ClientSideEvents ValueChanged="function(s,e){ onCboARPaymentMethodValueChanged(); }" />
                            </dxe:ASPxComboBox>
                        </td>
                    </tr>
                    ...
                    <tr id="trEDCMachine" runat="server" style="display: none">
                        <td class="tdLabel">
                            <label class="lblMandatory">
                                <%=GetLabel("EDC Machine")%></label>
                        </td>
                        <td>
                            <dxe:ASPxComboBox ID="cboEDCMachine" runat="server" Width="100%" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblLink lblMandatory" id="lblGLAccount1">
                                <%=GetLabel("COA Cara Penerimaan")%></label>
                        </td>
                        <td>
