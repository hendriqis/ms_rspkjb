<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="GLPatientPaymentMethodEDCBankList.aspx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLPatientPaymentMethodEDCBankList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PaymentMethod" HeaderText="Payment Method" HeaderStyle-Width="150px"
                                    HeaderStyle-HorizontalAlign="Left" />
                                <asp:TemplateField HeaderStyle-Width="180px" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <%=GetLabel("EDC Machine")%></HeaderTemplate>
                                    <ItemTemplate>
                                        <div style="font-size: 14px;">
                                            <%#:Eval("EDCMachineName") %></div>
                                        <div style="font-size: 12px;">
                                            <%#:Eval("EDCMachineCode") %></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-Width="180px" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <%=GetLabel("Bank")%></HeaderTemplate>
                                    <ItemTemplate>
                                        <div style="font-size: 14px;">
                                            <%#:Eval("BankName") %></div>
                                        <div style="font-size: 12px;">
                                ...
                                <asp:BoundField DataField="CashierGroup" HeaderText="Cashier Group" HeaderStyle-Width="150px"
                                    HeaderStyle-HorizontalAlign="Left" />
