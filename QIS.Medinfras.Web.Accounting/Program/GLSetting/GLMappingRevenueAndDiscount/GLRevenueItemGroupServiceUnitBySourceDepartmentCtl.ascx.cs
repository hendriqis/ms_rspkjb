...
{
    public partial class GLRevenueItemGroupServiceUnitBySourceDepartmentCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vGLRevenueItemGroupServiceUnitBySourceDepartment> lst = BusinessLayer.GetvGLRevenueItemGroupServiceUnitBySourceDepartmentList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemGroupServiceUnitBySourceDepartmentDao entityDao = new GLRevenueItemGroupServiceUnitBySourceDepartmentDao(ctx);
            try
            {
                GLRevenueItemGroupServiceUnitBySourceDepartment entity = new GLRevenueItemGroupServiceUnitBySourceDepartment();
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemGroupServiceUnitBySourceDepartment entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
