...
{
    public partial class GLMappingItemGroupEntryCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            {
                filterExpression += string.Format("(DiscountGLAccountNo1 = '{0}' OR DiscountGLAccountNo2 = '{0}' OR DiscountGLAccountNo3 = '{0}')", hdnGLAccountNoCtl.Value);
            }

            List<vGLRevenueItemGroup> lst = BusinessLayer.GetvGLRevenueItemGroupList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemGroupDao entityDao = new GLRevenueItemGroupDao(ctx);
            try
            {
                GLRevenueItemGroup entity = new GLRevenueItemGroup();
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemGroup entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
