<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemGroupServiceUnitEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLMappingItemGroupServiceUnitEntryCtl" %>
...
<script type="text/javascript" id="dxss_GLMappingItemGroupServiceUnitEntryCtl">
    ...
    //#region HPP
    function onGetHPPGLAccountIDFilterExpression() {
        var filterExpression = "IsHeader = 0 AND IsDeleted = 0 AND IsActive = 1";
        return filterExpression;
    }

    $('#lblHPPGLAccountID.lblLink').live('click', function () {
        openSearchDialog('chartofaccount', onGetHPPGLAccountIDFilterExpression(), function (value) {
            $('#<%=txtHPPGLAccountNo.ClientID %>').val(value);
            ontxtHPPGLAccountNoChanged(value);
        });
    });

    $('#<%=txtHPPGLAccountNo.ClientID %>').live('change', function () {
        ontxtHPPGLAccountNoChanged($(this).val());
    });

    function ontxtHPPGLAccountNoChanged(value) {
        var filterExpression = onGetHPPGLAccountIDFilterExpression() + " AND GLAccountNo = '" + value + "'";
        Methods.getObject('GetvChartOfAccountList', filterExpression, function (result) {
            if (result != null) {
                $('#<%=hdnHPPGLAccountID.ClientID %>').val(result.GLAccountID);
                $('#<%=txtHPPGLAccountName.ClientID %>').val(result.GLAccountName);
            }
            else {
                $('#<%=hdnHPPGLAccountID.ClientID %>').val('');
                $('#<%=txtHPPGLAccountNo.ClientID %>').val('');
                $('#<%=txtHPPGLAccountName.ClientID %>').val('');
            }
        });
    }
    //#endregion
                    ...
                    <fieldset id="fsEntryPopup" style="margin: 0">
                        <table class="tblEntryDetail" style="width: 100%">
                            ...
                            <tr>
                                <td class="tdLabel">
                                    <label class="lblNormal" style="font-size: small; font-weight: bold">
                                        <%=GetLabel("COA HPP")%></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tdLabel">
                                    <label class="lblLink lblNormal" id="lblHPPGLAccountID" style="font-style: italic; font-size: small;
                                        padding-left: 15px">
                                        <%=GetLabel("HPP")%></label>
                                </td>
                                <td colspan="2">
                                    <input type="hidden" id="hdnHPPGLAccountID" runat="server" />
                                    <table cellpadding="0" cellspacing="0">
                                        <colgroup>
                                            <col style="width: 120px" />
                                            <col style="width: 3px" />
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox runat="server" ID="txtHPPGLAccountNo" Width="100%" />
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                            <td>
                                                <asp:TextBox runat="server" ID="txtHPPGLAccountName" ReadOnly="true" Width="100%" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="180px">
                                         ...
                                         <asp:TemplateField HeaderStyle-Width="180px">
                                            ...
                                            <ItemTemplate>
                                             <label class="lblNormal" style="font-style: italic; font-size: small;">
                                                    <%=GetLabel("HPP : ")%></label><%#: Eval("GLHPPRevenueSharingNo")%><br />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-Width="180px">
                                            <HeaderTemplate>
