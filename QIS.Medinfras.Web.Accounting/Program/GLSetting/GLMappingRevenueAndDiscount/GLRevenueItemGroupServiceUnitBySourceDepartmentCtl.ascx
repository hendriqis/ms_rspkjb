<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLRevenueItemGroupServiceUnitBySourceDepartmentCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLRevenueItemGroupServiceUnitBySourceDepartmentCtl" %>
...
<script type="text/javascript" id="dxss_GLRevenueItemGroupServiceUnitBySourceDepartmentCtl">
    ...
    $('#btnEntryPopupSave').click(function (evt) {
        if (IsValid(evt, 'fsEntryPopup', 'mpEntryPopup')) {
            ...
            var sourceDeptID = $('#<%=hdnSourceDepartmentID.ClientID %>').val();

            if (itemGroupID != 0 && itemGroupID != "" && itemGroupID != null) {
                if (hsuID != 0 && hsuID != "" && hsuID != null) {
                    if (sourceDeptID != "" && sourceDeptID != null) {
                        cbpEntryPopupView.PerformCallback('save');
                    } else {
                        displayErrorMessageBox('INFORMASI', "Harap isi isian Asal Department Pasien terlebih dahulu.");
                    }
                } else {
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtSourceDepartmentID" Width="100%" runat="server" />
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtSourceDepartmentName" ReadOnly="true" Width="100%" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <div style="text-align: center">
                                                    <%=GetLabel("Source Department")%>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <label class="lblNormal" style="font-size: small;">
                                                    <%#: Eval("SourceDepartmentID")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
