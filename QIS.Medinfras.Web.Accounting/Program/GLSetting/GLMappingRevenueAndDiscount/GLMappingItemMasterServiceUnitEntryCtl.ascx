<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemMasterServiceUnitEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLMappingItemMasterServiceUnitEntryCtl" %>
