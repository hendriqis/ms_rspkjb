<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemMasterEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLMappingItemMasterEntryCtl" %>
