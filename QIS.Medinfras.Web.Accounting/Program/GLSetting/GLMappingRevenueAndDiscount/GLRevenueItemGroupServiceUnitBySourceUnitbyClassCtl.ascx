<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLRevenueItemGroupServiceUnitBySourceUnitbyClassCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLRevenueItemGroupServiceUnitBySourceUnitbyClassCtl" %>
...
<script type="text/javascript" id="dxss_GLRevenueItemGroupServiceUnitBySourceUnitbyClassCtl">
