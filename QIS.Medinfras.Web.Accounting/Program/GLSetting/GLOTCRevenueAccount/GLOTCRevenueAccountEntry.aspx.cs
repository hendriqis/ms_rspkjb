...
{
    public partial class GLOTCRevenueAccountEntry : BasePageEntry
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Accounting.GL_OTC_REVENUE_ACCOUNT;
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                String ID = param[0]; 
                hdnID.Value = ID;
                vGLOTCRevenueAccount entity = BusinessLayer.GetvGLOTCRevenueAccountList(String.Format("ID = {0}", hdnID.Value))[0];
        ...
        private void EntityToControl(vGLOTCRevenueAccount entity)
        {
        ...
        private void ControlToEntity(GLOTCRevenueAccount entity)
        {
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            try
            {
                GLOTCRevenueAccount entity = new GLOTCRevenueAccount();
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.InsertGLOTCRevenueAccount(entity);
                return true;
            }
            catch (Exception ex)
            {
        ...
        protected override bool OnSaveEditRecord(ref string errMessage)
        {
            try
            {
                GLOTCRevenueAccount entity = BusinessLayer.GetGLOTCRevenueAccount(Convert.ToInt32(hdnID.Value));
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateGLOTCRevenueAccount(entity);
                return true;
            }
            catch (Exception ex)
            {
