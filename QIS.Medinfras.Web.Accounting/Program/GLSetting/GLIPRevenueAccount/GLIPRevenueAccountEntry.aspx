<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master" AutoEventWireup="true" 
    CodeBehind="GLIPRevenueAccountEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Accounting.Program.GLIPRevenueAccountEntry" %>
        ...
        function onLoad() {
            ...
            function onGetRoomFilterExpression() {
                ...
                if ($('#<%=hdnHealthcareServiceUnitID.ClientID %>').val() != "") {
                    filterExpression += " AND HealthcareServiceUnitID = " + $('#<%=hdnHealthcareServiceUnitID.ClientID %>').val();
                }
                return filterExpression;
            }

            $('#lblRoom.lblLink').click(function () {
                openSearchDialog('serviceunitroom', onGetRoomFilterExpression(), function (value) {
        ...
        <tr>
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:50%">
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Admission Source")%></label></td>
                        <td><dxe:ASPxComboBox ID="cboGCAdmissionSource" runat="server" Width="300px" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tdLabel" valign="top" style="padding-top:5px"><label class="lblMandatory lblLink" id="lblRoom"><%=GetLabel("Ruangan")%></label></td>
                        <td>
                            ...
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td><asp:TextBox runat="server" ID="txtRoomCode" Width="100%" /></td>
                                    <td>&nbsp;</td>
                                    <td><asp:TextBox runat="server" ID="txtRoomName" Width="100%" ReadOnly="true" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr id="trClass" runat="server">
                        <td class="tdLabel"><label class="lblLink lblMandatory" runat="server" id="lblClass"><%=GetLabel("Kelas")%></label></td>
                        <td>
                            ...
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><asp:TextBox ID="txtClassName" Width="100%" runat="server" ReadOnly="true" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
