...
{
    public partial class GLIPRevenueAccountEntry : BasePageEntry
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.Accounting.GL_IP_REVENUE_ACCOUNT;
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                String ID = param[0]; 
                hdnID.Value = ID;
                vGLIPRevenueAccount entity = BusinessLayer.GetvGLIPRevenueAccountList(String.Format("ID = {0}", hdnID.Value))[0];
        ...
        {
            String filterExpression = String.Format("ParentID IN ('{0}','{1}') AND IsActive = 1 AND IsDeleted = 0", Constant.StandardCode.GL_REVENUE_TRANSACTION, Constant.StandardCode.ADMISSION_SOURCE);
            ...
            Methods.SetComboBoxField(cboGCAdmissionSource, lstStandardCode.Where(x => x.ParentID == Constant.StandardCode.ADMISSION_SOURCE).ToList(), "StandardCodeName", "StandardCodeID");
        }

        protected override void OnControlEntrySetting()
        {
            SetControlEntrySetting(cboGCAdmissionSource, new ControlEntrySetting(true, false, true));
            ...
            SetControlEntrySetting(hdnHealthcareServiceUnitID, new ControlEntrySetting(true, true, true));
            ...
            SetControlEntrySetting(txtGLAccount2Name, new ControlEntrySetting(false, false, true));
            ...
            SetControlEntrySetting(txtGLAccount3Name, new ControlEntrySetting(false, false, true));
            ...
            SetControlEntrySetting(txtGLAccount4Name, new ControlEntrySetting(false, false, true));
        ...
        private void EntityToControl(vGLIPRevenueAccount entity)
        {
            ...
            cboGCAdmissionSource.Value = entity.GCAdmissionSource;
        ...
        private void ControlToEntity(GLIPRevenueAccount entity)
        {
            ...
            entity.GCAdmissionSource = cboGCAdmissionSource.Value.ToString();
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            try
            {
                GLIPRevenueAccount entity = new GLIPRevenueAccount();
                ControlToEntity(entity);
                entity.LastUpdatedBy = entity.CreatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.InsertGLIPRevenueAccount(entity);
                return true;
            }
            catch (Exception ex)
            {
        ...
        protected override bool OnSaveEditRecord(ref string errMessage)
        {
            try
            {
                GLIPRevenueAccount entity = BusinessLayer.GetGLIPRevenueAccount(Convert.ToInt32(hdnID.Value));
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateGLIPRevenueAccount(entity);
                return true;
            }
            catch (Exception ex)
            {
