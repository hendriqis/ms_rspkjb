...
{
    public partial class GLRevenueItemGroupServiceUnitBySourceUnitbyClassDetailCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vGLRevenueItemGroupServiceUnitBySourceUnitbyClass> lst = BusinessLayer.GetvGLRevenueItemGroupServiceUnitBySourceUnitbyClassList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemGroupServiceUnitBySourceUnitByClassDao entityDao = new GLRevenueItemGroupServiceUnitBySourceUnitByClassDao(ctx);
            try
            {
                GLRevenueItemGroupServiceUnitBySourceUnitByClass entity = new GLRevenueItemGroupServiceUnitBySourceUnitByClass();
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemGroupServiceUnitBySourceUnitByClass entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
