<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemMasterServiceUnitDetailEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLMappingItemMasterServiceUnitDetailEntryCtl" %>
...
<script type="text/javascript" id="dxss_GLMappingItemMasterServiceUnitEntryCtl">
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; position: relative;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemCode" ItemStyle-CssClass="ItemCode" HeaderText="ItemCode"
                                            HeaderStyle-Width="120px" />
                                        <asp:BoundField DataField="ItemName1" ItemStyle-CssClass="ItemName1" HeaderText="ItemName1" />
                                        <asp:BoundField DataField="ServiceUnitCode" ItemStyle-CssClass="ServiceUnitCode"
                                            HeaderText="ServiceUnitCode" HeaderStyle-Width="120px" />
