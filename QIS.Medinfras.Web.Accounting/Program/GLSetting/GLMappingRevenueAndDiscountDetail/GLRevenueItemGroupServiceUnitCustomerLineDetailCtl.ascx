<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLRevenueItemGroupServiceUnitCustomerLineDetailCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLRevenueItemGroupServiceUnitCustomerLineDetailCtl" %>
...
<script type="text/javascript" id="dxss_GLMappingItemGroupServiceUnitCustomerLineDetailEntryCtl">
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; position: relative;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ServiceUnitCode" ItemStyle-CssClass="ServiceUnitCode"
                                            HeaderText="ServiceUnitCode" HeaderStyle-Width="150px" />
                                        <asp:BoundField DataField="ServiceUnitName" ItemStyle-CssClass="ServiceUnitName"
                                            HeaderText="ServiceUnitName" HeaderStyle-Width="150px" />
                                        <asp:BoundField DataField="CustomerLineCode" ItemStyle-CssClass="SourceServiceUnitCode"
                                            HeaderText="CustomerLineCode" HeaderStyle-Width="150px" />
                                        <asp:BoundField DataField="CustomerLineName" ItemStyle-CssClass="SourceServiceUnitName"
                                            HeaderText="CustomerLineName" HeaderStyle-Width="150px" />
