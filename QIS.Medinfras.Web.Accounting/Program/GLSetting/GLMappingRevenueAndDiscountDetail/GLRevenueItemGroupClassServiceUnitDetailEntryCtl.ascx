<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLRevenueItemGroupClassServiceUnitDetailEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLRevenueItemGroupClassServiceUnitDetailEntryCtl" %>
