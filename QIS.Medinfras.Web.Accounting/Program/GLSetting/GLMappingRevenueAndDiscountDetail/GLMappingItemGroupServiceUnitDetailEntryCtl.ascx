<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemGroupServiceUnitDetailEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLMappingItemGroupServiceUnitDetailEntryCtl" %>
