...
{
    public partial class GLRevenueItemGroupClassServiceUnitDetailEntryCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vGLRevenueItemGroupClassServiceUnit> lst = BusinessLayer.GetvGLRevenueItemGroupClassServiceUnitList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemGroupClassServiceUnitDao entityDao = new GLRevenueItemGroupClassServiceUnitDao(ctx);
            try
            {
                GLRevenueItemGroupClassServiceUnit entity = new GLRevenueItemGroupClassServiceUnit();
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemGroupClassServiceUnit entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
