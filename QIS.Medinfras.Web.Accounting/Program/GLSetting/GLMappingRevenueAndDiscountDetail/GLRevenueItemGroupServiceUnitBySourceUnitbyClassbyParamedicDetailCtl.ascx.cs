...
{
    public partial class GLRevenueItemGroupServiceUnitBySourceUnitbyClassbyParamedicDetailCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vGLRevenueItemGroupServiceUnitBySourceUnitbyClassbyParamedic> lst = BusinessLayer.GetvGLRevenueItemGroupServiceUnitBySourceUnitbyClassbyParamedicList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemGroupServiceUnitBySourceUnitByClassByParamedicDao entityDao = new GLRevenueItemGroupServiceUnitBySourceUnitByClassByParamedicDao(ctx);
            try
            {
                GLRevenueItemGroupServiceUnitBySourceUnitByClassByParamedic entity = new GLRevenueItemGroupServiceUnitBySourceUnitByClassByParamedic();
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemGroupServiceUnitBySourceUnitByClassByParamedic entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
