<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLRevenueItemGroupServiceUnitBySourceUnitbyClassbyParamedicDetailCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLRevenueItemGroupServiceUnitBySourceUnitbyClassbyParamedicDetailCtl" %>
                    ...
                    <fieldset id="fsEntryPopup" style="margin: 0">
                        <table class="tblEntryDetail" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxComboBox ID="cboEmploymentStatus" Width="30%" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td class="tdLabel">
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; position: relative;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SourceServiceUnitCode" ItemStyle-CssClass="SourceServiceUnitCode"
                                            HeaderText="SourceServiceUnitCode" HeaderStyle-Width="150px" />
                                        <asp:BoundField DataField="SourceServiceUnitName" ItemStyle-CssClass="SourceServiceUnitName"
                                            HeaderText="SourceServiceUnitName" HeaderStyle-Width="150px" />
                                        <asp:BoundField DataField="EmployeeStatus" ItemStyle-CssClass="EmployeeStatus" HeaderText="EmployeeStatus"
                                            HeaderStyle-Width="150px" />
