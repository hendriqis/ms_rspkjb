<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemMasterDetailEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLMappingItemMasterDetailEntryCtl" %>
...
<script type="text/javascript" id="dxss_GLMappingItemMasterEntryCtl">
    ...
    $('#btnEntryPopupSave').click(function (evt) {
        if (IsValid(evt, 'fsEntryPopup', 'mpEntryPopup')) {
            ...
            if (itemID != 0 && itemID != "" && itemID != null) {
                ...
                displayErrorMessageBox('INFORMASI', "Harap pilih satu atau lebih untuk pilihan Komponen terlebih dahulu.");
            }
        }
        return false;
    });
