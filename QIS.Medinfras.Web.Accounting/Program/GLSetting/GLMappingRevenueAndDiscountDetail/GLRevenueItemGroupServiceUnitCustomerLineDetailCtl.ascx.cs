...
{
    public partial class GLRevenueItemGroupServiceUnitCustomerLineDetailCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vGLRevenueItemGroupServiceUnitCustomerLine> lst = BusinessLayer.GetvGLRevenueItemGroupServiceUnitCustomerLineList(filterExpression);
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            ...
            GLRevenueItemGroupServiceUnitCustomerLineDao entityDao = new GLRevenueItemGroupServiceUnitCustomerLineDao(ctx);
            try
            {
                GLRevenueItemGroupServiceUnitCustomerLine entity = new GLRevenueItemGroupServiceUnitCustomerLine();
                ...
                entity.CustomerLineID = Convert.ToInt32(hdnCustomerLineID.Value);
        ...
        private bool OnDeleteRecord(ref string errMessage)
        {
            ...
            try
            {
                GLRevenueItemGroupServiceUnitCustomerLine entity = entityDao.Get(Convert.ToInt32(hdnIDCtl.Value));
