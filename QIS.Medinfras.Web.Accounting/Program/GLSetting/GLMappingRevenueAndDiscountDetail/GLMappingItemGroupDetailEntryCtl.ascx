<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLMappingItemGroupDetailEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.GLMappingItemGroupDetailEntryCtl" %>
