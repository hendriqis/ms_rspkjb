<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master"
    AutoEventWireup="true" CodeBehind="GLRevenueAccountEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Accounting.Program.GLRevenueAccountEntry" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            ...
            function getClassCareFilterExpression() {
                var filterExpression = 'IsDeleted = 0 AND IsUsedInChargeClass = 0';
               return filterExpression;
            }
            ...
            <td style="padding: 2px; vertical-align: top">
                <table class="tblEntryContent" style="width: 50%">
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblMandatory">
                                <%=GetLabel("Transaksi")%></label>
                        </td>
                        <td>
                            <dxe:ASPxComboBox ID="cboGLRevenueTransaction" runat="server" Width="100%" />
                        </td>
                    </tr>
                     <tr id="trClass" runat="server">
                        <td class="tdLabel"><label class="lblLink" runat="server" id="lblClass"><%=GetLabel("Kelas")%></label></td>
                        <td>
                                ...
                                <tr>
                                    <td class="tdLabel">
                                        <label class="lblLink" id="lblGLAccount1">
                                            <%=GetLabel("COA Tariff Komponen 1")%></label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tdLabel">
                                        <label class="lblLink" id="lblGLAccount2">
                                            <%=GetLabel("COA Tariff Komponen 2")%></label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tdLabel">
                                        <label class="lblLink" id="lblGLAccount3">
                                            <%=GetLabel("COA Tariff Komponen 3")%></label>
                                    </td>
                                    <td>
