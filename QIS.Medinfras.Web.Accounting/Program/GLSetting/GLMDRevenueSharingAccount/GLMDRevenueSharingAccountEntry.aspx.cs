...
{
    public partial class GLMDRevenueSharingAccountEntry : BasePageEntry
    {
        ...
        {
            return String.Format("IsDeleted = 0 AND DepartmentID = '{0}' AND HealthcareID = '{1}'",Constant.Facility.DIAGNOSTIC,AppSession.UserLogin.HealthcareID);
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                String ID = param[0]; 
                hdnID.Value = ID;
                vGLMDRevenueSharingAccount entity = BusinessLayer.GetvGLMDRevenueSharingAccountList(String.Format("ID = {0}", hdnID.Value))[0];
        ...
        private void EntityToControl(vGLMDRevenueSharingAccount entity)
        {
        ...
        private void ControlToEntity(GLMDRevenueSharingAccount entity)
        {
            entity.Remarks = txtNotes.Text;
            entity.DepartmentID = Constant.Facility.DIAGNOSTIC;
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            try
            {
                GLMDRevenueSharingAccount entity = new GLMDRevenueSharingAccount();
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.InsertGLMDRevenueSharingAccount(entity);
                return true;
            }
            catch (Exception ex)
            {
