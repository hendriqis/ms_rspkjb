<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BudgetingTemplateRCCEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.BudgetingTemplateRCCEntryCtl" %>
...
<script type="text/javascript" id="dxss_BudgetingMasterDtRCCEntryCtl">
    ...
    $('.imgPopupEdit').live('click', function () {
        ...
        $('#<%=hdnBudgetTemplateDtID.ClientID %>').val(entity.BudgetTemplateDtID);
...
<input type="hidden" id="hdnBudgetTemplateDtID" runat="server" value="" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                        <ItemTemplate>
                                            ...
                                            <input type="hidden" value="<%#:Eval("BudgetTemplateDtID") %>" bindingfield="BudgetTemplateDtID" />
