<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BudgetingMasterDtRCCEntryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Accounting.Program.BudgetingMasterDtRCCEntryCtl" %>
                    ...
                    <td align="left">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtRCCCode" Width="100%" />
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtRCCName" Width="100%" ReadOnly="true" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:TextBox ID="txtBudgetAmountCtl" runat="server" Width="100%" CssClass="txtCurrency" />
                                </td>
                            </tr>
                            <tr>
                                <td>
