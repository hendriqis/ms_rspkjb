<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="BudgetingMasterEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Accounting.Program.BudgetingMasterEntry" %>
    ...
    <script type="text/javascript">
        ...
        $('#lblAddData').live('click', function (evt) {
            if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                ...
                $('#<%=txtBudgetAmount.ClientID %>').val('0').trigger('changeValue');
        ...
        $('#<%=grdView.ClientID %> .imgEdit.imgLink').live('click', function () {
            ...
            $('#<%=hdnBudgetDtID.ClientID %>').val(entity.BudgetDtID);
            ...
            $('#<%=txtBudgetAmount.ClientID %>').val(entity.BudgetAmount).trigger('changeValue');
        ...
        $('#lblSelectBudget.lblLink').live('click', function () {
            var filterExpression = "BudgetHdID IS NOT NULL";
            openSearchDialog('budgethd', filterExpression, function (value) {
        ...
        $('.lnkDetailRCC a').live('click', function () {
            ...
            if (isEditable == "1") {
                ...
                var url = ResolveUrl("~/Program/Master/Budgeting/BudgetingMasterDtRCCEntryCtl.ascx");
                openUserControlPopup(url, id, 'Budgeting Detail - Revenue Cost Center', 900, 500);
            } else {
                                ...
                                <td align="left">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:TextBox ID="txtBudgetAmount" runat="server" Width="100%" CssClass="txtCurrency" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdNormal notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="BudgetDtID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
