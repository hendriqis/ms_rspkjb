...
namespace QIS.Medinfras.Web.Accounting.Program
{
    public partial class FAGroupList : BasePageList
    {
        ...
        public override void SetFilterParameter(ref string[] fieldListText, ref string[] fieldListValue)
        {
            ...
            fieldListValue = new string[] { "FAGroupCode", "FAGroupName" };
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvFAGroupRowCount(filterExpression);
        ...
        protected override bool OnDeleteRecord(ref string errMessage)
        {
            if (hdnID.Value.ToString() != "")
            {
                ...
                List<FAItem> lstHd = BusinessLayer.GetFAItemList(string.Format("FAGroupID = {0} AND IsDeleted = 0", hdnID.Value));
                if (lstHd.Count == 0)
                {
