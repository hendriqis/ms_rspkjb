<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="OperatingRoomPatientList1.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalDiagnostic.Program.OperatingRoomPatientList1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <style type="text/css">
        .ulAreaDrop         { margin: 0; padding: 0; height: 45px;}
        .ulAreaDrop > li    { width:260px; border:1px solid #AAA; height :100%; z-index: 10000; display: inline-block; list-style-type: none; margin-right: 0px; margin-left: 0px; position: relative;background-color: #d9d9d9!important }
        ...
        .divDropHereInfo    { color: Gray; width:100%;text-align: center; margin-top:2px; }
    ...
    <script type="text/javascript">
        ...
        function registerEventHandler() {
            ...
            $('.ulAreaDrop > li').droppable({
                drop: function (event, ui) {
                    ...
                    var testOrderID = $tr.find('.keyField').html();
                    if ($('.ulAreaDrop > li .hdnTestOrderID[value=' + testOrderID + ']').length < 1) {
                        $container = $(this);
                        $container.find('.hdnTestOrderID').val(testOrderID);
                        $container.find('.tdContent').html('');
                        $container.find('.tdContent').hide();
                        ...
                        Methods.getHtmlControl(url, visitID + '|' + isFromMigration, function (result) {
                            ...
                            $container.find('.tdContent').show();
                            $container.find('.tdContent').html(result.replace(/\VIEWSTATE/g, ''));
                        }, function () {
                            $container.find('.tdContent').show();
                            $container.find('.imgLoadingMedicalHistory').hide();
                        });
        ...
        function onCbpRoomScheduleStatusEndCallback(s) {
            ...
            if (param[0] == '1') {
                ...
                displayErrorMessageBox("Jadwal Kamar Operasi", param[1]);
            }
        }
    </script>
                                                                        ...
                                                                        <asp:Panel runat="server" ID="Panel1" CssClass="pnlContainerGrid1">
                                                                            <div id="containerAppointment" class="containerAppointment">
                                                                                <asp:GridView ID="grdAppointment" runat="server" CssClass="grdSelected grdAppointment"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:BoundField DataField="ScheduledTime" HeaderStyle-CssClass="scheduledTime" ItemStyle-CssClass="scheduledTime" HeaderStyle-Width="60px" ItemStyle-Width="60px" />
                                                                                                ...
                                                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#e6e6e6" >
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="background-color:#f2f2f2; text-align:center;">
                                                                                                            <div class="w3-bar w3-large" style="color:#990000;"><%#: Eval("ScheduledTime") %> - <%#: Eval("cfEndTime") %></div>
                                                                                                            <div>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <div <%# Eval("cfIsCompleted").ToString() == "True" ? "Style='display:none'":"" %>>
                                                                                                                                <img class="btnEdit imgLink" title='<%=GetLabel("Edit Order")%>' 
                                                                                                                                src='<%# Eval("cfIsAllowEdit").ToString() == "False" ? ResolveUrl("~/Libs/Images/Button/edit_disabled.png") : ResolveUrl("~/Libs/Images/Button/edit.png")%>' alt="" roomScheduleID = '<%#Eval("ID") %>'  visitID = '<%#Eval("VisitID") %>' orderID = '<%#Eval("TestOrderID") %>' patientInfo = '<%#Eval("PatientName") %>' enabled = '<%#Eval("cfIsAllowEdit") %>' patientLocation = '<%#Eval("cfPatientLocation") %>'/>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <div <%# Eval("cfIsCompleted").ToString() == "True" ? "Style='display:none'":"" %>>
                                                                                                                                <img class="btnDelete imgLink" title='<%=GetLabel("Hapus Jadwal")%>' 
                                                                                                                                src='<%# Eval("cfIsAllowEdit").ToString() == "False" ? ResolveUrl("~/Libs/Images/Button/delete_disabled.png") : ResolveUrl("~/Libs/Images/Button/delete.png")%>' alt="" roomScheduleID = '<%#Eval("ID") %>' visitID = '<%#Eval("VisitID") %>' orderID = '<%#Eval("TestOrderID") %>' patientInfo = '<%#Eval("PatientName") %>' enabled = '<%#Eval("cfIsAllowEdit") %>'/>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <div <%# Eval("cfIsCompleted").ToString() == "True" ? "Style='display:none'":"" %>>
                                                                                                                                <img class="btnStartOrder imgLink" src='<%# Eval("cfIsStarted").ToString() == "False" ? ResolveUrl("~/Libs/Images/Button/start.png") : ResolveUrl("~/Libs/Images/Button/done.png")%>' 
                                                                                                                                    title='<%# Eval("cfIsStarted").ToString() == "False" ? "Mulai Operasi" : "Selesai Operasi" %>' alt="" roomScheduleID = '<%#Eval("ID") %>' visitID = '<%#Eval("VisitID") %>' orderID = '<%#Eval("TestOrderID") %>' patientInfo = '<%#Eval("PatientName") %>' isAllowStart = '<%#Eval("cfIsAllowSTART") %>'  isStarted = '<%#Eval("cfIsStarted") %>' appointmentID = '<%#Eval("appointmentID") %>' isAppointmentRegistered = '<%#Eval("cfIsAppointmentRegistered") %>' isDocumentCheckListCompleted = '<%#Eval("IsDocumentCheckListCompleted") %>'  />
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                        <td></td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <div <%# Eval("cfIsCompleted").ToString() == "True" ? "Style='display:none'":"" %>>
                                                                                                                                ...
                                                                                                                                src='<%# Eval("cfIsAllowEdit").ToString() == "False" ? ResolveUrl("~/Libs/Images/Button/list_disabled.png") : ResolveUrl("~/Libs/Images/Button/list.png")%>' alt="" roomScheduleID = '<%#Eval("ID") %>'  visitID = '<%#Eval("VisitID") %>' orderID = '<%#Eval("TestOrderID") %>' patientInfo = '<%#Eval("PatientName") %>' enabled = '<%#Eval("cfIsAllowEdit") %>' patientLocation = '<%#Eval("cfPatientLocation") %>'/>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <div <%# Eval("AppointmentID").ToString() == "0" ? "Style='display:none'":"" %>>
                                                                                                                                ...
                                                                                                                                src='<%# Eval("cfIsAppointmentRegistered").ToString() == "True" ? ResolveUrl("~/Libs/Images/Button/link_disabled.png") : ResolveUrl("~/Libs/Images/Button/link.png")%>' alt="" roomScheduleID = '<%#Eval("ID") %>'  visitID = '<%#Eval("VisitID") %>' orderID = '<%#Eval("TestOrderID") %>' patientInfo = '<%#Eval("PatientName") %>' enabled = '<%#Eval("cfIsAllowEdit") %>' patientLocation = '<%#Eval("cfPatientLocation") %>'/>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>    
                                                                                                        ...
                                                                                                        <td style="background-color:#f2f2f2; width:100%">
                                                                                                            ...
                                                                                                            <div><%#: Eval("DokterOperator")%></div>
                                                                                                            <div><%#: Eval("BusinessPartnerName")%></div>
                                                                                                            <div <%# Eval("AppointmentID").ToString() == "0" ? "Style='display:none'":"" %> class="blink"><label id="lblAppointmentInfo" class="lblLink" title="Pasien Appointment" style="font-weight:bold"><%#: Eval("AppointmentNo")%></label></div>
                                                                                                        </td>
                                                                                                        <td style="background-color:#f2f2f2">                                                                                                                
                                                                                                        </td>
                                                                                                    </tr>
                                                                    ...
                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#e6e6e6" >
                                                                                ...
                                                                                <tr>
                                                                                    <td style="background-color:#f2f2f2">
                                                                                        <div class="w3-bar w3-xlarge" style="color:#990000;padding-right:5px"><%#: Eval("ScheduledTime") %></div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div style="text-align:left"><img class="imgPatientImage" src='<%#Eval("PatientImageUrl") %>' alt="" height="77px" width="45px" style="float:left;margin-right: 10px;" /></div>
                                                                                    </td>
                                                                                    ...
                                                                                    <td style="background-color:#f2f2f2">
                                                                                        <img class="btnProcess imgLink" title='<%=GetLabel("Penjadwalan Order")%>' src='<%= ResolveUrl("~/Libs/Images/Button/process.png")%>' alt="" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </ItemTemplate>
