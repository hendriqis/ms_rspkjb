...
namespace QIS.Medinfras.Web.MedicalDiagnostic.Program
{
    public partial class FollowupPatientDischargeList : BasePageContent
    {
        ...
        {
            return Constant.MenuCode.MedicalDiagnostic.FOLLOWUP_PATIENT_DISCHARGE;
        }
        ...
        {
            string filterExpression = string.Format("DepartmentID = '{0}' AND HealthcareServiceUnitID = {1} AND GCVisitStatus IN ('{2}','{3}')", Constant.Facility.DIAGNOSTIC, cboServiceUnit.Value, Constant.VisitStatus.DISCHARGED, Constant.VisitStatus.CLOSED);
            string orderBy = "";
