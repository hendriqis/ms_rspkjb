<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master"
    AutoEventWireup="true" CodeBehind="MDVisitList.aspx.cs" Inherits="QIS.Medinfras.Web.MedicalDiagnostic.Program.MDVisitList" %>
    ...
    <div style="padding: 15px">
        <div class="containerUlTabPage" style="margin-bottom: 3px;">
            <ul class="ulTabPage" id="ulTabLabResult">
                <li contentid="containerByOrder" style="display: none">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <table style="width: 100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtServiceUnitOrderCode" Width="150px" runat="server" />
                                                </td>
                                                <td>
                                                    &nbsp;
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtServiceUnitOrderName" ReadOnly="true" Width="100%" runat="server" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table style="width: 100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="chkIsHasOrder" runat="server" Text="Memiliki Order" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
