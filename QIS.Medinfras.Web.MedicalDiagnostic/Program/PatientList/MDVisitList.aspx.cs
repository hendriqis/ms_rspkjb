...
{
    public partial class MDVisitList : BasePageRegisteredPatient2
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.MedicalDiagnostic.PATIENT_PAGE;
        }
        ...
        public override string GetFilterExpression2()
        {
            ...
            {
                filterExpression += string.Format(" AND HealthcareServiceUnitIDTestOrder = {0} AND IsHasTestOrder = 1", cboMedicalDiagnostic.Value);
            }
        ...
        public override void OnGrdRowClick(string transactionNo)
        {
            ...
            string parentCode = "";
            parentCode = Constant.MenuCode.MedicalDiagnostic.PATIENT_PAGE;
