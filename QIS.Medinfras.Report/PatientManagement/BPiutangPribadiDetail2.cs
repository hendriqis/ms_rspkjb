...
{
    public partial class BPiutangPribadiDetail2 : BaseDailyPortraitRpt
    {
        Boolean isControlCoverageLimit;
        PatientBill entityBill = null;
        String custType;

        public BPiutangPribadiDetail2()
        {
            InitializeComponent();
        }
        ...
        public override void InitializeReport(string[] param)
        {
            ...
            lblTotalAmount.Text = entityBill.TotalPatientAmount.ToString("N2");
