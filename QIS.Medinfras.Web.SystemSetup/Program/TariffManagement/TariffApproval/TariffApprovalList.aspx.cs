...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class TariffApprovalList : BasePageList
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            filterExpression += String.Format("GCTransactionStatus = '{0}' AND ApprovedBy = {1} AND IsDeleted = 0", Constant.TransactionStatus.WAIT_FOR_APPROVAL, AppSession.UserLogin.UserID);
