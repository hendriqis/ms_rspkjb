<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserRolesLocationEntryCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.SystemSetup.Program.UserRolesLocationEntryCtl" %>
...
<div style="height:450px; overflow-y:auto;overflow-x:hidden">
    ...
    <div class="pageTitle"><%=GetLabel("Lokasi")%></div>
