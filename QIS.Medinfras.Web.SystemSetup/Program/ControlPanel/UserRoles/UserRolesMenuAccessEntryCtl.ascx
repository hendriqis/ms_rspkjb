<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserRolesMenuAccessEntryCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.SystemSetup.Program.UserRolesMenuAccessEntryCtl" %>
...
<script type="text/javascript" id="dxss_userrolemenuaccessentryctl">
    function addMenuAccessFilterRow() {
        ...
        $trFilter = $("<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>");
...
<table class="tblEntryContent" style="width:70%">
    ...
    <tr>
        <td class="tdLabel"><label class="lblNormal" runat="server"><%=GetLabel("Profil Pengguna")%></label></td>
    ...
    <%--
        Fitur Tambahan untuk Copy Role dari Profile lain. (TO-DO)
    <tr>
        <td class="tdLabel"><label id="lblCopyFromProfile" class="lblNormal" runat="server" ><%=GetLabel("Copy Profile")%></label></td>
        <td colspan="2"><asp:DropDownList ID="ddlProfile" ReadOnly="true" Width="100%" runat="server" /></td>
        <td><input type="button" value='<%= GetLabel("Copy")%>' style="width:70px" id="btnCopy" /></td>
    </tr>--%>
</table>
            ...
            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;height: 273px;overflow-y:auto; ">
                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                    <Columns>
                        ...
                        <asp:BoundField DataField="MenuCode" HeaderText = "Kode"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="80px" />
                    ...
                    <EmptyDataTemplate>
                        <%=GetLabel("Tidak ada menu yang tersedia untuk user profile ini")%>
                    </EmptyDataTemplate>
                </asp:GridView>
            </asp:Panel>
        </dx:PanelContent>
...
<div style="width:100%;text-align:center">
    <table style="margin-left: auto; margin-right: auto; margin-top: 10px;">
        <tr>
            <td><input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("Simpan")%>' style="width:80px" id="btnSaveMatrix" /></td>
            <td><input type="button" class="w3-btn w3-hover-blue" value='<%= GetLabel("Tutup")%>' style="width:80px" onclick="pcRightPanelContent.Hide();" /></td>
        </tr>
    </table>
</div>
