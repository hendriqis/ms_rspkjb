...
{
    public partial class TransactionNumberingList : BasePageList
    {
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetTransactionTypeRowIndex(filterExpression, keyValue) + 1;
        ...
        {
            url = ResolveUrl("~/Program/ControlPanel/TransactionNumbering/TransactionNumberingEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/ControlPanel/TransactionNumbering/TransactionNumberingEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
