...
{
    public partial class SettingParameterPerHealthcareEntry : BasePageEntry
    {
        ...
        protected override void InitializeDataControl()
        {
            if (Request.QueryString.Count > 0)
            {
                ...
                hdnID.Value = ID;
                hdnHealthcare.Value = Healthcare;
        ...
        private void EntityToControl(HealthcareParameter entity)
        {
            ...
            else if (entity.GCParameterValueType == Constant.ControlType.SEARCH_DIALOG)
            {
                ...
                SearchDialogFilterExpression = entity.SearchDialogFilterExpression.Replace("@HealthcareID", hdnHealthcare.Value);
        ...
        protected override bool OnSaveEditRecord(ref string errMessage)
        {
            try
            {
                HealthcareParameter entity = BusinessLayer.GetHealthcareParameter(hdnHealthcare.Value, hdnID.Value);
