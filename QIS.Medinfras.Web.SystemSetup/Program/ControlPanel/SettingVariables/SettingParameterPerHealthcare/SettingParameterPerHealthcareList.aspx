<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master" AutoEventWireup="true" CodeBehind="SettingParameterPerHealthcareList.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Program.SettingParameterPerHealthcareList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="ParameterCode" HeaderText="Parameter Code" HeaderStyle-Width="150px" />
                                <asp:BoundField DataField="ParameterName" HeaderText="Parameter Name" />
                                <asp:BoundField DataField="ParameterValue" HeaderText="Parameter Value" HeaderStyle-Width="200px" />
                            </Columns>
                            <EmptyDataTemplate>
