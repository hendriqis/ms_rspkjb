<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master" AutoEventWireup="true" 
    CodeBehind="SettingParameterEntryX.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Program.SettingParameterEntry" %>
                ...
                <table class="tblEntryContent" style="width:50%">
                 <colgroup>
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtParameterCode" Width="150px" runat="server" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr id="trTxtParameterValue" runat="server">
                        ...
                        <td colspan="2"><asp:TextBox ID="txtParameterValue" Width="600px" runat="server" /></td>
                    </tr>
                    ...
                    <td>
                        <table>
                        <tr>
                        <td style="width: 200px;"><asp:CheckBox ID="chkIsByHealthcare" runat="server"/><%=GetLabel("Per Rumah Sakit")%></td>
                        <td><asp:CheckBox ID="ChkIsUsedBySystem" runat="server"/><%=GetLabel("Is Used By System")%></td>
                        </tr>
                        </table>
                    </td>
                    </tr>
