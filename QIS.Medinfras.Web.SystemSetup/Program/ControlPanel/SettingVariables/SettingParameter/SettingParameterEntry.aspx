<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master"
    AutoEventWireup="true" CodeBehind="SettingParameterEntry.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Program.SettingParameterEntry" %>
                            ...
                            <table>
                                <tr>
                                    <td style="width: 200px;">
                                        <asp:CheckBox ID="chkIsByHealthcare" runat="server" /><%=GetLabel("Per Rumah Sakit")%>
                                    </td>
                                    <td>
                                        <asp:CheckBox ID="chkIsUsedBySystem" runat="server" /><%=GetLabel("Is Used By System")%>
                                    </td>
                                </tr>
                            </table>
                        </td>
