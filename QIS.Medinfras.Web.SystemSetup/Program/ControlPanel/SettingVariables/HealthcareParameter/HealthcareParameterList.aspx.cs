...
{
    public partial class HealthcareParameterList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.SystemSetup.HEALTHCARE_PARAMETER;
        }
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                ...
                CurrPage = 1;
            List<Module> lst = BusinessLayer.GetModuleList("");
        ...
        {
            url = ResolveUrl("~/Program/ControlPanel/SettingVariables/HealthcareParameter/HealthcareParameterEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/ControlPanel/SettingVariables/HealthcareParameter/HealthcareParameterEntry.aspx?id={0}", hdnID.Value + "|" + AppSession.UserLogin.HealthcareID));
                return true;
            }
            return false;
        }
        ...
        //{
        //    if (hdnID.Value.ToString() != "" && hdnCode.Value.ToString() != "")
        //    {
        //        HealthcareParameter entity = BusinessLayer.GetHealthcareParameter(hdnID.Value, hdnCode.Value);
        //        entity.LastUpdatedBy = AppSession.UserLogin.UserID;
        //        BusinessLayer.DeleteHealthcareParameter(entity);
        //        return true;
        //    }
        //    return false;
        //}
        ...
        //{
        //    List<HealthcareParameter> lstSettingParameterDt = BusinessLayer.GetHealthcareParameterList(string.Format("ParameterCode = '{0}'", hdnExpandID.Value));
