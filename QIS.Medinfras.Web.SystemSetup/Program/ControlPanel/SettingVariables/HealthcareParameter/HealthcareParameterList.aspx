<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="HealthcareParameterList.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Program.HealthcareParameterList" %>
...
//            var url = ResolveUrl("~/Program/ControlPanel/SettingVariables/HealthcareParameter/HealthcareParameterDtCtl.ascx");
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ParameterCode" HeaderText="Kode Parameter" HeaderStyle-HorizontalAlign="Left"
                                    HeaderStyle-Width="150px" />
                                <asp:BoundField DataField="ParameterName" HeaderText="Nama Parameter" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="ParameterValue" HeaderText="Nilai Global" HeaderStyle-HorizontalAlign="Left" />
                            </Columns>
                            <EmptyDataTemplate>
                            ...
                            <asp:Panel runat="server" ID="Panel2" Style="width: 100%; margin-left: auto; margin-right: auto">
                                <asp:GridView ID="grdDetail" runat="server" CssClass="grdView notAllowSelect grdDetail"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="HealthcareName" HeaderText="Rumah Sakit" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="ParameterValueCustom" HeaderText="Nilai" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
