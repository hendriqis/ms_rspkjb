<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="HealthcareList.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Program.HealthcareList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="HealthcareID" HeaderText="Kode RS"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100px" />
