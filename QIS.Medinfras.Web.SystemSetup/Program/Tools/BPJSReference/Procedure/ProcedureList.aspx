<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ProcedureList.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Tools.ProcedureList" %>
    ...
    <script type="text/javascript">
        ...
        $('#<%=btnImportProcedure.ClientID %>').live('click', function (evt) {
            ...
            if (IsBridgingToBPJS == "1") {
                var procedureSearch = $('#<%=txtParamProcedure.ClientID %>').val();
                SearchBPJSReferenceProcedure(procedureSearch);
            } else {
                showToast('INFORMATION', 'Status bridging dengan bpjs sedang nonaktif.');
            }
        });
        function SearchBPJSReferenceProcedure(procedureSearch) {
            if ($('#<%=hdnIsBridgingBPJSVClaimVersion.ClientID %>').val() == Constant.VersionBridgingBPJSVClaim.v1_0) {
                BPJSService.reinsertBPJSReferenceProcedure(procedureSearch, function (result) {
                    if (result != null) {
                ...
                BPJSService.reinsertBPJSReferenceProcedureMedinfrasAPI(procedureSearch, function (result) {
                    if (result != null) {
                        showToast('INFORMATION', result);
                    }
                });
        ...
        //#endregion
            ...
            <table class="tblContentArea">
                ...
                <tr>
                    <td class="tdLabel">
                        <label>
                            <%=GetLabel("Kode Procedure / Nama Procedure")%></label>
             </td>
                    <td>
                        <asp:TextBox runat="server" ID="txtParamProcedure" Width="460px" />
                    </td>
                </tr>
             <tr>
                    <td colspan="2">
