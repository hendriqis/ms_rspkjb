...
namespace QIS.Medinfras.Web.SystemSetup.Tools
{
    public partial class ProcedureList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.SystemSetup.BPJS_REFERENCE_PROCEDURE;
        }
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvBPJSReferenceProcedureRowIndex(filterExpression, keyValue) + 1;
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvBPJSReferenceProcedureRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_ITEM);
            }

            List<vBPJSReferenceProcedure> lstEntity = BusinessLayer.GetvBPJSReferenceProcedureList(filterExpression, Constant.GridViewPageSize.GRID_ITEM, pageIndex);
