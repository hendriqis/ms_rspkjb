...
namespace QIS.Medinfras.Web.SystemSetup.Tools
{
    public partial class KabupatenList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.SystemSetup.BPJS_REFERENCE_KABUPATEN;
        }
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvBPJSReferenceKabupatenRowIndex(filterExpression, keyValue) + 1;
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvBPJSReferenceKabupatenRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_ITEM);
            }

            List<vBPJSReferenceKabupaten> lstEntity = BusinessLayer.GetvBPJSReferenceKabupatenList(filterExpression, Constant.GridViewPageSize.GRID_ITEM, pageIndex);
