...
{
    public partial class PoliList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.SystemSetup.BPJS_REFERENCE_POLI;
        }
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvBPJSReferencePoliRowIndex(filterExpression, keyValue) + 1;
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvBPJSReferencePoliRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_ITEM);
            }

            List<vBPJSReferencePoli> lstEntity = BusinessLayer.GetvBPJSReferencePoliList(filterExpression, Constant.GridViewPageSize.GRID_ITEM, pageIndex);
