<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="SDMList.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Tools.SDMList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#<%=btnImport.ClientID %>').live('click', function (evt) {
            KemenKesService.reinsertSIRANAPReferenceSDM(function (result) {
                cbpView.PerformCallback('refresh');
            });
        });
        //#endregion
