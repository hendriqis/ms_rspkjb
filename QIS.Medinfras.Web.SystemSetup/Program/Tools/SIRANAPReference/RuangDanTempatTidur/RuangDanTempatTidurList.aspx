<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="RuangDanTempatTidurList.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Tools.RuangDanTempatTidurList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#<%=btnImport.ClientID %>').live('click', function (evt) {
            KemenKesService.reinsertSIRANAPReferenceRuangDanTempatTidur(function (result) {
                cbpView.PerformCallback('refresh');
            });
        });
        //#endregion
                            ...
                            <dx:PanelContent ID="PanelContent1" runat="server">
                                <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="SiRanapCode" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                            <asp:BoundField DataField="SiRanapCode" HeaderText="Parameter Code" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" />
                                            <asp:BoundField DataField="SiRanapName" HeaderText="Nama" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left" />
