<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiefComplaintInfoCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Inventory.Program.ChiefComplaintInfoCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ObservationTime" HeaderText="Observation Time" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="ChiefComplaintText" HeaderText="Chief Complaint" HeaderStyle-Width="250px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                        ...
                                        <asp:BoundField DataField="cfCreatedDateInString" HeaderText="Created Date" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />                                                        
                                    </Columns>
                                    <EmptyDataTemplate>
