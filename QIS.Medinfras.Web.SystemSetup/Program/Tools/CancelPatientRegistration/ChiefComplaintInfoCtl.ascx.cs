...
{
    public partial class ChiefComplaintInfoCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vChiefComplaint> lstEntity = BusinessLayer.GetvChiefComplaintList(filterExpression, Constant.GridViewPageSize.GRID_MATRIX, pageIndex, "ID DESC");
