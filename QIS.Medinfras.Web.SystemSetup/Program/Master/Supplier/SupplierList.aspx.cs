...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class SupplierList : BasePageList
    {
        ...
        {
            fieldListText = new string[] { "Supplier Code", "Supplier Name", "Short Name" };
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<BusinessPartners> lstEntity = BusinessLayer.GetBusinessPartnersList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex);
        ...
        {
            url = ResolveUrl("~/Program/Master/Supplier/SupplierEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/Supplier/SupplierEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
