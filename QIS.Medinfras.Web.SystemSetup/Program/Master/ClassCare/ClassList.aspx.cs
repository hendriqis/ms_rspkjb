...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class ClassList : BasePageList
    {
        ...
        {
            fieldListText = new string[] { "ClassCode", "ClassName", "ShortName" };
        ...
        {
            url = ResolveUrl("~/Program/Master/ClassCare/ClassEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/ClassCare/ClassEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
