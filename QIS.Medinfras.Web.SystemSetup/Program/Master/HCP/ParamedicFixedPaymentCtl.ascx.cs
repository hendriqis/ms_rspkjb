...
{
    public partial class ParamedicFixedPaymentCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView()
        {
            ...
            List<vParamedicFixedPayment> lst = BusinessLayer.GetvParamedicFixedPaymentList(filter);
        ...
        private void ControlToEntity(ParamedicFixedPayment entity)
        {
        ...
        private bool OnSaveAddRecord(ref string errMessage)
        {
            try
            {
                ParamedicFixedPayment entity = new ParamedicFixedPayment();
                ControlToEntity(entity);
                entity.CreatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.InsertParamedicFixedPayment(entity);
                return true;
            }
            catch (Exception ex)
            {
        ...
        private bool OnSaveEditRecord(ref string errMessage)
        {
            try
            {
                ParamedicFixedPayment entity = BusinessLayer.GetParamedicFixedPayment(Convert.ToInt32(hdnID.Value));
                ControlToEntity(entity);
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateParamedicFixedPayment(entity);
                return true;
            }
            catch (Exception ex)
            {
