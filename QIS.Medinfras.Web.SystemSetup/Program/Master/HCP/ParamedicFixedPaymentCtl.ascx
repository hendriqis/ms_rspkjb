<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParamedicFixedPaymentCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.SystemSetup.Program.ParamedicFixedPaymentCtl" %>
...
<script type="text/javascript" id="dxss_ParamedicFixedPaymentCtl">
    $(function () {
