<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ItemLaboratoryList.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Program.ItemLaboratoryList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkFraction a').live('click', function () {
            ...
            openUserControlPopup(url, id, 'Item Laboratory Fraction', 900, 500);
        });
    </script>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderText="Fraction" Text="Fraction" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="lnkFraction" HeaderStyle-Width="100px" />
                            </Columns>
                            <EmptyDataTemplate>
