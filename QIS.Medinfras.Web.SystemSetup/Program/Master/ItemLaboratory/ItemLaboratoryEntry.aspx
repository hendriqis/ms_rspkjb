...
CodeBehind="ItemLaboratoryEntry.aspx.cs" Inherits="QIS.Medinfras.Web.SystemSetup.Program.ItemLaboratoryEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <div class="pageTitle"><%=GetLabel("Item Laboratory")%></div>
            ...
            <td style="padding:5px;vertical-align:top">
                ...
                <div class="containerTblEntryContent">
                    <table class="tblEntryContent" style="width:100%">
                        ...
                        <tr>
                            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Lab Test Category")%></label></td>
                            <td><dxe:ASPxComboBox ID="cboLabTestCategory" runat="server" Width="200px" /></td>
                        </tr>
                        <tr>
                            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Duration")%></label></td>
                            <td><asp:TextBox ID="txtDuration" runat="server" CssClass="number" Width="80px" /></td>
                        </tr>
                        <tr>
                ...
                <h4 class="h4expanded"><%=GetLabel("Precondition Notes")%></h4>
                <div class="containerTblEntryContent">
                    <table class="tblEntryContent" style="width:100%">
                        <tr>
                            <td>
                                <asp:TextBox TextMode="MultiLine" Width="100%" Height="300px" ID="txtPreconditionNotes" runat="server" CssClass="htmlEditor" />
                            </td>
                        </tr>
                    </table>
                </div>
