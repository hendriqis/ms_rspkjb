...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class TemplateTextList : BasePageList
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vTemplateText> lstEntity = BusinessLayer.GetvTemplateTextList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex);
        ...
        {
            url = ResolveUrl("~/Program/Master/TemplateText/TemplateTextEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/TemplateText/TemplateTextEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
