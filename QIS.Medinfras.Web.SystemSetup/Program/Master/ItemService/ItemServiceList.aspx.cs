...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class ItemServiceList : BasePageList
    {
        ...
        public override string OnGetMenuCode()
        {
            ...
            switch (MenuID)
            {
                case "SERVICES": return Constant.MenuCode.SystemSetup.ITEM_SERVICE;
                case "IMAGING": return Constant.MenuCode.SystemSetup.IMAGING_TEST_ITEM;
                default: return Constant.MenuCode.SystemSetup.OTHER_DIAGNOSTIC_ITEM; 
            }
        }
        ...
        private string GetFilterExpression()
        {
            ...
            switch (MenuID)
            {
                case "SERVICES": filterExpression += string.Format(DEFAULT_GRDVIEW_FILTER, Constant.ItemGroupMaster.SERVICE); break;
                case "IMAGING": filterExpression += string.Format(DEFAULT_GRDVIEW_FILTER, Constant.ItemGroupMaster.RADIOLOGY); break;
                default: filterExpression += string.Format(DEFAULT_GRDVIEW_FILTER, Constant.ItemGroupMaster.DIAGNOSTIC); break;
            }
        ...
        {
            String MenuID = Request.QueryString["id"];
            url = ResolveUrl(string.Format("~/Program/Master/ItemService/ItemServiceEntry.aspx?menu={0}", MenuID));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                String MenuID = Request.QueryString["id"];
                url = ResolveUrl(string.Format("~/Program/Master/ItemService/ItemServiceEntry.aspx?menu={0}&id={1}", MenuID, hdnID.Value));
                return true;
            }
            return false;
        }
