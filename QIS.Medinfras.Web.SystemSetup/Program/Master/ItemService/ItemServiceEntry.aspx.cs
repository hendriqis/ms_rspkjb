...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class ItemServiceEntry : BasePageEntry
    {
        ...
        {
            return Constant.MenuCode.SystemSetup.ITEM_SERVICE;
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            switch (MenuID)
            {
                case "SERVICES": GCItemType = Constant.ItemGroupMaster.SERVICE; break;
                case "IMAGING": GCItemType = Constant.ItemGroupMaster.RADIOLOGY; break;
                default: GCItemType = Constant.ItemGroupMaster.DIAGNOSTIC; break;
            }
