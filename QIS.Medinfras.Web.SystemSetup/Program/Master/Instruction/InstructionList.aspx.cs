...
{
    public partial class InstructionList : BasePageList
    {
        ...
        {
            fieldListText = new string[] { "Instruction Code", "Instruction Description 1", "Instruction Description 2" };
            fieldListValue = new string[] { "InstructionCode", "InstructionDescription1", "InstructionDescription2" };
        }
        ...
        {
            url = ResolveUrl("~/Program/Master/Instruction/InstructionEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/Instruction/InstructionEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
