<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeItemClassEntryCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.SystemSetup.Program.CoverageTypeItemClassEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunithealthcareentryctl">
    ...
    $('#lblClass.lblLink').live('click', function () {
        var filterExpression = "ClassID NOT IN (SELECT ClassID FROM CoverageTypeItemClass WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeID.ClientID %>').val() + " AND ItemID = '" + $('#<%=hdnItemID.ClientID %>').val() + "' AND IsDeleted = 0) AND IsDeleted = 0";
...
<div style="height:440px; overflow-y:auto">
    ...
    <div class="pageTitle"><%=GetLabel("Coverage Type Item Class")%></div>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:70%">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><asp:TextBox ID="txtItem" ReadOnly="true" Width="100%" runat="server" /></td>
                    </tr>  
                </table>
