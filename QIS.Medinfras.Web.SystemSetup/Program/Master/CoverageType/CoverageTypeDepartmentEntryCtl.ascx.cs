...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class CoverageTypeDepartmentEntryCtl : BaseViewPopupCtl
    {
        ...
        {
            lvwView.DataSource = BusinessLayer.GetvCoverageTypeDepartmentList(string.Format("CoverageTypeID = {0} AND IsDeleted = 0 ORDER BY DepartmentName ASC", hdnCoverageTypeID.Value));
            lvwView.DataBind();
        }
