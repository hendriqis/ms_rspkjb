<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CoverageTypeDepartmentEntryCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.SystemSetup.Program.CoverageTypeDepartmentEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunithealthcareentryctl">
    ...
    $('#lblDepartment.lblLink').live('click', function () {
        var filterExpression = "DepartmentID NOT IN (SELECT DepartmentID FROM CoverageTypeDepartment WHERE CoverageTypeID = " + $('#<%=hdnCoverageTypeID.ClientID %>').val() + " AND IsDeleted = 0)";
        openSearchDialog('department', filterExpression, function (value) {
    ...
    function onTxtCoverageTypeDepartmentCodeChanged(value) {
        var filterExpression = "DepartmentID = '" + value + "'";
...
<div style="height:440px; overflow-y:auto">
    ...
    <div class="pageTitle"><%=GetLabel("Coverage Type Facility")%></div>
                ...
                <div id="containerPopupEntryData" style="margin-top:10px;display:none;">
                    ...
                    <fieldset id="fsEntryPopup" style="margin:0"> 
                        <table class="tblEntryDetail" style="width:100%">
                            ...
                            <tr>
                                <td class="tdLabel"><label class="lblMandatory lblLink" id="lblDepartment"><%=GetLabel("Facility")%></label></td>
                                <td>
                                    ...
                                    <EmptyDataTemplate>
                                        <table id="tblView" runat="server" class="grdView notAllowSelect" cellspacing="0" rules="all" >
                                            <tr>
                                                ...
                                                <th style="width:250px" rowspan="2" align="center"><%=GetLabel("Facility")%></th>
