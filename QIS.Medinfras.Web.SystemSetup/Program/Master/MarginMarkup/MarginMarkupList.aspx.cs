...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class MarginMarkupList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.SystemSetup.MARKUP_MARGIN;
        }
        ...
        {
            fieldListText = new string[] { "Markup Code", "Markup Name" };
            fieldListValue = new string[] { "MarkupCode", "MarkupName" };
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<MarginMarkupHd> lstEntity = BusinessLayer.GetMarginMarkupHdList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex);
