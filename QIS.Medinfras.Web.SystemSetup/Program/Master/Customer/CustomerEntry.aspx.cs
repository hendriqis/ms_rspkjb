...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class CustomerEntry : BasePageEntry
    {
        ...
        {
            return Constant.MenuCode.SystemSetup.CUSTOMER;
        }
        ...
        protected override void InitializeDataControl()
        {
            if (Request.QueryString.Count > 0)
            {
                ...
                EntityToControl(entity, entityCus, entityAddress, entityTagField);
            }
            else
            {
                SetControlProperties();
        ...
        {
            List<StandardCode> listStandardCode = BusinessLayer.GetStandardCodeList(string.Format("ParentID IN ('{0}','{1}') AND IsDeleted = 0", Constant.StandardCode.CUSTOMER_TYPE, Constant.StandardCode.TARIFF_SCHEME));
            ...
            List<MarginMarkupHd> listMarginMarkupHd = BusinessLayer.GetMarginMarkupHdList("IsDeleted = 0");
            listMarginMarkupHd.Insert(0, new MarginMarkupHd { MarkupID = 0, MarkupName = "" });
        }
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(txtCustomerCode, new ControlEntrySetting(true, true, true));
            ...
            SetControlEntrySetting(txtCreditLimit, new ControlEntrySetting(true, true, true, 0));
            SetControlEntrySetting(txtCreditBalance, new ControlEntrySetting(true, true, true, 0));
            #endregion
        ...
        private void EntityToControl(BusinessPartners entity, vCustomer entityCus, vAddress entityAddress, BusinessPartnerTagField entityTagField)
        {
            #region General Information
            ...
            #region Administration & Service
            txtCreditBalance.Text = entityCus.CreditBalance.ToString();
            txtCreditLimit.Text = entityCus.CreditLimit.ToString();
            #endregion
        ...
        private void ControlToEntity(BusinessPartners entity, Customer entityCus, Address entityAddress, BusinessPartnerTagField entityTagField)
        {
            #region General Information
        ...
        protected override bool OnBeforeSaveAddRecord(ref string errMessage)
        {
            ...
            string FilterExpression = string.Format("BusinessPartnerCode = '{0}'", txtCustomerCode.Text);
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                ControlToEntity(entity, entityCus, entityAddress, entityTagField);
