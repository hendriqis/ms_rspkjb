...
namespace QIS.Medinfras.Web.SystemSetup.Program
{
    public partial class EmployeeList : BasePageList
    {
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvEmployeeRowIndex(filterExpression, keyValue, "FullName ASC") + 1;
        ...
        public override void SetFilterParameter(ref string[] fieldListText, ref string[] fieldListValue)
        {
            ...
            fieldListValue = new string[] { "EmployeeCode", "FullName" };
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvEmployeeRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_MASTER);
            }

            List<vEmployee> lstEntity = BusinessLayer.GetvEmployeeList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "FullName ASC");
