<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BedQuickPicksReservationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inpatient.Controls.BedQuickPicksReservationCtl" %>
...
<script type="text/javascript" id="dxss_bedquickpicksctl">
    ...
    $('#ulBedPicksBedSelected li').live('click', function () {
        ...
        if (GCBedStatus != '<%=GCBedStatusClosed %>') {
            ...
            <td colspan="2">
                <div id="divShow0" class="divShow">
                    <table class="tblContentArea" style="width: 100%;">
                        ...
                        <tr>
                            <td style="width: 260px; padding: 5px; border: 1px solid #EAEAEA" valign="top">
                                    ...
                                    <PanelCollection>
                                        <dx:PanelContent ID="PanelContent1" runat="server">
                                            <asp:Repeater ID="rptRoom" runat="server" OnItemDataBound="rptRoom_ItemDataBound">
                                                <HeaderTemplate>
                                                    <div style="overflow-y: scroll; max-height: 390px">
                            ...
                            <td align="left" id="footer" valign="top" style="width: auto; height: 390px;">
                                <div style="overflow-x: scroll; overflow-y: scroll; height: 390px">
