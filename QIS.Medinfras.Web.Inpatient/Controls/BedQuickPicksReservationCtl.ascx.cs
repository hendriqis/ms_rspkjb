...
{
    public partial class BedQuickPicksReservationCtl : BaseContentPopupCtl
    {
        protected int pageC = 1;
        protected string GCBedStatusClosed = "";

        public override void InitializeControl(string param)
        {
            hdnRegistrationID.Value = param;

            GCBedStatusClosed = Constant.BedStatus.CLOSED;

            string filterSU = string.Format("DepartmentID = '{0}' AND IsUsingRegistration = 1 AND IsDeleted = 0", Constant.Facility.INPATIENT);
