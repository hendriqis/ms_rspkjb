...
{
    public partial class GridBedReservationCtl : System.Web.UI.UserControl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvBedReservationRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_PATIENT_LIST);
            }

            List<vBedReservation> lstEntity = BusinessLayer.GetvBedReservationList(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex, "ReservationNo ASC");
