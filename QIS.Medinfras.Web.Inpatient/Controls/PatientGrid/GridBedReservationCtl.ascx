<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridBedReservationCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inpatient.Controls.GridBedReservationCtl" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxCallbackPanel" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v11.1, Version=11.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dx" %>
<script type="text/javascript" id="dxss_gridGridbedreservationctl">
                ...
                <asp:ListView runat="server" ID="lvwView">
                    <EmptyDataTemplate>
                        <table id="tblView" runat="server" class="grdCollapsible lvwView" cellspacing="0" rules="all" >
                            <tr>
                                ...
                                <th style="width:120px; text-align: left;"><%=GetLabel("DATA RESERVASI")%></th>
                                <th style="width:200px; text-align: left;"><%=GetLabel("RUANG PERAWATAN")%></th>
                                <th style="width:200px; text-align: left;"><%=GetLabel("KELAS PERAWATAN")%></th>
                                <th style="width:300px; text-align: left;"><%=GetLabel("DATA PASIEN")%></th>
                                <th style="width:220px; text-align: left;"><%=GetLabel("ALAMAT PASIEN")%></th>
                                <th style="width:50px; text-align: center"><%=GetLabel("STATUS")%></th>
                            </tr>
                            <tr class="trEmpty">
                                <td colspan="5">
                                    <%=GetLabel("Tidak ada reservasi pasien")%>
                                </td>
                            </tr>
                        </table>
                    </EmptyDataTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <div><%#: Eval("ReservationNo") %></div>
                                    <input type="hidden" class="hdnReservationID" value='<%#: Eval("ReservationID") %>' />
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div><%#: Eval("PatientName") %> <%#: Eval("cfRegistrationNo") %></div>   
                            </td>
                            <td>
                                <div><%#: Eval("PatientAddress") %></div>   
                            </td>
                            <td>
                                <div style="width: 60%; margin: 0px auto;"><%#: Eval("ReservationStatus") %></div>
                            </td>
                        </tr>
                            ...
                            <td>
                                <div>
                                    <div style="float: left">
                                        <%#: Eval("cfReservationDateInString")%></div>
                                    <div style="margin-left: 100px">
                                        <%#: Eval("ReservationTime")%></div>
                            </td>
                            <td>
                                <div>
                                    <div>
                                    ...
                                    <div style="float: left"><%#: Eval("ClassName")%></div>
                                </div>
                            </td>
                            <td>
