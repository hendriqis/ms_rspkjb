<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FollowupNotesCtl.ascx.cs" Inherits="QIS.Medinfras.Web.Inpatient.Program.FollowupNotesCtl" %>
            ...
            <td style="padding: 5px; vertical-align: top;">
                <table class="tblEntryContent" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNoteTime" Width="80px" CssClass="time" MaxLength="5" runat="server" Style="text-align: center" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel">
