<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FollowupNotesHistoryCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inpatient.Program.FollowupNotesHistoryCtl" %>
