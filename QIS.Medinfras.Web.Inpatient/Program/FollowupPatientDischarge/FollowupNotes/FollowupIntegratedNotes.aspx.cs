...
{
    public partial class FollowupIntegratedNotes : BasePagePatientPageList
    {
        ...
        private void BindGridView()
        {
            ...
            string filterExpression = string.Format("VisitID IN ({0},{1}) AND GCPatientNoteType IN ('{2}', '{3}', '{4}', '{5}', '{6}') ORDER BY NoteDate DESC, NoteTime DESC", AppSession.RegisteredPatient.VisitID, cvLinkedID, Constant.PatientVisitNotes.NURSING_NOTES, Constant.PatientVisitNotes.SOAP_SUMMARY_NOTES, Constant.PatientVisitNotes.FOLLOWUP_NOTES, Constant.PatientVisitNotes.PHARMACY_NOTES, Constant.PatientVisitNotes.DIAGNOSTIC_SUPPORT_NOTES);
        ...
        //            {
        //                string outdated = string.Empty;
        //                if (entitySameTimeNotes.IsDeleted)
        //                {
        //                    outdated = "<span style='color:red; margin-left:10px'>OUTDATED</span>";
        //                }
        //                if (entitySameTimeNotes.GCPatientNoteType == Constant.PatientVisitNotes.NURSING_NOTES)
        //                {
        //                    if (!string.IsNullOrEmpty(newEntity.NursingNote)) newEntity.NursingNote += "\n";
        //                    newEntity.NursingNote += string.Format("<b>{0}: {1}\n</b>", entitySameTimeNotes.ParamedicName, outdated);
        //                    newEntity.NursingNote += string.Format("<div style=\"margin-left:10px;\">{0}</div>",entitySameTimeNotes.NoteText + "\n");
        //                }
        //                else
        //                {
        //                    if (!string.IsNullOrEmpty(newEntity.PhysicianNote)) newEntity.PhysicianNote += "\n";
        //                    newEntity.PhysicianNote += string.Format("<b>{0}: {1}\n</b>", entitySameTimeNotes.ParamedicName, outdated);
        //                    newEntity.PhysicianNote += string.Format("<div style=\"margin-left:10px;\">{0}</div>", entitySameTimeNotes.NoteText + "\n");
        //                }
        //            }
