<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="XXXParamedicTeamCtl.ascx.cs" 
Inherits="QIS.Medinfras.Web.Inpatient.Program.XXXParamedicTeamCtl" %>
                ...
                <div id="containerPopupEntryData" style="margin-top:10px;display:none;">
                    ...
                    <fieldset id="fsEntryPopup" style="margin:0"> 
                        <table class="tblEntryDetail" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <table style="width:100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td><asp:TextBox ID="txtParamedicCode" Width="100%" runat="server" /></td> <!-- Ini customer item code yg waktu mau insert -->
                                            <td>&nbsp;</td>
                            ...
                            <tr>
                                <td class="tdLabel"><label><%=GetLabel("Peranan")%></label></td>
                            ...
                            <asp:Panel runat="server" ID="pnlPatientVisitTransHdGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ParamedicName" HeaderText="Dokter / Paramedis" ItemStyle-CssClass="tdParamedicName" ItemStyle-HorizontalAlign="Left" />
