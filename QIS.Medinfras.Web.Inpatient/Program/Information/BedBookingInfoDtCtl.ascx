<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BedBookingInfoDtCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inpatient.Program.BedBookingInfoDtCtl" %>
...
<script type="text/javascript" id="dxss_BedBookingInfoDtCtl">
    //#region Paging
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:430px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" >
                                    <Columns>
                                        <asp:BoundField DataField="BedCode" HeaderText="Tempat Tidur" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="240px"  />
                                        <asp:BoundField DataField="RegistrationNo" HeaderText="No. Registrasi" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="240px"  />
