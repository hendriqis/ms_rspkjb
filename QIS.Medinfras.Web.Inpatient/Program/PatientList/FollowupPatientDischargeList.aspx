<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPMain.master" AutoEventWireup="true"
    CodeBehind="FollowupPatientDischargeList.aspx.cs" Inherits="QIS.Medinfras.Web.Inpatient.Program.FollowupPatientDischargeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=txtDischargeDateTo.ClientID %>').datepicker('option', 'maxDate', '0');
                        ...
                        <table class="tblEntryContent" style="width: 60%;">
                            ...
                            <tr>
                                ...
                                <asp:RadioButtonList ID="rblDataSource" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Text="Registrasi" Value="filterRegistrationDate" />
                                    <asp:ListItem Text="Tutup Registrasi" Value="filterClosedDate" Selected="true" />
