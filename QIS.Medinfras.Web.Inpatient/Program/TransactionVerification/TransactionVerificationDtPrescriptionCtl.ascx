<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TransactionVerificationDtPrescriptionCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.CommonLibs.Program.TransactionVerificationDtPrescriptionCtl" %>
...
<script type="text/javascript" id="dxss_generatebilldtprescriptionctl">
    ...
    $('#chkSelectAllPrescriptionResult').die('change');
    $('#chkSelectAllPrescriptionResult').live('change', function () {
...
<div class="containerUlTabPage" style="height:300px;background-color:White; overflow-y:scroll;margin-bottom: 10px;">
    <asp:ListView ID="lvwPrescription" runat="server">
        <EmptyDataTemplate>
            <table id="tblView" runat="server" class="grdNormal grdPrescription" cellspacing="0" rules="all" >
                <tr>  
                    <th style="width:70px" align="center" rowspan="2"><input id="chkSelectAllPrescriptionResult" type="checkbox" /></th>
                    <th rowspan="2">
        ...
        <LayoutTemplate>                                
            <table id="tblView" runat="server" class="grdPrescription grdNormal" cellspacing="0" rules="all" >
                <tr>  
                    <th style="width:70px" align="center" rowspan="2"><input id="chkSelectAllPrescriptionResult" type="checkbox" /></th>
                    <th rowspan="2">
                        <div><%=GetLabel("Generic")%> - <%=GetLabel("Product")%> - <%=GetLabel("Strength")%> - <%=GetLabel("Form")%></div>
