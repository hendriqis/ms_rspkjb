<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ItemDistributionConfirmedList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ItemDistributionConfirmedList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnItemDistributionHdItem" crudmode="R" runat="server">
        <img src='<%=ResolveUrl("~/Libs/Images/Icon/tbnew.png")%>' alt="" /><br style="clear: both" />
        <div>
            <%=GetLabel("Item")%></div>
    </li>
    <li id="btnItemDistributionHdApprove" crudmode="R" runat="server">
        <img src='<%=ResolveUrl("~/Libs/Images/Icon/tbapprove.png")%>' alt="" /><br style="clear: both" />
        <div>
            <%=GetLabel("Approve")%></div>
    </li>
    <li id="btnItemDistributionHdDecline" crudmode="R" runat="server">
            ...
            $('#<%=btnItemDistributionHdItem.ClientID %>').click(function () {
                if ($('.chkIsSelected input:checked').length == 1) {
                    if (IsValid(null, 'fsMPEntry', 'mpEntry')) {
                        ...
                        var url = ResolveUrl("~/Program/Warehouse/ItemDistribution/ItemDistributionConfirmedDetailCtl.ascx");
                        openUserControlPopup(url, param, 'Konfirmasi Penerimaan Barang', 800, 600);
                    }
                }
                else if ($('.chkIsSelected input:checked').length > 1) {
                    showToast('Warning', 'Please Select Only One Item Distribution');
                }
                else {
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderText="No. Distribusi" DataTextField="DistributionNo" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="lnkDistribution" HeaderStyle-Width="150px" />
                                ...
                                <asp:BoundField DataField="DeliveryRemarks" HeaderText="Keterangan" HeaderStyle-HorizontalAlign="Left"
