<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemDistributionExpiredDateCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ItemDistributionExpiredDateCtl" %>
...
<script type="text/javascript" id="dxss_serviceunithealthcareentryctl">
    ...
    $('#lblPopupAddData').live('click', function () {
        ...
        var dateNow = Methods.dateToDatePickerFormat(new Date());
        $('#<%=txtExpiredDate.ClientID %>').val(dateNow);
        $('#trEditEntry').show();
    });
    ...
    $('.imgEdit').live('click', function () {
        ...
        Methods.getObject('GetItemDistributionDtExpiredList', filterExpression, function (result) {
            if (result != null) {
                $('#trEditEntry').show();
...
<input type="hidden" runat="server" id="hdnIsUseMaxExpiredDate" value=""/>
<input type="hidden" runat="server" id="hdnMaxExpiredDate" value=""/>
