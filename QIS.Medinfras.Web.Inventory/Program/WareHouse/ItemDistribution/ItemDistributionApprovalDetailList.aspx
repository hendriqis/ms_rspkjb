<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ItemDistributionApprovalDetailList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ItemDistributionApprovalDetailList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnItemDistributionDetailApprove" crudmode="R" runat="server">
        <img src='<%=ResolveUrl("~/Libs/Images/Icon/tbapprove.png")%>' alt="" /><br style="clear: both" />
        <div>
            <%=GetLabel("Approve")%></div>
    </li>
    <li id="btnDistributionListBack" runat="server" crudmode="R">
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnDistributionListBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Warehouse/ItemDistribution/ItemDistributionApprovalList.aspx?id=to');
            });
    ...
    <div style="height: 435px; overflow-y: auto; overflow-x: hidden;">
        <%--<div class="pageTitle">
            <div style="font-size: 1.1em">
                <%=GetLabel("Distribusi Barang")%></div>
        </div>--%>
            ...
            <tr>
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="lblDistributionNo">
                                    <%=GetLabel("No. Distribusi")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDistributionNo" Width="150px" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNotes" Width="100%" runat="server" TextMode="MultiLine" ReadOnly="true" Rows="2" />
                            </td>
                        </tr>
                    </table>
                </td>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-right: 1px; width: 140px">
                                            <asp:TextBox ID="txtItemDistributionDate" Width="120px" ReadOnly="true" CssClass="datepicker" runat="server" />
                                        </td>
                                        <td style="width: 5px">
                                            &nbsp;
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtItemDistributionTime" Width="100px" CssClass="time" runat="server"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtLocationCodeTo" ReadOnly="true" Width="100%" runat="server" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
