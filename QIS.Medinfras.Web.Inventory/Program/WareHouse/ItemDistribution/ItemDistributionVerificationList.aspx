<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master"
    AutoEventWireup="true" CodeBehind="ItemDistributionVerificationList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ItemDistributionVerificationList" %>
            ...
            $('#<%=btnItemDistributionHdItem.ClientID %>').click(function () {
                if ($('.chkIsSelected input:checked').length == 1) {
                    if (IsValid(null, 'fsMPEntry', 'mpEntry')) {
                        ...
                        var url = ResolveUrl("~/Program/Warehouse/ItemDistribution/ItemDistributionVerificationDetailCtl.ascx");
