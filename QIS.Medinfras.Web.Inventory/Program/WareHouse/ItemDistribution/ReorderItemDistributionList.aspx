<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="ReorderItemDistributionList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ReorderItemDistributionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onAfterCustomClickSuccess(type, retval) {
            showToast('Save Success', 'Distribusi Barang Berhasil Dibuat Dengan No Distribusi <b>' + retval + '</b>', function () {
                                    ...
                                    <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                        ...
                                        <asp:GridView ID="grdView" runat="server" CssClass="grdService grdNormal notAllowSelect"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CustomMinimum2" HeaderText="Minimum" HeaderStyle-Width="80px"
                                                    HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                                <asp:BoundField DataField="CustomMaximum2" HeaderText="Maximum" HeaderStyle-Width="80px"
                                                    HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                                <asp:BoundField DataField="CustomEndingBalance2" HeaderText="Stok Tujuan" HeaderStyle-Width="80px"
                                                    HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                                <asp:BoundField DataField="CustomAverageQty" HeaderText="Pemakaian Rata-Rata" HeaderStyle-Width="80px"
                                                    HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                                <asp:BoundField DataField="CustomQtyOnOrderItemDistribution" HeaderText="On Distribution"
                                                    HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right" />
                                                <asp:TemplateField HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" HeaderText="Qty Distribusi"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
