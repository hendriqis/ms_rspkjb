<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemDistributionConfirmedDetailCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ItemDistributionConfirmedDetailCtl" %>
...
<div class="pageTitle">
    <%=GetLabel("Konfirmasi Penerimaan Barang Detail")%></div>
                        ...
                        <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                            ...
                            <asp:GridView ID="grdView" runat="server" CssClass="grdService grdNormal notAllowSelect"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CustomItemUnit" HeaderText="Quantity" HeaderStyle-Width="120px"
                                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                    <asp:BoundField DataField="CustomConversion" HeaderText="Konversi" HeaderStyle-Width="180px"
                                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="CustomItemDistribution" HeaderText="Total" HeaderStyle-Width="120px"
                                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                </Columns>
                                <EmptyDataTemplate>
