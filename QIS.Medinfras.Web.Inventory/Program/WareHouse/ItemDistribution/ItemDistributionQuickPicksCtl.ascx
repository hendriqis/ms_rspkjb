<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemDistributionQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ItemDistributionQuickPicksCtl" %>
...
<script type="text/javascript" id="dxss_drugslogisticsquickpicksctl">
    function addItemFilterRow() {
        ...
        $trFilter = $("<tr><td></td><td colspan='2'></td><td></td><td></td><td></td></tr>");
    ...
    $('#<%=grdView.ClientID %> .chkIsSelected input').live('change', function () {
        if ($(this).is(':checked')) {
            ...
            $newTr = $newTr.replace(/\$\{ItemCode}/g, $selectedTr.find('.tdItemCode').html());
            ...
            $newTr = $newTr.replace(/\$\{DrugClass}/g, $selectedTr.find('.tdDrugClass').html()); 
...
<div style="padding: 10px;">
    ...
    <input type="hidden" id="hdnGCLocationGroup" runat="server" value="" />
    <table>
        <colgroup>
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderStyle-Width="50px" DataField="ItemCode" HeaderText="Kode Item"
                                            ItemStyle-CssClass="tdItemCode" />
                                        <asp:BoundField DataField="ItemName1" HeaderText="Nama Item" ItemStyle-CssClass="tdItemName1" />
                                        ...
                                        <asp:BoundField HeaderStyle-Width="50px" DataField="ItemUnit" HeaderText="Satuan"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="tdItemUnit" />
                                        <asp:BoundField HeaderStyle-Width="70px" DataField="DrugClass" HeaderText="Klasifikasi Obat"
                                            ItemStyle-CssClass="tdDrugClass" />
                                    </Columns>
                                    <EmptyDataTemplate>
