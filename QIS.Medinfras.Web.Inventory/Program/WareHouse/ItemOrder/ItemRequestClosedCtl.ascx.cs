...
{
    public partial class ItemRequestClosedCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("ItemRequestID = {0} AND IsDeleted = 0 AND GCItemDetailStatus = '{1}'", hdnIRID.Value, Constant.TransactionStatus.CLOSED);
            if (isCountPageCount)
            {
