...
{
    public partial class ApprovedItemRequestList : BasePageTrx
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            filterExpression += " AND IsHasCopy = 0";

            if (isCountPageCount)
            {
                int rowCount = BusinessLayer.GetvItemRequestHd2RowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_PATIENT_LIST);
            }

            ////List<vItemRequestHd2> lstEntity = BusinessLayer.GetvItemRequestHd2List(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex, "LastUpdatedDate DESC");
            List<vItemRequestHd2> lstEntity = BusinessLayer.GetvItemRequestHd2List(filterExpression, Constant.GridViewPageSize.GRID_PATIENT_LIST, pageIndex, "TransactionDate DESC, ItemRequestID DESC");
