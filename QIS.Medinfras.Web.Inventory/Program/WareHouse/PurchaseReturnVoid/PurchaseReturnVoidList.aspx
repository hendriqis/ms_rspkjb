...
CodeBehind="PurchaseReturnVoidList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReturnVoidList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkDetail a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/Warehouse/PurchaseReturnVoid/PurchaseReturnDtCtl.ascx");
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="No Retur" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left" ItemStyle-CssClass="lnkDetail" >
                                    <ItemTemplate>
                                        <a><%#:Eval("PurchaseReturnNo")%></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField DataField="ReturnDateInString" HeaderText="Tgl. Retur" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
