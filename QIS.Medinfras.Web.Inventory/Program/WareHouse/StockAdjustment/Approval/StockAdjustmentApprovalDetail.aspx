<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="StockAdjustmentApprovalDetail.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.StockAdjustmentApprovalDetail" %>
    ...
    <div style="height: 435px; overflow-y: auto; overflow-x: hidden;">
        <%--<div class="pageTitle">
            <div style="font-size: 1.1em">
                <%=GetLabel("Penyesuaian Persediaan")%></div>
        </div>--%>
