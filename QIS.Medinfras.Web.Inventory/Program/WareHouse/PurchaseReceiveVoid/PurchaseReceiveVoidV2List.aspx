<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="PurchaseReceiveVoidV2List.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveVoidV2List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPurchaseReceiveVoid" crudmode="R" runat="server">
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveVoid.ClientID %>').click(function () {
                if ($('.chkIsSelected input:checked').length < 1) {
                    ...
                    $('.chkIsSelected input:checked').each(function () {
                        var porID = $(this).closest('tr').find('.keyField').html();
                        if (param != '')
                            param += ',';
                        param += porID;
                    });
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="No Penerimaan" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-CssClass="lnkDetail">
                                    <ItemTemplate>
                                        <a>
                                            <%#:Eval("PurchaseReceiveNo")%></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="SupplierName" HeaderText="Nama Supplier" ItemStyle-HorizontalAlign="Left"
                                    HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="ReceivedDateInString" HeaderText="Tgl. Penerimaan" HeaderStyle-Width="100px"
                                    ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="LocationName" HeaderText="Dari Lokasi" HeaderStyle-Width="200px"
                                    HeaderStyle-HorizontalAlign="Left" />
                            </Columns>
                            <EmptyDataTemplate>
