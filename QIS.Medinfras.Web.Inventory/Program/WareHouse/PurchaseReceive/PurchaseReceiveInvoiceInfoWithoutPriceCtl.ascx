<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceiveInvoiceInfoWithoutPriceCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveInvoiceInfoWithoutPriceCtl" %>
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblNormal">
                                <%=GetLabel("Purchase Receive No : ")%></label>
                        </td>
                        <td>
                            ...
                            <asp:panel runat="server" id="Panel1" cssclass="pnlContainerGridPatientPage">
                                <asp:gridview id="grdView" runat="server" cssclass="grdSelected grdView" autogeneratecolumns="false"
                                    ...
                                    <columns>
                                        ...
                                        <asp:BoundField DataField="PurchaseInvoiceNo" HeaderText="No. Invoice" HeaderStyle-Width="120px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="PurchaseInvoiceDateInString" HeaderText="Tanggal Invoice" HeaderStyle-Width="120px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="CreatedByName" HeaderText="Dibuat Oleh" HeaderStyle-Width="120px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                    </columns>
                                    <emptydatatemplate>
