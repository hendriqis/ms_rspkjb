...
{
    public partial class PurchaseReceiveConfirmedList : BasePageTrx
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            filterExpression += String.Format("GCTransactionStatus = '{0}' AND TransactionCode = '{1}' AND PurchaseReceiveID IN (SELECT DISTINCT PurchaseReceiveID From PurchaseReceiveDt WHERE IsNeedConfirmation = 1 AND GCItemDetailStatus NOT IN ('{2}','{3}'))", Constant.TransactionStatus.OPEN, Constant.TransactionCode.PURCHASE_RECEIVE, Constant.TransactionStatus.APPROVED, Constant.TransactionStatus.VOID);
