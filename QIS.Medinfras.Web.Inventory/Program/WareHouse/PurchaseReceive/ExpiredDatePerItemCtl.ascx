<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExpiredDatePerItemCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ExpiredDatePerItemCtl" %>
        ...
        <td>
            ...
            <div>
                <table class="tblEntryDetail" style="width: 100%">
                    ...
                    <tr>
                        <td><label class="lblMandatory"><%=GetLabel("Expired Date") %></label></td>
                        ...
                        <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                            ...
                            <asp:GridView ID="grdView" runat="server" CssClass="grdNormal"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="QuantityInString" HeaderText = "Quantity"  />
                                </Columns>
                                <EmptyDataTemplate>
