<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="PurchaseReceiveConfirmedDetailList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveConfirmedDetailList" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReceiveBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Warehouse/PurchaseReceive/PurchaseReceiveConfirmedList.aspx?id=to');
            });
