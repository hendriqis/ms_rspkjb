<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceiveApprovalInfoPORFullCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveApprovalInfoPORFullCtl" %>
...
<script type="text/javascript" id="dxss_PurchaseReceiveApprovalInfoPORFullCtl">
