<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceivedDtOrderCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceivedDtOrderCtl" %>
...
<input type="hidden" value="" id="hdnPORID" runat="server" />
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGridPatientPage">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPurchaseReceiveNo" ReadOnly="true" Width="50%" runat="server" />
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <asp:GridView ID="grdViewPODT" runat="server" CssClass="grdSelected grdPODT" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PurchaseOrderNo" HeaderText="No. Pemesanan" HeaderStyle-Width="200px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="OrderDateInString" HeaderText="Tanggal Pesan" HeaderStyle-Width="120px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="OrderedQuantity" HeaderText="Qty Pesan" HeaderStyle-Width="80px"
                                            ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="BaseUnit" HeaderText="Satuan Pesan" HeaderStyle-Width="100px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                    </Columns>
                                    <EmptyDataTemplate>
                                        <%=GetLabel("No Data To Display") %>
    ...
    $(function () {
        $('#<%=grdViewPRDT.ClientID %> > tbody > tr:gt(0):not(.trEmpty)').live('click', function () {
            if ($(this).attr('class') != 'selected') {
                ...
                cbpViewPODT.PerformCallback('refresh');
            }
        });
