...
{
    public partial class PurchaseReceiveApprovalDetailList : BasePageTrx
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (hdnReceiveID.Value != "")
                filterExpression = string.Format("PurchaseReceiveID = {0} AND GCItemDetailStatus != '{1}'", hdnReceiveID.Value, Constant.TransactionStatus.VOID);
