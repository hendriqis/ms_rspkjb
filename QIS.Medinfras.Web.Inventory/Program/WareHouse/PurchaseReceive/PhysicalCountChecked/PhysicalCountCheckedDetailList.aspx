<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="PhysicalCountCheckedDetailList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PhysicalCountCheckedDetailList" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReceiveBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Warehouse/PurchaseReceive/PhysicalCountChecked/PhysicalCountCheckedList.aspx?id=to');
            });
