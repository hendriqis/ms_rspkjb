...
{
    public partial class PhysicalCountCheckedDetailList : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.Inventory.PHYSICAL_COUNT_CHECKED;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            if (hdnReceiveID.Value != "")
                filterExpression = string.Format("PurchaseReceiveID = {0} AND IsPhysicalCountChecked = 0", hdnReceiveID.Value);
        ...
        protected override bool OnCustomButtonClick(string type, ref string errMessage)
        {
            ...
            try
            {
                string filterExpression = String.Format("PurchaseReceiveID = {0} AND IsPhysicalCountChecked = 0", hdnReceiveID.Value);
                ...
                {
                    itemDt.IsPhysicalCountChecked = true;
                    itemDt.PhysicalCountCheckedBy = AppSession.UserLogin.UserID;
                    itemDt.PhysicalCountCheckedDate = DateTime.Now;
