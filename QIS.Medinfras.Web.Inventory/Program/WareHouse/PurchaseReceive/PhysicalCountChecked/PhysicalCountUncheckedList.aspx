...
CodeBehind="PhysicalCountUncheckedList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PhysicalCountUncheckedList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Warehouse/PurchaseReceive/PhysicalCountChecked/PhysicalCountUncheckedDetailList.aspx?id=' + id);
