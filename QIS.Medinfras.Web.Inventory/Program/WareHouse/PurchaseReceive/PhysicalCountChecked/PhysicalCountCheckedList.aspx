...
CodeBehind="PhysicalCountCheckedList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PhysicalCountCheckedList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Warehouse/PurchaseReceive/PhysicalCountChecked/PhysicalCountCheckedDetailList.aspx?id=' + id);
