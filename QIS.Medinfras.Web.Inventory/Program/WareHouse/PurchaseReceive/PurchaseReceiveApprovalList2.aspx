<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="PurchaseReceiveApprovalList2.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveApprovalList2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lblPurchaseReceiveNo').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/WareHouse/PurchaseReceive/PurchaseReceiveApprovalInfoPORFullCtl.ascx");
            openUserControlPopup(url, purchaseOrderHdID, 'Detail Penerimaan Pembelian', 1200, 600);
        });
                                                ...
                                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="180px">
                                                            <HeaderTemplate>
                                                                <%=GetLabel("Info Penerimaan")%>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <b>
                                                                    <label class="lblLink lblPurchaseReceiveNo">
                                                                        <%#:Eval("PurchaseReceiveNo")%></label></b>
                                                                <br />
                                                                <label class="lblNormal" style="font-size: smaller;">
                                                                    <i>
                                                                        <%=GetLabel("Tgl Terima = ")%></i><%#:Eval("ReceivedDateInString")%></label>
                                                                <br />
                                                                <label class="lblNormal" style="font-size: smaller;">
                                                                    <i>
                                                                        <%=GetLabel("Tgl Jatuh Tempo = ")%></i><%#:Eval("PaymentDueDateInString")%></label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <%=GetLabel("Supplier & Product Line")%>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <b>
                                                                    <%#:Eval("SupplierName")%></b>
                                                                ...
                                                                <label class="lblNormal" style="font-size: smaller;">
                                                                    <i>
                                                                        <%=GetLabel("Product Line = ")%></i><%#:Eval("ProductLineName")%></label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <label class="lblNormal" style="font-size: smaller;">
                                                                        <i>
                                                                            <%=GetLabel("No Pemesanan = ")%></i><%#:Eval("PurchaseOrderNo")%></label>
                                                                    <br />
                                                                    <label class="lblNormal" style="font-size: smaller;">
                                                                        <i>
                                                                            <%=GetLabel("Dibuat Oleh = ")%></i><%#:Eval("CreatedByName")%></label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Right"
                                                                ...
                                                                <ItemTemplate>
                                                                    <label class="lblNormal">
                                                                        <%#:Eval("Quantity")%>
                                                                        <%=GetLabel(" ")%><%#:Eval("ItemUnit")%></label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="CustomUnitPrice" HeaderText="Harga / Satuan" HeaderStyle-HorizontalAlign="Right"
                                                            ...
                                                            <asp:BoundField DataField="CustomTotalDiscount" HeaderText="Total Discount" HeaderStyle-Width="100px"
                                                                HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                            <asp:BoundField DataField="CustomSubTotal" HeaderText="SubTotal" HeaderStyle-HorizontalAlign="Right"
                                                                ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px" DataFormatString="{0:N2}" />
                                                        </Columns>
                                                        <EmptyDataTemplate>
