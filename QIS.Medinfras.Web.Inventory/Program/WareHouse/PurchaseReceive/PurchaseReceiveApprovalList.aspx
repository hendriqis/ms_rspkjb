...
CodeBehind="PurchaseReceiveApprovalList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveApprovalList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Warehouse/PurchaseReceive/PurchaseReceiveApprovalDetailList.aspx?id=' + id);
