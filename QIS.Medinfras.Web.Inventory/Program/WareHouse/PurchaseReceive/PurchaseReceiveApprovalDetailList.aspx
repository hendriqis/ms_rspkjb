<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="PurchaseReceiveApprovalDetailList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveApprovalDetailList" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReceiveBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Warehouse/PurchaseReceive/PurchaseReceiveApprovalList.aspx?id=to');
            });
        }
