<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StockConsumptionQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.StockConsumptionQuickPicksCtl" %>
