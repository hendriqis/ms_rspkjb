<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="StockConsumptionEntry.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.StockConsumptionEntry" %>
...
<asp:Content ID="plhMenuTitle" ContentPlaceHolderID="plhMenuTitle" runat="server">
    <div class="menuTitle">
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        function onLoad() {
            ...
            $('#<%=txtConsumptionDate.ClientID %>').datepicker('option', 'maxDate', new Date(getDateNow()));
            ...
            $('#<%=lblRegistrationNo.ClientID %>.lblLink').live('click', function () {
                var filterReg = "GCRegistrationStatus NOT IN ('X020^006','X020^007','X020^005')"
        ...
        function onGetItemTypeFromFilterExpression() {
            ...
            else if ($('#<%=hdnGCLocationGroup.ClientID %>').val() == 'X227^2') {
                filterExpression = "GCItemType IN ('X001^008') AND IsDeleted = 0";
            }
            else {
                filterExpression = "GCItemType IN ('X001^009') AND IsDeleted = 0";
            }
            return filterExpression;
        }
        ...
        function GetItemQtyFromLocation() {
            var toUnitItem = cboItemUnit.GetValue();
            var toConversionFactor = $('#<%=hdnItemConversionFactor.ClientID %>').val();
            var maxQty = 0;
            ...
            Methods.getObject('GetvItemBalanceList', filterExpression, function (result) {
                if (result.GCItemUnit == toUnitItem) {
                    maxQty = result.QuantityEND;
                } else {
                    maxQty = (result.QuantityEND / toConversionFactor);
                }

                $('#<%=txtQuantity.ClientID %>').attr('max', maxQty);
        ...
        function onBeforeRightPanelPrint(code, filterExpression, errMessage) {
            ...
            if (code == 'IM-00054' || code == 'IM-00053' || code == 'IM-00206' || code == 'IM-00207') {
