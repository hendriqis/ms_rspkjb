...
{
    public partial class PurchaseReturnApprovalList : BasePageTrx
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            filterExpression += String.Format("GCTransactionStatus = '{0}' AND TransactionCode = '{1}'", Constant.TransactionStatus.WAIT_FOR_APPROVAL, Constant.TransactionCode.PURCHASE_RETURN);
            ...
            if (type == "approve")
            {
                ...
                try
                {
                    ...
                    foreach (PurchaseReturnHd purchaseHd in lstPurchaseReturnHd)
                    {
                        ...
                        purchaseHd.LastUpdatedDate = DateTime.Now;
