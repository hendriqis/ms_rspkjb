<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReturnInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReturnInfoCtl" %>
...
<input type="hidden" value="" id="hdnParam2" runat="server" />
            ...
            <div style="position: relative;">
                <table style="width: 50%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:textbox id="txtNotaKreditNo" readonly="true" width="50%" runat="server" />
                        </td>
                    </tr>
                            ...
                            <asp:panel runat="server" id="Panel1" cssclass="pnlContainerGridPatientPage">
                                <asp:gridview id="grdView" runat="server" cssclass="grdSelected grdView" autogeneratecolumns="false"
                                    ...
                                    <columns>
                                        ...
                                        <asp:BoundField DataField="PurchaseInvoiceNo" HeaderText="No. Invoice" HeaderStyle-Width="80px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="PurchaseInvoiceDateInString" HeaderText="Tanggal Invoice" HeaderStyle-Width="120px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="CreditNoteAmountInString" HeaderText="Jumlah Transaksi" HeaderStyle-Width="150px"
