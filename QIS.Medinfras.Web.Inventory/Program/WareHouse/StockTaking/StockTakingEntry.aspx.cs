...
namespace QIS.Medinfras.Web.Inventory.Program
{
    public partial class StockTakingEntry : BasePageTrx
    {
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(cboBinLocation, new ControlEntrySetting(true, true, false));
        ...
        private void EntityToControl(vStockTakingHd entity, ref bool isShowWatermark, ref string watermarkText)
        {
            ...
            string filterExpression2 = string.Format("LocationID = '{0}' AND IsDeleted = 0 ORDER BY BinLocationCode", hdnLocationID.Value);
            ...
            if (entity.BinLocationID != 0)
            {
                cboBinLocation.Value = entity.BinLocationID.ToString();
            }
        ...
        protected void lvwView_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                else
                {
                    ...
                    if (hdnIsAutoFillQtyEnd.Value == "1")
                    {
                        if (cboCheckCountType.Value == null)
                        {
        ...
        private void ControlToEntity(StockTakingHd entity)
        {
            ...
            if (cboBinLocation.Value != null && cboBinLocation.Value.ToString() != "")
            {
        ...
        private bool UpdateStockTakingDt(string[] param, ref string errMessage)
        {
            try
            {
                StockTakingHd stockTakingHd = BusinessLayer.GetStockTakingHd(Convert.ToInt32(hdnStockTakingID.Value));
        ...
        protected override bool OnVoidRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                if (stockTakingHd.GCTransactionStatus == Constant.TransactionStatus.OPEN)
                {
                    stockTakingHd.VoidBy = AppSession.UserLogin.UserID;
                    stockTakingHd.VoidDate = DateTime.Now;
                    stockTakingHd.GCTransactionStatus = Constant.TransactionStatus.VOID;
                    stockTakingHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                    stockTakingHdDao.Update(stockTakingHd);
        ...
        protected override bool OnCustomButtonClick(string type, ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                if (stockTakingHd.GCTransactionStatus == Constant.TransactionStatus.OPEN)
                {
                    ...
                    stockTakingHd.GCVoidReason = gcDeleteReason;
                    stockTakingHd.VoidReason = reason;
                    stockTakingHd.VoidBy = AppSession.UserLogin.UserID;
                    stockTakingHd.VoidDate = DateTime.Now;
                    stockTakingHd.GCTransactionStatus = Constant.TransactionStatus.VOID;
                    stockTakingHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                    ...
                    retval = stockTakingHd.StockTakingNo;
