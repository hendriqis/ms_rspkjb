<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="StockTakingV2Entry.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.StockTakingV2Entry" %>
                                ...
                                <asp:ListView runat="server" ID="lvwView" OnItemDataBound="lvwView_ItemDataBound">
                                    <EmptyDataTemplate>
                                        <table id="tblView" runat="server" class="grdView grdSelected" cellspacing="0" rules="all">
                                            ...
                                            <tr>
                                                <th style="width: 100px; display: none" align="right">
                                                    <%=GetLabel("Qty BSO")%>
                                                </th>
                                                <th style="width: 120px; display: none" align="right">
                                                    <%=GetLabel("Selisih")%>
                                                </th>
                                    ...
                                    <LayoutTemplate>
                                        <table id="tblView" runat="server" class="grdStokTaking grdSelected" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 120px; display: none">
                                                    <%=GetLabel("Selisih")%>
                                                </th>
