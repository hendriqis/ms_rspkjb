<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemOnHandAllQtyDtCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ItemOnHandAllQtyDtCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LocationName" HeaderText="Lokasi" HeaderStyle-Width="170px"
                                            HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gridColumnText" ItemStyle-CssClass="gridColumnText" />
