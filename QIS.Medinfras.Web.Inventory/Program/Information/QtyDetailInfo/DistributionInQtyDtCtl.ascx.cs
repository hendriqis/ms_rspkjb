...
{
    public partial class DistributionInQtyDtCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("ToLocationID = {0} AND ItemID = {1} AND GCItemDetailStatus = 'X160^003'", hdnLocationID.Value, hdnItemID.Value);
