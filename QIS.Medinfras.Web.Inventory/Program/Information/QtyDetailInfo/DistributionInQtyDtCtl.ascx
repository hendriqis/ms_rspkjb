<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DistributionInQtyDtCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.DistributionInQtyDtCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:440px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FromLocationName" HeaderText="Lokasi Asal" HeaderStyle-HorizontalAlign="Left" />
                                        ...
                                        <asp:BoundField DataField="LastUpdatedByName" HeaderText="Pengirim" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="90px" />
                                    </Columns>
                                    <EmptyDataTemplate>
