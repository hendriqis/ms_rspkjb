...
{
    public partial class ItemDistributionInfo : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.Inventory.ITEM_DISTRIBUTION_INFO;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vItemDistributionDt> lstEntity = BusinessLayer.GetvItemDistributionDtList(filterExpression, 10, pageIndex, "DistributionNo, ItemName1, ItemDetailStatus");
