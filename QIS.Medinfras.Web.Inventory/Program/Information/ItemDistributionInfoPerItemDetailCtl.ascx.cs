...
{
    public partial class ItemDistributionInfoPerItemDetailCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = DetailPage.GetItemDistributionDtFilterExpression();
            ...
            List<vItemDistributionDt> lstDistributionDt = BusinessLayer.GetvItemDistributionDtList(filterExpression, 10, pageIndex, "ID");
