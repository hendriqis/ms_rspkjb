<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="ItemDistributionInfo.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ItemDistributionInfo" %>
                        ...
                        <td>
                            <qis:QISIntellisenseTextBox runat="server" ClientInstanceName="txtSearchView" ID="txtSearchView" Width="300px" Watermark="Search">
                                ...
                                <IntellisenseHints>
                                    ...
                                    <qis:QISIntellisenseHint Text="Status" FieldName="ItemDetailStatus" />
                                </IntellisenseHints>
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="cfDeliveryDateInString" HeaderText="Tanggal" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
                                        <asp:BoundField DataField="DistributionNo" HeaderText="No. Distribusi" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="130px"  />
                                        <asp:BoundField DataField="ItemName1" HeaderText="Nama Item" HeaderStyle-HorizontalAlign="Left"  />
                                        <asp:BoundField DataField="FromLocationName" HeaderText="Dari Lokasi" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="250px" />
                                        <asp:BoundField DataField="ToLocationName" HeaderText="Kepada Lokasi" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="250px"  />
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="150px">
                                            <HeaderTemplate>
                                                <%=GetLabel("Jumlah") %>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="ItemDetailStatus" HeaderText="Status" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="120px"  />
                                        <asp:BoundField DataField="CreatedByName" HeaderText="Pengirim" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="120px" />
                                        <asp:BoundField DataField="LastUpdatedByName" HeaderText="Penerima" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="120px" />
                                    </Columns>
                                    <EmptyDataTemplate>
