<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemDistributionInfoPerItemDetailCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Pharmacy.Program.ItemDistributionInfoPerItemDetailCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:240px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemDetailStatus" HeaderText="Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
                                        <asp:BoundField DataField="LastUpdatedByName" HeaderText="Pengirim" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
                                    </Columns>
                                    <EmptyDataTemplate>
