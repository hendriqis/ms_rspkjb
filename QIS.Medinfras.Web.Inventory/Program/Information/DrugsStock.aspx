<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="DrugsStock.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.DrugsStock" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#lblLocation.lblLink').click(function () {
                openSearchDialog('locationallroleuser', onGetLocationFilterExpression(), function (value) {
        ...
        $('.lblExpired.lblLink').live('click', function () {
            $tr = $(this).closest('tr').closest('tr');
            var locationID = $('#<%=hdnLocationID.ClientID %>').val();
            var itemID = $tr.find('.hiddenColumn').html();
            var id = itemID + '|' + locationID;
            var url = ResolveUrl("~/Program/Information/QtyDetailInfo/ItemExpiredCtl.ascx");
            openUserControlPopup(url, id, 'History Expired', 800, 500);
        });
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="cboBinLocation" ClientInstanceName="cboBinLocation"
                                    Width="200px" OnCallback="cboBinLocation_Callback">
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="center" HeaderStyle-Width="70px">
                                                <ItemTemplate>
                                                    <label class="lblExpired lblLink">
