...
{
    public partial class PurchaseReceiveInfoDetailCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = DetailPage.GetPurchaseReceiveDtFilterExpression();
            filterExpression += string.Format(" AND ItemID = {0}", hdnItemID.Value, hdnReferenceNo.Value, hdnTaxInvoiceNo.Value, hdnBatchNoExpiredDate.Value);
            if (isCountPageCount)
            {
