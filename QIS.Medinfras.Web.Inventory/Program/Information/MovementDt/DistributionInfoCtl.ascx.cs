...
{
    public partial class ItemDistributionInfoCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            hdnIsDistributionIN.Value = lstParam[5];
        ...
        protected string GetFilterExpression()
        {
            ...
            {
                if (hdnIsDistributionIN.Value != "1")
                    filterExpression += string.Format("FromLocationID = {0}", hdnLocationID.Value);
                else
                    filterExpression += String.Format("ToLocationID = {0}", hdnLocationID.Value);
            ...
            filterExpression += string.Format(" AND IsHasItemMovement = 1");
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<vItemDistributionDt> lstDistributionDt = BusinessLayer.GetvItemDistributionDtList(filterExpression, 10, pageIndex, "DistributionID");
