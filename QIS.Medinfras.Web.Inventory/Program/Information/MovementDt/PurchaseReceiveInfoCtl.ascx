<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceiveInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveInfoCtl" %>
...
<script type="text/javascript" id="dxss_PurchaseReceiveInfoCtl">
    //#region Paging
                ...
                <dxcp:ASPxCallbackPanel ID="cbpPopupView" runat="server" Width="100%" ClientInstanceName="cbpPopupView"
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:360px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MovementDateInString" HeaderStyle-Width="100px" HeaderText="Tanggal Transaksi" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="center" />
                                        <asp:BoundField DataField="TransactionNo" HeaderText="No Transaksi" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Left"  />
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Right" >
                                            <HeaderTemplate>
                                                <%=GetLabel("Jumlah") %>    
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <%#:Eval("cfMovementQuantity", "{0:N2}") %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="ItemUnit" HeaderStyle-HorizontalAlign="Left" HeaderText="Satuan" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="60px"/>
                                        <asp:BoundField DataField="CreatedByUserName" HeaderText="Dibuat Oleh" HeaderStyle-Width="80px" />
                                    </Columns>
                                    <EmptyDataTemplate>
