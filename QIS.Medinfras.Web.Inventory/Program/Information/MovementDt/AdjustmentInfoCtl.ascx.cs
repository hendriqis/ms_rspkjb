...
{
    public partial class AdjustmentInfoCtl : BaseViewPopupCtl
    {
        ...
        protected string GetFilterExpression()
        {
            ...
            if (hdnLocationID.Value != "" || hdnItemID.Value != "")
            {
                ...
                filterExpression += String.Format(" AND TransactionCode IN ({0},{1},{2})", Constant.TransactionCode.ITEM_ADJUSTMENT, Constant.TransactionCode.STOCK_TAKING, Constant.TransactionCode.PRODUCTION_PROCESS);
            }
            else
