<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceiveVoidInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseReceiveVoidInfoCtl" %>
...
<script type="text/javascript" id="dxss_PurchaseReceiveVoidInfoCtl">
    //#region Paging
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:400px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    ...
                                    <EmptyDataTemplate>
                                        <%=GetLabel("Tidak ada data batal penerimaan barang untuk lokasi ini dan tanggal tersebut")%>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </asp:Panel>
                        </dx:PanelContent>
