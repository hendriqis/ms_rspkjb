<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsumptionInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ConsumptionInfoCtl" %>
...
<script type="text/javascript" id="dxss_ConsumptionInfoCtl">
    //#region Paging
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:400px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    ...
                                    <EmptyDataTemplate>
                                        <%=GetLabel("Tidak ada data pemakaian barang untuk lokasi ini dan tanggal tersebut")%>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </asp:Panel>
                        </dx:PanelContent>
