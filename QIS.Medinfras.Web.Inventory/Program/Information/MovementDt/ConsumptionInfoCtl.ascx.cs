...
{
    public partial class ConsumptionInfoCtl : BaseViewPopupCtl
    {
        ...
        protected string GetFilterExpression()
        {
            ...
            if (hdnLocationID.Value != "" || hdnItemID.Value != "")
            {
                ...
                filterExpression += String.Format(" AND TransactionCode IN ({0},{1},{2},{3},{4})", 
                    Constant.TransactionCode.ITEM_CONSUMPTION, Constant.TransactionCode.PURCHASE_RETURN, Constant.TransactionCode.DIRECT_PURCHASE_RETURN, Constant.TransactionCode.CONSIGNMENT_RETURN, Constant.TransactionCode.PRODUCTION_PROCESS);
            }
            else
