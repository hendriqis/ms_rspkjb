<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdjustmentInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.AdjustmentInfoCtl" %>
...
<script type="text/javascript" id="dxss_AdjustmentInfoCtl">
    //#region Paging
