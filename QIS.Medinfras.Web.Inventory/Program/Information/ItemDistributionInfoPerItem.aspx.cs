...
{
    public partial class ItemDistributionInfoPerItem : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.Inventory.ITEM_DISTRIBUTION_INFO_PER_ITEM;
        }
        ...
        protected string GetFilterExpression()
        {
            ...
            if (txtFromLocationCode.Text != "" || txtToLocationCode.Text != "")
            {
                ...
                if (txtDateFrom.Text != "" && txtDateTo.Text != "")
                    filterExpression += String.Format(" AND TransactionDate BETWEEN '{0}' AND '{1}'", Helper.GetDatePickerValue(txtDateFrom.Text), Helper.GetDatePickerValue(txtDateTo.Text));
        ...
        public string GetItemDistributionDtFilterExpression()
        {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            filterExpression = string.Format("ItemID IN (SELECT ItemID FROM vItemDistributionDt WHERE {0})", filterExpression);
            if (isCountPageCount)
            {
            ...
            List<ItemMaster> lstEntity = BusinessLayer.GetItemMasterList(filterExpression, 10, pageIndex, "ItemName1");
