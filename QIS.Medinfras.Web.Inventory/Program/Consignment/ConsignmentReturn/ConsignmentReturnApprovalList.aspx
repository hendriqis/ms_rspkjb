...
CodeBehind="ConsignmentReturnApprovalList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentReturnApprovalList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="PurchaseReceiveNo" HeaderText="No BTB" HeaderStyle-Width="150px"/>
                                <asp:BoundField DataField="SupplierName" HeaderText="Nama Supplier" HeaderStyle-Width="200px"/>
                                ...
                                <asp:BoundField DataField="PurchaseReturnType" HeaderText="Tipe Retur" />
