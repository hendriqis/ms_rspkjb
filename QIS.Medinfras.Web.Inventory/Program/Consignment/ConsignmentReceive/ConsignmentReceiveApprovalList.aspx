...
CodeBehind="ConsignmentReceiveApprovalList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentReceiveApprovalList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Consignment/ConsignmentReceive/ConsignmentReceiveApprovalDetailList.aspx?id=' + id);
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="ReceivedDateInString" HeaderText="Tanggal Penerimaan" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="120px" />
                                <asp:BoundField DataField="SupplierName" HeaderText="Nama Supplier" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="300px" />
                                <asp:BoundField DataField="PaymentDueDateInString" HeaderText="Tanggal Jatuh Tempo" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="120px" />
                                <asp:BoundField DataField="TransactionAmount" HeaderText="Jumlah Transaksi Kotor" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N}" />
                            </Columns>
                            <EmptyDataTemplate>
