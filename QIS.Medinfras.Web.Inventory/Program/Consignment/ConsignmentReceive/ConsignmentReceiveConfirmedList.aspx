...
CodeBehind="ConsignmentReceiveConfirmedList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentReceiveConfirmedList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Consignment/ConsignmentReceive/ConsignmentReceiveConfirmedDetailList.aspx?id=' + id);
