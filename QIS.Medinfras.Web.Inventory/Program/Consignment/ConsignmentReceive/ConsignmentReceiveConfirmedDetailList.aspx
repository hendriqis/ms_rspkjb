<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ConsignmentReceiveConfirmedDetailList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentReceiveConfirmedDetailList" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReceiveBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Consignment/ConsignmentReceive/ConsignmentReceiveConfirmedList.aspx?id=to');
            });
