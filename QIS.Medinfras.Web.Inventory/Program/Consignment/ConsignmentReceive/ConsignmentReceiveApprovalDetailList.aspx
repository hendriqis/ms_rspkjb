<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ConsignmentReceiveApprovalDetailList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentReceiveApprovalDetailList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPurchaseReceiveDetailApprove" crudmode="R" runat="server">
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReceiveBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Consignment/ConsignmentReceive/ConsignmentReceiveApprovalList.aspx?id=to');
            });

            $('#<%=btnPurchaseReceiveDetailApprove.ClientID %>').click(function () {
                getCheckedMember();
    ...
    <div style="height: 435px; overflow-y: auto; overflow-x: hidden;">
        <div class="pageTitle">
            <div style="font-size: 1.1em">
                <%=GetLabel("Penerimaan Barang Konsinyasi")%></div>
        </div>
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdService grdNormal notAllowSelect"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="LastUpdatedByName" HeaderText="Penerima" ItemStyle-HorizontalAlign="Left" />
                                        </Columns>
                                        <EmptyDataTemplate>
