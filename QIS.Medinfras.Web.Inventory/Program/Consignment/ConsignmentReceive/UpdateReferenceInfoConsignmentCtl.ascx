<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateReferenceInfoConsignmentCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.UpdateReferenceInfoConsignmentCtl" %>
...
<script type="text/javascript" id="dxss_updatereferenceconsctl">
    $(function () {
        hideLoadingPanel();
