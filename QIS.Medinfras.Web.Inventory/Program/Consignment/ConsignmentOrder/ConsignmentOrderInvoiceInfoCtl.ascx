<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentOrderInvoiceInfoCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentOrderInvoiceInfoCtl" %>
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblNormal">
                                <%=GetLabel("Purchase Order No : ")%></label>
                        </td>
                        <td>
