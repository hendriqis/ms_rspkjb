<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentOrderAddFromReceivePerItemCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentOrderAddFromReceivePerItemCtl" %>
...
<script type="text/javascript" id="dxss_ConsignmentOrderAddFromReceivePerItemCtl">
    ...
    function onBeforeSaveRecord(errMessage) {
        ...
        $('.chkIsSelected input').each(function () {
            if ($(this).is(':checked')) {
                ...
                data += purchaseReceiveID + ";" + itemID + ";" + quantity + ";" + gcPurchaseUnit + ";" + gcBaseUnit + ";" + conversionFactor + ";" + unitPrice + ";" + isDiscountInPercentage1 + ";" + isDiscountInPercentage2 + ";" + discountPercentage1 + ";" + discountPercentage2 + ";" + discountAmount1 + ";" + discountAmount2 + ";" + pOQty + ";" + receiveQtyConf + "|";
                count += 1;
            }
    ...
    function getItemFilterExpression() {
        var filterExpression = "<%=GetPurchaseReceivePerItemFilterExpression() %>";
    ...
    <tr>
        <td style="padding: 5px; vertical-align: top">
            <table class="tblEntryContent" style="width: 100%">
                ...
                <tr>
                    <td class="tdLabel">
                        <label class="lblLink" id="lblItem"><%=GetLabel("Item")%></label>
                    </td>
                    <td>
                        ...
                        <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                            ...
                            <asp:GridView ID="grdPopupView" runat="server" CssClass="grdNormal" AutoGenerateColumns="false" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PurchaseReceiveNo" HeaderText="No. Penerimaan" HeaderStyle-Width="180px" />
