<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ConsignmentOrderReopenList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ConsignmentOrderReopenList" %>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <div>
                                                        ...
                                                        /
                                                        <%#: Eval("NumberOfCompletedReceivedItems")%></div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataTemplate>
