<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx2.master"
    AutoEventWireup="true" CodeBehind="CSSDHandoverConfirmationDetailInfoList.aspx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.CSSDHandoverConfirmationDetailInfoList" %>
        ...
        function onLoad() {
            ...
            $('#lblQuickPick').click(function () {
                if (IsValid(null, 'fsMPEntry', 'mpEntry')) {
                    showLoadingPanel();
                    var url = ResolveUrl('~/Program/CSSD/CSSDRequest/CSSDConsumptionEntryQuickPickCtl.ascx');
                ...
                <td colspan="2">
                    ...
                    <div style="width: 100%; text-align: center">
                        <span class="lblLink" id="lblAddData" style="margin-right: 300px;">
                            <%= GetLabel("Tambah Data")%></span> <span class="lblLink" id="lblQuickPick" style="margin-right: 300px;">
                ...
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtLocationCode" Width="120px" runat="server" ReadOnly="true" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtLocationCodeTo" Width="120px" runat="server" ReadOnly="true" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtPreWashingVolume" Width="100%" runat="server" ReadOnly="true" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtPreWashingCondition" Width="100%" runat="server" ReadOnly="true" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal">
                                    <%=GetLabel("Washing Method")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtWashingMethod" Width="100%" runat="server" ReadOnly="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal">
                                    <%=GetLabel("Packaging Type")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtPackagingType" Width="100%" runat="server" ReadOnly="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal">
                                    <%=GetLabel("Sterilitation Type - Cycle")%></label>
                            </td>
                            <td>
                                <table style="width: 100%" cellpadding="0" cellspacing="0">
                                    <colgroup>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtSterilitationType" Width="100%" runat="server" ReadOnly="true" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtSterilitationCycle" Width="100%" runat="server" ReadOnly="true" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSterilitationExpired" Width="100%" runat="server" ReadOnly="true" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtServiceStatus" Font-Bold="true" Font-Size="Larger" ForeColor="Maroon"
                ...
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="Label3">
                                    <%=GetLabel("Washing By")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtWashingBy" Width="100%" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <%=GetLabel("Washing Date")%>
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-right: 1px; width: 140px">
                                            <asp:TextBox ID="txtWashingDate" Width="120px" CssClass="datepicker" ReadOnly="true"
                                                runat="server" />
                                        </td>
                                        <td style="width: 5px">
                                            &nbsp;
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtWashingTime" Width="100px" CssClass="time" runat="server" ReadOnly="true"
                                                Style="text-align: center" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="Label3">
                                    <%=GetLabel("Packaging By")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtPackagingBy" Width="100%" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <%=GetLabel("Packaging Date")%>
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-right: 1px; width: 140px">
                                            <asp:TextBox ID="txtPackagingDate" Width="120px" CssClass="datepicker" ReadOnly="true"
                                                runat="server" />
                                        </td>
                                        <td style="width: 5px">
                                            &nbsp;
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPackagingTime" Width="100px" CssClass="time" runat="server" ReadOnly="true"
                                                Style="text-align: center" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="Label4">
                                    <%=GetLabel("Sterilitation By")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSterilitationBy" Width="100%" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="Label5">
                                    <%=GetLabel("QC By")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtQCBy" Width="100%" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-right: 1px; width: 140px">
                                            <asp:TextBox ID="txtQCDate" Width="120px" CssClass="datepicker" ReadOnly="true" runat="server" />
                                        </td>
                                        <td style="width: 5px">
                                            &nbsp;
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtQCTime" Width="100px" CssClass="time" runat="server" ReadOnly="true"
                                                Style="text-align: center" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="Label6">
                                    <%=GetLabel("Storage By")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtStorageBy" Width="100%" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <%=GetLabel("Storage Date")%>
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-right: 1px; width: 140px">
                                            <asp:TextBox ID="txtStorageDate" Width="120px" CssClass="datepicker" ReadOnly="true" runat="server" />
                                        </td>
                                        <td style="width: 5px">
                                            &nbsp;
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtStorageTime" Width="100px" CssClass="time" runat="server" ReadOnly="true"
                                                Style="text-align: center" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="Label6">
                                    <%=GetLabel("Returned By")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtReturnedBy" Width="100%" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <%=GetLabel("Returned Date")%>
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-right: 1px; width: 140px">
                                            <asp:TextBox ID="txtReturnedDate" Width="120px" CssClass="datepicker" ReadOnly="true" runat="server" />
                                        </td>
                                        <td style="width: 5px">
                                            &nbsp;
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtReturnedTime" Width="100px" CssClass="time" runat="server" ReadOnly="true"
                                                Style="text-align: center" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="tdLabel">
                                <label class="lblNormal" id="Label5">
                                    <%=GetLabel("Confirmed By")%></label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtConfirmedBy" Width="100%" ReadOnly="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                <%=GetLabel("Confirmed Date")%>
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-right: 1px; width: 140px">
                                            <asp:TextBox ID="txtConfirmedDate" Width="120px" CssClass="datepicker" ReadOnly="true"
                                                runat="server" />
                                        </td>
                                        <td style="width: 5px">
                                            &nbsp;
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtConfirmedTime" Width="100px" CssClass="time" runat="server" ReadOnly="true"
                                                Style="text-align: center" />
                                        </td>
                                    </tr>
                                </table>
