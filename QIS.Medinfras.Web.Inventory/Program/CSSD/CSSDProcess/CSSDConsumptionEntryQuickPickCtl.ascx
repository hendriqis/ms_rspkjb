<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CSSDConsumptionEntryQuickPickCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.CSSDConsumptionEntryQuickPickCtl" %>
...
<script type="text/javascript" id="dxss_drugslogisticsquickpicksctl">
    ...
    $('#<%=grdView.ClientID %> .chkIsSelected input').live('change', function () {
        if ($(this).is(':checked')) {
            ...
            $newTr = $newTr.replace(/\$\{AveragePrice}/g, $selectedTr.find('.hiddenColumn').html());
            $newTr = $($newTr);
...
<div>
    <script id="tmplSelectedTestItem" type="text/x-jquery-tmpl">
        <tr class="trSelectedItem">
            <td align="center">
                ...
                <input type="hidden" class="hiddenColumn" value='${AveragePrice}' />
            </td>
            <td>${ItemName1}</td>
            <td><input type="text" validationgroup="mpDrugsQuickPicks" class="txtQty number" value="1" style="width:60px" /></td>
        </tr>
    </script>
    <input type="hidden" id="hdnServiceRequestIDCtl" runat="server" value="" />
    ...
    <input type="hidden" id="hdnSelectedMemberAveragePrice" runat="server" value="" />
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderStyle-Width="50px" DataField="QuantityEND" HeaderText="Stok"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N}" />
                                            <asp:BoundField HeaderStyle-Width="60px" DataField="ItemUnit" HeaderText="Satuan"
                                                HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                            <asp:BoundField HeaderStyle-Width="60px" DataField="AveragePrice" HeaderText="Average" HeaderStyle-CssClass="hiddenColumn" ItemStyle-CssClass="hiddenColumn"
