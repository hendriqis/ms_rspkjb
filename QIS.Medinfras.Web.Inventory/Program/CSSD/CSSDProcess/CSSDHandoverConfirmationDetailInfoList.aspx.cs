...
{
    public partial class CSSDHandoverConfirmationDetailInfoList : BasePageTrx
    {
        ...
        private void EntityToControl(vMDServiceRequestHd entity)
        {
            ...
            txtServiceStatus.Text = entity.ServiceStatus;
            txtServiceType.Text = entity.ServiceType;
            txtPreWashingVolume.Text = entity.PreWashingVolume;
            txtPreWashingCondition.Text = entity.PreWashingCondition;
            txtWashingMethod.Text = entity.WashingMethod;
            txtPackagingType.Text = entity.PackagingType;
            txtSterilitationType.Text = entity.SterilitationType;
            txtSterilitationCycle.Text = entity.SterilitationCycle.ToString();
            ...
            txtSentDate.Text = entity.SentDate.ToString(Constant.FormatString.DATE_FORMAT);
            txtSentTime.Text = entity.SentDate.ToString(Constant.FormatString.TIME_FORMAT);

            txtReceivedBy.Text = entity.ReceivedByName;
            txtReceivedDate.Text = entity.ReceivedDate.ToString(Constant.FormatString.DATE_FORMAT);
            txtReceivedTime.Text = entity.ReceivedDate.ToString(Constant.FormatString.TIME_FORMAT);

            if (entity.WashingDate != null && entity.WashingDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != "01-01-1900")
            {
                txtWashingBy.Text = entity.WashingByName;
                txtWashingDate.Text = entity.WashingDate.ToString(Constant.FormatString.DATE_FORMAT);
                txtWashingTime.Text = entity.WashingDate.ToString(Constant.FormatString.TIME_FORMAT);
            }

            if (entity.PackagingDate != null && entity.WashingDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != "01-01-1900")
            {
                txtPackagingBy.Text = entity.PackagingByName;
                txtPackagingDate.Text = entity.PackagingDate.ToString(Constant.FormatString.DATE_FORMAT);
                txtPackagingTime.Text = entity.PackagingDate.ToString(Constant.FormatString.TIME_FORMAT);
            }

            if (entity.SterilitationDate != null && entity.SterilitationDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != "01-01-1900")
            {
                txtSterilitationBy.Text = entity.SterilitationByName;
            ...
            if (entity.ControlledDate != null && entity.ControlledDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != "01-01-1900")
            {
                txtQCBy.Text = entity.ControlledByName;
                txtQCDate.Text = entity.ControlledDate.ToString(Constant.FormatString.DATE_FORMAT);
                txtQCTime.Text = entity.ControlledDate.ToString(Constant.FormatString.TIME_FORMAT);
            }

            if (entity.StorageDate != null && entity.StorageDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != "01-01-1900")
            {
                txtStorageBy.Text = entity.StorageByName;
                txtStorageDate.Text = entity.StorageDate.ToString(Constant.FormatString.DATE_FORMAT);
                txtStorageTime.Text = entity.StorageDate.ToString(Constant.FormatString.TIME_FORMAT);
            }

            if (entity.ReturnedDate != null && entity.ReturnedDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != "01-01-1900")
            {
                txtReturnedBy.Text = entity.ReturnedByName;
                txtReturnedDate.Text = entity.ReturnedDate.ToString(Constant.FormatString.DATE_FORMAT);
                txtReturnedTime.Text = entity.ReturnedDate.ToString(Constant.FormatString.TIME_FORMAT);
            }

            if (entity.ConfirmedDate != null && entity.ConfirmedDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != "01-01-1900")
            {
                txtConfirmedBy.Text = entity.ConfirmedByName;
                txtConfirmedDate.Text = entity.ConfirmedDate.ToString(Constant.FormatString.DATE_FORMAT);
                txtConfirmedTime.Text = entity.ConfirmedDate.ToString(Constant.FormatString.TIME_FORMAT);
            }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            {
                filterExpression = string.Format("RequestID = {0} AND IsDeleted = 0", hdnServiceRequestID.Value, Constant.ServiceStatus.ON_DELIVERY);
            }
