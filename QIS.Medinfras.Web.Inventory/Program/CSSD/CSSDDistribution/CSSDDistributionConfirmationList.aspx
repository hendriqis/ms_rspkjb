<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master"
    AutoEventWireup="true" CodeBehind="CSSDDistributionConfirmationList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.CSSDDistributionConfirmationList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnServiceRequestApprove" crudmode="R" runat="server">
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnServiceRequestApprove.ClientID %>').click(function () {
        ...
        $('.lnkDistribution a').live('click', function () {
            var param = $(this).closest('tr').find('.DistributionID').html();
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DistributionID" HeaderStyle-CssClass="DistributionID" ItemStyle-CssClass="DistributionID" />
