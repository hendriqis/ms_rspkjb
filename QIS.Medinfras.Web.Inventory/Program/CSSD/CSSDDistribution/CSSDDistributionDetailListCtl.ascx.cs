...
{
    public partial class CSSDDistributionDetailListCtl : BaseViewPopupCtl
    {
        protected int PageCount = 1;
        public override void InitializeDataControl(string param)
        {
            hdnDistributionID.Value = param;
            vItemDistributionHd entity = BusinessLayer.GetvItemDistributionHdList(string.Format("DistributionID = {0}", param)).FirstOrDefault();
