<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CSSDRequestEntryQuickPickCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.CSSDRequestEntryQuickPickCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemName1" HeaderText="Barang" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-CssClass="tdItemName1" />
                                        <asp:BoundField HeaderStyle-Width="50px" DataField="BinLocationName" HeaderText="Rak" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:BoundField HeaderStyle-Width="60px" DataField="ConvertionFactor" HeaderText="Konversi"
