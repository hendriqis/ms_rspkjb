<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true"
    CodeBehind="ItemProductList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ItemProductList" %>
                        ...
                        <asp:ListView runat="server" ID="grdView">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <i><b>
                                            <%=GetLabel("Kelompok Item : ")%></b></i><%#: Eval("ItemGroupName1")%> (<%#: Eval("ItemGroupCode")%>)<br />
                                        <i><b>
                                            <%=GetLabel("Product Line : ")%></b></i><%#: Eval("ProductLineName")%> (<%#: Eval("ProductLineCode")%>)
                                    </td>
                                    <td align="center">
                                        <%#: Eval("ItemUnit")%>
                                    </td>
