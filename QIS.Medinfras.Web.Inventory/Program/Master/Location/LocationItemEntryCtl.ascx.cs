...
namespace QIS.Medinfras.Web.Inventory.Program
{
    public partial class LocationItemEntryCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            hdnLocationItemGroupID.Value = entity.ItemGroupID.ToString();
        ...
        {
            return string.Format("GCItemType IN ('{1}','{2}','{3}') AND ItemID NOT IN (SELECT ItemID FROM ItemBalance WHERE LocationID = {0} AND IsDeleted = 0) AND IsDeleted = 0", hdnLocationID.Value, Constant.ItemGroupMaster.SUPPLIES, Constant.ItemGroupMaster.DRUGS, Constant.ItemGroupMaster.LOGISTIC);
        }
