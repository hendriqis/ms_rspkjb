<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LocationItemExpiredDateCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.LocationItemExpiredDateCtl" %>
...
<script type="text/javascript" id="dxss_LocationItemExpiredDateCtl">
    $(function () {
    ...
    $('.imgPopupEdit').live('click', function () {
        ...
        Methods.getObject('GetItemBalanceDtExpiredList', filterExpression, function (result) {
            if (result != null) {
                $('#trEditEntry').show();
