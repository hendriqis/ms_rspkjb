<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master" AutoEventWireup="true" CodeBehind="LocationList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.LocationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkLocation a').live('click', function () {
            var id = $(this).closest('tr').find('.keyField').html();
            var url = ResolveUrl("~/Program/Master/Location/LocationDetailListCtl.ascx");
            openUserControlPopup(url, id, 'Lokasi Gudang', 950, 550);
        });
    </script>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                <dxe:ASPxComboBox ID="cboHealthcare" runat="server" ClientInstanceName="cboHealthcare" Width="250px">
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="LocationName" HeaderText="Nama Gudang" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="ShortName" HeaderText="Nama Singkat" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" />
                                <asp:HyperLinkField HeaderText="Lokasi" HeaderStyle-Width="120px" Text="Lokasi" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="lnkLocation" HeaderStyle-HorizontalAlign="Center" />
                                ...
                                <%--ini field bawah di uncomment kalo user minta bisa setting balance dari menu lokasi ini--%>
                                <%--<asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="lnkItem" HeaderText="Item" HeaderStyle-Width="80px">
                                    <ItemTemplate>
                                        <a <%#: Eval("IsHeader").ToString() == "True" ? "style='display:none'" : ""%>>Setting</a>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>
                            <EmptyDataTemplate>
