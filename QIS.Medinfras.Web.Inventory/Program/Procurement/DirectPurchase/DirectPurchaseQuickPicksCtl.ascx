<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DirectPurchaseQuickPicksCtl.ascx.cs" 
    Inherits="QIS.Medinfras.Web.Inventory.Program.DirectPurchaseQuickPicksCtl" %>
...
<div style="padding:10px;">
    ...
    <input type="hidden" id="hdnPurchaseID" runat="server" value="" />
    ...
    <input type="hidden" id="hdnSupplierID" runat="server" value="" />
