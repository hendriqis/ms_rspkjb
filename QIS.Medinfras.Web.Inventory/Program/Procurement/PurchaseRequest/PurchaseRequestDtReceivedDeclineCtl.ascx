<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseRequestDtReceivedDeclineCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseRequestDtReceivedDeclineCtl" %>
                                ...
                                <asp:GridView ID="grdViewPRDT" runat="server" CssClass="grdSelected grdPODT" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:BoundField DataField="ItemCode" HeaderText="Kode Item" HeaderStyle-Width="50px"
                                        ...
                                        <asp:BoundField DataField="cfLastUpdateInformation" HeaderText="Terakhir Diubah" HeaderStyle-Width="200px"
