...
{
    public partial class PurchaseRequestDtReceivedClosedCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("PurchaseRequestID = {0} AND IsDeleted = 0 AND GCItemDetailStatus = '{1}'", hdnPRID.Value, Constant.TransactionStatus.CLOSED);
            if (isCountPageCount)
            {
