<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseRequestQuickPicksCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseRequestQuickPicksCtl" %>
...
<script type="text/javascript" id="dxss_PurchaseRequestQuickPicksCtl">
            ...
            Methods.getObject('GetBusinessPartnersList', filterExpression, function (result) {
                if (result != null) {
                    ...
                    Methods.getDateDiffPOPORPerSupplier($('#<%=hdnSupplierID.ClientID %>').val(), function (result) {
                        if (result != null) {
                            $('#<%=txtETACtl.ClientID %>').val(result.Hasil + ' Hari');
                        }
                        else {
                            $('#<%=txtETACtl.ClientID %>').val('');
                        }
                    });
                }
                else {
...
<div style="padding: 10px;">
    ...
    <table>
        ...
        <tr>
            <td class="tdLabel">
                <label class="lblLink" id="lblSupplierDrugLogistic">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtETACtl" ReadOnly="true" Width="100%" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="tdLabel">
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                ...
                                <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemName1" HeaderText="Item" ItemStyle-CssClass="tdItemName1" />
                                        ...
                                        <asp:BoundField HeaderStyle-Width="100px" DataField="ItemUnit" HeaderText="Satuan Kecil"
