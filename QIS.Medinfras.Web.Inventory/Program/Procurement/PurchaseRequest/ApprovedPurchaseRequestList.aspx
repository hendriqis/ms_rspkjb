...
CodeBehind="ApprovedPurchaseRequestList.aspx.cs" Inherits="QIS.Medinfras.Web.Inventory.Program.ApprovedPurchaseRequestList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseRequestHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Procurement/PurchaseRequest/ApprovedPurchaseRequestDetailList.aspx?id=' + id);
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="LocationCode" HeaderText="Kode Lokasi" HeaderStyle-Width="300px"/>
                                <asp:BoundField DataField="LocationName" HeaderText="Nama Lokasi" HeaderStyle-Width="300px"/>
