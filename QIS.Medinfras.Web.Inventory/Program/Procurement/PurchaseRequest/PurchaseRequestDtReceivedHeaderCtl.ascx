<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseRequestDtReceivedHeaderCtl.ascx.cs"
    Inherits="QIS.Medinfras.Web.Inventory.Program.PurchaseRequestDtReceivedHeaderCtl" %>
                    ...
                    <tr>
                        <td class="tdLabel">
                            <label class="lblNormal">
                                <b><%=GetLabel("No. Permintaan : ")%></b></label>
                        </td>
                        <td>
                            ...
                            <asp:panel runat="server" id="Panel1" cssclass="pnlContainerGridPatientPage">
                                <asp:gridview id="grdView" runat="server" cssclass="grdSelected grdView" autogeneratecolumns="false"
                                    ...
                                    <columns>
                                        ...
                                        <asp:BoundField DataField="PurchaseOrderNo" HeaderText="No. Order" HeaderStyle-Width="100px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="cfOrderDateInString" HeaderText="Tanggal Order" HeaderStyle-Width="80px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="TransactionStatus" HeaderText="Status Order" HeaderStyle-Width="150px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
